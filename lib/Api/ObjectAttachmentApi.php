...
/**
     ...
     * @return \eZmaxAPI\Model\AttachmentDownloadV1Response|\eZmaxAPI\Model\CommonResponseError|\eZmaxAPI\Model\CommonResponseError
     */
    public function attachmentDownloadV1($pkiAttachmentID, string $contentType = self::contentTypes['attachmentDownloadV1'][0])
    {
        list($response) = $this->attachmentDownloadV1WithHttpInfo($pkiAttachmentID, $contentType);
        return $response;
    }
     ...
     * @throws \eZmaxAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \eZmaxAPI\Model\AttachmentDownloadV1Response|\eZmaxAPI\Model\CommonResponseError|\eZmaxAPI\Model\CommonResponseError, HTTP status code, HTTP response headers (array of strings)
     */
    public function attachmentDownloadV1WithHttpInfo($pkiAttachmentID, string $contentType = self::contentTypes['attachmentDownloadV1'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eZmaxAPI\Model\AttachmentDownloadV1Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eZmaxAPI\Model\AttachmentDownloadV1Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\eZmaxAPI\Model\AttachmentDownloadV1Response', []),
            ...
            $returnType = '\eZmaxAPI\Model\AttachmentDownloadV1Response';
