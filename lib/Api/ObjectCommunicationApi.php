...
class ObjectCommunicationApi
{
    ...
    /**
     * Operation communicationGetCommunicationBodyV1
     *
     * Retrieve the communication body
     *
     * @param  int $pkiCommunicationID pkiCommunicationID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['communicationGetCommunicationBodyV1'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function communicationGetCommunicationBodyV1($pkiCommunicationID, string $contentType = self::contentTypes['communicationGetCommunicationBodyV1'][0])
    {
        $this->communicationGetCommunicationBodyV1WithHttpInfo($pkiCommunicationID, $contentType);
    }

    /**
     * Operation communicationGetCommunicationBodyV1WithHttpInfo
     *
     * Retrieve the communication body
     *
     ...
     */
    public function communicationGetCommunicationBodyV1WithHttpInfo($pkiCommunicationID, string $contentType = self::contentTypes['communicationGetCommunicationBodyV1'][0])
    {
        $request = $this->communicationGetCommunicationBodyV1Request($pkiCommunicationID, $contentType);
    ...
    /**
     * Operation communicationGetCommunicationBodyV1Async
     *
     * Retrieve the communication body
     *
     * @param  int $pkiCommunicationID (required)
     ...
     */
    public function communicationGetCommunicationBodyV1Async($pkiCommunicationID, string $contentType = self::contentTypes['communicationGetCommunicationBodyV1'][0])
    {
        return $this->communicationGetCommunicationBodyV1AsyncWithHttpInfo($pkiCommunicationID, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation communicationGetCommunicationBodyV1AsyncWithHttpInfo
     *
     * Retrieve the communication body
     *
     * @param  int $pkiCommunicationID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function communicationGetCommunicationBodyV1AsyncWithHttpInfo($pkiCommunicationID, string $contentType = self::contentTypes['communicationGetCommunicationBodyV1'][0])
    {
        $returnType = '';
        $request = $this->communicationGetCommunicationBodyV1Request($pkiCommunicationID, $contentType);
    ...
    /**
     * Create request for operation 'communicationGetCommunicationBodyV1'
     *
     * @param  int $pkiCommunicationID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['communicationGetCommunicationBodyV1'] to see the possible values for this operation
     *
     ...
     */
    public function communicationGetCommunicationBodyV1Request($pkiCommunicationID, string $contentType = self::contentTypes['communicationGetCommunicationBodyV1'][0])
    {
        ...
        if ($pkiCommunicationID === null || (is_array($pkiCommunicationID) && count($pkiCommunicationID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pkiCommunicationID when calling communicationGetCommunicationBodyV1'
            );
        }
        if ($pkiCommunicationID < 0) {
	    //throw new \InvalidArgumentException('invalid value for "$pkiCommunicationID" when calling ObjectCommunicationApi.communicationGetCommunicationBodyV1, must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCommunicationID)?'null':'"'.$pkiCommunicationID.'"').' for "pkiCommunicationID" when calling ObjectCommunicationApi.communicationGetCommunicationBodyV1, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/1/object/communication/{pkiCommunicationID}/getCommunicationBody';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function communicationSendV1Request($communicationSendV1Request, string $contentType = self::contentTypes['communicationSendV1'][0])
    {
        ...
        if (isset($communicationSendV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($communicationSendV1Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
