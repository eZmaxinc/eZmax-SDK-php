...
class ObjectCommunicationApi
{
     ...
     */
    public function communicationGetObjectV2($pkiCommunicationID)
    {
        list($response) = $this->communicationGetObjectV2WithHttpInfo($pkiCommunicationID);
        return $response;
    }
     ...
     */
    public function communicationGetObjectV2WithHttpInfo($pkiCommunicationID)
    {
        $request = $this->communicationGetObjectV2Request($pkiCommunicationID);
     ...
     */
    public function communicationGetObjectV2Async($pkiCommunicationID)
    {
        return $this->communicationGetObjectV2AsyncWithHttpInfo($pkiCommunicationID)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function communicationGetObjectV2AsyncWithHttpInfo($pkiCommunicationID)
    {
        $returnType = '\eZmaxAPI\Model\CommunicationGetObjectV2Response';
        $request = $this->communicationGetObjectV2Request($pkiCommunicationID);
     ...
     */
    public function communicationGetObjectV2Request($pkiCommunicationID)
    {
