...
/**
 * ExternalEzmaxpartnerApi Class Doc Comment
 *
 * @category Class
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
...
class ExternalEzmaxpartnerApi
{
    ...
    public function ezmaxpartnerSubscribeV1Request($ezmaxpartnerSubscribeV1Request, string $contentType = self::contentTypes['ezmaxpartnerSubscribeV1'][0])
    {
        ...
        $resourcePath = '/1/external/ezmaxpartner/subscribe';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (isset($ezmaxpartnerSubscribeV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezmaxpartnerSubscribeV1Request), JSON_THROW_ON_ERROR);
