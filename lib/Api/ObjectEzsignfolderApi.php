    ...
    public function ezsignfolderBatchDownloadV1Request($pkiEzsignfolderID, $ezsignfolderBatchDownloadV1Request, string $contentType = self::contentTypes['ezsignfolderBatchDownloadV1'][0])
    {
        ...
        if (isset($ezsignfolderBatchDownloadV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignfolderBatchDownloadV1Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function ezsignfolderCreateObjectV1Request($ezsignfolderCreateObjectV1Request, string $contentType = self::contentTypes['ezsignfolderCreateObjectV1'][0])
    {
        ...
        if (isset($ezsignfolderCreateObjectV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignfolderCreateObjectV1Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function ezsignfolderCreateObjectV2Request($ezsignfolderCreateObjectV2Request, string $contentType = self::contentTypes['ezsignfolderCreateObjectV2'][0])
    {
        ...
        if (isset($ezsignfolderCreateObjectV2Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignfolderCreateObjectV2Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function ezsignfolderCreateObjectV3Request($ezsignfolderCreateObjectV3Request, string $contentType = self::contentTypes['ezsignfolderCreateObjectV3'][0])
    {
        ...
        if (isset($ezsignfolderCreateObjectV3Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignfolderCreateObjectV3Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function ezsignfolderDisposeEzsignfoldersV1Request($ezsignfolderDisposeEzsignfoldersV1Request, string $contentType = self::contentTypes['ezsignfolderDisposeEzsignfoldersV1'][0])
    {
        ...
        if (isset($ezsignfolderDisposeEzsignfoldersV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignfolderDisposeEzsignfoldersV1Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function ezsignfolderDuplicateV1Request($pkiEzsignfolderID, $ezsignfolderDuplicateV1Request, string $contentType = self::contentTypes['ezsignfolderDuplicateV1'][0])
    {
        ...
        if (isset($ezsignfolderDuplicateV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignfolderDuplicateV1Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function ezsignfolderEditObjectV3Request($pkiEzsignfolderID, $ezsignfolderEditObjectV3Request, string $contentType = self::contentTypes['ezsignfolderEditObjectV3'][0])
    {
        ...
        if (isset($ezsignfolderEditObjectV3Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignfolderEditObjectV3Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function ezsignfolderImportEzsignfoldersignerassociationsV1Request($pkiEzsignfolderID, $ezsignfolderImportEzsignfoldersignerassociationsV1Request, string $contentType = self::contentTypes['ezsignfolderImportEzsignfoldersignerassociationsV1'][0])
    {
        ...
        if (isset($ezsignfolderImportEzsignfoldersignerassociationsV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignfolderImportEzsignfoldersignerassociationsV1Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function ezsignfolderImportEzsigntemplatepackageV1Request($pkiEzsignfolderID, $ezsignfolderImportEzsigntemplatepackageV1Request, string $contentType = self::contentTypes['ezsignfolderImportEzsigntemplatepackageV1'][0])
    {
        ...
        if (isset($ezsignfolderImportEzsigntemplatepackageV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignfolderImportEzsigntemplatepackageV1Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function ezsignfolderImportEzsigntemplatepackageV2Request($pkiEzsignfolderID, $ezsignfolderImportEzsigntemplatepackageV2Request, string $contentType = self::contentTypes['ezsignfolderImportEzsigntemplatepackageV2'][0])
    {
        ...
        if (isset($ezsignfolderImportEzsigntemplatepackageV2Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignfolderImportEzsigntemplatepackageV2Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function ezsignfolderImportEzsigntemplatepackageV3Request($pkiEzsignfolderID, $ezsignfolderImportEzsigntemplatepackageV3Request, string $contentType = self::contentTypes['ezsignfolderImportEzsigntemplatepackageV3'][0])
    {
        ...
        if (isset($ezsignfolderImportEzsigntemplatepackageV3Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignfolderImportEzsigntemplatepackageV3Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function ezsignfolderReorderV2Request($pkiEzsignfolderID, $ezsignfolderReorderV2Request, string $contentType = self::contentTypes['ezsignfolderReorderV2'][0])
    {
        ...
        if (isset($ezsignfolderReorderV2Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignfolderReorderV2Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function ezsignfolderSendV1Request($pkiEzsignfolderID, $ezsignfolderSendV1Request, string $contentType = self::contentTypes['ezsignfolderSendV1'][0])
    {
        ...
        if (isset($ezsignfolderSendV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignfolderSendV1Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function ezsignfolderSendV3Request($pkiEzsignfolderID, $ezsignfolderSendV3Request, string $contentType = self::contentTypes['ezsignfolderSendV3'][0])
    {
        ...
        if (isset($ezsignfolderSendV3Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignfolderSendV3Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
