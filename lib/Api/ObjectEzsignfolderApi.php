...
/**
    ...
    public function ezsignfolderCreateObjectV3WithHttpInfo($ezsignfolderCreateObjectV3Request, string $contentType = self::contentTypes['ezsignfolderCreateObjectV3'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\eZmaxAPI\Model\EzsignfolderCreateObjectV3Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eZmaxAPI\Model\EzsignfolderCreateObjectV3Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eZmaxAPI\Model\EzsignfolderCreateObjectV3Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    public function ezsignfolderEditObjectV3WithHttpInfo($pkiEzsignfolderID, $ezsignfolderEditObjectV3Request, string $contentType = self::contentTypes['ezsignfolderEditObjectV3'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eZmaxAPI\Model\EzsignfolderEditObjectV3Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eZmaxAPI\Model\EzsignfolderEditObjectV3Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eZmaxAPI\Model\EzsignfolderEditObjectV3Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
    ...
    public function ezsignfolderEndPrematurelyV1WithHttpInfo($pkiEzsignfolderID, $body, string $contentType = self::contentTypes['ezsignfolderEndPrematurelyV1'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eZmaxAPI\Model\EzsignfolderEndPrematurelyV1Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eZmaxAPI\Model\EzsignfolderEndPrematurelyV1Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eZmaxAPI\Model\EzsignfolderEndPrematurelyV1Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
    ...
    public function ezsignfolderGetAttachmentCountV1WithHttpInfo($pkiEzsignfolderID, string $contentType = self::contentTypes['ezsignfolderGetAttachmentCountV1'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eZmaxAPI\Model\EzsignfolderGetAttachmentCountV1Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eZmaxAPI\Model\EzsignfolderGetAttachmentCountV1Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eZmaxAPI\Model\EzsignfolderGetAttachmentCountV1Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
    ...
    public function ezsignfolderGetAttachmentsV1WithHttpInfo($pkiEzsignfolderID, string $contentType = self::contentTypes['ezsignfolderGetAttachmentsV1'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eZmaxAPI\Model\EzsignfolderGetAttachmentsV1Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eZmaxAPI\Model\EzsignfolderGetAttachmentsV1Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eZmaxAPI\Model\EzsignfolderGetAttachmentsV1Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
    ...
    public function ezsignfolderGetObjectV3WithHttpInfo($pkiEzsignfolderID, string $contentType = self::contentTypes['ezsignfolderGetObjectV3'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eZmaxAPI\Model\EzsignfolderGetObjectV3Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eZmaxAPI\Model\EzsignfolderGetObjectV3Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eZmaxAPI\Model\EzsignfolderGetObjectV3Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
    ...
    public function ezsignfolderReorderV2WithHttpInfo($pkiEzsignfolderID, $ezsignfolderReorderV2Request, string $contentType = self::contentTypes['ezsignfolderReorderV2'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eZmaxAPI\Model\EzsignfolderReorderV2Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eZmaxAPI\Model\EzsignfolderReorderV2Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eZmaxAPI\Model\EzsignfolderReorderV2Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
