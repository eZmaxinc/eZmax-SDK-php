...
class ObjectBrandingApi
{
     ...
     */
    public function brandingGetAutocompleteV1($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        list($response) = $this->brandingGetAutocompleteV1WithHttpInfo($sSelector, $sQuery, $acceptLanguage);
        return $response;
    }
     ...
     */
    public function brandingGetAutocompleteV1WithHttpInfo($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        $request = $this->brandingGetAutocompleteV1Request($sSelector, $sQuery, $acceptLanguage);
     ...
     */
    public function brandingGetAutocompleteV1Async($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        return $this->brandingGetAutocompleteV1AsyncWithHttpInfo($sSelector, $sQuery, $acceptLanguage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function brandingGetAutocompleteV1AsyncWithHttpInfo($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        $returnType = '\eZmaxAPI\Model\CommonGetAutocompleteV1Response';
        $request = $this->brandingGetAutocompleteV1Request($sSelector, $sQuery, $acceptLanguage);
     ...
     */
    public function brandingGetAutocompleteV1Request($sSelector, $sQuery = null, $acceptLanguage = null)
    {
