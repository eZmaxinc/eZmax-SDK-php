...
/**
    ...
    /**
     * Operation usergroupDeleteObjectV1
     *
     * Delete an existing Usergroup
     *
     * @param  int $pkiUsergroupID The unique ID of the Usergroup (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['usergroupDeleteObjectV1'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \eZmaxAPI\Model\UsergroupDeleteObjectV1Response|\eZmaxAPI\Model\CommonResponseError
     */
    public function usergroupDeleteObjectV1($pkiUsergroupID, string $contentType = self::contentTypes['usergroupDeleteObjectV1'][0])
    {
        list($response) = $this->usergroupDeleteObjectV1WithHttpInfo($pkiUsergroupID, $contentType);
        return $response;
    }

    /**
     * Operation usergroupDeleteObjectV1WithHttpInfo
     *
     * Delete an existing Usergroup
     *
     * @param  int $pkiUsergroupID The unique ID of the Usergroup (required)
     ...
     * @throws \eZmaxAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \eZmaxAPI\Model\UsergroupDeleteObjectV1Response|\eZmaxAPI\Model\CommonResponseError, HTTP status code, HTTP response headers (array of strings)
     */
    public function usergroupDeleteObjectV1WithHttpInfo($pkiUsergroupID, string $contentType = self::contentTypes['usergroupDeleteObjectV1'][0])
    {
        $request = $this->usergroupDeleteObjectV1Request($pkiUsergroupID, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eZmaxAPI\Model\UsergroupDeleteObjectV1Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eZmaxAPI\Model\UsergroupDeleteObjectV1Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\eZmaxAPI\Model\UsergroupDeleteObjectV1Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\eZmaxAPI\Model\UsergroupDeleteObjectV1Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    /**
     * Operation usergroupDeleteObjectV1Async
     *
     * Delete an existing Usergroup
     *
     * @param  int $pkiUsergroupID The unique ID of the Usergroup (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usergroupDeleteObjectV1Async($pkiUsergroupID, string $contentType = self::contentTypes['usergroupDeleteObjectV1'][0])
    {
        return $this->usergroupDeleteObjectV1AsyncWithHttpInfo($pkiUsergroupID, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation usergroupDeleteObjectV1AsyncWithHttpInfo
     *
     * Delete an existing Usergroup
     *
     * @param  int $pkiUsergroupID The unique ID of the Usergroup (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usergroupDeleteObjectV1AsyncWithHttpInfo($pkiUsergroupID, string $contentType = self::contentTypes['usergroupDeleteObjectV1'][0])
    {
        $returnType = '\eZmaxAPI\Model\UsergroupDeleteObjectV1Response';
        $request = $this->usergroupDeleteObjectV1Request($pkiUsergroupID, $contentType);
    ...
    /**
     * Create request for operation 'usergroupDeleteObjectV1'
     *
     * @param  int $pkiUsergroupID The unique ID of the Usergroup (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['usergroupDeleteObjectV1'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function usergroupDeleteObjectV1Request($pkiUsergroupID, string $contentType = self::contentTypes['usergroupDeleteObjectV1'][0])
    {
     ...
     */
    public function usergroupGetListV1($eOrderBy = null, $iRowMax = null, $iRowOffset = null, $acceptLanguage = null, $sFilter = null, string $contentType = self::contentTypes['usergroupGetListV1'][0])
    {
     ...
     */
    public function usergroupGetListV1WithHttpInfo($eOrderBy = null, $iRowMax = null, $iRowOffset = null, $acceptLanguage = null, $sFilter = null, string $contentType = self::contentTypes['usergroupGetListV1'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usergroupGetListV1Async($eOrderBy = null, $iRowMax = null, $iRowOffset = null, $acceptLanguage = null, $sFilter = null, string $contentType = self::contentTypes['usergroupGetListV1'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usergroupGetListV1AsyncWithHttpInfo($eOrderBy = null, $iRowMax = null, $iRowOffset = null, $acceptLanguage = null, $sFilter = null, string $contentType = self::contentTypes['usergroupGetListV1'][0])
    {
        $returnType = '\eZmaxAPI\Model\UsergroupGetListV1Response';
        $request = $this->usergroupGetListV1Request($eOrderBy, $iRowMax, $iRowOffset, $acceptLanguage, $sFilter, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function usergroupGetListV1Request($eOrderBy = null, $iRowMax = null, $iRowOffset = null, $acceptLanguage = null, $sFilter = null, string $contentType = self::contentTypes['usergroupGetListV1'][0])
    {
    ...
    /**
     * Operation usergroupGetMembersV1
     *
     * Retrieve an existing Usergroup&#39;s members
     *
     * @param  int $pkiUsergroupID The unique ID of the Usergroup (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['usergroupGetMembersV1'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \eZmaxAPI\Model\UsergroupGetMembersV1Response|\eZmaxAPI\Model\CommonResponseError
     */
    public function usergroupGetMembersV1($pkiUsergroupID, string $contentType = self::contentTypes['usergroupGetMembersV1'][0])
    {
        list($response) = $this->usergroupGetMembersV1WithHttpInfo($pkiUsergroupID, $contentType);
        return $response;
    }

    /**
     * Operation usergroupGetMembersV1WithHttpInfo
     *
     * Retrieve an existing Usergroup&#39;s members
     *
     * @param  int $pkiUsergroupID The unique ID of the Usergroup (required)
     ...
     * @throws \eZmaxAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \eZmaxAPI\Model\UsergroupGetMembersV1Response|\eZmaxAPI\Model\CommonResponseError, HTTP status code, HTTP response headers (array of strings)
     */
    public function usergroupGetMembersV1WithHttpInfo($pkiUsergroupID, string $contentType = self::contentTypes['usergroupGetMembersV1'][0])
    {
        $request = $this->usergroupGetMembersV1Request($pkiUsergroupID, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eZmaxAPI\Model\UsergroupGetMembersV1Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eZmaxAPI\Model\UsergroupGetMembersV1Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\eZmaxAPI\Model\UsergroupGetMembersV1Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\eZmaxAPI\Model\UsergroupGetMembersV1Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    /**
     * Operation usergroupGetMembersV1Async
     *
     * Retrieve an existing Usergroup&#39;s members
     *
     * @param  int $pkiUsergroupID The unique ID of the Usergroup (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usergroupGetMembersV1Async($pkiUsergroupID, string $contentType = self::contentTypes['usergroupGetMembersV1'][0])
    {
        return $this->usergroupGetMembersV1AsyncWithHttpInfo($pkiUsergroupID, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation usergroupGetMembersV1AsyncWithHttpInfo
     *
     * Retrieve an existing Usergroup&#39;s members
     *
     * @param  int $pkiUsergroupID The unique ID of the Usergroup (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usergroupGetMembersV1AsyncWithHttpInfo($pkiUsergroupID, string $contentType = self::contentTypes['usergroupGetMembersV1'][0])
    {
        $returnType = '\eZmaxAPI\Model\UsergroupGetMembersV1Response';
        $request = $this->usergroupGetMembersV1Request($pkiUsergroupID, $contentType);
    ...
    /**
     * Create request for operation 'usergroupGetMembersV1'
     *
     * @param  int $pkiUsergroupID The unique ID of the Usergroup (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['usergroupGetMembersV1'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function usergroupGetMembersV1Request($pkiUsergroupID, string $contentType = self::contentTypes['usergroupGetMembersV1'][0])
    {
        ...
        $resourcePath = '/1/object/usergroup/{pkiUsergroupID}/getMembers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
