...
class ObjectUsergroupApi
{
     ...
     */
    public function usergroupGetAutocompleteV1($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        list($response) = $this->usergroupGetAutocompleteV1WithHttpInfo($sSelector, $sQuery, $acceptLanguage);
        return $response;
    }
     ...
     */
    public function usergroupGetAutocompleteV1WithHttpInfo($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        $request = $this->usergroupGetAutocompleteV1Request($sSelector, $sQuery, $acceptLanguage);
     ...
     */
    public function usergroupGetAutocompleteV1Async($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        return $this->usergroupGetAutocompleteV1AsyncWithHttpInfo($sSelector, $sQuery, $acceptLanguage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function usergroupGetAutocompleteV1AsyncWithHttpInfo($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        $returnType = '\eZmaxAPI\Model\CommonGetAutocompleteV1Response';
        $request = $this->usergroupGetAutocompleteV1Request($sSelector, $sQuery, $acceptLanguage);
     ...
     */
    public function usergroupGetAutocompleteV1Request($sSelector, $sQuery = null, $acceptLanguage = null)
    {
