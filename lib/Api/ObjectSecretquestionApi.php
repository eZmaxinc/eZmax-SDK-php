...
class ObjectSecretquestionApi
{
    ...
    /**
     * Operation secretquestionGetAutocompleteV1
     *
     ...
     * @deprecated
     */
    public function secretquestionGetAutocompleteV1($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        list($response) = $this->secretquestionGetAutocompleteV1WithHttpInfo($sSelector, $eFilterActive, $sQuery, $acceptLanguage);
        return $response;
    }

    /**
     * Operation secretquestionGetAutocompleteV1WithHttpInfo
     *
     * Retrieve Secretquestions and IDs
     *
     * @param  string $sSelector The type of Secretquestions to return (required)
     ...
     * @deprecated
     */
    public function secretquestionGetAutocompleteV1WithHttpInfo($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        $request = $this->secretquestionGetAutocompleteV1Request($sSelector, $eFilterActive, $sQuery, $acceptLanguage);
    ...
    /**
     * Operation secretquestionGetAutocompleteV1Async
     *
     * Retrieve Secretquestions and IDs
     *
     * @param  string $sSelector The type of Secretquestions to return (required)
     ...
     * @deprecated
     */
    public function secretquestionGetAutocompleteV1Async($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        return $this->secretquestionGetAutocompleteV1AsyncWithHttpInfo($sSelector, $eFilterActive, $sQuery, $acceptLanguage)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation secretquestionGetAutocompleteV1AsyncWithHttpInfo
     *
     * Retrieve Secretquestions and IDs
     *
     * @param  string $sSelector The type of Secretquestions to return (required)
     ...
     * @deprecated
     */
    public function secretquestionGetAutocompleteV1AsyncWithHttpInfo($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        $returnType = '\eZmaxAPI\Model\CommonGetAutocompleteV1Response';
        $request = $this->secretquestionGetAutocompleteV1Request($sSelector, $eFilterActive, $sQuery, $acceptLanguage);
    ...
    /**
     * Create request for operation 'secretquestionGetAutocompleteV1'
     *
     * @param  string $sSelector The type of Secretquestions to return (required)
     * @param  string $eFilterActive Specify which results we want to display. (optional, default to 'Active')
     * @param  string $sQuery Allow to filter the returned results (optional)
     ...
     * @deprecated
     */
    public function secretquestionGetAutocompleteV1Request($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {

        // verify the required parameter 'sSelector' is set
        if ($sSelector === null || (is_array($sSelector) && count($sSelector) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sSelector when calling secretquestionGetAutocompleteV1'
            );
        }
        ...
        $resourcePath = '/1/object/secretquestion/getAutocomplete/{sSelector}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function secretquestionGetAutocompleteV2($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        list($response) = $this->secretquestionGetAutocompleteV2WithHttpInfo($sSelector, $eFilterActive, $sQuery, $acceptLanguage);
        return $response;
    }
     ...
     */
    public function secretquestionGetAutocompleteV2WithHttpInfo($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        $request = $this->secretquestionGetAutocompleteV2Request($sSelector, $eFilterActive, $sQuery, $acceptLanguage);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function secretquestionGetAutocompleteV2Async($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        return $this->secretquestionGetAutocompleteV2AsyncWithHttpInfo($sSelector, $eFilterActive, $sQuery, $acceptLanguage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function secretquestionGetAutocompleteV2AsyncWithHttpInfo($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        $returnType = '\eZmaxAPI\Model\SecretquestionGetAutocompleteV2Response';
        $request = $this->secretquestionGetAutocompleteV2Request($sSelector, $eFilterActive, $sQuery, $acceptLanguage);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function secretquestionGetAutocompleteV2Request($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
