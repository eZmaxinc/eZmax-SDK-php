...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['secretquestionGetAutocompleteV1'] to see the possible values for this operation
     *
     ...
     * @deprecated
     */
    public function secretquestionGetAutocompleteV1($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null, string $contentType = self::contentTypes['secretquestionGetAutocompleteV1'][0])
    {
        list($response) = $this->secretquestionGetAutocompleteV1WithHttpInfo($sSelector, $eFilterActive, $sQuery, $acceptLanguage, $contentType);
        return $response;
    }
     ...
     * @deprecated
     */
    public function secretquestionGetAutocompleteV1WithHttpInfo($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null, string $contentType = self::contentTypes['secretquestionGetAutocompleteV1'][0])
    {
        $request = $this->secretquestionGetAutocompleteV1Request($sSelector, $eFilterActive, $sQuery, $acceptLanguage, $contentType);
     ...
     * @deprecated
     */
    public function secretquestionGetAutocompleteV1Async($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null, string $contentType = self::contentTypes['secretquestionGetAutocompleteV1'][0])
    {
        return $this->secretquestionGetAutocompleteV1AsyncWithHttpInfo($sSelector, $eFilterActive, $sQuery, $acceptLanguage, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function secretquestionGetAutocompleteV1AsyncWithHttpInfo($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null, string $contentType = self::contentTypes['secretquestionGetAutocompleteV1'][0])
    {
        $returnType = '\eZmaxAPI\Model\CommonGetAutocompleteV1Response';
        $request = $this->secretquestionGetAutocompleteV1Request($sSelector, $eFilterActive, $sQuery, $acceptLanguage, $contentType);
     ...
     * @deprecated
     */
    public function secretquestionGetAutocompleteV1Request($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null, string $contentType = self::contentTypes['secretquestionGetAutocompleteV1'][0])
    {
