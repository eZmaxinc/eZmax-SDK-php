...
class ObjectEzmaxinvoicingApi
{
    ...
    /**
     * Operation ezmaxinvoicingGetObjectV1
     *
    ...
    /**
     * Operation ezmaxinvoicingGetObjectV1WithHttpInfo
     *
     * Retrieve an existing Ezmaxinvoicing
     *
    ...
    public function ezmaxinvoicingGetObjectV1WithHttpInfo($pkiEzmaxinvoicingID)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eZmaxAPI\Model\EzmaxinvoicingGetObjectV1Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eZmaxAPI\Model\EzmaxinvoicingGetObjectV1Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\eZmaxAPI\Model\EzmaxinvoicingGetObjectV1Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
    ...
    /**
     * Operation ezmaxinvoicingGetObjectV1Async
     *
     * Retrieve an existing Ezmaxinvoicing
     *
     * @param  int $pkiEzmaxinvoicingID (required)
    ...
    /**
     * Operation ezmaxinvoicingGetObjectV1AsyncWithHttpInfo
     *
     * Retrieve an existing Ezmaxinvoicing
     *
     * @param  int $pkiEzmaxinvoicingID (required)
    ...
    public function ezmaxinvoicingGetObjectV1Request($pkiEzmaxinvoicingID)
    {
        ...
        if ($pkiEzmaxinvoicingID === null || (is_array($pkiEzmaxinvoicingID) && count($pkiEzmaxinvoicingID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pkiEzmaxinvoicingID when calling ezmaxinvoicingGetObjectV1'
            );
        }
