...
class ObjectFranchiseofficeApi
{
     ...
     */
    public function franchiseofficeGetAutocompleteV1($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        list($response) = $this->franchiseofficeGetAutocompleteV1WithHttpInfo($sSelector, $sQuery, $acceptLanguage);
        return $response;
    }
     ...
     */
    public function franchiseofficeGetAutocompleteV1WithHttpInfo($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        $request = $this->franchiseofficeGetAutocompleteV1Request($sSelector, $sQuery, $acceptLanguage);
     ...
     */
    public function franchiseofficeGetAutocompleteV1Async($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        return $this->franchiseofficeGetAutocompleteV1AsyncWithHttpInfo($sSelector, $sQuery, $acceptLanguage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function franchiseofficeGetAutocompleteV1AsyncWithHttpInfo($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        $returnType = '\eZmaxAPI\Model\CommonGetAutocompleteV1Response';
        $request = $this->franchiseofficeGetAutocompleteV1Request($sSelector, $sQuery, $acceptLanguage);
     ...
     */
    public function franchiseofficeGetAutocompleteV1Request($sSelector, $sQuery = null, $acceptLanguage = null)
    {
