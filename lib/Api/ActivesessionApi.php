...
class ActivesessionApi
{
     ...
     * @return \OpenAPI\Client\Model\Response1ObjectActivesessionGetCurrent
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Response1ObjectActivesessionGetCurrent, HTTP status code, HTTP response headers (array of strings)
     */
    public function call1ObjectActivesessionGetCurrentGetWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\Response1ObjectActivesessionGetCurrent' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\Response1ObjectActivesessionGetCurrent', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\Response1ObjectActivesessionGetCurrent';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\Response1ObjectActivesessionGetCurrent',
