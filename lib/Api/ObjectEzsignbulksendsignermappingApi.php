    ...
    public function ezsignbulksendsignermappingCreateObjectV1Request($ezsignbulksendsignermappingCreateObjectV1Request, string $contentType = self::contentTypes['ezsignbulksendsignermappingCreateObjectV1'][0])
    {
        ...
        if (isset($ezsignbulksendsignermappingCreateObjectV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignbulksendsignermappingCreateObjectV1Request), JSON_THROW_ON_ERROR);
    ...
    public function ezsignbulksendsignermappingCreateObjectV2Request($ezsignbulksendsignermappingCreateObjectV2Request, string $contentType = self::contentTypes['ezsignbulksendsignermappingCreateObjectV2'][0])
    {
        ...
        if (isset($ezsignbulksendsignermappingCreateObjectV2Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignbulksendsignermappingCreateObjectV2Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
