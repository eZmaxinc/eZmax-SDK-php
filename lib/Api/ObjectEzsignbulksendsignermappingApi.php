...
class ObjectEzsignbulksendsignermappingApi
{
    ...
    public function ezsignbulksendsignermappingCreateObjectV1Request($ezsignbulksendsignermappingCreateObjectV1Request, string $contentType = self::contentTypes['ezsignbulksendsignermappingCreateObjectV1'][0])
    {
        ...
        if (isset($ezsignbulksendsignermappingCreateObjectV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
				...
				$httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignbulksendsignermappingCreateObjectV1Request));
            } else {
    ...
    /**
     * Operation ezsignbulksendsignermappingCreateObjectV2
     *
     * Create a new Ezsignbulksendsignermapping
     *
     * @param  \eZmaxAPI\Model\EzsignbulksendsignermappingCreateObjectV2Request $ezsignbulksendsignermappingCreateObjectV2Request ezsignbulksendsignermappingCreateObjectV2Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsignbulksendsignermappingCreateObjectV2'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \eZmaxAPI\Model\EzsignbulksendsignermappingCreateObjectV2Response
     */
    public function ezsignbulksendsignermappingCreateObjectV2($ezsignbulksendsignermappingCreateObjectV2Request, string $contentType = self::contentTypes['ezsignbulksendsignermappingCreateObjectV2'][0])
    {
        list($response) = $this->ezsignbulksendsignermappingCreateObjectV2WithHttpInfo($ezsignbulksendsignermappingCreateObjectV2Request, $contentType);
        return $response;
    }

    /**
     * Operation ezsignbulksendsignermappingCreateObjectV2WithHttpInfo
     *
     * Create a new Ezsignbulksendsignermapping
     *
     * @param  \eZmaxAPI\Model\EzsignbulksendsignermappingCreateObjectV2Request $ezsignbulksendsignermappingCreateObjectV2Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsignbulksendsignermappingCreateObjectV2'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \eZmaxAPI\Model\EzsignbulksendsignermappingCreateObjectV2Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function ezsignbulksendsignermappingCreateObjectV2WithHttpInfo($ezsignbulksendsignermappingCreateObjectV2Request, string $contentType = self::contentTypes['ezsignbulksendsignermappingCreateObjectV2'][0])
    {
        $request = $this->ezsignbulksendsignermappingCreateObjectV2Request($ezsignbulksendsignermappingCreateObjectV2Request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\eZmaxAPI\Model\EzsignbulksendsignermappingCreateObjectV2Response',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation ezsignbulksendsignermappingCreateObjectV2Async
     *
     * Create a new Ezsignbulksendsignermapping
     *
     * @param  \eZmaxAPI\Model\EzsignbulksendsignermappingCreateObjectV2Request $ezsignbulksendsignermappingCreateObjectV2Request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsignbulksendsignermappingCreateObjectV2Async($ezsignbulksendsignermappingCreateObjectV2Request, string $contentType = self::contentTypes['ezsignbulksendsignermappingCreateObjectV2'][0])
    {
        return $this->ezsignbulksendsignermappingCreateObjectV2AsyncWithHttpInfo($ezsignbulksendsignermappingCreateObjectV2Request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ezsignbulksendsignermappingCreateObjectV2AsyncWithHttpInfo
     *
     * Create a new Ezsignbulksendsignermapping
     *
     * @param  \eZmaxAPI\Model\EzsignbulksendsignermappingCreateObjectV2Request $ezsignbulksendsignermappingCreateObjectV2Request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsignbulksendsignermappingCreateObjectV2AsyncWithHttpInfo($ezsignbulksendsignermappingCreateObjectV2Request, string $contentType = self::contentTypes['ezsignbulksendsignermappingCreateObjectV2'][0])
    {
        $returnType = '\eZmaxAPI\Model\EzsignbulksendsignermappingCreateObjectV2Response';
        $request = $this->ezsignbulksendsignermappingCreateObjectV2Request($ezsignbulksendsignermappingCreateObjectV2Request, $contentType);
    ...
    /**
     * Create request for operation 'ezsignbulksendsignermappingCreateObjectV2'
     *
     * @param  \eZmaxAPI\Model\EzsignbulksendsignermappingCreateObjectV2Request $ezsignbulksendsignermappingCreateObjectV2Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsignbulksendsignermappingCreateObjectV2'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ezsignbulksendsignermappingCreateObjectV2Request($ezsignbulksendsignermappingCreateObjectV2Request, string $contentType = self::contentTypes['ezsignbulksendsignermappingCreateObjectV2'][0])
    {

        // verify the required parameter 'ezsignbulksendsignermappingCreateObjectV2Request' is set
        if ($ezsignbulksendsignermappingCreateObjectV2Request === null || (is_array($ezsignbulksendsignermappingCreateObjectV2Request) && count($ezsignbulksendsignermappingCreateObjectV2Request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ezsignbulksendsignermappingCreateObjectV2Request when calling ezsignbulksendsignermappingCreateObjectV2'
            );
        }


        $resourcePath = '/2/object/ezsignbulksendsignermapping';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($ezsignbulksendsignermappingCreateObjectV2Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                //$httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($ezsignbulksendsignermappingCreateObjectV2Request));
				$httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignbulksendsignermappingCreateObjectV2Request));
            } else {
                $httpBody = $ezsignbulksendsignermappingCreateObjectV2Request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation ezsignbulksendsignermappingGetObjectV3
     *
     * Retrieve an existing Ezsignbulksendsignermapping
     *
     * @param  int $pkiEzsignbulksendsignermappingID pkiEzsignbulksendsignermappingID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsignbulksendsignermappingGetObjectV3'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \eZmaxAPI\Model\EzsignbulksendsignermappingGetObjectV3Response|\eZmaxAPI\Model\CommonResponseError
     */
    public function ezsignbulksendsignermappingGetObjectV3($pkiEzsignbulksendsignermappingID, string $contentType = self::contentTypes['ezsignbulksendsignermappingGetObjectV3'][0])
    {
        list($response) = $this->ezsignbulksendsignermappingGetObjectV3WithHttpInfo($pkiEzsignbulksendsignermappingID, $contentType);
        return $response;
    }

    /**
     * Operation ezsignbulksendsignermappingGetObjectV3WithHttpInfo
     *
     * Retrieve an existing Ezsignbulksendsignermapping
     *
     * @param  int $pkiEzsignbulksendsignermappingID (required)
     ...
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \eZmaxAPI\Model\EzsignbulksendsignermappingGetObjectV3Response|\eZmaxAPI\Model\CommonResponseError, HTTP status code, HTTP response headers (array of strings)
     */
    public function ezsignbulksendsignermappingGetObjectV3WithHttpInfo($pkiEzsignbulksendsignermappingID, string $contentType = self::contentTypes['ezsignbulksendsignermappingGetObjectV3'][0])
    {
        $request = $this->ezsignbulksendsignermappingGetObjectV3Request($pkiEzsignbulksendsignermappingID, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\eZmaxAPI\Model\EzsignbulksendsignermappingGetObjectV3Response',
                        $request,
                        $response,
                    );
                case 404:
    ...
    /**
     * Operation ezsignbulksendsignermappingGetObjectV3Async
     *
     * Retrieve an existing Ezsignbulksendsignermapping
     *
     * @param  int $pkiEzsignbulksendsignermappingID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsignbulksendsignermappingGetObjectV3Async($pkiEzsignbulksendsignermappingID, string $contentType = self::contentTypes['ezsignbulksendsignermappingGetObjectV3'][0])
    {
        return $this->ezsignbulksendsignermappingGetObjectV3AsyncWithHttpInfo($pkiEzsignbulksendsignermappingID, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ezsignbulksendsignermappingGetObjectV3AsyncWithHttpInfo
     *
     * Retrieve an existing Ezsignbulksendsignermapping
     *
     * @param  int $pkiEzsignbulksendsignermappingID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsignbulksendsignermappingGetObjectV3AsyncWithHttpInfo($pkiEzsignbulksendsignermappingID, string $contentType = self::contentTypes['ezsignbulksendsignermappingGetObjectV3'][0])
    {
        $returnType = '\eZmaxAPI\Model\EzsignbulksendsignermappingGetObjectV3Response';
        $request = $this->ezsignbulksendsignermappingGetObjectV3Request($pkiEzsignbulksendsignermappingID, $contentType);
    ...
    /**
     * Create request for operation 'ezsignbulksendsignermappingGetObjectV3'
     *
     * @param  int $pkiEzsignbulksendsignermappingID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsignbulksendsignermappingGetObjectV3'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ezsignbulksendsignermappingGetObjectV3Request($pkiEzsignbulksendsignermappingID, string $contentType = self::contentTypes['ezsignbulksendsignermappingGetObjectV3'][0])
    {

        // verify the required parameter 'pkiEzsignbulksendsignermappingID' is set
        if ($pkiEzsignbulksendsignermappingID === null || (is_array($pkiEzsignbulksendsignermappingID) && count($pkiEzsignbulksendsignermappingID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pkiEzsignbulksendsignermappingID when calling ezsignbulksendsignermappingGetObjectV3'
            );
        }
        if ($pkiEzsignbulksendsignermappingID < 0) {
	    //throw new \InvalidArgumentException('invalid value for "$pkiEzsignbulksendsignermappingID" when calling ObjectEzsignbulksendsignermappingApi.ezsignbulksendsignermappingGetObjectV3, must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignbulksendsignermappingID)?'null':'"'.$pkiEzsignbulksendsignermappingID.'"').' for "pkiEzsignbulksendsignermappingID" when calling ObjectEzsignbulksendsignermappingApi.ezsignbulksendsignermappingGetObjectV3, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/3/object/ezsignbulksendsignermapping/{pkiEzsignbulksendsignermappingID}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
