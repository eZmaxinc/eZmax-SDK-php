...
class ObjectFranchisebrokerApi
{
     ...
     */
    public function franchisebrokerGetAutocompleteV1($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        list($response) = $this->franchisebrokerGetAutocompleteV1WithHttpInfo($sSelector, $sQuery, $acceptLanguage);
        return $response;
    }
     ...
     */
    public function franchisebrokerGetAutocompleteV1WithHttpInfo($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        $request = $this->franchisebrokerGetAutocompleteV1Request($sSelector, $sQuery, $acceptLanguage);
     ...
     */
    public function franchisebrokerGetAutocompleteV1Async($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        return $this->franchisebrokerGetAutocompleteV1AsyncWithHttpInfo($sSelector, $sQuery, $acceptLanguage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function franchisebrokerGetAutocompleteV1AsyncWithHttpInfo($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        $returnType = '\eZmaxAPI\Model\CommonGetAutocompleteV1Response';
        $request = $this->franchisebrokerGetAutocompleteV1Request($sSelector, $sQuery, $acceptLanguage);
     ...
     */
    public function franchisebrokerGetAutocompleteV1Request($sSelector, $sQuery = null, $acceptLanguage = null)
    {
