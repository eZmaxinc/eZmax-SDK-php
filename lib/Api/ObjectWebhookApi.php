...
class ObjectWebhookApi
{
     ...
     * @throws \eZmaxAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \eZmaxAPI\Model\WebhookGetHistoryV1Response|\eZmaxAPI\Model\CommonResponseError
     */
     ...
     * @throws \eZmaxAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \eZmaxAPI\Model\WebhookGetHistoryV1Response|\eZmaxAPI\Model\CommonResponseError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     */
    public function webhookTestUrlV1($pkiWebhookID)
    {
        list($response) = $this->webhookTestUrlV1WithHttpInfo($pkiWebhookID);
        return $response;
    }

    /**
     * Operation webhookTestUrlV1WithHttpInfo
     *
     * Test the Webhook by calling the Url
     *
     * @param  int $pkiWebhookID (required)
     ...
     */
    public function webhookTestUrlV1WithHttpInfo($pkiWebhookID)
    {
        $request = $this->webhookTestUrlV1Request($pkiWebhookID);
    ...
    /**
     * Operation webhookTestUrlV1Async
     *
     * Test the Webhook by calling the Url
     *
     * @param  int $pkiWebhookID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookTestUrlV1Async($pkiWebhookID)
    {
        return $this->webhookTestUrlV1AsyncWithHttpInfo($pkiWebhookID)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhookTestUrlV1AsyncWithHttpInfo
     *
     * Test the Webhook by calling the Url
     *
     * @param  int $pkiWebhookID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookTestUrlV1AsyncWithHttpInfo($pkiWebhookID)
    {
        $returnType = '\eZmaxAPI\Model\WebhookTestV1Response';
        $request = $this->webhookTestUrlV1Request($pkiWebhookID);
    ...
    /**
     * Create request for operation 'webhookTestUrlV1'
     *
     * @param  int $pkiWebhookID (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhookTestUrlV1Request($pkiWebhookID)
    {
        // verify the required parameter 'pkiWebhookID' is set
        if ($pkiWebhookID === null || (is_array($pkiWebhookID) && count($pkiWebhookID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pkiWebhookID when calling webhookTestUrlV1'
            );
        }
