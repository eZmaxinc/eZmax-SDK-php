...
/**
    ...
    public function webhookGetListV1Request($eOrderBy = null, $iRowMax = null, $iRowOffset = 0, $acceptLanguage = null, $sFilter = null, string $contentType = self::contentTypes['webhookGetListV1'][0])
    {
	    ...
	    //throw new \InvalidArgumentException('invalid value for "$iRowMax" when calling ObjectWebhookApi.webhookGetListV1, must be smaller than or equal to 10000.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iRowMax)?'null':'"'.$iRowMax.'"').' for "iRowMax" when calling ObjectWebhookApi.webhookGetListV1, must be smaller than or equal to 10000.');
        }
	    ...
	    //throw new \InvalidArgumentException('invalid value for "$iRowMax" when calling ObjectWebhookApi.webhookGetListV1, must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iRowMax)?'null':'"'.$iRowMax.'"').' for "iRowMax" when calling ObjectWebhookApi.webhookGetListV1, must be bigger than or equal to 1.');
        }
	    ...
	    //throw new \InvalidArgumentException('invalid value for "$iRowOffset" when calling ObjectWebhookApi.webhookGetListV1, must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iRowOffset)?'null':'"'.$iRowOffset.'"').' for "iRowOffset" when calling ObjectWebhookApi.webhookGetListV1, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation webhookSendWebhookV1
     *
     * Emit a Webhook event
     *
     * @param  \eZmaxAPI\Model\WebhookSendWebhookV1Request $webhookSendWebhookV1Request webhookSendWebhookV1Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookSendWebhookV1'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \eZmaxAPI\Model\WebhookSendWebhookV1Response|\eZmaxAPI\Model\CommonResponseError
     */
    public function webhookSendWebhookV1($webhookSendWebhookV1Request, string $contentType = self::contentTypes['webhookSendWebhookV1'][0])
    {
        list($response) = $this->webhookSendWebhookV1WithHttpInfo($webhookSendWebhookV1Request, $contentType);
        return $response;
    }

    /**
     * Operation webhookSendWebhookV1WithHttpInfo
     *
     * Emit a Webhook event
     *
     * @param  \eZmaxAPI\Model\WebhookSendWebhookV1Request $webhookSendWebhookV1Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookSendWebhookV1'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \eZmaxAPI\Model\WebhookSendWebhookV1Response|\eZmaxAPI\Model\CommonResponseError, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhookSendWebhookV1WithHttpInfo($webhookSendWebhookV1Request, string $contentType = self::contentTypes['webhookSendWebhookV1'][0])
    {
        $request = $this->webhookSendWebhookV1Request($webhookSendWebhookV1Request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eZmaxAPI\Model\WebhookSendWebhookV1Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eZmaxAPI\Model\WebhookSendWebhookV1Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eZmaxAPI\Model\WebhookSendWebhookV1Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\eZmaxAPI\Model\WebhookSendWebhookV1Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    /**
     * Operation webhookSendWebhookV1Async
     *
     * Emit a Webhook event
     *
     * @param  \eZmaxAPI\Model\WebhookSendWebhookV1Request $webhookSendWebhookV1Request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookSendWebhookV1Async($webhookSendWebhookV1Request, string $contentType = self::contentTypes['webhookSendWebhookV1'][0])
    {
        return $this->webhookSendWebhookV1AsyncWithHttpInfo($webhookSendWebhookV1Request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhookSendWebhookV1AsyncWithHttpInfo
     *
     * Emit a Webhook event
     *
     * @param  \eZmaxAPI\Model\WebhookSendWebhookV1Request $webhookSendWebhookV1Request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhookSendWebhookV1AsyncWithHttpInfo($webhookSendWebhookV1Request, string $contentType = self::contentTypes['webhookSendWebhookV1'][0])
    {
        $returnType = '\eZmaxAPI\Model\WebhookSendWebhookV1Response';
        $request = $this->webhookSendWebhookV1Request($webhookSendWebhookV1Request, $contentType);
    ...
    /**
     * Create request for operation 'webhookSendWebhookV1'
     *
     * @param  \eZmaxAPI\Model\WebhookSendWebhookV1Request $webhookSendWebhookV1Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhookSendWebhookV1'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhookSendWebhookV1Request($webhookSendWebhookV1Request, string $contentType = self::contentTypes['webhookSendWebhookV1'][0])
    {

        // verify the required parameter 'webhookSendWebhookV1Request' is set
        if ($webhookSendWebhookV1Request === null || (is_array($webhookSendWebhookV1Request) && count($webhookSendWebhookV1Request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webhookSendWebhookV1Request when calling webhookSendWebhookV1'
            );
        }


        $resourcePath = '/1/object/webhook/sendWebhook';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
