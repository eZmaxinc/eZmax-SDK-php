    ...
    public function webhookCreateObjectV2Request($webhookCreateObjectV2Request, string $contentType = self::contentTypes['webhookCreateObjectV2'][0])
    {
        ...
        if (isset($webhookCreateObjectV2Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($webhookCreateObjectV2Request), JSON_THROW_ON_ERROR);
    ...
    public function webhookEditObjectV1Request($pkiWebhookID, $webhookEditObjectV1Request, string $contentType = self::contentTypes['webhookEditObjectV1'][0])
    {
        ...
        if (isset($webhookEditObjectV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($webhookEditObjectV1Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function webhookRegenerateApikeyV1Request($pkiWebhookID, $webhookRegenerateApikeyV1Request, string $contentType = self::contentTypes['webhookRegenerateApikeyV1'][0])
    {
        ...
        if (isset($webhookRegenerateApikeyV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($webhookRegenerateApikeyV1Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function webhookSendWebhookV1Request($webhookSendWebhookV1Request, string $contentType = self::contentTypes['webhookSendWebhookV1'][0])
    {
        ...
        if (isset($webhookSendWebhookV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($webhookSendWebhookV1Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
