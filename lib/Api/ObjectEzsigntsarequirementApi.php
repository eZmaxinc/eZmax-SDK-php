...
/**
 * ObjectEzsigntsarequirementApi Class Doc Comment
 *
 * @category Class
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
...
/**
    ...
    /**
     * Operation ezsigntsarequirementGetAutocompleteV2
     *
     * Retrieve Ezsigntsarequirements and IDs
     *
     * @param  string $sSelector The type of Ezsigntsarequirements to return (required)
    ...
    /**
     * Operation ezsigntsarequirementGetAutocompleteV2WithHttpInfo
     *
     * Retrieve Ezsigntsarequirements and IDs
     *
     * @param  string $sSelector The type of Ezsigntsarequirements to return (required)
    ...
    public function ezsigntsarequirementGetAutocompleteV2WithHttpInfo($sSelector, $fkiEzsignfoldertypeID = null, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null, string $contentType = self::contentTypes['ezsigntsarequirementGetAutocompleteV2'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eZmaxAPI\Model\EzsigntsarequirementGetAutocompleteV2Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eZmaxAPI\Model\EzsigntsarequirementGetAutocompleteV2Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eZmaxAPI\Model\EzsigntsarequirementGetAutocompleteV2Response', []),
    ...
    /**
     * Operation ezsigntsarequirementGetAutocompleteV2Async
     *
     * Retrieve Ezsigntsarequirements and IDs
     *
     * @param  string $sSelector The type of Ezsigntsarequirements to return (required)
    ...
    /**
     * Operation ezsigntsarequirementGetAutocompleteV2AsyncWithHttpInfo
     *
     * Retrieve Ezsigntsarequirements and IDs
     *
     * @param  string $sSelector The type of Ezsigntsarequirements to return (required)
    ...
    /**
     * Create request for operation 'ezsigntsarequirementGetAutocompleteV2'
     *
     * @param  string $sSelector The type of Ezsigntsarequirements to return (required)
     * @param  int|null $fkiEzsignfoldertypeID (optional)
     * @param  string|null $eFilterActive Specify which results we want to display. (optional, default to 'Active')
    ...
    public function ezsigntsarequirementGetAutocompleteV2Request($sSelector, $fkiEzsignfoldertypeID = null, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null, string $contentType = self::contentTypes['ezsigntsarequirementGetAutocompleteV2'][0])
    {
        ...
        if ($sSelector === null || (is_array($sSelector) && count($sSelector) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sSelector when calling ezsigntsarequirementGetAutocompleteV2'
            );
        }

        if ($fkiEzsignfoldertypeID !== null && $fkiEzsignfoldertypeID > 65535) {
	    //throw new \InvalidArgumentException('invalid value for "$fkiEzsignfoldertypeID" when calling ObjectEzsigntsarequirementApi.ezsigntsarequirementGetAutocompleteV2, must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for "fkiEzsignfoldertypeID" when calling ObjectEzsigntsarequirementApi.ezsigntsarequirementGetAutocompleteV2, must be smaller than or equal to 65535.');
        }
	    ...
	    //throw new \InvalidArgumentException('invalid value for "$fkiEzsignfoldertypeID" when calling ObjectEzsigntsarequirementApi.ezsigntsarequirementGetAutocompleteV2, must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for "fkiEzsignfoldertypeID" when calling ObjectEzsigntsarequirementApi.ezsigntsarequirementGetAutocompleteV2, must be bigger than or equal to 0.');
        }
        ...
        $resourcePath = '/2/object/ezsigntsarequirement/getAutocomplete/{sSelector}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
