...
class ObjectEzsigntsarequirementApi
{
    ...
    /**
     * Operation ezsigntsarequirementGetAutocompleteV1
     *
     ...
     */
    public function ezsigntsarequirementGetAutocompleteV1($sSelector, $fkiEzsignfoldertypeID = null, $sQuery = null, $acceptLanguage = null)
    {
        list($response) = $this->ezsigntsarequirementGetAutocompleteV1WithHttpInfo($sSelector, $fkiEzsignfoldertypeID, $sQuery, $acceptLanguage);
        return $response;
    }

    /**
     * Operation ezsigntsarequirementGetAutocompleteV1WithHttpInfo
     *
     * Retrieve Ezsigntsarequirements and IDs
     *
     * @param  string $sSelector The type of Ezsigntsarequirements to return (required)
     ...
     */
    public function ezsigntsarequirementGetAutocompleteV1WithHttpInfo($sSelector, $fkiEzsignfoldertypeID = null, $sQuery = null, $acceptLanguage = null)
    {
        $request = $this->ezsigntsarequirementGetAutocompleteV1Request($sSelector, $fkiEzsignfoldertypeID, $sQuery, $acceptLanguage);
    ...
    /**
     * Operation ezsigntsarequirementGetAutocompleteV1Async
     *
     * Retrieve Ezsigntsarequirements and IDs
     *
     * @param  string $sSelector The type of Ezsigntsarequirements to return (required)
     ...
     */
    public function ezsigntsarequirementGetAutocompleteV1Async($sSelector, $fkiEzsignfoldertypeID = null, $sQuery = null, $acceptLanguage = null)
    {
        return $this->ezsigntsarequirementGetAutocompleteV1AsyncWithHttpInfo($sSelector, $fkiEzsignfoldertypeID, $sQuery, $acceptLanguage)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ezsigntsarequirementGetAutocompleteV1AsyncWithHttpInfo
     *
     * Retrieve Ezsigntsarequirements and IDs
     *
     * @param  string $sSelector The type of Ezsigntsarequirements to return (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsigntsarequirementGetAutocompleteV1AsyncWithHttpInfo($sSelector, $fkiEzsignfoldertypeID = null, $sQuery = null, $acceptLanguage = null)
    {
        $returnType = '\eZmaxAPI\Model\CommonGetAutocompleteDisabledV1Response';
        $request = $this->ezsigntsarequirementGetAutocompleteV1Request($sSelector, $fkiEzsignfoldertypeID, $sQuery, $acceptLanguage);
    ...
    /**
     * Create request for operation 'ezsigntsarequirementGetAutocompleteV1'
     *
     * @param  string $sSelector The type of Ezsigntsarequirements to return (required)
     * @param  int $fkiEzsignfoldertypeID (optional)
     * @param  string $sQuery Allow to filter the returned results (optional)
     ...
     */
    public function ezsigntsarequirementGetAutocompleteV1Request($sSelector, $fkiEzsignfoldertypeID = null, $sQuery = null, $acceptLanguage = null)
    {
        // verify the required parameter 'sSelector' is set
        if ($sSelector === null || (is_array($sSelector) && count($sSelector) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sSelector when calling ezsigntsarequirementGetAutocompleteV1'
            );
        }
        ...
        $resourcePath = '/1/object/ezsigntsarequirement/getAutocomplete/{sSelector}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
