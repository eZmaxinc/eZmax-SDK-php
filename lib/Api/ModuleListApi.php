...
class ModuleListApi
{
    ...
    /**
     * Operation listListpresentationV1
     *
     ...
     */
    public function listListpresentationV1($sListName, $listSaveListpresentationV1Request)
    {
        list($response) = $this->listListpresentationV1WithHttpInfo($sListName, $listSaveListpresentationV1Request);
        return $response;
    }

    /**
     * Operation listListpresentationV1WithHttpInfo
     *
     * Save all Listpresentation for a specific list
     *
     * @param  string $sListName The list Name (required)
     ...
     */
    public function listListpresentationV1WithHttpInfo($sListName, $listSaveListpresentationV1Request)
    {
        $request = $this->listListpresentationV1Request($sListName, $listSaveListpresentationV1Request);
    ...
    /**
     * Operation listListpresentationV1Async
     *
     * Save all Listpresentation for a specific list
     *
     * @param  string $sListName The list Name (required)
     ...
     */
    public function listListpresentationV1Async($sListName, $listSaveListpresentationV1Request)
    {
        return $this->listListpresentationV1AsyncWithHttpInfo($sListName, $listSaveListpresentationV1Request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listListpresentationV1AsyncWithHttpInfo
     *
     * Save all Listpresentation for a specific list
     *
     * @param  string $sListName The list Name (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listListpresentationV1AsyncWithHttpInfo($sListName, $listSaveListpresentationV1Request)
    {
        $returnType = '\eZmaxAPI\Model\ListSaveListpresentationV1Response';
        $request = $this->listListpresentationV1Request($sListName, $listSaveListpresentationV1Request);
    ...
    /**
     * Create request for operation 'listListpresentationV1'
     *
     * @param  string $sListName The list Name (required)
     * @param  \eZmaxAPI\Model\ListSaveListpresentationV1Request $listSaveListpresentationV1Request (required)
     *
     ...
     */
    public function listListpresentationV1Request($sListName, $listSaveListpresentationV1Request)
    {
        // verify the required parameter 'sListName' is set
        if ($sListName === null || (is_array($sListName) && count($sListName) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sListName when calling listListpresentationV1'
            );
        }
        ...
        if ($listSaveListpresentationV1Request === null || (is_array($listSaveListpresentationV1Request) && count($listSaveListpresentationV1Request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $listSaveListpresentationV1Request when calling listListpresentationV1'
            );
        }
