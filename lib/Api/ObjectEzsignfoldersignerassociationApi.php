...
class ObjectEzsignfoldersignerassociationApi
{
    ...
    /**
     * Operation ezsignfoldersignerassociationGetChildrenV1
     *
     ...
     * @return void
     */
    public function ezsignfoldersignerassociationGetChildrenV1($pkiEzsignfoldersignerassociationID)
    {
        $this->ezsignfoldersignerassociationGetChildrenV1WithHttpInfo($pkiEzsignfoldersignerassociationID);
    }

    /**
     * Operation ezsignfoldersignerassociationGetChildrenV1WithHttpInfo
     *
     * Retrieve an existing Ezsignfoldersignerassociation's children IDs
     *
     * @param  int $pkiEzsignfoldersignerassociationID The unique ID of the Ezsignfoldersignerassociation (required)
     ...
     */
    public function ezsignfoldersignerassociationGetChildrenV1WithHttpInfo($pkiEzsignfoldersignerassociationID)
    {
        $request = $this->ezsignfoldersignerassociationGetChildrenV1Request($pkiEzsignfoldersignerassociationID);
    ...
    /**
     * Operation ezsignfoldersignerassociationGetChildrenV1Async
     *
     * Retrieve an existing Ezsignfoldersignerassociation's children IDs
     *
     * @param  int $pkiEzsignfoldersignerassociationID The unique ID of the Ezsignfoldersignerassociation (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsignfoldersignerassociationGetChildrenV1Async($pkiEzsignfoldersignerassociationID)
    {
        return $this->ezsignfoldersignerassociationGetChildrenV1AsyncWithHttpInfo($pkiEzsignfoldersignerassociationID)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ezsignfoldersignerassociationGetChildrenV1AsyncWithHttpInfo
     *
     * Retrieve an existing Ezsignfoldersignerassociation's children IDs
     *
     * @param  int $pkiEzsignfoldersignerassociationID The unique ID of the Ezsignfoldersignerassociation (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsignfoldersignerassociationGetChildrenV1AsyncWithHttpInfo($pkiEzsignfoldersignerassociationID)
    {
        $returnType = '';
        $request = $this->ezsignfoldersignerassociationGetChildrenV1Request($pkiEzsignfoldersignerassociationID);
    ...
    /**
     * Create request for operation 'ezsignfoldersignerassociationGetChildrenV1'
     *
     * @param  int $pkiEzsignfoldersignerassociationID The unique ID of the Ezsignfoldersignerassociation (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ezsignfoldersignerassociationGetChildrenV1Request($pkiEzsignfoldersignerassociationID)
    {
        // verify the required parameter 'pkiEzsignfoldersignerassociationID' is set
        if ($pkiEzsignfoldersignerassociationID === null || (is_array($pkiEzsignfoldersignerassociationID) && count($pkiEzsignfoldersignerassociationID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pkiEzsignfoldersignerassociationID when calling ezsignfoldersignerassociationGetChildrenV1'
            );
        }
