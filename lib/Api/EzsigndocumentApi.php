...
class EzsigndocumentApi
{
    ...
    protected function ezsigndocumentCreateObjectV1Request($ezsigndocumentCreateObjectV1Request)
    {
        ...
        if (isset($ezsigndocumentCreateObjectV1Request)) {
            $_tempBody = $ezsigndocumentCreateObjectV1Request;
        }
    ...
    protected function ezsigndocumentEditObjectV1Request($pkiEzsigndocumentID, $ezsigndocumentEditObjectV1Request)
    {
        ...
        if (isset($ezsigndocumentEditObjectV1Request)) {
            $_tempBody = $ezsigndocumentEditObjectV1Request;
        }
     ...
     * @throws \eZmaxAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \eZmaxAPI\Model\CommonResponseError|\eZmaxAPI\Model\EzsigndocumentGetDownloadUrlV1Response|\eZmaxAPI\Model\CommonResponseError
     */
     ...
     * @throws \eZmaxAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \eZmaxAPI\Model\CommonResponseError|\eZmaxAPI\Model\EzsigndocumentGetDownloadUrlV1Response|\eZmaxAPI\Model\CommonResponseError, HTTP status code, HTTP response headers (array of strings)
     */
