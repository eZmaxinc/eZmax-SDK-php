...
/**
    ...
    public function notificationtestGetElementsV1WithHttpInfo($pkiNotificationtestID, string $contentType = self::contentTypes['notificationtestGetElementsV1'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eZmaxAPI\Model\NotificationtestGetElementsV1Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\eZmaxAPI\Model\NotificationtestGetElementsV1Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eZmaxAPI\Model\NotificationtestGetElementsV1Response', []),
