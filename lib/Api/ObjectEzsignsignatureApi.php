...
class ObjectEzsignsignatureApi
{
    ...
    public function ezsignsignatureCreateObjectV1Request($ezsignsignatureCreateObjectV1Request, string $contentType = self::contentTypes['ezsignsignatureCreateObjectV1'][0])
    {
        ...
        if (isset($ezsignsignatureCreateObjectV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
				...
				$httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignsignatureCreateObjectV1Request));
            } else {
    ...
    public function ezsignsignatureCreateObjectV2Request($ezsignsignatureCreateObjectV2Request, string $contentType = self::contentTypes['ezsignsignatureCreateObjectV2'][0])
    {
        ...
        if (isset($ezsignsignatureCreateObjectV2Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
				...
				$httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignsignatureCreateObjectV2Request));
            } else {
    ...
    public function ezsignsignatureCreateObjectV3Request($ezsignsignatureCreateObjectV3Request, string $contentType = self::contentTypes['ezsignsignatureCreateObjectV3'][0])
    {
        ...
        if (isset($ezsignsignatureCreateObjectV3Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
				...
				$httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignsignatureCreateObjectV3Request));
            } else {
    ...
    /**
     * Operation ezsignsignatureCreateObjectV4
     *
     * Create a new Ezsignsignature
     *
     * @param  \eZmaxAPI\Model\EzsignsignatureCreateObjectV4Request $ezsignsignatureCreateObjectV4Request ezsignsignatureCreateObjectV4Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsignsignatureCreateObjectV4'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \eZmaxAPI\Model\EzsignsignatureCreateObjectV4Response
     */
    public function ezsignsignatureCreateObjectV4($ezsignsignatureCreateObjectV4Request, string $contentType = self::contentTypes['ezsignsignatureCreateObjectV4'][0])
    {
        list($response) = $this->ezsignsignatureCreateObjectV4WithHttpInfo($ezsignsignatureCreateObjectV4Request, $contentType);
        return $response;
    }

    /**
     * Operation ezsignsignatureCreateObjectV4WithHttpInfo
     *
     * Create a new Ezsignsignature
     *
     * @param  \eZmaxAPI\Model\EzsignsignatureCreateObjectV4Request $ezsignsignatureCreateObjectV4Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsignsignatureCreateObjectV4'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \eZmaxAPI\Model\EzsignsignatureCreateObjectV4Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function ezsignsignatureCreateObjectV4WithHttpInfo($ezsignsignatureCreateObjectV4Request, string $contentType = self::contentTypes['ezsignsignatureCreateObjectV4'][0])
    {
        $request = $this->ezsignsignatureCreateObjectV4Request($ezsignsignatureCreateObjectV4Request, $contentType);
    ...
    /**
     * Operation ezsignsignatureCreateObjectV4Async
     *
     * Create a new Ezsignsignature
     *
     * @param  \eZmaxAPI\Model\EzsignsignatureCreateObjectV4Request $ezsignsignatureCreateObjectV4Request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsignsignatureCreateObjectV4Async($ezsignsignatureCreateObjectV4Request, string $contentType = self::contentTypes['ezsignsignatureCreateObjectV4'][0])
    {
        return $this->ezsignsignatureCreateObjectV4AsyncWithHttpInfo($ezsignsignatureCreateObjectV4Request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ezsignsignatureCreateObjectV4AsyncWithHttpInfo
     *
     * Create a new Ezsignsignature
     *
     * @param  \eZmaxAPI\Model\EzsignsignatureCreateObjectV4Request $ezsignsignatureCreateObjectV4Request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsignsignatureCreateObjectV4AsyncWithHttpInfo($ezsignsignatureCreateObjectV4Request, string $contentType = self::contentTypes['ezsignsignatureCreateObjectV4'][0])
    {
        $returnType = '\eZmaxAPI\Model\EzsignsignatureCreateObjectV4Response';
        $request = $this->ezsignsignatureCreateObjectV4Request($ezsignsignatureCreateObjectV4Request, $contentType);
    ...
    /**
     * Create request for operation 'ezsignsignatureCreateObjectV4'
     *
     * @param  \eZmaxAPI\Model\EzsignsignatureCreateObjectV4Request $ezsignsignatureCreateObjectV4Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsignsignatureCreateObjectV4'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ezsignsignatureCreateObjectV4Request($ezsignsignatureCreateObjectV4Request, string $contentType = self::contentTypes['ezsignsignatureCreateObjectV4'][0])
    {

        // verify the required parameter 'ezsignsignatureCreateObjectV4Request' is set
        if ($ezsignsignatureCreateObjectV4Request === null || (is_array($ezsignsignatureCreateObjectV4Request) && count($ezsignsignatureCreateObjectV4Request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ezsignsignatureCreateObjectV4Request when calling ezsignsignatureCreateObjectV4'
            );
        }


        $resourcePath = '/4/object/ezsignsignature';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($ezsignsignatureCreateObjectV4Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                //$httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($ezsignsignatureCreateObjectV4Request));
				$httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignsignatureCreateObjectV4Request));
            } else {
                $httpBody = $ezsignsignatureCreateObjectV4Request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation ezsignsignatureEditObjectV3
     *
     * Edit an existing Ezsignsignature
     *
     * @param  int $pkiEzsignsignatureID pkiEzsignsignatureID (required)
     * @param  \eZmaxAPI\Model\EzsignsignatureEditObjectV3Request $ezsignsignatureEditObjectV3Request ezsignsignatureEditObjectV3Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsignsignatureEditObjectV3'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \eZmaxAPI\Model\EzsignsignatureEditObjectV3Response|\eZmaxAPI\Model\CommonResponseError|\eZmaxAPI\Model\CommonResponseError
     */
    public function ezsignsignatureEditObjectV3($pkiEzsignsignatureID, $ezsignsignatureEditObjectV3Request, string $contentType = self::contentTypes['ezsignsignatureEditObjectV3'][0])
    {
        list($response) = $this->ezsignsignatureEditObjectV3WithHttpInfo($pkiEzsignsignatureID, $ezsignsignatureEditObjectV3Request, $contentType);
        return $response;
    }

    /**
     * Operation ezsignsignatureEditObjectV3WithHttpInfo
     *
     * Edit an existing Ezsignsignature
     *
     * @param  int $pkiEzsignsignatureID (required)
     * @param  \eZmaxAPI\Model\EzsignsignatureEditObjectV3Request $ezsignsignatureEditObjectV3Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsignsignatureEditObjectV3'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \eZmaxAPI\Model\EzsignsignatureEditObjectV3Response|\eZmaxAPI\Model\CommonResponseError|\eZmaxAPI\Model\CommonResponseError, HTTP status code, HTTP response headers (array of strings)
     */
    public function ezsignsignatureEditObjectV3WithHttpInfo($pkiEzsignsignatureID, $ezsignsignatureEditObjectV3Request, string $contentType = self::contentTypes['ezsignsignatureEditObjectV3'][0])
    {
        $request = $this->ezsignsignatureEditObjectV3Request($pkiEzsignsignatureID, $ezsignsignatureEditObjectV3Request, $contentType);
    ...
    /**
     * Operation ezsignsignatureEditObjectV3Async
     *
     * Edit an existing Ezsignsignature
     *
     * @param  int $pkiEzsignsignatureID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsignsignatureEditObjectV3Async($pkiEzsignsignatureID, $ezsignsignatureEditObjectV3Request, string $contentType = self::contentTypes['ezsignsignatureEditObjectV3'][0])
    {
        return $this->ezsignsignatureEditObjectV3AsyncWithHttpInfo($pkiEzsignsignatureID, $ezsignsignatureEditObjectV3Request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ezsignsignatureEditObjectV3AsyncWithHttpInfo
     *
     * Edit an existing Ezsignsignature
     *
     * @param  int $pkiEzsignsignatureID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsignsignatureEditObjectV3AsyncWithHttpInfo($pkiEzsignsignatureID, $ezsignsignatureEditObjectV3Request, string $contentType = self::contentTypes['ezsignsignatureEditObjectV3'][0])
    {
        $returnType = '\eZmaxAPI\Model\EzsignsignatureEditObjectV3Response';
        $request = $this->ezsignsignatureEditObjectV3Request($pkiEzsignsignatureID, $ezsignsignatureEditObjectV3Request, $contentType);
    ...
    /**
     * Create request for operation 'ezsignsignatureEditObjectV3'
     *
     * @param  int $pkiEzsignsignatureID (required)
     * @param  \eZmaxAPI\Model\EzsignsignatureEditObjectV3Request $ezsignsignatureEditObjectV3Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsignsignatureEditObjectV3'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ezsignsignatureEditObjectV3Request($pkiEzsignsignatureID, $ezsignsignatureEditObjectV3Request, string $contentType = self::contentTypes['ezsignsignatureEditObjectV3'][0])
    {

        // verify the required parameter 'pkiEzsignsignatureID' is set
        if ($pkiEzsignsignatureID === null || (is_array($pkiEzsignsignatureID) && count($pkiEzsignsignatureID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pkiEzsignsignatureID when calling ezsignsignatureEditObjectV3'
            );
        }
        if ($pkiEzsignsignatureID < 0) {
	    //throw new \InvalidArgumentException('invalid value for "$pkiEzsignsignatureID" when calling ObjectEzsignsignatureApi.ezsignsignatureEditObjectV3, must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignatureID)?'null':'"'.$pkiEzsignsignatureID.'"').' for "pkiEzsignsignatureID" when calling ObjectEzsignsignatureApi.ezsignsignatureEditObjectV3, must be bigger than or equal to 0.');
        }
        
        // verify the required parameter 'ezsignsignatureEditObjectV3Request' is set
        if ($ezsignsignatureEditObjectV3Request === null || (is_array($ezsignsignatureEditObjectV3Request) && count($ezsignsignatureEditObjectV3Request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ezsignsignatureEditObjectV3Request when calling ezsignsignatureEditObjectV3'
            );
        }
        ...
        // for model (json/xml)
        if (isset($ezsignsignatureEditObjectV3Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                //$httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($ezsignsignatureEditObjectV3Request));
				$httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignsignatureEditObjectV3Request));
            } else {
                $httpBody = $ezsignsignatureEditObjectV3Request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation ezsignsignatureGetObjectV4
     *
     * Retrieve an existing Ezsignsignature
     *
     * @param  int $pkiEzsignsignatureID pkiEzsignsignatureID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsignsignatureGetObjectV4'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \eZmaxAPI\Model\EzsignsignatureGetObjectV4Response|\eZmaxAPI\Model\CommonResponseError
     */
    public function ezsignsignatureGetObjectV4($pkiEzsignsignatureID, string $contentType = self::contentTypes['ezsignsignatureGetObjectV4'][0])
    {
        list($response) = $this->ezsignsignatureGetObjectV4WithHttpInfo($pkiEzsignsignatureID, $contentType);
        return $response;
    }

    /**
     * Operation ezsignsignatureGetObjectV4WithHttpInfo
     *
     * Retrieve an existing Ezsignsignature
     *
     * @param  int $pkiEzsignsignatureID (required)
     ...
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \eZmaxAPI\Model\EzsignsignatureGetObjectV4Response|\eZmaxAPI\Model\CommonResponseError, HTTP status code, HTTP response headers (array of strings)
     */
    public function ezsignsignatureGetObjectV4WithHttpInfo($pkiEzsignsignatureID, string $contentType = self::contentTypes['ezsignsignatureGetObjectV4'][0])
    {
        $request = $this->ezsignsignatureGetObjectV4Request($pkiEzsignsignatureID, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\eZmaxAPI\Model\EzsignsignatureGetObjectV4Response',
                        $request,
                        $response,
                    );
                case 404:
    ...
    /**
     * Operation ezsignsignatureGetObjectV4Async
     *
     * Retrieve an existing Ezsignsignature
     *
     * @param  int $pkiEzsignsignatureID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsignsignatureGetObjectV4Async($pkiEzsignsignatureID, string $contentType = self::contentTypes['ezsignsignatureGetObjectV4'][0])
    {
        return $this->ezsignsignatureGetObjectV4AsyncWithHttpInfo($pkiEzsignsignatureID, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ezsignsignatureGetObjectV4AsyncWithHttpInfo
     *
     * Retrieve an existing Ezsignsignature
     *
     * @param  int $pkiEzsignsignatureID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsignsignatureGetObjectV4AsyncWithHttpInfo($pkiEzsignsignatureID, string $contentType = self::contentTypes['ezsignsignatureGetObjectV4'][0])
    {
        $returnType = '\eZmaxAPI\Model\EzsignsignatureGetObjectV4Response';
        $request = $this->ezsignsignatureGetObjectV4Request($pkiEzsignsignatureID, $contentType);
    ...
    /**
     * Create request for operation 'ezsignsignatureGetObjectV4'
     *
     * @param  int $pkiEzsignsignatureID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsignsignatureGetObjectV4'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ezsignsignatureGetObjectV4Request($pkiEzsignsignatureID, string $contentType = self::contentTypes['ezsignsignatureGetObjectV4'][0])
    {

        // verify the required parameter 'pkiEzsignsignatureID' is set
        if ($pkiEzsignsignatureID === null || (is_array($pkiEzsignsignatureID) && count($pkiEzsignsignatureID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pkiEzsignsignatureID when calling ezsignsignatureGetObjectV4'
            );
        }
        if ($pkiEzsignsignatureID < 0) {
	    //throw new \InvalidArgumentException('invalid value for "$pkiEzsignsignatureID" when calling ObjectEzsignsignatureApi.ezsignsignatureGetObjectV4, must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignatureID)?'null':'"'.$pkiEzsignsignatureID.'"').' for "pkiEzsignsignatureID" when calling ObjectEzsignsignatureApi.ezsignsignatureGetObjectV4, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/4/object/ezsignsignature/{pkiEzsignsignatureID}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function ezsignsignatureSignV1Request($pkiEzsignsignatureID, $ezsignsignatureSignV1Request, string $contentType = self::contentTypes['ezsignsignatureSignV1'][0])
    {
        ...
        if (isset($ezsignsignatureSignV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
				...
				$httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsignsignatureSignV1Request));
            } else {
