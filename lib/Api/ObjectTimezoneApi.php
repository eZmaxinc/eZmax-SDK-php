...
class ObjectTimezoneApi
{
     ...
     */
    public function timezoneGetAutocompleteV1($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        list($response) = $this->timezoneGetAutocompleteV1WithHttpInfo($sSelector, $sQuery, $acceptLanguage);
        return $response;
    }
     ...
     */
    public function timezoneGetAutocompleteV1WithHttpInfo($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        $request = $this->timezoneGetAutocompleteV1Request($sSelector, $sQuery, $acceptLanguage);
     ...
     */
    public function timezoneGetAutocompleteV1Async($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        return $this->timezoneGetAutocompleteV1AsyncWithHttpInfo($sSelector, $sQuery, $acceptLanguage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timezoneGetAutocompleteV1AsyncWithHttpInfo($sSelector, $sQuery = null, $acceptLanguage = null)
    {
        $returnType = '\eZmaxAPI\Model\CommonGetAutocompleteV1Response';
        $request = $this->timezoneGetAutocompleteV1Request($sSelector, $sQuery, $acceptLanguage);
     ...
     */
    public function timezoneGetAutocompleteV1Request($sSelector, $sQuery = null, $acceptLanguage = null)
    {
