...
class ObjectEzsigntemplatepackageApi
{
    ...
    public function ezsigntemplatepackageCreateObjectV1Request($ezsigntemplatepackageCreateObjectV1Request, string $contentType = self::contentTypes['ezsigntemplatepackageCreateObjectV1'][0])
    {
        ...
        if (isset($ezsigntemplatepackageCreateObjectV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
				...
				$httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsigntemplatepackageCreateObjectV1Request));
            } else {
    ...
    public function ezsigntemplatepackageDeleteObjectV1Request($pkiEzsigntemplatepackageID, string $contentType = self::contentTypes['ezsigntemplatepackageDeleteObjectV1'][0])
    {
	    ...
	    //throw new \InvalidArgumentException('invalid value for "$pkiEzsigntemplatepackageID" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageDeleteObjectV1, must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepackageID)?'null':'"'.$pkiEzsigntemplatepackageID.'"').' for "pkiEzsigntemplatepackageID" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageDeleteObjectV1, must be bigger than or equal to 0.');
        }
    ...
    public function ezsigntemplatepackageEditEzsigntemplatepackagesignersV1Request($pkiEzsigntemplatepackageID, $ezsigntemplatepackageEditEzsigntemplatepackagesignersV1Request, string $contentType = self::contentTypes['ezsigntemplatepackageEditEzsigntemplatepackagesignersV1'][0])
    {
	    ...
	    //throw new \InvalidArgumentException('invalid value for "$pkiEzsigntemplatepackageID" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageEditEzsigntemplatepackagesignersV1, must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepackageID)?'null':'"'.$pkiEzsigntemplatepackageID.'"').' for "pkiEzsigntemplatepackageID" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageEditEzsigntemplatepackagesignersV1, must be bigger than or equal to 0.');
        }
        ...
        if (isset($ezsigntemplatepackageEditEzsigntemplatepackagesignersV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
				...
				$httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsigntemplatepackageEditEzsigntemplatepackagesignersV1Request));
            } else {
    ...
    /**
     * Operation ezsigntemplatepackageEditEzsigntemplatepackagesignersV2
     *
     * Edit multiple Ezsigntemplatepackagesigners
     *
     * @param  int $pkiEzsigntemplatepackageID pkiEzsigntemplatepackageID (required)
     * @param  \eZmaxAPI\Model\EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request $ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsigntemplatepackageEditEzsigntemplatepackagesignersV2'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \eZmaxAPI\Model\EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response|\eZmaxAPI\Model\CommonResponseError|\eZmaxAPI\Model\CommonResponseError
     */
    public function ezsigntemplatepackageEditEzsigntemplatepackagesignersV2($pkiEzsigntemplatepackageID, $ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, string $contentType = self::contentTypes['ezsigntemplatepackageEditEzsigntemplatepackagesignersV2'][0])
    {
        list($response) = $this->ezsigntemplatepackageEditEzsigntemplatepackagesignersV2WithHttpInfo($pkiEzsigntemplatepackageID, $ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, $contentType);
        return $response;
    }

    /**
     * Operation ezsigntemplatepackageEditEzsigntemplatepackagesignersV2WithHttpInfo
     *
     * Edit multiple Ezsigntemplatepackagesigners
     *
     * @param  int $pkiEzsigntemplatepackageID (required)
     * @param  \eZmaxAPI\Model\EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request $ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsigntemplatepackageEditEzsigntemplatepackagesignersV2'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \eZmaxAPI\Model\EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response|\eZmaxAPI\Model\CommonResponseError|\eZmaxAPI\Model\CommonResponseError, HTTP status code, HTTP response headers (array of strings)
     */
    public function ezsigntemplatepackageEditEzsigntemplatepackagesignersV2WithHttpInfo($pkiEzsigntemplatepackageID, $ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, string $contentType = self::contentTypes['ezsigntemplatepackageEditEzsigntemplatepackagesignersV2'][0])
    {
        $request = $this->ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request($pkiEzsigntemplatepackageID, $ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\eZmaxAPI\Model\EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response',
                        $request,
                        $response,
                    );
                case 404:
    ...
    /**
     * Operation ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Async
     *
     * Edit multiple Ezsigntemplatepackagesigners
     *
     * @param  int $pkiEzsigntemplatepackageID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Async($pkiEzsigntemplatepackageID, $ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, string $contentType = self::contentTypes['ezsigntemplatepackageEditEzsigntemplatepackagesignersV2'][0])
    {
        return $this->ezsigntemplatepackageEditEzsigntemplatepackagesignersV2AsyncWithHttpInfo($pkiEzsigntemplatepackageID, $ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ezsigntemplatepackageEditEzsigntemplatepackagesignersV2AsyncWithHttpInfo
     *
     * Edit multiple Ezsigntemplatepackagesigners
     *
     * @param  int $pkiEzsigntemplatepackageID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsigntemplatepackageEditEzsigntemplatepackagesignersV2AsyncWithHttpInfo($pkiEzsigntemplatepackageID, $ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, string $contentType = self::contentTypes['ezsigntemplatepackageEditEzsigntemplatepackagesignersV2'][0])
    {
        $returnType = '\eZmaxAPI\Model\EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response';
        $request = $this->ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request($pkiEzsigntemplatepackageID, $ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, $contentType);
    ...
    /**
     * Create request for operation 'ezsigntemplatepackageEditEzsigntemplatepackagesignersV2'
     *
     * @param  int $pkiEzsigntemplatepackageID (required)
     * @param  \eZmaxAPI\Model\EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request $ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsigntemplatepackageEditEzsigntemplatepackagesignersV2'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request($pkiEzsigntemplatepackageID, $ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request, string $contentType = self::contentTypes['ezsigntemplatepackageEditEzsigntemplatepackagesignersV2'][0])
    {

        // verify the required parameter 'pkiEzsigntemplatepackageID' is set
        if ($pkiEzsigntemplatepackageID === null || (is_array($pkiEzsigntemplatepackageID) && count($pkiEzsigntemplatepackageID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pkiEzsigntemplatepackageID when calling ezsigntemplatepackageEditEzsigntemplatepackagesignersV2'
            );
        }
        if ($pkiEzsigntemplatepackageID < 0) {
	    //throw new \InvalidArgumentException('invalid value for "$pkiEzsigntemplatepackageID" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageEditEzsigntemplatepackagesignersV2, must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepackageID)?'null':'"'.$pkiEzsigntemplatepackageID.'"').' for "pkiEzsigntemplatepackageID" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageEditEzsigntemplatepackagesignersV2, must be bigger than or equal to 0.');
        }
        
        // verify the required parameter 'ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request' is set
        if ($ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request === null || (is_array($ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request) && count($ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request when calling ezsigntemplatepackageEditEzsigntemplatepackagesignersV2'
            );
        }


        $resourcePath = '/2/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}/editEzsigntemplatepackagesigners';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                //$httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request));
				$httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request));
            } else {
                $httpBody = $ezsigntemplatepackageEditEzsigntemplatepackagesignersV2Request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    public function ezsigntemplatepackageEditObjectV1Request($pkiEzsigntemplatepackageID, $ezsigntemplatepackageEditObjectV1Request, string $contentType = self::contentTypes['ezsigntemplatepackageEditObjectV1'][0])
    {
	    ...
	    //throw new \InvalidArgumentException('invalid value for "$pkiEzsigntemplatepackageID" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageEditObjectV1, must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepackageID)?'null':'"'.$pkiEzsigntemplatepackageID.'"').' for "pkiEzsigntemplatepackageID" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageEditObjectV1, must be bigger than or equal to 0.');
        }
        ...
        if (isset($ezsigntemplatepackageEditObjectV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
				...
				$httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($ezsigntemplatepackageEditObjectV1Request));
            } else {
     ...
     */
    public function ezsigntemplatepackageGetAutocompleteV2($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null, $fkiEzsignfoldertypeID = null, string $contentType = self::contentTypes['ezsigntemplatepackageGetAutocompleteV2'][0])
    {
        list($response) = $this->ezsigntemplatepackageGetAutocompleteV2WithHttpInfo($sSelector, $eFilterActive, $sQuery, $acceptLanguage, $fkiEzsignfoldertypeID, $contentType);
        return $response;
    }
     ...
     */
    public function ezsigntemplatepackageGetAutocompleteV2WithHttpInfo($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null, $fkiEzsignfoldertypeID = null, string $contentType = self::contentTypes['ezsigntemplatepackageGetAutocompleteV2'][0])
    {
        $request = $this->ezsigntemplatepackageGetAutocompleteV2Request($sSelector, $eFilterActive, $sQuery, $acceptLanguage, $fkiEzsignfoldertypeID, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsigntemplatepackageGetAutocompleteV2Async($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null, $fkiEzsignfoldertypeID = null, string $contentType = self::contentTypes['ezsigntemplatepackageGetAutocompleteV2'][0])
    {
        return $this->ezsigntemplatepackageGetAutocompleteV2AsyncWithHttpInfo($sSelector, $eFilterActive, $sQuery, $acceptLanguage, $fkiEzsignfoldertypeID, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsigntemplatepackageGetAutocompleteV2AsyncWithHttpInfo($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null, $fkiEzsignfoldertypeID = null, string $contentType = self::contentTypes['ezsigntemplatepackageGetAutocompleteV2'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ezsigntemplatepackageGetAutocompleteV2Request($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null, $fkiEzsignfoldertypeID = null, string $contentType = self::contentTypes['ezsigntemplatepackageGetAutocompleteV2'][0])
    {
    ...
    public function ezsigntemplatepackageGetListV1Request($eOrderBy = null, $iRowMax = null, $iRowOffset = 0, $acceptLanguage = null, $sFilter = null, string $contentType = self::contentTypes['ezsigntemplatepackageGetListV1'][0])
    {
	    ...
	    //throw new \InvalidArgumentException('invalid value for "$iRowMax" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageGetListV1, must be smaller than or equal to 10000.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iRowMax)?'null':'"'.$iRowMax.'"').' for "iRowMax" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageGetListV1, must be smaller than or equal to 10000.');
        }
	    ...
	    //throw new \InvalidArgumentException('invalid value for "$iRowMax" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageGetListV1, must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iRowMax)?'null':'"'.$iRowMax.'"').' for "iRowMax" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageGetListV1, must be bigger than or equal to 1.');
        }
	    ...
	    //throw new \InvalidArgumentException('invalid value for "$iRowOffset" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageGetListV1, must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iRowOffset)?'null':'"'.$iRowOffset.'"').' for "iRowOffset" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageGetListV1, must be bigger than or equal to 0.');
        }
    ...
    public function ezsigntemplatepackageGetObjectV2Request($pkiEzsigntemplatepackageID, string $contentType = self::contentTypes['ezsigntemplatepackageGetObjectV2'][0])
    {
	    ...
	    //throw new \InvalidArgumentException('invalid value for "$pkiEzsigntemplatepackageID" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageGetObjectV2, must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepackageID)?'null':'"'.$pkiEzsigntemplatepackageID.'"').' for "pkiEzsigntemplatepackageID" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageGetObjectV2, must be bigger than or equal to 0.');
        }
    ...
    /**
     * Operation ezsigntemplatepackageGetObjectV3
     *
     * Retrieve an existing Ezsigntemplatepackage
     *
     * @param  int $pkiEzsigntemplatepackageID pkiEzsigntemplatepackageID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsigntemplatepackageGetObjectV3'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \eZmaxAPI\Model\EzsigntemplatepackageGetObjectV3Response|\eZmaxAPI\Model\CommonResponseError
     */
    public function ezsigntemplatepackageGetObjectV3($pkiEzsigntemplatepackageID, string $contentType = self::contentTypes['ezsigntemplatepackageGetObjectV3'][0])
    {
        list($response) = $this->ezsigntemplatepackageGetObjectV3WithHttpInfo($pkiEzsigntemplatepackageID, $contentType);
        return $response;
    }

    /**
     * Operation ezsigntemplatepackageGetObjectV3WithHttpInfo
     *
     * Retrieve an existing Ezsigntemplatepackage
     *
     * @param  int $pkiEzsigntemplatepackageID (required)
     ...
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \eZmaxAPI\Model\EzsigntemplatepackageGetObjectV3Response|\eZmaxAPI\Model\CommonResponseError, HTTP status code, HTTP response headers (array of strings)
     */
    public function ezsigntemplatepackageGetObjectV3WithHttpInfo($pkiEzsigntemplatepackageID, string $contentType = self::contentTypes['ezsigntemplatepackageGetObjectV3'][0])
    {
        $request = $this->ezsigntemplatepackageGetObjectV3Request($pkiEzsigntemplatepackageID, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\eZmaxAPI\Model\EzsigntemplatepackageGetObjectV3Response',
                        $request,
                        $response,
                    );
                case 404:
    ...
    /**
     * Operation ezsigntemplatepackageGetObjectV3Async
     *
     * Retrieve an existing Ezsigntemplatepackage
     *
     * @param  int $pkiEzsigntemplatepackageID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsigntemplatepackageGetObjectV3Async($pkiEzsigntemplatepackageID, string $contentType = self::contentTypes['ezsigntemplatepackageGetObjectV3'][0])
    {
        return $this->ezsigntemplatepackageGetObjectV3AsyncWithHttpInfo($pkiEzsigntemplatepackageID, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation ezsigntemplatepackageGetObjectV3AsyncWithHttpInfo
     *
     * Retrieve an existing Ezsigntemplatepackage
     *
     * @param  int $pkiEzsigntemplatepackageID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function ezsigntemplatepackageGetObjectV3AsyncWithHttpInfo($pkiEzsigntemplatepackageID, string $contentType = self::contentTypes['ezsigntemplatepackageGetObjectV3'][0])
    {
        $returnType = '\eZmaxAPI\Model\EzsigntemplatepackageGetObjectV3Response';
        $request = $this->ezsigntemplatepackageGetObjectV3Request($pkiEzsigntemplatepackageID, $contentType);
    ...
    /**
     * Create request for operation 'ezsigntemplatepackageGetObjectV3'
     *
     * @param  int $pkiEzsigntemplatepackageID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['ezsigntemplatepackageGetObjectV3'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ezsigntemplatepackageGetObjectV3Request($pkiEzsigntemplatepackageID, string $contentType = self::contentTypes['ezsigntemplatepackageGetObjectV3'][0])
    {

        // verify the required parameter 'pkiEzsigntemplatepackageID' is set
        if ($pkiEzsigntemplatepackageID === null || (is_array($pkiEzsigntemplatepackageID) && count($pkiEzsigntemplatepackageID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pkiEzsigntemplatepackageID when calling ezsigntemplatepackageGetObjectV3'
            );
        }
        if ($pkiEzsigntemplatepackageID < 0) {
	    //throw new \InvalidArgumentException('invalid value for "$pkiEzsigntemplatepackageID" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageGetObjectV3, must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepackageID)?'null':'"'.$pkiEzsigntemplatepackageID.'"').' for "pkiEzsigntemplatepackageID" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackageGetObjectV3, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/3/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
