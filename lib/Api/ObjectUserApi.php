...
class ObjectUserApi
{
     ...
     * @deprecated
     */
    public function userGetAutocompleteV1($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        list($response) = $this->userGetAutocompleteV1WithHttpInfo($sSelector, $eFilterActive, $sQuery, $acceptLanguage);
        return $response;
    }
     ...
     * @deprecated
     */
    public function userGetAutocompleteV1WithHttpInfo($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        $request = $this->userGetAutocompleteV1Request($sSelector, $eFilterActive, $sQuery, $acceptLanguage);
     ...
     * @deprecated
     */
    public function userGetAutocompleteV1Async($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        return $this->userGetAutocompleteV1AsyncWithHttpInfo($sSelector, $eFilterActive, $sQuery, $acceptLanguage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function userGetAutocompleteV1AsyncWithHttpInfo($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        $returnType = '\eZmaxAPI\Model\CommonGetAutocompleteV1Response';
        $request = $this->userGetAutocompleteV1Request($sSelector, $eFilterActive, $sQuery, $acceptLanguage);
     ...
     * @deprecated
     */
    public function userGetAutocompleteV1Request($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
     ...
     */
    public function userGetAutocompleteV2($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        list($response) = $this->userGetAutocompleteV2WithHttpInfo($sSelector, $eFilterActive, $sQuery, $acceptLanguage);
        return $response;
    }
     ...
     */
    public function userGetAutocompleteV2WithHttpInfo($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        $request = $this->userGetAutocompleteV2Request($sSelector, $eFilterActive, $sQuery, $acceptLanguage);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userGetAutocompleteV2Async($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        return $this->userGetAutocompleteV2AsyncWithHttpInfo($sSelector, $eFilterActive, $sQuery, $acceptLanguage)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userGetAutocompleteV2AsyncWithHttpInfo($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
        $returnType = '\eZmaxAPI\Model\UserGetAutocompleteV2Response';
        $request = $this->userGetAutocompleteV2Request($sSelector, $eFilterActive, $sQuery, $acceptLanguage);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function userGetAutocompleteV2Request($sSelector, $eFilterActive = 'Active', $sQuery = null, $acceptLanguage = null)
    {
