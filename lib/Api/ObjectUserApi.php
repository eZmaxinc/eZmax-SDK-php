...
class ObjectUserApi
{
    ...
    public function userCreateObjectV1Request($userCreateObjectV1Request, string $contentType = self::contentTypes['userCreateObjectV1'][0])
    {
        ...
        if (isset($userCreateObjectV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($userCreateObjectV1Request), JSON_THROW_ON_ERROR);
    ...
    public function userCreateObjectV2Request($userCreateObjectV2Request, string $contentType = self::contentTypes['userCreateObjectV2'][0])
    {
        ...
        if (isset($userCreateObjectV2Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($userCreateObjectV2Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function userEditColleaguesV2Request($pkiUserID, $userEditColleaguesV2Request, string $contentType = self::contentTypes['userEditColleaguesV2'][0])
    {
        ...
        if (isset($userEditColleaguesV2Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($userEditColleaguesV2Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function userEditObjectV1Request($pkiUserID, $userEditObjectV1Request, string $contentType = self::contentTypes['userEditObjectV1'][0])
    {
        ...
        if (isset($userEditObjectV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($userEditObjectV1Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    public function userEditPermissionsV1Request($pkiUserID, $userEditPermissionsV1Request, string $contentType = self::contentTypes['userEditPermissionsV1'][0])
    {
        ...
        if (isset($userEditPermissionsV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($userEditPermissionsV1Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
    ...
    /**
     * Operation userGetEzmaxcustomeruserV1
     *
     * Returns the Ezmaxcustomeruser for the User
     *
     * @param  int $pkiUserID pkiUserID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['userGetEzmaxcustomeruserV1'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \eZmaxAPI\Model\UserGetEzmaxcustomeruserV1Response|\eZmaxAPI\Model\CommonResponseError|\eZmaxAPI\Model\CommonResponseError
     */
    public function userGetEzmaxcustomeruserV1($pkiUserID, string $contentType = self::contentTypes['userGetEzmaxcustomeruserV1'][0])
    {
        list($response) = $this->userGetEzmaxcustomeruserV1WithHttpInfo($pkiUserID, $contentType);
        return $response;
    }

    /**
     * Operation userGetEzmaxcustomeruserV1WithHttpInfo
     *
     * Returns the Ezmaxcustomeruser for the User
     *
     * @param  int $pkiUserID (required)
     ...
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \eZmaxAPI\Model\UserGetEzmaxcustomeruserV1Response|\eZmaxAPI\Model\CommonResponseError|\eZmaxAPI\Model\CommonResponseError, HTTP status code, HTTP response headers (array of strings)
     */
    public function userGetEzmaxcustomeruserV1WithHttpInfo($pkiUserID, string $contentType = self::contentTypes['userGetEzmaxcustomeruserV1'][0])
    {
        $request = $this->userGetEzmaxcustomeruserV1Request($pkiUserID, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\eZmaxAPI\Model\UserGetEzmaxcustomeruserV1Response',
                        $request,
                        $response,
                    );
                case 404:
    ...
    /**
     * Operation userGetEzmaxcustomeruserV1Async
     *
     * Returns the Ezmaxcustomeruser for the User
     *
     * @param  int $pkiUserID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userGetEzmaxcustomeruserV1Async($pkiUserID, string $contentType = self::contentTypes['userGetEzmaxcustomeruserV1'][0])
    {
        return $this->userGetEzmaxcustomeruserV1AsyncWithHttpInfo($pkiUserID, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation userGetEzmaxcustomeruserV1AsyncWithHttpInfo
     *
     * Returns the Ezmaxcustomeruser for the User
     *
     * @param  int $pkiUserID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userGetEzmaxcustomeruserV1AsyncWithHttpInfo($pkiUserID, string $contentType = self::contentTypes['userGetEzmaxcustomeruserV1'][0])
    {
        $returnType = '\eZmaxAPI\Model\UserGetEzmaxcustomeruserV1Response';
        $request = $this->userGetEzmaxcustomeruserV1Request($pkiUserID, $contentType);
    ...
    /**
     * Create request for operation 'userGetEzmaxcustomeruserV1'
     *
     * @param  int $pkiUserID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['userGetEzmaxcustomeruserV1'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function userGetEzmaxcustomeruserV1Request($pkiUserID, string $contentType = self::contentTypes['userGetEzmaxcustomeruserV1'][0])
    {

        // verify the required parameter 'pkiUserID' is set
        if ($pkiUserID === null || (is_array($pkiUserID) && count($pkiUserID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pkiUserID when calling userGetEzmaxcustomeruserV1'
            );
        }
        if ($pkiUserID < 0) {
	    //throw new \InvalidArgumentException('invalid value for "$pkiUserID" when calling ObjectUserApi.userGetEzmaxcustomeruserV1, must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUserID)?'null':'"'.$pkiUserID.'"').' for "pkiUserID" when calling ObjectUserApi.userGetEzmaxcustomeruserV1, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/1/object/user/{pkiUserID}/getEzmaxcustomeruser';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation userImpersonateV1
     *
     * Impersonate the user
     *
     * @param  int $pkiUserID pkiUserID (required)
     * @param  \eZmaxAPI\Model\UserImpersonateV1Request $userImpersonateV1Request userImpersonateV1Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['userImpersonateV1'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \eZmaxAPI\Model\UserImpersonateV1Response|\eZmaxAPI\Model\CommonResponseError|\eZmaxAPI\Model\CommonResponseError
     */
    public function userImpersonateV1($pkiUserID, $userImpersonateV1Request, string $contentType = self::contentTypes['userImpersonateV1'][0])
    {
        list($response) = $this->userImpersonateV1WithHttpInfo($pkiUserID, $userImpersonateV1Request, $contentType);
        return $response;
    }

    /**
     * Operation userImpersonateV1WithHttpInfo
     *
     * Impersonate the user
     *
     * @param  int $pkiUserID (required)
     * @param  \eZmaxAPI\Model\UserImpersonateV1Request $userImpersonateV1Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['userImpersonateV1'] to see the possible values for this operation
     *
     * @throws \eZmaxAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \eZmaxAPI\Model\UserImpersonateV1Response|\eZmaxAPI\Model\CommonResponseError|\eZmaxAPI\Model\CommonResponseError, HTTP status code, HTTP response headers (array of strings)
     */
    public function userImpersonateV1WithHttpInfo($pkiUserID, $userImpersonateV1Request, string $contentType = self::contentTypes['userImpersonateV1'][0])
    {
        $request = $this->userImpersonateV1Request($pkiUserID, $userImpersonateV1Request, $contentType);
    ...
    /**
     * Operation userImpersonateV1Async
     *
     * Impersonate the user
     *
     * @param  int $pkiUserID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userImpersonateV1Async($pkiUserID, $userImpersonateV1Request, string $contentType = self::contentTypes['userImpersonateV1'][0])
    {
        return $this->userImpersonateV1AsyncWithHttpInfo($pkiUserID, $userImpersonateV1Request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation userImpersonateV1AsyncWithHttpInfo
     *
     * Impersonate the user
     *
     * @param  int $pkiUserID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userImpersonateV1AsyncWithHttpInfo($pkiUserID, $userImpersonateV1Request, string $contentType = self::contentTypes['userImpersonateV1'][0])
    {
        $returnType = '\eZmaxAPI\Model\UserImpersonateV1Response';
        $request = $this->userImpersonateV1Request($pkiUserID, $userImpersonateV1Request, $contentType);
    ...
    /**
     * Create request for operation 'userImpersonateV1'
     *
     * @param  int $pkiUserID (required)
     * @param  \eZmaxAPI\Model\UserImpersonateV1Request $userImpersonateV1Request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['userImpersonateV1'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function userImpersonateV1Request($pkiUserID, $userImpersonateV1Request, string $contentType = self::contentTypes['userImpersonateV1'][0])
    {

        // verify the required parameter 'pkiUserID' is set
        if ($pkiUserID === null || (is_array($pkiUserID) && count($pkiUserID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pkiUserID when calling userImpersonateV1'
            );
        }
        if ($pkiUserID < 0) {
	    //throw new \InvalidArgumentException('invalid value for "$pkiUserID" when calling ObjectUserApi.userImpersonateV1, must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUserID)?'null':'"'.$pkiUserID.'"').' for "pkiUserID" when calling ObjectUserApi.userImpersonateV1, must be bigger than or equal to 0.');
        }
        
        // verify the required parameter 'userImpersonateV1Request' is set
        if ($userImpersonateV1Request === null || (is_array($userImpersonateV1Request) && count($userImpersonateV1Request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $userImpersonateV1Request when calling userImpersonateV1'
            );
        }


        $resourcePath = '/1/object/user/{pkiUserID}/impersonate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($userImpersonateV1Request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                try {
                    $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($userImpersonateV1Request), JSON_THROW_ON_ERROR);
                } catch (\JsonException $e) {
                    throw new \InvalidArgumentException('json_encode error: ' . $e->getMessage(), 0, $e);
                }
            } else {
                $httpBody = $userImpersonateV1Request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
