...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://prod.api.appcluster01.ca-central-1.ezmax.com/rest';
    ...
    {
        $report  = 'PHP SDK (eZmaxAPI) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.0.45' . PHP_EOL;
