...
/**
 * EzsignfoldertypeResponseCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignfoldertypeResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignfoldertype-ResponseCompound';
    ...
    */
	...
	//if (!is_null($this->container['sUsergroupNameX']) && !preg_match("/^.{0,50}$/", $this->container['sUsergroupNameX'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sUsergroupNameX', must be conform to the pattern /^.{0,50}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sUsergroupNameX'])?'null':'"'.$this->container['sUsergroupNameX'].'"')." for 'sUsergroupNameX', must be conform to the pattern /^.{0,50}$/.";
        }

	//if (!is_null($this->container['sUsergroupNameXRestricted']) && !preg_match("/^.{0,50}$/", $this->container['sUsergroupNameXRestricted'])) {
        if (!is_null($this->container['sUsergroupNameXRestricted']) && !preg_match("/(*UTF8)^.{0,50}$/", $this->container['sUsergroupNameXRestricted'])) {
        //    $invalidProperties[] = "invalid value for 'sUsergroupNameXRestricted', must be conform to the pattern /^.{0,50}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sUsergroupNameXRestricted'])?'null':'"'.$this->container['sUsergroupNameXRestricted'].'"')." for 'sUsergroupNameXRestricted', must be conform to the pattern /^.{0,50}$/.";
        }
	...
	//if (($pkiEzsignfoldertypeID > 65535)) {
        if (($pkiEzsignfoldertypeID > 65535)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignfoldertypeID when calling EzsignfoldertypeResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignfoldertypeID)?'null':'"'.$pkiEzsignfoldertypeID.'"').' for pkiEzsignfoldertypeID when calling EzsignfoldertypeResponseCompound., must be smaller than or equal to 65535.');
        }
	//if (($pkiEzsignfoldertypeID < 0)) {
        if (($pkiEzsignfoldertypeID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignfoldertypeID when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignfoldertypeID)?'null':'"'.$pkiEzsignfoldertypeID.'"').' for pkiEzsignfoldertypeID when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiBrandingID < 0)) {
        if (($fkiBrandingID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiBrandingID when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBrandingID)?'null':'"'.$fkiBrandingID.'"').' for fkiBrandingID when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiBillingentityinternalID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiBillingentityinternalID when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBillingentityinternalID)?'null':'"'.$fkiBillingentityinternalID.'"').' for fkiBillingentityinternalID when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUsergroupID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling EzsignfoldertypeResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling EzsignfoldertypeResponseCompound., must be smaller than or equal to 255.');
        }
	//if (($fkiUsergroupID < 0)) {
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUsergroupIDRestricted > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupIDRestricted when calling EzsignfoldertypeResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupIDRestricted)?'null':'"'.$fkiUsergroupIDRestricted.'"').' for fkiUsergroupIDRestricted when calling EzsignfoldertypeResponseCompound., must be smaller than or equal to 255.');
        }
	//if (($fkiUsergroupIDRestricted < 0)) {
        if (!is_null($fkiUsergroupIDRestricted) && ($fkiUsergroupIDRestricted < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupIDRestricted when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupIDRestricted)?'null':'"'.$fkiUsergroupIDRestricted.'"').' for fkiUsergroupIDRestricted when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntsarequirementID > 3)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntsarequirementID when calling EzsignfoldertypeResponseCompound., must be smaller than or equal to 3.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntsarequirementID)?'null':'"'.$fkiEzsigntsarequirementID.'"').' for fkiEzsigntsarequirementID when calling EzsignfoldertypeResponseCompound., must be smaller than or equal to 3.');
        }
	//if (($fkiEzsigntsarequirementID < 1)) {
        if (!is_null($fkiEzsigntsarequirementID) && ($fkiEzsigntsarequirementID < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntsarequirementID when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntsarequirementID)?'null':'"'.$fkiEzsigntsarequirementID.'"').' for fkiEzsigntsarequirementID when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//if ((!preg_match("/^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddressSigned)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEmailAddressSigned when calling EzsignfoldertypeResponseCompound., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEmailAddressSigned)?'null':'"'.$sEmailAddressSigned.'"')." for sEmailAddressSigned when calling EzsignfoldertypeResponseCompound., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
        }
	...
	//if ((!preg_match("/^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddressSummary)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEmailAddressSummary when calling EzsignfoldertypeResponseCompound., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEmailAddressSummary)?'null':'"'.$sEmailAddressSummary.'"')." for sEmailAddressSummary when calling EzsignfoldertypeResponseCompound., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
        }
	...
	//if ((!preg_match("/^.{0,50}$/", ObjectSerializer::toString($sUsergroupNameX)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sUsergroupNameX when calling EzsignfoldertypeResponseCompound., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupNameX)?'null':'"'.$sUsergroupNameX.'"')." for sUsergroupNameX when calling EzsignfoldertypeResponseCompound., must conform to the pattern /^.{0,50}$/.");
        }
	...
	//if ((!preg_match("/^.{0,50}$/", ObjectSerializer::toString($sUsergroupNameXRestricted)))) {
        if (!is_null($sUsergroupNameXRestricted) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sUsergroupNameXRestricted)))) {
	    //throw new \InvalidArgumentException("invalid value for \$sUsergroupNameXRestricted when calling EzsignfoldertypeResponseCompound., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupNameXRestricted)?'null':'"'.$sUsergroupNameXRestricted.'"')." for sUsergroupNameXRestricted when calling EzsignfoldertypeResponseCompound., must conform to the pattern /^.{0,50}$/.");
        }
	...
	//if (($iEzsignfoldertypeArchivaldays > 180)) {
        if (($iEzsignfoldertypeArchivaldays > 180)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignfoldertypeArchivaldays when calling EzsignfoldertypeResponseCompound., must be smaller than or equal to 180.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfoldertypeArchivaldays)?'null':'"'.$iEzsignfoldertypeArchivaldays.'"').' for iEzsignfoldertypeArchivaldays when calling EzsignfoldertypeResponseCompound., must be smaller than or equal to 180.');
        }
	//if (($iEzsignfoldertypeArchivaldays < 0)) {
        if (($iEzsignfoldertypeArchivaldays < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignfoldertypeArchivaldays when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfoldertypeArchivaldays)?'null':'"'.$iEzsignfoldertypeArchivaldays.'"').' for iEzsignfoldertypeArchivaldays when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignfoldertypeDisposaldays > 9999)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignfoldertypeDisposaldays when calling EzsignfoldertypeResponseCompound., must be smaller than or equal to 9999.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfoldertypeDisposaldays)?'null':'"'.$iEzsignfoldertypeDisposaldays.'"').' for iEzsignfoldertypeDisposaldays when calling EzsignfoldertypeResponseCompound., must be smaller than or equal to 9999.');
        }
	//if (($iEzsignfoldertypeDisposaldays < 0)) {
        if (!is_null($iEzsignfoldertypeDisposaldays) && ($iEzsignfoldertypeDisposaldays < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignfoldertypeDisposaldays when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfoldertypeDisposaldays)?'null':'"'.$iEzsignfoldertypeDisposaldays.'"').' for iEzsignfoldertypeDisposaldays when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignfoldertypeDeadlinedays > 60)) {
        if (($iEzsignfoldertypeDeadlinedays > 60)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignfoldertypeDeadlinedays when calling EzsignfoldertypeResponseCompound., must be smaller than or equal to 60.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfoldertypeDeadlinedays)?'null':'"'.$iEzsignfoldertypeDeadlinedays.'"').' for iEzsignfoldertypeDeadlinedays when calling EzsignfoldertypeResponseCompound., must be smaller than or equal to 60.');
        }
	//if (($iEzsignfoldertypeDeadlinedays < 1)) {
        if (($iEzsignfoldertypeDeadlinedays < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignfoldertypeDeadlinedays when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfoldertypeDeadlinedays)?'null':'"'.$iEzsignfoldertypeDeadlinedays.'"').' for iEzsignfoldertypeDeadlinedays when calling EzsignfoldertypeResponseCompound., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param \eZmaxAPI\Model\UserlogintypeResponse[] $aObjUserlogintype 
     *
     * @return self
     */
