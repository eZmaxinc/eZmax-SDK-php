    ...
    */
	...
	//if (($pkiEzsigntemplateformfieldgroupsignerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplateformfieldgroupsignerID when calling EzsigntemplateformfieldgroupsignerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateformfieldgroupsignerID)?'null':'"'.$pkiEzsigntemplateformfieldgroupsignerID.'"').' for pkiEzsigntemplateformfieldgroupsignerID when calling EzsigntemplateformfieldgroupsignerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatesignerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatesignerID when calling EzsigntemplateformfieldgroupsignerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatesignerID)?'null':'"'.$fkiEzsigntemplatesignerID.'"').' for fkiEzsigntemplatesignerID when calling EzsigntemplateformfieldgroupsignerResponseCompound., must be bigger than or equal to 0.');
        }
