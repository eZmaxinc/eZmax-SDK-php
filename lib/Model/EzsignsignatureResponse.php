...
class EzsignsignatureResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzsignsignatureCreditcardamount)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dEzsignsignatureCreditcardamount when calling EzsignsignatureResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzsignsignatureCreditcardamount)?'null':'"'.$dEzsignsignatureCreditcardamount.'"')." for dEzsignsignatureCreditcardamount when calling EzsignsignatureResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
