...
class EzsignsignatureResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsignsignatureID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignatureID)?'null':'"'.$pkiEzsignsignatureID.'"').' for pkiEzsignsignatureID when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigndocumentID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigndocumentID)?'null':'"'.$fkiEzsigndocumentID.'"').' for fkiEzsigndocumentID when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsignfoldersignerassociationID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationID)?'null':'"'.$fkiEzsignfoldersignerassociationID.'"').' for fkiEzsignfoldersignerassociationID when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignsigningreasonID) && ($fkiEzsignsigningreasonID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignsigningreasonID when calling EzsignsignatureResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsigningreasonID)?'null':'"'.$fkiEzsignsigningreasonID.'"').' for fkiEzsignsigningreasonID when calling EzsignsignatureResponse., must be smaller than or equal to 255.');
        }
        //if (($fkiEzsignsigningreasonID < 0)) {
        if (!is_null($fkiEzsignsigningreasonID) && ($fkiEzsignsigningreasonID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignsigningreasonID when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsigningreasonID)?'null':'"'.$fkiEzsignsigningreasonID.'"').' for fkiEzsignsigningreasonID when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiFontID) && ($fkiFontID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFontID when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFontID)?'null':'"'.$fkiFontID.'"').' for fkiFontID when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiPaymentgatewayID) && ($fkiPaymentgatewayID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiPaymentgatewayID when calling EzsignsignatureResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPaymentgatewayID)?'null':'"'.$fkiPaymentgatewayID.'"').' for fkiPaymentgatewayID when calling EzsignsignatureResponse., must be smaller than or equal to 255.');
        }
        //if (($fkiPaymentgatewayID < 0)) {
        if (!is_null($fkiPaymentgatewayID) && ($fkiPaymentgatewayID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiPaymentgatewayID when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPaymentgatewayID)?'null':'"'.$fkiPaymentgatewayID.'"').' for fkiPaymentgatewayID when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCurrencyDescriptionX) && (!preg_match("/(*UTF8)^.{1,20}$/", ObjectSerializer::toString($sCurrencyDescriptionX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCurrencyDescriptionX when calling EzsignsignatureResponse., must conform to the pattern /^.{1,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCurrencyDescriptionX)?'null':'"'.$sCurrencyDescriptionX.'"')." for sCurrencyDescriptionX when calling EzsignsignatureResponse., must conform to the pattern /^.{1,20}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzsignsignatureCreditcardamount) && (!preg_match("/(*UTF8)^[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzsignsignatureCreditcardamount)))) {
            //throw new \InvalidArgumentException("invalid value for \$dEzsignsignatureCreditcardamount when calling EzsignsignatureResponse., must conform to the pattern /^[\\d]{1,9}?\\.[\\d]{2}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzsignsignatureCreditcardamount)?'null':'"'.$dEzsignsignatureCreditcardamount.'"')." for dEzsignsignatureCreditcardamount when calling EzsignsignatureResponse., must conform to the pattern /^[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignsignatureCreditcardamountdescription) && (!preg_match("/(*UTF8)^.{1,50}$/", ObjectSerializer::toString($sEzsignsignatureCreditcardamountdescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsignsignatureCreditcardamountdescription when calling EzsignsignatureResponse., must conform to the pattern /^.{1,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignsignatureCreditcardamountdescription)?'null':'"'.$sEzsignsignatureCreditcardamountdescription.'"')." for sEzsignsignatureCreditcardamountdescription when calling EzsignsignatureResponse., must conform to the pattern /^.{1,50}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignsigningreasonDescriptionX) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sEzsignsigningreasonDescriptionX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsignsigningreasonDescriptionX when calling EzsignsignatureResponse., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignsigningreasonDescriptionX)?'null':'"'.$sEzsignsigningreasonDescriptionX.'"')." for sEzsignsigningreasonDescriptionX when calling EzsignsignatureResponse., must conform to the pattern /^.{0,50}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsignpagePagenumber < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignpagePagenumber)?'null':'"'.$iEzsignpagePagenumber.'"').' for iEzsignpagePagenumber when calling EzsignsignatureResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsignsignatureX < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureX)?'null':'"'.$iEzsignsignatureX.'"').' for iEzsignsignatureX when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsignsignatureY < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureY)?'null':'"'.$iEzsignsignatureY.'"').' for iEzsignsignatureY when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsignsignatureHeight) && ($iEzsignsignatureHeight < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureHeight when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureHeight)?'null':'"'.$iEzsignsignatureHeight.'"').' for iEzsignsignatureHeight when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsignsignatureWidth) && ($iEzsignsignatureWidth < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureWidth when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureWidth)?'null':'"'.$iEzsignsignatureWidth.'"').' for iEzsignsignatureWidth when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignfoldersignerassociationIDValidation) && ($fkiEzsignfoldersignerassociationIDValidation < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationIDValidation)?'null':'"'.$fkiEzsignfoldersignerassociationIDValidation.'"').' for fkiEzsignfoldersignerassociationIDValidation when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtEzsignsignatureDate) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtEzsignsignatureDate)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dtEzsignsignatureDate)?'null':'"'.$dtEzsignsignatureDate.'"')." for dtEzsignsignatureDate when calling EzsignsignatureResponse., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsignsignatureMaxlength) && ($iEzsignsignatureMaxlength > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureMaxlength when calling EzsignsignatureResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureMaxlength)?'null':'"'.$iEzsignsignatureMaxlength.'"').' for iEzsignsignatureMaxlength when calling EzsignsignatureResponse., must be smaller than or equal to 65535.');
        }
        //if (($iEzsignsignatureMaxlength < 0)) {
        if (!is_null($iEzsignsignatureMaxlength) && ($iEzsignsignatureMaxlength < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureMaxlength when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureMaxlength)?'null':'"'.$iEzsignsignatureMaxlength.'"').' for iEzsignsignatureMaxlength when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignsignatureTextvalidationcustommessage) && (mb_strlen($sEzsignsignatureTextvalidationcustommessage) > 50)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsignsignatureTextvalidationcustommessage when calling EzsignsignatureResponse., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignsignatureTextvalidationcustommessage)?'null':'"'.$sEzsignsignatureTextvalidationcustommessage.'"').', invalid length for sEzsignsignatureTextvalidationcustommessage when calling EzsignsignatureResponse., must be smaller than or equal to 50.');
        }
        ...
        if (!is_null($sEzsignsignatureTextvalidationcustommessage) && (mb_strlen($sEzsignsignatureTextvalidationcustommessage) < 0)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsignsignatureTextvalidationcustommessage when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignsignatureTextvalidationcustommessage)?'null':'"'.$sEzsignsignatureTextvalidationcustommessage.'"').', invalid length for sEzsignsignatureTextvalidationcustommessage when calling EzsignsignatureResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignsignatureRegexp) && (!preg_match("/(*UTF8)^\\^.*\\$$|^$/", ObjectSerializer::toString($sEzsignsignatureRegexp)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignsignatureRegexp)?'null':'"'.$sEzsignsignatureRegexp.'"')." for sEzsignsignatureRegexp when calling EzsignsignatureResponse., must conform to the pattern /^\\^.*\\$$|^$/.");
        }
