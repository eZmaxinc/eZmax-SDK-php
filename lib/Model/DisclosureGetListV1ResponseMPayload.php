...
/**
 * DisclosureGetListV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /1/object/disclosure/getList
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DisclosureGetListV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'disclosure-getList-v1-Response-mPayload';
    ...
    protected static $openAPITypes = [
        'iRowReturned' => 'int',
        'iRowFiltered' => 'int',
        'aObjDisclosure' => '\eZmaxAPI\Model\DisclosureListElement[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'aObjDisclosure' => 'a_objDisclosure'
    ];
    ...
    protected static $setters = [
        ...
        'aObjDisclosure' => 'setAObjDisclosure'
    ];
    ...
    protected static $getters = [
        ...
        'aObjDisclosure' => 'getAObjDisclosure'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aObjDisclosure', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aObjDisclosure'] === null) {
            $invalidProperties[] = "'aObjDisclosure' can't be null";
        }
     ...
     * Gets aObjDisclosure
     *
     * @return \eZmaxAPI\Model\DisclosureListElement[]
     */
    public function getAObjDisclosure()
    {
	//return $this->container['aObjDisclosure'];
        return $this->container['aObjDisclosure'];
    }
     ...
     * Sets aObjDisclosure
     *
     * @param \eZmaxAPI\Model\DisclosureListElement[] $aObjDisclosure aObjDisclosure
     *
     * @return self
     */
    public function setAObjDisclosure($aObjDisclosure)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjDisclosure)) {
            //throw new \InvalidArgumentException('non-nullable aObjDisclosure cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjDisclosure'] = $aObjDisclosure;
        $this->container['aObjDisclosure'] = $aObjDisclosure;
