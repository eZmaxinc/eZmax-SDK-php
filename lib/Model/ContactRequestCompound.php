 ...
 * @link     https://openapi-generator.tech
 */
class ContactRequestCompound implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['objContactinformations'] = isset($data['objContactinformations']) ? $data['objContactinformations'] : null;
        $this->container['fkiContacttitleID'] = isset($data['fkiContacttitleID']) ? $data['fkiContacttitleID'] : null;
        ...
        $this->container['sContactCompany'] = isset($data['sContactCompany']) ? $data['sContactCompany'] : null;
        $this->container['dtContactBirthdate'] = isset($data['dtContactBirthdate']) ? $data['dtContactBirthdate'] : null;
    }
