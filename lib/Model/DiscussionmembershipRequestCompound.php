...
/**
 * DiscussionmembershipRequestCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class DiscussionmembershipRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'discussionmembership-RequestCompound';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['pkiDiscussionmembershipID']) && ($this->container['pkiDiscussionmembershipID'] > 16777215)) {
            $invalidProperties[] = "invalid value for 'pkiDiscussionmembershipID', must be smaller than or equal to 16777215.";
        }

        if (!is_null($this->container['pkiDiscussionmembershipID']) && ($this->container['pkiDiscussionmembershipID'] < 0)) {
     ...
     *
     * @param int|null $pkiDiscussionmembershipID The unique ID of the Discussionmembership
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiDiscussionmembershipID) && ($pkiDiscussionmembershipID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $pkiDiscussionmembershipID when calling DiscussionmembershipRequestCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiDiscussionmembershipID)?'null':'"'.$pkiDiscussionmembershipID.'"').' for pkiDiscussionmembershipID when calling DiscussionmembershipRequestCompound., must be smaller than or equal to 16777215.');
        }
        //if (($pkiDiscussionmembershipID < 0)) {
        if (!is_null($pkiDiscussionmembershipID) && ($pkiDiscussionmembershipID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiDiscussionmembershipID when calling DiscussionmembershipRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiDiscussionmembershipID)?'null':'"'.$pkiDiscussionmembershipID.'"').' for pkiDiscussionmembershipID when calling DiscussionmembershipRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiDiscussionID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDiscussionID when calling DiscussionmembershipRequestCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDiscussionID)?'null':'"'.$fkiDiscussionID.'"').' for fkiDiscussionID when calling DiscussionmembershipRequestCompound., must be smaller than or equal to 16777215.');
        }
        //if (($fkiDiscussionID < 0)) {
        if (($fkiDiscussionID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDiscussionID when calling DiscussionmembershipRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDiscussionID)?'null':'"'.$fkiDiscussionID.'"').' for fkiDiscussionID when calling DiscussionmembershipRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUserID) && ($fkiUserID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling DiscussionmembershipRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling DiscussionmembershipRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling DiscussionmembershipRequestCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling DiscussionmembershipRequestCompound., must be smaller than or equal to 255.');
        }
        //if (($fkiUsergroupID < 0)) {
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling DiscussionmembershipRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling DiscussionmembershipRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiModulesectionID) && ($fkiModulesectionID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiModulesectionID when calling DiscussionmembershipRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiModulesectionID)?'null':'"'.$fkiModulesectionID.'"').' for fkiModulesectionID when calling DiscussionmembershipRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtDiscussionmembershipJoined) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtDiscussionmembershipJoined)))) {
            //throw new \InvalidArgumentException("invalid value for \$dtDiscussionmembershipJoined when calling DiscussionmembershipRequestCompound., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtDiscussionmembershipJoined)?'null':'"'.$dtDiscussionmembershipJoined.'"')." for dtDiscussionmembershipJoined when calling DiscussionmembershipRequestCompound., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
