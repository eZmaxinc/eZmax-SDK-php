    ...
    */
	...
	//if (!is_null($this->container['sSvg']) && !preg_match("/^.{0,65535}$/", $this->container['sSvg'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sSvg', must be conform to the pattern /^.{0,65535}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sSvg'])?'null':'"'.$this->container['sSvg'].'"')." for 'sSvg', must be conform to the pattern /^.{0,65535}$/.";
        }
	...
	//if ((!preg_match("/^[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzsignsignatureCreditcardamount)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dEzsignsignatureCreditcardamount when calling EzsignsignatureSignV1Request., must conform to the pattern /^[\\d]{1,9}?\\.[\\d]{2}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzsignsignatureCreditcardamount)?'null':'"'.$dEzsignsignatureCreditcardamount.'"')." for dEzsignsignatureCreditcardamount when calling EzsignsignatureSignV1Request., must conform to the pattern /^[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
