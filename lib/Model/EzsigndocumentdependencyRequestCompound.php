...
/**
 * EzsigndocumentdependencyRequestCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigndocumentdependencyRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigndocumentdependency-RequestCompound';
    ...
    */
	...
	//if (($pkiEzsigndocumentdependencyID > 16777215)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigndocumentdependencyID when calling EzsigndocumentdependencyRequestCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndocumentdependencyID)?'null':'"'.$pkiEzsigndocumentdependencyID.'"').' for pkiEzsigndocumentdependencyID when calling EzsigndocumentdependencyRequestCompound., must be smaller than or equal to 16777215.');
        }
	//if (($pkiEzsigndocumentdependencyID < 0)) {
        if (!is_null($pkiEzsigndocumentdependencyID) && ($pkiEzsigndocumentdependencyID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigndocumentdependencyID when calling EzsigndocumentdependencyRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndocumentdependencyID)?'null':'"'.$pkiEzsigndocumentdependencyID.'"').' for pkiEzsigndocumentdependencyID when calling EzsigndocumentdependencyRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigndocumentIDdependency < 0)) {
        if (($fkiEzsigndocumentIDdependency < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigndocumentIDdependency when calling EzsigndocumentdependencyRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigndocumentIDdependency)?'null':'"'.$fkiEzsigndocumentIDdependency.'"').' for fkiEzsigndocumentIDdependency when calling EzsigndocumentdependencyRequestCompound., must be bigger than or equal to 0.');
        }
