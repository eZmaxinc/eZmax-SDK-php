...
/**
 * EzsigntemplatesignerResponseCompoundV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplatesignerResponseCompoundV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplatesigner-ResponseCompoundV3';
    ...
    protected static $openAPITypes = [
        ...
        'eEzsigntemplatesignerRole' => '\eZmaxAPI\Model\FieldEEzsigntemplatesignerRole',
    ...
    protected static $openAPIFormats = [
        ...
        'eEzsigntemplatesignerRole' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'eEzsigntemplatesignerRole' => false,
    ...
    protected static $attributeMap = [
        ...
        'eEzsigntemplatesignerRole' => 'eEzsigntemplatesignerRole',
    ...
    protected static $setters = [
        ...
        'eEzsigntemplatesignerRole' => 'setEEzsigntemplatesignerRole',
    ...
    protected static $getters = [
        ...
        'eEzsigntemplatesignerRole' => 'getEEzsigntemplatesignerRole',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('eEzsigntemplatesignerRole', $data ?? [], null);
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigntemplatesignerID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatesignerID when calling EzsigntemplatesignerResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatesignerID)?'null':'"'.$pkiEzsigntemplatesignerID.'"').' for pkiEzsigntemplatesignerID when calling EzsigntemplatesignerResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigntemplateID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplateID when calling EzsigntemplatesignerResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateID)?'null':'"'.$fkiEzsigntemplateID.'"').' for fkiEzsigntemplateID when calling EzsigntemplatesignerResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUserID) && ($fkiUserID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling EzsigntemplatesignerResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling EzsigntemplatesignerResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling EzsigntemplatesignerResponseCompoundV3., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling EzsigntemplatesignerResponseCompoundV3., must be smaller than or equal to 255.');
        }
        //if (($fkiUsergroupID < 0)) {
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling EzsigntemplatesignerResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling EzsigntemplatesignerResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzdoctemplatedocumentID) && ($fkiEzdoctemplatedocumentID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatedocumentID when calling EzsigntemplatesignerResponseCompoundV3., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatedocumentID)?'null':'"'.$fkiEzdoctemplatedocumentID.'"').' for fkiEzdoctemplatedocumentID when calling EzsigntemplatesignerResponseCompoundV3., must be smaller than or equal to 65535.');
        }
        //if (($fkiEzdoctemplatedocumentID < 0)) {
        if (!is_null($fkiEzdoctemplatedocumentID) && ($fkiEzdoctemplatedocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatedocumentID when calling EzsigntemplatesignerResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatedocumentID)?'null':'"'.$fkiEzdoctemplatedocumentID.'"').' for fkiEzdoctemplatedocumentID when calling EzsigntemplatesignerResponseCompoundV3., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets eEzsigntemplatesignerRole
     *
     * @return \eZmaxAPI\Model\FieldEEzsigntemplatesignerRole|null
     */
    public function getEEzsigntemplatesignerRole()
    {
	//return $this->container['eEzsigntemplatesignerRole'];
        return $this->container['eEzsigntemplatesignerRole'];
    }

    /**
     * Sets eEzsigntemplatesignerRole
     *
     * @param \eZmaxAPI\Model\FieldEEzsigntemplatesignerRole|null $eEzsigntemplatesignerRole eEzsigntemplatesignerRole
     *
     * @return self
     */
    public function setEEzsigntemplatesignerRole($eEzsigntemplatesignerRole)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($eEzsigntemplatesignerRole)) {
            //throw new \InvalidArgumentException('non-nullable eEzsigntemplatesignerRole cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['eEzsigntemplatesignerRole'] = $eEzsigntemplatesignerRole;
        $this->container['eEzsigntemplatesignerRole'] = $eEzsigntemplatesignerRole;
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatesignerDescription) && (!preg_match("/(*UTF8)^.{1,50}$/", ObjectSerializer::toString($sEzsigntemplatesignerDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatesignerDescription when calling EzsigntemplatesignerResponseCompoundV3., must conform to the pattern /^.{1,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatesignerDescription)?'null':'"'.$sEzsigntemplatesignerDescription.'"')." for sEzsigntemplatesignerDescription when calling EzsigntemplatesignerResponseCompoundV3., must conform to the pattern /^.{1,50}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUsergroupNameX) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sUsergroupNameX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUsergroupNameX when calling EzsigntemplatesignerResponseCompoundV3., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupNameX)?'null':'"'.$sUsergroupNameX.'"')." for sUsergroupNameX when calling EzsigntemplatesignerResponseCompoundV3., must conform to the pattern /^.{0,50}$/.");
        }
