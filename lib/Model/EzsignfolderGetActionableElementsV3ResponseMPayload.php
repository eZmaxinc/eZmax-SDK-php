...
/**
 * EzsignfolderGetActionableElementsV3ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /3/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsignfolderGetActionableElementsV3ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsignfolder-getActionableElements-v3-Response-mPayload';
