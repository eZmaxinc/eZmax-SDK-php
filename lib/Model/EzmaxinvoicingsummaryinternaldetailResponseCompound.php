...
class EzmaxinvoicingsummaryinternaldetailResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryinternaldetailCountreal']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryinternaldetailCountreal'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryinternaldetailCountreal'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryinternaldetailCountreal'].'"')." for 'dEzmaxinvoicingsummaryinternaldetailCountreal', must be conform to the pattern /^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryinternaldetailSubtotal']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryinternaldetailSubtotal'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryinternaldetailSubtotal'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryinternaldetailSubtotal'].'"')." for 'dEzmaxinvoicingsummaryinternaldetailSubtotal', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryinternaldetailRebate']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryinternaldetailRebate'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryinternaldetailRebate'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryinternaldetailRebate'].'"')." for 'dEzmaxinvoicingsummaryinternaldetailRebate', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryinternaldetailTotal']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryinternaldetailTotal'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryinternaldetailTotal'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryinternaldetailTotal'].'"')." for 'dEzmaxinvoicingsummaryinternaldetailTotal', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzmaxinvoicingsummaryinternaldetailID) && ($pkiEzmaxinvoicingsummaryinternaldetailID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzmaxinvoicingsummaryinternaldetailID)?'null':'"'.$pkiEzmaxinvoicingsummaryinternaldetailID.'"').' for pkiEzmaxinvoicingsummaryinternaldetailID when calling EzmaxinvoicingsummaryinternaldetailResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzmaxinvoicingsummaryinternalID) && ($fkiEzmaxinvoicingsummaryinternalID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxinvoicingsummaryinternalID)?'null':'"'.$fkiEzmaxinvoicingsummaryinternalID.'"').' for fkiEzmaxinvoicingsummaryinternalID when calling EzmaxinvoicingsummaryinternaldetailResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzmaxproductID < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxproductID)?'null':'"'.$fkiEzmaxproductID.'"').' for fkiEzmaxproductID when calling EzmaxinvoicingsummaryinternaldetailResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiBillingentityexternalID < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBillingentityexternalID)?'null':'"'.$fkiBillingentityexternalID.'"').' for fkiBillingentityexternalID when calling EzmaxinvoicingsummaryinternaldetailResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//return $this->container['dEzmaxinvoicingsummaryinternaldetailCountreal'];
        return is_null($this->container['dEzmaxinvoicingsummaryinternaldetailCountreal']) ? null : trim($this->container['dEzmaxinvoicingsummaryinternaldetailCountreal']);
    }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if ((!preg_match("/^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryinternaldetailCountreal)))) {
        if (!is_null($dEzmaxinvoicingsummaryinternaldetailCountreal) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryinternaldetailCountreal)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryinternaldetailCountreal)?'null':'"'.$dEzmaxinvoicingsummaryinternaldetailCountreal.'"')." for dEzmaxinvoicingsummaryinternaldetailCountreal when calling EzmaxinvoicingsummaryinternaldetailResponseCompound., must conform to the pattern /^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/.");
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['dEzmaxinvoicingsummaryinternaldetailCountreal'] = $dEzmaxinvoicingsummaryinternaldetailCountreal;
        $this->container['dEzmaxinvoicingsummaryinternaldetailCountreal'] = (is_null($dEzmaxinvoicingsummaryinternaldetailCountreal) ? null : trim((string) $dEzmaxinvoicingsummaryinternaldetailCountreal));
	...
	//return $this->container['dEzmaxinvoicingsummaryinternaldetailSubtotal'];
        return is_null($this->container['dEzmaxinvoicingsummaryinternaldetailSubtotal']) ? null : trim($this->container['dEzmaxinvoicingsummaryinternaldetailSubtotal']);
    }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryinternaldetailSubtotal)))) {
        if (!is_null($dEzmaxinvoicingsummaryinternaldetailSubtotal) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryinternaldetailSubtotal)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryinternaldetailSubtotal)?'null':'"'.$dEzmaxinvoicingsummaryinternaldetailSubtotal.'"')." for dEzmaxinvoicingsummaryinternaldetailSubtotal when calling EzmaxinvoicingsummaryinternaldetailResponseCompound., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['dEzmaxinvoicingsummaryinternaldetailSubtotal'] = $dEzmaxinvoicingsummaryinternaldetailSubtotal;
        $this->container['dEzmaxinvoicingsummaryinternaldetailSubtotal'] = (is_null($dEzmaxinvoicingsummaryinternaldetailSubtotal) ? null : trim((string) $dEzmaxinvoicingsummaryinternaldetailSubtotal));
	...
	//return $this->container['dEzmaxinvoicingsummaryinternaldetailRebate'];
        return is_null($this->container['dEzmaxinvoicingsummaryinternaldetailRebate']) ? null : trim($this->container['dEzmaxinvoicingsummaryinternaldetailRebate']);
    }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryinternaldetailRebate)))) {
        if (!is_null($dEzmaxinvoicingsummaryinternaldetailRebate) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryinternaldetailRebate)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryinternaldetailRebate)?'null':'"'.$dEzmaxinvoicingsummaryinternaldetailRebate.'"')." for dEzmaxinvoicingsummaryinternaldetailRebate when calling EzmaxinvoicingsummaryinternaldetailResponseCompound., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['dEzmaxinvoicingsummaryinternaldetailRebate'] = $dEzmaxinvoicingsummaryinternaldetailRebate;
        $this->container['dEzmaxinvoicingsummaryinternaldetailRebate'] = (is_null($dEzmaxinvoicingsummaryinternaldetailRebate) ? null : trim((string) $dEzmaxinvoicingsummaryinternaldetailRebate));
	...
	//return $this->container['dEzmaxinvoicingsummaryinternaldetailTotal'];
        return is_null($this->container['dEzmaxinvoicingsummaryinternaldetailTotal']) ? null : trim($this->container['dEzmaxinvoicingsummaryinternaldetailTotal']);
    }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryinternaldetailTotal)))) {
        if (!is_null($dEzmaxinvoicingsummaryinternaldetailTotal) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryinternaldetailTotal)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryinternaldetailTotal)?'null':'"'.$dEzmaxinvoicingsummaryinternaldetailTotal.'"')." for dEzmaxinvoicingsummaryinternaldetailTotal when calling EzmaxinvoicingsummaryinternaldetailResponseCompound., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['dEzmaxinvoicingsummaryinternaldetailTotal'] = $dEzmaxinvoicingsummaryinternaldetailTotal;
        $this->container['dEzmaxinvoicingsummaryinternaldetailTotal'] = (is_null($dEzmaxinvoicingsummaryinternaldetailTotal) ? null : trim((string) $dEzmaxinvoicingsummaryinternaldetailTotal));
