...
class EzsigntemplateelementdependencyResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigntemplateelementdependencyID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplateelementdependencyID when calling EzsigntemplateelementdependencyResponseCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateelementdependencyID)?'null':'"'.$pkiEzsigntemplateelementdependencyID.'"').' for pkiEzsigntemplateelementdependencyID when calling EzsigntemplateelementdependencyResponseCompound., must be smaller than or equal to 16777215.');
        }
