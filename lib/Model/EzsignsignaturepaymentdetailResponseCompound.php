...
/**
 * EzsignsignaturepaymentdetailResponseCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignsignaturepaymentdetailResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignsignaturepaymentdetail-ResponseCompound';
    ...
    */
	...
	//if (($pkiEzsignsignaturepaymentdetailID > 65535)) {
        if (($pkiEzsignsignaturepaymentdetailID > 65535)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignaturepaymentdetailID when calling EzsignsignaturepaymentdetailResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignaturepaymentdetailID)?'null':'"'.$pkiEzsignsignaturepaymentdetailID.'"').' for pkiEzsignsignaturepaymentdetailID when calling EzsignsignaturepaymentdetailResponseCompound., must be smaller than or equal to 65535.');
        }
	//if (($pkiEzsignsignaturepaymentdetailID < 0)) {
        if (($pkiEzsignsignaturepaymentdetailID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignaturepaymentdetailID when calling EzsignsignaturepaymentdetailResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignaturepaymentdetailID)?'null':'"'.$pkiEzsignsignaturepaymentdetailID.'"').' for pkiEzsignsignaturepaymentdetailID when calling EzsignsignaturepaymentdetailResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiGlaccountcontainerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiGlaccountcontainerID when calling EzsignsignaturepaymentdetailResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiGlaccountcontainerID)?'null':'"'.$fkiGlaccountcontainerID.'"').' for fkiGlaccountcontainerID when calling EzsignsignaturepaymentdetailResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzsignsignaturepaymentdetailAmount)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dEzsignsignaturepaymentdetailAmount when calling EzsignsignaturepaymentdetailResponseCompound., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzsignsignaturepaymentdetailAmount)?'null':'"'.$dEzsignsignaturepaymentdetailAmount.'"')." for dEzsignsignaturepaymentdetailAmount when calling EzsignsignaturepaymentdetailResponseCompound., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
