    ...
    */
	...
	//if (($pkiEzsignpageID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignpageID when calling EzsignpageResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignpageID)?'null':'"'.$pkiEzsignpageID.'"').' for pkiEzsignpageID when calling EzsignpageResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignpageWidthimage < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignpageWidthimage when calling EzsignpageResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignpageWidthimage)?'null':'"'.$iEzsignpageWidthimage.'"').' for iEzsignpageWidthimage when calling EzsignpageResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignpageHeightimage < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignpageHeightimage when calling EzsignpageResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignpageHeightimage)?'null':'"'.$iEzsignpageHeightimage.'"').' for iEzsignpageHeightimage when calling EzsignpageResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignpageWidthpdf < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignpageWidthpdf when calling EzsignpageResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignpageWidthpdf)?'null':'"'.$iEzsignpageWidthpdf.'"').' for iEzsignpageWidthpdf when calling EzsignpageResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignpageHeightpdf < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignpageHeightpdf when calling EzsignpageResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignpageHeightpdf)?'null':'"'.$iEzsignpageHeightpdf.'"').' for iEzsignpageHeightpdf when calling EzsignpageResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignpagePagenumber < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignpagePagenumber when calling EzsignpageResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignpagePagenumber)?'null':'"'.$iEzsignpagePagenumber.'"').' for iEzsignpagePagenumber when calling EzsignpageResponseCompound., must be bigger than or equal to 1.');
        }
