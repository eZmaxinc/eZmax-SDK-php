...
/**
 * SupplierGetListV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /1/object/supplier/getList
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SupplierGetListV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'supplier-getList-v1-Response-mPayload';
    ...
    protected static $openAPITypes = [
        'iRowReturned' => 'int',
        'iRowFiltered' => 'int',
        'aObjSupplier' => '\eZmaxAPI\Model\SupplierListElement[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aObjSupplier', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aObjSupplier'] === null) {
            $invalidProperties[] = "'aObjSupplier' can't be null";
        }
     ...
     * Gets aObjSupplier
     *
     * @return \eZmaxAPI\Model\SupplierListElement[]
     */
    public function getAObjSupplier()
    {
	//return $this->container['aObjSupplier'];
        return $this->container['aObjSupplier'];
    }
     ...
     * Sets aObjSupplier
     *
     * @param \eZmaxAPI\Model\SupplierListElement[] $aObjSupplier aObjSupplier
     *
     * @return self
     */
    public function setAObjSupplier($aObjSupplier)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjSupplier)) {
            //throw new \InvalidArgumentException('non-nullable aObjSupplier cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjSupplier'] = $aObjSupplier;
        $this->container['aObjSupplier'] = $aObjSupplier;
