...
/**
 * EzsigntemplateformfieldgroupsignerRequestCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplateformfieldgroupsignerRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigntemplateformfieldgroupsigner-RequestCompound';
    ...
    */
	...
	//if (($pkiEzsigntemplateformfieldgroupsignerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplateformfieldgroupsignerID when calling EzsigntemplateformfieldgroupsignerRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateformfieldgroupsignerID)?'null':'"'.$pkiEzsigntemplateformfieldgroupsignerID.'"').' for pkiEzsigntemplateformfieldgroupsignerID when calling EzsigntemplateformfieldgroupsignerRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatesignerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatesignerID when calling EzsigntemplateformfieldgroupsignerRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatesignerID)?'null':'"'.$fkiEzsigntemplatesignerID.'"').' for fkiEzsigntemplatesignerID when calling EzsigntemplateformfieldgroupsignerRequestCompound., must be bigger than or equal to 0.');
        }
