...
class WebhookRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'aObjWebhookheader' => '\eZmaxAPI\Model\WebhookheaderRequestCompound[]'
    ];
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiAuthenticationexternalID) && ($fkiAuthenticationexternalID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiAuthenticationexternalID when calling WebhookRequestCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAuthenticationexternalID)?'null':'"'.$fkiAuthenticationexternalID.'"').' for fkiAuthenticationexternalID when calling WebhookRequestCompound., must be smaller than or equal to 255.');
        }
        //if (($fkiAuthenticationexternalID < 0)) {
        if (!is_null($fkiAuthenticationexternalID) && ($fkiAuthenticationexternalID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiAuthenticationexternalID when calling WebhookRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAuthenticationexternalID)?'null':'"'.$fkiAuthenticationexternalID.'"').' for fkiAuthenticationexternalID when calling WebhookRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignfoldertypeID) && ($fkiEzsignfoldertypeID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling WebhookRequestCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling WebhookRequestCompound., must be smaller than or equal to 65535.');
        }
        ...
        if (!is_null($fkiEzsignfoldertypeID) && ($fkiEzsignfoldertypeID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling WebhookRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sWebhookUrl) && (!preg_match("/(*UTF8)^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/", ObjectSerializer::toString($sWebhookUrl)))) {
            //throw new \InvalidArgumentException("invalid value for \$sWebhookUrl when calling WebhookRequestCompound., must conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sWebhookUrl)?'null':'"'.$sWebhookUrl.'"')." for sWebhookUrl when calling WebhookRequestCompound., must conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.");
        }
     ...
     *
     * @return \eZmaxAPI\Model\WebhookheaderRequestCompound[]|null
     */
     ...
     *
     * @param \eZmaxAPI\Model\WebhookheaderRequestCompound[]|null $aObjWebhookheader aObjWebhookheader
     *
     * @return self
     */
