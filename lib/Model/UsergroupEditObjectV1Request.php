...
/**
 * UsergroupEditObjectV1Request Class Doc Comment
 *
 * @category Class
 ...
 */
class UsergroupEditObjectV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'usergroup-editObject-v1-Request';
    ...
    protected static $openAPITypes = [
        'objUsergroup' => '\eZmaxAPI\Model\UsergroupRequestCompound'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['objUsergroup'] === null) {
            $invalidProperties[] = "'objUsergroup' can't be null";
        }
     ...
     * Sets objUsergroup
     *
     * @param \eZmaxAPI\Model\UsergroupRequestCompound $objUsergroup objUsergroup
     *
     * @return self
     */
