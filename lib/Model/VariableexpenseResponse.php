...
class VariableexpenseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiVariableexpenseID > 255)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiVariableexpenseID)?'null':'"'.$pkiVariableexpenseID.'"').' for pkiVariableexpenseID when calling VariableexpenseResponse., must be smaller than or equal to 255.');
        }
        ...
        if (($pkiVariableexpenseID < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiVariableexpenseID)?'null':'"'.$pkiVariableexpenseID.'"').' for pkiVariableexpenseID when calling VariableexpenseResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sVariableexpenseCode) && (!preg_match("/(*UTF8)^.{0,5}$/", ObjectSerializer::toString($sVariableexpenseCode)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sVariableexpenseCode)?'null':'"'.$sVariableexpenseCode.'"')." for sVariableexpenseCode when calling VariableexpenseResponse., must conform to the pattern /^.{0,5}$/.");
        }
