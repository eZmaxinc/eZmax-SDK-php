    ...
    */
	...
	//if (!is_null($this->container['sPhoneE164Cell']) && !preg_match("/^\\+[1-9]\\d{1,14}$/", $this->container['sPhoneE164Cell'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sPhoneE164Cell', must be conform to the pattern /^\\+[1-9]\\d{1,14}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sPhoneE164Cell'])?'null':'"'.$this->container['sPhoneE164Cell'].'"')." for 'sPhoneE164Cell', must be conform to the pattern /^\\+[1-9]\\d{1,14}$/.";
        }
	...
	//if (($pkiContactID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiContactID when calling EzsignsignerResponseCompoundContact., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiContactID)?'null':'"'.$pkiContactID.'"').' for pkiContactID when calling EzsignsignerResponseCompoundContact., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{1,20}$/", ObjectSerializer::toString($sContactFirstname)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sContactFirstname when calling EzsignsignerResponseCompoundContact., must conform to the pattern /^.{1,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sContactFirstname)?'null':'"'.$sContactFirstname.'"')." for sContactFirstname when calling EzsignsignerResponseCompoundContact., must conform to the pattern /^.{1,20}$/.");
        }
	...
	//if ((!preg_match("/^.{1,25}$/", ObjectSerializer::toString($sContactLastname)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sContactLastname when calling EzsignsignerResponseCompoundContact., must conform to the pattern /^.{1,25}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sContactLastname)?'null':'"'.$sContactLastname.'"')." for sContactLastname when calling EzsignsignerResponseCompoundContact., must conform to the pattern /^.{1,25}$/.");
        }
	...
	//if (($fkiLanguageID > 2)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsignsignerResponseCompoundContact., must be smaller than or equal to 2.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsignsignerResponseCompoundContact., must be smaller than or equal to 2.');
        }
	//if (($fkiLanguageID < 1)) {
        if (($fkiLanguageID < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsignsignerResponseCompoundContact., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsignsignerResponseCompoundContact., must be bigger than or equal to 1.');
        }
	...
	//if ((!preg_match("/^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddress)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEmailAddress when calling EzsignsignerResponseCompoundContact., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEmailAddress)?'null':'"'.$sEmailAddress.'"')." for sEmailAddress when calling EzsignsignerResponseCompoundContact., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
        }
	...
	//if ((!preg_match("/^\\+[1-9]\\d{1,14}$/", ObjectSerializer::toString($sPhoneE164)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sPhoneE164 when calling EzsignsignerResponseCompoundContact., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sPhoneE164)?'null':'"'.$sPhoneE164.'"')." for sPhoneE164 when calling EzsignsignerResponseCompoundContact., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
	...
	//if ((!preg_match("/^\\+[1-9]\\d{1,14}$/", ObjectSerializer::toString($sPhoneE164Cell)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sPhoneE164Cell when calling EzsignsignerResponseCompoundContact., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sPhoneE164Cell)?'null':'"'.$sPhoneE164Cell.'"')." for sPhoneE164Cell when calling EzsignsignerResponseCompoundContact., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
