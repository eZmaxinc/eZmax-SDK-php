...
class EzsignfolderBatchDownloadV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aEDocumentType', $data ?? [], null);
    }
    ...
    */
	...
	//if ((count($this->container['aEDocumentType']) < 1)) {
        if (!is_null($this->container['aEDocumentType']) && (count($this->container['aEDocumentType']) < 1)) {
            $invalidProperties[] = "invalid value for 'aEDocumentType', number of items must be greater than or equal to 1.";
        }
	...
	//if ((count($aEDocumentType) < 1)) {
        if ((count($aEDocumentType) < 1)) {
            //throw new \InvalidArgumentException('invalid length for $aEDocumentType when calling EzsignfolderBatchDownloadV1Request., number of items must be greater than or equal to 1.');
	    throw new \InvalidArgumentException('invalid length for aEDocumentType when calling EzsignfolderBatchDownloadV1Request., number of items must be greater than or equal to 1.');
        }
