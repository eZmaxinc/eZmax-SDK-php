...
class EzsigntemplateformfieldResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigntemplateformfieldID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateformfieldID)?'null':'"'.$pkiEzsigntemplateformfieldID.'"').' for pkiEzsigntemplateformfieldID when calling EzsigntemplateformfieldResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplatedocumentpagePagenumber < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagePagenumber)?'null':'"'.$iEzsigntemplatedocumentpagePagenumber.'"').' for iEzsigntemplatedocumentpagePagenumber when calling EzsigntemplateformfieldResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplateformfieldX) && ($iEzsigntemplateformfieldX < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldX)?'null':'"'.$iEzsigntemplateformfieldX.'"').' for iEzsigntemplateformfieldX when calling EzsigntemplateformfieldResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplateformfieldY) && ($iEzsigntemplateformfieldY < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldY)?'null':'"'.$iEzsigntemplateformfieldY.'"').' for iEzsigntemplateformfieldY when calling EzsigntemplateformfieldResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplateformfieldWidth < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldWidth)?'null':'"'.$iEzsigntemplateformfieldWidth.'"').' for iEzsigntemplateformfieldWidth when calling EzsigntemplateformfieldResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplateformfieldHeight < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldHeight)?'null':'"'.$iEzsigntemplateformfieldHeight.'"').' for iEzsigntemplateformfieldHeight when calling EzsigntemplateformfieldResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplateformfieldPositioningpattern) && (!preg_match("/(*UTF8)^.{0,30}$/", ObjectSerializer::toString($sEzsigntemplateformfieldPositioningpattern)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplateformfieldPositioningpattern)?'null':'"'.$sEzsigntemplateformfieldPositioningpattern.'"')." for sEzsigntemplateformfieldPositioningpattern when calling EzsigntemplateformfieldResponse., must conform to the pattern /^.{0,30}$/.");
        }
