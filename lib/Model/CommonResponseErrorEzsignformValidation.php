...
class CommonResponseErrorEzsignformValidation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Common-Response-Error-EzsignformValidation';
     ...
     *
     * @return \eZmaxAPI\Model\CustomEzsignformfielderrorResponse[]
     */
    public function getAObjEzsignformfielderror()
    {
	//return $this->container['aObjEzsignformfielderror'];
        return $this->container['aObjEzsignformfielderror'];
    }

    /**
     * Sets aObjEzsignformfielderror
     *
     * @param \eZmaxAPI\Model\CustomEzsignformfielderrorResponse[] $aObjEzsignformfielderror 
     *
     * @return self
     */
    public function setAObjEzsignformfielderror($aObjEzsignformfielderror)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjEzsignformfielderror)) {
            //throw new \InvalidArgumentException('non-nullable aObjEzsignformfielderror cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjEzsignformfielderror'] = $aObjEzsignformfielderror;
        $this->container['aObjEzsignformfielderror'] = $aObjEzsignformfielderror;
