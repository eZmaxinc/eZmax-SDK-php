...
/**
 * CustomEzsignfoldersignerassociationstatusResponseV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomEzsignfoldersignerassociationstatusResponseV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Custom-Ezsignfoldersignerassociationstatus-ResponseV3';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsignfoldersignerassociationID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldersignerassociationID when calling CustomEzsignfoldersignerassociationstatusResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationID)?'null':'"'.$fkiEzsignfoldersignerassociationID.'"').' for fkiEzsignfoldersignerassociationID when calling CustomEzsignfoldersignerassociationstatusResponseV3., must be bigger than or equal to 0.');
        }
