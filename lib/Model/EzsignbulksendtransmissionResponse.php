    ...
    */
	...
	//if (($pkiEzsignbulksendtransmissionID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignbulksendtransmissionID when calling EzsignbulksendtransmissionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignbulksendtransmissionID)?'null':'"'.$pkiEzsignbulksendtransmissionID.'"').' for pkiEzsignbulksendtransmissionID when calling EzsignbulksendtransmissionResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignbulksendID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignbulksendID when calling EzsignbulksendtransmissionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignbulksendID)?'null':'"'.$fkiEzsignbulksendID.'"').' for fkiEzsignbulksendID when calling EzsignbulksendtransmissionResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignbulksendtransmissionErrors < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignbulksendtransmissionErrors when calling EzsignbulksendtransmissionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignbulksendtransmissionErrors)?'null':'"'.$iEzsignbulksendtransmissionErrors.'"').' for iEzsignbulksendtransmissionErrors when calling EzsignbulksendtransmissionResponse., must be bigger than or equal to 0.');
        }
