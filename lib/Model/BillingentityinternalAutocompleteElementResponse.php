    ...
    */
	...
	//if (($pkiBillingentityinternalID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiBillingentityinternalID when calling BillingentityinternalAutocompleteElementResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiBillingentityinternalID)?'null':'"'.$pkiBillingentityinternalID.'"').' for pkiBillingentityinternalID when calling BillingentityinternalAutocompleteElementResponse., must be bigger than or equal to 0.');
        }
