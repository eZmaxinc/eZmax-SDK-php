...
class SystemconfigurationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'systemconfiguration-Response';
    ...
    protected static $openAPITypes = [
        ...
        'bSystemconfigurationHascreditcardmerchant' => 'bool',
        'bSystemconfigurationIsdisposalactive' => 'bool',
        'bSystemconfigurationAllowcomplexcreditcardsignature' => 'bool',
    ...
    protected static $openAPIFormats = [
        ...
        'fkiBrandingID' => null,
        'fkiTimezoneIDDefault' => null,
        'sTimezoneNameDefault' => null,
        ...
        'bSystemconfigurationHascreditcardmerchant' => null,
        'bSystemconfigurationIsdisposalactive' => null,
        'bSystemconfigurationAllowcomplexcreditcardsignature' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'fkiBrandingID' => false,
        'fkiTimezoneIDDefault' => false,
        'sTimezoneNameDefault' => false,
        ...
        'bSystemconfigurationHascreditcardmerchant' => false,
        'bSystemconfigurationIsdisposalactive' => false,
        'bSystemconfigurationAllowcomplexcreditcardsignature' => false,
    ...
    protected static $attributeMap = [
        ...
        'bSystemconfigurationIsdisposalactive' => 'bSystemconfigurationIsdisposalactive',
        'bSystemconfigurationAllowcomplexcreditcardsignature' => 'bSystemconfigurationAllowcomplexcreditcardsignature',
    ...
    protected static $setters = [
        ...
        'fkiTimezoneIDDefault' => 'setFkiTimezoneIDDefault',
        'sTimezoneNameDefault' => 'setSTimezoneNameDefault',
        ...
        'bSystemconfigurationHascreditcardmerchant' => 'setBSystemconfigurationHascreditcardmerchant',
        'bSystemconfigurationIsdisposalactive' => 'setBSystemconfigurationIsdisposalactive',
        'bSystemconfigurationAllowcomplexcreditcardsignature' => 'setBSystemconfigurationAllowcomplexcreditcardsignature',
    ...
    protected static $getters = [
        ...
        'fkiTimezoneIDDefault' => 'getFkiTimezoneIDDefault',
        'sTimezoneNameDefault' => 'getSTimezoneNameDefault',
        ...
        'bSystemconfigurationHascreditcardmerchant' => 'getBSystemconfigurationHascreditcardmerchant',
        'bSystemconfigurationIsdisposalactive' => 'getBSystemconfigurationIsdisposalactive',
        'bSystemconfigurationAllowcomplexcreditcardsignature' => 'getBSystemconfigurationAllowcomplexcreditcardsignature',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('fkiTimezoneIDDefault', $data ?? [], null);
        $this->setIfExists('sTimezoneNameDefault', $data ?? [], null);
        ...
        $this->setIfExists('bSystemconfigurationHascreditcardmerchant', $data ?? [], null);
        $this->setIfExists('bSystemconfigurationIsdisposalactive', $data ?? [], null);
        $this->setIfExists('bSystemconfigurationAllowcomplexcreditcardsignature', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fkiTimezoneIDDefault'] === null) {
            $invalidProperties[] = "'fkiTimezoneIDDefault' can't be null";
        }
        if (($this->container['fkiTimezoneIDDefault'] < 0)) {
            $invalidProperties[] = "invalid value for 'fkiTimezoneIDDefault', must be bigger than or equal to 0.";
        }

        if ($this->container['sTimezoneNameDefault'] === null) {
            $invalidProperties[] = "'sTimezoneNameDefault' can't be null";
        }
        ...
        if (!is_null($this->container['iSystemconfigurationEzsignreminderhoursend']) && ($this->container['iSystemconfigurationEzsignreminderhoursend'] > 23)) {
            $invalidProperties[] = "invalid value for 'iSystemconfigurationEzsignreminderhoursend', must be smaller than or equal to 23.";
        }

        if (!is_null($this->container['iSystemconfigurationEzsignreminderhoursend']) && ($this->container['iSystemconfigurationEzsignreminderhoursend'] < 0)) {
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiSystemconfigurationID > 1)) {
            //throw new \InvalidArgumentException('invalid value for $pkiSystemconfigurationID when calling SystemconfigurationResponse., must be smaller than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSystemconfigurationID)?'null':'"'.$pkiSystemconfigurationID.'"').' for pkiSystemconfigurationID when calling SystemconfigurationResponse., must be smaller than or equal to 1.');
        }
        //if (($pkiSystemconfigurationID < 1)) {
        if (($pkiSystemconfigurationID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $pkiSystemconfigurationID when calling SystemconfigurationResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSystemconfigurationID)?'null':'"'.$pkiSystemconfigurationID.'"').' for pkiSystemconfigurationID when calling SystemconfigurationResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiSystemconfigurationtypeID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiSystemconfigurationtypeID when calling SystemconfigurationResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiSystemconfigurationtypeID)?'null':'"'.$fkiSystemconfigurationtypeID.'"').' for fkiSystemconfigurationtypeID when calling SystemconfigurationResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiBrandingID) && ($fkiBrandingID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBrandingID when calling SystemconfigurationResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBrandingID)?'null':'"'.$fkiBrandingID.'"').' for fkiBrandingID when calling SystemconfigurationResponse., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets fkiTimezoneIDDefault
     *
     * @return int
     */
    public function getFkiTimezoneIDDefault()
    {
	//return $this->container['fkiTimezoneIDDefault'];
        return $this->container['fkiTimezoneIDDefault'];
    }

    /**
     * Sets fkiTimezoneIDDefault
     *
     * @param int $fkiTimezoneIDDefault The unique ID of the Timezone
     *
     * @return self
     */
    public function setFkiTimezoneIDDefault($fkiTimezoneIDDefault)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($fkiTimezoneIDDefault)) {
            //throw new \InvalidArgumentException('non-nullable fkiTimezoneIDDefault cannot be null');
        //}
        //if (($fkiTimezoneIDDefault < 0)) {
        if (($fkiTimezoneIDDefault < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiTimezoneIDDefault when calling SystemconfigurationResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiTimezoneIDDefault)?'null':'"'.$fkiTimezoneIDDefault.'"').' for fkiTimezoneIDDefault when calling SystemconfigurationResponse., must be bigger than or equal to 0.');
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['fkiTimezoneIDDefault'] = $fkiTimezoneIDDefault;
        $this->container['fkiTimezoneIDDefault'] = (is_null($fkiTimezoneIDDefault) ? null : (int) $fkiTimezoneIDDefault);

        return $this;
    }

    /**
     * Gets sTimezoneNameDefault
     *
     * @return string
     */
    public function getSTimezoneNameDefault()
    {
	//return $this->container['sTimezoneNameDefault'];
        return is_null($this->container['sTimezoneNameDefault']) ? null : trim($this->container['sTimezoneNameDefault']);
    }

    /**
     * Sets sTimezoneNameDefault
     *
     * @param string $sTimezoneNameDefault The description of the Timezone
     *
     * @return self
     */
    public function setSTimezoneNameDefault($sTimezoneNameDefault)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($sTimezoneNameDefault)) {
            //throw new \InvalidArgumentException('non-nullable sTimezoneNameDefault cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['sTimezoneNameDefault'] = $sTimezoneNameDefault;
        $this->container['sTimezoneNameDefault'] = (is_null($sTimezoneNameDefault) ? null : trim((string) $sTimezoneNameDefault));
    ...
    /**
     * Gets bSystemconfigurationHascreditcardmerchant
     *
     * @return bool|null
     */
    public function getBSystemconfigurationHascreditcardmerchant()
    {
	//return $this->container['bSystemconfigurationHascreditcardmerchant'];
        return $this->container['bSystemconfigurationHascreditcardmerchant'];
    }

    /**
     * Sets bSystemconfigurationHascreditcardmerchant
     *
     * @param bool|null $bSystemconfigurationHascreditcardmerchant Whether there is a creditcard merchant configured or not
     *
     * @return self
     */
    public function setBSystemconfigurationHascreditcardmerchant($bSystemconfigurationHascreditcardmerchant)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($bSystemconfigurationHascreditcardmerchant)) {
            //throw new \InvalidArgumentException('non-nullable bSystemconfigurationHascreditcardmerchant cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['bSystemconfigurationHascreditcardmerchant'] = $bSystemconfigurationHascreditcardmerchant;
        $this->container['bSystemconfigurationHascreditcardmerchant'] = (is_null($bSystemconfigurationHascreditcardmerchant) ? null : (bool) $bSystemconfigurationHascreditcardmerchant);

        return $this;
    }

    /**
     * Gets bSystemconfigurationIsdisposalactive
     *
     * @return bool|null
     */
    public function getBSystemconfigurationIsdisposalactive()
    {
	//return $this->container['bSystemconfigurationIsdisposalactive'];
        return $this->container['bSystemconfigurationIsdisposalactive'];
    }

    /**
     * Sets bSystemconfigurationIsdisposalactive
     *
     * @param bool|null $bSystemconfigurationIsdisposalactive Whether is Disposal processus is active or not
     *
     * @return self
     */
    public function setBSystemconfigurationIsdisposalactive($bSystemconfigurationIsdisposalactive)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($bSystemconfigurationIsdisposalactive)) {
            //throw new \InvalidArgumentException('non-nullable bSystemconfigurationIsdisposalactive cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['bSystemconfigurationIsdisposalactive'] = $bSystemconfigurationIsdisposalactive;
        $this->container['bSystemconfigurationIsdisposalactive'] = (is_null($bSystemconfigurationIsdisposalactive) ? null : (bool) $bSystemconfigurationIsdisposalactive);

        return $this;
    }

    /**
     * Gets bSystemconfigurationAllowcomplexcreditcardsignature
     *
     * @return bool|null
     */
    public function getBSystemconfigurationAllowcomplexcreditcardsignature()
    {
	//return $this->container['bSystemconfigurationAllowcomplexcreditcardsignature'];
        return $this->container['bSystemconfigurationAllowcomplexcreditcardsignature'];
    }

    /**
     * Sets bSystemconfigurationAllowcomplexcreditcardsignature
     *
     * @param bool|null $bSystemconfigurationAllowcomplexcreditcardsignature Whether is the system allows to have a complex creditcard signature
     *
     * @return self
     */
    public function setBSystemconfigurationAllowcomplexcreditcardsignature($bSystemconfigurationAllowcomplexcreditcardsignature)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($bSystemconfigurationAllowcomplexcreditcardsignature)) {
            //throw new \InvalidArgumentException('non-nullable bSystemconfigurationAllowcomplexcreditcardsignature cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['bSystemconfigurationAllowcomplexcreditcardsignature'] = $bSystemconfigurationAllowcomplexcreditcardsignature;
        $this->container['bSystemconfigurationAllowcomplexcreditcardsignature'] = (is_null($bSystemconfigurationAllowcomplexcreditcardsignature) ? null : (bool) $bSystemconfigurationAllowcomplexcreditcardsignature);
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtSystemconfigurationReadonlyexpirationstart) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", ObjectSerializer::toString($dtSystemconfigurationReadonlyexpirationstart)))) {
            //throw new \InvalidArgumentException("invalid value for \$dtSystemconfigurationReadonlyexpirationstart when calling SystemconfigurationResponse., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtSystemconfigurationReadonlyexpirationstart)?'null':'"'.$dtSystemconfigurationReadonlyexpirationstart.'"')." for dtSystemconfigurationReadonlyexpirationstart when calling SystemconfigurationResponse., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtSystemconfigurationReadonlyexpirationend) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", ObjectSerializer::toString($dtSystemconfigurationReadonlyexpirationend)))) {
            //throw new \InvalidArgumentException("invalid value for \$dtSystemconfigurationReadonlyexpirationend when calling SystemconfigurationResponse., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtSystemconfigurationReadonlyexpirationend)?'null':'"'.$dtSystemconfigurationReadonlyexpirationend.'"')." for dtSystemconfigurationReadonlyexpirationend when calling SystemconfigurationResponse., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
        }
     ...
     *
     * @param int|null $iSystemconfigurationEzsignreminderhoursend The hour we will send the eZsign reminders
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iSystemconfigurationEzsignreminderhoursend) && ($iSystemconfigurationEzsignreminderhoursend > 23)) {
            //throw new \InvalidArgumentException('invalid value for $iSystemconfigurationEzsignreminderhoursend when calling SystemconfigurationResponse., must be smaller than or equal to 23.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iSystemconfigurationEzsignreminderhoursend)?'null':'"'.$iSystemconfigurationEzsignreminderhoursend.'"').' for iSystemconfigurationEzsignreminderhoursend when calling SystemconfigurationResponse., must be smaller than or equal to 23.');
        }
        //if (($iSystemconfigurationEzsignreminderhoursend < 0)) {
        if (!is_null($iSystemconfigurationEzsignreminderhoursend) && ($iSystemconfigurationEzsignreminderhoursend < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iSystemconfigurationEzsignreminderhoursend when calling SystemconfigurationResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iSystemconfigurationEzsignreminderhoursend)?'null':'"'.$iSystemconfigurationEzsignreminderhoursend.'"').' for iSystemconfigurationEzsignreminderhoursend when calling SystemconfigurationResponse., must be bigger than or equal to 0.');
        }
