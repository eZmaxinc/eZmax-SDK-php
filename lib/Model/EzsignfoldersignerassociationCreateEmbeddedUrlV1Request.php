...
/**
 * EzsignfoldersignerassociationCreateEmbeddedUrlV1Request Class Doc Comment
 *
 * @category Class
 * @description Request for POST /1/object/ezsignfoldersignerassociation/createEmbeddedUrl
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsignfoldersignerassociationCreateEmbeddedUrlV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsignfoldersignerassociation-createEmbeddedUrl-v1-Request';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sReturnUrl) && (!preg_match("/(*UTF8)^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/", ObjectSerializer::toString($sReturnUrl)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sReturnUrl)?'null':'"'.$sReturnUrl.'"')." for sReturnUrl when calling EzsignfoldersignerassociationCreateEmbeddedUrlV1Request., must conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.");
        }
     ...
     * @return string|null
     */
    public function getSIframedomain()
    {
	//return $this->container['sIframedomain'];
        return is_null($this->container['sIframedomain']) ? null : trim($this->container['sIframedomain']);
    }

    /**
     * Sets sIframedomain
     *
     * @param string|null $sIframedomain Domain protection for the iFrame
     *
     * @return self
     */
    public function setSIframedomain($sIframedomain)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
	...
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        ...
        $this->container['sIframedomain'] = (is_null($sIframedomain) ? null : trim((string) $sIframedomain));
