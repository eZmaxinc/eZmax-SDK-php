...
/**
 * EzsigntemplatesignerCreateObjectV2ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for POST /2/object/ezsigntemplatesigner
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsigntemplatesignerCreateObjectV2ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplatesigner-createObject-v2-Response-mPayload';
    ...
    protected static $openAPITypes = [
        'aPkiEzsigntemplatesignerID' => 'int[]',
    ...
    protected static $openAPIFormats = [
        'aPkiEzsigntemplatesignerID' => null,
    ...
    protected static array $openAPINullables = [
        'aPkiEzsigntemplatesignerID' => false,
    ...
    protected static $attributeMap = [
        'aPkiEzsigntemplatesignerID' => 'a_pkiEzsigntemplatesignerID',
    ...
    protected static $setters = [
        'aPkiEzsigntemplatesignerID' => 'setAPkiEzsigntemplatesignerID',
    ...
    protected static $getters = [
        'aPkiEzsigntemplatesignerID' => 'getAPkiEzsigntemplatesignerID',
    ...
    {
        $this->setIfExists('aPkiEzsigntemplatesignerID', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aPkiEzsigntemplatesignerID'] === null) {
            $invalidProperties[] = "'aPkiEzsigntemplatesignerID' can't be null";
        }
    ...
    /**
     * Gets aPkiEzsigntemplatesignerID
     *
     * @return int[]
     */
    public function getAPkiEzsigntemplatesignerID()
    {
	//return $this->container['aPkiEzsigntemplatesignerID'];
        return $this->container['aPkiEzsigntemplatesignerID'];
    }

    /**
     * Sets aPkiEzsigntemplatesignerID
     *
     * @param int[] $aPkiEzsigntemplatesignerID An array of unique IDs representing the object that were requested to be created.  They are returned in the same order as the array containing the objects to be created that was sent in the request.
     *
     * @return self
     */
    public function setAPkiEzsigntemplatesignerID($aPkiEzsigntemplatesignerID)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aPkiEzsigntemplatesignerID)) {
            //throw new \InvalidArgumentException('non-nullable aPkiEzsigntemplatesignerID cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aPkiEzsigntemplatesignerID'] = $aPkiEzsigntemplatesignerID;
        $this->container['aPkiEzsigntemplatesignerID'] = (is_null($aPkiEzsigntemplatesignerID) ? null : $aPkiEzsigntemplatesignerID);
