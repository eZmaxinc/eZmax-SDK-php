    ...
    */
	...
	//if (($pkiEzsigntemplatedocumentID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatedocumentID when calling EzsigntemplatedocumentRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatedocumentID)?'null':'"'.$pkiEzsigntemplatedocumentID.'"').' for pkiEzsigntemplatedocumentID when calling EzsigntemplatedocumentRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplateID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplateID when calling EzsigntemplatedocumentRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateID)?'null':'"'.$fkiEzsigntemplateID.'"').' for fkiEzsigntemplateID when calling EzsigntemplatedocumentRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigndocumentID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigndocumentID when calling EzsigntemplatedocumentRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigndocumentID)?'null':'"'.$fkiEzsigndocumentID.'"').' for fkiEzsigndocumentID when calling EzsigntemplatedocumentRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatesignerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatesignerID when calling EzsigntemplatedocumentRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatesignerID)?'null':'"'.$fkiEzsigntemplatesignerID.'"').' for fkiEzsigntemplatesignerID when calling EzsigntemplatedocumentRequest., must be bigger than or equal to 0.');
        }
