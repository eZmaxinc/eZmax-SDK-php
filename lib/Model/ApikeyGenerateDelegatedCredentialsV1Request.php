...
/**
 * ApikeyGenerateDelegatedCredentialsV1Request Class Doc Comment
 *
 * @category Class
 * @description Request for POST /1/object/apikey/generateDelegatedCredentials
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ApikeyGenerateDelegatedCredentialsV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'apikey-generateDelegatedCredentials-v1-Request';
    ...
    */
	...
	//if (($iExpirationMinutes > 180)) {
        if (($iExpirationMinutes > 180)) {
	    //throw new \InvalidArgumentException('invalid value for $iExpirationMinutes when calling ApikeyGenerateDelegatedCredentialsV1Request., must be smaller than or equal to 180.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iExpirationMinutes)?'null':'"'.$iExpirationMinutes.'"').' for iExpirationMinutes when calling ApikeyGenerateDelegatedCredentialsV1Request., must be smaller than or equal to 180.');
        }
	//if (($iExpirationMinutes < 1)) {
        if (($iExpirationMinutes < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $iExpirationMinutes when calling ApikeyGenerateDelegatedCredentialsV1Request., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iExpirationMinutes)?'null':'"'.$iExpirationMinutes.'"').' for iExpirationMinutes when calling ApikeyGenerateDelegatedCredentialsV1Request., must be bigger than or equal to 1.');
        }
