...
/**
 * WebhookheaderResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookheaderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhookheader-Response';
    ...
    */
	...
	//if ((!preg_match("/^(?!(?:e|E)(?:z|Z)(?:m|M)(?:a|A)(?:x|X))(?!(?:h|H)(?:o|O)(?:s|S)(?:t|T)$|(?:u|U)(?:s|S)(?:e|E)(?:r|R)-(?:a|A)(?:g|G)(?:e|E)(?:n|N)(?:t|T)$)(?!\\s)[^\\s].*$/", ObjectSerializer::toString($sWebhookheaderName)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sWebhookheaderName when calling WebhookheaderResponse., must conform to the pattern /^(?!(?:e|E)(?:z|Z)(?:m|M)(?:a|A)(?:x|X))(?!(?:h|H)(?:o|O)(?:s|S)(?:t|T)$|(?:u|U)(?:s|S)(?:e|E)(?:r|R)-(?:a|A)(?:g|G)(?:e|E)(?:n|N)(?:t|T)$)(?!\\s)[^\\s].*$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sWebhookheaderName)?'null':'"'.$sWebhookheaderName.'"')." for sWebhookheaderName when calling WebhookheaderResponse., must conform to the pattern /^(?!(?:e|E)(?:z|Z)(?:m|M)(?:a|A)(?:x|X))(?!(?:h|H)(?:o|O)(?:s|S)(?:t|T)$|(?:u|U)(?:s|S)(?:e|E)(?:r|R)-(?:a|A)(?:g|G)(?:e|E)(?:n|N)(?:t|T)$)(?!\\s)[^\\s].*$/.");
        }
	...
	//if ((!preg_match("/^.{1,255}$/", ObjectSerializer::toString($sWebhookheaderValue)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sWebhookheaderValue when calling WebhookheaderResponse., must conform to the pattern /^.{1,255}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sWebhookheaderValue)?'null':'"'.$sWebhookheaderValue.'"')." for sWebhookheaderValue when calling WebhookheaderResponse., must conform to the pattern /^.{1,255}$/.");
        }
