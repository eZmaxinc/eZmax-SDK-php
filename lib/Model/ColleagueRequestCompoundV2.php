...
/**
 * ColleagueRequestCompoundV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class ColleagueRequestCompoundV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'colleague-RequestCompoundV2';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['pkiColleagueID']) && ($this->container['pkiColleagueID'] > 65535)) {
            $invalidProperties[] = "invalid value for 'pkiColleagueID', must be smaller than or equal to 65535.";
        }

        if (!is_null($this->container['pkiColleagueID']) && ($this->container['pkiColleagueID'] < 0)) {
	...
	//if (!is_null($this->container['dtColleagueFrom']) && !preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", $this->container['dtColleagueFrom'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'dtColleagueFrom', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtColleagueFrom'])?'null':'"'.$this->container['dtColleagueFrom'].'"')." for 'dtColleagueFrom', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.";
        }
	...
	//if (!is_null($this->container['dtColleagueTo']) && !preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", $this->container['dtColleagueTo'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'dtColleagueTo', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtColleagueTo'])?'null':'"'.$this->container['dtColleagueTo'].'"')." for 'dtColleagueTo', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.";
        }
     ...
     * Sets pkiColleagueID
     *
     * @param int|null $pkiColleagueID The unique ID of the Colleague
     *
     * @return self
     */
	...
	//if (($pkiColleagueID > 65535)) {
        if (!is_null($pkiColleagueID) && ($pkiColleagueID > 65535)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiColleagueID when calling ColleagueRequestCompoundV2., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiColleagueID)?'null':'"'.$pkiColleagueID.'"').' for pkiColleagueID when calling ColleagueRequestCompoundV2., must be smaller than or equal to 65535.');
        }
	//if (($pkiColleagueID < 0)) {
        if (!is_null($pkiColleagueID) && ($pkiColleagueID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiColleagueID when calling ColleagueRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiColleagueID)?'null':'"'.$pkiColleagueID.'"').' for pkiColleagueID when calling ColleagueRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserID < 0)) {
        if (($fkiUserID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling ColleagueRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling ColleagueRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserIDColleague < 0)) {
        if (($fkiUserIDColleague < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiUserIDColleague when calling ColleagueRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserIDColleague)?'null':'"'.$fkiUserIDColleague.'"').' for fkiUserIDColleague when calling ColleagueRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", ObjectSerializer::toString($dtColleagueFrom)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dtColleagueFrom when calling ColleagueRequestCompoundV2., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtColleagueFrom)?'null':'"'.$dtColleagueFrom.'"')." for dtColleagueFrom when calling ColleagueRequestCompoundV2., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
        }
	...
	//if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", ObjectSerializer::toString($dtColleagueTo)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dtColleagueTo when calling ColleagueRequestCompoundV2., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtColleagueTo)?'null':'"'.$dtColleagueTo.'"')." for dtColleagueTo when calling ColleagueRequestCompoundV2., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
        }
