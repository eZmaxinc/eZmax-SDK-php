...
class DiscussionmessageRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//if ((!preg_match("/^[\\s\\S]{0,65535}$/", ObjectSerializer::toString($tDiscussionmessageContent)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$tDiscussionmessageContent when calling DiscussionmessageRequestCompound., must conform to the pattern /^[\\s\\S]{0,65535}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($tDiscussionmessageContent)?'null':'"'.$tDiscussionmessageContent.'"')." for tDiscussionmessageContent when calling DiscussionmessageRequestCompound., must conform to the pattern /^[\\s\\S]{0,65535}$/.");
        }
