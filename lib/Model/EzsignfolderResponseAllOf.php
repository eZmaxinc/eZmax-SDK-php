 ...
 * @link     https://openapi-generator.tech
 */
class EzsignfolderResponseAllOf implements ModelInterface, ArrayAccess
{
    ...
    public function setFkiLanguageID($fkiLanguageID)
    {
        ...
        if (($fkiLanguageID > 2)) {
            throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsignfolderResponseAllOf., must be smaller than or equal to 2.');
        }
        if (($fkiLanguageID < 1)) {
            throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsignfolderResponseAllOf., must be bigger than or equal to 1.');
        }
