...
class PhoneRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//if (($pkiPhoneID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiPhoneID when calling PhoneRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiPhoneID)?'null':'"'.$pkiPhoneID.'"').' for pkiPhoneID when calling PhoneRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiPhonetypeID < 0)) {
        if (($fkiPhonetypeID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiPhonetypeID when calling PhoneRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPhonetypeID)?'null':'"'.$fkiPhonetypeID.'"').' for fkiPhonetypeID when calling PhoneRequest., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^\\+[1-9]\\d{1,14}$/", ObjectSerializer::toString($sPhoneE164)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sPhoneE164 when calling PhoneRequest., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sPhoneE164)?'null':'"'.$sPhoneE164.'"')." for sPhoneE164 when calling PhoneRequest., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
