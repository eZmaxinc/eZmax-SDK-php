...
class PhoneRequest implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['fkiPhonetypeID'] = isset($data['fkiPhonetypeID']) ? $data['fkiPhonetypeID'] : null;
        $this->container['ePhoneType'] = isset($data['ePhoneType']) ? $data['ePhoneType'] : null;
        $this->container['sPhoneRegion'] = isset($data['sPhoneRegion']) ? $data['sPhoneRegion'] : null;
        $this->container['sPhoneExchange'] = isset($data['sPhoneExchange']) ? $data['sPhoneExchange'] : null;
        $this->container['sPhoneNumber'] = isset($data['sPhoneNumber']) ? $data['sPhoneNumber'] : null;
        $this->container['sPhoneInternational'] = isset($data['sPhoneInternational']) ? $data['sPhoneInternational'] : null;
        $this->container['sPhoneExtension'] = isset($data['sPhoneExtension']) ? $data['sPhoneExtension'] : null;
    }
