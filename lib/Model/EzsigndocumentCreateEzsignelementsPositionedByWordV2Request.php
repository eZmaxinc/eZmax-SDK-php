...
/**
 * EzsigndocumentCreateEzsignelementsPositionedByWordV2Request Class Doc Comment
 *
 * @category Class
 * @description Request for POST /2/object/ezsigndocument/{pkiEzsigndocumentID}/createEzsignelementsPositionedByWord
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsigndocumentCreateEzsignelementsPositionedByWordV2Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigndocument-createEzsignelementsPositionedByWord-v2-Request';
