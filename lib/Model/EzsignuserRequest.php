...
/**
 * EzsignuserRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignuserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignuser-Request';
    ...
    */
	...
	//if (($pkiEzsignuserID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignuserID when calling EzsignuserRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignuserID)?'null':'"'.$pkiEzsignuserID.'"').' for pkiEzsignuserID when calling EzsignuserRequest., must be smaller than or equal to 65535.');
        }
	//if (($pkiEzsignuserID < 0)) {
        if (!is_null($pkiEzsignuserID) && ($pkiEzsignuserID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignuserID when calling EzsignuserRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignuserID)?'null':'"'.$pkiEzsignuserID.'"').' for pkiEzsignuserID when calling EzsignuserRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiContactID < 0)) {
        if (($fkiContactID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiContactID when calling EzsignuserRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiContactID)?'null':'"'.$fkiContactID.'"').' for fkiContactID when calling EzsignuserRequest., must be bigger than or equal to 0.');
        }
