...
/**
 * AttachmentPrivacyV1Request Class Doc Comment
 *
 * @category Class
 * @description Request for POST /1/object/attachment/{pkiAttachmentID}/privacy
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AttachmentPrivacyV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'attachment-privacy-v1-Request';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUserIDSpecific) && ($fkiUserIDSpecific < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserIDSpecific when calling AttachmentPrivacyV1Request., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserIDSpecific)?'null':'"'.$fkiUserIDSpecific.'"').' for fkiUserIDSpecific when calling AttachmentPrivacyV1Request., must be bigger than or equal to 0.');
        }
