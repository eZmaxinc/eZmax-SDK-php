...
/**
 * CreditcardmerchantResponseCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class CreditcardmerchantResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'creditcardmerchant-ResponseCompound';
    ...
    protected static $setters = [
        ...
        'fkiCurrencyID' => 'setFkiCurrencyID',
    ...
    protected static $getters = [
        ...
        'fkiCurrencyID' => 'getFkiCurrencyID',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('fkiCurrencyID', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fkiCurrencyID'] === null) {
            $invalidProperties[] = "'fkiCurrencyID' can't be null";
        }
        if (($this->container['fkiCurrencyID'] < 0)) {
            $invalidProperties[] = "invalid value for 'fkiCurrencyID', must be bigger than or equal to 0.";
        }
        ...
        if (!is_null($this->container['sCreditcardmerchantStoreid']) && !preg_match("/(*UTF8)^.{0,25}$/", $this->container['sCreditcardmerchantStoreid'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sCreditcardmerchantStoreid'])?'null':'"'.$this->container['sCreditcardmerchantStoreid'].'"')." for 'sCreditcardmerchantStoreid', must be conform to the pattern /^.{0,25}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiCreditcardmerchantID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $pkiCreditcardmerchantID when calling CreditcardmerchantResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCreditcardmerchantID)?'null':'"'.$pkiCreditcardmerchantID.'"').' for pkiCreditcardmerchantID when calling CreditcardmerchantResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($pkiCreditcardmerchantID < 0)) {
        if (($pkiCreditcardmerchantID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiCreditcardmerchantID when calling CreditcardmerchantResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCreditcardmerchantID)?'null':'"'.$pkiCreditcardmerchantID.'"').' for pkiCreditcardmerchantID when calling CreditcardmerchantResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiBankaccountID) && ($fkiBankaccountID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBankaccountID when calling CreditcardmerchantResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBankaccountID)?'null':'"'.$fkiBankaccountID.'"').' for fkiBankaccountID when calling CreditcardmerchantResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($fkiBankaccountID < 0)) {
        if (!is_null($fkiBankaccountID) && ($fkiBankaccountID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBankaccountID when calling CreditcardmerchantResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBankaccountID)?'null':'"'.$fkiBankaccountID.'"').' for fkiBankaccountID when calling CreditcardmerchantResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiLanguageID > 2)) {
        if (($fkiLanguageID > 2)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling CreditcardmerchantResponseCompound., must be smaller than or equal to 2.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling CreditcardmerchantResponseCompound., must be smaller than or equal to 2.');
        }
        //if (($fkiLanguageID < 1)) {
        if (($fkiLanguageID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling CreditcardmerchantResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling CreditcardmerchantResponseCompound., must be bigger than or equal to 1.');
        }
     ...
     * @return int
     */
    public function getFkiCurrencyID()
    {
	//return $this->container['fkiCurrencyID'];
        return $this->container['fkiCurrencyID'];
    }
     ...
     * Sets fkiCurrencyID
     *
     * @param int $fkiCurrencyID The unique ID of the Currency.
     *
     * @return self
     */
    public function setFkiCurrencyID($fkiCurrencyID)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($fkiCurrencyID)) {
            //throw new \InvalidArgumentException('non-nullable fkiCurrencyID cannot be null');
        //}
        //if (($fkiCurrencyID < 0)) {
        if (($fkiCurrencyID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCurrencyID when calling CreditcardmerchantResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCurrencyID)?'null':'"'.$fkiCurrencyID.'"').' for fkiCurrencyID when calling CreditcardmerchantResponseCompound., must be bigger than or equal to 0.');
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['fkiCurrencyID'] = $fkiCurrencyID;
        $this->container['fkiCurrencyID'] = (is_null($fkiCurrencyID) ? null : (int) $fkiCurrencyID);
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCurrencyDescriptionX) && (!preg_match("/(*UTF8)^.{1,20}$/", ObjectSerializer::toString($sCurrencyDescriptionX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCurrencyDescriptionX when calling CreditcardmerchantResponseCompound., must conform to the pattern /^.{1,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCurrencyDescriptionX)?'null':'"'.$sCurrencyDescriptionX.'"')." for sCurrencyDescriptionX when calling CreditcardmerchantResponseCompound., must conform to the pattern /^.{1,20}$/.");
        }
     ...
     *
     * @param string|null $sBankaccountBankname The name of the bank
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCreditcardmerchantDescription) && (!preg_match("/(*UTF8)^.{0,25}$/", ObjectSerializer::toString($sCreditcardmerchantDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCreditcardmerchantDescription when calling CreditcardmerchantResponseCompound., must conform to the pattern /^.{0,25}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCreditcardmerchantDescription)?'null':'"'.$sCreditcardmerchantDescription.'"')." for sCreditcardmerchantDescription when calling CreditcardmerchantResponseCompound., must conform to the pattern /^.{0,25}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCreditcardmerchantStoreid) && (!preg_match("/(*UTF8)^.{0,25}$/", ObjectSerializer::toString($sCreditcardmerchantStoreid)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCreditcardmerchantStoreid when calling CreditcardmerchantResponseCompound., must conform to the pattern /^.{0,25}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCreditcardmerchantStoreid)?'null':'"'.$sCreditcardmerchantStoreid.'"')." for sCreditcardmerchantStoreid when calling CreditcardmerchantResponseCompound., must conform to the pattern /^.{0,25}$/.");
        }
