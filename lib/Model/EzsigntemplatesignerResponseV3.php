...
/**
 * EzsigntemplatesignerResponseV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplatesignerResponseV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplatesigner-ResponseV3';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigntemplatesignerID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatesignerID when calling EzsigntemplatesignerResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatesignerID)?'null':'"'.$pkiEzsigntemplatesignerID.'"').' for pkiEzsigntemplatesignerID when calling EzsigntemplatesignerResponseV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigntemplateID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplateID when calling EzsigntemplatesignerResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateID)?'null':'"'.$fkiEzsigntemplateID.'"').' for fkiEzsigntemplateID when calling EzsigntemplatesignerResponseV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUserID) && ($fkiUserID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling EzsigntemplatesignerResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling EzsigntemplatesignerResponseV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling EzsigntemplatesignerResponseV3., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling EzsigntemplatesignerResponseV3., must be smaller than or equal to 255.');
        }
        //if (($fkiUsergroupID < 0)) {
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling EzsigntemplatesignerResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling EzsigntemplatesignerResponseV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzdoctemplatedocumentID) && ($fkiEzdoctemplatedocumentID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatedocumentID when calling EzsigntemplatesignerResponseV3., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatedocumentID)?'null':'"'.$fkiEzdoctemplatedocumentID.'"').' for fkiEzdoctemplatedocumentID when calling EzsigntemplatesignerResponseV3., must be smaller than or equal to 65535.');
        }
        //if (($fkiEzdoctemplatedocumentID < 0)) {
        if (!is_null($fkiEzdoctemplatedocumentID) && ($fkiEzdoctemplatedocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatedocumentID when calling EzsigntemplatesignerResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatedocumentID)?'null':'"'.$fkiEzdoctemplatedocumentID.'"').' for fkiEzdoctemplatedocumentID when calling EzsigntemplatesignerResponseV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatesignerDescription) && (!preg_match("/(*UTF8)^.{1,50}$/", ObjectSerializer::toString($sEzsigntemplatesignerDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatesignerDescription when calling EzsigntemplatesignerResponseV3., must conform to the pattern /^.{1,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatesignerDescription)?'null':'"'.$sEzsigntemplatesignerDescription.'"')." for sEzsigntemplatesignerDescription when calling EzsigntemplatesignerResponseV3., must conform to the pattern /^.{1,50}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUsergroupNameX) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sUsergroupNameX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUsergroupNameX when calling EzsigntemplatesignerResponseV3., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupNameX)?'null':'"'.$sUsergroupNameX.'"')." for sUsergroupNameX when calling EzsigntemplatesignerResponseV3., must conform to the pattern /^.{0,50}$/.");
        }
