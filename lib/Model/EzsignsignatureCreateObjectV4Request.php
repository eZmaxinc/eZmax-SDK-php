...
/**
 * EzsignsignatureCreateObjectV4Request Class Doc Comment
 *
 * @category Class
 * @description Request for POST /4/object/ezsignsignature
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsignsignatureCreateObjectV4Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsignsignature-createObject-v4-Request';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if ((count($aObjEzsignsignature) < 1)) {
            //throw new \InvalidArgumentException('invalid length for $aObjEzsignsignature when calling EzsignsignatureCreateObjectV4Request., number of items must be greater than or equal to 1.');
            throw new \InvalidArgumentException('invalid length for aObjEzsignsignature when calling EzsignsignatureCreateObjectV4Request., number of items must be greater than or equal to 1.');
        }
