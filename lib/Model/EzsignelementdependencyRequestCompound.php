...
class EzsignelementdependencyRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sEzsignelementdependencyValue']) && !preg_match("/(*UTF8)^.{0,50}$/", $this->container['sEzsignelementdependencyValue'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsignelementdependencyValue'])?'null':'"'.$this->container['sEzsignelementdependencyValue'].'"')." for 'sEzsignelementdependencyValue', must be conform to the pattern /^.{0,50}$/.";
        }
