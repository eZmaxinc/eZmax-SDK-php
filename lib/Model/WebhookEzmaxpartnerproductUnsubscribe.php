...
/**
 * WebhookEzmaxpartnerproductUnsubscribe Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookEzmaxpartnerproductUnsubscribe implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Webhook-Ezmaxpartnerproduct-Unsubscribe';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sExternalID) && (!preg_match("/(*UTF8)^.{0,128}$/", ObjectSerializer::toString($sExternalID)))) {
            //throw new \InvalidArgumentException("invalid value for \$sExternalID when calling WebhookEzmaxpartnerproductUnsubscribe., must conform to the pattern /^.{0,128}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sExternalID)?'null':'"'.$sExternalID.'"')." for sExternalID when calling WebhookEzmaxpartnerproductUnsubscribe., must conform to the pattern /^.{0,128}$/.");
        }
