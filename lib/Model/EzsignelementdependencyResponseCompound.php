...
//        if (($pkiEzsignelementdependencyID > 65535)) {
        if (($pkiEzsignelementdependencyID > 65535)) {
            throw new \InvalidArgumentException('invalid value for $pkiEzsignelementdependencyID when calling EzsignelementdependencyResponseCompound., must be smaller than or equal to 65535.');
        }
