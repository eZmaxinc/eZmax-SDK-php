...
class EzsignelementdependencyResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsignelementdependencyID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsignelementdependencyID when calling EzsignelementdependencyResponseCompound., must be smaller than or equal to 16777215.');
        ...
        if (($pkiEzsignelementdependencyID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsignelementdependencyID when calling EzsignelementdependencyResponseCompound., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignformfieldID) && ($fkiEzsignformfieldID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignformfieldID when calling EzsignelementdependencyResponseCompound., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignsignatureID) && ($fkiEzsignsignatureID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignsignatureID when calling EzsignelementdependencyResponseCompound., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignformfieldIDValidation) && ($fkiEzsignformfieldIDValidation < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignformfieldIDValidation when calling EzsignelementdependencyResponseCompound., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignformfieldgroupIDValidation) && ($fkiEzsignformfieldgroupIDValidation < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignformfieldgroupIDValidation when calling EzsignelementdependencyResponseCompound., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignelementdependencyValue) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sEzsignelementdependencyValue)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsignelementdependencyValue when calling EzsignelementdependencyResponseCompound., must conform to the pattern /^.{0,50}$/.");
