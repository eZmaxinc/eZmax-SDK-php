...
class SignatureRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'signature-Request';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['tSignatureSvg']) && !preg_match("/(*UTF8)^.{60,65535}$/", $this->container['tSignatureSvg'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['tSignatureSvg'])?'null':'"'.$this->container['tSignatureSvg'].'"')." for 'tSignatureSvg', must be conform to the pattern /^.{60,65535}$/.";
        }
        ...
        if (!is_null($this->container['tSignatureSvginitials']) && !preg_match("/(*UTF8)^.{60,65535}$/", $this->container['tSignatureSvginitials'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['tSignatureSvginitials'])?'null':'"'.$this->container['tSignatureSvginitials'].'"')." for 'tSignatureSvginitials', must be conform to the pattern /^.{60,65535}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiSignatureID) && ($pkiSignatureID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $pkiSignatureID when calling SignatureRequest., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSignatureID)?'null':'"'.$pkiSignatureID.'"').' for pkiSignatureID when calling SignatureRequest., must be smaller than or equal to 16777215.');
        }
        //if (($pkiSignatureID < 0)) {
        if (!is_null($pkiSignatureID) && ($pkiSignatureID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiSignatureID when calling SignatureRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSignatureID)?'null':'"'.$pkiSignatureID.'"').' for pkiSignatureID when calling SignatureRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiFontID < 0)) {
        if (($fkiFontID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFontID when calling SignatureRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFontID)?'null':'"'.$fkiFontID.'"').' for fkiFontID when calling SignatureRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($tSignatureSvg) && (!preg_match("/(*UTF8)^.{60,65535}$/", ObjectSerializer::toString($tSignatureSvg)))) {
            //throw new \InvalidArgumentException("invalid value for \$tSignatureSvg when calling SignatureRequest., must conform to the pattern /^.{60,65535}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($tSignatureSvg)?'null':'"'.$tSignatureSvg.'"')." for tSignatureSvg when calling SignatureRequest., must conform to the pattern /^.{60,65535}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($tSignatureSvginitials) && (!preg_match("/(*UTF8)^.{60,65535}$/", ObjectSerializer::toString($tSignatureSvginitials)))) {
            //throw new \InvalidArgumentException("invalid value for \$tSignatureSvginitials when calling SignatureRequest., must conform to the pattern /^.{60,65535}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($tSignatureSvginitials)?'null':'"'.$tSignatureSvginitials.'"')." for tSignatureSvginitials when calling SignatureRequest., must conform to the pattern /^.{60,65535}$/.");
        }
