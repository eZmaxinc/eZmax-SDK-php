...
//        if (!preg_match("/^.{0,32767}$/", $this->container['tSignatureSvg'])) {
        if (!is_null($this->container['tSignatureSvg']) && !preg_match("/^.{0,32767}$/", $this->container['tSignatureSvg'])) {
            $invalidProperties[] = "invalid value for 'tSignatureSvg', must be conform to the pattern /^.{0,32767}$/.";
        }
