...
class SignatureRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tSignatureSvg'] === null) {
            $invalidProperties[] = "'tSignatureSvg' can't be null";
        }
//        if (!preg_match("/^.{0,65535}$/", $this->container['tSignatureSvg'])) {
        if (!is_null($this->container['tSignatureSvg']) && !preg_match("/(*UTF8)^.{0,65535}$/", $this->container['tSignatureSvg'])) {
            $invalidProperties[] = "invalid value for 'tSignatureSvg', must be conform to the pattern /^.{0,65535}$/.";
        }
...
//        if ((!preg_match("/^.{0,65535}$/", ObjectSerializer::toString($tSignatureSvg)))) {
        if (!is_null($tSignatureSvg) && (!preg_match("/(*UTF8)^.{0,65535}$/", ObjectSerializer::toString($tSignatureSvg)))) {
            throw new \InvalidArgumentException("invalid value for \$tSignatureSvg when calling SignatureRequest., must conform to the pattern /^.{0,65535}$/.");
        }
