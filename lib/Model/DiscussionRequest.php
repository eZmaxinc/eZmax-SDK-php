...
/**
 * DiscussionRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class DiscussionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'discussion-Request';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiDiscussionID) && ($pkiDiscussionID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $pkiDiscussionID when calling DiscussionRequest., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiDiscussionID)?'null':'"'.$pkiDiscussionID.'"').' for pkiDiscussionID when calling DiscussionRequest., must be smaller than or equal to 16777215.');
        }
        //if (($pkiDiscussionID < 0)) {
        if (!is_null($pkiDiscussionID) && ($pkiDiscussionID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiDiscussionID when calling DiscussionRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiDiscussionID)?'null':'"'.$pkiDiscussionID.'"').' for pkiDiscussionID when calling DiscussionRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sDiscussionDescription) && (!preg_match("/(*UTF8)^.{0,75}$/", ObjectSerializer::toString($sDiscussionDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sDiscussionDescription when calling DiscussionRequest., must conform to the pattern /^.{0,75}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sDiscussionDescription)?'null':'"'.$sDiscussionDescription.'"')." for sDiscussionDescription when calling DiscussionRequest., must conform to the pattern /^.{0,75}$/.");
        }
