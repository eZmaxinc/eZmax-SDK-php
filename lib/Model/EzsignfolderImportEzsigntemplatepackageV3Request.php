...
/**
 * EzsignfolderImportEzsigntemplatepackageV3Request Class Doc Comment
 *
 * @category Class
 * @description Request for POST /3/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsignfolderImportEzsigntemplatepackageV3Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignfolder-importEzsigntemplatepackage-v3-Request';
    ...
    */
	...
	//if (($fkiEzsigntemplatepackageID < 0)) {
        if (($fkiEzsigntemplatepackageID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepackageID when calling EzsignfolderImportEzsigntemplatepackageV3Request., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatepackageID)?'null':'"'.$fkiEzsigntemplatepackageID.'"').' for fkiEzsigntemplatepackageID when calling EzsignfolderImportEzsigntemplatepackageV3Request., must be bigger than or equal to 0.');
        }
