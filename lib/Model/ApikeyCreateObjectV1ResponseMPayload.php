...
/**
 * ApikeyCreateObjectV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for POST /1/object/apikey
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ApikeyCreateObjectV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'apikey-createObject-v1-Response-mPayload';
    ...
    */
    ...
    public function setAObjApikey($aObjApikey)
    {
        ...
        if ((count($aObjApikey) < 1)) {
            throw new \InvalidArgumentException('invalid length for $aObjApikey when calling ApikeyCreateObjectV1ResponseMPayload., number of items must be greater than or equal to 1.');
        }
