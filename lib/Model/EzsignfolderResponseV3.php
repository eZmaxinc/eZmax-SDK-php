...
/**
 * EzsignfolderResponseV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignfolderResponseV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignfolder-ResponseV3';
    ...
    protected static $openAPIFormats = [
        ...
        'iEzsignfolderStepcurrent' => null,
        'dtEzsignfolderClose' => null,
        'dtEzsignfolderArchive' => null,
        'dtEzsignfolderDispose' => null,
        'tEzsignfolderMessage' => null,
        'eEzsignfolderMessageorder' => null,
        'objAudit' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'iEzsignfolderStepcurrent' => false,
        'dtEzsignfolderClose' => false,
        'dtEzsignfolderArchive' => false,
        'dtEzsignfolderDispose' => false,
        'tEzsignfolderMessage' => false,
        'eEzsignfolderMessageorder' => false,
        'objAudit' => false,
    ...
    protected static $attributeMap = [
        ...
        'iEzsignfolderStepcurrent' => 'iEzsignfolderStepcurrent',
        'dtEzsignfolderClose' => 'dtEzsignfolderClose',
        'dtEzsignfolderArchive' => 'dtEzsignfolderArchive',
        'dtEzsignfolderDispose' => 'dtEzsignfolderDispose',
        'tEzsignfolderMessage' => 'tEzsignfolderMessage',
        'eEzsignfolderMessageorder' => 'eEzsignfolderMessageorder',
        'objAudit' => 'objAudit',
    ...
    protected static $setters = [
        ...
        'iEzsignfolderStepcurrent' => 'setIEzsignfolderStepcurrent',
        'dtEzsignfolderClose' => 'setDtEzsignfolderClose',
        'dtEzsignfolderArchive' => 'setDtEzsignfolderArchive',
        'dtEzsignfolderDispose' => 'setDtEzsignfolderDispose',
        'tEzsignfolderMessage' => 'setTEzsignfolderMessage',
        'eEzsignfolderMessageorder' => 'setEEzsignfolderMessageorder',
    ...
    protected static $getters = [
        ...
        'iEzsignfolderStepcurrent' => 'getIEzsignfolderStepcurrent',
        'dtEzsignfolderClose' => 'getDtEzsignfolderClose',
        'dtEzsignfolderArchive' => 'getDtEzsignfolderArchive',
        'dtEzsignfolderDispose' => 'getDtEzsignfolderDispose',
        'tEzsignfolderMessage' => 'getTEzsignfolderMessage',
        'eEzsignfolderMessageorder' => 'getEEzsignfolderMessageorder',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('iEzsignfolderStepcurrent', $data ?? [], null);
        $this->setIfExists('dtEzsignfolderClose', $data ?? [], null);
        $this->setIfExists('dtEzsignfolderArchive', $data ?? [], null);
        $this->setIfExists('dtEzsignfolderDispose', $data ?? [], null);
        $this->setIfExists('tEzsignfolderMessage', $data ?? [], null);
        $this->setIfExists('eEzsignfolderMessageorder', $data ?? [], null);
    ...
    */
	...
	//if (!preg_match("/^.{0,75}$/", $this->container['sEzsignfolderDescription'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sEzsignfolderDescription', must be conform to the pattern /^.{0,75}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsignfolderDescription'])?'null':'"'.$this->container['sEzsignfolderDescription'].'"')." for 'sEzsignfolderDescription', must be conform to the pattern /^.{0,75}$/.";
        }
        ...
        if (!is_null($this->container['iEzsignfolderStepcurrent']) && ($this->container['iEzsignfolderStepcurrent'] > 255)) {
            $invalidProperties[] = "invalid value for 'iEzsignfolderStepcurrent', must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['iEzsignfolderStepcurrent']) && ($this->container['iEzsignfolderStepcurrent'] < 0)) {
            $invalidProperties[] = "invalid value for 'iEzsignfolderStepcurrent', must be bigger than or equal to 0.";
        }
	...
	//if (!is_null($this->container['sEzsignfolderExternalid']) && !preg_match("/^.{0,128}$/", $this->container['sEzsignfolderExternalid'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sEzsignfolderExternalid', must be conform to the pattern /^.{0,128}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsignfolderExternalid'])?'null':'"'.$this->container['sEzsignfolderExternalid'].'"')." for 'sEzsignfolderExternalid', must be conform to the pattern /^.{0,128}$/.";
        }
	...
	//if (($pkiEzsignfolderID < 0)) {
        if (($pkiEzsignfolderID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignfolderID when calling EzsignfolderResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignfolderID)?'null':'"'.$pkiEzsignfolderID.'"').' for pkiEzsignfolderID when calling EzsignfolderResponseV3., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignfoldertypeID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsignfolderResponseV3., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsignfolderResponseV3., must be smaller than or equal to 65535.');
        }
	//if (($fkiEzsignfoldertypeID < 0)) {
        if (!is_null($fkiEzsignfoldertypeID) && ($fkiEzsignfoldertypeID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsignfolderResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsignfolderResponseV3., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiTimezoneID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiTimezoneID when calling EzsignfolderResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiTimezoneID)?'null':'"'.$fkiTimezoneID.'"').' for fkiTimezoneID when calling EzsignfolderResponseV3., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiBillingentityinternalID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiBillingentityinternalID when calling EzsignfolderResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBillingentityinternalID)?'null':'"'.$fkiBillingentityinternalID.'"').' for fkiBillingentityinternalID when calling EzsignfolderResponseV3., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntsarequirementID > 3)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntsarequirementID when calling EzsignfolderResponseV3., must be smaller than or equal to 3.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntsarequirementID)?'null':'"'.$fkiEzsigntsarequirementID.'"').' for fkiEzsigntsarequirementID when calling EzsignfolderResponseV3., must be smaller than or equal to 3.');
        }
	//if (($fkiEzsigntsarequirementID < 1)) {
        if (!is_null($fkiEzsigntsarequirementID) && ($fkiEzsigntsarequirementID < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntsarequirementID when calling EzsignfolderResponseV3., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntsarequirementID)?'null':'"'.$fkiEzsigntsarequirementID.'"').' for fkiEzsigntsarequirementID when calling EzsignfolderResponseV3., must be bigger than or equal to 1.');
        }
	...
	//if ((!preg_match("/^.{0,75}$/", ObjectSerializer::toString($sEzsignfolderDescription)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsignfolderDescription when calling EzsignfolderResponseV3., must conform to the pattern /^.{0,75}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignfolderDescription)?'null':'"'.$sEzsignfolderDescription.'"')." for sEzsignfolderDescription when calling EzsignfolderResponseV3., must conform to the pattern /^.{0,75}$/.");
        }
     ...
     *
     * @param int|null $iEzsignfolderSendreminderfirstdays The number of days before the first reminder sending
     *
     * @return self
     */
	...
	//if (($iEzsignfolderSendreminderfirstdays > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignfolderSendreminderfirstdays when calling EzsignfolderResponseV3., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfolderSendreminderfirstdays)?'null':'"'.$iEzsignfolderSendreminderfirstdays.'"').' for iEzsignfolderSendreminderfirstdays when calling EzsignfolderResponseV3., must be smaller than or equal to 255.');
        }
	//if (($iEzsignfolderSendreminderfirstdays < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignfolderSendreminderfirstdays when calling EzsignfolderResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfolderSendreminderfirstdays)?'null':'"'.$iEzsignfolderSendreminderfirstdays.'"').' for iEzsignfolderSendreminderfirstdays when calling EzsignfolderResponseV3., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignfolderSendreminderotherdays > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignfolderSendreminderotherdays when calling EzsignfolderResponseV3., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfolderSendreminderotherdays)?'null':'"'.$iEzsignfolderSendreminderotherdays.'"').' for iEzsignfolderSendreminderotherdays when calling EzsignfolderResponseV3., must be smaller than or equal to 255.');
        }
	//if (($iEzsignfolderSendreminderotherdays < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignfolderSendreminderotherdays when calling EzsignfolderResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfolderSendreminderotherdays)?'null':'"'.$iEzsignfolderSendreminderotherdays.'"').' for iEzsignfolderSendreminderotherdays when calling EzsignfolderResponseV3., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets iEzsignfolderStepcurrent
     *
     * @return int|null
     */
    public function getIEzsignfolderStepcurrent()
    {
	//return $this->container['iEzsignfolderStepcurrent'];
        return $this->container['iEzsignfolderStepcurrent'];
    }

    /**
     * Sets iEzsignfolderStepcurrent
     *
     * @param int|null $iEzsignfolderStepcurrent The current step of the ezsignfolder when eEzsignfolderCompletion = 'PerEzsignfolderStepSync'
     *
     * @return self
     */
    public function setIEzsignfolderStepcurrent($iEzsignfolderStepcurrent)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($iEzsignfolderStepcurrent)) {
            //throw new \InvalidArgumentException('non-nullable iEzsignfolderStepcurrent cannot be null');
        //}

	//if (($iEzsignfolderStepcurrent > 255)) {
        if (!is_null($iEzsignfolderStepcurrent) && ($iEzsignfolderStepcurrent > 255)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignfolderStepcurrent when calling EzsignfolderResponseV3., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfolderStepcurrent)?'null':'"'.$iEzsignfolderStepcurrent.'"').' for iEzsignfolderStepcurrent when calling EzsignfolderResponseV3., must be smaller than or equal to 255.');
        }
	//if (($iEzsignfolderStepcurrent < 0)) {
        if (!is_null($iEzsignfolderStepcurrent) && ($iEzsignfolderStepcurrent < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignfolderStepcurrent when calling EzsignfolderResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfolderStepcurrent)?'null':'"'.$iEzsignfolderStepcurrent.'"').' for iEzsignfolderStepcurrent when calling EzsignfolderResponseV3., must be bigger than or equal to 0.');
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
	//$this->container['iEzsignfolderStepcurrent'] = $iEzsignfolderStepcurrent;
        $this->container['iEzsignfolderStepcurrent'] = (is_null($iEzsignfolderStepcurrent) ? null : (int) $iEzsignfolderStepcurrent);
    ...
    /**
     * Gets dtEzsignfolderArchive
     *
     * @return string|null
     */
    public function getDtEzsignfolderArchive()
    {
	//return $this->container['dtEzsignfolderArchive'];
        return is_null($this->container['dtEzsignfolderArchive']) ? null : trim($this->container['dtEzsignfolderArchive']);
    }

    /**
     * Sets dtEzsignfolderArchive
     *
     * @param string|null $dtEzsignfolderArchive The date and time at which the Ezsignfolder was archived.
     *
     * @return self
     */
    public function setDtEzsignfolderArchive($dtEzsignfolderArchive)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($dtEzsignfolderArchive)) {
            //throw new \InvalidArgumentException('non-nullable dtEzsignfolderArchive cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
	//$this->container['dtEzsignfolderArchive'] = $dtEzsignfolderArchive;
        $this->container['dtEzsignfolderArchive'] = (is_null($dtEzsignfolderArchive) ? null : trim((string) $dtEzsignfolderArchive));

        return $this;
    }

    /**
     * Gets dtEzsignfolderDispose
     *
     * @return string|null
     */
    public function getDtEzsignfolderDispose()
    {
	//return $this->container['dtEzsignfolderDispose'];
        return is_null($this->container['dtEzsignfolderDispose']) ? null : trim($this->container['dtEzsignfolderDispose']);
    }

    /**
     * Sets dtEzsignfolderDispose
     *
     * @param string|null $dtEzsignfolderDispose The date and time at which the Ezsignfolder was disposed.
     *
     * @return self
     */
    public function setDtEzsignfolderDispose($dtEzsignfolderDispose)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($dtEzsignfolderDispose)) {
            //throw new \InvalidArgumentException('non-nullable dtEzsignfolderDispose cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
	//$this->container['dtEzsignfolderDispose'] = $dtEzsignfolderDispose;
        $this->container['dtEzsignfolderDispose'] = (is_null($dtEzsignfolderDispose) ? null : trim((string) $dtEzsignfolderDispose));
    ...
    /**
     * Gets eEzsignfolderMessageorder
     *
     * @return \eZmaxAPI\Model\FieldEEzsignfolderMessageorder|null
     */
    public function getEEzsignfolderMessageorder()
    {
	//return $this->container['eEzsignfolderMessageorder'];
        return $this->container['eEzsignfolderMessageorder'];
    }

    /**
     * Sets eEzsignfolderMessageorder
     *
     * @param \eZmaxAPI\Model\FieldEEzsignfolderMessageorder|null $eEzsignfolderMessageorder eEzsignfolderMessageorder
     *
     * @return self
     */
    public function setEEzsignfolderMessageorder($eEzsignfolderMessageorder)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($eEzsignfolderMessageorder)) {
            //throw new \InvalidArgumentException('non-nullable eEzsignfolderMessageorder cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
	//$this->container['eEzsignfolderMessageorder'] = $eEzsignfolderMessageorder;
        $this->container['eEzsignfolderMessageorder'] = $eEzsignfolderMessageorder;
	...
	//if ((!preg_match("/^.{0,128}$/", ObjectSerializer::toString($sEzsignfolderExternalid)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsignfolderExternalid when calling EzsignfolderResponseV3., must conform to the pattern /^.{0,128}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignfolderExternalid)?'null':'"'.$sEzsignfolderExternalid.'"')." for sEzsignfolderExternalid when calling EzsignfolderResponseV3., must conform to the pattern /^.{0,128}$/.");
        }
