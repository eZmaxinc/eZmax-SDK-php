...
/**
 * EzsigndiscussionRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigndiscussionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigndiscussion-Request';
    ...
    */
	...
	//if (($pkiEzsigndiscussionID > 16777215)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigndiscussionID when calling EzsigndiscussionRequest., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndiscussionID)?'null':'"'.$pkiEzsigndiscussionID.'"').' for pkiEzsigndiscussionID when calling EzsigndiscussionRequest., must be smaller than or equal to 16777215.');
        }
	//if (($pkiEzsigndiscussionID < 0)) {
        if (!is_null($pkiEzsigndiscussionID) && ($pkiEzsigndiscussionID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigndiscussionID when calling EzsigndiscussionRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndiscussionID)?'null':'"'.$pkiEzsigndiscussionID.'"').' for pkiEzsigndiscussionID when calling EzsigndiscussionRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigndocumentID < 0)) {
        if (($fkiEzsigndocumentID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigndocumentID when calling EzsigndiscussionRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigndocumentID)?'null':'"'.$fkiEzsigndocumentID.'"').' for fkiEzsigndocumentID when calling EzsigndiscussionRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigndiscussionX > 65535)) {
        if (($iEzsigndiscussionX > 65535)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsigndiscussionX when calling EzsigndiscussionRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndiscussionX)?'null':'"'.$iEzsigndiscussionX.'"').' for iEzsigndiscussionX when calling EzsigndiscussionRequest., must be smaller than or equal to 65535.');
        }
	//if (($iEzsigndiscussionX < 0)) {
        if (($iEzsigndiscussionX < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsigndiscussionX when calling EzsigndiscussionRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndiscussionX)?'null':'"'.$iEzsigndiscussionX.'"').' for iEzsigndiscussionX when calling EzsigndiscussionRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigndiscussionY > 65535)) {
        if (($iEzsigndiscussionY > 65535)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsigndiscussionY when calling EzsigndiscussionRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndiscussionY)?'null':'"'.$iEzsigndiscussionY.'"').' for iEzsigndiscussionY when calling EzsigndiscussionRequest., must be smaller than or equal to 65535.');
        }
	//if (($iEzsigndiscussionY < 0)) {
        if (($iEzsigndiscussionY < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsigndiscussionY when calling EzsigndiscussionRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndiscussionY)?'null':'"'.$iEzsigndiscussionY.'"').' for iEzsigndiscussionY when calling EzsigndiscussionRequest., must be bigger than or equal to 0.');
        }
