...
/**
 * PermissionRequestCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class PermissionRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'permission-RequestCompound';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['pkiPermissionID']) && ($this->container['pkiPermissionID'] > 65535)) {
            $invalidProperties[] = "invalid value for 'pkiPermissionID', must be smaller than or equal to 65535.";
        }

        if (!is_null($this->container['pkiPermissionID']) && ($this->container['pkiPermissionID'] < 0)) {
     ...
     *
     * @param int|null $pkiPermissionID The unique ID of the Permission
     *
     * @return self
     */
	...
	//if (($pkiPermissionID > 65535)) {
        if (!is_null($pkiPermissionID) && ($pkiPermissionID > 65535)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiPermissionID when calling PermissionRequestCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiPermissionID)?'null':'"'.$pkiPermissionID.'"').' for pkiPermissionID when calling PermissionRequestCompound., must be smaller than or equal to 65535.');
        }
	//if (($pkiPermissionID < 0)) {
        if (!is_null($pkiPermissionID) && ($pkiPermissionID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiPermissionID when calling PermissionRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiPermissionID)?'null':'"'.$pkiPermissionID.'"').' for pkiPermissionID when calling PermissionRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling PermissionRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling PermissionRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiApikeyID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiApikeyID when calling PermissionRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiApikeyID)?'null':'"'.$fkiApikeyID.'"').' for fkiApikeyID when calling PermissionRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUsergroupID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling PermissionRequestCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling PermissionRequestCompound., must be smaller than or equal to 255.');
        }
	//if (($fkiUsergroupID < 0)) {
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling PermissionRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling PermissionRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiCompanyID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiCompanyID when calling PermissionRequestCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCompanyID)?'null':'"'.$fkiCompanyID.'"').' for fkiCompanyID when calling PermissionRequestCompound., must be smaller than or equal to 255.');
        }
	//if (($fkiCompanyID < 1)) {
        if (!is_null($fkiCompanyID) && ($fkiCompanyID < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiCompanyID when calling PermissionRequestCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCompanyID)?'null':'"'.$fkiCompanyID.'"').' for fkiCompanyID when calling PermissionRequestCompound., must be bigger than or equal to 1.');
        }
	...
	//if (($fkiModulesectionID < 0)) {
        if (($fkiModulesectionID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiModulesectionID when calling PermissionRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiModulesectionID)?'null':'"'.$fkiModulesectionID.'"').' for fkiModulesectionID when calling PermissionRequestCompound., must be bigger than or equal to 0.');
        }
