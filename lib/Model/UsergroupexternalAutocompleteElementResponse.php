...
/**
 * UsergroupexternalAutocompleteElementResponse Class Doc Comment
 *
 * @category Class
 * @description A Usergroupexternal AutocompleteElement Response
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UsergroupexternalAutocompleteElementResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'usergroupexternal-AutocompleteElement-Response';
    ...
    protected static $openAPITypes = [
        ...
        'bUsergroupexternalIsactive' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'bUsergroupexternalIsactive' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'bUsergroupexternalIsactive' => false
    ];
    ...
    protected static $setters = [
        ...
        'bUsergroupexternalIsactive' => 'setBUsergroupexternalIsactive'
    ];
    ...
    protected static $getters = [
        ...
        'bUsergroupexternalIsactive' => 'getBUsergroupexternalIsactive'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bUsergroupexternalIsactive', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bUsergroupexternalIsactive'] === null) {
            $invalidProperties[] = "'bUsergroupexternalIsactive' can't be null";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiUsergroupexternalID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $pkiUsergroupexternalID when calling UsergroupexternalAutocompleteElementResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupexternalID)?'null':'"'.$pkiUsergroupexternalID.'"').' for pkiUsergroupexternalID when calling UsergroupexternalAutocompleteElementResponse., must be smaller than or equal to 255.');
        }
        //if (($pkiUsergroupexternalID < 0)) {
        if (($pkiUsergroupexternalID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiUsergroupexternalID when calling UsergroupexternalAutocompleteElementResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupexternalID)?'null':'"'.$pkiUsergroupexternalID.'"').' for pkiUsergroupexternalID when calling UsergroupexternalAutocompleteElementResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUsergroupexternalName) && (!preg_match("/(*UTF8)^.{0,64}$/", ObjectSerializer::toString($sUsergroupexternalName)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUsergroupexternalName when calling UsergroupexternalAutocompleteElementResponse., must conform to the pattern /^.{0,64}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupexternalName)?'null':'"'.$sUsergroupexternalName.'"')." for sUsergroupexternalName when calling UsergroupexternalAutocompleteElementResponse., must conform to the pattern /^.{0,64}$/.");
        }
    ...
    /**
     * Gets bUsergroupexternalIsactive
     *
     * @return bool
     */
    public function getBUsergroupexternalIsactive()
    {
	//return $this->container['bUsergroupexternalIsactive'];
        return $this->container['bUsergroupexternalIsactive'];
    }

    /**
     * Sets bUsergroupexternalIsactive
     *
     * @param bool $bUsergroupexternalIsactive Whether the Usergroupexternal is active or not
     *
     * @return self
     */
    public function setBUsergroupexternalIsactive($bUsergroupexternalIsactive)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($bUsergroupexternalIsactive)) {
            //throw new \InvalidArgumentException('non-nullable bUsergroupexternalIsactive cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['bUsergroupexternalIsactive'] = $bUsergroupexternalIsactive;
        $this->container['bUsergroupexternalIsactive'] = (is_null($bUsergroupexternalIsactive) ? null : (bool) $bUsergroupexternalIsactive);
