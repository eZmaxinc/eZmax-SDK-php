...
class UsergroupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'usergroup-Request';
    ...
    */
	...
	//if (($pkiUsergroupID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiUsergroupID when calling UsergroupRequest., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupID)?'null':'"'.$pkiUsergroupID.'"').' for pkiUsergroupID when calling UsergroupRequest., must be smaller than or equal to 255.');
        }
	//if (($pkiUsergroupID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiUsergroupID when calling UsergroupRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupID)?'null':'"'.$pkiUsergroupID.'"').' for pkiUsergroupID when calling UsergroupRequest., must be bigger than or equal to 0.');
        }
