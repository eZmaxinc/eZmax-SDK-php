...
/**
 * CustomEzsignfoldersignerassociationmineResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomEzsignfoldersignerassociationmineResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Custom-Ezsignfoldersignerassociationmine-Response';
...
//        if (($pkiEzsignfoldersignerassociationID < 0)) {
        if (($pkiEzsignfoldersignerassociationID < 0)) {
            throw new \InvalidArgumentException('invalid value for $pkiEzsignfoldersignerassociationID when calling CustomEzsignfoldersignerassociationmineResponse., must be bigger than or equal to 0.');
        }
...
//        if (($fkiEzsignfolderID < 0)) {
        if (($fkiEzsignfolderID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsignfolderID when calling CustomEzsignfoldersignerassociationmineResponse., must be bigger than or equal to 0.');
        }
