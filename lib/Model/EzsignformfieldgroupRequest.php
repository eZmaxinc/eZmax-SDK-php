    ...
    */
	...
	//if (($pkiEzsignformfieldgroupID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignformfieldgroupID when calling EzsignformfieldgroupRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignformfieldgroupID)?'null':'"'.$pkiEzsignformfieldgroupID.'"').' for pkiEzsignformfieldgroupID when calling EzsignformfieldgroupRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigndocumentID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigndocumentID when calling EzsignformfieldgroupRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigndocumentID)?'null':'"'.$fkiEzsigndocumentID.'"').' for fkiEzsigndocumentID when calling EzsignformfieldgroupRequest., must be bigger than or equal to 0.');
        }
	...
	//if ((mb_strlen($sEzsignformfieldgroupLabel) > 50)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupLabel when calling EzsignformfieldgroupRequest., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupLabel)?'null':'"'.$sEzsignformfieldgroupLabel.'"').', invalid length for sEzsignformfieldgroupLabel when calling EzsignformfieldgroupRequest., must be smaller than or equal to 50.');
        }
	//if ((mb_strlen($sEzsignformfieldgroupLabel) < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupLabel when calling EzsignformfieldgroupRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupLabel)?'null':'"'.$sEzsignformfieldgroupLabel.'"').', invalid length for sEzsignformfieldgroupLabel when calling EzsignformfieldgroupRequest., must be bigger than or equal to 1.');
        }
	...
	//if (($iEzsignformfieldgroupStep < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupStep when calling EzsignformfieldgroupRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupStep)?'null':'"'.$iEzsignformfieldgroupStep.'"').' for iEzsignformfieldgroupStep when calling EzsignformfieldgroupRequest., must be bigger than or equal to 1.');
        }
	...
	//if (($iEzsignformfieldgroupFilledmin < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupFilledmin when calling EzsignformfieldgroupRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupFilledmin)?'null':'"'.$iEzsignformfieldgroupFilledmin.'"').' for iEzsignformfieldgroupFilledmin when calling EzsignformfieldgroupRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignformfieldgroupFilledmax < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupFilledmax when calling EzsignformfieldgroupRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupFilledmax)?'null':'"'.$iEzsignformfieldgroupFilledmax.'"').' for iEzsignformfieldgroupFilledmax when calling EzsignformfieldgroupRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignformfieldgroupMaxlength > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupMaxlength when calling EzsignformfieldgroupRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupMaxlength)?'null':'"'.$iEzsignformfieldgroupMaxlength.'"').' for iEzsignformfieldgroupMaxlength when calling EzsignformfieldgroupRequest., must be smaller than or equal to 65535.');
        }
	//if (($iEzsignformfieldgroupMaxlength < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupMaxlength when calling EzsignformfieldgroupRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupMaxlength)?'null':'"'.$iEzsignformfieldgroupMaxlength.'"').' for iEzsignformfieldgroupMaxlength when calling EzsignformfieldgroupRequest., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^\\^.*\\$$|^$/", ObjectSerializer::toString($sEzsignformfieldgroupRegexp)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsignformfieldgroupRegexp when calling EzsignformfieldgroupRequest., must conform to the pattern /^\\^.*\\$$|^$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignformfieldgroupRegexp)?'null':'"'.$sEzsignformfieldgroupRegexp.'"')." for sEzsignformfieldgroupRegexp when calling EzsignformfieldgroupRequest., must conform to the pattern /^\\^.*\\$$|^$/.");
        }
	...
	//if ((mb_strlen($sEzsignformfieldgroupTextvalidationcustommessage) > 50)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupTextvalidationcustommessage when calling EzsignformfieldgroupRequest., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupTextvalidationcustommessage)?'null':'"'.$sEzsignformfieldgroupTextvalidationcustommessage.'"').', invalid length for sEzsignformfieldgroupTextvalidationcustommessage when calling EzsignformfieldgroupRequest., must be smaller than or equal to 50.');
        }
	//if ((mb_strlen($sEzsignformfieldgroupTextvalidationcustommessage) < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupTextvalidationcustommessage when calling EzsignformfieldgroupRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupTextvalidationcustommessage)?'null':'"'.$sEzsignformfieldgroupTextvalidationcustommessage.'"').', invalid length for sEzsignformfieldgroupTextvalidationcustommessage when calling EzsignformfieldgroupRequest., must be bigger than or equal to 0.');
        }
