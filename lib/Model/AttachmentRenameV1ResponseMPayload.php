...
/**
 * AttachmentRenameV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Response for POST /1/object/attachment/{pkiAttachmentID}/rename
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AttachmentRenameV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'attachment-rename-v1-Response-mPayload';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiAttachmentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiAttachmentID when calling AttachmentRenameV1ResponseMPayload., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiAttachmentID)?'null':'"'.$pkiAttachmentID.'"').' for pkiAttachmentID when calling AttachmentRenameV1ResponseMPayload., must be bigger than or equal to 0.');
        }
