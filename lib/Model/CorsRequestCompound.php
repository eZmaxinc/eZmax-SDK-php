...
/**
 * CorsRequestCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class CorsRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'cors-RequestCompound';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sCorsEntryurl']) && !preg_match("/(*UTF8)^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/", $this->container['sCorsEntryurl'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sCorsEntryurl'])?'null':'"'.$this->container['sCorsEntryurl'].'"')." for 'sCorsEntryurl', must be conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiCorsID) && ($pkiCorsID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $pkiCorsID when calling CorsRequestCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCorsID)?'null':'"'.$pkiCorsID.'"').' for pkiCorsID when calling CorsRequestCompound., must be smaller than or equal to 65535.');
        }
        //if (($pkiCorsID < 0)) {
        if (!is_null($pkiCorsID) && ($pkiCorsID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiCorsID when calling CorsRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCorsID)?'null':'"'.$pkiCorsID.'"').' for pkiCorsID when calling CorsRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiApikeyID < 0)) {
        if (($fkiApikeyID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiApikeyID when calling CorsRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiApikeyID)?'null':'"'.$fkiApikeyID.'"').' for fkiApikeyID when calling CorsRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCorsEntryurl) && (!preg_match("/(*UTF8)^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/", ObjectSerializer::toString($sCorsEntryurl)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCorsEntryurl when calling CorsRequestCompound., must conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCorsEntryurl)?'null':'"'.$sCorsEntryurl.'"')." for sCorsEntryurl when calling CorsRequestCompound., must conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.");
        }
