...
/**
 * CreditcardmerchantRequestCompound Class Doc Comment
 *
 * @category Class
 * @description A Creditcardmerchant Object and children
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreditcardmerchantRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'creditcardmerchant-RequestCompound';
    ...
    protected static $openAPIFormats = [
        ...
        'sCreditcardmerchantApitoken' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'sCreditcardmerchantApitoken' => false,
    ...
    protected static $attributeMap = [
        ...
        'sCreditcardmerchantApitoken' => 'sCreditcardmerchantApitoken',
    ...
    protected static $setters = [
        ...
        'sCreditcardmerchantApitoken' => 'setSCreditcardmerchantApitoken',
    ...
    protected static $getters = [
        ...
        'sCreditcardmerchantApitoken' => 'getSCreditcardmerchantApitoken',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sCreditcardmerchantApitoken', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['pkiCreditcardmerchantID']) && ($this->container['pkiCreditcardmerchantID'] > 255)) {
            $invalidProperties[] = "invalid value for 'pkiCreditcardmerchantID', must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['pkiCreditcardmerchantID']) && ($this->container['pkiCreditcardmerchantID'] < 0)) {
        ...
        //if (!is_null($this->container['sCreditcardmerchantApitoken']) && !preg_match("/^.{0,25}$/", $this->container['sCreditcardmerchantApitoken'])) {
        if (!is_null($this->container['sCreditcardmerchantApitoken']) && !preg_match("/(*UTF8)^.{0,25}$/", $this->container['sCreditcardmerchantApitoken'])) {
            //$invalidProperties[] = "invalid value for 'sCreditcardmerchantApitoken', must be conform to the pattern /^.{0,25}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sCreditcardmerchantApitoken'])?'null':'"'.$this->container['sCreditcardmerchantApitoken'].'"')." for 'sCreditcardmerchantApitoken', must be conform to the pattern /^.{0,25}$/.";
        }
     ...
     *
     * @param int|null $pkiCreditcardmerchantID The unique ID of the Creditcardmerchant
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiCreditcardmerchantID) && ($pkiCreditcardmerchantID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $pkiCreditcardmerchantID when calling CreditcardmerchantRequestCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCreditcardmerchantID)?'null':'"'.$pkiCreditcardmerchantID.'"').' for pkiCreditcardmerchantID when calling CreditcardmerchantRequestCompound., must be smaller than or equal to 255.');
        }
        //if (($pkiCreditcardmerchantID < 0)) {
        if (!is_null($pkiCreditcardmerchantID) && ($pkiCreditcardmerchantID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiCreditcardmerchantID when calling CreditcardmerchantRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCreditcardmerchantID)?'null':'"'.$pkiCreditcardmerchantID.'"').' for pkiCreditcardmerchantID when calling CreditcardmerchantRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiBankaccountID) && ($fkiBankaccountID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBankaccountID when calling CreditcardmerchantRequestCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBankaccountID)?'null':'"'.$fkiBankaccountID.'"').' for fkiBankaccountID when calling CreditcardmerchantRequestCompound., must be smaller than or equal to 255.');
        }
        //if (($fkiBankaccountID < 0)) {
        if (!is_null($fkiBankaccountID) && ($fkiBankaccountID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBankaccountID when calling CreditcardmerchantRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBankaccountID)?'null':'"'.$fkiBankaccountID.'"').' for fkiBankaccountID when calling CreditcardmerchantRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiLanguageID > 2)) {
        if (($fkiLanguageID > 2)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling CreditcardmerchantRequestCompound., must be smaller than or equal to 2.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling CreditcardmerchantRequestCompound., must be smaller than or equal to 2.');
        }
        //if (($fkiLanguageID < 1)) {
        if (($fkiLanguageID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling CreditcardmerchantRequestCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling CreditcardmerchantRequestCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiCurrencyID < 0)) {
        if (($fkiCurrencyID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCurrencyID when calling CreditcardmerchantRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCurrencyID)?'null':'"'.$fkiCurrencyID.'"').' for fkiCurrencyID when calling CreditcardmerchantRequestCompound., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets sCreditcardmerchantApitoken
     *
     * @return string|null
     */
    public function getSCreditcardmerchantApitoken()
    {
	//return $this->container['sCreditcardmerchantApitoken'];
        return is_null($this->container['sCreditcardmerchantApitoken']) ? null : trim($this->container['sCreditcardmerchantApitoken']);
    }

    /**
     * Sets sCreditcardmerchantApitoken
     *
     * @param string|null $sCreditcardmerchantApitoken The apitoken of the Creditcardmerchant
     *
     * @return self
     */
    public function setSCreditcardmerchantApitoken($sCreditcardmerchantApitoken)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($sCreditcardmerchantApitoken)) {
            //throw new \InvalidArgumentException('non-nullable sCreditcardmerchantApitoken cannot be null');
        //}

        //if ((!preg_match("/^.{0,25}$/", ObjectSerializer::toString($sCreditcardmerchantApitoken)))) {
        if (!is_null($sCreditcardmerchantApitoken) && (!preg_match("/(*UTF8)^.{0,25}$/", ObjectSerializer::toString($sCreditcardmerchantApitoken)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCreditcardmerchantApitoken when calling CreditcardmerchantRequestCompound., must conform to the pattern /^.{0,25}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCreditcardmerchantApitoken)?'null':'"'.$sCreditcardmerchantApitoken.'"')." for sCreditcardmerchantApitoken when calling CreditcardmerchantRequestCompound., must conform to the pattern /^.{0,25}$/.");
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['sCreditcardmerchantApitoken'] = $sCreditcardmerchantApitoken;
        $this->container['sCreditcardmerchantApitoken'] = (is_null($sCreditcardmerchantApitoken) ? null : trim((string) $sCreditcardmerchantApitoken));
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCreditcardmerchantDescription) && (!preg_match("/(*UTF8)^.{0,25}$/", ObjectSerializer::toString($sCreditcardmerchantDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCreditcardmerchantDescription when calling CreditcardmerchantRequestCompound., must conform to the pattern /^.{0,25}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCreditcardmerchantDescription)?'null':'"'.$sCreditcardmerchantDescription.'"')." for sCreditcardmerchantDescription when calling CreditcardmerchantRequestCompound., must conform to the pattern /^.{0,25}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCreditcardmerchantStoreid) && (!preg_match("/(*UTF8)^.{0,25}$/", ObjectSerializer::toString($sCreditcardmerchantStoreid)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCreditcardmerchantStoreid when calling CreditcardmerchantRequestCompound., must conform to the pattern /^.{0,25}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCreditcardmerchantStoreid)?'null':'"'.$sCreditcardmerchantStoreid.'"')." for sCreditcardmerchantStoreid when calling CreditcardmerchantRequestCompound., must conform to the pattern /^.{0,25}$/.");
        }
