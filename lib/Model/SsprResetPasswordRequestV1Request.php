...
/**
 * SsprResetPasswordRequestV1Request Class Doc Comment
 *
 * @category Class
 ...
 */
class SsprResetPasswordRequestV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sspr-resetPasswordRequest-v1-Request';
    ...
    public function setPksCustomerCode($pksCustomerCode)
    {
        if ((mb_strlen($pksCustomerCode) > 6)) {
            throw new \InvalidArgumentException('invalid length for $pksCustomerCode when calling SsprResetPasswordRequestV1Request., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($pksCustomerCode) < 2)) {
            throw new \InvalidArgumentException('invalid length for $pksCustomerCode when calling SsprResetPasswordRequestV1Request., must be bigger than or equal to 2.');
        }
    ...
    public function setFkiLanguageID($fkiLanguageID)
    {
        ...
        if (($fkiLanguageID > 2)) {
            throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling SsprResetPasswordRequestV1Request., must be smaller than or equal to 2.');
        }
        if (($fkiLanguageID < 1)) {
            throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling SsprResetPasswordRequestV1Request., must be bigger than or equal to 1.');
        }
