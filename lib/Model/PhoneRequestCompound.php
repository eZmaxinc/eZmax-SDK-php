...
class PhoneRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiPhoneID) && ($pkiPhoneID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiPhoneID when calling PhoneRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiPhoneID)?'null':'"'.$pkiPhoneID.'"').' for pkiPhoneID when calling PhoneRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiPhonetypeID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPhonetypeID)?'null':'"'.$fkiPhonetypeID.'"').' for fkiPhonetypeID when calling PhoneRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sPhoneE164) && (!preg_match("/(*UTF8)^\\+[1-9]\\d{1,14}$/", ObjectSerializer::toString($sPhoneE164)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sPhoneE164)?'null':'"'.$sPhoneE164.'"')." for sPhoneE164 when calling PhoneRequestCompound., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
