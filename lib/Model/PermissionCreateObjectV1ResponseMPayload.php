...
/**
 * PermissionCreateObjectV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 ...
 */
class PermissionCreateObjectV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'permission-createObject-v1-Response-mPayload';
    ...
    */
     ...
     *
     * @param int[] $aPkiPermissionID An array of unique IDs representing the object that were requested to be created.  They are returned in the same order as the array containing the objects to be created that was sent in the request.
     *
     * @return self
     */
