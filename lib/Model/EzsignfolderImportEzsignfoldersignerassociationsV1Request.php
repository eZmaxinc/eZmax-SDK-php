...
/**
 * EzsignfolderImportEzsignfoldersignerassociationsV1Request Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignfolderImportEzsignfoldersignerassociationsV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignfolder-importEzsignfoldersignerassociations-v1-Request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ('int[]' !== 'array[]') {
            if ($this->container['aFkiEzsignfoldersignerassociationID'] !== null && count($this->container['aFkiEzsignfoldersignerassociationID']) != count(array_unique($this->container['aFkiEzsignfoldersignerassociationID']))) {
                $invalidProperties[] = "'aFkiEzsignfoldersignerassociationID' must be unique.";
            }
        }
	...
	//if ((count($this->container['aFkiEzsignfoldersignerassociationID']) < 1)) {
        if (!is_null($this->container['aFkiEzsignfoldersignerassociationID']) && (count($this->container['aFkiEzsignfoldersignerassociationID']) < 1)) {
            $invalidProperties[] = "invalid value for 'aFkiEzsignfoldersignerassociationID', number of items must be greater than or equal to 1.";
        }
	...
	//if ((count($aFkiEzsignfoldersignerassociationID) < 1)) {
        if ((count($aFkiEzsignfoldersignerassociationID) < 1)) {
            //throw new \InvalidArgumentException('invalid length for $aFkiEzsignfoldersignerassociationID when calling EzsignfolderImportEzsignfoldersignerassociationsV1Request., number of items must be greater than or equal to 1.');
	    throw new \InvalidArgumentException('invalid length for aFkiEzsignfoldersignerassociationID when calling EzsignfolderImportEzsignfoldersignerassociationsV1Request., number of items must be greater than or equal to 1.');
        }
