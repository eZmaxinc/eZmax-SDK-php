...
class DiscussionmessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//if (!preg_match("/^[\\s\\S]{0,65535}$/", $this->container['tDiscussionmessageContent'])) {
        if (!is_null($this->container['tDiscussionmessageContent']) && !preg_match("/(*UTF8)^[\\s\\S]{0,65535}$/", $this->container['tDiscussionmessageContent'])) {
        //    $invalidProperties[] = "invalid value for 'tDiscussionmessageContent', must be conform to the pattern /^[\\s\\S]{0,65535}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['tDiscussionmessageContent'])?'null':'"'.$this->container['tDiscussionmessageContent'].'"')." for 'tDiscussionmessageContent', must be conform to the pattern /^[\\s\\S]{0,65535}$/.";
        }
	...
	//if (($pkiDiscussionmessageID > 16777215)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiDiscussionmessageID when calling DiscussionmessageRequest., must be smaller than or equal to 16777215.');
	...
	//if (($pkiDiscussionmessageID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiDiscussionmessageID when calling DiscussionmessageRequest., must be bigger than or equal to 0.');
	...
	//if (($fkiDiscussionID > 16777215)) {
        if (($fkiDiscussionID > 16777215)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiDiscussionID when calling DiscussionmessageRequest., must be smaller than or equal to 16777215.');
	...
	//if (($fkiDiscussionID < 0)) {
        if (($fkiDiscussionID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiDiscussionID when calling DiscussionmessageRequest., must be bigger than or equal to 0.');
	...
	//if (($fkiDiscussionmembershipIDActionrequired > 16777215)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiDiscussionmembershipIDActionrequired when calling DiscussionmessageRequest., must be smaller than or equal to 16777215.');
	...
	//if (($fkiDiscussionmembershipIDActionrequired < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiDiscussionmembershipIDActionrequired when calling DiscussionmessageRequest., must be bigger than or equal to 0.');
	...
	//if ((!preg_match("/^[\\s\\S]{0,65535}$/", ObjectSerializer::toString($tDiscussionmessageContent)))) {
        if (!is_null($tDiscussionmessageContent) && (!preg_match("/(*UTF8)^[\\s\\S]{0,65535}$/", ObjectSerializer::toString($tDiscussionmessageContent)))) {
	    //throw new \InvalidArgumentException("invalid value for \$tDiscussionmessageContent when calling DiscussionmessageRequest., must conform to the pattern /^[\\s\\S]{0,65535}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($tDiscussionmessageContent)?'null':'"'.$tDiscussionmessageContent.'"')." for tDiscussionmessageContent when calling DiscussionmessageRequest., must conform to the pattern /^[\\s\\S]{0,65535}$/.");
        }
