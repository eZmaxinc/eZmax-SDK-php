...
/**
 * EzsignbulksendsignermappingResponseCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignbulksendsignermappingResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsignbulksendsignermapping-ResponseCompound';
    ...
    protected static $openAPITypes = [
        ...
        'fkiUserID' => 'int',
        'bEzsignbulksendsignermappingReceivecopy' => 'bool',
    ...
    protected static $openAPIFormats = [
        ...
        'fkiUserID' => null,
        'bEzsignbulksendsignermappingReceivecopy' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'fkiUserID' => false,
        'bEzsignbulksendsignermappingReceivecopy' => false,
    ...
    protected static $attributeMap = [
        ...
        'fkiUserID' => 'fkiUserID',
        'bEzsignbulksendsignermappingReceivecopy' => 'bEzsignbulksendsignermappingReceivecopy',
    ...
    protected static $setters = [
        ...
        'bEzsignbulksendsignermappingReceivecopy' => 'setBEzsignbulksendsignermappingReceivecopy',
    ...
    protected static $getters = [
        ...
        'bEzsignbulksendsignermappingReceivecopy' => 'getBEzsignbulksendsignermappingReceivecopy',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bEzsignbulksendsignermappingReceivecopy', $data ?? [], null);
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsignbulksendsignermappingID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsignbulksendsignermappingID when calling EzsignbulksendsignermappingResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignbulksendsignermappingID)?'null':'"'.$pkiEzsignbulksendsignermappingID.'"').' for pkiEzsignbulksendsignermappingID when calling EzsignbulksendsignermappingResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsignbulksendID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignbulksendID when calling EzsignbulksendsignermappingResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignbulksendID)?'null':'"'.$fkiEzsignbulksendID.'"').' for fkiEzsignbulksendID when calling EzsignbulksendsignermappingResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUserID) && ($fkiUserID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling EzsignbulksendsignermappingResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling EzsignbulksendsignermappingResponseCompound., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets bEzsignbulksendsignermappingReceivecopy
     *
     * @return bool|null
     */
    public function getBEzsignbulksendsignermappingReceivecopy()
    {
	//return $this->container['bEzsignbulksendsignermappingReceivecopy'];
        return $this->container['bEzsignbulksendsignermappingReceivecopy'];
    }

    /**
     * Sets bEzsignbulksendsignermappingReceivecopy
     *
     * @param bool|null $bEzsignbulksendsignermappingReceivecopy Whether the Ezsignbulksendsigner will receive a copy or not
     *
     * @return self
     */
    public function setBEzsignbulksendsignermappingReceivecopy($bEzsignbulksendsignermappingReceivecopy)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($bEzsignbulksendsignermappingReceivecopy)) {
            //throw new \InvalidArgumentException('non-nullable bEzsignbulksendsignermappingReceivecopy cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['bEzsignbulksendsignermappingReceivecopy'] = $bEzsignbulksendsignermappingReceivecopy;
        $this->container['bEzsignbulksendsignermappingReceivecopy'] = (is_null($bEzsignbulksendsignermappingReceivecopy) ? null : (bool) $bEzsignbulksendsignermappingReceivecopy);
