...
/**
 * CustomEzsigndocumentEzsignsignaturesAutomaticResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomEzsigndocumentEzsignsignaturesAutomaticResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Custom-EzsigndocumentEzsignsignaturesAutomatic-Response';
    ...
    protected static $openAPITypes = [
        ...
        'aObjEzsignsignature' => '\eZmaxAPI\Model\CustomEzsignsignatureEzsignsignaturesAutomaticResponse[]'
    ];
    ...
    */
	...
	//if (($pkiEzsigndocumentID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigndocumentID when calling CustomEzsigndocumentEzsignsignaturesAutomaticResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndocumentID)?'null':'"'.$pkiEzsigndocumentID.'"').' for pkiEzsigndocumentID when calling CustomEzsigndocumentEzsignsignaturesAutomaticResponse., must be bigger than or equal to 0.');
        }
     ...
     *
     * @return \eZmaxAPI\Model\CustomEzsignsignatureEzsignsignaturesAutomaticResponse[]
     */
     ...
     *
     * @param \eZmaxAPI\Model\CustomEzsignsignatureEzsignsignaturesAutomaticResponse[] $aObjEzsignsignature aObjEzsignsignature
     *
     * @return self
     */
