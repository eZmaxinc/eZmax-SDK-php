...
/**
 * WordPositionResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class WordPositionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'wordPosition-Response';
    ...
    public function setIPage($iPage)
    {
        ...
        if (!is_null($iPage) && ($iPage < 1)) {
            throw new \InvalidArgumentException('invalid value for $iPage when calling WordPositionResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setIX($iX)
    {
        ...
        if (!is_null($iX) && ($iX < 0)) {
            throw new \InvalidArgumentException('invalid value for $iX when calling WordPositionResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setIY($iY)
    {
        ...
        if (!is_null($iY) && ($iY < 0)) {
            throw new \InvalidArgumentException('invalid value for $iY when calling WordPositionResponse., must be bigger than or equal to 0.');
        }
