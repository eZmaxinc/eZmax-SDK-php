...
/**
 * UserAutocompleteElementResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class UserAutocompleteElementResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'user-AutocompleteElement-Response';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sUserName'] === null) {
            $invalidProperties[] = "'sUserName' can't be null";
        }
	...
	//if (($pkiUserID < 0)) {
        if (($pkiUserID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiUserID when calling UserAutocompleteElementResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUserID)?'null':'"'.$pkiUserID.'"').' for pkiUserID when calling UserAutocompleteElementResponse., must be bigger than or equal to 0.');
        }
