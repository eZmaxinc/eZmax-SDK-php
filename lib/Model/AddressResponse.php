...
class AddressResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'address-Response';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['fAddressLongitude']) && !preg_match("/(*UTF8)^(-?)(180(\\.0{1,15})?|((1[0-7]\\d)|(\\d{1,2}))(\\.\\d{1,15})?)$/", $this->container['fAddressLongitude'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['fAddressLongitude'])?'null':'"'.$this->container['fAddressLongitude'].'"')." for 'fAddressLongitude', must be conform to the pattern /^(-?)(180(\\.0{1,15})?|((1[0-7]\\d)|(\\d{1,2}))(\\.\\d{1,15})?)$/.";
        }
        ...
        if (!is_null($this->container['fAddressLatitude']) && !preg_match("/(*UTF8)^(-?)(90(\\.0{1,15})?|([1-8]?\\d(\\.\\d{1,15})?))$/", $this->container['fAddressLatitude'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['fAddressLatitude'])?'null':'"'.$this->container['fAddressLatitude'].'"')." for 'fAddressLatitude', must be conform to the pattern /^(-?)(90(\\.0{1,15})?|([1-8]?\\d(\\.\\d{1,15})?))$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($pkiAddressID < 0)) {
        if (($pkiAddressID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiAddressID when calling AddressResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiAddressID)?'null':'"'.$pkiAddressID.'"').' for pkiAddressID when calling AddressResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiAddresstypeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiAddresstypeID when calling AddressResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAddresstypeID)?'null':'"'.$fkiAddresstypeID.'"').' for fkiAddresstypeID when calling AddressResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiProvinceID < 0)) {
        if (($fkiProvinceID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiProvinceID when calling AddressResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiProvinceID)?'null':'"'.$fkiProvinceID.'"').' for fkiProvinceID when calling AddressResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sProvinceNameX) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sProvinceNameX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sProvinceNameX when calling AddressResponse., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sProvinceNameX)?'null':'"'.$sProvinceNameX.'"')." for sProvinceNameX when calling AddressResponse., must conform to the pattern /^.{0,50}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiCountryID < 0)) {
        if (($fkiCountryID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCountryID when calling AddressResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCountryID)?'null':'"'.$fkiCountryID.'"').' for fkiCountryID when calling AddressResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCountryNameX) && (!preg_match("/(*UTF8)^.{0,40}$/", ObjectSerializer::toString($sCountryNameX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCountryNameX when calling AddressResponse., must conform to the pattern /^.{0,40}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCountryNameX)?'null':'"'.$sCountryNameX.'"')." for sCountryNameX when calling AddressResponse., must conform to the pattern /^.{0,40}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fAddressLongitude) && (!preg_match("/(*UTF8)^(-?)(180(\\.0{1,15})?|((1[0-7]\\d)|(\\d{1,2}))(\\.\\d{1,15})?)$/", ObjectSerializer::toString($fAddressLongitude)))) {
            //throw new \InvalidArgumentException("invalid value for \$fAddressLongitude when calling AddressResponse., must conform to the pattern /^(-?)(180(\\.0{1,15})?|((1[0-7]\\d)|(\\d{1,2}))(\\.\\d{1,15})?)$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($fAddressLongitude)?'null':'"'.$fAddressLongitude.'"')." for fAddressLongitude when calling AddressResponse., must conform to the pattern /^(-?)(180(\\.0{1,15})?|((1[0-7]\\d)|(\\d{1,2}))(\\.\\d{1,15})?)$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fAddressLatitude) && (!preg_match("/(*UTF8)^(-?)(90(\\.0{1,15})?|([1-8]?\\d(\\.\\d{1,15})?))$/", ObjectSerializer::toString($fAddressLatitude)))) {
            //throw new \InvalidArgumentException("invalid value for \$fAddressLatitude when calling AddressResponse., must conform to the pattern /^(-?)(90(\\.0{1,15})?|([1-8]?\\d(\\.\\d{1,15})?))$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($fAddressLatitude)?'null':'"'.$fAddressLatitude.'"')." for fAddressLatitude when calling AddressResponse., must conform to the pattern /^(-?)(90(\\.0{1,15})?|([1-8]?\\d(\\.\\d{1,15})?))$/.");
        }
