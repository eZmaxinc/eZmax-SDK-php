...
/**
 * CreditcardmerchantResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class CreditcardmerchantResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'creditcardmerchant-Response';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiCreditcardmerchantID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $pkiCreditcardmerchantID when calling CreditcardmerchantResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCreditcardmerchantID)?'null':'"'.$pkiCreditcardmerchantID.'"').' for pkiCreditcardmerchantID when calling CreditcardmerchantResponse., must be smaller than or equal to 255.');
        }
        //if (($pkiCreditcardmerchantID < 0)) {
        if (($pkiCreditcardmerchantID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiCreditcardmerchantID when calling CreditcardmerchantResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCreditcardmerchantID)?'null':'"'.$pkiCreditcardmerchantID.'"').' for pkiCreditcardmerchantID when calling CreditcardmerchantResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiBankaccountID) && ($fkiBankaccountID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBankaccountID when calling CreditcardmerchantResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBankaccountID)?'null':'"'.$fkiBankaccountID.'"').' for fkiBankaccountID when calling CreditcardmerchantResponse., must be smaller than or equal to 255.');
        }
        //if (($fkiBankaccountID < 0)) {
        if (!is_null($fkiBankaccountID) && ($fkiBankaccountID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBankaccountID when calling CreditcardmerchantResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBankaccountID)?'null':'"'.$fkiBankaccountID.'"').' for fkiBankaccountID when calling CreditcardmerchantResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiLanguageID > 2)) {
        if (($fkiLanguageID > 2)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling CreditcardmerchantResponse., must be smaller than or equal to 2.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling CreditcardmerchantResponse., must be smaller than or equal to 2.');
        }
        //if (($fkiLanguageID < 1)) {
        if (($fkiLanguageID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling CreditcardmerchantResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling CreditcardmerchantResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiCurrencyID < 0)) {
        if (($fkiCurrencyID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCurrencyID when calling CreditcardmerchantResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCurrencyID)?'null':'"'.$fkiCurrencyID.'"').' for fkiCurrencyID when calling CreditcardmerchantResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCurrencyDescriptionX) && (!preg_match("/(*UTF8)^.{1,20}$/", ObjectSerializer::toString($sCurrencyDescriptionX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCurrencyDescriptionX when calling CreditcardmerchantResponse., must conform to the pattern /^.{1,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCurrencyDescriptionX)?'null':'"'.$sCurrencyDescriptionX.'"')." for sCurrencyDescriptionX when calling CreditcardmerchantResponse., must conform to the pattern /^.{1,20}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCreditcardmerchantDescription) && (!preg_match("/(*UTF8)^.{0,25}$/", ObjectSerializer::toString($sCreditcardmerchantDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCreditcardmerchantDescription when calling CreditcardmerchantResponse., must conform to the pattern /^.{0,25}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCreditcardmerchantDescription)?'null':'"'.$sCreditcardmerchantDescription.'"')." for sCreditcardmerchantDescription when calling CreditcardmerchantResponse., must conform to the pattern /^.{0,25}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCreditcardmerchantStoreid) && (!preg_match("/(*UTF8)^.{0,25}$/", ObjectSerializer::toString($sCreditcardmerchantStoreid)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCreditcardmerchantStoreid when calling CreditcardmerchantResponse., must conform to the pattern /^.{0,25}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCreditcardmerchantStoreid)?'null':'"'.$sCreditcardmerchantStoreid.'"')." for sCreditcardmerchantStoreid when calling CreditcardmerchantResponse., must conform to the pattern /^.{0,25}$/.");
        }
