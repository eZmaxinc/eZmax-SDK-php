    ...
    */
	...
	//if (($pkiVersionhistoryID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiVersionhistoryID when calling VersionhistoryResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiVersionhistoryID)?'null':'"'.$pkiVersionhistoryID.'"').' for pkiVersionhistoryID when calling VersionhistoryResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiModuleID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiModuleID when calling VersionhistoryResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiModuleID)?'null':'"'.$fkiModuleID.'"').' for fkiModuleID when calling VersionhistoryResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiModulesectionID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiModulesectionID when calling VersionhistoryResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiModulesectionID)?'null':'"'.$fkiModulesectionID.'"').' for fkiModulesectionID when calling VersionhistoryResponse., must be bigger than or equal to 0.');
        }
