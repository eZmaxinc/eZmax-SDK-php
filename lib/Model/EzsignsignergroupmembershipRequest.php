...
/**
 * EzsignsignergroupmembershipRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignsignergroupmembershipRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignsignergroupmembership-Request';
    ...
    */
	...
	//if (($pkiEzsignsignergroupmembershipID > 16777215)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignergroupmembershipID when calling EzsignsignergroupmembershipRequest., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignergroupmembershipID)?'null':'"'.$pkiEzsignsignergroupmembershipID.'"').' for pkiEzsignsignergroupmembershipID when calling EzsignsignergroupmembershipRequest., must be smaller than or equal to 16777215.');
        }
	//if (($pkiEzsignsignergroupmembershipID < 0)) {
        if (!is_null($pkiEzsignsignergroupmembershipID) && ($pkiEzsignsignergroupmembershipID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignergroupmembershipID when calling EzsignsignergroupmembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignergroupmembershipID)?'null':'"'.$pkiEzsignsignergroupmembershipID.'"').' for pkiEzsignsignergroupmembershipID when calling EzsignsignergroupmembershipRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignsignergroupID > 65535)) {
        if (($fkiEzsignsignergroupID > 65535)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignsignergroupID when calling EzsignsignergroupmembershipRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsignergroupID)?'null':'"'.$fkiEzsignsignergroupID.'"').' for fkiEzsignsignergroupID when calling EzsignsignergroupmembershipRequest., must be smaller than or equal to 65535.');
        }
	//if (($fkiEzsignsignergroupID < 0)) {
        if (($fkiEzsignsignergroupID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignsignergroupID when calling EzsignsignergroupmembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsignergroupID)?'null':'"'.$fkiEzsignsignergroupID.'"').' for fkiEzsignsignergroupID when calling EzsignsignergroupmembershipRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignsignerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignsignerID when calling EzsignsignergroupmembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsignerID)?'null':'"'.$fkiEzsignsignerID.'"').' for fkiEzsignsignerID when calling EzsignsignergroupmembershipRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling EzsignsignergroupmembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling EzsignsignergroupmembershipRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUsergroupID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling EzsignsignergroupmembershipRequest., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling EzsignsignergroupmembershipRequest., must be smaller than or equal to 255.');
        }
	//if (($fkiUsergroupID < 0)) {
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling EzsignsignergroupmembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling EzsignsignergroupmembershipRequest., must be bigger than or equal to 0.');
        }
