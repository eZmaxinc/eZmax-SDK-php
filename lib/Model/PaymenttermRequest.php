...
/**
 * PaymenttermRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymenttermRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'paymentterm-Request';
    ...
    */
	...
	//if ((!preg_match("/^[A-Z0-9]{1,4}$/", ObjectSerializer::toString($sPaymenttermCode)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sPaymenttermCode when calling PaymenttermRequest., must conform to the pattern /^[A-Z0-9]{1,4}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sPaymenttermCode)?'null':'"'.$sPaymenttermCode.'"')." for sPaymenttermCode when calling PaymenttermRequest., must conform to the pattern /^[A-Z0-9]{1,4}$/.");
        }
	...
	//if (($iPaymenttermDay > 255)) {
        if (($iPaymenttermDay > 255)) {
	    //throw new \InvalidArgumentException('invalid value for $iPaymenttermDay when calling PaymenttermRequest., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iPaymenttermDay)?'null':'"'.$iPaymenttermDay.'"').' for iPaymenttermDay when calling PaymenttermRequest., must be smaller than or equal to 255.');
        }
	//if (($iPaymenttermDay < 0)) {
        if (($iPaymenttermDay < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iPaymenttermDay when calling PaymenttermRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iPaymenttermDay)?'null':'"'.$iPaymenttermDay.'"').' for iPaymenttermDay when calling PaymenttermRequest., must be bigger than or equal to 0.');
        }
