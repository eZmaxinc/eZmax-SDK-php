    ...
    */
	...
	//if (!preg_match("/^.{0,20}$/", $this->container['sPhonetypeNameX'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sPhonetypeNameX', must be conform to the pattern /^.{0,20}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sPhonetypeNameX'])?'null':'"'.$this->container['sPhonetypeNameX'].'"')." for 'sPhonetypeNameX', must be conform to the pattern /^.{0,20}$/.";
        }
