...
/**
 * EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /1/object/ezsigntemplatepackagesignermembership/{pkiEzsigntemplatepackagesignermembershipID}
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigntemplatepackagesignermembership-getObject-v1-Response-mPayload';
    ...
    {
        $this->container['pkiEzsigntemplatepackagesignermembershipID'] = $data['pkiEzsigntemplatepackagesignermembershipID'] ?? null;
        $this->container['fkiEzsigntemplatepackagemembershipID'] = $data['fkiEzsigntemplatepackagemembershipID'] ?? null;
        ...
        $this->container['iEzsigntemplatepackagesignermembershipCopy'] = $data['iEzsigntemplatepackagesignermembershipCopy'] ?? null;
    }
    ...
    public function setPkiEzsigntemplatepackagesignermembershipID($pkiEzsigntemplatepackagesignermembershipID)
    {
        ...
        if (($pkiEzsigntemplatepackagesignermembershipID < 0)) {
            throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatepackagesignermembershipID when calling EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setFkiEzsigntemplatepackagemembershipID($fkiEzsigntemplatepackagemembershipID)
    {
        ...
        if (($fkiEzsigntemplatepackagemembershipID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepackagemembershipID when calling EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setFkiEzsigntemplatepackagesignerID($fkiEzsigntemplatepackagesignerID)
    {
        ...
        if (($fkiEzsigntemplatepackagesignerID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepackagesignerID when calling EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setFkiEzsigntemplatesignerID($fkiEzsigntemplatesignerID)
    {
        ...
        if (($fkiEzsigntemplatesignerID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatesignerID when calling EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setIEzsigntemplatepackagesignermembershipCopy($iEzsigntemplatepackagesignermembershipCopy)
    {
        ...
        if (!is_null($iEzsigntemplatepackagesignermembershipCopy) && ($iEzsigntemplatepackagesignermembershipCopy < 1)) {
            throw new \InvalidArgumentException('invalid value for $iEzsigntemplatepackagesignermembershipCopy when calling EzsigntemplatepackagesignermembershipGetObjectV1ResponseMPayload., must be bigger than or equal to 1.');
        }
