...
class MultilingualPaymenttermDescription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sPaymenttermDescription1']) && (mb_strlen($this->container['sPaymenttermDescription1']) > 40)) {
            $invalidProperties[] = "invalid value for 'sPaymenttermDescription1', the character length must be smaller than or equal to 40.";
        }

        if (!is_null($this->container['sPaymenttermDescription2']) && (mb_strlen($this->container['sPaymenttermDescription2']) > 40)) {
            $invalidProperties[] = "invalid value for 'sPaymenttermDescription2', the character length must be smaller than or equal to 40.";
        }
    ...
    {
        if (!is_null($sPaymenttermDescription1) && (mb_strlen($sPaymenttermDescription1) > 40)) {
            throw new \InvalidArgumentException('invalid length for $sPaymenttermDescription1 when calling MultilingualPaymenttermDescription., must be smaller than or equal to 40.');
        }
    ...
    {
        if (!is_null($sPaymenttermDescription2) && (mb_strlen($sPaymenttermDescription2) > 40)) {
            throw new \InvalidArgumentException('invalid length for $sPaymenttermDescription2 when calling MultilingualPaymenttermDescription., must be smaller than or equal to 40.');
        }
