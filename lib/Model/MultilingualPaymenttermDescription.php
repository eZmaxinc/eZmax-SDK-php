...
class MultilingualPaymenttermDescription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sPaymenttermDescription1']) && !preg_match("/(*UTF8)^.{1,40}$/", $this->container['sPaymenttermDescription1'])) {
            //$invalidProperties[] = "invalid value for 'sPaymenttermDescription1', must be conform to the pattern /^.{1,40}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sPaymenttermDescription1'])?'null':'"'.$this->container['sPaymenttermDescription1'].'"')." for 'sPaymenttermDescription1', must be conform to the pattern /^.{1,40}$/.";
        }

        //if (!is_null($this->container['sPaymenttermDescription2']) && !preg_match("/^.{1,40}$/", $this->container['sPaymenttermDescription2'])) {
        if (!is_null($this->container['sPaymenttermDescription2']) && !preg_match("/(*UTF8)^.{1,40}$/", $this->container['sPaymenttermDescription2'])) {
            //$invalidProperties[] = "invalid value for 'sPaymenttermDescription2', must be conform to the pattern /^.{1,40}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sPaymenttermDescription2'])?'null':'"'.$this->container['sPaymenttermDescription2'].'"')." for 'sPaymenttermDescription2', must be conform to the pattern /^.{1,40}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sPaymenttermDescription1) && (!preg_match("/(*UTF8)^.{1,40}$/", ObjectSerializer::toString($sPaymenttermDescription1)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sPaymenttermDescription1)?'null':'"'.$sPaymenttermDescription1.'"')." for sPaymenttermDescription1 when calling MultilingualPaymenttermDescription., must conform to the pattern /^.{1,40}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sPaymenttermDescription2) && (!preg_match("/(*UTF8)^.{1,40}$/", ObjectSerializer::toString($sPaymenttermDescription2)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sPaymenttermDescription2)?'null':'"'.$sPaymenttermDescription2.'"')." for sPaymenttermDescription2 when calling MultilingualPaymenttermDescription., must conform to the pattern /^.{1,40}$/.");
        }
