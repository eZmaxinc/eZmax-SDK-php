...
/**
 * EzsignfolderDisposeEzsignfoldersV1Request Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignfolderDisposeEzsignfoldersV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignfolder-disposeEzsignfolders-v1-Request';
...
//        if ((count($this->container['aPkiEzsignfolderID']) < 1)) {
     ...
     *
     * @param int[] $aPkiEzsignfolderID aPkiEzsignfolderID
     *
     * @return self
     */
