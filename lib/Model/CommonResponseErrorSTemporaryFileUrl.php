...
/**
 * CommonResponseErrorSTemporaryFileUrl Class Doc Comment
 *
 * @category Class
 ...
 */
class CommonResponseErrorSTemporaryFileUrl implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Common-Response-Error-sTemporaryFileUrl';
    ...
    protected static $attributeMap = [
        ...
        'sTemporaryFileUrl' => 'sTemporaryFileUrl'
    ];
    ...
    protected static $setters = [
        ...
        'sTemporaryFileUrl' => 'setSTemporaryFileUrl'
    ];
    ...
    protected static $getters = [
        ...
        'sTemporaryFileUrl' => 'getSTemporaryFileUrl'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sTemporaryFileUrl', $data ?? [], null);
    }
    ...
    */
	...
	//if (!is_null($this->container['sTemporaryFileUrl']) && !preg_match("/^https:\/\/[^\\s\/$.?#].[^\\s]*$/", $this->container['sTemporaryFileUrl'])) {
        if (!is_null($this->container['sTemporaryFileUrl']) && !preg_match("/(*UTF8)^https:\/\/[^\\s\/$.?#].[^\\s]*$/", $this->container['sTemporaryFileUrl'])) {
        //    $invalidProperties[] = "invalid value for 'sTemporaryFileUrl', must be conform to the pattern /^https:\/\/[^\\s\/$.?#].[^\\s]*$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sTemporaryFileUrl'])?'null':'"'.$this->container['sTemporaryFileUrl'].'"')." for 'sTemporaryFileUrl', must be conform to the pattern /^https:\/\/[^\\s\/$.?#].[^\\s]*$/.";
        }
	...
	//if ((!preg_match("/^.{0,500}$/", ObjectSerializer::toString($sErrorMessage)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sErrorMessage when calling CommonResponseErrorSTemporaryFileUrl., must conform to the pattern /^.{0,500}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sErrorMessage)?'null':'"'.$sErrorMessage.'"')." for sErrorMessage when calling CommonResponseErrorSTemporaryFileUrl., must conform to the pattern /^.{0,500}$/.");
        }
    ...
    /**
     * Sets sTemporaryFileUrl
     *
     * @param string|null $sTemporaryFileUrl The Temporary File Url of the document that was uploaded. That url can be reused instead of uploading the file again.
     *
     * @return self
     */
	...
	//if ((!preg_match("/^https:\/\/[^\\s\/$.?#].[^\\s]*$/", ObjectSerializer::toString($sTemporaryFileUrl)))) {
        if (!is_null($sTemporaryFileUrl) && (!preg_match("/(*UTF8)^https:\/\/[^\\s\/$.?#].[^\\s]*$/", ObjectSerializer::toString($sTemporaryFileUrl)))) {
	    //throw new \InvalidArgumentException("invalid value for \$sTemporaryFileUrl when calling CommonResponseErrorSTemporaryFileUrl., must conform to the pattern /^https:\/\/[^\\s\/$.?#].[^\\s]*$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sTemporaryFileUrl)?'null':'"'.$sTemporaryFileUrl.'"')." for sTemporaryFileUrl when calling CommonResponseErrorSTemporaryFileUrl., must conform to the pattern /^https:\/\/[^\\s\/$.?#].[^\\s]*$/.");
        }
