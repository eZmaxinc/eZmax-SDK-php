...
class CommonResponseErrorSTemporaryFileUrl implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['sTemporaryFileUrl'] = $data['sTemporaryFileUrl'] ?? null;
        $this->container['sErrorMessage'] = $data['sErrorMessage'] ?? null;
        $this->container['eErrorCode'] = $data['eErrorCode'] ?? null;
    }
     ...
     * Sets eErrorCode
     *
     * @param string|null $eErrorCode The error code. See documentation for valid values
     *
     * @return self
     */
