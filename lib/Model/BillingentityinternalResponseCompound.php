...
/**
 * BillingentityinternalResponseCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class BillingentityinternalResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'billingentityinternal-ResponseCompound';
    ...
    protected static $openAPITypes = [
        ...
        'aObjBillingentityinternalproduct' => '\eZmaxAPI\Model\BillingentityinternalproductResponseCompound[]'
    ];
...
//        if (($pkiBillingentityinternalID < 0)) {
        if (($pkiBillingentityinternalID < 0)) {
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiBillingentityinternalID)?'null':'"'.$pkiBillingentityinternalID.'"').' for pkiBillingentityinternalID when calling BillingentityinternalResponseCompound., must be bigger than or equal to 0.');
        }
     ...
     *
     * @return \eZmaxAPI\Model\BillingentityinternalproductResponseCompound[]
     */
    public function getAObjBillingentityinternalproduct()
    {
        return $this->container['aObjBillingentityinternalproduct'];
    }

    /**
     * Sets aObjBillingentityinternalproduct
     *
     * @param \eZmaxAPI\Model\BillingentityinternalproductResponseCompound[] $aObjBillingentityinternalproduct aObjBillingentityinternalproduct
     *
     * @return self
     */
    public function setAObjBillingentityinternalproduct($aObjBillingentityinternalproduct)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjBillingentityinternalproduct)) {
            //throw new \InvalidArgumentException('non-nullable aObjBillingentityinternalproduct cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
	//$this->container['aObjBillingentityinternalproduct'] = $aObjBillingentityinternalproduct;
        $this->container['aObjBillingentityinternalproduct'] = $aObjBillingentityinternalproduct;
