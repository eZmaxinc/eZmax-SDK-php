...
/**
 * EzmaxmaillinglistGetListV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /1/object/ezmaxmaillinglist/getList
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzmaxmaillinglistGetListV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezmaxmaillinglist-getList-v1-Response-mPayload';
    ...
    protected static $openAPITypes = [
        'iRowReturned' => 'int',
        'iRowFiltered' => 'int',
        'aObjEzmaxmaillinglist' => '\eZmaxAPI\Model\EzmaxmaillinglistListElement[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'aObjEzmaxmaillinglist' => 'a_objEzmaxmaillinglist'
    ];
    ...
    protected static $setters = [
        ...
        'aObjEzmaxmaillinglist' => 'setAObjEzmaxmaillinglist'
    ];
    ...
    protected static $getters = [
        ...
        'aObjEzmaxmaillinglist' => 'getAObjEzmaxmaillinglist'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aObjEzmaxmaillinglist', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aObjEzmaxmaillinglist'] === null) {
            $invalidProperties[] = "'aObjEzmaxmaillinglist' can't be null";
        }
    ...
    /**
     * Gets aObjEzmaxmaillinglist
     *
     * @return \eZmaxAPI\Model\EzmaxmaillinglistListElement[]
     */
    public function getAObjEzmaxmaillinglist()
    {
	//return $this->container['aObjEzmaxmaillinglist'];
        return $this->container['aObjEzmaxmaillinglist'];
    }

    /**
     * Sets aObjEzmaxmaillinglist
     *
     * @param \eZmaxAPI\Model\EzmaxmaillinglistListElement[] $aObjEzmaxmaillinglist aObjEzmaxmaillinglist
     *
     * @return self
     */
    public function setAObjEzmaxmaillinglist($aObjEzmaxmaillinglist)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjEzmaxmaillinglist)) {
            //throw new \InvalidArgumentException('non-nullable aObjEzmaxmaillinglist cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjEzmaxmaillinglist'] = $aObjEzmaxmaillinglist;
        $this->container['aObjEzmaxmaillinglist'] = $aObjEzmaxmaillinglist;
