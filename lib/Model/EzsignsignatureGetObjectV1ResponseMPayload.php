 ...
 */
class EzsignsignatureGetObjectV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignsignature-getObject-v1-Response-mPayload';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['iEzsignsignatureValidationstep'] = $data['iEzsignsignatureValidationstep'] ?? null;
        $this->container['sEzsignsignatureAttachmentdescription'] = $data['sEzsignsignatureAttachmentdescription'] ?? null;
        $this->container['eEzsignsignatureAttachmentnamesource'] = $data['eEzsignsignatureAttachmentnamesource'] ?? null;
        $this->container['bEzsignsignatureRequired'] = $data['bEzsignsignatureRequired'] ?? null;
    ...
    public function setPkiEzsignsignatureID($pkiEzsignsignatureID)
    {
        ...
        if (($pkiEzsignsignatureID < 0)) {
            throw new \InvalidArgumentException('invalid value for $pkiEzsignsignatureID when calling EzsignsignatureGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setFkiEzsigndocumentID($fkiEzsigndocumentID)
    {
        ...
        if (($fkiEzsigndocumentID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsigndocumentID when calling EzsignsignatureGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setFkiEzsignfoldersignerassociationID($fkiEzsignfoldersignerassociationID)
    {
        ...
        if (($fkiEzsignfoldersignerassociationID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldersignerassociationID when calling EzsignsignatureGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setIEzsignpagePagenumber($iEzsignpagePagenumber)
    {
        ...
        if (($iEzsignpagePagenumber < 1)) {
            throw new \InvalidArgumentException('invalid value for $iEzsignpagePagenumber when calling EzsignsignatureGetObjectV1ResponseMPayload., must be bigger than or equal to 1.');
        }
    ...
    public function setIEzsignsignatureX($iEzsignsignatureX)
    {
        ...
        if (($iEzsignsignatureX < 0)) {
            throw new \InvalidArgumentException('invalid value for $iEzsignsignatureX when calling EzsignsignatureGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setIEzsignsignatureY($iEzsignsignatureY)
    {
        ...
        if (($iEzsignsignatureY < 0)) {
            throw new \InvalidArgumentException('invalid value for $iEzsignsignatureY when calling EzsignsignatureGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setFkiUserID($fkiUserID)
    {
        ...
        if (!is_null($fkiUserID) && ($fkiUserID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiUserID when calling EzsignsignatureGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
