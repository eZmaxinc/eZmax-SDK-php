...
class CustomFormDataDocumentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aObjFormDataSigner', $data ?? [], null);
    }
    ...
    */
	...
	//if (($pkiEzsigndocumentID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigndocumentID when calling CustomFormDataDocumentResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndocumentID)?'null':'"'.$pkiEzsigndocumentID.'"').' for pkiEzsigndocumentID when calling CustomFormDataDocumentResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignfolderID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfolderID when calling CustomFormDataDocumentResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfolderID)?'null':'"'.$fkiEzsignfolderID.'"').' for fkiEzsignfolderID when calling CustomFormDataDocumentResponse., must be bigger than or equal to 0.');
        }
