...
/**
 * PhoneRequestCompoundV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class PhoneRequestCompoundV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'phone-RequestCompoundV2';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['pkiPhoneID']) && ($this->container['pkiPhoneID'] < 0)) {
     ...
     * Sets pkiPhoneID
     *
     * @param int|null $pkiPhoneID The unique ID of the Phone.
     *
     * @return self
     */
	...
	//if (($pkiPhoneID < 0)) {
        if (!is_null($pkiPhoneID) && ($pkiPhoneID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiPhoneID when calling PhoneRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiPhoneID)?'null':'"'.$pkiPhoneID.'"').' for pkiPhoneID when calling PhoneRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiPhonetypeID < 0)) {
        if (($fkiPhonetypeID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiPhonetypeID when calling PhoneRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPhonetypeID)?'null':'"'.$fkiPhonetypeID.'"').' for fkiPhonetypeID when calling PhoneRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^\\+[1-9]\\d{1,14}$/", ObjectSerializer::toString($sPhoneE164)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sPhoneE164 when calling PhoneRequestCompoundV2., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sPhoneE164)?'null':'"'.$sPhoneE164.'"')." for sPhoneE164 when calling PhoneRequestCompoundV2., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
