...
class EzsigndocumentResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//if ((!preg_match("/^.{32}$/", ObjectSerializer::toString($sEzsigndocumentMD5initial)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsigndocumentMD5initial when calling EzsigndocumentResponseCompound., must conform to the pattern /^.{32}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigndocumentMD5initial)?'null':'"'.$sEzsigndocumentMD5initial.'"')." for sEzsigndocumentMD5initial when calling EzsigndocumentResponseCompound., must conform to the pattern /^.{32}$/.");
        }
	...
	//if ((!preg_match("/^.{32}$/", ObjectSerializer::toString($sEzsigndocumentMD5signed)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsigndocumentMD5signed when calling EzsigndocumentResponseCompound., must conform to the pattern /^.{32}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigndocumentMD5signed)?'null':'"'.$sEzsigndocumentMD5signed.'"')." for sEzsigndocumentMD5signed when calling EzsigndocumentResponseCompound., must conform to the pattern /^.{32}$/.");
        }
