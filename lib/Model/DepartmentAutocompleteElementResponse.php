...
//        if (($pkiDepartmentID < 0)) {
        if (($pkiDepartmentID < 0)) {
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiDepartmentID)?'null':'"'.$pkiDepartmentID.'"').' for pkiDepartmentID when calling DepartmentAutocompleteElementResponse., must be bigger than or equal to 0.');
        }
