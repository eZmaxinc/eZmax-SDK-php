 ...
 */
class EzsigndocumentCreateObjectV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'objEzsigndocument' => false,
		'objEzsigndocumentCompound' => false
    ];
    ...
    {
        $this->setIfExists('objEzsigndocument', $data ?? [], null);
        $this->setIfExists('objEzsigndocumentCompound', $data ?? [], null);
    }
