...
/**
 * SignatureRequestCompound Class Doc Comment
 *
 * @category Class
...
class SignatureRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'signature-RequestCompound';
...
//        if ((!preg_match("/^.{0,65535}$/", ObjectSerializer::toString($tSignatureSvg)))) {
        if (!is_null($tSignatureSvg) && (!preg_match("/(*UTF8)^.{0,65535}$/", ObjectSerializer::toString($tSignatureSvg)))) {
            throw new \InvalidArgumentException("invalid value for \$tSignatureSvg when calling SignatureRequestCompound., must conform to the pattern /^.{0,65535}$/.");
        }
