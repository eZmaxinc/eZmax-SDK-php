...
/**
 * UsergroupexternalListElement Class Doc Comment
 *
 * @category Class
 * @description A Usergroupexternal List Element
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UsergroupexternalListElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'usergroupexternal-ListElement';
    ...
    */
	...
	//if (($pkiUsergroupexternalID > 255)) {
        if (($pkiUsergroupexternalID > 255)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiUsergroupexternalID when calling UsergroupexternalListElement., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupexternalID)?'null':'"'.$pkiUsergroupexternalID.'"').' for pkiUsergroupexternalID when calling UsergroupexternalListElement., must be smaller than or equal to 255.');
        }
	//if (($pkiUsergroupexternalID < 0)) {
        if (($pkiUsergroupexternalID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiUsergroupexternalID when calling UsergroupexternalListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupexternalID)?'null':'"'.$pkiUsergroupexternalID.'"').' for pkiUsergroupexternalID when calling UsergroupexternalListElement., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{0,64}$/", ObjectSerializer::toString($sUsergroupexternalName)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sUsergroupexternalName when calling UsergroupexternalListElement., must conform to the pattern /^.{0,64}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupexternalName)?'null':'"'.$sUsergroupexternalName.'"')." for sUsergroupexternalName when calling UsergroupexternalListElement., must conform to the pattern /^.{0,64}$/.");
        }
	...
	//if ((!preg_match("/^.{0,64}$/", ObjectSerializer::toString($sUsergroupexternalID)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sUsergroupexternalID when calling UsergroupexternalListElement., must conform to the pattern /^.{0,64}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupexternalID)?'null':'"'.$sUsergroupexternalID.'"')." for sUsergroupexternalID when calling UsergroupexternalListElement., must conform to the pattern /^.{0,64}$/.");
        }
