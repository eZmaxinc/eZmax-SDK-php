...
/**
 * CommonResponseErrorTooManyRequests Class Doc Comment
 *
 * @category Class
 ...
 */
class CommonResponseErrorTooManyRequests implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Common-Response-Error-TooManyRequests';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sErrorMessage) && (!preg_match("/(*UTF8)^.{0,500}$/", ObjectSerializer::toString($sErrorMessage)))) {
            //throw new \InvalidArgumentException("invalid value for \$sErrorMessage when calling CommonResponseErrorTooManyRequests., must conform to the pattern /^.{0,500}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sErrorMessage)?'null':'"'.$sErrorMessage.'"')." for sErrorMessage when calling CommonResponseErrorTooManyRequests., must conform to the pattern /^.{0,500}$/.");
        }
