...
/**
 * NotaryGetListV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /1/object/notary/getList
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NotaryGetListV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'notary-getList-v1-Response-mPayload';
    ...
    protected static $openAPITypes = [
        'iRowReturned' => 'int',
        'iRowFiltered' => 'int',
        'aObjNotary' => '\eZmaxAPI\Model\NotaryListElement[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aObjNotary', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aObjNotary'] === null) {
            $invalidProperties[] = "'aObjNotary' can't be null";
        }
     ...
     * Gets aObjNotary
     *
     * @return \eZmaxAPI\Model\NotaryListElement[]
     */
    public function getAObjNotary()
    {
	//return $this->container['aObjNotary'];
        return $this->container['aObjNotary'];
    }
     ...
     * Sets aObjNotary
     *
     * @param \eZmaxAPI\Model\NotaryListElement[] $aObjNotary aObjNotary
     *
     * @return self
     */
    public function setAObjNotary($aObjNotary)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjNotary)) {
            //throw new \InvalidArgumentException('non-nullable aObjNotary cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjNotary'] = $aObjNotary;
        $this->container['aObjNotary'] = $aObjNotary;
