...
class CustomEzmaxpricingResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['dEzmaxpricingRebateezsignallagents']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxpricingRebateezsignallagents'])) {
            //$invalidProperties[] = "invalid value for 'dEzmaxpricingRebateezsignallagents', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxpricingRebateezsignallagents'])?'null':'"'.$this->container['dEzmaxpricingRebateezsignallagents'].'"')." for 'dEzmaxpricingRebateezsignallagents', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzmaxpricingID < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzmaxpricingID)?'null':'"'.$pkiEzmaxpricingID.'"').' for pkiEzmaxpricingID when calling CustomEzmaxpricingResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxpricingRebateezsignallagents) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxpricingRebateezsignallagents)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxpricingRebateezsignallagents)?'null':'"'.$dEzmaxpricingRebateezsignallagents.'"')." for dEzmaxpricingRebateezsignallagents when calling CustomEzmaxpricingResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
