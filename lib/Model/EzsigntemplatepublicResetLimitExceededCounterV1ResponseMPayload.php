...
/**
 * EzsigntemplatepublicResetLimitExceededCounterV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for POST /1/object/ezsigntemplatepublic/{pkiEzsigntemplatepublicID}/resetLimitExceededCounter
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsigntemplatepublicResetLimitExceededCounterV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigntemplatepublic-resetLimitExceededCounter-v1-Response-mPayload';
    ...
    */
	...
	//if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtEzsigntemplatepublicLimitexceededsince)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dtEzsigntemplatepublicLimitexceededsince when calling EzsigntemplatepublicResetLimitExceededCounterV1ResponseMPayload., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtEzsigntemplatepublicLimitexceededsince)?'null':'"'.$dtEzsigntemplatepublicLimitexceededsince.'"')." for dtEzsigntemplatepublicLimitexceededsince when calling EzsigntemplatepublicResetLimitExceededCounterV1ResponseMPayload., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
