...
/**
 * SupplyResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class SupplyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'supply-Response';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiSupplyID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $pkiSupplyID when calling SupplyResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSupplyID)?'null':'"'.$pkiSupplyID.'"').' for pkiSupplyID when calling SupplyResponse., must be smaller than or equal to 65535.');
        }
        //if (($pkiSupplyID < 0)) {
        if (($pkiSupplyID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiSupplyID when calling SupplyResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSupplyID)?'null':'"'.$pkiSupplyID.'"').' for pkiSupplyID when calling SupplyResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiGlaccountID) && ($fkiGlaccountID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiGlaccountID when calling SupplyResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiGlaccountID)?'null':'"'.$fkiGlaccountID.'"').' for fkiGlaccountID when calling SupplyResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiGlaccountcontainerID) && ($fkiGlaccountcontainerID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiGlaccountcontainerID when calling SupplyResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiGlaccountcontainerID)?'null':'"'.$fkiGlaccountcontainerID.'"').' for fkiGlaccountcontainerID when calling SupplyResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiVariableexpenseID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiVariableexpenseID when calling SupplyResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiVariableexpenseID)?'null':'"'.$fkiVariableexpenseID.'"').' for fkiVariableexpenseID when calling SupplyResponse., must be smaller than or equal to 255.');
        }
        //if (($fkiVariableexpenseID < 1)) {
        if (($fkiVariableexpenseID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiVariableexpenseID when calling SupplyResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiVariableexpenseID)?'null':'"'.$fkiVariableexpenseID.'"').' for fkiVariableexpenseID when calling SupplyResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sSupplyCode) && (!preg_match("/(*UTF8)^.{0,5}$/", ObjectSerializer::toString($sSupplyCode)))) {
            //throw new \InvalidArgumentException("invalid value for \$sSupplyCode when calling SupplyResponse., must conform to the pattern /^.{0,5}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sSupplyCode)?'null':'"'.$sSupplyCode.'"')." for sSupplyCode when calling SupplyResponse., must conform to the pattern /^.{0,5}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if ((mb_strlen($dSupplyUnitprice) > 13)) {
            //throw new \InvalidArgumentException('invalid length for $dSupplyUnitprice when calling SupplyResponse., must be smaller than or equal to 13.');
            throw new \InvalidArgumentException('value '.(is_null($dSupplyUnitprice)?'null':'"'.$dSupplyUnitprice.'"').', invalid length for dSupplyUnitprice when calling SupplyResponse., must be smaller than or equal to 13.');
        }
        //if ((mb_strlen($dSupplyUnitprice) < 4)) {
        if ((mb_strlen($dSupplyUnitprice) < 4)) {
            //throw new \InvalidArgumentException('invalid length for $dSupplyUnitprice when calling SupplyResponse., must be bigger than or equal to 4.');
            throw new \InvalidArgumentException('value '.(is_null($dSupplyUnitprice)?'null':'"'.$dSupplyUnitprice.'"').', invalid length for dSupplyUnitprice when calling SupplyResponse., must be bigger than or equal to 4.');
        }
        ...
        if (!is_null($dSupplyUnitprice) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dSupplyUnitprice)))) {
            //throw new \InvalidArgumentException("invalid value for \$dSupplyUnitprice when calling SupplyResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dSupplyUnitprice)?'null':'"'.$dSupplyUnitprice.'"')." for dSupplyUnitprice when calling SupplyResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sVariableexpenseDescriptionX) && (!preg_match("/(*UTF8)^.{0,40}$/", ObjectSerializer::toString($sVariableexpenseDescriptionX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sVariableexpenseDescriptionX when calling SupplyResponse., must conform to the pattern /^.{0,40}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sVariableexpenseDescriptionX)?'null':'"'.$sVariableexpenseDescriptionX.'"')." for sVariableexpenseDescriptionX when calling SupplyResponse., must conform to the pattern /^.{0,40}$/.");
        }
