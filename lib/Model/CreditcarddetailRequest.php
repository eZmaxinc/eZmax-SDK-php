...
/**
 * CreditcarddetailRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreditcarddetailRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'creditcarddetail-Request';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iCreditcarddetailExpirationmonth > 12)) {
            //throw new \InvalidArgumentException('invalid value for $iCreditcarddetailExpirationmonth when calling CreditcarddetailRequest., must be smaller than or equal to 12.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCreditcarddetailExpirationmonth)?'null':'"'.$iCreditcarddetailExpirationmonth.'"').' for iCreditcarddetailExpirationmonth when calling CreditcarddetailRequest., must be smaller than or equal to 12.');
        }
        //if (($iCreditcarddetailExpirationmonth < 0)) {
        if (($iCreditcarddetailExpirationmonth < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iCreditcarddetailExpirationmonth when calling CreditcarddetailRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCreditcarddetailExpirationmonth)?'null':'"'.$iCreditcarddetailExpirationmonth.'"').' for iCreditcarddetailExpirationmonth when calling CreditcarddetailRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iCreditcarddetailExpirationyear > 2200)) {
            //throw new \InvalidArgumentException('invalid value for $iCreditcarddetailExpirationyear when calling CreditcarddetailRequest., must be smaller than or equal to 2200.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCreditcarddetailExpirationyear)?'null':'"'.$iCreditcarddetailExpirationyear.'"').' for iCreditcarddetailExpirationyear when calling CreditcarddetailRequest., must be smaller than or equal to 2200.');
        }
        //if (($iCreditcarddetailExpirationyear < 0)) {
        if (($iCreditcarddetailExpirationyear < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iCreditcarddetailExpirationyear when calling CreditcarddetailRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCreditcarddetailExpirationyear)?'null':'"'.$iCreditcarddetailExpirationyear.'"').' for iCreditcarddetailExpirationyear when calling CreditcarddetailRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCreditcarddetailCivic) && (!preg_match("/(*UTF8)^[\\d]{1,8}$/", ObjectSerializer::toString($sCreditcarddetailCivic)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCreditcarddetailCivic when calling CreditcarddetailRequest., must conform to the pattern /^[\\d]{1,8}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCreditcarddetailCivic)?'null':'"'.$sCreditcarddetailCivic.'"')." for sCreditcarddetailCivic when calling CreditcarddetailRequest., must conform to the pattern /^[\\d]{1,8}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCreditcarddetailStreet) && (!preg_match("/(*UTF8)^.{1,19}$/", ObjectSerializer::toString($sCreditcarddetailStreet)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCreditcarddetailStreet when calling CreditcarddetailRequest., must conform to the pattern /^.{1,19}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCreditcarddetailStreet)?'null':'"'.$sCreditcarddetailStreet.'"')." for sCreditcarddetailStreet when calling CreditcarddetailRequest., must conform to the pattern /^.{1,19}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCreditcarddetailZip) && (!preg_match("/(*UTF8)^.{0,9}$/", ObjectSerializer::toString($sCreditcarddetailZip)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCreditcarddetailZip when calling CreditcarddetailRequest., must conform to the pattern /^.{0,9}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCreditcarddetailZip)?'null':'"'.$sCreditcarddetailZip.'"')." for sCreditcarddetailZip when calling CreditcarddetailRequest., must conform to the pattern /^.{0,9}$/.");
        }
