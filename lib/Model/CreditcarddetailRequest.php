...
//        if (!is_null($this->container['sCreditcarddetailCivic']) && !preg_match("/^.{0,8}$/", $this->container['sCreditcarddetailCivic'])) {
...
//        if (!is_null($this->container['sCreditcarddetailStreet']) && !preg_match("/^.{0,40}$/", $this->container['sCreditcarddetailStreet'])) {
...
//        if (!is_null($this->container['sCreditcarddetailZip']) && !preg_match("/^.{0,10}$/", $this->container['sCreditcarddetailZip'])) {
...
//        if (($iCreditcarddetailExpirationyear < 0)) {
     ...
     *
     * @param string|null $sCreditcarddetailCivic The civic of the Creditcarddetail
     *
     * @return self
     */
...
//        if ((!preg_match("/^.{0,8}$/", ObjectSerializer::toString($sCreditcarddetailCivic)))) {
        if (!is_null($sCreditcarddetailCivic) && (!preg_match("/(*UTF8)^.{0,8}$/", ObjectSerializer::toString($sCreditcarddetailCivic)))) {
            throw new \InvalidArgumentException("invalid value for \$sCreditcarddetailCivic when calling CreditcarddetailRequest., must conform to the pattern /^.{0,8}$/.");
        }
     ...
     *
     * @param string|null $sCreditcarddetailStreet The street of the Creditcarddetail
     *
     * @return self
     */
...
//        if ((!preg_match("/^.{0,40}$/", ObjectSerializer::toString($sCreditcarddetailStreet)))) {
        if (!is_null($sCreditcarddetailStreet) && (!preg_match("/(*UTF8)^.{0,40}$/", ObjectSerializer::toString($sCreditcarddetailStreet)))) {
            throw new \InvalidArgumentException("invalid value for \$sCreditcarddetailStreet when calling CreditcarddetailRequest., must conform to the pattern /^.{0,40}$/.");
        }
     ...
     *
     * @param string|null $sCreditcarddetailZip The zip of the Creditcarddetail
     *
     * @return self
     */
...
//        if ((!preg_match("/^.{0,10}$/", ObjectSerializer::toString($sCreditcarddetailZip)))) {
        if (!is_null($sCreditcarddetailZip) && (!preg_match("/(*UTF8)^.{0,10}$/", ObjectSerializer::toString($sCreditcarddetailZip)))) {
            throw new \InvalidArgumentException("invalid value for \$sCreditcarddetailZip when calling CreditcarddetailRequest., must conform to the pattern /^.{0,10}$/.");
        }
