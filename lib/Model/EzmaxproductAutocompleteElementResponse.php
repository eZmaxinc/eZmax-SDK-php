...
/**
 * EzmaxproductAutocompleteElementResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class EzmaxproductAutocompleteElementResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezmaxproduct-AutocompleteElement-Response';
    ...
    protected static $openAPITypes = [
        'pkiEzmaxproductID' => 'int',
        'sEzmaxproductDescriptionX' => 'string',
        'bEzmaxproductIsactive' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'pkiEzmaxproductID' => null,
        'sEzmaxproductDescriptionX' => null,
        'bEzmaxproductIsactive' => null
    ];
    ...
    protected static array $openAPINullables = [
        'pkiEzmaxproductID' => false,
		'sEzmaxproductDescriptionX' => false,
		'bEzmaxproductIsactive' => false
    ];
    ...
    protected static $setters = [
        'pkiEzmaxproductID' => 'setPkiEzmaxproductID',
        'sEzmaxproductDescriptionX' => 'setSEzmaxproductDescriptionX',
        'bEzmaxproductIsactive' => 'setBEzmaxproductIsactive'
    ];
    ...
    protected static $getters = [
        'pkiEzmaxproductID' => 'getPkiEzmaxproductID',
        'sEzmaxproductDescriptionX' => 'getSEzmaxproductDescriptionX',
        'bEzmaxproductIsactive' => 'getBEzmaxproductIsactive'
    ];
    ...
    {
        $this->setIfExists('pkiEzmaxproductID', $data ?? [], null);
        $this->setIfExists('sEzmaxproductDescriptionX', $data ?? [], null);
        $this->setIfExists('bEzmaxproductIsactive', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pkiEzmaxproductID'] === null) {
            $invalidProperties[] = "'pkiEzmaxproductID' can't be null";
        }
        if (($this->container['pkiEzmaxproductID'] < 1)) {
            $invalidProperties[] = "invalid value for 'pkiEzmaxproductID', must be bigger than or equal to 1.";
        }

        if ($this->container['sEzmaxproductDescriptionX'] === null) {
            $invalidProperties[] = "'sEzmaxproductDescriptionX' can't be null";
        }
        if ($this->container['bEzmaxproductIsactive'] === null) {
            $invalidProperties[] = "'bEzmaxproductIsactive' can't be null";
        }
    ...
    /**
     * Gets pkiEzmaxproductID
     *
     * @return int
     */
    public function getPkiEzmaxproductID()
    {
	//return $this->container['pkiEzmaxproductID'];
        return $this->container['pkiEzmaxproductID'];
    }

    /**
     * Sets pkiEzmaxproductID
     *
     * @param int $pkiEzmaxproductID The unique ID of the Ezmaxproduct
     *
     * @return self
     */
	...
	//if (($pkiEzmaxproductID < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzmaxproductID when calling EzmaxproductAutocompleteElementResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzmaxproductID)?'null':'"'.$pkiEzmaxproductID.'"').' for pkiEzmaxproductID when calling EzmaxproductAutocompleteElementResponse., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets bEzmaxproductIsactive
     *
     * @return bool
     */
    public function getBEzmaxproductIsactive()
    {
	//return $this->container['bEzmaxproductIsactive'];
        return $this->container['bEzmaxproductIsactive'];
    }

    /**
     * Sets bEzmaxproductIsactive
     *
     * @param bool $bEzmaxproductIsactive Whether the Ezmaxproduct is active or not
     *
     * @return self
     */
