...
/**
 * EzsignsignatureCreateObjectV3Request Class Doc Comment
 *
 * @category Class
 * @description Request for POST /3/object/ezsignsignature
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsignsignatureCreateObjectV3Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignsignature-createObject-v3-Request';
    ...
    protected static $openAPITypes = [
        'aObjEzsignsignature' => '\eZmaxAPI\Model\EzsignsignatureRequestCompoundV2[]'
    ];
    ...
    */
     ...
     *
     * @return \eZmaxAPI\Model\EzsignsignatureRequestCompoundV2[]
     */
     ...
     *
     * @param \eZmaxAPI\Model\EzsignsignatureRequestCompoundV2[] $aObjEzsignsignature aObjEzsignsignature
     *
     * @return self
     */
	...
	//if ((count($aObjEzsignsignature) < 1)) {
        if ((count($aObjEzsignsignature) < 1)) {
            //throw new \InvalidArgumentException('invalid length for $aObjEzsignsignature when calling EzsignsignatureCreateObjectV3Request., number of items must be greater than or equal to 1.');
	    throw new \InvalidArgumentException('invalid length for aObjEzsignsignature when calling EzsignsignatureCreateObjectV3Request., number of items must be greater than or equal to 1.');
        }
