...
/**
 * ColleagueRequestV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class ColleagueRequestV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'colleague-RequestV2';
    ...
    */
	...
	//if (($pkiColleagueID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiColleagueID when calling ColleagueRequestV2., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiColleagueID)?'null':'"'.$pkiColleagueID.'"').' for pkiColleagueID when calling ColleagueRequestV2., must be smaller than or equal to 65535.');
        }
	//if (($pkiColleagueID < 0)) {
        if (!is_null($pkiColleagueID) && ($pkiColleagueID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiColleagueID when calling ColleagueRequestV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiColleagueID)?'null':'"'.$pkiColleagueID.'"').' for pkiColleagueID when calling ColleagueRequestV2., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserID < 0)) {
        if (($fkiUserID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling ColleagueRequestV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling ColleagueRequestV2., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserIDColleague < 0)) {
        if (($fkiUserIDColleague < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiUserIDColleague when calling ColleagueRequestV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserIDColleague)?'null':'"'.$fkiUserIDColleague.'"').' for fkiUserIDColleague when calling ColleagueRequestV2., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", ObjectSerializer::toString($dtColleagueFrom)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dtColleagueFrom when calling ColleagueRequestV2., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtColleagueFrom)?'null':'"'.$dtColleagueFrom.'"')." for dtColleagueFrom when calling ColleagueRequestV2., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
        }
	...
	//if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", ObjectSerializer::toString($dtColleagueTo)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dtColleagueTo when calling ColleagueRequestV2., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtColleagueTo)?'null':'"'.$dtColleagueTo.'"')." for dtColleagueTo when calling ColleagueRequestV2., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
        }
