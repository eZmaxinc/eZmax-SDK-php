...
/**
 * EzsignfolderRequestV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignfolderRequestV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsignfolder-RequestV3';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzsignfolderID) && ($pkiEzsignfolderID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsignfolderID when calling EzsignfolderRequestV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignfolderID)?'null':'"'.$pkiEzsignfolderID.'"').' for pkiEzsignfolderID when calling EzsignfolderRequestV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsignfoldertypeID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsignfolderRequestV3., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsignfolderRequestV3., must be smaller than or equal to 65535.');
        }
        //if (($fkiEzsignfoldertypeID < 0)) {
        if (($fkiEzsignfoldertypeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsignfolderRequestV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsignfolderRequestV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiTimezoneID) && ($fkiTimezoneID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiTimezoneID when calling EzsignfolderRequestV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiTimezoneID)?'null':'"'.$fkiTimezoneID.'"').' for fkiTimezoneID when calling EzsignfolderRequestV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntsarequirementID) && ($fkiEzsigntsarequirementID > 3)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntsarequirementID when calling EzsignfolderRequestV3., must be smaller than or equal to 3.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntsarequirementID)?'null':'"'.$fkiEzsigntsarequirementID.'"').' for fkiEzsigntsarequirementID when calling EzsignfolderRequestV3., must be smaller than or equal to 3.');
        }
        //if (($fkiEzsigntsarequirementID < 1)) {
        if (!is_null($fkiEzsigntsarequirementID) && ($fkiEzsigntsarequirementID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntsarequirementID when calling EzsignfolderRequestV3., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntsarequirementID)?'null':'"'.$fkiEzsigntsarequirementID.'"').' for fkiEzsigntsarequirementID when calling EzsignfolderRequestV3., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignfolderDescription) && (!preg_match("/(*UTF8)^.{0,75}$/", ObjectSerializer::toString($sEzsignfolderDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsignfolderDescription when calling EzsignfolderRequestV3., must conform to the pattern /^.{0,75}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignfolderDescription)?'null':'"'.$sEzsignfolderDescription.'"')." for sEzsignfolderDescription when calling EzsignfolderRequestV3., must conform to the pattern /^.{0,75}$/.");
        }
     ...
     *
     * @param int $iEzsignfolderSendreminderfirstdays The number of days before the first reminder sending
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsignfolderSendreminderfirstdays > 255)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignfolderSendreminderfirstdays when calling EzsignfolderRequestV3., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfolderSendreminderfirstdays)?'null':'"'.$iEzsignfolderSendreminderfirstdays.'"').' for iEzsignfolderSendreminderfirstdays when calling EzsignfolderRequestV3., must be smaller than or equal to 255.');
        }
        //if (($iEzsignfolderSendreminderfirstdays < 0)) {
        if (($iEzsignfolderSendreminderfirstdays < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignfolderSendreminderfirstdays when calling EzsignfolderRequestV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfolderSendreminderfirstdays)?'null':'"'.$iEzsignfolderSendreminderfirstdays.'"').' for iEzsignfolderSendreminderfirstdays when calling EzsignfolderRequestV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsignfolderSendreminderotherdays > 255)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignfolderSendreminderotherdays when calling EzsignfolderRequestV3., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfolderSendreminderotherdays)?'null':'"'.$iEzsignfolderSendreminderotherdays.'"').' for iEzsignfolderSendreminderotherdays when calling EzsignfolderRequestV3., must be smaller than or equal to 255.');
        }
        //if (($iEzsignfolderSendreminderotherdays < 0)) {
        if (($iEzsignfolderSendreminderotherdays < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignfolderSendreminderotherdays when calling EzsignfolderRequestV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfolderSendreminderotherdays)?'null':'"'.$iEzsignfolderSendreminderotherdays.'"').' for iEzsignfolderSendreminderotherdays when calling EzsignfolderRequestV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignfolderExternalid) && (!preg_match("/(*UTF8)^.{0,128}$/", ObjectSerializer::toString($sEzsignfolderExternalid)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsignfolderExternalid when calling EzsignfolderRequestV3., must conform to the pattern /^.{0,128}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignfolderExternalid)?'null':'"'.$sEzsignfolderExternalid.'"')." for sEzsignfolderExternalid when calling EzsignfolderRequestV3., must conform to the pattern /^.{0,128}$/.");
        }
