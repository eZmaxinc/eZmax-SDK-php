...
//        if (($iBrandingInterfacecolor > 16777215)) {
        if (!is_null($iBrandingInterfacecolor) && ($iBrandingInterfacecolor > 16777215)) {
            throw new \InvalidArgumentException('invalid value for $iBrandingInterfacecolor when calling BrandingResponseCompound., must be smaller than or equal to 16777215.');
        }
//        if (($iBrandingInterfacecolor < 0)) {
        if (!is_null($iBrandingInterfacecolor) && ($iBrandingInterfacecolor < 0)) {
            throw new \InvalidArgumentException('invalid value for $iBrandingInterfacecolor when calling BrandingResponseCompound., must be bigger than or equal to 0.');
        }
