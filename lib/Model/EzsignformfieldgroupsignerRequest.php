...
class EzsignformfieldgroupsignerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//if (($pkiEzsignformfieldgroupsignerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignformfieldgroupsignerID when calling EzsignformfieldgroupsignerRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignformfieldgroupsignerID)?'null':'"'.$pkiEzsignformfieldgroupsignerID.'"').' for pkiEzsignformfieldgroupsignerID when calling EzsignformfieldgroupsignerRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignfoldersignerassociationID < 0)) {
        if (($fkiEzsignfoldersignerassociationID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldersignerassociationID when calling EzsignformfieldgroupsignerRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationID)?'null':'"'.$fkiEzsignfoldersignerassociationID.'"').' for fkiEzsignfoldersignerassociationID when calling EzsignformfieldgroupsignerRequest., must be bigger than or equal to 0.');
        }
