...
/**
 * UsergroupmembershipResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class UsergroupmembershipResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'usergroupmembership-Response';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiUsergroupmembershipID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $pkiUsergroupmembershipID when calling UsergroupmembershipResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupmembershipID)?'null':'"'.$pkiUsergroupmembershipID.'"').' for pkiUsergroupmembershipID when calling UsergroupmembershipResponse., must be smaller than or equal to 65535.');
        }
        //if (($pkiUsergroupmembershipID < 0)) {
        if (($pkiUsergroupmembershipID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiUsergroupmembershipID when calling UsergroupmembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupmembershipID)?'null':'"'.$pkiUsergroupmembershipID.'"').' for pkiUsergroupmembershipID when calling UsergroupmembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiUsergroupID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling UsergroupmembershipResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling UsergroupmembershipResponse., must be smaller than or equal to 255.');
        }
        //if (($fkiUsergroupID < 0)) {
        if (($fkiUsergroupID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling UsergroupmembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling UsergroupmembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUserID) && ($fkiUserID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling UsergroupmembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling UsergroupmembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUsergroupexternalID) && ($fkiUsergroupexternalID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupexternalID when calling UsergroupmembershipResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupexternalID)?'null':'"'.$fkiUsergroupexternalID.'"').' for fkiUsergroupexternalID when calling UsergroupmembershipResponse., must be smaller than or equal to 255.');
        }
        //if (($fkiUsergroupexternalID < 0)) {
        if (!is_null($fkiUsergroupexternalID) && ($fkiUsergroupexternalID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupexternalID when calling UsergroupmembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupexternalID)?'null':'"'.$fkiUsergroupexternalID.'"').' for fkiUsergroupexternalID when calling UsergroupmembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUserLoginname) && (!preg_match("/(*UTF8)^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/", ObjectSerializer::toString($sUserLoginname)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUserLoginname when calling UsergroupmembershipResponse., must conform to the pattern /^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUserLoginname)?'null':'"'.$sUserLoginname.'"')." for sUserLoginname when calling UsergroupmembershipResponse., must conform to the pattern /^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEmailAddress) && (!preg_match("/(*UTF8)^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddress)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEmailAddress when calling UsergroupmembershipResponse., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEmailAddress)?'null':'"'.$sEmailAddress.'"')." for sEmailAddress when calling UsergroupmembershipResponse., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUsergroupNameX) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sUsergroupNameX)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupNameX)?'null':'"'.$sUsergroupNameX.'"')." for sUsergroupNameX when calling UsergroupmembershipResponse., must conform to the pattern /^.{0,50}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUsergroupexternalName) && (!preg_match("/(*UTF8)^.{0,64}$/", ObjectSerializer::toString($sUsergroupexternalName)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUsergroupexternalName when calling UsergroupmembershipResponse., must conform to the pattern /^.{0,64}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupexternalName)?'null':'"'.$sUsergroupexternalName.'"')." for sUsergroupexternalName when calling UsergroupmembershipResponse., must conform to the pattern /^.{0,64}$/.");
        }
