...
/**
 * CustomEzsigndocumentGetEzsignformfieldgroupsResponse Class Doc Comment
 *
 * @category Class
 * @description An Ezsigndocument Object in the context of a getEzsignformfieldgroups path
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomEzsigndocumentGetEzsignformfieldgroupsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Custom-EzsigndocumentGetEzsignformfieldgroups-Response';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigndocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigndocumentID when calling CustomEzsigndocumentGetEzsignformfieldgroupsResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndocumentID)?'null':'"'.$pkiEzsigndocumentID.'"').' for pkiEzsigndocumentID when calling CustomEzsigndocumentGetEzsignformfieldgroupsResponse., must be bigger than or equal to 0.');
        }
