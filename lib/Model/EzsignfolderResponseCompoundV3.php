...
/**
 * EzsignfolderResponseCompoundV3 Class Doc Comment
 *
 * @category Class
...
class EzsignfolderResponseCompoundV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignfolder-ResponseCompoundV3';
    ...
    */
	...
	//if (($iEzsignfolderStepcurrent > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignfolderStepcurrent when calling EzsignfolderResponseCompoundV3., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfolderStepcurrent)?'null':'"'.$iEzsignfolderStepcurrent.'"').' for iEzsignfolderStepcurrent when calling EzsignfolderResponseCompoundV3., must be smaller than or equal to 255.');
        }
	//if (($iEzsignfolderStepcurrent < 0)) {
        if (!is_null($iEzsignfolderStepcurrent) && ($iEzsignfolderStepcurrent < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignfolderStepcurrent when calling EzsignfolderResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignfolderStepcurrent)?'null':'"'.$iEzsignfolderStepcurrent.'"').' for iEzsignfolderStepcurrent when calling EzsignfolderResponseCompoundV3., must be bigger than or equal to 0.');
        }
