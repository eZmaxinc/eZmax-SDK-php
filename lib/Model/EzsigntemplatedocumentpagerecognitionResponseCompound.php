...
/**
 * EzsigntemplatedocumentpagerecognitionResponseCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplatedocumentpagerecognitionResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplatedocumentpagerecognition-ResponseCompound';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigntemplatedocumentpagerecognitionID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatedocumentpagerecognitionID when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatedocumentpagerecognitionID)?'null':'"'.$pkiEzsigntemplatedocumentpagerecognitionID.'"').' for pkiEzsigntemplatedocumentpagerecognitionID when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($pkiEzsigntemplatedocumentpagerecognitionID < 0)) {
        if (($pkiEzsigntemplatedocumentpagerecognitionID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatedocumentpagerecognitionID when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatedocumentpagerecognitionID)?'null':'"'.$pkiEzsigntemplatedocumentpagerecognitionID.'"').' for pkiEzsigntemplatedocumentpagerecognitionID when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigntemplatedocumentpageID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatedocumentpageID when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatedocumentpageID)?'null':'"'.$fkiEzsigntemplatedocumentpageID.'"').' for fkiEzsigntemplatedocumentpageID when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionSimilarpercentage) && ($iEzsigntemplatedocumentpagerecognitionSimilarpercentage > 100)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionSimilarpercentage when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be smaller than or equal to 100.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionSimilarpercentage)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionSimilarpercentage.'"').' for iEzsigntemplatedocumentpagerecognitionSimilarpercentage when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be smaller than or equal to 100.');
        }
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionSimilarpercentage) && ($iEzsigntemplatedocumentpagerecognitionSimilarpercentage < 60)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionSimilarpercentage when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be bigger than or equal to 60.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionSimilarpercentage)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionSimilarpercentage.'"').' for iEzsigntemplatedocumentpagerecognitionSimilarpercentage when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be bigger than or equal to 60.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionX) && ($iEzsigntemplatedocumentpagerecognitionX > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionX when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionX)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionX.'"').' for iEzsigntemplatedocumentpagerecognitionX when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be smaller than or equal to 65535.');
        }
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionX) && ($iEzsigntemplatedocumentpagerecognitionX < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionX when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionX)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionX.'"').' for iEzsigntemplatedocumentpagerecognitionX when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionY) && ($iEzsigntemplatedocumentpagerecognitionY > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionY when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionY)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionY.'"').' for iEzsigntemplatedocumentpagerecognitionY when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be smaller than or equal to 65535.');
        }
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionY) && ($iEzsigntemplatedocumentpagerecognitionY < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionY when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionY)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionY.'"').' for iEzsigntemplatedocumentpagerecognitionY when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionWidth) && ($iEzsigntemplatedocumentpagerecognitionWidth > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionWidth when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionWidth)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionWidth.'"').' for iEzsigntemplatedocumentpagerecognitionWidth when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be smaller than or equal to 65535.');
        }
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionWidth) && ($iEzsigntemplatedocumentpagerecognitionWidth < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionWidth when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionWidth)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionWidth.'"').' for iEzsigntemplatedocumentpagerecognitionWidth when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionHeight) && ($iEzsigntemplatedocumentpagerecognitionHeight > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionHeight when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionHeight)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionHeight.'"').' for iEzsigntemplatedocumentpagerecognitionHeight when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be smaller than or equal to 65535.');
        }
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionHeight) && ($iEzsigntemplatedocumentpagerecognitionHeight < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionHeight when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionHeight)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionHeight.'"').' for iEzsigntemplatedocumentpagerecognitionHeight when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($tEzsigntemplatedocumentpagerecognitionText) && (!preg_match("/(*UTF8)^[.\\D\\d]{0,65535}$/", ObjectSerializer::toString($tEzsigntemplatedocumentpagerecognitionText)))) {
            //throw new \InvalidArgumentException("invalid value for \$tEzsigntemplatedocumentpagerecognitionText when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must conform to the pattern /^[.\\D\\d]{0,65535}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($tEzsigntemplatedocumentpagerecognitionText)?'null':'"'.$tEzsigntemplatedocumentpagerecognitionText.'"')." for tEzsigntemplatedocumentpagerecognitionText when calling EzsigntemplatedocumentpagerecognitionResponseCompound., must conform to the pattern /^[.\\D\\d]{0,65535}$/.");
        }
