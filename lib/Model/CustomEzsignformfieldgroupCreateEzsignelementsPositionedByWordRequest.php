...
/**
 * CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest Class Doc Comment
 *
 * @category Class
 * @description An Ezsignformfieldgroup Object in the context of a createEzsignelementsPositionedByWord path
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Custom-EzsignformfieldgroupCreateEzsignelementsPositionedByWord-Request';
    ...
    */
	...
	//if (!is_null($this->container['sEzsignformfieldgroupRegexp']) && !preg_match("/^\\^.*\\$$|^$/", $this->container['sEzsignformfieldgroupRegexp'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sEzsignformfieldgroupRegexp', must be conform to the pattern /^\\^.*\\$$|^$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsignformfieldgroupRegexp'])?'null':'"'.$this->container['sEzsignformfieldgroupRegexp'].'"')." for 'sEzsignformfieldgroupRegexp', must be conform to the pattern /^\\^.*\\$$|^$/.";
        }
	...
	//if (($pkiEzsignformfieldgroupID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignformfieldgroupID when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignformfieldgroupID)?'null':'"'.$pkiEzsignformfieldgroupID.'"').' for pkiEzsignformfieldgroupID when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigndocumentID < 0)) {
        if (($fkiEzsigndocumentID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigndocumentID when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigndocumentID)?'null':'"'.$fkiEzsigndocumentID.'"').' for fkiEzsigndocumentID when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if ((mb_strlen($sEzsignformfieldgroupLabel) > 50)) {
        if ((mb_strlen($sEzsignformfieldgroupLabel) > 50)) {
	    //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupLabel when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupLabel)?'null':'"'.$sEzsignformfieldgroupLabel.'"').', invalid length for sEzsignformfieldgroupLabel when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be smaller than or equal to 50.');
        }
	//if ((mb_strlen($sEzsignformfieldgroupLabel) < 1)) {
        if ((mb_strlen($sEzsignformfieldgroupLabel) < 1)) {
	    //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupLabel when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupLabel)?'null':'"'.$sEzsignformfieldgroupLabel.'"').', invalid length for sEzsignformfieldgroupLabel when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 1.');
        }
	...
	//if (($iEzsignformfieldgroupStep < 1)) {
        if (($iEzsignformfieldgroupStep < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupStep when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupStep)?'null':'"'.$iEzsignformfieldgroupStep.'"').' for iEzsignformfieldgroupStep when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 1.');
        }
	...
	//if (($iEzsignformfieldgroupFilledmin < 0)) {
        if (($iEzsignformfieldgroupFilledmin < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupFilledmin when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupFilledmin)?'null':'"'.$iEzsignformfieldgroupFilledmin.'"').' for iEzsignformfieldgroupFilledmin when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignformfieldgroupFilledmax < 0)) {
        if (($iEzsignformfieldgroupFilledmax < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupFilledmax when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupFilledmax)?'null':'"'.$iEzsignformfieldgroupFilledmax.'"').' for iEzsignformfieldgroupFilledmax when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignformfieldgroupMaxlength > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupMaxlength when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupMaxlength)?'null':'"'.$iEzsignformfieldgroupMaxlength.'"').' for iEzsignformfieldgroupMaxlength when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be smaller than or equal to 65535.');
        }
	//if (($iEzsignformfieldgroupMaxlength < 0)) {
        if (!is_null($iEzsignformfieldgroupMaxlength) && ($iEzsignformfieldgroupMaxlength < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupMaxlength when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupMaxlength)?'null':'"'.$iEzsignformfieldgroupMaxlength.'"').' for iEzsignformfieldgroupMaxlength when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^\\^.*\\$$|^$/", ObjectSerializer::toString($sEzsignformfieldgroupRegexp)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsignformfieldgroupRegexp when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must conform to the pattern /^\\^.*\\$$|^$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignformfieldgroupRegexp)?'null':'"'.$sEzsignformfieldgroupRegexp.'"')." for sEzsignformfieldgroupRegexp when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must conform to the pattern /^\\^.*\\$$|^$/.");
        }
	...
	//if ((mb_strlen($sEzsignformfieldgroupTextvalidationcustommessage) > 50)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupTextvalidationcustommessage when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupTextvalidationcustommessage)?'null':'"'.$sEzsignformfieldgroupTextvalidationcustommessage.'"').', invalid length for sEzsignformfieldgroupTextvalidationcustommessage when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be smaller than or equal to 50.');
        }
	//if ((mb_strlen($sEzsignformfieldgroupTextvalidationcustommessage) < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupTextvalidationcustommessage when calling CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
