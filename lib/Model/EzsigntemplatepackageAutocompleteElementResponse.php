...
class EzsigntemplatepackageAutocompleteElementResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatepackageDescription) && (!preg_match("/(*UTF8)^.{0,80}$/", ObjectSerializer::toString($sEzsigntemplatepackageDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatepackageDescription when calling EzsigntemplatepackageAutocompleteElementResponse., must conform to the pattern /^.{0,80}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatepackageDescription)?'null':'"'.$sEzsigntemplatepackageDescription.'"')." for sEzsigntemplatepackageDescription when calling EzsigntemplatepackageAutocompleteElementResponse., must conform to the pattern /^.{0,80}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigntemplatepackageID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepackageID)?'null':'"'.$pkiEzsigntemplatepackageID.'"').' for pkiEzsigntemplatepackageID when calling EzsigntemplatepackageAutocompleteElementResponse., must be bigger than or equal to 0.');
        }
