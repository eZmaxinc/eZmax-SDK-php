    ...
    */
	...
	//if (!preg_match("/^[A-Z0-9]{1,4}$/", $this->container['sPaymenttermCode'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sPaymenttermCode', must be conform to the pattern /^[A-Z0-9]{1,4}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sPaymenttermCode'])?'null':'"'.$this->container['sPaymenttermCode'].'"')." for 'sPaymenttermCode', must be conform to the pattern /^[A-Z0-9]{1,4}$/.";
        }
	...
	//if (!preg_match("/^.{1,40}$/", $this->container['sPaymenttermDescriptionX'])) {
        if (!is_null($this->container['sPaymenttermDescriptionX']) && !preg_match("/(*UTF8)^.{1,40}$/", $this->container['sPaymenttermDescriptionX'])) {
        //    $invalidProperties[] = "invalid value for 'sPaymenttermDescriptionX', must be conform to the pattern /^.{1,40}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sPaymenttermDescriptionX'])?'null':'"'.$this->container['sPaymenttermDescriptionX'].'"')." for 'sPaymenttermDescriptionX', must be conform to the pattern /^.{1,40}$/.";
        }
	...
	//if ((!preg_match("/^[A-Z0-9]{1,4}$/", ObjectSerializer::toString($sPaymenttermCode)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sPaymenttermCode when calling PaymenttermListElement., must conform to the pattern /^[A-Z0-9]{1,4}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sPaymenttermCode)?'null':'"'.$sPaymenttermCode.'"')." for sPaymenttermCode when calling PaymenttermListElement., must conform to the pattern /^[A-Z0-9]{1,4}$/.");
        }
	...
	//if (($iPaymenttermDay > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iPaymenttermDay when calling PaymenttermListElement., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iPaymenttermDay)?'null':'"'.$iPaymenttermDay.'"').' for iPaymenttermDay when calling PaymenttermListElement., must be smaller than or equal to 255.');
        }
	//if (($iPaymenttermDay < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iPaymenttermDay when calling PaymenttermListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iPaymenttermDay)?'null':'"'.$iPaymenttermDay.'"').' for iPaymenttermDay when calling PaymenttermListElement., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{1,40}$/", ObjectSerializer::toString($sPaymenttermDescriptionX)))) {
        if (!is_null($sPaymenttermDescriptionX) && (!preg_match("/(*UTF8)^.{1,40}$/", ObjectSerializer::toString($sPaymenttermDescriptionX)))) {
	    //throw new \InvalidArgumentException("invalid value for \$sPaymenttermDescriptionX when calling PaymenttermListElement., must conform to the pattern /^.{1,40}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sPaymenttermDescriptionX)?'null':'"'.$sPaymenttermDescriptionX.'"')." for sPaymenttermDescriptionX when calling PaymenttermListElement., must conform to the pattern /^.{1,40}$/.");
        }
