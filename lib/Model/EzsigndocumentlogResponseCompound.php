    ...
    */
	...
	//if (($fkiUserID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling EzsigndocumentlogResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling EzsigndocumentlogResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignsignerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignsignerID when calling EzsigndocumentlogResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsignerID)?'null':'"'.$fkiEzsignsignerID.'"').' for fkiEzsignsignerID when calling EzsigndocumentlogResponseCompound., must be bigger than or equal to 0.');
        }
