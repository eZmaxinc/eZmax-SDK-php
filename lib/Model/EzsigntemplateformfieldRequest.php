...
/**
 * EzsigntemplateformfieldRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplateformfieldRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplateformfield-Request';
    ...
    protected static $openAPITypes = [
        ...
        'eEzsigntemplateformfieldHorizontalalignment' => '\eZmaxAPI\Model\EnumHorizontalalignment',
    ...
    protected static $openAPIFormats = [
        ...
        'eEzsigntemplateformfieldHorizontalalignment' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'eEzsigntemplateformfieldHorizontalalignment' => false,
    ...
    protected static $attributeMap = [
        ...
        'eEzsigntemplateformfieldHorizontalalignment' => 'eEzsigntemplateformfieldHorizontalalignment',
    ...
    protected static $setters = [
        ...
        'eEzsigntemplateformfieldHorizontalalignment' => 'setEEzsigntemplateformfieldHorizontalalignment',
    ...
    protected static $getters = [
        ...
        'eEzsigntemplateformfieldHorizontalalignment' => 'getEEzsigntemplateformfieldHorizontalalignment',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('eEzsigntemplateformfieldHorizontalalignment', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sEzsigntemplateformfieldPositioningpattern']) && !preg_match("/(*UTF8)^.{0,30}$/", $this->container['sEzsigntemplateformfieldPositioningpattern'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsigntemplateformfieldPositioningpattern'])?'null':'"'.$this->container['sEzsigntemplateformfieldPositioningpattern'].'"')." for 'sEzsigntemplateformfieldPositioningpattern', must be conform to the pattern /^.{0,30}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzsigntemplateformfieldID) && ($pkiEzsigntemplateformfieldID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplateformfieldID when calling EzsigntemplateformfieldRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateformfieldID)?'null':'"'.$pkiEzsigntemplateformfieldID.'"').' for pkiEzsigntemplateformfieldID when calling EzsigntemplateformfieldRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplatedocumentpagePagenumber < 1)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagePagenumber when calling EzsigntemplateformfieldRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagePagenumber)?'null':'"'.$iEzsigntemplatedocumentpagePagenumber.'"').' for iEzsigntemplatedocumentpagePagenumber when calling EzsigntemplateformfieldRequest., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplateformfieldX) && ($iEzsigntemplateformfieldX < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldX when calling EzsigntemplateformfieldRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldX)?'null':'"'.$iEzsigntemplateformfieldX.'"').' for iEzsigntemplateformfieldX when calling EzsigntemplateformfieldRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplateformfieldY) && ($iEzsigntemplateformfieldY < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldY when calling EzsigntemplateformfieldRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldY)?'null':'"'.$iEzsigntemplateformfieldY.'"').' for iEzsigntemplateformfieldY when calling EzsigntemplateformfieldRequest., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param int $iEzsigntemplateformfieldWidth The Width of the Ezsigntemplateformfield in pixels calculated at 100 DPI
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplateformfieldWidth < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldWidth when calling EzsigntemplateformfieldRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldWidth)?'null':'"'.$iEzsigntemplateformfieldWidth.'"').' for iEzsigntemplateformfieldWidth when calling EzsigntemplateformfieldRequest., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param int $iEzsigntemplateformfieldHeight The Height of the Ezsigntemplateformfield in pixels calculated at 100 DPI
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplateformfieldHeight < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldHeight when calling EzsigntemplateformfieldRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldHeight)?'null':'"'.$iEzsigntemplateformfieldHeight.'"').' for iEzsigntemplateformfieldHeight when calling EzsigntemplateformfieldRequest., must be bigger than or equal to 0.');
        }
    ...
    {
	//return $this->container['sEzsigntemplateformfieldPositioningpattern'];
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplateformfieldPositioningpattern) && (!preg_match("/(*UTF8)^.{0,30}$/", ObjectSerializer::toString($sEzsigntemplateformfieldPositioningpattern)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplateformfieldPositioningpattern when calling EzsigntemplateformfieldRequest., must conform to the pattern /^.{0,30}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplateformfieldPositioningpattern)?'null':'"'.$sEzsigntemplateformfieldPositioningpattern.'"')." for sEzsigntemplateformfieldPositioningpattern when calling EzsigntemplateformfieldRequest., must conform to the pattern /^.{0,30}$/.");
        }
    ...
    /**
     * Gets eEzsigntemplateformfieldHorizontalalignment
     *
     * @return \eZmaxAPI\Model\EnumHorizontalalignment|null
     */
    public function getEEzsigntemplateformfieldHorizontalalignment()
    {
	//return $this->container['eEzsigntemplateformfieldHorizontalalignment'];
        return $this->container['eEzsigntemplateformfieldHorizontalalignment'];
    }

    /**
     * Sets eEzsigntemplateformfieldHorizontalalignment
     *
     * @param \eZmaxAPI\Model\EnumHorizontalalignment|null $eEzsigntemplateformfieldHorizontalalignment eEzsigntemplateformfieldHorizontalalignment
     *
     * @return self
     */
    public function setEEzsigntemplateformfieldHorizontalalignment($eEzsigntemplateformfieldHorizontalalignment)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($eEzsigntemplateformfieldHorizontalalignment)) {
            //throw new \InvalidArgumentException('non-nullable eEzsigntemplateformfieldHorizontalalignment cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['eEzsigntemplateformfieldHorizontalalignment'] = $eEzsigntemplateformfieldHorizontalalignment;
        $this->container['eEzsigntemplateformfieldHorizontalalignment'] = $eEzsigntemplateformfieldHorizontalalignment;
