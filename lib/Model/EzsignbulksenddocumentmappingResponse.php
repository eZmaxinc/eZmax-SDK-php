...
/**
 * EzsignbulksenddocumentmappingResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignbulksenddocumentmappingResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignbulksenddocumentmapping-Response';
    ...
    */
	...
	//if (($pkiEzsignbulksenddocumentmappingID < 0)) {
        if (($pkiEzsignbulksenddocumentmappingID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignbulksenddocumentmappingID when calling EzsignbulksenddocumentmappingResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignbulksenddocumentmappingID)?'null':'"'.$pkiEzsignbulksenddocumentmappingID.'"').' for pkiEzsignbulksenddocumentmappingID when calling EzsignbulksenddocumentmappingResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignbulksendID < 0)) {
        if (($fkiEzsignbulksendID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignbulksendID when calling EzsignbulksenddocumentmappingResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignbulksendID)?'null':'"'.$fkiEzsignbulksendID.'"').' for fkiEzsignbulksendID when calling EzsignbulksenddocumentmappingResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatepackageID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepackageID when calling EzsignbulksenddocumentmappingResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatepackageID)?'null':'"'.$fkiEzsigntemplatepackageID.'"').' for fkiEzsigntemplatepackageID when calling EzsignbulksenddocumentmappingResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplateID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplateID when calling EzsignbulksenddocumentmappingResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateID)?'null':'"'.$fkiEzsigntemplateID.'"').' for fkiEzsigntemplateID when calling EzsignbulksenddocumentmappingResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignbulksenddocumentmappingOrder < 0)) {
        if (($iEzsignbulksenddocumentmappingOrder < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignbulksenddocumentmappingOrder when calling EzsignbulksenddocumentmappingResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignbulksenddocumentmappingOrder)?'null':'"'.$iEzsignbulksenddocumentmappingOrder.'"').' for iEzsignbulksenddocumentmappingOrder when calling EzsignbulksenddocumentmappingResponse., must be bigger than or equal to 0.');
        }
