...
/**
 * EzsignfoldersignerassociationRequestCompoundV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignfoldersignerassociationRequestCompoundV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsignfoldersignerassociation-RequestCompoundV2';
    ...
    protected static $openAPITypes = [
        ...
        'eEzsignfoldersignerassociationRole' => '\eZmaxAPI\Model\FieldEEzsignfoldersignerassociationRole',
    ...
    protected static $openAPIFormats = [
        ...
        'eEzsignfoldersignerassociationRole' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'eEzsignfoldersignerassociationRole' => false,
    ...
    protected static $attributeMap = [
        ...
        'eEzsignfoldersignerassociationRole' => 'eEzsignfoldersignerassociationRole',
    ...
    protected static $setters = [
        ...
        'eEzsignfoldersignerassociationRole' => 'setEEzsignfoldersignerassociationRole',
    ...
    protected static $getters = [
        ...
        'eEzsignfoldersignerassociationRole' => 'getEEzsignfoldersignerassociationRole',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('eEzsignfoldersignerassociationRole', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['eEzsignfoldersignerassociationRole'] === null) {
            $invalidProperties[] = "'eEzsignfoldersignerassociationRole' can't be null";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzsignfoldersignerassociationID) && ($pkiEzsignfoldersignerassociationID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsignfoldersignerassociationID when calling EzsignfoldersignerassociationRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignfoldersignerassociationID)?'null':'"'.$pkiEzsignfoldersignerassociationID.'"').' for pkiEzsignfoldersignerassociationID when calling EzsignfoldersignerassociationRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUserID) && ($fkiUserID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling EzsignfoldersignerassociationRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling EzsignfoldersignerassociationRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignsignergroupID) && ($fkiEzsignsignergroupID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignsignergroupID when calling EzsignfoldersignerassociationRequestCompoundV2., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsignergroupID)?'null':'"'.$fkiEzsignsignergroupID.'"').' for fkiEzsignsignergroupID when calling EzsignfoldersignerassociationRequestCompoundV2., must be smaller than or equal to 65535.');
        }
        //if (($fkiEzsignsignergroupID < 0)) {
        if (!is_null($fkiEzsignsignergroupID) && ($fkiEzsignsignergroupID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignsignergroupID when calling EzsignfoldersignerassociationRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsignergroupID)?'null':'"'.$fkiEzsignsignergroupID.'"').' for fkiEzsignsignergroupID when calling EzsignfoldersignerassociationRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsignfolderID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfolderID when calling EzsignfoldersignerassociationRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfolderID)?'null':'"'.$fkiEzsignfolderID.'"').' for fkiEzsignfolderID when calling EzsignfoldersignerassociationRequestCompoundV2., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets eEzsignfoldersignerassociationRole
     *
     * @return \eZmaxAPI\Model\FieldEEzsignfoldersignerassociationRole
     */
    public function getEEzsignfoldersignerassociationRole()
    {
	//return $this->container['eEzsignfoldersignerassociationRole'];
        return $this->container['eEzsignfoldersignerassociationRole'];
    }

    /**
     * Sets eEzsignfoldersignerassociationRole
     *
     * @param \eZmaxAPI\Model\FieldEEzsignfoldersignerassociationRole $eEzsignfoldersignerassociationRole eEzsignfoldersignerassociationRole
     *
     * @return self
     */
    public function setEEzsignfoldersignerassociationRole($eEzsignfoldersignerassociationRole)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($eEzsignfoldersignerassociationRole)) {
            //throw new \InvalidArgumentException('non-nullable eEzsignfoldersignerassociationRole cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['eEzsignfoldersignerassociationRole'] = $eEzsignfoldersignerassociationRole;
        $this->container['eEzsignfoldersignerassociationRole'] = $eEzsignfoldersignerassociationRole;
