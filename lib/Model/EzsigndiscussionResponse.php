    ...
    */
	...
	//if (($pkiEzsigndiscussionID > 16777215)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigndiscussionID when calling EzsigndiscussionResponse., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndiscussionID)?'null':'"'.$pkiEzsigndiscussionID.'"').' for pkiEzsigndiscussionID when calling EzsigndiscussionResponse., must be smaller than or equal to 16777215.');
        }
	//if (($pkiEzsigndiscussionID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigndiscussionID when calling EzsigndiscussionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndiscussionID)?'null':'"'.$pkiEzsigndiscussionID.'"').' for pkiEzsigndiscussionID when calling EzsigndiscussionResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignpageID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignpageID when calling EzsigndiscussionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignpageID)?'null':'"'.$fkiEzsignpageID.'"').' for fkiEzsignpageID when calling EzsigndiscussionResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiDiscussionID > 16777215)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiDiscussionID when calling EzsigndiscussionResponse., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDiscussionID)?'null':'"'.$fkiDiscussionID.'"').' for fkiDiscussionID when calling EzsigndiscussionResponse., must be smaller than or equal to 16777215.');
        }
	//if (($fkiDiscussionID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiDiscussionID when calling EzsigndiscussionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDiscussionID)?'null':'"'.$fkiDiscussionID.'"').' for fkiDiscussionID when calling EzsigndiscussionResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigndiscussionX > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigndiscussionX when calling EzsigndiscussionResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndiscussionX)?'null':'"'.$iEzsigndiscussionX.'"').' for iEzsigndiscussionX when calling EzsigndiscussionResponse., must be smaller than or equal to 65535.');
        }
	//if (($iEzsigndiscussionX < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigndiscussionX when calling EzsigndiscussionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndiscussionX)?'null':'"'.$iEzsigndiscussionX.'"').' for iEzsigndiscussionX when calling EzsigndiscussionResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigndiscussionY > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigndiscussionY when calling EzsigndiscussionResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndiscussionY)?'null':'"'.$iEzsigndiscussionY.'"').' for iEzsigndiscussionY when calling EzsigndiscussionResponse., must be smaller than or equal to 65535.');
        }
	//if (($iEzsigndiscussionY < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigndiscussionY when calling EzsigndiscussionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndiscussionY)?'null':'"'.$iEzsigndiscussionY.'"').' for iEzsigndiscussionY when calling EzsigndiscussionResponse., must be bigger than or equal to 0.');
        }
