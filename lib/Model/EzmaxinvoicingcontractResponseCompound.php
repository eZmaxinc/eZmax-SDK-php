...
class EzmaxinvoicingcontractResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['dEzmaxinvoicingcontractLicense']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingcontractLicense'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingcontractLicense'])?'null':'"'.$this->container['dEzmaxinvoicingcontractLicense'].'"')." for 'dEzmaxinvoicingcontractLicense', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingcontract121qa']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingcontract121qa'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingcontract121qa'])?'null':'"'.$this->container['dEzmaxinvoicingcontract121qa'].'"')." for 'dEzmaxinvoicingcontract121qa', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
