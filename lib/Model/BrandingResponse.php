...
//        if ((!preg_match("/^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddress)))) {
        if (!is_null($sEmailAddress) && (!preg_match("/(*UTF8)^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddress)))) {
            throw new \InvalidArgumentException("invalid value for \$sEmailAddress when calling BrandingResponse., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
        }
...
//        if (($iBrandingInterfacecolor > 16777215)) {
        if (!is_null($iBrandingInterfacecolor) && ($iBrandingInterfacecolor > 16777215)) {
            throw new \InvalidArgumentException('invalid value for $iBrandingInterfacecolor when calling BrandingResponse., must be smaller than or equal to 16777215.');
        }
//        if (($iBrandingInterfacecolor < 0)) {
        if (!is_null($iBrandingInterfacecolor) && ($iBrandingInterfacecolor < 0)) {
            throw new \InvalidArgumentException('invalid value for $iBrandingInterfacecolor when calling BrandingResponse., must be bigger than or equal to 0.');
        }
