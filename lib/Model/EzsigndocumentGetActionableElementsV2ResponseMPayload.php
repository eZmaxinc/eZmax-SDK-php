...
/**
 * EzsigndocumentGetActionableElementsV2ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /2/object/ezsigndocument/{pkiEzsigndocumentID}/getActionableElements
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsigndocumentGetActionableElementsV2ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigndocument-getActionableElements-v2-Response-mPayload';
