...
/**
 * DomainListElement Class Doc Comment
 *
 * @category Class
 ...
 */
class DomainListElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'domain-ListElement';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($pkiDomainID > 255)) {
        if (($pkiDomainID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $pkiDomainID when calling DomainListElement., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiDomainID)?'null':'"'.$pkiDomainID.'"').' for pkiDomainID when calling DomainListElement., must be smaller than or equal to 255.');
        }
        //if (($pkiDomainID < 0)) {
        if (($pkiDomainID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiDomainID when calling DomainListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiDomainID)?'null':'"'.$pkiDomainID.'"').' for pkiDomainID when calling DomainListElement., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sDomainName) && (!preg_match("/(*UTF8)^(?=.{4,75}$)([a-zA-Z0-9-]+\\.)+[a-zA-Z]{2,63}$/", ObjectSerializer::toString($sDomainName)))) {
            //throw new \InvalidArgumentException("invalid value for \$sDomainName when calling DomainListElement., must conform to the pattern /^(?=.{4,75}$)([a-zA-Z0-9-]+\\.)+[a-zA-Z]{2,63}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sDomainName)?'null':'"'.$sDomainName.'"')." for sDomainName when calling DomainListElement., must conform to the pattern /^(?=.{4,75}$)([a-zA-Z0-9-]+\\.)+[a-zA-Z]{2,63}$/.");
        }
