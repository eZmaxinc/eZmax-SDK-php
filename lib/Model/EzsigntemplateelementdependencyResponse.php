...
class EzsigntemplateelementdependencyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['pkiEzsigntemplateelementdependencyID'] > 16777215)) {
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigntemplateelementdependencyID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplateelementdependencyID when calling EzsigntemplateelementdependencyResponse., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateelementdependencyID)?'null':'"'.$pkiEzsigntemplateelementdependencyID.'"').' for pkiEzsigntemplateelementdependencyID when calling EzsigntemplateelementdependencyResponse., must be smaller than or equal to 16777215.');
        }
        ...
        if (($pkiEzsigntemplateelementdependencyID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateelementdependencyID)?'null':'"'.$pkiEzsigntemplateelementdependencyID.'"').' for pkiEzsigntemplateelementdependencyID when calling EzsigntemplateelementdependencyResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplateformfieldID) && ($fkiEzsigntemplateformfieldID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateformfieldID)?'null':'"'.$fkiEzsigntemplateformfieldID.'"').' for fkiEzsigntemplateformfieldID when calling EzsigntemplateelementdependencyResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplatesignatureID) && ($fkiEzsigntemplatesignatureID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatesignatureID)?'null':'"'.$fkiEzsigntemplatesignatureID.'"').' for fkiEzsigntemplatesignatureID when calling EzsigntemplateelementdependencyResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplateformfieldIDValidation) && ($fkiEzsigntemplateformfieldIDValidation < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateformfieldIDValidation)?'null':'"'.$fkiEzsigntemplateformfieldIDValidation.'"').' for fkiEzsigntemplateformfieldIDValidation when calling EzsigntemplateelementdependencyResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplateformfieldgroupIDValidation) && ($fkiEzsigntemplateformfieldgroupIDValidation < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateformfieldgroupIDValidation)?'null':'"'.$fkiEzsigntemplateformfieldgroupIDValidation.'"').' for fkiEzsigntemplateformfieldgroupIDValidation when calling EzsigntemplateelementdependencyResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplateelementdependencyValue) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sEzsigntemplateelementdependencyValue)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplateelementdependencyValue)?'null':'"'.$sEzsigntemplateelementdependencyValue.'"')." for sEzsigntemplateelementdependencyValue when calling EzsigntemplateelementdependencyResponse., must conform to the pattern /^.{0,50}$/.");
        }
