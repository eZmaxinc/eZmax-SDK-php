...
/**
 * EzsigntemplateformfieldgroupResponseCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplateformfieldgroupResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigntemplateformfieldgroup-ResponseCompound';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pkiEzsigntemplateformfieldgroupID'] === null) {
            $invalidProperties[] = "'pkiEzsigntemplateformfieldgroupID' can't be null";
        }
        if (($this->container['pkiEzsigntemplateformfieldgroupID'] < 0)) {
     ...
     *
     * @param int $pkiEzsigntemplateformfieldgroupID The unique ID of the Ezsigntemplateformfieldgroup
     *
     * @return self
     */
	...
	//if (($pkiEzsigntemplateformfieldgroupID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplateformfieldgroupID when calling EzsigntemplateformfieldgroupResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateformfieldgroupID)?'null':'"'.$pkiEzsigntemplateformfieldgroupID.'"').' for pkiEzsigntemplateformfieldgroupID when calling EzsigntemplateformfieldgroupResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatedocumentID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatedocumentID when calling EzsigntemplateformfieldgroupResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatedocumentID)?'null':'"'.$fkiEzsigntemplatedocumentID.'"').' for fkiEzsigntemplatedocumentID when calling EzsigntemplateformfieldgroupResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if ((mb_strlen($sEzsigntemplateformfieldgroupLabel) > 50)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzsigntemplateformfieldgroupLabel when calling EzsigntemplateformfieldgroupResponseCompound., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsigntemplateformfieldgroupLabel)?'null':'"'.$sEzsigntemplateformfieldgroupLabel.'"').', invalid length for sEzsigntemplateformfieldgroupLabel when calling EzsigntemplateformfieldgroupResponseCompound., must be smaller than or equal to 50.');
        }
	//if ((mb_strlen($sEzsigntemplateformfieldgroupLabel) < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzsigntemplateformfieldgroupLabel when calling EzsigntemplateformfieldgroupResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsigntemplateformfieldgroupLabel)?'null':'"'.$sEzsigntemplateformfieldgroupLabel.'"').', invalid length for sEzsigntemplateformfieldgroupLabel when calling EzsigntemplateformfieldgroupResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//if (($iEzsigntemplateformfieldgroupStep < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldgroupStep when calling EzsigntemplateformfieldgroupResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldgroupStep)?'null':'"'.$iEzsigntemplateformfieldgroupStep.'"').' for iEzsigntemplateformfieldgroupStep when calling EzsigntemplateformfieldgroupResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//if (($iEzsigntemplateformfieldgroupFilledmin < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldgroupFilledmin when calling EzsigntemplateformfieldgroupResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldgroupFilledmin)?'null':'"'.$iEzsigntemplateformfieldgroupFilledmin.'"').' for iEzsigntemplateformfieldgroupFilledmin when calling EzsigntemplateformfieldgroupResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplateformfieldgroupFilledmax < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldgroupFilledmax when calling EzsigntemplateformfieldgroupResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldgroupFilledmax)?'null':'"'.$iEzsigntemplateformfieldgroupFilledmax.'"').' for iEzsigntemplateformfieldgroupFilledmax when calling EzsigntemplateformfieldgroupResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplateformfieldgroupMaxlength > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldgroupMaxlength when calling EzsigntemplateformfieldgroupResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldgroupMaxlength)?'null':'"'.$iEzsigntemplateformfieldgroupMaxlength.'"').' for iEzsigntemplateformfieldgroupMaxlength when calling EzsigntemplateformfieldgroupResponseCompound., must be smaller than or equal to 65535.');
        }
	//if (($iEzsigntemplateformfieldgroupMaxlength < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldgroupMaxlength when calling EzsigntemplateformfieldgroupResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldgroupMaxlength)?'null':'"'.$iEzsigntemplateformfieldgroupMaxlength.'"').' for iEzsigntemplateformfieldgroupMaxlength when calling EzsigntemplateformfieldgroupResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^\\^.*\\$$|^$/", ObjectSerializer::toString($sEzsigntemplateformfieldgroupRegexp)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplateformfieldgroupRegexp when calling EzsigntemplateformfieldgroupResponseCompound., must conform to the pattern /^\\^.*\\$$|^$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplateformfieldgroupRegexp)?'null':'"'.$sEzsigntemplateformfieldgroupRegexp.'"')." for sEzsigntemplateformfieldgroupRegexp when calling EzsigntemplateformfieldgroupResponseCompound., must conform to the pattern /^\\^.*\\$$|^$/.");
        }
	...
	//if ((mb_strlen($sEzsigntemplateformfieldgroupTextvalidationcustommessage) < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzsigntemplateformfieldgroupTextvalidationcustommessage when calling EzsigntemplateformfieldgroupResponseCompound., must be bigger than or equal to 0.');
