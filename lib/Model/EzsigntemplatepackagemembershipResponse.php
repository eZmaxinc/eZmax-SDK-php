    ...
    */
	...
	//if (($pkiEzsigntemplatepackagemembershipID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatepackagemembershipID when calling EzsigntemplatepackagemembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepackagemembershipID)?'null':'"'.$pkiEzsigntemplatepackagemembershipID.'"').' for pkiEzsigntemplatepackagemembershipID when calling EzsigntemplatepackagemembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatepackageID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepackageID when calling EzsigntemplatepackagemembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatepackageID)?'null':'"'.$fkiEzsigntemplatepackageID.'"').' for fkiEzsigntemplatepackageID when calling EzsigntemplatepackagemembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplateID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplateID when calling EzsigntemplatepackagemembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateID)?'null':'"'.$fkiEzsigntemplateID.'"').' for fkiEzsigntemplateID when calling EzsigntemplatepackagemembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatepackagemembershipOrder < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatepackagemembershipOrder when calling EzsigntemplatepackagemembershipResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatepackagemembershipOrder)?'null':'"'.$iEzsigntemplatepackagemembershipOrder.'"').' for iEzsigntemplatepackagemembershipOrder when calling EzsigntemplatepackagemembershipResponse., must be bigger than or equal to 1.');
        }
