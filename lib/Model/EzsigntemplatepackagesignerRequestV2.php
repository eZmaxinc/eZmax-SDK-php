...
/**
 * EzsigntemplatepackagesignerRequestV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplatepackagesignerRequestV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplatepackagesigner-RequestV2';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzsigntemplatepackagesignerID) && ($pkiEzsigntemplatepackagesignerID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatepackagesignerID when calling EzsigntemplatepackagesignerRequestV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepackagesignerID)?'null':'"'.$pkiEzsigntemplatepackagesignerID.'"').' for pkiEzsigntemplatepackagesignerID when calling EzsigntemplatepackagesignerRequestV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigntemplatepackageID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepackageID when calling EzsigntemplatepackagesignerRequestV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatepackageID)?'null':'"'.$fkiEzsigntemplatepackageID.'"').' for fkiEzsigntemplatepackageID when calling EzsigntemplatepackagesignerRequestV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzdoctemplatedocumentID) && ($fkiEzdoctemplatedocumentID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatedocumentID when calling EzsigntemplatepackagesignerRequestV2., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatedocumentID)?'null':'"'.$fkiEzdoctemplatedocumentID.'"').' for fkiEzdoctemplatedocumentID when calling EzsigntemplatepackagesignerRequestV2., must be smaller than or equal to 65535.');
        }
        //if (($fkiEzdoctemplatedocumentID < 0)) {
        if (!is_null($fkiEzdoctemplatedocumentID) && ($fkiEzdoctemplatedocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatedocumentID when calling EzsigntemplatepackagesignerRequestV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatedocumentID)?'null':'"'.$fkiEzdoctemplatedocumentID.'"').' for fkiEzdoctemplatedocumentID when calling EzsigntemplatepackagesignerRequestV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUserID) && ($fkiUserID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling EzsigntemplatepackagesignerRequestV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling EzsigntemplatepackagesignerRequestV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling EzsigntemplatepackagesignerRequestV2., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling EzsigntemplatepackagesignerRequestV2., must be smaller than or equal to 255.');
        }
        //if (($fkiUsergroupID < 0)) {
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling EzsigntemplatepackagesignerRequestV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling EzsigntemplatepackagesignerRequestV2., must be bigger than or equal to 0.');
        }
