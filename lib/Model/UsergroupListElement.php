...
class UsergroupListElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'iCountInactiveuser' => 'setICountInactiveuser'
    ];
    ...
    protected static $getters = [
        ...
        'iCountInactiveuser' => 'getICountInactiveuser'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('iCountInactiveuser', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['iCountInactiveuser'] === null) {
            $invalidProperties[] = "'iCountInactiveuser' can't be null";
        }
        if (($this->container['iCountInactiveuser'] > 16777215)) {
            $invalidProperties[] = "invalid value for 'iCountInactiveuser', must be smaller than or equal to 16777215.";
        }

        if (($this->container['iCountInactiveuser'] < 0)) {
            $invalidProperties[] = "invalid value for 'iCountInactiveuser', must be bigger than or equal to 0.";
        }
    ...
    /**
     * Gets iCountInactiveuser
     *
     * @return int
     */
    public function getICountInactiveuser()
    {
	//return $this->container['iCountInactiveuser'];
        return $this->container['iCountInactiveuser'];
    }

    /**
     * Sets iCountInactiveuser
     *
     * @param int $iCountInactiveuser Number of inactive users in group
     *
     * @return self
     */
    public function setICountInactiveuser($iCountInactiveuser)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($iCountInactiveuser)) {
            //throw new \InvalidArgumentException('non-nullable iCountInactiveuser cannot be null');
        //}
        //if (($iCountInactiveuser > 16777215)) {
        if (($iCountInactiveuser > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $iCountInactiveuser when calling UsergroupListElement., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCountInactiveuser)?'null':'"'.$iCountInactiveuser.'"').' for iCountInactiveuser when calling UsergroupListElement., must be smaller than or equal to 16777215.');
        }
        //if (($iCountInactiveuser < 0)) {
        if (($iCountInactiveuser < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iCountInactiveuser when calling UsergroupListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCountInactiveuser)?'null':'"'.$iCountInactiveuser.'"').' for iCountInactiveuser when calling UsergroupListElement., must be bigger than or equal to 0.');
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['iCountInactiveuser'] = $iCountInactiveuser;
        $this->container['iCountInactiveuser'] = (is_null($iCountInactiveuser) ? null : (int) $iCountInactiveuser);
