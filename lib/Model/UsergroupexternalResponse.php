...
/**
 * UsergroupexternalResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class UsergroupexternalResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'usergroupexternal-Response';
    ...
    */
	...
	//if (($pkiUsergroupexternalID > 255)) {
        if (($pkiUsergroupexternalID > 255)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiUsergroupexternalID when calling UsergroupexternalResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupexternalID)?'null':'"'.$pkiUsergroupexternalID.'"').' for pkiUsergroupexternalID when calling UsergroupexternalResponse., must be smaller than or equal to 255.');
        }
	//if (($pkiUsergroupexternalID < 0)) {
        if (($pkiUsergroupexternalID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiUsergroupexternalID when calling UsergroupexternalResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupexternalID)?'null':'"'.$pkiUsergroupexternalID.'"').' for pkiUsergroupexternalID when calling UsergroupexternalResponse., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{0,64}$/", ObjectSerializer::toString($sUsergroupexternalName)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sUsergroupexternalName when calling UsergroupexternalResponse., must conform to the pattern /^.{0,64}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupexternalName)?'null':'"'.$sUsergroupexternalName.'"')." for sUsergroupexternalName when calling UsergroupexternalResponse., must conform to the pattern /^.{0,64}$/.");
        }
	...
	//if ((!preg_match("/^.{0,64}$/", ObjectSerializer::toString($sUsergroupexternalID)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sUsergroupexternalID when calling UsergroupexternalResponse., must conform to the pattern /^.{0,64}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupexternalID)?'null':'"'.$sUsergroupexternalID.'"')." for sUsergroupexternalID when calling UsergroupexternalResponse., must conform to the pattern /^.{0,64}$/.");
        }
