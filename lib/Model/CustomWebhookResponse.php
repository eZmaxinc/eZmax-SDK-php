...
class CustomWebhookResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'eWebhookEzmaxpartnerevent' => '\eZmaxAPI\Model\FieldEWebhookEzmaxpartnerevent',
        ...
        'eWebhookRealestateevent' => '\eZmaxAPI\Model\FieldEWebhookRealestateevent',
        'sWebhookUrl' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'eWebhookModule' => null,
        'eWebhookEzmaxpartnerevent' => null,
        'eWebhookEzsignevent' => null,
        'eWebhookManagementevent' => null,
        'eWebhookRealestateevent' => null,
        'sWebhookUrl' => null,
        ...
        'objAudit' => null,
        'sWebhookEvent' => null,
        'sWebhookAuthentificationexternalerror' => null,
        'aObjWebhookheader' => null,
        'pksCustomerCode' => null,
        'bWebhookTest' => null,
        'eWebhookEmittype' => null,
        'fkiEzmaxpartnerproductstagewebhookID' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'eWebhookEzmaxpartnerevent' => false,
        'eWebhookEzsignevent' => false,
        'eWebhookManagementevent' => false,
        'eWebhookRealestateevent' => false,
        'sWebhookUrl' => false,
        ...
        'objAudit' => false,
        'sWebhookEvent' => false,
        'sWebhookAuthentificationexternalerror' => false,
        'aObjWebhookheader' => false,
        'pksCustomerCode' => false,
        'bWebhookTest' => false,
        'eWebhookEmittype' => false,
        'fkiEzmaxpartnerproductstagewebhookID' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'eWebhookEzmaxpartnerevent' => 'eWebhookEzmaxpartnerevent',
        'eWebhookEzsignevent' => 'eWebhookEzsignevent',
        'eWebhookManagementevent' => 'eWebhookManagementevent',
        'eWebhookRealestateevent' => 'eWebhookRealestateevent',
        ...
        'sWebhookAuthentificationexternalerror' => 'sWebhookAuthentificationexternalerror',
        ...
        'fkiEzmaxpartnerproductstagewebhookID' => 'fkiEzmaxpartnerproductstagewebhookID'
    ];
    ...
    protected static $setters = [
        ...
        'eWebhookEzmaxpartnerevent' => 'setEWebhookEzmaxpartnerevent',
        'eWebhookEzsignevent' => 'setEWebhookEzsignevent',
        'eWebhookManagementevent' => 'setEWebhookManagementevent',
        'eWebhookRealestateevent' => 'setEWebhookRealestateevent',
        ...
        'sWebhookAuthentificationexternalerror' => 'setSWebhookAuthentificationexternalerror',
        ...
        'fkiEzmaxpartnerproductstagewebhookID' => 'setFkiEzmaxpartnerproductstagewebhookID'
    ];
    ...
    protected static $getters = [
        ...
        'eWebhookEzmaxpartnerevent' => 'getEWebhookEzmaxpartnerevent',
        'eWebhookEzsignevent' => 'getEWebhookEzsignevent',
        'eWebhookManagementevent' => 'getEWebhookManagementevent',
        'eWebhookRealestateevent' => 'getEWebhookRealestateevent',
        ...
        'sWebhookAuthentificationexternalerror' => 'getSWebhookAuthentificationexternalerror',
        ...
        'fkiEzmaxpartnerproductstagewebhookID' => 'getFkiEzmaxpartnerproductstagewebhookID'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('eWebhookEzmaxpartnerevent', $data ?? [], null);
        $this->setIfExists('eWebhookEzsignevent', $data ?? [], null);
        $this->setIfExists('eWebhookManagementevent', $data ?? [], null);
        $this->setIfExists('eWebhookRealestateevent', $data ?? [], null);
        ...
        $this->setIfExists('sWebhookAuthentificationexternalerror', $data ?? [], null);
        ...
        $this->setIfExists('fkiEzmaxpartnerproductstagewebhookID', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sWebhookUrl']) && !preg_match("/(*UTF8)^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/", $this->container['sWebhookUrl'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sWebhookUrl'])?'null':'"'.$this->container['sWebhookUrl'].'"')." for 'sWebhookUrl', must be conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.";
        }
        ...
        if (!is_null($this->container['sAuthenticationexternalDescription']) && !preg_match("/(*UTF8)^.{0,50}$/", $this->container['sAuthenticationexternalDescription'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sAuthenticationexternalDescription'])?'null':'"'.$this->container['sAuthenticationexternalDescription'].'"')." for 'sAuthenticationexternalDescription', must be conform to the pattern /^.{0,50}$/.";
        }
        ...
        if (!is_null($this->container['fkiEzmaxpartnerproductstagewebhookID']) && ($this->container['fkiEzmaxpartnerproductstagewebhookID'] > 65535)) {
            $invalidProperties[] = "invalid value for 'fkiEzmaxpartnerproductstagewebhookID', must be smaller than or equal to 65535.";
        }

        if (!is_null($this->container['fkiEzmaxpartnerproductstagewebhookID']) && ($this->container['fkiEzmaxpartnerproductstagewebhookID'] < 0)) {
            $invalidProperties[] = "invalid value for 'fkiEzmaxpartnerproductstagewebhookID', must be bigger than or equal to 0.";
        }
    ...
    /**
     * Gets eWebhookEzmaxpartnerevent
     *
     * @return \eZmaxAPI\Model\FieldEWebhookEzmaxpartnerevent|null
     */
    public function getEWebhookEzmaxpartnerevent()
    {
	//return $this->container['eWebhookEzmaxpartnerevent'];
        return $this->container['eWebhookEzmaxpartnerevent'];
    }

    /**
     * Sets eWebhookEzmaxpartnerevent
     *
     * @param \eZmaxAPI\Model\FieldEWebhookEzmaxpartnerevent|null $eWebhookEzmaxpartnerevent eWebhookEzmaxpartnerevent
     *
     * @return self
     */
    public function setEWebhookEzmaxpartnerevent($eWebhookEzmaxpartnerevent)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($eWebhookEzmaxpartnerevent)) {
            //throw new \InvalidArgumentException('non-nullable eWebhookEzmaxpartnerevent cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['eWebhookEzmaxpartnerevent'] = $eWebhookEzmaxpartnerevent;
        $this->container['eWebhookEzmaxpartnerevent'] = $eWebhookEzmaxpartnerevent;
    ...
    /**
     * Gets eWebhookRealestateevent
     *
     * @return \eZmaxAPI\Model\FieldEWebhookRealestateevent|null
     */
    public function getEWebhookRealestateevent()
    {
	//return $this->container['eWebhookRealestateevent'];
        return $this->container['eWebhookRealestateevent'];
    }

    /**
     * Sets eWebhookRealestateevent
     *
     * @param \eZmaxAPI\Model\FieldEWebhookRealestateevent|null $eWebhookRealestateevent eWebhookRealestateevent
     *
     * @return self
     */
    public function setEWebhookRealestateevent($eWebhookRealestateevent)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($eWebhookRealestateevent)) {
            //throw new \InvalidArgumentException('non-nullable eWebhookRealestateevent cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['eWebhookRealestateevent'] = $eWebhookRealestateevent;
        $this->container['eWebhookRealestateevent'] = $eWebhookRealestateevent;
    ...
    /**
     * Gets sWebhookAuthentificationexternalerror
     *
     * @return string|null
     */
    public function getSWebhookAuthentificationexternalerror()
    {
	//return $this->container['sWebhookAuthentificationexternalerror'];
        return is_null($this->container['sWebhookAuthentificationexternalerror']) ? null : trim($this->container['sWebhookAuthentificationexternalerror']);
    }

    /**
     * Sets sWebhookAuthentificationexternalerror
     *
     * @param string|null $sWebhookAuthentificationexternalerror Error message when token renewal failed or is not configured. Only if an Authenticationexternal is set.
     *
     * @return self
     */
    public function setSWebhookAuthentificationexternalerror($sWebhookAuthentificationexternalerror)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($sWebhookAuthentificationexternalerror)) {
            //throw new \InvalidArgumentException('non-nullable sWebhookAuthentificationexternalerror cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['sWebhookAuthentificationexternalerror'] = $sWebhookAuthentificationexternalerror;
        $this->container['sWebhookAuthentificationexternalerror'] = (is_null($sWebhookAuthentificationexternalerror) ? null : trim((string) $sWebhookAuthentificationexternalerror));
    ...
    /**
     * Gets fkiEzmaxpartnerproductstagewebhookID
     *
     * @return int|null
     */
    public function getFkiEzmaxpartnerproductstagewebhookID()
    {
	//return $this->container['fkiEzmaxpartnerproductstagewebhookID'];
        return $this->container['fkiEzmaxpartnerproductstagewebhookID'];
    }

    /**
     * Sets fkiEzmaxpartnerproductstagewebhookID
     *
     * @param int|null $fkiEzmaxpartnerproductstagewebhookID The unique ID of the Ezmaxpartnerproductstagewebhook
     *
     * @return self
     */
    public function setFkiEzmaxpartnerproductstagewebhookID($fkiEzmaxpartnerproductstagewebhookID)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($fkiEzmaxpartnerproductstagewebhookID)) {
            //throw new \InvalidArgumentException('non-nullable fkiEzmaxpartnerproductstagewebhookID cannot be null');
        //}
        //if (($fkiEzmaxpartnerproductstagewebhookID > 65535)) {
        if (!is_null($fkiEzmaxpartnerproductstagewebhookID) && ($fkiEzmaxpartnerproductstagewebhookID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzmaxpartnerproductstagewebhookID when calling CustomWebhookResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxpartnerproductstagewebhookID)?'null':'"'.$fkiEzmaxpartnerproductstagewebhookID.'"').' for fkiEzmaxpartnerproductstagewebhookID when calling CustomWebhookResponse., must be smaller than or equal to 65535.');
        }
        //if (($fkiEzmaxpartnerproductstagewebhookID < 0)) {
        if (!is_null($fkiEzmaxpartnerproductstagewebhookID) && ($fkiEzmaxpartnerproductstagewebhookID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzmaxpartnerproductstagewebhookID when calling CustomWebhookResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxpartnerproductstagewebhookID)?'null':'"'.$fkiEzmaxpartnerproductstagewebhookID.'"').' for fkiEzmaxpartnerproductstagewebhookID when calling CustomWebhookResponse., must be bigger than or equal to 0.');
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['fkiEzmaxpartnerproductstagewebhookID'] = $fkiEzmaxpartnerproductstagewebhookID;
        $this->container['fkiEzmaxpartnerproductstagewebhookID'] = (is_null($fkiEzmaxpartnerproductstagewebhookID) ? null : (int) $fkiEzmaxpartnerproductstagewebhookID);
