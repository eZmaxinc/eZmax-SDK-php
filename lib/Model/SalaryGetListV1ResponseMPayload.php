...
/**
 * SalaryGetListV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /1/object/salary/getList
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SalaryGetListV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'salary-getList-v1-Response-mPayload';
    ...
    protected static $openAPITypes = [
        'iRowReturned' => 'int',
        'iRowFiltered' => 'int',
        'aObjSalary' => '\eZmaxAPI\Model\SalaryListElement[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aObjSalary', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aObjSalary'] === null) {
            $invalidProperties[] = "'aObjSalary' can't be null";
        }
     ...
     * Gets aObjSalary
     *
     * @return \eZmaxAPI\Model\SalaryListElement[]
     */
    public function getAObjSalary()
    {
	//return $this->container['aObjSalary'];
        return $this->container['aObjSalary'];
    }
     ...
     * Sets aObjSalary
     *
     * @param \eZmaxAPI\Model\SalaryListElement[] $aObjSalary aObjSalary
     *
     * @return self
     */
    public function setAObjSalary($aObjSalary)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjSalary)) {
            //throw new \InvalidArgumentException('non-nullable aObjSalary cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjSalary'] = $aObjSalary;
        $this->container['aObjSalary'] = $aObjSalary;
