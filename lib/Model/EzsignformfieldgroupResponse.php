...
/**
 * EzsignformfieldgroupResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignformfieldgroupResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsignformfieldgroup-Response';
    ...
    protected static $openAPITypes = [
        ...
        'dtEzsignformfieldgroupCompleted' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'dtEzsignformfieldgroupCompleted' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'dtEzsignformfieldgroupCompleted' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'dtEzsignformfieldgroupCompleted' => 'dtEzsignformfieldgroupCompleted'
    ];
    ...
    protected static $setters = [
        ...
        'dtEzsignformfieldgroupCompleted' => 'setDtEzsignformfieldgroupCompleted'
    ];
    ...
    protected static $getters = [
        ...
        'dtEzsignformfieldgroupCompleted' => 'getDtEzsignformfieldgroupCompleted'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('dtEzsignformfieldgroupCompleted', $data ?? [], null);
    }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsignformfieldgroupID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsignformfieldgroupID when calling EzsignformfieldgroupResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignformfieldgroupID)?'null':'"'.$pkiEzsignformfieldgroupID.'"').' for pkiEzsignformfieldgroupID when calling EzsignformfieldgroupResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigndocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigndocumentID when calling EzsignformfieldgroupResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigndocumentID)?'null':'"'.$fkiEzsigndocumentID.'"').' for fkiEzsigndocumentID when calling EzsignformfieldgroupResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if ((mb_strlen($sEzsignformfieldgroupLabel) > 50)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupLabel when calling EzsignformfieldgroupResponse., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupLabel)?'null':'"'.$sEzsignformfieldgroupLabel.'"').', invalid length for sEzsignformfieldgroupLabel when calling EzsignformfieldgroupResponse., must be smaller than or equal to 50.');
        }
        //if ((mb_strlen($sEzsignformfieldgroupLabel) < 1)) {
        if ((mb_strlen($sEzsignformfieldgroupLabel) < 1)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupLabel when calling EzsignformfieldgroupResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupLabel)?'null':'"'.$sEzsignformfieldgroupLabel.'"').', invalid length for sEzsignformfieldgroupLabel when calling EzsignformfieldgroupResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsignformfieldgroupStep < 1)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupStep when calling EzsignformfieldgroupResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupStep)?'null':'"'.$iEzsignformfieldgroupStep.'"').' for iEzsignformfieldgroupStep when calling EzsignformfieldgroupResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsignformfieldgroupFilledmin < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupFilledmin when calling EzsignformfieldgroupResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupFilledmin)?'null':'"'.$iEzsignformfieldgroupFilledmin.'"').' for iEzsignformfieldgroupFilledmin when calling EzsignformfieldgroupResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsignformfieldgroupFilledmax < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupFilledmax when calling EzsignformfieldgroupResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupFilledmax)?'null':'"'.$iEzsignformfieldgroupFilledmax.'"').' for iEzsignformfieldgroupFilledmax when calling EzsignformfieldgroupResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsignformfieldgroupMaxlength) && ($iEzsignformfieldgroupMaxlength > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupMaxlength when calling EzsignformfieldgroupResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupMaxlength)?'null':'"'.$iEzsignformfieldgroupMaxlength.'"').' for iEzsignformfieldgroupMaxlength when calling EzsignformfieldgroupResponse., must be smaller than or equal to 65535.');
        }
        //if (($iEzsignformfieldgroupMaxlength < 0)) {
        if (!is_null($iEzsignformfieldgroupMaxlength) && ($iEzsignformfieldgroupMaxlength < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupMaxlength when calling EzsignformfieldgroupResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupMaxlength)?'null':'"'.$iEzsignformfieldgroupMaxlength.'"').' for iEzsignformfieldgroupMaxlength when calling EzsignformfieldgroupResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignformfieldgroupRegexp) && (!preg_match("/(*UTF8)^\\^.*\\$$|^$/", ObjectSerializer::toString($sEzsignformfieldgroupRegexp)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignformfieldgroupRegexp)?'null':'"'.$sEzsignformfieldgroupRegexp.'"')." for sEzsignformfieldgroupRegexp when calling EzsignformfieldgroupResponse., must conform to the pattern /^\\^.*\\$$|^$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignformfieldgroupTextvalidationcustommessage) && (mb_strlen($sEzsignformfieldgroupTextvalidationcustommessage) > 50)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupTextvalidationcustommessage when calling EzsignformfieldgroupResponse., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupTextvalidationcustommessage)?'null':'"'.$sEzsignformfieldgroupTextvalidationcustommessage.'"').', invalid length for sEzsignformfieldgroupTextvalidationcustommessage when calling EzsignformfieldgroupResponse., must be smaller than or equal to 50.');
        }
        ...
        if (!is_null($sEzsignformfieldgroupTextvalidationcustommessage) && (mb_strlen($sEzsignformfieldgroupTextvalidationcustommessage) < 0)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupTextvalidationcustommessage when calling EzsignformfieldgroupResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupTextvalidationcustommessage)?'null':'"'.$sEzsignformfieldgroupTextvalidationcustommessage.'"').', invalid length for sEzsignformfieldgroupTextvalidationcustommessage when calling EzsignformfieldgroupResponse., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets dtEzsignformfieldgroupCompleted
     *
     * @return string|null
     */
    public function getDtEzsignformfieldgroupCompleted()
    {
	//return $this->container['dtEzsignformfieldgroupCompleted'];
        return is_null($this->container['dtEzsignformfieldgroupCompleted']) ? null : trim($this->container['dtEzsignformfieldgroupCompleted']);
    }

    /**
     * Sets dtEzsignformfieldgroupCompleted
     *
     * @param string|null $dtEzsignformfieldgroupCompleted The date the Ezsignformfieldgroup was completed.
     *
     * @return self
     */
    public function setDtEzsignformfieldgroupCompleted($dtEzsignformfieldgroupCompleted)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($dtEzsignformfieldgroupCompleted)) {
            //throw new \InvalidArgumentException('non-nullable dtEzsignformfieldgroupCompleted cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['dtEzsignformfieldgroupCompleted'] = $dtEzsignformfieldgroupCompleted;
        $this->container['dtEzsignformfieldgroupCompleted'] = (is_null($dtEzsignformfieldgroupCompleted) ? null : trim((string) $dtEzsignformfieldgroupCompleted));
