...
/**
 * EzsignfoldertypeRequestV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignfoldertypeRequestV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignfoldertype-RequestV2';
...
//        if (($pkiEzsignfoldertypeID > 65535)) {
        if (!is_null($pkiEzsignfoldertypeID) && ($pkiEzsignfoldertypeID > 65535)) {
            throw new \InvalidArgumentException('invalid value for $pkiEzsignfoldertypeID when calling EzsignfoldertypeRequestV2., must be smaller than or equal to 65535.');
        }
//        if (($pkiEzsignfoldertypeID < 0)) {
        if (!is_null($pkiEzsignfoldertypeID) && ($pkiEzsignfoldertypeID < 0)) {
            throw new \InvalidArgumentException('invalid value for $pkiEzsignfoldertypeID when calling EzsignfoldertypeRequestV2., must be bigger than or equal to 0.');
        }
...
//        if (($fkiBrandingID < 0)) {
        if (($fkiBrandingID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiBrandingID when calling EzsignfoldertypeRequestV2., must be bigger than or equal to 0.');
        }
...
//        if (($fkiBillingentityinternalID < 0)) {
        if (!is_null($fkiBillingentityinternalID) && ($fkiBillingentityinternalID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiBillingentityinternalID when calling EzsignfoldertypeRequestV2., must be bigger than or equal to 0.');
        }
...
//        if (($fkiEzsigntsarequirementID > 3)) {
        if (!is_null($fkiEzsigntsarequirementID) && ($fkiEzsigntsarequirementID > 3)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsigntsarequirementID when calling EzsignfoldertypeRequestV2., must be smaller than or equal to 3.');
        }
//        if (($fkiEzsigntsarequirementID < 1)) {
        if (!is_null($fkiEzsigntsarequirementID) && ($fkiEzsigntsarequirementID < 1)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsigntsarequirementID when calling EzsignfoldertypeRequestV2., must be bigger than or equal to 1.');
        }
...
//        if ((!preg_match("/^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddressSigned)))) {
        if (!is_null($sEmailAddressSigned) && (!preg_match("/(*UTF8)^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddressSigned)))) {
            throw new \InvalidArgumentException("invalid value for \$sEmailAddressSigned when calling EzsignfoldertypeRequestV2., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
        }
...
//        if ((!preg_match("/^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddressSummary)))) {
        if (!is_null($sEmailAddressSummary) && (!preg_match("/(*UTF8)^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddressSummary)))) {
            throw new \InvalidArgumentException("invalid value for \$sEmailAddressSummary when calling EzsignfoldertypeRequestV2., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
        }
...
//        if (($iEzsignfoldertypeArchivaldays > 180)) {
        if (($iEzsignfoldertypeArchivaldays > 180)) {
            throw new \InvalidArgumentException('invalid value for $iEzsignfoldertypeArchivaldays when calling EzsignfoldertypeRequestV2., must be smaller than or equal to 180.');
        }
//        if (($iEzsignfoldertypeArchivaldays < 0)) {
        if (($iEzsignfoldertypeArchivaldays < 0)) {
            throw new \InvalidArgumentException('invalid value for $iEzsignfoldertypeArchivaldays when calling EzsignfoldertypeRequestV2., must be bigger than or equal to 0.');
        }
...
//        if (($iEzsignfoldertypeDisposaldays > 9999)) {
        if (!is_null($iEzsignfoldertypeDisposaldays) && ($iEzsignfoldertypeDisposaldays > 9999)) {
            throw new \InvalidArgumentException('invalid value for $iEzsignfoldertypeDisposaldays when calling EzsignfoldertypeRequestV2., must be smaller than or equal to 9999.');
        }
//        if (($iEzsignfoldertypeDisposaldays < 0)) {
        if (!is_null($iEzsignfoldertypeDisposaldays) && ($iEzsignfoldertypeDisposaldays < 0)) {
            throw new \InvalidArgumentException('invalid value for $iEzsignfoldertypeDisposaldays when calling EzsignfoldertypeRequestV2., must be bigger than or equal to 0.');
        }
...
//        if (($iEzsignfoldertypeDeadlinedays > 60)) {
        if (($iEzsignfoldertypeDeadlinedays > 60)) {
            throw new \InvalidArgumentException('invalid value for $iEzsignfoldertypeDeadlinedays when calling EzsignfoldertypeRequestV2., must be smaller than or equal to 60.');
        }
//        if (($iEzsignfoldertypeDeadlinedays < 1)) {
        if (($iEzsignfoldertypeDeadlinedays < 1)) {
            throw new \InvalidArgumentException('invalid value for $iEzsignfoldertypeDeadlinedays when calling EzsignfoldertypeRequestV2., must be bigger than or equal to 1.');
        }
