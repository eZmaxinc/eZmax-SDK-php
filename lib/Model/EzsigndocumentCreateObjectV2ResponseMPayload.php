...
/**
 * EzsigndocumentCreateObjectV2ResponseMPayload Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigndocumentCreateObjectV2ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigndocument-createObject-v2-Response-mPayload';
    ...
    {
        $this->setIfExists('aPkiEzsigndocumentID', $data ?? [], null);
    }
    ...
    */
    ...
    public function setAPkiEzsigndocumentID($aPkiEzsigndocumentID)
    {
        ...
        if ((count($aPkiEzsigndocumentID) < 1)) {
            throw new \InvalidArgumentException('invalid length for $aPkiEzsigndocumentID when calling EzsigndocumentCreateObjectV2ResponseMPayload., number of items must be greater than or equal to 1.');
        }
