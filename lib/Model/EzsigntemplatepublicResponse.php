...
/**
 * EzsigntemplatepublicResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplatepublicResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplatepublic-Response';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sEzsigntemplatepublicReferenceid']) && !preg_match("/(*UTF8)^.{0,36}$/", $this->container['sEzsigntemplatepublicReferenceid'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsigntemplatepublicReferenceid'])?'null':'"'.$this->container['sEzsigntemplatepublicReferenceid'].'"')." for 'sEzsigntemplatepublicReferenceid', must be conform to the pattern /^.{0,36}$/.";
        }
        ...
        if (!is_null($this->container['tEzsigntemplatepublicNote']) && !preg_match("/(*UTF8)^.{0,65535}$/", $this->container['tEzsigntemplatepublicNote'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['tEzsigntemplatepublicNote'])?'null':'"'.$this->container['tEzsigntemplatepublicNote'].'"')." for 'tEzsigntemplatepublicNote', must be conform to the pattern /^.{0,65535}$/.";
        }
        ...
        if (!is_null($this->container['dtEzsigntemplatepublicLimitexceededsince']) && !preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", $this->container['dtEzsigntemplatepublicLimitexceededsince'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtEzsigntemplatepublicLimitexceededsince'])?'null':'"'.$this->container['dtEzsigntemplatepublicLimitexceededsince'].'"')." for 'dtEzsigntemplatepublicLimitexceededsince', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
        }

        if ($this->container['sEzsigntemplatepublicUrl'] === null) {
            $invalidProperties[] = "'sEzsigntemplatepublicUrl' can't be null";
        }
        //if (!preg_match("/^https:\/\/[^\\s\/$.?#].[^\\s]*$/", $this->container['sEzsigntemplatepublicUrl'])) {
        if (!is_null($this->container['sEzsigntemplatepublicUrl']) && !preg_match("/(*UTF8)^https:\/\/[^\\s\/$.?#].[^\\s]*$/", $this->container['sEzsigntemplatepublicUrl'])) {
            //$invalidProperties[] = "invalid value for 'sEzsigntemplatepublicUrl', must be conform to the pattern /^https:\/\/[^\\s\/$.?#].[^\\s]*$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsigntemplatepublicUrl'])?'null':'"'.$this->container['sEzsigntemplatepublicUrl'].'"')." for 'sEzsigntemplatepublicUrl', must be conform to the pattern /^https:\/\/[^\\s\/$.?#].[^\\s]*$/.";
        }
        ...
        if (!is_null($this->container['sEzsigntemplatepublicEzsigntemplatedescription']) && !preg_match("/(*UTF8)^.{1,80}$/", $this->container['sEzsigntemplatepublicEzsigntemplatedescription'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsigntemplatepublicEzsigntemplatedescription'])?'null':'"'.$this->container['sEzsigntemplatepublicEzsigntemplatedescription'].'"')." for 'sEzsigntemplatepublicEzsigntemplatedescription', must be conform to the pattern /^.{1,80}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigntemplatepublicID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatepublicID when calling EzsigntemplatepublicResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepublicID)?'null':'"'.$pkiEzsigntemplatepublicID.'"').' for pkiEzsigntemplatepublicID when calling EzsigntemplatepublicResponse., must be smaller than or equal to 65535.');
        }
        //if (($pkiEzsigntemplatepublicID < 0)) {
        if (($pkiEzsigntemplatepublicID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatepublicID when calling EzsigntemplatepublicResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepublicID)?'null':'"'.$pkiEzsigntemplatepublicID.'"').' for pkiEzsigntemplatepublicID when calling EzsigntemplatepublicResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsignfoldertypeID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsigntemplatepublicResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsigntemplatepublicResponse., must be smaller than or equal to 65535.');
        }
        //if (($fkiEzsignfoldertypeID < 0)) {
        if (($fkiEzsignfoldertypeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsigntemplatepublicResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsigntemplatepublicResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiUserlogintypeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserlogintypeID when calling EzsigntemplatepublicResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserlogintypeID)?'null':'"'.$fkiUserlogintypeID.'"').' for fkiUserlogintypeID when calling EzsigntemplatepublicResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplateID) && ($fkiEzsigntemplateID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplateID when calling EzsigntemplatepublicResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateID)?'null':'"'.$fkiEzsigntemplateID.'"').' for fkiEzsigntemplateID when calling EzsigntemplatepublicResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplatepackageID) && ($fkiEzsigntemplatepackageID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepackageID when calling EzsigntemplatepublicResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatepackageID)?'null':'"'.$fkiEzsigntemplatepackageID.'"').' for fkiEzsigntemplatepackageID when calling EzsigntemplatepublicResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatepublicDescription) && (!preg_match("/(*UTF8)^.{0,80}$/", ObjectSerializer::toString($sEzsigntemplatepublicDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatepublicDescription when calling EzsigntemplatepublicResponse., must conform to the pattern /^.{0,80}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatepublicDescription)?'null':'"'.$sEzsigntemplatepublicDescription.'"')." for sEzsigntemplatepublicDescription when calling EzsigntemplatepublicResponse., must conform to the pattern /^.{0,80}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatepublicReferenceid) && (!preg_match("/(*UTF8)^.{0,36}$/", ObjectSerializer::toString($sEzsigntemplatepublicReferenceid)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatepublicReferenceid when calling EzsigntemplatepublicResponse., must conform to the pattern /^.{0,36}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatepublicReferenceid)?'null':'"'.$sEzsigntemplatepublicReferenceid.'"')." for sEzsigntemplatepublicReferenceid when calling EzsigntemplatepublicResponse., must conform to the pattern /^.{0,36}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($tEzsigntemplatepublicNote) && (!preg_match("/(*UTF8)^.{0,65535}$/", ObjectSerializer::toString($tEzsigntemplatepublicNote)))) {
            //throw new \InvalidArgumentException("invalid value for \$tEzsigntemplatepublicNote when calling EzsigntemplatepublicResponse., must conform to the pattern /^.{0,65535}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($tEzsigntemplatepublicNote)?'null':'"'.$tEzsigntemplatepublicNote.'"')." for tEzsigntemplatepublicNote when calling EzsigntemplatepublicResponse., must conform to the pattern /^.{0,65535}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplatepublicLimit > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatepublicLimit when calling EzsigntemplatepublicResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatepublicLimit)?'null':'"'.$iEzsigntemplatepublicLimit.'"').' for iEzsigntemplatepublicLimit when calling EzsigntemplatepublicResponse., must be smaller than or equal to 65535.');
        }
        //if (($iEzsigntemplatepublicLimit < 0)) {
        if (($iEzsigntemplatepublicLimit < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatepublicLimit when calling EzsigntemplatepublicResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatepublicLimit)?'null':'"'.$iEzsigntemplatepublicLimit.'"').' for iEzsigntemplatepublicLimit when calling EzsigntemplatepublicResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplatepublicLimitexceeded > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatepublicLimitexceeded when calling EzsigntemplatepublicResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatepublicLimitexceeded)?'null':'"'.$iEzsigntemplatepublicLimitexceeded.'"').' for iEzsigntemplatepublicLimitexceeded when calling EzsigntemplatepublicResponse., must be smaller than or equal to 65535.');
        }
        //if (($iEzsigntemplatepublicLimitexceeded < 0)) {
        if (($iEzsigntemplatepublicLimitexceeded < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatepublicLimitexceeded when calling EzsigntemplatepublicResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatepublicLimitexceeded)?'null':'"'.$iEzsigntemplatepublicLimitexceeded.'"').' for iEzsigntemplatepublicLimitexceeded when calling EzsigntemplatepublicResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtEzsigntemplatepublicLimitexceededsince) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtEzsigntemplatepublicLimitexceededsince)))) {
            //throw new \InvalidArgumentException("invalid value for \$dtEzsigntemplatepublicLimitexceededsince when calling EzsigntemplatepublicResponse., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtEzsigntemplatepublicLimitexceededsince)?'null':'"'.$dtEzsigntemplatepublicLimitexceededsince.'"')." for dtEzsigntemplatepublicLimitexceededsince when calling EzsigntemplatepublicResponse., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if ((!preg_match("/^https:\/\/[^\\s\/$.?#].[^\\s]*$/", ObjectSerializer::toString($sEzsigntemplatepublicUrl)))) {
        if (!is_null($sEzsigntemplatepublicUrl) && (!preg_match("/(*UTF8)^https:\/\/[^\\s\/$.?#].[^\\s]*$/", ObjectSerializer::toString($sEzsigntemplatepublicUrl)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatepublicUrl when calling EzsigntemplatepublicResponse., must conform to the pattern /^https:\/\/[^\\s\/$.?#].[^\\s]*$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatepublicUrl)?'null':'"'.$sEzsigntemplatepublicUrl.'"')." for sEzsigntemplatepublicUrl when calling EzsigntemplatepublicResponse., must conform to the pattern /^https:\/\/[^\\s\/$.?#].[^\\s]*$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatepublicEzsigntemplatedescription) && (!preg_match("/(*UTF8)^.{1,80}$/", ObjectSerializer::toString($sEzsigntemplatepublicEzsigntemplatedescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatepublicEzsigntemplatedescription when calling EzsigntemplatepublicResponse., must conform to the pattern /^.{1,80}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatepublicEzsigntemplatedescription)?'null':'"'.$sEzsigntemplatepublicEzsigntemplatedescription.'"')." for sEzsigntemplatepublicEzsigntemplatedescription when calling EzsigntemplatepublicResponse., must conform to the pattern /^.{1,80}$/.");
        }
