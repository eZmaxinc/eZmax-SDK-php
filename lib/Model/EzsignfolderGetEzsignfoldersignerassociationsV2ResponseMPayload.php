...
/**
 * EzsignfolderGetEzsignfoldersignerassociationsV2ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /2/object/ezsignfolder/{pkiEzsignfolder}/getEzsignfoldersignerassociations
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsignfolderGetEzsignfoldersignerassociationsV2ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsignfolder-getEzsignfoldersignerassociations-v2-Response-mPayload';
    ...
    protected static $openAPITypes = [
        'aObjEzsignfoldersignerassociation' => '\eZmaxAPI\Model\CustomEzsignfoldersignerassociationActionableElementResponseV2[]'
    ];
     ...
     *
     * @return \eZmaxAPI\Model\CustomEzsignfoldersignerassociationActionableElementResponseV2[]
     */
     ...
     *
     * @param \eZmaxAPI\Model\CustomEzsignfoldersignerassociationActionableElementResponseV2[] $aObjEzsignfoldersignerassociation aObjEzsignfoldersignerassociation
     *
     * @return self
     */
