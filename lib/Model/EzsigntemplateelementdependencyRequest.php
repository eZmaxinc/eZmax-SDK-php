...
class EzsigntemplateelementdependencyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['pkiEzsigntemplateelementdependencyID']) && ($this->container['pkiEzsigntemplateelementdependencyID'] > 16777215)) {
            $invalidProperties[] = "invalid value for 'pkiEzsigntemplateelementdependencyID', must be smaller than or equal to 16777215.";
        }
        ...
        if (!is_null($this->container['sEzsigntemplateelementdependencyValue']) && !preg_match("/(*UTF8)^.{0,50}$/", $this->container['sEzsigntemplateelementdependencyValue'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsigntemplateelementdependencyValue'])?'null':'"'.$this->container['sEzsigntemplateelementdependencyValue'].'"')." for 'sEzsigntemplateelementdependencyValue', must be conform to the pattern /^.{0,50}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //}
        //if (($pkiEzsigntemplateelementdependencyID > 16777215)) {
        if (!is_null($pkiEzsigntemplateelementdependencyID) && ($pkiEzsigntemplateelementdependencyID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplateelementdependencyID when calling EzsigntemplateelementdependencyRequest., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateelementdependencyID)?'null':'"'.$pkiEzsigntemplateelementdependencyID.'"').' for pkiEzsigntemplateelementdependencyID when calling EzsigntemplateelementdependencyRequest., must be smaller than or equal to 16777215.');
        }
