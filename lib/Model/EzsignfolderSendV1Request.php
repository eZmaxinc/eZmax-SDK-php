...
/**
 * EzsignfolderSendV1Request Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class EzsignfolderSendV1Request implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignfolder-send-v1-Request';
    ...
    {
        $this->container['tExtraMessage'] = isset($data['tExtraMessage']) ? $data['tExtraMessage'] : null;
    }
