 ...
 *
 * @category Class
 * @description Payload for GET /1/object/ezsignbulksend/{pkiEzsignbulksendID}
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class EzsignbulksendGetObjectV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setPkiEzsignbulksendID($pkiEzsignbulksendID)
    {
        ...
        if (($pkiEzsignbulksendID < 0)) {
            throw new \InvalidArgumentException('invalid value for $pkiEzsignbulksendID when calling EzsignbulksendGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setFkiEzsignfoldertypeID($fkiEzsignfoldertypeID)
    {
        ...
        if (($fkiEzsignfoldertypeID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsignbulksendGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
