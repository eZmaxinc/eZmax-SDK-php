...
/**
 * EzsigntemplatepackagesignerCreateObjectV2Request Class Doc Comment
 *
 * @category Class
 * @description Request for POST /2/object/ezsigntemplatepackagesigner
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsigntemplatepackagesignerCreateObjectV2Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplatepackagesigner-createObject-v2-Request';
    ...
    protected static $openAPITypes = [
        'aObjEzsigntemplatepackagesigner' => '\eZmaxAPI\Model\EzsigntemplatepackagesignerRequestCompoundV2[]'
    ];
     ...
     *
     * @param \eZmaxAPI\Model\EzsigntemplatepackagesignerRequestCompoundV2[] $aObjEzsigntemplatepackagesigner aObjEzsigntemplatepackagesigner
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if ((count($aObjEzsigntemplatepackagesigner) < 1)) {
            //throw new \InvalidArgumentException('invalid length for $aObjEzsigntemplatepackagesigner when calling EzsigntemplatepackagesignerCreateObjectV2Request., number of items must be greater than or equal to 1.');
            throw new \InvalidArgumentException('invalid length for aObjEzsigntemplatepackagesigner when calling EzsigntemplatepackagesignerCreateObjectV2Request., number of items must be greater than or equal to 1.');
        }
