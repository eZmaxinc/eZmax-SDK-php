 ...
 * @link     https://openapi-generator.tech
 */
class EzsigndocumentRequestCompound implements ModelInterface, ArrayAccess
{
    ...
    public function setFkiEzsignfolderID($fkiEzsignfolderID)
    {
        ...
        if (($fkiEzsignfolderID < 1)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsignfolderID when calling EzsigndocumentRequestCompound., must be bigger than or equal to 1.');
        }
