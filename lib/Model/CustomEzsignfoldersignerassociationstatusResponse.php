...
class CustomEzsignfoldersignerassociationstatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//if (($fkiEzsignfoldersignerassociationID < 0)) {
        if (($fkiEzsignfoldersignerassociationID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldersignerassociationID when calling CustomEzsignfoldersignerassociationstatusResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationID)?'null':'"'.$fkiEzsignfoldersignerassociationID.'"').' for fkiEzsignfoldersignerassociationID when calling CustomEzsignfoldersignerassociationstatusResponse., must be bigger than or equal to 0.');
        }
