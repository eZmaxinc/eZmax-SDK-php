...
/**
 * UsergroupmembershipRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class UsergroupmembershipRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'usergroupmembership-Request';
    ...
    */
	...
	//if (($pkiUsergroupmembershipID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiUsergroupmembershipID when calling UsergroupmembershipRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupmembershipID)?'null':'"'.$pkiUsergroupmembershipID.'"').' for pkiUsergroupmembershipID when calling UsergroupmembershipRequest., must be smaller than or equal to 65535.');
        }
	//if (($pkiUsergroupmembershipID < 0)) {
        if (!is_null($pkiUsergroupmembershipID) && ($pkiUsergroupmembershipID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiUsergroupmembershipID when calling UsergroupmembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupmembershipID)?'null':'"'.$pkiUsergroupmembershipID.'"').' for pkiUsergroupmembershipID when calling UsergroupmembershipRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUsergroupID > 255)) {
        if (($fkiUsergroupID > 255)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling UsergroupmembershipRequest., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling UsergroupmembershipRequest., must be smaller than or equal to 255.');
        }
	//if (($fkiUsergroupID < 0)) {
        if (($fkiUsergroupID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling UsergroupmembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling UsergroupmembershipRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling UsergroupmembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling UsergroupmembershipRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUsergroupexternalID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupexternalID when calling UsergroupmembershipRequest., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupexternalID)?'null':'"'.$fkiUsergroupexternalID.'"').' for fkiUsergroupexternalID when calling UsergroupmembershipRequest., must be smaller than or equal to 255.');
        }
	//if (($fkiUsergroupexternalID < 0)) {
        if (!is_null($fkiUsergroupexternalID) && ($fkiUsergroupexternalID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupexternalID when calling UsergroupmembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupexternalID)?'null':'"'.$fkiUsergroupexternalID.'"').' for fkiUsergroupexternalID when calling UsergroupmembershipRequest., must be bigger than or equal to 0.');
        }
