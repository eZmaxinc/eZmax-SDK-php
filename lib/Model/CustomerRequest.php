...
class CustomerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//if ((!preg_match("/^.{0,25}$/", ObjectSerializer::toString($sCustomerNote)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sCustomerNote when calling CustomerRequest., must conform to the pattern /^.{0,25}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCustomerNote)?'null':'"'.$sCustomerNote.'"')." for sCustomerNote when calling CustomerRequest., must conform to the pattern /^.{0,25}$/.");
        }
