    ...
    */
	...
	//if (($pkiEzmaxinvoicingsummaryinternalID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzmaxinvoicingsummaryinternalID when calling EzmaxinvoicingsummaryinternalResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzmaxinvoicingsummaryinternalID)?'null':'"'.$pkiEzmaxinvoicingsummaryinternalID.'"').' for pkiEzmaxinvoicingsummaryinternalID when calling EzmaxinvoicingsummaryinternalResponse., must be bigger than or equal to 0.');
        }
	...
	//if ((mb_strlen($sEzmaxinvoicingsummaryinternalDescriptionX) > 70)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzmaxinvoicingsummaryinternalDescriptionX when calling EzmaxinvoicingsummaryinternalResponse., must be smaller than or equal to 70.');
            throw new \InvalidArgumentException('value '.(is_null($sEzmaxinvoicingsummaryinternalDescriptionX)?'null':'"'.$sEzmaxinvoicingsummaryinternalDescriptionX.'"').', invalid length for sEzmaxinvoicingsummaryinternalDescriptionX when calling EzmaxinvoicingsummaryinternalResponse., must be smaller than or equal to 70.');
        }
	...
	//if (($fkiEzmaxinvoicingID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzmaxinvoicingID when calling EzmaxinvoicingsummaryinternalResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxinvoicingID)?'null':'"'.$fkiEzmaxinvoicingID.'"').' for fkiEzmaxinvoicingID when calling EzmaxinvoicingsummaryinternalResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiBillingentityinternalID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiBillingentityinternalID when calling EzmaxinvoicingsummaryinternalResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBillingentityinternalID)?'null':'"'.$fkiBillingentityinternalID.'"').' for fkiBillingentityinternalID when calling EzmaxinvoicingsummaryinternalResponse., must be bigger than or equal to 0.');
        }
