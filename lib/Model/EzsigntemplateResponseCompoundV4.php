...
/**
 * EzsigntemplateResponseCompoundV4 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplateResponseCompoundV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplate-ResponseCompoundV4';
    ...
    protected static $openAPITypes = [
        ...
        'objEzsignfoldertype' => '\eZmaxAPI\Model\CustomEzsignfoldertypeTemplateResponse',
        'fkiLanguageID' => 'int',
        ...
        'aObjEzsigntemplatesigner' => '\eZmaxAPI\Model\EzsigntemplatesignerResponseCompoundV3[]',
        'aObjEzsigntemplateannotation' => '\eZmaxAPI\Model\EzsigntemplateannotationResponseCompound[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'aObjEzsigntemplateannotation' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'aObjEzsigntemplateannotation' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'aObjEzsigntemplateannotation' => 'a_objEzsigntemplateannotation'
    ];
    ...
    protected static $setters = [
        ...
        'aObjEzsigntemplateannotation' => 'setAObjEzsigntemplateannotation'
    ];
    ...
    protected static $getters = [
        ...
        'aObjEzsigntemplateannotation' => 'getAObjEzsigntemplateannotation'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aObjEzsigntemplateannotation', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sEzsigntemplateDescription']) && !preg_match("/(*UTF8)^.{0,80}$/", $this->container['sEzsigntemplateDescription'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsigntemplateDescription'])?'null':'"'.$this->container['sEzsigntemplateDescription'].'"')." for 'sEzsigntemplateDescription', must be conform to the pattern /^.{0,80}$/.";
        }
        ...
        if (!is_null($this->container['sEzsigntemplateExternaldescription']) && !preg_match("/(*UTF8)^.{0,75}$/", $this->container['sEzsigntemplateExternaldescription'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsigntemplateExternaldescription'])?'null':'"'.$this->container['sEzsigntemplateExternaldescription'].'"')." for 'sEzsigntemplateExternaldescription', must be conform to the pattern /^.{0,75}$/.";
        }
        ...
        if (!is_null($this->container['sEzsigntemplateFilenameregexp']) && !preg_match("/(*UTF8)^.{1,50}$/", $this->container['sEzsigntemplateFilenameregexp'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsigntemplateFilenameregexp'])?'null':'"'.$this->container['sEzsigntemplateFilenameregexp'].'"')." for 'sEzsigntemplateFilenameregexp', must be conform to the pattern /^.{1,50}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigntemplateID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplateID when calling EzsigntemplateResponseCompoundV4., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateID)?'null':'"'.$pkiEzsigntemplateID.'"').' for pkiEzsigntemplateID when calling EzsigntemplateResponseCompoundV4., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplatedocumentID) && ($fkiEzsigntemplatedocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatedocumentID when calling EzsigntemplateResponseCompoundV4., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatedocumentID)?'null':'"'.$fkiEzsigntemplatedocumentID.'"').' for fkiEzsigntemplatedocumentID when calling EzsigntemplateResponseCompoundV4., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignfoldertypeID) && ($fkiEzsignfoldertypeID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsigntemplateResponseCompoundV4., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsigntemplateResponseCompoundV4., must be smaller than or equal to 65535.');
        }
        //if (($fkiEzsignfoldertypeID < 0)) {
        if (!is_null($fkiEzsignfoldertypeID) && ($fkiEzsignfoldertypeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsigntemplateResponseCompoundV4., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsigntemplateResponseCompoundV4., must be bigger than or equal to 0.');
        }
     ...
     *
     * @return \eZmaxAPI\Model\CustomEzsignfoldertypeTemplateResponse|null
     */
     ...
     *
     * @param \eZmaxAPI\Model\CustomEzsignfoldertypeTemplateResponse|null $objEzsignfoldertype objEzsignfoldertype
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiLanguageID > 2)) {
        if (($fkiLanguageID > 2)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsigntemplateResponseCompoundV4., must be smaller than or equal to 2.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsigntemplateResponseCompoundV4., must be smaller than or equal to 2.');
        }
        //if (($fkiLanguageID < 1)) {
        if (($fkiLanguageID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsigntemplateResponseCompoundV4., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsigntemplateResponseCompoundV4., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzdoctemplatedocumentID) && ($fkiEzdoctemplatedocumentID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatedocumentID when calling EzsigntemplateResponseCompoundV4., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatedocumentID)?'null':'"'.$fkiEzdoctemplatedocumentID.'"').' for fkiEzdoctemplatedocumentID when calling EzsigntemplateResponseCompoundV4., must be smaller than or equal to 65535.');
        }
        //if (($fkiEzdoctemplatedocumentID < 0)) {
        if (!is_null($fkiEzdoctemplatedocumentID) && ($fkiEzdoctemplatedocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatedocumentID when calling EzsigntemplateResponseCompoundV4., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatedocumentID)?'null':'"'.$fkiEzdoctemplatedocumentID.'"').' for fkiEzdoctemplatedocumentID when calling EzsigntemplateResponseCompoundV4., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzdoctemplatedocumentNameX) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sEzdoctemplatedocumentNameX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzdoctemplatedocumentNameX when calling EzsigntemplateResponseCompoundV4., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzdoctemplatedocumentNameX)?'null':'"'.$sEzdoctemplatedocumentNameX.'"')." for sEzdoctemplatedocumentNameX when calling EzsigntemplateResponseCompoundV4., must conform to the pattern /^.{0,50}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplateDescription) && (!preg_match("/(*UTF8)^.{0,80}$/", ObjectSerializer::toString($sEzsigntemplateDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplateDescription when calling EzsigntemplateResponseCompoundV4., must conform to the pattern /^.{0,80}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplateDescription)?'null':'"'.$sEzsigntemplateDescription.'"')." for sEzsigntemplateDescription when calling EzsigntemplateResponseCompoundV4., must conform to the pattern /^.{0,80}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplateExternaldescription) && (!preg_match("/(*UTF8)^.{0,75}$/", ObjectSerializer::toString($sEzsigntemplateExternaldescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplateExternaldescription when calling EzsigntemplateResponseCompoundV4., must conform to the pattern /^.{0,75}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplateExternaldescription)?'null':'"'.$sEzsigntemplateExternaldescription.'"')." for sEzsigntemplateExternaldescription when calling EzsigntemplateResponseCompoundV4., must conform to the pattern /^.{0,75}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplateFilenameregexp) && (!preg_match("/(*UTF8)^.{1,50}$/", ObjectSerializer::toString($sEzsigntemplateFilenameregexp)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplateFilenameregexp when calling EzsigntemplateResponseCompoundV4., must conform to the pattern /^.{1,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplateFilenameregexp)?'null':'"'.$sEzsigntemplateFilenameregexp.'"')." for sEzsigntemplateFilenameregexp when calling EzsigntemplateResponseCompoundV4., must conform to the pattern /^.{1,50}$/.");
        }
     ...
     *
     * @return \eZmaxAPI\Model\EzsigntemplatesignerResponseCompoundV3[]
     */
     ...
     *
     * @param \eZmaxAPI\Model\EzsigntemplatesignerResponseCompoundV3[] $aObjEzsigntemplatesigner aObjEzsigntemplatesigner
     *
     * @return self
     */
    ...
    /**
     * Gets aObjEzsigntemplateannotation
     *
     * @return \eZmaxAPI\Model\EzsigntemplateannotationResponseCompound[]|null
     */
    public function getAObjEzsigntemplateannotation()
    {
	//return $this->container['aObjEzsigntemplateannotation'];
        return $this->container['aObjEzsigntemplateannotation'];
    }

    /**
     * Sets aObjEzsigntemplateannotation
     *
     * @param \eZmaxAPI\Model\EzsigntemplateannotationResponseCompound[]|null $aObjEzsigntemplateannotation aObjEzsigntemplateannotation
     *
     * @return self
     */
    public function setAObjEzsigntemplateannotation($aObjEzsigntemplateannotation)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjEzsigntemplateannotation)) {
            //throw new \InvalidArgumentException('non-nullable aObjEzsigntemplateannotation cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjEzsigntemplateannotation'] = $aObjEzsigntemplateannotation;
        $this->container['aObjEzsigntemplateannotation'] = $aObjEzsigntemplateannotation;
