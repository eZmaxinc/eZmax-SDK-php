...
/**
 * EzsignfoldersignerassociationCreateObjectV2ResponseMPayload Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignfoldersignerassociationCreateObjectV2ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignfoldersignerassociation-createObject-v2-Response-mPayload';
...
//        if ((count($aPkiEzsignfoldersignerassociationID) < 1)) {
        if ((count($aPkiEzsignfoldersignerassociationID) < 1)) {
            throw new \InvalidArgumentException('invalid length for $aPkiEzsignfoldersignerassociationID when calling EzsignfoldersignerassociationCreateObjectV2ResponseMPayload., number of items must be greater than or equal to 1.');
        }
