...
/**
 * AttachmentlogResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class AttachmentlogResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'attachmentlog-Response';
    ...
    */
	...
	//if (!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", $this->container['dtAttachmentlogDatetime'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'dtAttachmentlogDatetime', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtAttachmentlogDatetime'])?'null':'"'.$this->container['dtAttachmentlogDatetime'].'"')." for 'dtAttachmentlogDatetime', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
        }
	...
	//if (!is_null($this->container['sAttachmentlogDetail']) && !preg_match("/^.{0,75}$/", $this->container['sAttachmentlogDetail'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sAttachmentlogDetail', must be conform to the pattern /^.{0,75}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sAttachmentlogDetail'])?'null':'"'.$this->container['sAttachmentlogDetail'].'"')." for 'sAttachmentlogDetail', must be conform to the pattern /^.{0,75}$/.";
        }
	...
	//if (($fkiAttachmentID < 0)) {
        if (($fkiAttachmentID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiAttachmentID when calling AttachmentlogResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAttachmentID)?'null':'"'.$fkiAttachmentID.'"').' for fkiAttachmentID when calling AttachmentlogResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserID < 0)) {
        if (($fkiUserID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling AttachmentlogResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling AttachmentlogResponse., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtAttachmentlogDatetime)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dtAttachmentlogDatetime when calling AttachmentlogResponse., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtAttachmentlogDatetime)?'null':'"'.$dtAttachmentlogDatetime.'"')." for dtAttachmentlogDatetime when calling AttachmentlogResponse., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
	...
	//if ((!preg_match("/^.{0,75}$/", ObjectSerializer::toString($sAttachmentlogDetail)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sAttachmentlogDetail when calling AttachmentlogResponse., must conform to the pattern /^.{0,75}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sAttachmentlogDetail)?'null':'"'.$sAttachmentlogDetail.'"')." for sAttachmentlogDetail when calling AttachmentlogResponse., must conform to the pattern /^.{0,75}$/.");
        }
