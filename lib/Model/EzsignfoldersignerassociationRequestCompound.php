 ...
 * @link     https://openapi-generator.tech
 */
class EzsignfoldersignerassociationRequestCompound implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['objEzsignsigner'] = isset($data['objEzsignsigner']) ? $data['objEzsignsigner'] : null;
