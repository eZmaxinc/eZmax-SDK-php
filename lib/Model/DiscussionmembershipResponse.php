...
/**
 * DiscussionmembershipResponse Class Doc Comment
 *
 * @category Class
 * @description A Discussionmembership Object
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DiscussionmembershipResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'discussionmembership-Response';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sDiscussionmembershipDescription']) && !preg_match("/(*UTF8)^.{0,100}$/", $this->container['sDiscussionmembershipDescription'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sDiscussionmembershipDescription'])?'null':'"'.$this->container['sDiscussionmembershipDescription'].'"')." for 'sDiscussionmembershipDescription', must be conform to the pattern /^.{0,100}$/.";
        }
        ...
        if (!is_null($this->container['dtDiscussionmembershipJoined']) && !preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", $this->container['dtDiscussionmembershipJoined'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtDiscussionmembershipJoined'])?'null':'"'.$this->container['dtDiscussionmembershipJoined'].'"')." for 'dtDiscussionmembershipJoined', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiDiscussionmembershipID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $pkiDiscussionmembershipID when calling DiscussionmembershipResponse., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiDiscussionmembershipID)?'null':'"'.$pkiDiscussionmembershipID.'"').' for pkiDiscussionmembershipID when calling DiscussionmembershipResponse., must be smaller than or equal to 16777215.');
        }
        //if (($pkiDiscussionmembershipID < 0)) {
        if (($pkiDiscussionmembershipID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiDiscussionmembershipID when calling DiscussionmembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiDiscussionmembershipID)?'null':'"'.$pkiDiscussionmembershipID.'"').' for pkiDiscussionmembershipID when calling DiscussionmembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiDiscussionID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDiscussionID when calling DiscussionmembershipResponse., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDiscussionID)?'null':'"'.$fkiDiscussionID.'"').' for fkiDiscussionID when calling DiscussionmembershipResponse., must be smaller than or equal to 16777215.');
        }
        //if (($fkiDiscussionID < 0)) {
        if (($fkiDiscussionID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDiscussionID when calling DiscussionmembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDiscussionID)?'null':'"'.$fkiDiscussionID.'"').' for fkiDiscussionID when calling DiscussionmembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUserID) && ($fkiUserID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling DiscussionmembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling DiscussionmembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling DiscussionmembershipResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling DiscussionmembershipResponse., must be smaller than or equal to 255.');
        }
        //if (($fkiUsergroupID < 0)) {
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling DiscussionmembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling DiscussionmembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiModulesectionID) && ($fkiModulesectionID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiModulesectionID when calling DiscussionmembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiModulesectionID)?'null':'"'.$fkiModulesectionID.'"').' for fkiModulesectionID when calling DiscussionmembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sDiscussionmembershipDescription) && (!preg_match("/(*UTF8)^.{0,100}$/", ObjectSerializer::toString($sDiscussionmembershipDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sDiscussionmembershipDescription when calling DiscussionmembershipResponse., must conform to the pattern /^.{0,100}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sDiscussionmembershipDescription)?'null':'"'.$sDiscussionmembershipDescription.'"')." for sDiscussionmembershipDescription when calling DiscussionmembershipResponse., must conform to the pattern /^.{0,100}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtDiscussionmembershipJoined) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtDiscussionmembershipJoined)))) {
            //throw new \InvalidArgumentException("invalid value for \$dtDiscussionmembershipJoined when calling DiscussionmembershipResponse., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtDiscussionmembershipJoined)?'null':'"'.$dtDiscussionmembershipJoined.'"')." for dtDiscussionmembershipJoined when calling DiscussionmembershipResponse., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
