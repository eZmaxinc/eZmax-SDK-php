...
class CustomCreditcardtransactionresponseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sCreditcardtransactionISOcode']) && !preg_match("/(*UTF8)^.{1,2}$/", $this->container['sCreditcardtransactionISOcode'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sCreditcardtransactionISOcode'])?'null':'"'.$this->container['sCreditcardtransactionISOcode'].'"')." for 'sCreditcardtransactionISOcode', must be conform to the pattern /^.{1,2}$/.";
        }
        ...
        if (!is_null($this->container['sCreditcardtransactionResponsecode']) && !preg_match("/(*UTF8)^.{1,3}$/", $this->container['sCreditcardtransactionResponsecode'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sCreditcardtransactionResponsecode'])?'null':'"'.$this->container['sCreditcardtransactionResponsecode'].'"')." for 'sCreditcardtransactionResponsecode', must be conform to the pattern /^.{1,3}$/.";
        }
        ...
        if (!is_null($this->container['sCreditcardtransactionResponseterminalmessage']) && !preg_match("/(*UTF8)^.{0,50}$/", $this->container['sCreditcardtransactionResponseterminalmessage'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sCreditcardtransactionResponseterminalmessage'])?'null':'"'.$this->container['sCreditcardtransactionResponseterminalmessage'].'"')." for 'sCreditcardtransactionResponseterminalmessage', must be conform to the pattern /^.{0,50}$/.";
        }
