...
/**
 * EzsignbulksendsignermappingGetObjectV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /1/object/ezsignbulksendsignermapping/{pkiEzsignbulksendsignermappingID}
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsignbulksendsignermappingGetObjectV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignbulksendsignermapping-getObject-v1-Response-mPayload';
    ...
    public function setPkiEzsignbulksendsignermappingID($pkiEzsignbulksendsignermappingID)
    {
        ...
        if (($pkiEzsignbulksendsignermappingID < 0)) {
            throw new \InvalidArgumentException('invalid value for $pkiEzsignbulksendsignermappingID when calling EzsignbulksendsignermappingGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setFkiEzsignbulksendID($fkiEzsignbulksendID)
    {
        ...
        if (($fkiEzsignbulksendID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsignbulksendID when calling EzsignbulksendsignermappingGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setFkiUserID($fkiUserID)
    {
        ...
        if (!is_null($fkiUserID) && ($fkiUserID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiUserID when calling EzsignbulksendsignermappingGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
