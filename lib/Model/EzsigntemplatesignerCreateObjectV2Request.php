...
/**
 * EzsigntemplatesignerCreateObjectV2Request Class Doc Comment
 *
 * @category Class
 * @description Request for POST /2/object/ezsigntemplatesigner
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsigntemplatesignerCreateObjectV2Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplatesigner-createObject-v2-Request';
    ...
    protected static $openAPITypes = [
        'aObjEzsigntemplatesigner' => '\eZmaxAPI\Model\EzsigntemplatesignerRequestCompoundV2[]'
    ];
     ...
     *
     * @param \eZmaxAPI\Model\EzsigntemplatesignerRequestCompoundV2[] $aObjEzsigntemplatesigner aObjEzsigntemplatesigner
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if ((count($aObjEzsigntemplatesigner) < 1)) {
            //throw new \InvalidArgumentException('invalid length for $aObjEzsigntemplatesigner when calling EzsigntemplatesignerCreateObjectV2Request., number of items must be greater than or equal to 1.');
            throw new \InvalidArgumentException('invalid length for aObjEzsigntemplatesigner when calling EzsigntemplatesignerCreateObjectV2Request., number of items must be greater than or equal to 1.');
        }
