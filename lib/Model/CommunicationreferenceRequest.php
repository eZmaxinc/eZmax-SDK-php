    ...
    */
	...
	//if (($pkiCommunicationreferenceID > 4294967295)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiCommunicationreferenceID when calling CommunicationreferenceRequest., must be smaller than or equal to 4294967295.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCommunicationreferenceID)?'null':'"'.$pkiCommunicationreferenceID.'"').' for pkiCommunicationreferenceID when calling CommunicationreferenceRequest., must be smaller than or equal to 4294967295.');
        }
	//if (($pkiCommunicationreferenceID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiCommunicationreferenceID when calling CommunicationreferenceRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCommunicationreferenceID)?'null':'"'.$pkiCommunicationreferenceID.'"').' for pkiCommunicationreferenceID when calling CommunicationreferenceRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiBuyercontractID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiBuyercontractID when calling CommunicationreferenceRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBuyercontractID)?'null':'"'.$fkiBuyercontractID.'"').' for fkiBuyercontractID when calling CommunicationreferenceRequest., must be smaller than or equal to 65535.');
        }
	//if (($fkiBuyercontractID < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiBuyercontractID when calling CommunicationreferenceRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBuyercontractID)?'null':'"'.$fkiBuyercontractID.'"').' for fkiBuyercontractID when calling CommunicationreferenceRequest., must be bigger than or equal to 1.');
        }
	...
	//if (($fkiEzsignfolderID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfolderID when calling CommunicationreferenceRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfolderID)?'null':'"'.$fkiEzsignfolderID.'"').' for fkiEzsignfolderID when calling CommunicationreferenceRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiInscriptionID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiInscriptionID when calling CommunicationreferenceRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiInscriptionID)?'null':'"'.$fkiInscriptionID.'"').' for fkiInscriptionID when calling CommunicationreferenceRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiInscriptiontempID > 16777215)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiInscriptiontempID when calling CommunicationreferenceRequest., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiInscriptiontempID)?'null':'"'.$fkiInscriptiontempID.'"').' for fkiInscriptiontempID when calling CommunicationreferenceRequest., must be smaller than or equal to 16777215.');
        }
	//if (($fkiInscriptiontempID < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiInscriptiontempID when calling CommunicationreferenceRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiInscriptiontempID)?'null':'"'.$fkiInscriptiontempID.'"').' for fkiInscriptiontempID when calling CommunicationreferenceRequest., must be bigger than or equal to 1.');
        }
	...
	//if (($fkiInvoiceID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiInvoiceID when calling CommunicationreferenceRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiInvoiceID)?'null':'"'.$fkiInvoiceID.'"').' for fkiInvoiceID when calling CommunicationreferenceRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiOtherincomeID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiOtherincomeID when calling CommunicationreferenceRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiOtherincomeID)?'null':'"'.$fkiOtherincomeID.'"').' for fkiOtherincomeID when calling CommunicationreferenceRequest., must be smaller than or equal to 65535.');
        }
	//if (($fkiOtherincomeID < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiOtherincomeID when calling CommunicationreferenceRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiOtherincomeID)?'null':'"'.$fkiOtherincomeID.'"').' for fkiOtherincomeID when calling CommunicationreferenceRequest., must be bigger than or equal to 1.');
        }
	...
	//if (($fkiElectronicfundstransferID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiElectronicfundstransferID when calling CommunicationreferenceRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiElectronicfundstransferID)?'null':'"'.$fkiElectronicfundstransferID.'"').' for fkiElectronicfundstransferID when calling CommunicationreferenceRequest., must be smaller than or equal to 65535.');
        }
	//if (($fkiElectronicfundstransferID < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiElectronicfundstransferID when calling CommunicationreferenceRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiElectronicfundstransferID)?'null':'"'.$fkiElectronicfundstransferID.'"').' for fkiElectronicfundstransferID when calling CommunicationreferenceRequest., must be bigger than or equal to 1.');
        }
	...
	//if (($fkiRejectedoffertopurchaseID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiRejectedoffertopurchaseID when calling CommunicationreferenceRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiRejectedoffertopurchaseID)?'null':'"'.$fkiRejectedoffertopurchaseID.'"').' for fkiRejectedoffertopurchaseID when calling CommunicationreferenceRequest., must be smaller than or equal to 65535.');
        }
	//if (($fkiRejectedoffertopurchaseID < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiRejectedoffertopurchaseID when calling CommunicationreferenceRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiRejectedoffertopurchaseID)?'null':'"'.$fkiRejectedoffertopurchaseID.'"').' for fkiRejectedoffertopurchaseID when calling CommunicationreferenceRequest., must be bigger than or equal to 1.');
        }
