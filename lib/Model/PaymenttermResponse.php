...
/**
 * PaymenttermResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymenttermResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'paymentterm-Response';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sPaymenttermCode) && (!preg_match("/(*UTF8)^[A-Z0-9]{1,4}$/", ObjectSerializer::toString($sPaymenttermCode)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sPaymenttermCode)?'null':'"'.$sPaymenttermCode.'"')." for sPaymenttermCode when calling PaymenttermResponse., must conform to the pattern /^[A-Z0-9]{1,4}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iPaymenttermDay > 255)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iPaymenttermDay)?'null':'"'.$iPaymenttermDay.'"').' for iPaymenttermDay when calling PaymenttermResponse., must be smaller than or equal to 255.');
        }
        ...
        if (($iPaymenttermDay < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iPaymenttermDay)?'null':'"'.$iPaymenttermDay.'"').' for iPaymenttermDay when calling PaymenttermResponse., must be bigger than or equal to 0.');
        }
