    ...
    */
	...
	//if (($pkiEzsignformfieldID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignformfieldID when calling EzsignformfieldRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignformfieldID)?'null':'"'.$pkiEzsignformfieldID.'"').' for pkiEzsignformfieldID when calling EzsignformfieldRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignpagePagenumber < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignpagePagenumber when calling EzsignformfieldRequestCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignpagePagenumber)?'null':'"'.$iEzsignpagePagenumber.'"').' for iEzsignpagePagenumber when calling EzsignformfieldRequestCompound., must be bigger than or equal to 1.');
        }
	...
	//if (($iEzsignformfieldX < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldX when calling EzsignformfieldRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldX)?'null':'"'.$iEzsignformfieldX.'"').' for iEzsignformfieldX when calling EzsignformfieldRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignformfieldY < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldY when calling EzsignformfieldRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldY)?'null':'"'.$iEzsignformfieldY.'"').' for iEzsignformfieldY when calling EzsignformfieldRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignformfieldWidth < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldWidth when calling EzsignformfieldRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldWidth)?'null':'"'.$iEzsignformfieldWidth.'"').' for iEzsignformfieldWidth when calling EzsignformfieldRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignformfieldHeight < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldHeight when calling EzsignformfieldRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldHeight)?'null':'"'.$iEzsignformfieldHeight.'"').' for iEzsignformfieldHeight when calling EzsignformfieldRequestCompound., must be bigger than or equal to 0.');
        }
