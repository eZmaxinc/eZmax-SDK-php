    ...
    */
	...
	//if (($pkiPermissionID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiPermissionID when calling PermissionResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiPermissionID)?'null':'"'.$pkiPermissionID.'"').' for pkiPermissionID when calling PermissionResponse., must be smaller than or equal to 65535.');
        }
	//if (($pkiPermissionID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiPermissionID when calling PermissionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiPermissionID)?'null':'"'.$pkiPermissionID.'"').' for pkiPermissionID when calling PermissionResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling PermissionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling PermissionResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiApikeyID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiApikeyID when calling PermissionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiApikeyID)?'null':'"'.$fkiApikeyID.'"').' for fkiApikeyID when calling PermissionResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUsergroupID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling PermissionResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling PermissionResponse., must be smaller than or equal to 255.');
        }
	//if (($fkiUsergroupID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling PermissionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling PermissionResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiCompanyID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiCompanyID when calling PermissionResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCompanyID)?'null':'"'.$fkiCompanyID.'"').' for fkiCompanyID when calling PermissionResponse., must be smaller than or equal to 255.');
        }
	//if (($fkiCompanyID < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiCompanyID when calling PermissionResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCompanyID)?'null':'"'.$fkiCompanyID.'"').' for fkiCompanyID when calling PermissionResponse., must be bigger than or equal to 1.');
        }
	...
	//if (($fkiModulesectionID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiModulesectionID when calling PermissionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiModulesectionID)?'null':'"'.$fkiModulesectionID.'"').' for fkiModulesectionID when calling PermissionResponse., must be bigger than or equal to 0.');
        }
