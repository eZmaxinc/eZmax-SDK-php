...
/**
 * EzsignfoldersignerassociationRequestV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignfoldersignerassociationRequestV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsignfoldersignerassociation-RequestV2';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzsignfoldersignerassociationID) && ($pkiEzsignfoldersignerassociationID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsignfoldersignerassociationID when calling EzsignfoldersignerassociationRequestV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignfoldersignerassociationID)?'null':'"'.$pkiEzsignfoldersignerassociationID.'"').' for pkiEzsignfoldersignerassociationID when calling EzsignfoldersignerassociationRequestV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUserID) && ($fkiUserID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling EzsignfoldersignerassociationRequestV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling EzsignfoldersignerassociationRequestV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignsignergroupID) && ($fkiEzsignsignergroupID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignsignergroupID when calling EzsignfoldersignerassociationRequestV2., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsignergroupID)?'null':'"'.$fkiEzsignsignergroupID.'"').' for fkiEzsignsignergroupID when calling EzsignfoldersignerassociationRequestV2., must be smaller than or equal to 65535.');
        }
        //if (($fkiEzsignsignergroupID < 0)) {
        if (!is_null($fkiEzsignsignergroupID) && ($fkiEzsignsignergroupID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignsignergroupID when calling EzsignfoldersignerassociationRequestV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsignergroupID)?'null':'"'.$fkiEzsignsignergroupID.'"').' for fkiEzsignsignergroupID when calling EzsignfoldersignerassociationRequestV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsignfolderID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfolderID when calling EzsignfoldersignerassociationRequestV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfolderID)?'null':'"'.$fkiEzsignfolderID.'"').' for fkiEzsignfolderID when calling EzsignfoldersignerassociationRequestV2., must be bigger than or equal to 0.');
        }
