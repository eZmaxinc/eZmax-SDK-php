...
/**
 * EzdoctemplatedocumentListElement Class Doc Comment
 *
 * @category Class
 ...
 */
class EzdoctemplatedocumentListElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezdoctemplatedocument-ListElement';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['fkiEzdoctemplatefieldtypecategoryID']) && ($this->container['fkiEzdoctemplatefieldtypecategoryID'] > 255)) {
            $invalidProperties[] = "invalid value for 'fkiEzdoctemplatefieldtypecategoryID', must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['fkiEzdoctemplatefieldtypecategoryID']) && ($this->container['fkiEzdoctemplatefieldtypecategoryID'] < 0)) {
            $invalidProperties[] = "invalid value for 'fkiEzdoctemplatefieldtypecategoryID', must be bigger than or equal to 0.";
        }

        //if (!is_null($this->container['sEzdoctemplatetypeDescriptionX']) && !preg_match("/^.{0,50}$/", $this->container['sEzdoctemplatetypeDescriptionX'])) {
        if (!is_null($this->container['sEzdoctemplatetypeDescriptionX']) && !preg_match("/(*UTF8)^.{0,50}$/", $this->container['sEzdoctemplatetypeDescriptionX'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzdoctemplatetypeDescriptionX'])?'null':'"'.$this->container['sEzdoctemplatetypeDescriptionX'].'"')." for 'sEzdoctemplatetypeDescriptionX', must be conform to the pattern /^.{0,50}$/.";
        }

        //if (!is_null($this->container['sEzdoctemplatefieldtypecategoryDescriptionX']) && !preg_match("/^.{0,55}$/", $this->container['sEzdoctemplatefieldtypecategoryDescriptionX'])) {
        if (!is_null($this->container['sEzdoctemplatefieldtypecategoryDescriptionX']) && !preg_match("/(*UTF8)^.{0,55}$/", $this->container['sEzdoctemplatefieldtypecategoryDescriptionX'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzdoctemplatefieldtypecategoryDescriptionX'])?'null':'"'.$this->container['sEzdoctemplatefieldtypecategoryDescriptionX'].'"')." for 'sEzdoctemplatefieldtypecategoryDescriptionX', must be conform to the pattern /^.{0,55}$/.";
        }

        if ($this->container['bEzdoctemplatedocumentIsactive'] === null) {
            $invalidProperties[] = "'bEzdoctemplatedocumentIsactive' can't be null";
        }
        if ($this->container['sEzdoctemplatedocumentNameX'] === null) {
            $invalidProperties[] = "'sEzdoctemplatedocumentNameX' can't be null";
        }
        //if (!preg_match("/^.{0,50}$/", $this->container['sEzdoctemplatedocumentNameX'])) {
        if (!is_null($this->container['sEzdoctemplatedocumentNameX']) && !preg_match("/(*UTF8)^.{0,50}$/", $this->container['sEzdoctemplatedocumentNameX'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzdoctemplatedocumentNameX'])?'null':'"'.$this->container['sEzdoctemplatedocumentNameX'].'"')." for 'sEzdoctemplatedocumentNameX', must be conform to the pattern /^.{0,50}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzdoctemplatedocumentID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzdoctemplatedocumentID when calling EzdoctemplatedocumentListElement., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzdoctemplatedocumentID)?'null':'"'.$pkiEzdoctemplatedocumentID.'"').' for pkiEzdoctemplatedocumentID when calling EzdoctemplatedocumentListElement., must be smaller than or equal to 65535.');
        }
        //if (($pkiEzdoctemplatedocumentID < 0)) {
        if (($pkiEzdoctemplatedocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzdoctemplatedocumentID when calling EzdoctemplatedocumentListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzdoctemplatedocumentID)?'null':'"'.$pkiEzdoctemplatedocumentID.'"').' for pkiEzdoctemplatedocumentID when calling EzdoctemplatedocumentListElement., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiLanguageID > 2)) {
        if (($fkiLanguageID > 2)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzdoctemplatedocumentListElement., must be smaller than or equal to 2.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzdoctemplatedocumentListElement., must be smaller than or equal to 2.');
        }
        //if (($fkiLanguageID < 1)) {
        if (($fkiLanguageID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzdoctemplatedocumentListElement., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzdoctemplatedocumentListElement., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignfoldertypeID) && ($fkiEzsignfoldertypeID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzdoctemplatedocumentListElement., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzdoctemplatedocumentListElement., must be smaller than or equal to 65535.');
        }
        //if (($fkiEzsignfoldertypeID < 0)) {
        if (!is_null($fkiEzsignfoldertypeID) && ($fkiEzsignfoldertypeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzdoctemplatedocumentListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzdoctemplatedocumentListElement., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzdoctemplatetypeID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatetypeID when calling EzdoctemplatedocumentListElement., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatetypeID)?'null':'"'.$fkiEzdoctemplatetypeID.'"').' for fkiEzdoctemplatetypeID when calling EzdoctemplatedocumentListElement., must be smaller than or equal to 255.');
        }
        //if (($fkiEzdoctemplatetypeID < 0)) {
        if (($fkiEzdoctemplatetypeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatetypeID when calling EzdoctemplatedocumentListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatetypeID)?'null':'"'.$fkiEzdoctemplatetypeID.'"').' for fkiEzdoctemplatetypeID when calling EzdoctemplatedocumentListElement., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param int|null $fkiEzdoctemplatefieldtypecategoryID The unique ID of the Ezdoctemplatefieldtypecategory
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzdoctemplatefieldtypecategoryID) && ($fkiEzdoctemplatefieldtypecategoryID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatefieldtypecategoryID when calling EzdoctemplatedocumentListElement., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatefieldtypecategoryID)?'null':'"'.$fkiEzdoctemplatefieldtypecategoryID.'"').' for fkiEzdoctemplatefieldtypecategoryID when calling EzdoctemplatedocumentListElement., must be smaller than or equal to 255.');
        }
        //if (($fkiEzdoctemplatefieldtypecategoryID < 0)) {
        if (!is_null($fkiEzdoctemplatefieldtypecategoryID) && ($fkiEzdoctemplatefieldtypecategoryID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatefieldtypecategoryID when calling EzdoctemplatedocumentListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatefieldtypecategoryID)?'null':'"'.$fkiEzdoctemplatefieldtypecategoryID.'"').' for fkiEzdoctemplatefieldtypecategoryID when calling EzdoctemplatedocumentListElement., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $sEzdoctemplatetypeDescriptionX The description of the Ezdoctemplatetype in the language of the requester
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzdoctemplatetypeDescriptionX) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sEzdoctemplatetypeDescriptionX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzdoctemplatetypeDescriptionX when calling EzdoctemplatedocumentListElement., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzdoctemplatetypeDescriptionX)?'null':'"'.$sEzdoctemplatetypeDescriptionX.'"')." for sEzdoctemplatetypeDescriptionX when calling EzdoctemplatedocumentListElement., must conform to the pattern /^.{0,50}$/.");
        }
     ...
     *
     * @param string|null $sEzdoctemplatefieldtypecategoryDescriptionX The description of the Ezdoctemplatefieldtypecategory in the language of the requester
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzdoctemplatefieldtypecategoryDescriptionX) && (!preg_match("/(*UTF8)^.{0,55}$/", ObjectSerializer::toString($sEzdoctemplatefieldtypecategoryDescriptionX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzdoctemplatefieldtypecategoryDescriptionX when calling EzdoctemplatedocumentListElement., must conform to the pattern /^.{0,55}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzdoctemplatefieldtypecategoryDescriptionX)?'null':'"'.$sEzdoctemplatefieldtypecategoryDescriptionX.'"')." for sEzdoctemplatefieldtypecategoryDescriptionX when calling EzdoctemplatedocumentListElement., must conform to the pattern /^.{0,55}$/.");
        }
     ...
     *
     * @param string $sEzdoctemplatedocumentNameX The name of the Ezdoctemplatedocument in the language of the requester
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzdoctemplatedocumentNameX) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sEzdoctemplatedocumentNameX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzdoctemplatedocumentNameX when calling EzdoctemplatedocumentListElement., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzdoctemplatedocumentNameX)?'null':'"'.$sEzdoctemplatedocumentNameX.'"')." for sEzdoctemplatedocumentNameX when calling EzdoctemplatedocumentListElement., must conform to the pattern /^.{0,50}$/.");
        }
