...
/**
 * PaymenttermCreateObjectV1Request Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymenttermCreateObjectV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'paymentterm-createObject-v1-Request';
    ...
    protected static $openAPITypes = [
        'aObjPaymentterm' => '\eZmaxAPI\Model\PaymenttermRequestCompound[]'
    ];
...
//        if ((count($this->container['aObjPaymentterm']) < 1)) {
     ...
     *
     * @param \eZmaxAPI\Model\PaymenttermRequestCompound[] $aObjPaymentterm aObjPaymentterm
     *
     * @return self
     */
