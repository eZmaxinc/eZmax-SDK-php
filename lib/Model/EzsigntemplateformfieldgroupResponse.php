...
/**
 * EzsigntemplateformfieldgroupResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplateformfieldgroupResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplateformfieldgroup-Response';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigntemplateformfieldgroupID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplateformfieldgroupID when calling EzsigntemplateformfieldgroupResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateformfieldgroupID)?'null':'"'.$pkiEzsigntemplateformfieldgroupID.'"').' for pkiEzsigntemplateformfieldgroupID when calling EzsigntemplateformfieldgroupResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigntemplatedocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatedocumentID when calling EzsigntemplateformfieldgroupResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatedocumentID)?'null':'"'.$fkiEzsigntemplatedocumentID.'"').' for fkiEzsigntemplatedocumentID when calling EzsigntemplateformfieldgroupResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if ((mb_strlen($sEzsigntemplateformfieldgroupLabel) > 50)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsigntemplateformfieldgroupLabel when calling EzsigntemplateformfieldgroupResponse., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsigntemplateformfieldgroupLabel)?'null':'"'.$sEzsigntemplateformfieldgroupLabel.'"').', invalid length for sEzsigntemplateformfieldgroupLabel when calling EzsigntemplateformfieldgroupResponse., must be smaller than or equal to 50.');
        }
        //if ((mb_strlen($sEzsigntemplateformfieldgroupLabel) < 1)) {
        if ((mb_strlen($sEzsigntemplateformfieldgroupLabel) < 1)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsigntemplateformfieldgroupLabel when calling EzsigntemplateformfieldgroupResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsigntemplateformfieldgroupLabel)?'null':'"'.$sEzsigntemplateformfieldgroupLabel.'"').', invalid length for sEzsigntemplateformfieldgroupLabel when calling EzsigntemplateformfieldgroupResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplateformfieldgroupStep < 1)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldgroupStep when calling EzsigntemplateformfieldgroupResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldgroupStep)?'null':'"'.$iEzsigntemplateformfieldgroupStep.'"').' for iEzsigntemplateformfieldgroupStep when calling EzsigntemplateformfieldgroupResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplateformfieldgroupFilledmin < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldgroupFilledmin when calling EzsigntemplateformfieldgroupResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldgroupFilledmin)?'null':'"'.$iEzsigntemplateformfieldgroupFilledmin.'"').' for iEzsigntemplateformfieldgroupFilledmin when calling EzsigntemplateformfieldgroupResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplateformfieldgroupFilledmax < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldgroupFilledmax when calling EzsigntemplateformfieldgroupResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldgroupFilledmax)?'null':'"'.$iEzsigntemplateformfieldgroupFilledmax.'"').' for iEzsigntemplateformfieldgroupFilledmax when calling EzsigntemplateformfieldgroupResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplateformfieldgroupMaxlength) && ($iEzsigntemplateformfieldgroupMaxlength > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldgroupMaxlength when calling EzsigntemplateformfieldgroupResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldgroupMaxlength)?'null':'"'.$iEzsigntemplateformfieldgroupMaxlength.'"').' for iEzsigntemplateformfieldgroupMaxlength when calling EzsigntemplateformfieldgroupResponse., must be smaller than or equal to 65535.');
        }
        ...
        if (!is_null($iEzsigntemplateformfieldgroupMaxlength) && ($iEzsigntemplateformfieldgroupMaxlength < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldgroupMaxlength when calling EzsigntemplateformfieldgroupResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldgroupMaxlength)?'null':'"'.$iEzsigntemplateformfieldgroupMaxlength.'"').' for iEzsigntemplateformfieldgroupMaxlength when calling EzsigntemplateformfieldgroupResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplateformfieldgroupRegexp) && (!preg_match("/(*UTF8)^\\^.*\\$$|^$/", ObjectSerializer::toString($sEzsigntemplateformfieldgroupRegexp)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplateformfieldgroupRegexp when calling EzsigntemplateformfieldgroupResponse., must conform to the pattern /^\\^.*\\$$|^$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplateformfieldgroupRegexp)?'null':'"'.$sEzsigntemplateformfieldgroupRegexp.'"')." for sEzsigntemplateformfieldgroupRegexp when calling EzsigntemplateformfieldgroupResponse., must conform to the pattern /^\\^.*\\$$|^$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplateformfieldgroupTextvalidationcustommessage) && (mb_strlen($sEzsigntemplateformfieldgroupTextvalidationcustommessage) < 0)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsigntemplateformfieldgroupTextvalidationcustommessage when calling EzsigntemplateformfieldgroupResponse., must be bigger than or equal to 0.');
