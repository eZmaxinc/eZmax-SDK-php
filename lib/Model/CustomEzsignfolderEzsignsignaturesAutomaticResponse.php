...
/**
 * CustomEzsignfolderEzsignsignaturesAutomaticResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomEzsignfolderEzsignsignaturesAutomaticResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Custom-EzsignfolderEzsignsignaturesAutomatic-Response';
    ...
    protected static $openAPITypes = [
        ...
        'aObjEzsigndocument' => '\eZmaxAPI\Model\CustomEzsigndocumentEzsignsignaturesAutomaticResponse[]'
    ];
    ...
    */
	...
	//if (($pkiEzsignfolderID < 0)) {
        if (($pkiEzsignfolderID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignfolderID when calling CustomEzsignfolderEzsignsignaturesAutomaticResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignfolderID)?'null':'"'.$pkiEzsignfolderID.'"').' for pkiEzsignfolderID when calling CustomEzsignfolderEzsignsignaturesAutomaticResponse., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{0,75}$/", ObjectSerializer::toString($sEzsignfolderDescription)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsignfolderDescription when calling CustomEzsignfolderEzsignsignaturesAutomaticResponse., must conform to the pattern /^.{0,75}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignfolderDescription)?'null':'"'.$sEzsignfolderDescription.'"')." for sEzsignfolderDescription when calling CustomEzsignfolderEzsignsignaturesAutomaticResponse., must conform to the pattern /^.{0,75}$/.");
        }
     ...
     *
     * @return \eZmaxAPI\Model\CustomEzsigndocumentEzsignsignaturesAutomaticResponse[]
     */
     ...
     *
     * @param \eZmaxAPI\Model\CustomEzsigndocumentEzsignsignaturesAutomaticResponse[] $aObjEzsigndocument aObjEzsigndocument
     *
     * @return self
     */
