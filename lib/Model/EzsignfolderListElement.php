...
class EzsignfolderListElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'fkiEzsignbulksendtransmissionID' => 'int',
        'sEzsignbulksendtransmissionDescription' => 'string',
        'fkiEzsigntemplatepublicID' => 'int',
        'sEzsigntemplatepublicDescription' => 'string',
        'eEzsignfolderSource' => '\eZmaxAPI\Model\FieldEEzsignfolderSource',
    ...
    protected static $openAPIFormats = [
        ...
        'fkiEzsignbulksendtransmissionID' => null,
        'sEzsignbulksendtransmissionDescription' => null,
        'fkiEzsigntemplatepublicID' => null,
        'sEzsigntemplatepublicDescription' => null,
        'eEzsignfolderSource' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'fkiEzsignbulksendtransmissionID' => false,
        'sEzsignbulksendtransmissionDescription' => false,
        'fkiEzsigntemplatepublicID' => false,
        'sEzsigntemplatepublicDescription' => false,
        'eEzsignfolderSource' => false,
    ...
    protected static $attributeMap = [
        ...
        'fkiEzsignbulksendtransmissionID' => 'fkiEzsignbulksendtransmissionID',
        'sEzsignbulksendtransmissionDescription' => 'sEzsignbulksendtransmissionDescription',
        'fkiEzsigntemplatepublicID' => 'fkiEzsigntemplatepublicID',
        ...
        'bEzsignfolderIsmyown' => 'bEzsignfolderIsmyown'
    ];
    ...
    protected static $setters = [
        ...
        'fkiEzsignbulksendtransmissionID' => 'setFkiEzsignbulksendtransmissionID',
        'sEzsignbulksendtransmissionDescription' => 'setSEzsignbulksendtransmissionDescription',
        'fkiEzsigntemplatepublicID' => 'setFkiEzsigntemplatepublicID',
        'sEzsigntemplatepublicDescription' => 'setSEzsigntemplatepublicDescription',
        'eEzsignfolderSource' => 'setEEzsignfolderSource',
        ...
        'bEzsignfolderIsmyown' => 'setBEzsignfolderIsmyown'
    ];
    ...
    protected static $getters = [
        ...
        'fkiEzsignbulksendtransmissionID' => 'getFkiEzsignbulksendtransmissionID',
        'sEzsignbulksendtransmissionDescription' => 'getSEzsignbulksendtransmissionDescription',
        'fkiEzsigntemplatepublicID' => 'getFkiEzsigntemplatepublicID',
        'sEzsigntemplatepublicDescription' => 'getSEzsigntemplatepublicDescription',
        'eEzsignfolderSource' => 'getEEzsignfolderSource',
        ...
        'bEzsignfolderIsmyown' => 'getBEzsignfolderIsmyown'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('fkiEzsignbulksendtransmissionID', $data ?? [], null);
        $this->setIfExists('sEzsignbulksendtransmissionDescription', $data ?? [], null);
        $this->setIfExists('fkiEzsigntemplatepublicID', $data ?? [], null);
        $this->setIfExists('sEzsigntemplatepublicDescription', $data ?? [], null);
        $this->setIfExists('eEzsignfolderSource', $data ?? [], null);
        ...
        $this->setIfExists('bEzsignfolderIsmyown', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['fkiEzsignbulksendID']) && ($this->container['fkiEzsignbulksendID'] < 0)) {
            $invalidProperties[] = "invalid value for 'fkiEzsignbulksendID', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['fkiEzsignbulksendtransmissionID']) && ($this->container['fkiEzsignbulksendtransmissionID'] < 0)) {
            $invalidProperties[] = "invalid value for 'fkiEzsignbulksendtransmissionID', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['fkiEzsigntemplatepublicID']) && ($this->container['fkiEzsigntemplatepublicID'] > 65535)) {
            $invalidProperties[] = "invalid value for 'fkiEzsigntemplatepublicID', must be smaller than or equal to 65535.";
        }

        if (!is_null($this->container['fkiEzsigntemplatepublicID']) && ($this->container['fkiEzsigntemplatepublicID'] < 0)) {
            $invalidProperties[] = "invalid value for 'fkiEzsigntemplatepublicID', must be bigger than or equal to 0.";
        }

        //if (!is_null($this->container['sEzsigntemplatepublicDescription']) && !preg_match("/^.{0,80}$/", $this->container['sEzsigntemplatepublicDescription'])) {
        if (!is_null($this->container['sEzsigntemplatepublicDescription']) && !preg_match("/(*UTF8)^.{0,80}$/", $this->container['sEzsigntemplatepublicDescription'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsigntemplatepublicDescription'])?'null':'"'.$this->container['sEzsigntemplatepublicDescription'].'"')." for 'sEzsigntemplatepublicDescription', must be conform to the pattern /^.{0,80}$/.";
        }

        if ($this->container['eEzsignfolderSource'] === null) {
            $invalidProperties[] = "'eEzsignfolderSource' can't be null";
        }
        ...
        if (!is_null($this->container['dEzsignfolderCompletedpercentage']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/", $this->container['dEzsignfolderCompletedpercentage'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzsignfolderCompletedpercentage'])?'null':'"'.$this->container['dEzsignfolderCompletedpercentage'].'"')." for 'dEzsignfolderCompletedpercentage', must be conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzsignfolderFormcompletedpercentage']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/", $this->container['dEzsignfolderFormcompletedpercentage'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzsignfolderFormcompletedpercentage'])?'null':'"'.$this->container['dEzsignfolderFormcompletedpercentage'].'"')." for 'dEzsignfolderFormcompletedpercentage', must be conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzsignfolderSignaturecompletedpercentage']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/", $this->container['dEzsignfolderSignaturecompletedpercentage'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzsignfolderSignaturecompletedpercentage'])?'null':'"'.$this->container['dEzsignfolderSignaturecompletedpercentage'].'"')." for 'dEzsignfolderSignaturecompletedpercentage', must be conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.";
        }
     ...
     *
     * @param int|null $fkiEzsignbulksendID The unique ID of the Ezsignbulksend
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignbulksendID) && ($fkiEzsignbulksendID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignbulksendID when calling EzsignfolderListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignbulksendID)?'null':'"'.$fkiEzsignbulksendID.'"').' for fkiEzsignbulksendID when calling EzsignfolderListElement., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string|null $sEzsignbulksendDescription The description of the Ezsignbulksend
     *
     * @return self
     */
    ...
    /**
     * Gets fkiEzsignbulksendtransmissionID
     *
     * @return int|null
     */
    public function getFkiEzsignbulksendtransmissionID()
    {
	//return $this->container['fkiEzsignbulksendtransmissionID'];
        return $this->container['fkiEzsignbulksendtransmissionID'];
    }

    /**
     * Sets fkiEzsignbulksendtransmissionID
     *
     * @param int|null $fkiEzsignbulksendtransmissionID The unique ID of the Ezsignbulksendtransmission
     *
     * @return self
     */
    public function setFkiEzsignbulksendtransmissionID($fkiEzsignbulksendtransmissionID)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($fkiEzsignbulksendtransmissionID)) {
            //throw new \InvalidArgumentException('non-nullable fkiEzsignbulksendtransmissionID cannot be null');
        //}

        //if (($fkiEzsignbulksendtransmissionID < 0)) {
        if (!is_null($fkiEzsignbulksendtransmissionID) && ($fkiEzsignbulksendtransmissionID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignbulksendtransmissionID when calling EzsignfolderListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignbulksendtransmissionID)?'null':'"'.$fkiEzsignbulksendtransmissionID.'"').' for fkiEzsignbulksendtransmissionID when calling EzsignfolderListElement., must be bigger than or equal to 0.');
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['fkiEzsignbulksendtransmissionID'] = $fkiEzsignbulksendtransmissionID;
        $this->container['fkiEzsignbulksendtransmissionID'] = (is_null($fkiEzsignbulksendtransmissionID) ? null : (int) $fkiEzsignbulksendtransmissionID);
     ...
     *
     * @param string|null $sEzsignbulksendtransmissionDescription The description of the Ezsignbulksendtransmission
     *
     * @return self
     */
    ...
    /**
     * Gets fkiEzsigntemplatepublicID
     *
     * @return int|null
     */
    public function getFkiEzsigntemplatepublicID()
    {
	//return $this->container['fkiEzsigntemplatepublicID'];
        return $this->container['fkiEzsigntemplatepublicID'];
    }

    /**
     * Sets fkiEzsigntemplatepublicID
     *
     * @param int|null $fkiEzsigntemplatepublicID The unique ID of the Ezsigntemplatepublic
     *
     * @return self
     */
    public function setFkiEzsigntemplatepublicID($fkiEzsigntemplatepublicID)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($fkiEzsigntemplatepublicID)) {
            //throw new \InvalidArgumentException('non-nullable fkiEzsigntemplatepublicID cannot be null');
        //}

        //if (($fkiEzsigntemplatepublicID > 65535)) {
        if (!is_null($fkiEzsigntemplatepublicID) && ($fkiEzsigntemplatepublicID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepublicID when calling EzsignfolderListElement., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatepublicID)?'null':'"'.$fkiEzsigntemplatepublicID.'"').' for fkiEzsigntemplatepublicID when calling EzsignfolderListElement., must be smaller than or equal to 65535.');
        }
        //if (($fkiEzsigntemplatepublicID < 0)) {
        if (!is_null($fkiEzsigntemplatepublicID) && ($fkiEzsigntemplatepublicID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepublicID when calling EzsignfolderListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatepublicID)?'null':'"'.$fkiEzsigntemplatepublicID.'"').' for fkiEzsigntemplatepublicID when calling EzsignfolderListElement., must be bigger than or equal to 0.');
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['fkiEzsigntemplatepublicID'] = $fkiEzsigntemplatepublicID;
        $this->container['fkiEzsigntemplatepublicID'] = (is_null($fkiEzsigntemplatepublicID) ? null : (int) $fkiEzsigntemplatepublicID);
     ...
     *
     * @param string|null $sEzsigntemplatepublicDescription The description of the Ezsigntemplatepublic
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatepublicDescription) && (!preg_match("/(*UTF8)^.{0,80}$/", ObjectSerializer::toString($sEzsigntemplatepublicDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatepublicDescription when calling EzsignfolderListElement., must conform to the pattern /^.{0,80}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatepublicDescription)?'null':'"'.$sEzsigntemplatepublicDescription.'"')." for sEzsigntemplatepublicDescription when calling EzsignfolderListElement., must conform to the pattern /^.{0,80}$/.");
        }
    ...
    /**
     * Gets eEzsignfolderSource
     *
     * @return \eZmaxAPI\Model\FieldEEzsignfolderSource
     */
    public function getEEzsignfolderSource()
    {
	//return $this->container['eEzsignfolderSource'];
        return $this->container['eEzsignfolderSource'];
    }

    /**
     * Sets eEzsignfolderSource
     *
     * @param \eZmaxAPI\Model\FieldEEzsignfolderSource $eEzsignfolderSource eEzsignfolderSource
     *
     * @return self
     */
    public function setEEzsignfolderSource($eEzsignfolderSource)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($eEzsignfolderSource)) {
            //throw new \InvalidArgumentException('non-nullable eEzsignfolderSource cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['eEzsignfolderSource'] = $eEzsignfolderSource;
        $this->container['eEzsignfolderSource'] = $eEzsignfolderSource;
    ...
    /**
     * Gets bEzsignfolderIsmyown
     *
     * @return bool|null
     */
    public function getBEzsignfolderIsmyown()
    {
	//return $this->container['bEzsignfolderIsmyown'];
        return $this->container['bEzsignfolderIsmyown'];
    }

    /**
     * Sets bEzsignfolderIsmyown
     *
     * @param bool|null $bEzsignfolderIsmyown Whether the Ezsignfolder is my own or not
     *
     * @return self
     */
    public function setBEzsignfolderIsmyown($bEzsignfolderIsmyown)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($bEzsignfolderIsmyown)) {
            //throw new \InvalidArgumentException('non-nullable bEzsignfolderIsmyown cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['bEzsignfolderIsmyown'] = $bEzsignfolderIsmyown;
        $this->container['bEzsignfolderIsmyown'] = (is_null($bEzsignfolderIsmyown) ? null : (bool) $bEzsignfolderIsmyown);
