...
/**
 * EzsignsignergroupRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignsignergroupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignsignergroup-Request';
    ...
    */
	...
	//if (($pkiEzsignsignergroupID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignergroupID when calling EzsignsignergroupRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignergroupID)?'null':'"'.$pkiEzsignsignergroupID.'"').' for pkiEzsignsignergroupID when calling EzsignsignergroupRequest., must be smaller than or equal to 65535.');
        }
	//if (($pkiEzsignsignergroupID < 0)) {
        if (!is_null($pkiEzsignsignergroupID) && ($pkiEzsignsignergroupID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignergroupID when calling EzsignsignergroupRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignergroupID)?'null':'"'.$pkiEzsignsignergroupID.'"').' for pkiEzsignsignergroupID when calling EzsignsignergroupRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignfolderID < 0)) {
        if (($fkiEzsignfolderID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfolderID when calling EzsignsignergroupRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfolderID)?'null':'"'.$fkiEzsignfolderID.'"').' for fkiEzsignfolderID when calling EzsignsignergroupRequest., must be bigger than or equal to 0.');
        }
