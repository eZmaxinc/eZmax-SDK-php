...
/**
 * EzsignformfieldgroupsignerRequestCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignformfieldgroupsignerRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignformfieldgroupsigner-RequestCompound';
    ...
    protected static array $openAPINullables = [
        'pkiEzsignformfieldgroupsignerID' => false,
    ...
    {
        $this->setIfExists('pkiEzsignformfieldgroupsignerID', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['pkiEzsignformfieldgroupsignerID']) && ($this->container['pkiEzsignformfieldgroupsignerID'] < 0)) {
	...
	//if (($pkiEzsignformfieldgroupsignerID < 0)) {
        if (!is_null($pkiEzsignformfieldgroupsignerID) && ($pkiEzsignformfieldgroupsignerID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignformfieldgroupsignerID when calling EzsignformfieldgroupsignerRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignformfieldgroupsignerID)?'null':'"'.$pkiEzsignformfieldgroupsignerID.'"').' for pkiEzsignformfieldgroupsignerID when calling EzsignformfieldgroupsignerRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignfoldersignerassociationID < 0)) {
        if (($fkiEzsignfoldersignerassociationID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldersignerassociationID when calling EzsignformfieldgroupsignerRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationID)?'null':'"'.$fkiEzsignfoldersignerassociationID.'"').' for fkiEzsignfoldersignerassociationID when calling EzsignformfieldgroupsignerRequestCompound., must be bigger than or equal to 0.');
        }
