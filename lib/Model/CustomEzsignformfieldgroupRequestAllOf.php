...
/**
 * CustomEzsignformfieldgroupRequestAllOf Class Doc Comment
 *
 * @category Class
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 ...
 */
class CustomEzsignformfieldgroupRequestAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Custom_Ezsignformfieldgroup_Request_allOf';
...
//        if (($pkiEzsignformfieldgroupID < 0)) {
        if (!is_null($pkiEzsignformfieldgroupID) && ($pkiEzsignformfieldgroupID < 0)) {
            throw new \InvalidArgumentException('invalid value for $pkiEzsignformfieldgroupID when calling CustomEzsignformfieldgroupRequestAllOf., must be bigger than or equal to 0.');
        }
...
//        if ((mb_strlen($sEzsignformfieldgroupLabel) > 50)) {
        if (!is_null($sEzsignformfieldgroupLabel) && (mb_strlen($sEzsignformfieldgroupLabel) > 50)) {
            throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupLabel when calling CustomEzsignformfieldgroupRequestAllOf., must be smaller than or equal to 50.');
        }
//        if ((mb_strlen($sEzsignformfieldgroupLabel) < 1)) {
        if (!is_null($sEzsignformfieldgroupLabel) && (mb_strlen($sEzsignformfieldgroupLabel) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupLabel when calling CustomEzsignformfieldgroupRequestAllOf., must be bigger than or equal to 1.');
        }
...
//        if ((count($aObjEzsignformfield) < 1)) {
        if ((count($aObjEzsignformfield) < 1)) {
            throw new \InvalidArgumentException('invalid length for $aObjEzsignformfield when calling CustomEzsignformfieldgroupRequestAllOf., number of items must be greater than or equal to 1.');
        }
