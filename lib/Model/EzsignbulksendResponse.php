    ...
    */
	...
	//if (($pkiEzsignbulksendID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignbulksendID when calling EzsignbulksendResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignbulksendID)?'null':'"'.$pkiEzsignbulksendID.'"').' for pkiEzsignbulksendID when calling EzsignbulksendResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignfoldertypeID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsignbulksendResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsignbulksendResponse., must be smaller than or equal to 65535.');
        }
	//if (($fkiEzsignfoldertypeID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsignbulksendResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsignbulksendResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiLanguageID > 2)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsignbulksendResponse., must be smaller than or equal to 2.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsignbulksendResponse., must be smaller than or equal to 2.');
        }
	//if (($fkiLanguageID < 1)) {
        if (($fkiLanguageID < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsignbulksendResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsignbulksendResponse., must be bigger than or equal to 1.');
        }
