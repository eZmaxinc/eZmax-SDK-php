...
/**
 * BillingentityinternalResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class BillingentityinternalResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'billingentityinternal-Response';
    ...
    */
	...
	//if (($pkiBillingentityinternalID < 0)) {
        if (($pkiBillingentityinternalID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiBillingentityinternalID when calling BillingentityinternalResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiBillingentityinternalID)?'null':'"'.$pkiBillingentityinternalID.'"').' for pkiBillingentityinternalID when calling BillingentityinternalResponse., must be bigger than or equal to 0.');
        }
