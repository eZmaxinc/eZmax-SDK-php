...
/**
 * LeadGetListV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /1/object/lead/getList
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LeadGetListV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'lead-getList-v1-Response-mPayload';
    ...
    protected static $openAPITypes = [
        'iRowReturned' => 'int',
        'iRowFiltered' => 'int',
        'aObjLead' => '\eZmaxAPI\Model\LeadListElement[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aObjLead', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aObjLead'] === null) {
            $invalidProperties[] = "'aObjLead' can't be null";
        }
     ...
     * Gets aObjLead
     *
     * @return \eZmaxAPI\Model\LeadListElement[]
     */
    public function getAObjLead()
    {
	//return $this->container['aObjLead'];
        return $this->container['aObjLead'];
    }
     ...
     * Sets aObjLead
     *
     * @param \eZmaxAPI\Model\LeadListElement[] $aObjLead aObjLead
     *
     * @return self
     */
    public function setAObjLead($aObjLead)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjLead)) {
            //throw new \InvalidArgumentException('non-nullable aObjLead cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjLead'] = $aObjLead;
        $this->container['aObjLead'] = $aObjLead;
