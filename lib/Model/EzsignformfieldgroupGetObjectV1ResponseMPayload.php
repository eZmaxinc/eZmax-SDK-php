 ...
 */
class EzsignformfieldgroupGetObjectV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignformfieldgroup-getObject-v1-Response-mPayload';
    ...
    */
    ...
    public function setPkiEzsignformfieldgroupID($pkiEzsignformfieldgroupID)
    {
        ...
        if (($pkiEzsignformfieldgroupID < 0)) {
            throw new \InvalidArgumentException('invalid value for $pkiEzsignformfieldgroupID when calling EzsignformfieldgroupGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setFkiEzsigndocumentID($fkiEzsigndocumentID)
    {
        ...
        if (($fkiEzsigndocumentID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsigndocumentID when calling EzsignformfieldgroupGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setSEzsignformfieldgroupLabel($sEzsignformfieldgroupLabel)
    {
        if ((mb_strlen($sEzsignformfieldgroupLabel) > 50)) {
            throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupLabel when calling EzsignformfieldgroupGetObjectV1ResponseMPayload., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($sEzsignformfieldgroupLabel) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupLabel when calling EzsignformfieldgroupGetObjectV1ResponseMPayload., must be bigger than or equal to 1.');
        }
    ...
    public function setIEzsignformfieldgroupStep($iEzsignformfieldgroupStep)
    {
        ...
        if (($iEzsignformfieldgroupStep < 1)) {
            throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupStep when calling EzsignformfieldgroupGetObjectV1ResponseMPayload., must be bigger than or equal to 1.');
        }
    ...
    public function setIEzsignformfieldgroupFilledmin($iEzsignformfieldgroupFilledmin)
    {
        ...
        if (($iEzsignformfieldgroupFilledmin < 0)) {
            throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupFilledmin when calling EzsignformfieldgroupGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setIEzsignformfieldgroupFilledmax($iEzsignformfieldgroupFilledmax)
    {
        ...
        if (($iEzsignformfieldgroupFilledmax < 0)) {
            throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupFilledmax when calling EzsignformfieldgroupGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setIEzsignformfieldgroupMaxlength($iEzsignformfieldgroupMaxlength)
    {
        ...
        if (!is_null($iEzsignformfieldgroupMaxlength) && ($iEzsignformfieldgroupMaxlength < 0)) {
            throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupMaxlength when calling EzsignformfieldgroupGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
