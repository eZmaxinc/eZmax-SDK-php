...
class DiscussionmessageResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sDiscussionmessageCreatorname']) && !preg_match("/(*UTF8)^.{0,75}$/", $this->container['sDiscussionmessageCreatorname'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sDiscussionmessageCreatorname'])?'null':'"'.$this->container['sDiscussionmessageCreatorname'].'"')." for 'sDiscussionmessageCreatorname', must be conform to the pattern /^.{0,75}$/.";
        }
        ...
        if (!is_null($this->container['sDiscussionmessageActionrequiredname']) && !preg_match("/(*UTF8)^.{0,75}$/", $this->container['sDiscussionmessageActionrequiredname'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sDiscussionmessageActionrequiredname'])?'null':'"'.$this->container['sDiscussionmessageActionrequiredname'].'"')." for 'sDiscussionmessageActionrequiredname', must be conform to the pattern /^.{0,75}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($tDiscussionmessageContent) && (!preg_match("/(*UTF8)^[\\s\\S]{0,65535}$/", ObjectSerializer::toString($tDiscussionmessageContent)))) {
            //throw new \InvalidArgumentException("invalid value for \$tDiscussionmessageContent when calling DiscussionmessageResponseCompound., must conform to the pattern /^[\\s\\S]{0,65535}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($tDiscussionmessageContent)?'null':'"'.$tDiscussionmessageContent.'"')." for tDiscussionmessageContent when calling DiscussionmessageResponseCompound., must conform to the pattern /^[\\s\\S]{0,65535}$/.");
        }
