...
class FranchisereferalincomeRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dFranchisereferalincomeLoan'])) {
            $invalidProperties[] = "invalid value for 'dFranchisereferalincomeLoan', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
        ...
        if (!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dFranchisereferalincomeFranchiseamount'])) {
            $invalidProperties[] = "invalid value for 'dFranchisereferalincomeFranchiseamount', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
        ...
        if (!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dFranchisereferalincomeFranchisoramount'])) {
            $invalidProperties[] = "invalid value for 'dFranchisereferalincomeFranchisoramount', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
        ...
        if (!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dFranchisereferalincomeAgentamount'])) {
            $invalidProperties[] = "invalid value for 'dFranchisereferalincomeAgentamount', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
    ...
    public function setDFranchisereferalincomeLoan($dFranchisereferalincomeLoan)
    {
        ...
        if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $dFranchisereferalincomeLoan))) {
            throw new \InvalidArgumentException("invalid value for \$dFranchisereferalincomeLoan when calling FranchisereferalincomeRequestCompound., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
    ...
    public function setDFranchisereferalincomeFranchiseamount($dFranchisereferalincomeFranchiseamount)
    {
        ...
        if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $dFranchisereferalincomeFranchiseamount))) {
            throw new \InvalidArgumentException("invalid value for \$dFranchisereferalincomeFranchiseamount when calling FranchisereferalincomeRequestCompound., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
    ...
    public function setDFranchisereferalincomeFranchisoramount($dFranchisereferalincomeFranchisoramount)
    {
        ...
        if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $dFranchisereferalincomeFranchisoramount))) {
            throw new \InvalidArgumentException("invalid value for \$dFranchisereferalincomeFranchisoramount when calling FranchisereferalincomeRequestCompound., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
    ...
    public function setDFranchisereferalincomeAgentamount($dFranchisereferalincomeAgentamount)
    {
        ...
        if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $dFranchisereferalincomeAgentamount))) {
            throw new \InvalidArgumentException("invalid value for \$dFranchisereferalincomeAgentamount when calling FranchisereferalincomeRequestCompound., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
