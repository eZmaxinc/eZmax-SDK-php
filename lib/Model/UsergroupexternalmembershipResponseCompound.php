...
class UsergroupexternalmembershipResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiUsergroupexternalmembershipID > 65535)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupexternalmembershipID)?'null':'"'.$pkiUsergroupexternalmembershipID.'"').' for pkiUsergroupexternalmembershipID when calling UsergroupexternalmembershipResponseCompound., must be smaller than or equal to 65535.');
        }
        ...
        if (($pkiUsergroupexternalmembershipID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupexternalmembershipID)?'null':'"'.$pkiUsergroupexternalmembershipID.'"').' for pkiUsergroupexternalmembershipID when calling UsergroupexternalmembershipResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiUsergroupexternalID > 255)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupexternalID)?'null':'"'.$fkiUsergroupexternalID.'"').' for fkiUsergroupexternalID when calling UsergroupexternalmembershipResponseCompound., must be smaller than or equal to 255.');
        }
        ...
        if (($fkiUsergroupexternalID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupexternalID)?'null':'"'.$fkiUsergroupexternalID.'"').' for fkiUsergroupexternalID when calling UsergroupexternalmembershipResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiUserID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling UsergroupexternalmembershipResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUserLoginname) && (!preg_match("/(*UTF8)^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/", ObjectSerializer::toString($sUserLoginname)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sUserLoginname)?'null':'"'.$sUserLoginname.'"')." for sUserLoginname when calling UsergroupexternalmembershipResponseCompound., must conform to the pattern /^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEmailAddress) && (!preg_match("/(*UTF8)^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddress)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sEmailAddress)?'null':'"'.$sEmailAddress.'"')." for sEmailAddress when calling UsergroupexternalmembershipResponseCompound., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUsergroupexternalName) && (!preg_match("/(*UTF8)^.{0,64}$/", ObjectSerializer::toString($sUsergroupexternalName)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupexternalName)?'null':'"'.$sUsergroupexternalName.'"')." for sUsergroupexternalName when calling UsergroupexternalmembershipResponseCompound., must conform to the pattern /^.{0,64}$/.");
        }
