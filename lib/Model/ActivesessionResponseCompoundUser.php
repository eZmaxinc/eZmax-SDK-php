...
class ActivesessionResponseCompoundUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'bUserAddmeinezsignfolder' => 'setBUserAddmeinezsignfolder',
        ...
        'iUserFrontendgoal' => 'setIUserFrontendgoal'
    ];
    ...
    protected static $getters = [
        ...
        'bUserAddmeinezsignfolder' => 'getBUserAddmeinezsignfolder',
        ...
        'iUserFrontendgoal' => 'getIUserFrontendgoal'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bUserAddmeinezsignfolder', $data ?? [], null);
        ...
        $this->setIfExists('iUserFrontendgoal', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sAvatarUrl']) && !preg_match("/(*UTF8)^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/", $this->container['sAvatarUrl'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sAvatarUrl'])?'null':'"'.$this->container['sAvatarUrl'].'"')." for 'sAvatarUrl', must be conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.";
        }
        ...
        if ($this->container['bUserAddmeinezsignfolder'] === null) {
            $invalidProperties[] = "'bUserAddmeinezsignfolder' can't be null";
        }
        ...
        if ($this->container['iUserFrontendgoal'] === null) {
            $invalidProperties[] = "'iUserFrontendgoal' can't be null";
        }
        if (($this->container['iUserFrontendgoal'] < 0)) {
            $invalidProperties[] = "invalid value for 'iUserFrontendgoal', must be bigger than or equal to 0.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiUserID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUserID)?'null':'"'.$pkiUserID.'"').' for pkiUserID when calling ActivesessionResponseCompoundUser., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiTimezoneID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiTimezoneID)?'null':'"'.$fkiTimezoneID.'"').' for fkiTimezoneID when calling ActivesessionResponseCompoundUser., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sAvatarUrl) && (!preg_match("/(*UTF8)^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/", ObjectSerializer::toString($sAvatarUrl)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sAvatarUrl)?'null':'"'.$sAvatarUrl.'"')." for sAvatarUrl when calling ActivesessionResponseCompoundUser., must conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEmailAddress) && (!preg_match("/(*UTF8)^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddress)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sEmailAddress)?'null':'"'.$sEmailAddress.'"')." for sEmailAddress when calling ActivesessionResponseCompoundUser., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
        }
    ...
    /**
     * Gets bUserAddmeinezsignfolder
     *
     * @return bool
     */
    public function getBUserAddmeinezsignfolder()
    {
	//return $this->container['bUserAddmeinezsignfolder'];
        return $this->container['bUserAddmeinezsignfolder'];
    }

    /**
     * Sets bUserAddmeinezsignfolder
     *
     * @param bool $bUserAddmeinezsignfolder Whether if I want to automatically add myself during the creation of Ezsignfolder of which I am the owner
     *
     * @return self
     */
    public function setBUserAddmeinezsignfolder($bUserAddmeinezsignfolder)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($bUserAddmeinezsignfolder)) {
            //throw new \InvalidArgumentException('non-nullable bUserAddmeinezsignfolder cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['bUserAddmeinezsignfolder'] = $bUserAddmeinezsignfolder;
        $this->container['bUserAddmeinezsignfolder'] = (is_null($bUserAddmeinezsignfolder) ? null : (bool) $bUserAddmeinezsignfolder);
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iUserInterfacecolor < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iUserInterfacecolor)?'null':'"'.$iUserInterfacecolor.'"').' for iUserInterfacecolor when calling ActivesessionResponseCompoundUser., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iUserListresult > 500)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iUserListresult)?'null':'"'.$iUserListresult.'"').' for iUserListresult when calling ActivesessionResponseCompoundUser., must be smaller than or equal to 500.');
        }
        ...
        if (($iUserListresult < 5)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iUserListresult)?'null':'"'.$iUserListresult.'"').' for iUserListresult when calling ActivesessionResponseCompoundUser., must be bigger than or equal to 5.');
        }
    ...
    /**
     * Gets iUserFrontendgoal
     *
     * @return int
     */
    public function getIUserFrontendgoal()
    {
	//return $this->container['iUserFrontendgoal'];
        return $this->container['iUserFrontendgoal'];
    }

    /**
     * Sets iUserFrontendgoal
     *
     * @param int $iUserFrontendgoal Goals save as bit wise (one bit per goal)
     *
     * @return self
     */
    public function setIUserFrontendgoal($iUserFrontendgoal)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($iUserFrontendgoal)) {
            //throw new \InvalidArgumentException('non-nullable iUserFrontendgoal cannot be null');
        //}
        //if (($iUserFrontendgoal < 0)) {
        if (($iUserFrontendgoal < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iUserFrontendgoal when calling ActivesessionResponseCompoundUser., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iUserFrontendgoal)?'null':'"'.$iUserFrontendgoal.'"').' for iUserFrontendgoal when calling ActivesessionResponseCompoundUser., must be bigger than or equal to 0.');
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['iUserFrontendgoal'] = $iUserFrontendgoal;
        $this->container['iUserFrontendgoal'] = (is_null($iUserFrontendgoal) ? null : (int) $iUserFrontendgoal);
