...
class EzsigntemplatepublicRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzsigntemplatepublicID) && ($pkiEzsigntemplatepublicID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatepublicID when calling EzsigntemplatepublicRequest., must be smaller than or equal to 65535.');
        ...
        if (!is_null($pkiEzsigntemplatepublicID) && ($pkiEzsigntemplatepublicID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatepublicID when calling EzsigntemplatepublicRequest., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsignfoldertypeID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsigntemplatepublicRequest., must be smaller than or equal to 65535.');
        ...
        if (($fkiEzsignfoldertypeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsigntemplatepublicRequest., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiUserlogintypeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserlogintypeID when calling EzsigntemplatepublicRequest., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplateID) && ($fkiEzsigntemplateID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplateID when calling EzsigntemplatepublicRequest., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplatepackageID) && ($fkiEzsigntemplatepackageID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepackageID when calling EzsigntemplatepublicRequest., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatepublicDescription) && (!preg_match("/(*UTF8)^.{0,80}$/", ObjectSerializer::toString($sEzsigntemplatepublicDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatepublicDescription when calling EzsigntemplatepublicRequest., must conform to the pattern /^.{0,80}$/.");
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($tEzsigntemplatepublicNote) && (!preg_match("/(*UTF8)^.{0,65535}$/", ObjectSerializer::toString($tEzsigntemplatepublicNote)))) {
            //throw new \InvalidArgumentException("invalid value for \$tEzsigntemplatepublicNote when calling EzsigntemplatepublicRequest., must conform to the pattern /^.{0,65535}$/.");
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplatepublicLimit > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatepublicLimit when calling EzsigntemplatepublicRequest., must be smaller than or equal to 65535.');
        ...
        if (($iEzsigntemplatepublicLimit < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatepublicLimit when calling EzsigntemplatepublicRequest., must be bigger than or equal to 0.');
