...
/**
 * BillingentityexternalGenerateFederationTokenV1Request Class Doc Comment
 *
 * @category Class
 * @description Request for POST /1/object/billingentityexternal/{pkiBillingentityexternalID}/generateFederationToken
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BillingentityexternalGenerateFederationTokenV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'billingentityexternal-generateFederationToken-v1-Request';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if ((mb_strlen($fksEzmaxcustomerCode) > 6)) {
            //throw new \InvalidArgumentException('invalid length for $fksEzmaxcustomerCode when calling BillingentityexternalGenerateFederationTokenV1Request., must be smaller than or equal to 6.');
            throw new \InvalidArgumentException('value '.(is_null($fksEzmaxcustomerCode)?'null':'"'.$fksEzmaxcustomerCode.'"').', invalid length for fksEzmaxcustomerCode when calling BillingentityexternalGenerateFederationTokenV1Request., must be smaller than or equal to 6.');
        }
        //if ((mb_strlen($fksEzmaxcustomerCode) < 2)) {
        if ((mb_strlen($fksEzmaxcustomerCode) < 2)) {
            //throw new \InvalidArgumentException('invalid length for $fksEzmaxcustomerCode when calling BillingentityexternalGenerateFederationTokenV1Request., must be bigger than or equal to 2.');
            throw new \InvalidArgumentException('value '.(is_null($fksEzmaxcustomerCode)?'null':'"'.$fksEzmaxcustomerCode.'"').', invalid length for fksEzmaxcustomerCode when calling BillingentityexternalGenerateFederationTokenV1Request., must be bigger than or equal to 2.');
        }
        ...
        if (!is_null($fksEzmaxcustomerCode) && (!preg_match("/(*UTF8)^[a-z\\d]{2,6}$/", ObjectSerializer::toString($fksEzmaxcustomerCode)))) {
            //throw new \InvalidArgumentException("invalid value for \$fksEzmaxcustomerCode when calling BillingentityexternalGenerateFederationTokenV1Request., must conform to the pattern /^[a-z\\d]{2,6}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($fksEzmaxcustomerCode)?'null':'"'.$fksEzmaxcustomerCode.'"')." for fksEzmaxcustomerCode when calling BillingentityexternalGenerateFederationTokenV1Request., must conform to the pattern /^[a-z\\d]{2,6}$/.");
        }
