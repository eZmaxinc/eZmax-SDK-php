 ...
 * @link     https://openapi-generator.tech
 */
class EzsignsignerRequestCompound implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['objContact'] = isset($data['objContact']) ? $data['objContact'] : null;
    ...
    public function setFkiTaxassignmentID($fkiTaxassignmentID)
    {
        ...
        if (($fkiTaxassignmentID < 1)) {
            throw new \InvalidArgumentException('invalid value for $fkiTaxassignmentID when calling EzsignsignerRequestCompound., must be bigger than or equal to 1.');
        }
    ...
    public function setFkiSecretquestionID($fkiSecretquestionID)
    {
        ...
        if (!is_null($fkiSecretquestionID) && ($fkiSecretquestionID > 15)) {
            throw new \InvalidArgumentException('invalid value for $fkiSecretquestionID when calling EzsignsignerRequestCompound., must be smaller than or equal to 15.');
        }
        if (!is_null($fkiSecretquestionID) && ($fkiSecretquestionID < 1)) {
            throw new \InvalidArgumentException('invalid value for $fkiSecretquestionID when calling EzsignsignerRequestCompound., must be bigger than or equal to 1.');
        }
