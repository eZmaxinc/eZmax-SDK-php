...
//        if (($fkiUserlogintypeID < 0)) {
        if (!is_null($fkiUserlogintypeID) && ($fkiUserlogintypeID < 0)) {
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserlogintypeID)?'null':'"'.$fkiUserlogintypeID.'"').' for fkiUserlogintypeID when calling EzsignsignerRequestCompound., must be bigger than or equal to 0.');
        }
...
//        if (($fkiTaxassignmentID > 15)) {
        if (($fkiTaxassignmentID > 15)) {
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiTaxassignmentID)?'null':'"'.$fkiTaxassignmentID.'"').' for fkiTaxassignmentID when calling EzsignsignerRequestCompound., must be smaller than or equal to 15.');
        }
//        if (($fkiTaxassignmentID < 0)) {
        if (($fkiTaxassignmentID < 0)) {
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiTaxassignmentID)?'null':'"'.$fkiTaxassignmentID.'"').' for fkiTaxassignmentID when calling EzsignsignerRequestCompound., must be bigger than or equal to 0.');
        }
...
//        if (($fkiSecretquestionID < 0)) {
        if (!is_null($fkiSecretquestionID) && ($fkiSecretquestionID < 0)) {
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiSecretquestionID)?'null':'"'.$fkiSecretquestionID.'"').' for fkiSecretquestionID when calling EzsignsignerRequestCompound., must be bigger than or equal to 0.');
        }
