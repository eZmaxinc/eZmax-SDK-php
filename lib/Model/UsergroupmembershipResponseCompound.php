...
/**
 * UsergroupmembershipResponseCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class UsergroupmembershipResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'usergroupmembership-ResponseCompound';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pkiUsergroupmembershipID'] === null) {
            $invalidProperties[] = "'pkiUsergroupmembershipID' can't be null";
        }
        if (($this->container['pkiUsergroupmembershipID'] > 65535)) {
            $invalidProperties[] = "invalid value for 'pkiUsergroupmembershipID', must be smaller than or equal to 65535.";
        }

        if (($this->container['pkiUsergroupmembershipID'] < 0)) {
        ...
        //if (!is_null($this->container['sUsergroupexternalName']) && !preg_match("/^.{0,64}$/", $this->container['sUsergroupexternalName'])) {
        if (!is_null($this->container['sUsergroupexternalName']) && !preg_match("/(*UTF8)^.{0,64}$/", $this->container['sUsergroupexternalName'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sUsergroupexternalName'])?'null':'"'.$this->container['sUsergroupexternalName'].'"')." for 'sUsergroupexternalName', must be conform to the pattern /^.{0,64}$/.";
        }
     ...
     *
     * @param int $pkiUsergroupmembershipID The unique ID of the Usergroupmembership
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiUsergroupmembershipID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $pkiUsergroupmembershipID when calling UsergroupmembershipResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupmembershipID)?'null':'"'.$pkiUsergroupmembershipID.'"').' for pkiUsergroupmembershipID when calling UsergroupmembershipResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($pkiUsergroupmembershipID < 0)) {
        if (($pkiUsergroupmembershipID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiUsergroupmembershipID when calling UsergroupmembershipResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupmembershipID)?'null':'"'.$pkiUsergroupmembershipID.'"').' for pkiUsergroupmembershipID when calling UsergroupmembershipResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiUsergroupID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling UsergroupmembershipResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling UsergroupmembershipResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($fkiUsergroupID < 0)) {
        if (($fkiUsergroupID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling UsergroupmembershipResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling UsergroupmembershipResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUserID) && ($fkiUserID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling UsergroupmembershipResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling UsergroupmembershipResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUsergroupexternalID) && ($fkiUsergroupexternalID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupexternalID when calling UsergroupmembershipResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupexternalID)?'null':'"'.$fkiUsergroupexternalID.'"').' for fkiUsergroupexternalID when calling UsergroupmembershipResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($fkiUsergroupexternalID < 0)) {
        if (!is_null($fkiUsergroupexternalID) && ($fkiUsergroupexternalID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUsergroupexternalID when calling UsergroupmembershipResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupexternalID)?'null':'"'.$fkiUsergroupexternalID.'"').' for fkiUsergroupexternalID when calling UsergroupmembershipResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUserLoginname) && (!preg_match("/(*UTF8)^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/", ObjectSerializer::toString($sUserLoginname)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUserLoginname when calling UsergroupmembershipResponseCompound., must conform to the pattern /^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUserLoginname)?'null':'"'.$sUserLoginname.'"')." for sUserLoginname when calling UsergroupmembershipResponseCompound., must conform to the pattern /^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEmailAddress) && (!preg_match("/(*UTF8)^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddress)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEmailAddress when calling UsergroupmembershipResponseCompound., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEmailAddress)?'null':'"'.$sEmailAddress.'"')." for sEmailAddress when calling UsergroupmembershipResponseCompound., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUsergroupNameX) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sUsergroupNameX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUsergroupNameX when calling UsergroupmembershipResponseCompound., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupNameX)?'null':'"'.$sUsergroupNameX.'"')." for sUsergroupNameX when calling UsergroupmembershipResponseCompound., must conform to the pattern /^.{0,50}$/.");
        }
     ...
     * Sets bUserIsactive
     *
     * @param bool|null $bUserIsactive Whether the User is active or not
     *
     * @return self
     */
     ...
     *
     * @param string|null $sUsergroupexternalName The name of the Usergroupexternal
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUsergroupexternalName) && (!preg_match("/(*UTF8)^.{0,64}$/", ObjectSerializer::toString($sUsergroupexternalName)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUsergroupexternalName when calling UsergroupmembershipResponseCompound., must conform to the pattern /^.{0,64}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupexternalName)?'null':'"'.$sUsergroupexternalName.'"')." for sUsergroupexternalName when calling UsergroupmembershipResponseCompound., must conform to the pattern /^.{0,64}$/.");
        }
