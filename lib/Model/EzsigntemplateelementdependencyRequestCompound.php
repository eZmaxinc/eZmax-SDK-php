...
class EzsigntemplateelementdependencyRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzsigntemplateelementdependencyID) && ($pkiEzsigntemplateelementdependencyID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplateelementdependencyID when calling EzsigntemplateelementdependencyRequestCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateelementdependencyID)?'null':'"'.$pkiEzsigntemplateelementdependencyID.'"').' for pkiEzsigntemplateelementdependencyID when calling EzsigntemplateelementdependencyRequestCompound., must be smaller than or equal to 16777215.');
        }
        ...
        if (!is_null($pkiEzsigntemplateelementdependencyID) && ($pkiEzsigntemplateelementdependencyID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateelementdependencyID)?'null':'"'.$pkiEzsigntemplateelementdependencyID.'"').' for pkiEzsigntemplateelementdependencyID when calling EzsigntemplateelementdependencyRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplateformfieldIDValidation) && ($fkiEzsigntemplateformfieldIDValidation < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateformfieldIDValidation)?'null':'"'.$fkiEzsigntemplateformfieldIDValidation.'"').' for fkiEzsigntemplateformfieldIDValidation when calling EzsigntemplateelementdependencyRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplateformfieldgroupIDValidation) && ($fkiEzsigntemplateformfieldgroupIDValidation < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateformfieldgroupIDValidation)?'null':'"'.$fkiEzsigntemplateformfieldgroupIDValidation.'"').' for fkiEzsigntemplateformfieldgroupIDValidation when calling EzsigntemplateelementdependencyRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplateelementdependencyValue) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sEzsigntemplateelementdependencyValue)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplateelementdependencyValue)?'null':'"'.$sEzsigntemplateelementdependencyValue.'"')." for sEzsigntemplateelementdependencyValue when calling EzsigntemplateelementdependencyRequestCompound., must conform to the pattern /^.{0,50}$/.");
        }
