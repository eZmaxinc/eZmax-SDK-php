...
/**
 * CustomerResponseCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'customer-ResponseCompound';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['efksCustomerCode']) && !preg_match("/(*UTF8)^.{0,6}$/", $this->container['efksCustomerCode'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['efksCustomerCode'])?'null':'"'.$this->container['efksCustomerCode'].'"')." for 'efksCustomerCode', must be conform to the pattern /^.{0,6}$/.";
        }
        ...
        if (!is_null($this->container['dCustomerFulltimeequivalent']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/", $this->container['dCustomerFulltimeequivalent'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dCustomerFulltimeequivalent'])?'null':'"'.$this->container['dCustomerFulltimeequivalent'].'"')." for 'dCustomerFulltimeequivalent', must be conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dCustomerMinimumchargeableinterests']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dCustomerMinimumchargeableinterests'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dCustomerMinimumchargeableinterests'])?'null':'"'.$this->container['dCustomerMinimumchargeableinterests'].'"')." for 'dCustomerMinimumchargeableinterests', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dtCustomerBirthdate']) && !preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", $this->container['dtCustomerBirthdate'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtCustomerBirthdate'])?'null':'"'.$this->container['dtCustomerBirthdate'].'"')." for 'dtCustomerBirthdate', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.";
        }
        ...
        if (!is_null($this->container['dtCustomerTransfer']) && !preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", $this->container['dtCustomerTransfer'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtCustomerTransfer'])?'null':'"'.$this->container['dtCustomerTransfer'].'"')." for 'dtCustomerTransfer', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
        }
        ...
        if (!is_null($this->container['dtCustomerTransferappointment']) && !preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", $this->container['dtCustomerTransferappointment'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtCustomerTransferappointment'])?'null':'"'.$this->container['dtCustomerTransferappointment'].'"')." for 'dtCustomerTransferappointment', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
        }
        ...
        if (!is_null($this->container['dtCustomerTransfersurvey']) && !preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", $this->container['dtCustomerTransfersurvey'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtCustomerTransfersurvey'])?'null':'"'.$this->container['dtCustomerTransfersurvey'].'"')." for 'dtCustomerTransfersurvey', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
        }
        ...
        //if (!preg_match("/^.{0,65535}$/", $this->container['tCustomerComment'])) {
        if (!is_null($this->container['tCustomerComment']) && !preg_match("/(*UTF8)^.{0,65535}$/", $this->container['tCustomerComment'])) {
            //$invalidProperties[] = "invalid value for 'tCustomerComment', must be conform to the pattern /^.{0,65535}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['tCustomerComment'])?'null':'"'.$this->container['tCustomerComment'].'"')." for 'tCustomerComment', must be conform to the pattern /^.{0,65535}$/.";
        }
        ...
        if (!is_null($this->container['iMPORTID']) && !preg_match("/(*UTF8)^.{0,15}$/", $this->container['iMPORTID'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['iMPORTID'])?'null':'"'.$this->container['iMPORTID'].'"')." for 'iMPORTID', must be conform to the pattern /^.{0,15}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($pkiCustomerID < 0)) {
        if (($pkiCustomerID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiCustomerID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCustomerID)?'null':'"'.$pkiCustomerID.'"').' for pkiCustomerID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiCompanyID > 255)) {
        if (($fkiCompanyID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCompanyID when calling CustomerResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCompanyID)?'null':'"'.$fkiCompanyID.'"').' for fkiCompanyID when calling CustomerResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($fkiCompanyID < 1)) {
        if (($fkiCompanyID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCompanyID when calling CustomerResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCompanyID)?'null':'"'.$fkiCompanyID.'"').' for fkiCompanyID when calling CustomerResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiCustomergroupID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCustomergroupID when calling CustomerResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCustomergroupID)?'null':'"'.$fkiCustomergroupID.'"').' for fkiCustomergroupID when calling CustomerResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($fkiCustomergroupID < 0)) {
        if (($fkiCustomergroupID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCustomergroupID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCustomergroupID)?'null':'"'.$fkiCustomergroupID.'"').' for fkiCustomergroupID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCustomerName) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sCustomerName)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCustomerName when calling CustomerResponseCompound., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCustomerName)?'null':'"'.$sCustomerName.'"')." for sCustomerName when calling CustomerResponseCompound., must conform to the pattern /^.{0,50}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCustomerNote) && (!preg_match("/(*UTF8)^.{0,25}$/", ObjectSerializer::toString($sCustomerNote)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCustomerNote when calling CustomerResponseCompound., must conform to the pattern /^.{0,25}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCustomerNote)?'null':'"'.$sCustomerNote.'"')." for sCustomerNote when calling CustomerResponseCompound., must conform to the pattern /^.{0,25}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiContactinformationsID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiContactinformationsID when calling CustomerResponseCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiContactinformationsID)?'null':'"'.$fkiContactinformationsID.'"').' for fkiContactinformationsID when calling CustomerResponseCompound., must be smaller than or equal to 16777215.');
        }
        //if (($fkiContactinformationsID < 0)) {
        if (($fkiContactinformationsID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiContactinformationsID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiContactinformationsID)?'null':'"'.$fkiContactinformationsID.'"').' for fkiContactinformationsID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiContactcontainerID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiContactcontainerID when calling CustomerResponseCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiContactcontainerID)?'null':'"'.$fkiContactcontainerID.'"').' for fkiContactcontainerID when calling CustomerResponseCompound., must be smaller than or equal to 16777215.');
        }
        //if (($fkiContactcontainerID < 0)) {
        if (($fkiContactcontainerID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiContactcontainerID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiContactcontainerID)?'null':'"'.$fkiContactcontainerID.'"').' for fkiContactcontainerID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiGlaccountcontainerID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiGlaccountcontainerID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiGlaccountcontainerID)?'null':'"'.$fkiGlaccountcontainerID.'"').' for fkiGlaccountcontainerID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiLanguageID > 2)) {
        if (($fkiLanguageID > 2)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling CustomerResponseCompound., must be smaller than or equal to 2.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling CustomerResponseCompound., must be smaller than or equal to 2.');
        }
        //if (($fkiLanguageID < 1)) {
        if (($fkiLanguageID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling CustomerResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling CustomerResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiDepartmentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDepartmentID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDepartmentID)?'null':'"'.$fkiDepartmentID.'"').' for fkiDepartmentID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiPaymentmethodID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiPaymentmethodID when calling CustomerResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPaymentmethodID)?'null':'"'.$fkiPaymentmethodID.'"').' for fkiPaymentmethodID when calling CustomerResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($fkiPaymentmethodID < 0)) {
        if (($fkiPaymentmethodID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiPaymentmethodID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPaymentmethodID)?'null':'"'.$fkiPaymentmethodID.'"').' for fkiPaymentmethodID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiElectronicfundstransferbankaccountID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiElectronicfundstransferbankaccountID when calling CustomerResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiElectronicfundstransferbankaccountID)?'null':'"'.$fkiElectronicfundstransferbankaccountID.'"').' for fkiElectronicfundstransferbankaccountID when calling CustomerResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiElectronicfundstransferbankaccountID < 0)) {
        if (($fkiElectronicfundstransferbankaccountID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiElectronicfundstransferbankaccountID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiElectronicfundstransferbankaccountID)?'null':'"'.$fkiElectronicfundstransferbankaccountID.'"').' for fkiElectronicfundstransferbankaccountID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiElectronicfundstransferbankaccountIDDirectdebit > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiElectronicfundstransferbankaccountIDDirectdebit when calling CustomerResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiElectronicfundstransferbankaccountIDDirectdebit)?'null':'"'.$fkiElectronicfundstransferbankaccountIDDirectdebit.'"').' for fkiElectronicfundstransferbankaccountIDDirectdebit when calling CustomerResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiElectronicfundstransferbankaccountIDDirectdebit < 0)) {
        if (($fkiElectronicfundstransferbankaccountIDDirectdebit < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiElectronicfundstransferbankaccountIDDirectdebit when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiElectronicfundstransferbankaccountIDDirectdebit)?'null':'"'.$fkiElectronicfundstransferbankaccountIDDirectdebit.'"').' for fkiElectronicfundstransferbankaccountIDDirectdebit when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiSendingmethodID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiSendingmethodID when calling CustomerResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiSendingmethodID)?'null':'"'.$fkiSendingmethodID.'"').' for fkiSendingmethodID when calling CustomerResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($fkiSendingmethodID < 0)) {
        if (($fkiSendingmethodID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiSendingmethodID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiSendingmethodID)?'null':'"'.$fkiSendingmethodID.'"').' for fkiSendingmethodID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiTaxassignmentID > 15)) {
            //throw new \InvalidArgumentException('invalid value for $fkiTaxassignmentID when calling CustomerResponseCompound., must be smaller than or equal to 15.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiTaxassignmentID)?'null':'"'.$fkiTaxassignmentID.'"').' for fkiTaxassignmentID when calling CustomerResponseCompound., must be smaller than or equal to 15.');
        }
        //if (($fkiTaxassignmentID < 0)) {
        if (($fkiTaxassignmentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiTaxassignmentID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiTaxassignmentID)?'null':'"'.$fkiTaxassignmentID.'"').' for fkiTaxassignmentID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiAttendancestatusID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiAttendancestatusID when calling CustomerResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAttendancestatusID)?'null':'"'.$fkiAttendancestatusID.'"').' for fkiAttendancestatusID when calling CustomerResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiAttendancestatusID < 0)) {
        if (($fkiAttendancestatusID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiAttendancestatusID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAttendancestatusID)?'null':'"'.$fkiAttendancestatusID.'"').' for fkiAttendancestatusID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiAgentIDVariableexpensechargeto < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiAgentIDVariableexpensechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAgentIDVariableexpensechargeto)?'null':'"'.$fkiAgentIDVariableexpensechargeto.'"').' for fkiAgentIDVariableexpensechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiBrokerIDVariableexpensechargeto < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBrokerIDVariableexpensechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBrokerIDVariableexpensechargeto)?'null':'"'.$fkiBrokerIDVariableexpensechargeto.'"').' for fkiBrokerIDVariableexpensechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiCustomerIDVariableexpensechargeto < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCustomerIDVariableexpensechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCustomerIDVariableexpensechargeto)?'null':'"'.$fkiCustomerIDVariableexpensechargeto.'"').' for fkiCustomerIDVariableexpensechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiGlaccountcontainerIDVariableexpensechargeto < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiGlaccountcontainerIDVariableexpensechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiGlaccountcontainerIDVariableexpensechargeto)?'null':'"'.$fkiGlaccountcontainerIDVariableexpensechargeto.'"').' for fkiGlaccountcontainerIDVariableexpensechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiAgentIDSupplychargechargeto < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiAgentIDSupplychargechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAgentIDSupplychargechargeto)?'null':'"'.$fkiAgentIDSupplychargechargeto.'"').' for fkiAgentIDSupplychargechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiBrokerIDSupplychargechargeto < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBrokerIDSupplychargechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBrokerIDSupplychargechargeto)?'null':'"'.$fkiBrokerIDSupplychargechargeto.'"').' for fkiBrokerIDSupplychargechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiCustomerIDSupplychargechargeto < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCustomerIDSupplychargechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCustomerIDSupplychargechargeto)?'null':'"'.$fkiCustomerIDSupplychargechargeto.'"').' for fkiCustomerIDSupplychargechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiGlaccountcontainerIDSupplychargechargeto < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiGlaccountcontainerIDSupplychargechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiGlaccountcontainerIDSupplychargechargeto)?'null':'"'.$fkiGlaccountcontainerIDSupplychargechargeto.'"').' for fkiGlaccountcontainerIDSupplychargechargeto when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiInvoicealternatelogoID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiInvoicealternatelogoID when calling CustomerResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiInvoicealternatelogoID)?'null':'"'.$fkiInvoicealternatelogoID.'"').' for fkiInvoicealternatelogoID when calling CustomerResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($fkiInvoicealternatelogoID < 0)) {
        if (($fkiInvoicealternatelogoID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiInvoicealternatelogoID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiInvoicealternatelogoID)?'null':'"'.$fkiInvoicealternatelogoID.'"').' for fkiInvoicealternatelogoID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiSynchronizationlinkserverID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiSynchronizationlinkserverID when calling CustomerResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiSynchronizationlinkserverID)?'null':'"'.$fkiSynchronizationlinkserverID.'"').' for fkiSynchronizationlinkserverID when calling CustomerResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($fkiSynchronizationlinkserverID < 0)) {
        if (($fkiSynchronizationlinkserverID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiSynchronizationlinkserverID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiSynchronizationlinkserverID)?'null':'"'.$fkiSynchronizationlinkserverID.'"').' for fkiSynchronizationlinkserverID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($efkiUserID) && ($efkiUserID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $efkiUserID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($efkiUserID)?'null':'"'.$efkiUserID.'"').' for efkiUserID when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($efksCustomerCode) && (!preg_match("/(*UTF8)^.{0,6}$/", ObjectSerializer::toString($efksCustomerCode)))) {
            //throw new \InvalidArgumentException("invalid value for \$efksCustomerCode when calling CustomerResponseCompound., must conform to the pattern /^.{0,6}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($efksCustomerCode)?'null':'"'.$efksCustomerCode.'"')." for efksCustomerCode when calling CustomerResponseCompound., must conform to the pattern /^.{0,6}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCustomerCode) && (!preg_match("/(*UTF8)^.{0,6}$/", ObjectSerializer::toString($sCustomerCode)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCustomerCode when calling CustomerResponseCompound., must conform to the pattern /^.{0,6}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCustomerCode)?'null':'"'.$sCustomerCode.'"')." for sCustomerCode when calling CustomerResponseCompound., must conform to the pattern /^.{0,6}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dCustomerFulltimeequivalent) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/", ObjectSerializer::toString($dCustomerFulltimeequivalent)))) {
            //throw new \InvalidArgumentException("invalid value for \$dCustomerFulltimeequivalent when calling CustomerResponseCompound., must conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dCustomerFulltimeequivalent)?'null':'"'.$dCustomerFulltimeequivalent.'"')." for dCustomerFulltimeequivalent when calling CustomerResponseCompound., must conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iCustomerPhotocopiercode > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $iCustomerPhotocopiercode when calling CustomerResponseCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCustomerPhotocopiercode)?'null':'"'.$iCustomerPhotocopiercode.'"').' for iCustomerPhotocopiercode when calling CustomerResponseCompound., must be smaller than or equal to 16777215.');
        }
        //if (($iCustomerPhotocopiercode < 0)) {
        if (($iCustomerPhotocopiercode < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iCustomerPhotocopiercode when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCustomerPhotocopiercode)?'null':'"'.$iCustomerPhotocopiercode.'"').' for iCustomerPhotocopiercode when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iCustomerLongdistancecode > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $iCustomerLongdistancecode when calling CustomerResponseCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCustomerLongdistancecode)?'null':'"'.$iCustomerLongdistancecode.'"').' for iCustomerLongdistancecode when calling CustomerResponseCompound., must be smaller than or equal to 16777215.');
        }
        //if (($iCustomerLongdistancecode < 0)) {
        if (($iCustomerLongdistancecode < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iCustomerLongdistancecode when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCustomerLongdistancecode)?'null':'"'.$iCustomerLongdistancecode.'"').' for iCustomerLongdistancecode when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iCustomerTimewindowstart > 255)) {
            //throw new \InvalidArgumentException('invalid value for $iCustomerTimewindowstart when calling CustomerResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCustomerTimewindowstart)?'null':'"'.$iCustomerTimewindowstart.'"').' for iCustomerTimewindowstart when calling CustomerResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($iCustomerTimewindowstart < 0)) {
        if (($iCustomerTimewindowstart < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iCustomerTimewindowstart when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCustomerTimewindowstart)?'null':'"'.$iCustomerTimewindowstart.'"').' for iCustomerTimewindowstart when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iCustomerTimewindowend > 255)) {
            //throw new \InvalidArgumentException('invalid value for $iCustomerTimewindowend when calling CustomerResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCustomerTimewindowend)?'null':'"'.$iCustomerTimewindowend.'"').' for iCustomerTimewindowend when calling CustomerResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($iCustomerTimewindowend < 0)) {
        if (($iCustomerTimewindowend < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iCustomerTimewindowend when calling CustomerResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCustomerTimewindowend)?'null':'"'.$iCustomerTimewindowend.'"').' for iCustomerTimewindowend when calling CustomerResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dCustomerMinimumchargeableinterests) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dCustomerMinimumchargeableinterests)))) {
            //throw new \InvalidArgumentException("invalid value for \$dCustomerMinimumchargeableinterests when calling CustomerResponseCompound., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dCustomerMinimumchargeableinterests)?'null':'"'.$dCustomerMinimumchargeableinterests.'"')." for dCustomerMinimumchargeableinterests when calling CustomerResponseCompound., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtCustomerBirthdate) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", ObjectSerializer::toString($dtCustomerBirthdate)))) {
            //throw new \InvalidArgumentException("invalid value for \$dtCustomerBirthdate when calling CustomerResponseCompound., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtCustomerBirthdate)?'null':'"'.$dtCustomerBirthdate.'"')." for dtCustomerBirthdate when calling CustomerResponseCompound., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtCustomerTransfer) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtCustomerTransfer)))) {
            //throw new \InvalidArgumentException("invalid value for \$dtCustomerTransfer when calling CustomerResponseCompound., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtCustomerTransfer)?'null':'"'.$dtCustomerTransfer.'"')." for dtCustomerTransfer when calling CustomerResponseCompound., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtCustomerTransferappointment) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtCustomerTransferappointment)))) {
            //throw new \InvalidArgumentException("invalid value for \$dtCustomerTransferappointment when calling CustomerResponseCompound., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtCustomerTransferappointment)?'null':'"'.$dtCustomerTransferappointment.'"')." for dtCustomerTransferappointment when calling CustomerResponseCompound., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtCustomerTransfersurvey) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtCustomerTransfersurvey)))) {
            //throw new \InvalidArgumentException("invalid value for \$dtCustomerTransfersurvey when calling CustomerResponseCompound., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtCustomerTransfersurvey)?'null':'"'.$dtCustomerTransfersurvey.'"')." for dtCustomerTransfersurvey when calling CustomerResponseCompound., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if ((!preg_match("/^.{0,65535}$/", ObjectSerializer::toString($tCustomerComment)))) {
        if (!is_null($tCustomerComment) && (!preg_match("/(*UTF8)^.{0,65535}$/", ObjectSerializer::toString($tCustomerComment)))) {
            //throw new \InvalidArgumentException("invalid value for \$tCustomerComment when calling CustomerResponseCompound., must conform to the pattern /^.{0,65535}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($tCustomerComment)?'null':'"'.$tCustomerComment.'"')." for tCustomerComment when calling CustomerResponseCompound., must conform to the pattern /^.{0,65535}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iMPORTID) && (!preg_match("/(*UTF8)^.{0,15}$/", ObjectSerializer::toString($iMPORTID)))) {
            //throw new \InvalidArgumentException("invalid value for \$iMPORTID when calling CustomerResponseCompound., must conform to the pattern /^.{0,15}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($iMPORTID)?'null':'"'.$iMPORTID.'"')." for iMPORTID when calling CustomerResponseCompound., must conform to the pattern /^.{0,15}$/.");
        }
