...
class CustomerResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['tCustomerComment']) && !preg_match("/(*UTF8)^.{0,16777215}$/", $this->container['tCustomerComment'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['tCustomerComment'])?'null':'"'.$this->container['tCustomerComment'].'"')." for 'tCustomerComment', must be conform to the pattern /^.{0,16777215}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($tCustomerComment) && (!preg_match("/(*UTF8)^.{0,16777215}$/", ObjectSerializer::toString($tCustomerComment)))) {
            //throw new \InvalidArgumentException("invalid value for \$tCustomerComment when calling CustomerResponseCompound., must conform to the pattern /^.{0,16777215}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($tCustomerComment)?'null':'"'.$tCustomerComment.'"')." for tCustomerComment when calling CustomerResponseCompound., must conform to the pattern /^.{0,16777215}$/.");
        }
