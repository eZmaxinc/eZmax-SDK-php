    ...
    */
	...
	//if (($pkiEzsignformfieldgroupsignerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignformfieldgroupsignerID when calling EzsignformfieldgroupsignerResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignformfieldgroupsignerID)?'null':'"'.$pkiEzsignformfieldgroupsignerID.'"').' for pkiEzsignformfieldgroupsignerID when calling EzsignformfieldgroupsignerResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignfoldersignerassociationID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldersignerassociationID when calling EzsignformfieldgroupsignerResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationID)?'null':'"'.$fkiEzsignfoldersignerassociationID.'"').' for fkiEzsignfoldersignerassociationID when calling EzsignformfieldgroupsignerResponse., must be bigger than or equal to 0.');
        }
