...
/**
 * CustomEzsigndocumentGetEzsignannotationsResponse Class Doc Comment
 *
 * @category Class
 * @description An Ezsigndocument Object in the context of a getEzsignannotations path
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomEzsigndocumentGetEzsignannotationsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Custom-EzsigndocumentGetEzsignannotations-Response';
    ...
    protected static $openAPITypes = [
        ...
        'aObjEzsignannotation' => '\eZmaxAPI\Model\EzsignannotationResponseCompound[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'aObjEzsignannotation' => 'a_objEzsignannotation'
    ];
    ...
    protected static $setters = [
        ...
        'aObjEzsignannotation' => 'setAObjEzsignannotation'
    ];
    ...
    protected static $getters = [
        ...
        'aObjEzsignannotation' => 'getAObjEzsignannotation'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aObjEzsignannotation', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aObjEzsignannotation'] === null) {
            $invalidProperties[] = "'aObjEzsignannotation' can't be null";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigndocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigndocumentID when calling CustomEzsigndocumentGetEzsignannotationsResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndocumentID)?'null':'"'.$pkiEzsigndocumentID.'"').' for pkiEzsigndocumentID when calling CustomEzsigndocumentGetEzsignannotationsResponse., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets aObjEzsignannotation
     *
     * @return \eZmaxAPI\Model\EzsignannotationResponseCompound[]
     */
    public function getAObjEzsignannotation()
    {
	//return $this->container['aObjEzsignannotation'];
        return $this->container['aObjEzsignannotation'];
    }

    /**
     * Sets aObjEzsignannotation
     *
     * @param \eZmaxAPI\Model\EzsignannotationResponseCompound[] $aObjEzsignannotation aObjEzsignannotation
     *
     * @return self
     */
    public function setAObjEzsignannotation($aObjEzsignannotation)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjEzsignannotation)) {
            //throw new \InvalidArgumentException('non-nullable aObjEzsignannotation cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjEzsignannotation'] = $aObjEzsignannotation;
        $this->container['aObjEzsignannotation'] = $aObjEzsignannotation;
