...
/**
 * EzsigndocumentGetActionableElementsV3ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /3/object/ezsigndocument/{pkiEzsigndocumentID}/getActionableElements
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsigndocumentGetActionableElementsV3ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigndocument-getActionableElements-v3-Response-mPayload';
