...
/**
 * UsergroupRequestCompound Class Doc Comment
 *
 * @category Class
...
class UsergroupRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'usergroup-RequestCompound';
...
//        if (($pkiUsergroupID < 1)) {
        if (!is_null($pkiUsergroupID) && ($pkiUsergroupID < 1)) {
            throw new \InvalidArgumentException('invalid value for $pkiUsergroupID when calling UsergroupRequestCompound., must be bigger than or equal to 1.');
        }
