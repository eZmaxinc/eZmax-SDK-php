...
class AddressRequest implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['fkiAddresstypeID'] = isset($data['fkiAddresstypeID']) ? $data['fkiAddresstypeID'] : null;
        $this->container['sAddressCivic'] = isset($data['sAddressCivic']) ? $data['sAddressCivic'] : null;
        $this->container['sAddressStreet'] = isset($data['sAddressStreet']) ? $data['sAddressStreet'] : null;
        $this->container['sAddressSuite'] = isset($data['sAddressSuite']) ? $data['sAddressSuite'] : null;
        $this->container['sAddressCity'] = isset($data['sAddressCity']) ? $data['sAddressCity'] : null;
        $this->container['fkiProvinceID'] = isset($data['fkiProvinceID']) ? $data['fkiProvinceID'] : null;
        $this->container['fkiCountryID'] = isset($data['fkiCountryID']) ? $data['fkiCountryID'] : null;
        $this->container['sAddressZip'] = isset($data['sAddressZip']) ? $data['sAddressZip'] : null;
    }
