...
class AddressRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiAddressID) && ($pkiAddressID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiAddressID when calling AddressRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiAddressID)?'null':'"'.$pkiAddressID.'"').' for pkiAddressID when calling AddressRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiAddresstypeID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAddresstypeID)?'null':'"'.$fkiAddresstypeID.'"').' for fkiAddresstypeID when calling AddressRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiProvinceID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiProvinceID)?'null':'"'.$fkiProvinceID.'"').' for fkiProvinceID when calling AddressRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiCountryID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCountryID)?'null':'"'.$fkiCountryID.'"').' for fkiCountryID when calling AddressRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fAddressLongitude) && (!preg_match("/(*UTF8)^(-?)(180(\\.0{1,15})?|((1[0-7]\\d)|(\\d{1,2}))(\\.\\d{1,15})?)$/", ObjectSerializer::toString($fAddressLongitude)))) {
            //throw new \InvalidArgumentException("invalid value for \$fAddressLongitude when calling AddressRequest., must conform to the pattern /^(-?)(180(\\.0{1,15})?|((1[0-7]\\d)|(\\d{1,2}))(\\.\\d{1,15})?)$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($fAddressLongitude)?'null':'"'.$fAddressLongitude.'"')." for fAddressLongitude when calling AddressRequest., must conform to the pattern /^(-?)(180(\\.0{1,15})?|((1[0-7]\\d)|(\\d{1,2}))(\\.\\d{1,15})?)$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fAddressLatitude) && (!preg_match("/(*UTF8)^(-?)(90(\\.0{1,15})?|([1-8]?\\d(\\.\\d{1,15})?))$/", ObjectSerializer::toString($fAddressLatitude)))) {
            //throw new \InvalidArgumentException("invalid value for \$fAddressLatitude when calling AddressRequest., must conform to the pattern /^(-?)(90(\\.0{1,15})?|([1-8]?\\d(\\.\\d{1,15})?))$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($fAddressLatitude)?'null':'"'.$fAddressLatitude.'"')." for fAddressLatitude when calling AddressRequest., must conform to the pattern /^(-?)(90(\\.0{1,15})?|([1-8]?\\d(\\.\\d{1,15})?))$/.");
        }
