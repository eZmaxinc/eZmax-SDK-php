...
/**
 * EzsigndocumentApplyEzsigntemplateglobalV1Request Class Doc Comment
 *
 * @category Class
 * @description Request for POST /1/object/ezsigndocument/{pkiEzsigndocumentID}/applyEzsigntemplateglobal
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsigndocumentApplyEzsigntemplateglobalV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigndocument-applyEzsigntemplateglobal-v1-Request';
    ...
    */
	...
	//if ((count($this->container['aSEzsigntemplateglobalsigner']) < 1)) {
        if (!is_null($this->container['aSEzsigntemplateglobalsigner']) && (count($this->container['aSEzsigntemplateglobalsigner']) < 1)) {
            $invalidProperties[] = "invalid value for 'aSEzsigntemplateglobalsigner', number of items must be greater than or equal to 1.";
        }
	...
	//if (($fkiEzsigntemplateglobalID < 0)) {
        if (($fkiEzsigntemplateglobalID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplateglobalID when calling EzsigndocumentApplyEzsigntemplateglobalV1Request., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateglobalID)?'null':'"'.$fkiEzsigntemplateglobalID.'"').' for fkiEzsigntemplateglobalID when calling EzsigndocumentApplyEzsigntemplateglobalV1Request., must be bigger than or equal to 0.');
        }
	...
	//if ((count($aSEzsigntemplateglobalsigner) < 1)) {
        if ((count($aSEzsigntemplateglobalsigner) < 1)) {
            //throw new \InvalidArgumentException('invalid length for $aSEzsigntemplateglobalsigner when calling EzsigndocumentApplyEzsigntemplateglobalV1Request., number of items must be greater than or equal to 1.');
	    throw new \InvalidArgumentException('invalid length for aSEzsigntemplateglobalsigner when calling EzsigndocumentApplyEzsigntemplateglobalV1Request., number of items must be greater than or equal to 1.');
        }
	...
	//if ((count($aPkiEzsignfoldersignerassociationID) < 1)) {
        if ((count($aPkiEzsignfoldersignerassociationID) < 1)) {
            //throw new \InvalidArgumentException('invalid length for $aPkiEzsignfoldersignerassociationID when calling EzsigndocumentApplyEzsigntemplateglobalV1Request., number of items must be greater than or equal to 1.');
	    throw new \InvalidArgumentException('invalid length for aPkiEzsignfoldersignerassociationID when calling EzsigndocumentApplyEzsigntemplateglobalV1Request., number of items must be greater than or equal to 1.');
        }
