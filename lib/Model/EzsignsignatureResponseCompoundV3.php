...
/**
 * EzsignsignatureResponseCompoundV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignsignatureResponseCompoundV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsignsignature-ResponseCompoundV3';
    ...
    protected static $openAPITypes = [
        ...
        'eEzsignsignatureSignaturepad' => '\eZmaxAPI\Model\FieldEEzsignsignatureSignaturepad',
        'eEzsignsignatureSignaturepadrequired' => '\eZmaxAPI\Model\FieldEEzsignsignatureSignaturepadrequired',
        ...
        'aObjEzsignsignaturecustomdate' => '\eZmaxAPI\Model\EzsignsignaturecustomdateResponseCompoundV2[]',
        ...
        'aObjEzsignsignaturepaymentdetail' => '\eZmaxAPI\Model\EzsignsignaturepaymentdetailResponseCompound[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'fkiFontID' => null,
        'fkiPaymentgatewayID' => null,
        'sCurrencyDescriptionX' => null,
        'dEzsignsignatureCreditcardamount' => null,
        'sEzsignsignatureCreditcardamountdescription' => null,
        'bEzsignsignatureCreditcardcustomamount' => null,
        ...
        'eEzsignsignatureSignaturepad' => null,
        'eEzsignsignatureSignaturepadrequired' => null,
        ...
        'aObjEzsignsignaturepaymentdetail' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'fkiFontID' => false,
        'fkiPaymentgatewayID' => false,
        'sCurrencyDescriptionX' => false,
        'dEzsignsignatureCreditcardamount' => false,
        'sEzsignsignatureCreditcardamountdescription' => false,
        ...
        'eEzsignsignatureSignaturepad' => false,
        'eEzsignsignatureSignaturepadrequired' => false,
        ...
        'aObjEzsignsignaturepaymentdetail' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'fkiFontID' => 'fkiFontID',
        'fkiPaymentgatewayID' => 'fkiPaymentgatewayID',
        'sCurrencyDescriptionX' => 'sCurrencyDescriptionX',
        'dEzsignsignatureCreditcardamount' => 'dEzsignsignatureCreditcardamount',
        'sEzsignsignatureCreditcardamountdescription' => 'sEzsignsignatureCreditcardamountdescription',
        'bEzsignsignatureCreditcardcustomamount' => 'bEzsignsignatureCreditcardcustomamount',
        ...
        'eEzsignsignatureSignaturepad' => 'eEzsignsignatureSignaturepad',
        'eEzsignsignatureSignaturepadrequired' => 'eEzsignsignatureSignaturepadrequired',
        ...
        'aObjEzsignsignaturepaymentdetail' => 'a_objEzsignsignaturepaymentdetail'
    ];
    ...
    protected static $setters = [
        ...
        'fkiPaymentgatewayID' => 'setFkiPaymentgatewayID',
        'sCurrencyDescriptionX' => 'setSCurrencyDescriptionX',
        'dEzsignsignatureCreditcardamount' => 'setDEzsignsignatureCreditcardamount',
        'sEzsignsignatureCreditcardamountdescription' => 'setSEzsignsignatureCreditcardamountdescription',
        'bEzsignsignatureCreditcardcustomamount' => 'setBEzsignsignatureCreditcardcustomamount',
        ...
        'eEzsignsignatureSignaturepad' => 'setEEzsignsignatureSignaturepad',
        'eEzsignsignatureSignaturepadrequired' => 'setEEzsignsignatureSignaturepadrequired',
        ...
        'aObjEzsignsignaturepaymentdetail' => 'setAObjEzsignsignaturepaymentdetail'
    ];
    ...
    protected static $getters = [
        ...
        'fkiPaymentgatewayID' => 'getFkiPaymentgatewayID',
        'sCurrencyDescriptionX' => 'getSCurrencyDescriptionX',
        'dEzsignsignatureCreditcardamount' => 'getDEzsignsignatureCreditcardamount',
        'sEzsignsignatureCreditcardamountdescription' => 'getSEzsignsignatureCreditcardamountdescription',
        'bEzsignsignatureCreditcardcustomamount' => 'getBEzsignsignatureCreditcardcustomamount',
        ...
        'eEzsignsignatureSignaturepad' => 'getEEzsignsignatureSignaturepad',
        'eEzsignsignatureSignaturepadrequired' => 'getEEzsignsignatureSignaturepadrequired',
        ...
        'aObjEzsignsignaturepaymentdetail' => 'getAObjEzsignsignaturepaymentdetail'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('fkiPaymentgatewayID', $data ?? [], null);
        $this->setIfExists('sCurrencyDescriptionX', $data ?? [], null);
        $this->setIfExists('dEzsignsignatureCreditcardamount', $data ?? [], null);
        $this->setIfExists('sEzsignsignatureCreditcardamountdescription', $data ?? [], null);
        $this->setIfExists('bEzsignsignatureCreditcardcustomamount', $data ?? [], null);
        ...
        $this->setIfExists('eEzsignsignatureSignaturepad', $data ?? [], null);
        $this->setIfExists('eEzsignsignatureSignaturepadrequired', $data ?? [], null);
        ...
        $this->setIfExists('aObjEzsignsignaturepaymentdetail', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['fkiPaymentgatewayID']) && ($this->container['fkiPaymentgatewayID'] > 255)) {
            $invalidProperties[] = "invalid value for 'fkiPaymentgatewayID', must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['fkiPaymentgatewayID']) && ($this->container['fkiPaymentgatewayID'] < 0)) {
            $invalidProperties[] = "invalid value for 'fkiPaymentgatewayID', must be bigger than or equal to 0.";
        }

        //if (!is_null($this->container['sCurrencyDescriptionX']) && !preg_match("/^.{1,20}$/", $this->container['sCurrencyDescriptionX'])) {
        if (!is_null($this->container['sCurrencyDescriptionX']) && !preg_match("/(*UTF8)^.{1,20}$/", $this->container['sCurrencyDescriptionX'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sCurrencyDescriptionX'])?'null':'"'.$this->container['sCurrencyDescriptionX'].'"')." for 'sCurrencyDescriptionX', must be conform to the pattern /^.{1,20}$/.";
        }

        //if (!is_null($this->container['dEzsignsignatureCreditcardamount']) && !preg_match("/^[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzsignsignatureCreditcardamount'])) {
        if (!is_null($this->container['dEzsignsignatureCreditcardamount']) && !preg_match("/(*UTF8)^[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzsignsignatureCreditcardamount'])) {
            //$invalidProperties[] = "invalid value for 'dEzsignsignatureCreditcardamount', must be conform to the pattern /^[\\d]{1,9}?\\.[\\d]{2}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzsignsignatureCreditcardamount'])?'null':'"'.$this->container['dEzsignsignatureCreditcardamount'].'"')." for 'dEzsignsignatureCreditcardamount', must be conform to the pattern /^[\\d]{1,9}?\\.[\\d]{2}$/.";
        }

        //if (!is_null($this->container['sEzsignsignatureCreditcardamountdescription']) && !preg_match("/^.{1,50}$/", $this->container['sEzsignsignatureCreditcardamountdescription'])) {
        if (!is_null($this->container['sEzsignsignatureCreditcardamountdescription']) && !preg_match("/(*UTF8)^.{1,50}$/", $this->container['sEzsignsignatureCreditcardamountdescription'])) {
            //$invalidProperties[] = "invalid value for 'sEzsignsignatureCreditcardamountdescription', must be conform to the pattern /^.{1,50}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsignsignatureCreditcardamountdescription'])?'null':'"'.$this->container['sEzsignsignatureCreditcardamountdescription'].'"')." for 'sEzsignsignatureCreditcardamountdescription', must be conform to the pattern /^.{1,50}$/.";
        }
        ...
        if (!is_null($this->container['sEzsignsigningreasonDescriptionX']) && !preg_match("/(*UTF8)^.{0,50}$/", $this->container['sEzsignsigningreasonDescriptionX'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsignsigningreasonDescriptionX'])?'null':'"'.$this->container['sEzsignsigningreasonDescriptionX'].'"')." for 'sEzsignsigningreasonDescriptionX', must be conform to the pattern /^.{0,50}$/.";
        }
        ...
        if (!is_null($this->container['dtEzsignsignatureDate']) && !preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", $this->container['dtEzsignsignatureDate'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtEzsignsignatureDate'])?'null':'"'.$this->container['dtEzsignsignatureDate'].'"')." for 'dtEzsignsignatureDate', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
        }
        ...
        if (!is_null($this->container['sEzsignsignatureRegexp']) && !preg_match("/(*UTF8)^\\^.*\\$$|^$/", $this->container['sEzsignsignatureRegexp'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsignsignatureRegexp'])?'null':'"'.$this->container['sEzsignsignatureRegexp'].'"')." for 'sEzsignsignatureRegexp', must be conform to the pattern /^\\^.*\\$$|^$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsignsignatureID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignatureID when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignatureID)?'null':'"'.$pkiEzsignsignatureID.'"').' for pkiEzsignsignatureID when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigndocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigndocumentID when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigndocumentID)?'null':'"'.$fkiEzsigndocumentID.'"').' for fkiEzsigndocumentID when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsignfoldersignerassociationID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldersignerassociationID when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationID)?'null':'"'.$fkiEzsignfoldersignerassociationID.'"').' for fkiEzsignfoldersignerassociationID when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignsigningreasonID) && ($fkiEzsignsigningreasonID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignsigningreasonID when calling EzsignsignatureResponseCompoundV3., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsigningreasonID)?'null':'"'.$fkiEzsignsigningreasonID.'"').' for fkiEzsignsigningreasonID when calling EzsignsignatureResponseCompoundV3., must be smaller than or equal to 255.');
        }
        //if (($fkiEzsignsigningreasonID < 0)) {
        if (!is_null($fkiEzsignsigningreasonID) && ($fkiEzsignsigningreasonID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignsigningreasonID when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsigningreasonID)?'null':'"'.$fkiEzsignsigningreasonID.'"').' for fkiEzsignsigningreasonID when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiFontID) && ($fkiFontID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFontID when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFontID)?'null':'"'.$fkiFontID.'"').' for fkiFontID when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets fkiPaymentgatewayID
     *
     * @return int|null
     */
    public function getFkiPaymentgatewayID()
    {
	//return $this->container['fkiPaymentgatewayID'];
        return $this->container['fkiPaymentgatewayID'];
    }

    /**
     * Sets fkiPaymentgatewayID
     *
     * @param int|null $fkiPaymentgatewayID The unique ID of the Paymentgateway
     *
     * @return self
     */
    public function setFkiPaymentgatewayID($fkiPaymentgatewayID)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($fkiPaymentgatewayID)) {
            //throw new \InvalidArgumentException('non-nullable fkiPaymentgatewayID cannot be null');
        //}

        //if (($fkiPaymentgatewayID > 255)) {
        if (!is_null($fkiPaymentgatewayID) && ($fkiPaymentgatewayID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiPaymentgatewayID when calling EzsignsignatureResponseCompoundV3., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPaymentgatewayID)?'null':'"'.$fkiPaymentgatewayID.'"').' for fkiPaymentgatewayID when calling EzsignsignatureResponseCompoundV3., must be smaller than or equal to 255.');
        }
        //if (($fkiPaymentgatewayID < 0)) {
        if (!is_null($fkiPaymentgatewayID) && ($fkiPaymentgatewayID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiPaymentgatewayID when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPaymentgatewayID)?'null':'"'.$fkiPaymentgatewayID.'"').' for fkiPaymentgatewayID when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['fkiPaymentgatewayID'] = $fkiPaymentgatewayID;
        $this->container['fkiPaymentgatewayID'] = (is_null($fkiPaymentgatewayID) ? null : (int) $fkiPaymentgatewayID);
     ...
     *
     * @param string|null $sCurrencyDescriptionX The description of the Currency in the language of the requester
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCurrencyDescriptionX) && (!preg_match("/(*UTF8)^.{1,20}$/", ObjectSerializer::toString($sCurrencyDescriptionX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sCurrencyDescriptionX when calling EzsignsignatureResponseCompoundV3., must conform to the pattern /^.{1,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCurrencyDescriptionX)?'null':'"'.$sCurrencyDescriptionX.'"')." for sCurrencyDescriptionX when calling EzsignsignatureResponseCompoundV3., must conform to the pattern /^.{1,20}$/.");
        }
    ...
    /**
     * Gets dEzsignsignatureCreditcardamount
     *
     * @return string|null
     */
    public function getDEzsignsignatureCreditcardamount()
    {
	//return $this->container['dEzsignsignatureCreditcardamount'];
        return is_null($this->container['dEzsignsignatureCreditcardamount']) ? null : trim($this->container['dEzsignsignatureCreditcardamount']);
    }

    /**
     * Sets dEzsignsignatureCreditcardamount
     *
     * @param string|null $dEzsignsignatureCreditcardamount The amount of the Creditcard signature
     *
     * @return self
     */
    public function setDEzsignsignatureCreditcardamount($dEzsignsignatureCreditcardamount)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($dEzsignsignatureCreditcardamount)) {
            //throw new \InvalidArgumentException('non-nullable dEzsignsignatureCreditcardamount cannot be null');
        //}

        //if ((!preg_match("/^[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzsignsignatureCreditcardamount)))) {
        if (!is_null($dEzsignsignatureCreditcardamount) && (!preg_match("/(*UTF8)^[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzsignsignatureCreditcardamount)))) {
            //throw new \InvalidArgumentException("invalid value for \$dEzsignsignatureCreditcardamount when calling EzsignsignatureResponseCompoundV3., must conform to the pattern /^[\\d]{1,9}?\\.[\\d]{2}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzsignsignatureCreditcardamount)?'null':'"'.$dEzsignsignatureCreditcardamount.'"')." for dEzsignsignatureCreditcardamount when calling EzsignsignatureResponseCompoundV3., must conform to the pattern /^[\\d]{1,9}?\\.[\\d]{2}$/.");
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['dEzsignsignatureCreditcardamount'] = $dEzsignsignatureCreditcardamount;
        $this->container['dEzsignsignatureCreditcardamount'] = (is_null($dEzsignsignatureCreditcardamount) ? null : trim((string) $dEzsignsignatureCreditcardamount));

        return $this;
    }

    /**
     * Gets sEzsignsignatureCreditcardamountdescription
     *
     * @return string|null
     */
    public function getSEzsignsignatureCreditcardamountdescription()
    {
	//return $this->container['sEzsignsignatureCreditcardamountdescription'];
        return is_null($this->container['sEzsignsignatureCreditcardamountdescription']) ? null : trim($this->container['sEzsignsignatureCreditcardamountdescription']);
    }

    /**
     * Sets sEzsignsignatureCreditcardamountdescription
     *
     * @param string|null $sEzsignsignatureCreditcardamountdescription The description of the Creditcard signature
     *
     * @return self
     */
    public function setSEzsignsignatureCreditcardamountdescription($sEzsignsignatureCreditcardamountdescription)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($sEzsignsignatureCreditcardamountdescription)) {
            //throw new \InvalidArgumentException('non-nullable sEzsignsignatureCreditcardamountdescription cannot be null');
        //}

        //if ((!preg_match("/^.{1,50}$/", ObjectSerializer::toString($sEzsignsignatureCreditcardamountdescription)))) {
        if (!is_null($sEzsignsignatureCreditcardamountdescription) && (!preg_match("/(*UTF8)^.{1,50}$/", ObjectSerializer::toString($sEzsignsignatureCreditcardamountdescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsignsignatureCreditcardamountdescription when calling EzsignsignatureResponseCompoundV3., must conform to the pattern /^.{1,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignsignatureCreditcardamountdescription)?'null':'"'.$sEzsignsignatureCreditcardamountdescription.'"')." for sEzsignsignatureCreditcardamountdescription when calling EzsignsignatureResponseCompoundV3., must conform to the pattern /^.{1,50}$/.");
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['sEzsignsignatureCreditcardamountdescription'] = $sEzsignsignatureCreditcardamountdescription;
        $this->container['sEzsignsignatureCreditcardamountdescription'] = (is_null($sEzsignsignatureCreditcardamountdescription) ? null : trim((string) $sEzsignsignatureCreditcardamountdescription));

        return $this;
    }

    /**
     * Gets bEzsignsignatureCreditcardcustomamount
     *
     * @return bool|null
     */
    public function getBEzsignsignatureCreditcardcustomamount()
    {
	//return $this->container['bEzsignsignatureCreditcardcustomamount'];
        return $this->container['bEzsignsignatureCreditcardcustomamount'];
    }

    /**
     * Sets bEzsignsignatureCreditcardcustomamount
     *
     * @param bool|null $bEzsignsignatureCreditcardcustomamount Whether we can enter a custom amount while signing an Ezsignsignature 'Creditcard' or not
     *
     * @return self
     */
    public function setBEzsignsignatureCreditcardcustomamount($bEzsignsignatureCreditcardcustomamount)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($bEzsignsignatureCreditcardcustomamount)) {
            //throw new \InvalidArgumentException('non-nullable bEzsignsignatureCreditcardcustomamount cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['bEzsignsignatureCreditcardcustomamount'] = $bEzsignsignatureCreditcardcustomamount;
        $this->container['bEzsignsignatureCreditcardcustomamount'] = (is_null($bEzsignsignatureCreditcardcustomamount) ? null : (bool) $bEzsignsignatureCreditcardcustomamount);
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignsigningreasonDescriptionX) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sEzsignsigningreasonDescriptionX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsignsigningreasonDescriptionX when calling EzsignsignatureResponseCompoundV3., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignsigningreasonDescriptionX)?'null':'"'.$sEzsignsigningreasonDescriptionX.'"')." for sEzsignsigningreasonDescriptionX when calling EzsignsignatureResponseCompoundV3., must conform to the pattern /^.{0,50}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsignpagePagenumber < 1)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignpagePagenumber when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignpagePagenumber)?'null':'"'.$iEzsignpagePagenumber.'"').' for iEzsignpagePagenumber when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsignsignatureX < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureX when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureX)?'null':'"'.$iEzsignsignatureX.'"').' for iEzsignsignatureX when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsignsignatureY < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureY when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureY)?'null':'"'.$iEzsignsignatureY.'"').' for iEzsignsignatureY when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsignsignatureHeight) && ($iEzsignsignatureHeight < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureHeight when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureHeight)?'null':'"'.$iEzsignsignatureHeight.'"').' for iEzsignsignatureHeight when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsignsignatureWidth) && ($iEzsignsignatureWidth < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureWidth when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureWidth)?'null':'"'.$iEzsignsignatureWidth.'"').' for iEzsignsignatureWidth when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets eEzsignsignatureSignaturepad
     *
     * @return \eZmaxAPI\Model\FieldEEzsignsignatureSignaturepad|null
     */
    public function getEEzsignsignatureSignaturepad()
    {
	//return $this->container['eEzsignsignatureSignaturepad'];
        return $this->container['eEzsignsignatureSignaturepad'];
    }

    /**
     * Sets eEzsignsignatureSignaturepad
     *
     * @param \eZmaxAPI\Model\FieldEEzsignsignatureSignaturepad|null $eEzsignsignatureSignaturepad eEzsignsignatureSignaturepad
     *
     * @return self
     */
    public function setEEzsignsignatureSignaturepad($eEzsignsignatureSignaturepad)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($eEzsignsignatureSignaturepad)) {
            //throw new \InvalidArgumentException('non-nullable eEzsignsignatureSignaturepad cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['eEzsignsignatureSignaturepad'] = $eEzsignsignatureSignaturepad;
        $this->container['eEzsignsignatureSignaturepad'] = $eEzsignsignatureSignaturepad;
    ...
    /**
     * Gets eEzsignsignatureSignaturepadrequired
     *
     * @return \eZmaxAPI\Model\FieldEEzsignsignatureSignaturepadrequired|null
     */
    public function getEEzsignsignatureSignaturepadrequired()
    {
	//return $this->container['eEzsignsignatureSignaturepadrequired'];
        return $this->container['eEzsignsignatureSignaturepadrequired'];
    }

    /**
     * Sets eEzsignsignatureSignaturepadrequired
     *
     * @param \eZmaxAPI\Model\FieldEEzsignsignatureSignaturepadrequired|null $eEzsignsignatureSignaturepadrequired eEzsignsignatureSignaturepadrequired
     *
     * @return self
     */
    public function setEEzsignsignatureSignaturepadrequired($eEzsignsignatureSignaturepadrequired)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($eEzsignsignatureSignaturepadrequired)) {
            //throw new \InvalidArgumentException('non-nullable eEzsignsignatureSignaturepadrequired cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['eEzsignsignatureSignaturepadrequired'] = $eEzsignsignatureSignaturepadrequired;
        $this->container['eEzsignsignatureSignaturepadrequired'] = $eEzsignsignatureSignaturepadrequired;
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignfoldersignerassociationIDValidation) && ($fkiEzsignfoldersignerassociationIDValidation < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldersignerassociationIDValidation when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationIDValidation)?'null':'"'.$fkiEzsignfoldersignerassociationIDValidation.'"').' for fkiEzsignfoldersignerassociationIDValidation when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtEzsignsignatureDate) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtEzsignsignatureDate)))) {
            //throw new \InvalidArgumentException("invalid value for \$dtEzsignsignatureDate when calling EzsignsignatureResponseCompoundV3., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtEzsignsignatureDate)?'null':'"'.$dtEzsignsignatureDate.'"')." for dtEzsignsignatureDate when calling EzsignsignatureResponseCompoundV3., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsignsignatureMaxlength) && ($iEzsignsignatureMaxlength > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureMaxlength when calling EzsignsignatureResponseCompoundV3., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureMaxlength)?'null':'"'.$iEzsignsignatureMaxlength.'"').' for iEzsignsignatureMaxlength when calling EzsignsignatureResponseCompoundV3., must be smaller than or equal to 65535.');
        }
        //if (($iEzsignsignatureMaxlength < 0)) {
        if (!is_null($iEzsignsignatureMaxlength) && ($iEzsignsignatureMaxlength < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureMaxlength when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureMaxlength)?'null':'"'.$iEzsignsignatureMaxlength.'"').' for iEzsignsignatureMaxlength when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignsignatureTextvalidationcustommessage) && (mb_strlen($sEzsignsignatureTextvalidationcustommessage) > 50)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsignsignatureTextvalidationcustommessage when calling EzsignsignatureResponseCompoundV3., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignsignatureTextvalidationcustommessage)?'null':'"'.$sEzsignsignatureTextvalidationcustommessage.'"').', invalid length for sEzsignsignatureTextvalidationcustommessage when calling EzsignsignatureResponseCompoundV3., must be smaller than or equal to 50.');
        }
        ...
        if (!is_null($sEzsignsignatureTextvalidationcustommessage) && (mb_strlen($sEzsignsignatureTextvalidationcustommessage) < 0)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsignsignatureTextvalidationcustommessage when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignsignatureTextvalidationcustommessage)?'null':'"'.$sEzsignsignatureTextvalidationcustommessage.'"').', invalid length for sEzsignsignatureTextvalidationcustommessage when calling EzsignsignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignsignatureRegexp) && (!preg_match("/(*UTF8)^\\^.*\\$$|^$/", ObjectSerializer::toString($sEzsignsignatureRegexp)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsignsignatureRegexp when calling EzsignsignatureResponseCompoundV3., must conform to the pattern /^\\^.*\\$$|^$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignsignatureRegexp)?'null':'"'.$sEzsignsignatureRegexp.'"')." for sEzsignsignatureRegexp when calling EzsignsignatureResponseCompoundV3., must conform to the pattern /^\\^.*\\$$|^$/.");
        }
     ...
     *
     * @return \eZmaxAPI\Model\EzsignsignaturecustomdateResponseCompoundV2[]|null
     */
     ...
     *
     * @param \eZmaxAPI\Model\EzsignsignaturecustomdateResponseCompoundV2[]|null $aObjEzsignsignaturecustomdate An array of custom date blocks that will be filled at the time of signature.  Can only be used if bEzsignsignatureCustomdate is true.  Use an empty array if you don't want to have a date at all.
     *
     * @return self
     */
    ...
    /**
     * Gets aObjEzsignsignaturepaymentdetail
     *
     * @return \eZmaxAPI\Model\EzsignsignaturepaymentdetailResponseCompound[]|null
     */
    public function getAObjEzsignsignaturepaymentdetail()
    {
	//return $this->container['aObjEzsignsignaturepaymentdetail'];
        return $this->container['aObjEzsignsignaturepaymentdetail'];
    }

    /**
     * Sets aObjEzsignsignaturepaymentdetail
     *
     * @param \eZmaxAPI\Model\EzsignsignaturepaymentdetailResponseCompound[]|null $aObjEzsignsignaturepaymentdetail aObjEzsignsignaturepaymentdetail
     *
     * @return self
     */
    public function setAObjEzsignsignaturepaymentdetail($aObjEzsignsignaturepaymentdetail)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjEzsignsignaturepaymentdetail)) {
            //throw new \InvalidArgumentException('non-nullable aObjEzsignsignaturepaymentdetail cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjEzsignsignaturepaymentdetail'] = $aObjEzsignsignaturepaymentdetail;
        $this->container['aObjEzsignsignaturepaymentdetail'] = $aObjEzsignsignaturepaymentdetail;
