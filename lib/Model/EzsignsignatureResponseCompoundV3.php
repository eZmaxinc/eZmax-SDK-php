...
class EzsignsignatureResponseCompoundV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//if (!is_null($this->container['dEzsignsignatureCreditcardamount']) && !preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzsignsignatureCreditcardamount'])) {
        if (!is_null($this->container['dEzsignsignatureCreditcardamount']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzsignsignatureCreditcardamount'])) {
        //    $invalidProperties[] = "invalid value for 'dEzsignsignatureCreditcardamount', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzsignsignatureCreditcardamount'])?'null':'"'.$this->container['dEzsignsignatureCreditcardamount'].'"')." for 'dEzsignsignatureCreditcardamount', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
	...
	//if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzsignsignatureCreditcardamount)))) {
        if (!is_null($dEzsignsignatureCreditcardamount) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzsignsignatureCreditcardamount)))) {
	    //throw new \InvalidArgumentException("invalid value for \$dEzsignsignatureCreditcardamount when calling EzsignsignatureResponseCompoundV3., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzsignsignatureCreditcardamount)?'null':'"'.$dEzsignsignatureCreditcardamount.'"')." for dEzsignsignatureCreditcardamount when calling EzsignsignatureResponseCompoundV3., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
