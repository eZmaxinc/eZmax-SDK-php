    ...
    */
	...
	//if (($pkiSystemconfigurationID > 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiSystemconfigurationID when calling SystemconfigurationResponseCompound., must be smaller than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSystemconfigurationID)?'null':'"'.$pkiSystemconfigurationID.'"').' for pkiSystemconfigurationID when calling SystemconfigurationResponseCompound., must be smaller than or equal to 1.');
        }
	//if (($pkiSystemconfigurationID < 1)) {
        if (($pkiSystemconfigurationID < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiSystemconfigurationID when calling SystemconfigurationResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSystemconfigurationID)?'null':'"'.$pkiSystemconfigurationID.'"').' for pkiSystemconfigurationID when calling SystemconfigurationResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//if (($fkiSystemconfigurationtypeID < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiSystemconfigurationtypeID when calling SystemconfigurationResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiSystemconfigurationtypeID)?'null':'"'.$fkiSystemconfigurationtypeID.'"').' for fkiSystemconfigurationtypeID when calling SystemconfigurationResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//if (($fkiBrandingID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiBrandingID when calling SystemconfigurationResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBrandingID)?'null':'"'.$fkiBrandingID.'"').' for fkiBrandingID when calling SystemconfigurationResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiTimezoneIDDefault < 0)) {
        if (($fkiTimezoneIDDefault < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiTimezoneIDDefault when calling SystemconfigurationResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiTimezoneIDDefault)?'null':'"'.$fkiTimezoneIDDefault.'"').' for fkiTimezoneIDDefault when calling SystemconfigurationResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", ObjectSerializer::toString($dtSystemconfigurationReadonlyexpirationend)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dtSystemconfigurationReadonlyexpirationend when calling SystemconfigurationResponseCompound., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtSystemconfigurationReadonlyexpirationend)?'null':'"'.$dtSystemconfigurationReadonlyexpirationend.'"')." for dtSystemconfigurationReadonlyexpirationend when calling SystemconfigurationResponseCompound., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
        }
	...
	//if (($iSystemconfigurationEzsignreminderhoursend > 23)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iSystemconfigurationEzsignreminderhoursend when calling SystemconfigurationResponseCompound., must be smaller than or equal to 23.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iSystemconfigurationEzsignreminderhoursend)?'null':'"'.$iSystemconfigurationEzsignreminderhoursend.'"').' for iSystemconfigurationEzsignreminderhoursend when calling SystemconfigurationResponseCompound., must be smaller than or equal to 23.');
        }
	//if (($iSystemconfigurationEzsignreminderhoursend < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iSystemconfigurationEzsignreminderhoursend when calling SystemconfigurationResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iSystemconfigurationEzsignreminderhoursend)?'null':'"'.$iSystemconfigurationEzsignreminderhoursend.'"').' for iSystemconfigurationEzsignreminderhoursend when calling SystemconfigurationResponseCompound., must be bigger than or equal to 0.');
        }
