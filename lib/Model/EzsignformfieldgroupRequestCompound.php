...
class EzsignformfieldgroupRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzsignformfieldgroupID) && ($pkiEzsignformfieldgroupID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsignformfieldgroupID when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignformfieldgroupID)?'null':'"'.$pkiEzsignformfieldgroupID.'"').' for pkiEzsignformfieldgroupID when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigndocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigndocumentID when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigndocumentID)?'null':'"'.$fkiEzsigndocumentID.'"').' for fkiEzsigndocumentID when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if ((mb_strlen($sEzsignformfieldgroupLabel) > 50)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupLabel when calling EzsignformfieldgroupRequestCompound., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupLabel)?'null':'"'.$sEzsignformfieldgroupLabel.'"').', invalid length for sEzsignformfieldgroupLabel when calling EzsignformfieldgroupRequestCompound., must be smaller than or equal to 50.');
        }
        //if ((mb_strlen($sEzsignformfieldgroupLabel) < 1)) {
        if ((mb_strlen($sEzsignformfieldgroupLabel) < 1)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupLabel when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupLabel)?'null':'"'.$sEzsignformfieldgroupLabel.'"').', invalid length for sEzsignformfieldgroupLabel when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsignformfieldgroupStep < 1)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupStep when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupStep)?'null':'"'.$iEzsignformfieldgroupStep.'"').' for iEzsignformfieldgroupStep when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsignformfieldgroupFilledmin < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupFilledmin when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupFilledmin)?'null':'"'.$iEzsignformfieldgroupFilledmin.'"').' for iEzsignformfieldgroupFilledmin when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsignformfieldgroupFilledmax < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupFilledmax when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupFilledmax)?'null':'"'.$iEzsignformfieldgroupFilledmax.'"').' for iEzsignformfieldgroupFilledmax when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsignformfieldgroupMaxlength) && ($iEzsignformfieldgroupMaxlength > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupMaxlength when calling EzsignformfieldgroupRequestCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupMaxlength)?'null':'"'.$iEzsignformfieldgroupMaxlength.'"').' for iEzsignformfieldgroupMaxlength when calling EzsignformfieldgroupRequestCompound., must be smaller than or equal to 65535.');
        }
        //if (($iEzsignformfieldgroupMaxlength < 0)) {
        if (!is_null($iEzsignformfieldgroupMaxlength) && ($iEzsignformfieldgroupMaxlength < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignformfieldgroupMaxlength when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignformfieldgroupMaxlength)?'null':'"'.$iEzsignformfieldgroupMaxlength.'"').' for iEzsignformfieldgroupMaxlength when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignformfieldgroupRegexp) && (!preg_match("/(*UTF8)^\\^.*\\$$|^$/", ObjectSerializer::toString($sEzsignformfieldgroupRegexp)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignformfieldgroupRegexp)?'null':'"'.$sEzsignformfieldgroupRegexp.'"')." for sEzsignformfieldgroupRegexp when calling EzsignformfieldgroupRequestCompound., must conform to the pattern /^\\^.*\\$$|^$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignformfieldgroupTextvalidationcustommessage) && (mb_strlen($sEzsignformfieldgroupTextvalidationcustommessage) > 50)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupTextvalidationcustommessage when calling EzsignformfieldgroupRequestCompound., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupTextvalidationcustommessage)?'null':'"'.$sEzsignformfieldgroupTextvalidationcustommessage.'"').', invalid length for sEzsignformfieldgroupTextvalidationcustommessage when calling EzsignformfieldgroupRequestCompound., must be smaller than or equal to 50.');
        }
        ...
        if (!is_null($sEzsignformfieldgroupTextvalidationcustommessage) && (mb_strlen($sEzsignformfieldgroupTextvalidationcustommessage) < 0)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupTextvalidationcustommessage when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupTextvalidationcustommessage)?'null':'"'.$sEzsignformfieldgroupTextvalidationcustommessage.'"').', invalid length for sEzsignformfieldgroupTextvalidationcustommessage when calling EzsignformfieldgroupRequestCompound., must be bigger than or equal to 0.');
        }
