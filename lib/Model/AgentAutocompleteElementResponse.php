...
/**
 * AgentAutocompleteElementResponse Class Doc Comment
 *
 * @category Class
 * @description A Agent AutocompleteElement Response
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AgentAutocompleteElementResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'agent-AutocompleteElement-Response';
    ...
    */
	...
	//if (($pkiAgentID < 0)) {
        if (($pkiAgentID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiAgentID when calling AgentAutocompleteElementResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiAgentID)?'null':'"'.$pkiAgentID.'"').' for pkiAgentID when calling AgentAutocompleteElementResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiDepartmentID < 0)) {
        if (($fkiDepartmentID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiDepartmentID when calling AgentAutocompleteElementResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDepartmentID)?'null':'"'.$fkiDepartmentID.'"').' for fkiDepartmentID when calling AgentAutocompleteElementResponse., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{1,20}$/", ObjectSerializer::toString($sContactFirstname)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sContactFirstname when calling AgentAutocompleteElementResponse., must conform to the pattern /^.{1,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sContactFirstname)?'null':'"'.$sContactFirstname.'"')." for sContactFirstname when calling AgentAutocompleteElementResponse., must conform to the pattern /^.{1,20}$/.");
        }
	...
	//if ((!preg_match("/^.{1,25}$/", ObjectSerializer::toString($sContactLastname)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sContactLastname when calling AgentAutocompleteElementResponse., must conform to the pattern /^.{1,25}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sContactLastname)?'null':'"'.$sContactLastname.'"')." for sContactLastname when calling AgentAutocompleteElementResponse., must conform to the pattern /^.{1,25}$/.");
        }
