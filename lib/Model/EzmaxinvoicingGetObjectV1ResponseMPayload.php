...
/**
 * EzmaxinvoicingGetObjectV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 ...
 */
class EzmaxinvoicingGetObjectV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezmaxinvoicing-getObject-v1-Response-mPayload';
    ...
    */
    ...
    public function setPkiEzmaxinvoicingID($pkiEzmaxinvoicingID)
    {
        ...
        if (!is_null($pkiEzmaxinvoicingID) && ($pkiEzmaxinvoicingID < 0)) {
            throw new \InvalidArgumentException('invalid value for $pkiEzmaxinvoicingID when calling EzmaxinvoicingGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setFkiEzmaxinvoicingcontractID($fkiEzmaxinvoicingcontractID)
    {
        ...
        if (($fkiEzmaxinvoicingcontractID < 1)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzmaxinvoicingcontractID when calling EzmaxinvoicingGetObjectV1ResponseMPayload., must be bigger than or equal to 1.');
        }
    ...
    public function setFkiEzmaxpricingID($fkiEzmaxpricingID)
    {
        ...
        if (($fkiEzmaxpricingID < 1)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzmaxpricingID when calling EzmaxinvoicingGetObjectV1ResponseMPayload., must be bigger than or equal to 1.');
        }
    ...
    public function setFkiSystemconfigurationtypeID($fkiSystemconfigurationtypeID)
    {
        ...
        if (($fkiSystemconfigurationtypeID < 1)) {
            throw new \InvalidArgumentException('invalid value for $fkiSystemconfigurationtypeID when calling EzmaxinvoicingGetObjectV1ResponseMPayload., must be bigger than or equal to 1.');
        }
    ...
    public function setYyyymmEzmaxinvoicing($yyyymmEzmaxinvoicing)
    {
        if ((mb_strlen($yyyymmEzmaxinvoicing) > 7)) {
            throw new \InvalidArgumentException('invalid length for $yyyymmEzmaxinvoicing when calling EzmaxinvoicingGetObjectV1ResponseMPayload., must be smaller than or equal to 7.');
        }
    ...
    public function setIEzmaxinvoicingDays($iEzmaxinvoicingDays)
    {
        ...
        if (($iEzmaxinvoicingDays < 1)) {
            throw new \InvalidArgumentException('invalid value for $iEzmaxinvoicingDays when calling EzmaxinvoicingGetObjectV1ResponseMPayload., must be bigger than or equal to 1.');
        }
    ...
    public function setDEzmaxinvoicingRebatepaymenttype($dEzmaxinvoicingRebatepaymenttype)
    {
        ...
        if ((!preg_match("/^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/", $dEzmaxinvoicingRebatepaymenttype))) {
            throw new \InvalidArgumentException("invalid value for \$dEzmaxinvoicingRebatepaymenttype when calling EzmaxinvoicingGetObjectV1ResponseMPayload., must conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.");
        }
    ...
    public function setIEzmaxinvoicingContractlength($iEzmaxinvoicingContractlength)
    {
        ...
        if (($iEzmaxinvoicingContractlength < 1)) {
            throw new \InvalidArgumentException('invalid value for $iEzmaxinvoicingContractlength when calling EzmaxinvoicingGetObjectV1ResponseMPayload., must be bigger than or equal to 1.');
        }
    ...
    public function setDEzmaxinvoicingRebatecontractlength($dEzmaxinvoicingRebatecontractlength)
    {
        ...
        if ((!preg_match("/^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/", $dEzmaxinvoicingRebatecontractlength))) {
            throw new \InvalidArgumentException("invalid value for \$dEzmaxinvoicingRebatecontractlength when calling EzmaxinvoicingGetObjectV1ResponseMPayload., must conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.");
        }
