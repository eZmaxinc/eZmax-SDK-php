    ...
    */
	...
	//if (($pkiCompanyID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiCompanyID when calling CompanyAutocompleteElementResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCompanyID)?'null':'"'.$pkiCompanyID.'"').' for pkiCompanyID when calling CompanyAutocompleteElementResponse., must be smaller than or equal to 255.');
        }
	//if (($pkiCompanyID < 1)) {
        if (($pkiCompanyID < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiCompanyID when calling CompanyAutocompleteElementResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCompanyID)?'null':'"'.$pkiCompanyID.'"').' for pkiCompanyID when calling CompanyAutocompleteElementResponse., must be bigger than or equal to 1.');
        }
