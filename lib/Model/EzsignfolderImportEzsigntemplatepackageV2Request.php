...
/**
 * EzsignfolderImportEzsigntemplatepackageV2Request Class Doc Comment
 *
 * @category Class
 * @description Request for POST /2/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsignfolderImportEzsigntemplatepackageV2Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsignfolder-importEzsigntemplatepackage-v2-Request';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigntemplatepackageID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepackageID when calling EzsignfolderImportEzsigntemplatepackageV2Request., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatepackageID)?'null':'"'.$fkiEzsigntemplatepackageID.'"').' for fkiEzsigntemplatepackageID when calling EzsignfolderImportEzsigntemplatepackageV2Request., must be bigger than or equal to 0.');
        }
