...
/**
 * EzsigntemplatepackagemembershipRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplatepackagemembershipRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigntemplatepackagemembership-Request';
    ...
    */
	...
	//if (($pkiEzsigntemplatepackagemembershipID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatepackagemembershipID when calling EzsigntemplatepackagemembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepackagemembershipID)?'null':'"'.$pkiEzsigntemplatepackagemembershipID.'"').' for pkiEzsigntemplatepackagemembershipID when calling EzsigntemplatepackagemembershipRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatepackageID < 0)) {
        if (($fkiEzsigntemplatepackageID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepackageID when calling EzsigntemplatepackagemembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatepackageID)?'null':'"'.$fkiEzsigntemplatepackageID.'"').' for fkiEzsigntemplatepackageID when calling EzsigntemplatepackagemembershipRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplateID < 0)) {
        if (($fkiEzsigntemplateID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplateID when calling EzsigntemplatepackagemembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateID)?'null':'"'.$fkiEzsigntemplateID.'"').' for fkiEzsigntemplateID when calling EzsigntemplatepackagemembershipRequest., must be bigger than or equal to 0.');
        }
