...
/**
 * CustomEzmaxinvoicingEzsignfolderResponseAllOf Class Doc Comment
 *
 * @category Class
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 ...
 */
class CustomEzmaxinvoicingEzsignfolderResponseAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Custom_EzmaxinvoicingEzsignfolder_Response_allOf';
    ...
    */
    ...
    public function setFkiEzsignfolderID($fkiEzsignfolderID)
    {
        ...
        if (($fkiEzsignfolderID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsignfolderID when calling CustomEzmaxinvoicingEzsignfolderResponseAllOf., must be bigger than or equal to 0.');
        }
