...
class AuthenticationexternalResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//if ((!preg_match("/^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/", ObjectSerializer::toString($sAuthenticationexternalAuthorizationurl)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sAuthenticationexternalAuthorizationurl when calling AuthenticationexternalResponse., must conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sAuthenticationexternalAuthorizationurl)?'null':'"'.$sAuthenticationexternalAuthorizationurl.'"')." for sAuthenticationexternalAuthorizationurl when calling AuthenticationexternalResponse., must conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.");
        }
