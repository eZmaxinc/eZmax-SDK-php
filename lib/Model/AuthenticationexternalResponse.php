...
/**
 * AuthenticationexternalResponse Class Doc Comment
 *
 * @category Class
 * @description A Authenticationexternal Object
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AuthenticationexternalResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'authenticationexternal-Response';
    ...
    */
	...
	//if (!is_null($this->container['sAuthenticationexternalAuthorizationurl']) && !preg_match("/^https:\/\/[^\\s\/$.?#].[^\\s]*$/", $this->container['sAuthenticationexternalAuthorizationurl'])) {
        if (!is_null($this->container['sAuthenticationexternalAuthorizationurl']) && !preg_match("/(*UTF8)^https:\/\/[^\\s\/$.?#].[^\\s]*$/", $this->container['sAuthenticationexternalAuthorizationurl'])) {
        //    $invalidProperties[] = "invalid value for 'sAuthenticationexternalAuthorizationurl', must be conform to the pattern /^https:\/\/[^\\s\/$.?#].[^\\s]*$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sAuthenticationexternalAuthorizationurl'])?'null':'"'.$this->container['sAuthenticationexternalAuthorizationurl'].'"')." for 'sAuthenticationexternalAuthorizationurl', must be conform to the pattern /^https:\/\/[^\\s\/$.?#].[^\\s]*$/.";
        }
	...
	//if (($pkiAuthenticationexternalID > 255)) {
        if (($pkiAuthenticationexternalID > 255)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiAuthenticationexternalID when calling AuthenticationexternalResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiAuthenticationexternalID)?'null':'"'.$pkiAuthenticationexternalID.'"').' for pkiAuthenticationexternalID when calling AuthenticationexternalResponse., must be smaller than or equal to 255.');
        }
	//if (($pkiAuthenticationexternalID < 0)) {
        if (($pkiAuthenticationexternalID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiAuthenticationexternalID when calling AuthenticationexternalResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiAuthenticationexternalID)?'null':'"'.$pkiAuthenticationexternalID.'"').' for pkiAuthenticationexternalID when calling AuthenticationexternalResponse., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{0,50}$/", ObjectSerializer::toString($sAuthenticationexternalDescription)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sAuthenticationexternalDescription when calling AuthenticationexternalResponse., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sAuthenticationexternalDescription)?'null':'"'.$sAuthenticationexternalDescription.'"')." for sAuthenticationexternalDescription when calling AuthenticationexternalResponse., must conform to the pattern /^.{0,50}$/.");
        }
	...
	//if ((!preg_match("/^https:\/\/[^\\s\/$.?#].[^\\s]*$/", ObjectSerializer::toString($sAuthenticationexternalAuthorizationurl)))) {
        if (!is_null($sAuthenticationexternalAuthorizationurl) && (!preg_match("/(*UTF8)^https:\/\/[^\\s\/$.?#].[^\\s]*$/", ObjectSerializer::toString($sAuthenticationexternalAuthorizationurl)))) {
	    //throw new \InvalidArgumentException("invalid value for \$sAuthenticationexternalAuthorizationurl when calling AuthenticationexternalResponse., must conform to the pattern /^https:\/\/[^\\s\/$.?#].[^\\s]*$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sAuthenticationexternalAuthorizationurl)?'null':'"'.$sAuthenticationexternalAuthorizationurl.'"')." for sAuthenticationexternalAuthorizationurl when calling AuthenticationexternalResponse., must conform to the pattern /^https:\/\/[^\\s\/$.?#].[^\\s]*$/.");
        }
