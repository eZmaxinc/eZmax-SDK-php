...
/**
 * PurchaseGetListV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /1/object/purchase/getList
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PurchaseGetListV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'purchase-getList-v1-Response-mPayload';
    ...
    protected static $openAPITypes = [
        'iRowReturned' => 'int',
        'iRowFiltered' => 'int',
        'aObjPurchase' => '\eZmaxAPI\Model\PurchaseListElement[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aObjPurchase', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aObjPurchase'] === null) {
            $invalidProperties[] = "'aObjPurchase' can't be null";
        }
     ...
     * Gets aObjPurchase
     *
     * @return \eZmaxAPI\Model\PurchaseListElement[]
     */
    public function getAObjPurchase()
    {
	//return $this->container['aObjPurchase'];
        return $this->container['aObjPurchase'];
    }
     ...
     * Sets aObjPurchase
     *
     * @param \eZmaxAPI\Model\PurchaseListElement[] $aObjPurchase aObjPurchase
     *
     * @return self
     */
    public function setAObjPurchase($aObjPurchase)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjPurchase)) {
            //throw new \InvalidArgumentException('non-nullable aObjPurchase cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjPurchase'] = $aObjPurchase;
        $this->container['aObjPurchase'] = $aObjPurchase;
