...
class EzsigndocumentGetFormDataV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('objFormDataDocument', $data ?? [], null);
    }
    ...
    */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($objFormDataDocument)) {
            //throw new \InvalidArgumentException('non-nullable objFormDataDocument cannot be null');
        //}
