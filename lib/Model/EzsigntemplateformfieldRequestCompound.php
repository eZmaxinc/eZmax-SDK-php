    ...
    */
	...
	//if (($pkiEzsigntemplateformfieldID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplateformfieldID when calling EzsigntemplateformfieldRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateformfieldID)?'null':'"'.$pkiEzsigntemplateformfieldID.'"').' for pkiEzsigntemplateformfieldID when calling EzsigntemplateformfieldRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatedocumentpagePagenumber < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagePagenumber when calling EzsigntemplateformfieldRequestCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagePagenumber)?'null':'"'.$iEzsigntemplatedocumentpagePagenumber.'"').' for iEzsigntemplatedocumentpagePagenumber when calling EzsigntemplateformfieldRequestCompound., must be bigger than or equal to 1.');
        }
	...
	//if (($iEzsigntemplateformfieldX < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldX when calling EzsigntemplateformfieldRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldX)?'null':'"'.$iEzsigntemplateformfieldX.'"').' for iEzsigntemplateformfieldX when calling EzsigntemplateformfieldRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplateformfieldY < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldY when calling EzsigntemplateformfieldRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldY)?'null':'"'.$iEzsigntemplateformfieldY.'"').' for iEzsigntemplateformfieldY when calling EzsigntemplateformfieldRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplateformfieldWidth < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldWidth when calling EzsigntemplateformfieldRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldWidth)?'null':'"'.$iEzsigntemplateformfieldWidth.'"').' for iEzsigntemplateformfieldWidth when calling EzsigntemplateformfieldRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplateformfieldHeight < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldHeight when calling EzsigntemplateformfieldRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldHeight)?'null':'"'.$iEzsigntemplateformfieldHeight.'"').' for iEzsigntemplateformfieldHeight when calling EzsigntemplateformfieldRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{0,30}$/", ObjectSerializer::toString($sEzsigntemplateformfieldPositioningpattern)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplateformfieldPositioningpattern when calling EzsigntemplateformfieldRequestCompound., must conform to the pattern /^.{0,30}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplateformfieldPositioningpattern)?'null':'"'.$sEzsigntemplateformfieldPositioningpattern.'"')." for sEzsigntemplateformfieldPositioningpattern when calling EzsigntemplateformfieldRequestCompound., must conform to the pattern /^.{0,30}$/.");
        }
