    ...
    */
	...
	//if (($pkiEzsigntemplatedocumentpageID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatedocumentpageID when calling EzsigntemplatedocumentpageResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatedocumentpageID)?'null':'"'.$pkiEzsigntemplatedocumentpageID.'"').' for pkiEzsigntemplatedocumentpageID when calling EzsigntemplatedocumentpageResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatedocumentpageWidthimage < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpageWidthimage when calling EzsigntemplatedocumentpageResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpageWidthimage)?'null':'"'.$iEzsigntemplatedocumentpageWidthimage.'"').' for iEzsigntemplatedocumentpageWidthimage when calling EzsigntemplatedocumentpageResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatedocumentpageHeightimage < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpageHeightimage when calling EzsigntemplatedocumentpageResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpageHeightimage)?'null':'"'.$iEzsigntemplatedocumentpageHeightimage.'"').' for iEzsigntemplatedocumentpageHeightimage when calling EzsigntemplatedocumentpageResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatedocumentpageWidthpdf < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpageWidthpdf when calling EzsigntemplatedocumentpageResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpageWidthpdf)?'null':'"'.$iEzsigntemplatedocumentpageWidthpdf.'"').' for iEzsigntemplatedocumentpageWidthpdf when calling EzsigntemplatedocumentpageResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatedocumentpageHeightpdf < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpageHeightpdf when calling EzsigntemplatedocumentpageResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpageHeightpdf)?'null':'"'.$iEzsigntemplatedocumentpageHeightpdf.'"').' for iEzsigntemplatedocumentpageHeightpdf when calling EzsigntemplatedocumentpageResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatedocumentpagePagenumber < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagePagenumber when calling EzsigntemplatedocumentpageResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagePagenumber)?'null':'"'.$iEzsigntemplatedocumentpagePagenumber.'"').' for iEzsigntemplatedocumentpagePagenumber when calling EzsigntemplatedocumentpageResponse., must be bigger than or equal to 1.');
        }
