...
/**
 * EzsignsignatureGetObjectV4ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /4/object/ezsignsignature/{pkiEzsignsignatureID}
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsignsignatureGetObjectV4ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsignsignature-getObject-v4-Response-mPayload';
