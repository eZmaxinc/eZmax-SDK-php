...
/**
 * BillingentityinternalproductRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class BillingentityinternalproductRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'billingentityinternalproduct-Request';
    ...
    */
	...
	//if (($pkiBillingentityinternalproductID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiBillingentityinternalproductID when calling BillingentityinternalproductRequest., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiBillingentityinternalproductID)?'null':'"'.$pkiBillingentityinternalproductID.'"').' for pkiBillingentityinternalproductID when calling BillingentityinternalproductRequest., must be smaller than or equal to 255.');
        }
	//if (($pkiBillingentityinternalproductID < 0)) {
        if (!is_null($pkiBillingentityinternalproductID) && ($pkiBillingentityinternalproductID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiBillingentityinternalproductID when calling BillingentityinternalproductRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiBillingentityinternalproductID)?'null':'"'.$pkiBillingentityinternalproductID.'"').' for pkiBillingentityinternalproductID when calling BillingentityinternalproductRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzmaxproductID < 1)) {
        if (($fkiEzmaxproductID < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzmaxproductID when calling BillingentityinternalproductRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxproductID)?'null':'"'.$fkiEzmaxproductID.'"').' for fkiEzmaxproductID when calling BillingentityinternalproductRequest., must be bigger than or equal to 1.');
        }
	...
	//if (($fkiBillingentityexternalID < 1)) {
        if (($fkiBillingentityexternalID < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiBillingentityexternalID when calling BillingentityinternalproductRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBillingentityexternalID)?'null':'"'.$fkiBillingentityexternalID.'"').' for fkiBillingentityexternalID when calling BillingentityinternalproductRequest., must be bigger than or equal to 1.');
        }
