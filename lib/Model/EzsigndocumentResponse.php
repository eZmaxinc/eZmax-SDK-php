...
class EzsigndocumentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigndocumentID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndocumentID)?'null':'"'.$pkiEzsigndocumentID.'"').' for pkiEzsigndocumentID when calling EzsigndocumentResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsignfolderID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfolderID)?'null':'"'.$fkiEzsignfolderID.'"').' for fkiEzsignfolderID when calling EzsigndocumentResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignfoldersignerassociationIDDeclinedtosign) && ($fkiEzsignfoldersignerassociationIDDeclinedtosign < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldersignerassociationIDDeclinedtosign when calling EzsigndocumentResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationIDDeclinedtosign)?'null':'"'.$fkiEzsignfoldersignerassociationIDDeclinedtosign.'"').' for fkiEzsignfoldersignerassociationIDDeclinedtosign when calling EzsigndocumentResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiLanguageID) && ($fkiLanguageID > 2)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsigndocumentResponse., must be smaller than or equal to 2.');
        }
        //if (($fkiLanguageID < 1)) {
        if (!is_null($fkiLanguageID) && ($fkiLanguageID < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsigndocumentResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigndocumentOrder < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentOrder)?'null':'"'.$iEzsigndocumentOrder.'"').' for iEzsigndocumentOrder when calling EzsigndocumentResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigndocumentPagetotal < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentPagetotal)?'null':'"'.$iEzsigndocumentPagetotal.'"').' for iEzsigndocumentPagetotal when calling EzsigndocumentResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigndocumentSignaturesigned < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentSignaturesigned)?'null':'"'.$iEzsigndocumentSignaturesigned.'"').' for iEzsigndocumentSignaturesigned when calling EzsigndocumentResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigndocumentSignaturetotal < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentSignaturetotal)?'null':'"'.$iEzsigndocumentSignaturetotal.'"').' for iEzsigndocumentSignaturetotal when calling EzsigndocumentResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigndocumentFormfieldtotal < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigndocumentFormfieldtotal when calling EzsigndocumentResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentFormfieldtotal)?'null':'"'.$iEzsigndocumentFormfieldtotal.'"').' for iEzsigndocumentFormfieldtotal when calling EzsigndocumentResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigndocumentMD5initial) && (!preg_match("/(*UTF8)^.{32}$/", ObjectSerializer::toString($sEzsigndocumentMD5initial)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigndocumentMD5initial when calling EzsigndocumentResponse., must conform to the pattern /^.{32}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigndocumentMD5initial)?'null':'"'.$sEzsigndocumentMD5initial.'"')." for sEzsigndocumentMD5initial when calling EzsigndocumentResponse., must conform to the pattern /^.{32}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigndocumentMD5signed) && (!preg_match("/(*UTF8)^.{32}$/", ObjectSerializer::toString($sEzsigndocumentMD5signed)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigndocumentMD5signed when calling EzsigndocumentResponse., must conform to the pattern /^.{32}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigndocumentMD5signed)?'null':'"'.$sEzsigndocumentMD5signed.'"')." for sEzsigndocumentMD5signed when calling EzsigndocumentResponse., must conform to the pattern /^.{32}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigndocumentExternalid) && (!preg_match("/(*UTF8)^.{0,128}$/", ObjectSerializer::toString($sEzsigndocumentExternalid)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigndocumentExternalid when calling EzsigndocumentResponse., must conform to the pattern /^.{0,128}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigndocumentExternalid)?'null':'"'.$sEzsigndocumentExternalid.'"')." for sEzsigndocumentExternalid when calling EzsigndocumentResponse., must conform to the pattern /^.{0,128}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigndocumentEzsignsignatureattachmenttotal < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigndocumentEzsignsignatureattachmenttotal when calling EzsigndocumentResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentEzsignsignatureattachmenttotal)?'null':'"'.$iEzsigndocumentEzsignsignatureattachmenttotal.'"').' for iEzsigndocumentEzsignsignatureattachmenttotal when calling EzsigndocumentResponse., must be bigger than or equal to 0.');
        }
