    ...
    */
	...
	//if (($pkiEzmaxinvoicingsummaryexternalID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzmaxinvoicingsummaryexternalID when calling EzmaxinvoicingsummaryexternalResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzmaxinvoicingsummaryexternalID)?'null':'"'.$pkiEzmaxinvoicingsummaryexternalID.'"').' for pkiEzmaxinvoicingsummaryexternalID when calling EzmaxinvoicingsummaryexternalResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzmaxinvoicingID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzmaxinvoicingID when calling EzmaxinvoicingsummaryexternalResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxinvoicingID)?'null':'"'.$fkiEzmaxinvoicingID.'"').' for fkiEzmaxinvoicingID when calling EzmaxinvoicingsummaryexternalResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiBillingentityexternalID < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiBillingentityexternalID when calling EzmaxinvoicingsummaryexternalResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBillingentityexternalID)?'null':'"'.$fkiBillingentityexternalID.'"').' for fkiBillingentityexternalID when calling EzmaxinvoicingsummaryexternalResponse., must be bigger than or equal to 1.');
        }
	...
	//if ((mb_strlen($sEzmaxinvoicingsummaryexternalDescription) > 70)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzmaxinvoicingsummaryexternalDescription when calling EzmaxinvoicingsummaryexternalResponse., must be smaller than or equal to 70.');
            throw new \InvalidArgumentException('value '.(is_null($sEzmaxinvoicingsummaryexternalDescription)?'null':'"'.$sEzmaxinvoicingsummaryexternalDescription.'"').', invalid length for sEzmaxinvoicingsummaryexternalDescription when calling EzmaxinvoicingsummaryexternalResponse., must be smaller than or equal to 70.');
        }
