    ...
    */
	...
	//if (($pkiApikeyID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiApikeyID when calling ActivesessionResponseCompoundApikey., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiApikeyID)?'null':'"'.$pkiApikeyID.'"').' for pkiApikeyID when calling ActivesessionResponseCompoundApikey., must be bigger than or equal to 0.');
        }
