...
/**
 * AuthenticationexternalRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AuthenticationexternalRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'authenticationexternal-Request';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiAuthenticationexternalID) && ($pkiAuthenticationexternalID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $pkiAuthenticationexternalID when calling AuthenticationexternalRequest., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiAuthenticationexternalID)?'null':'"'.$pkiAuthenticationexternalID.'"').' for pkiAuthenticationexternalID when calling AuthenticationexternalRequest., must be smaller than or equal to 255.');
        }
        //if (($pkiAuthenticationexternalID < 0)) {
        if (!is_null($pkiAuthenticationexternalID) && ($pkiAuthenticationexternalID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiAuthenticationexternalID when calling AuthenticationexternalRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiAuthenticationexternalID)?'null':'"'.$pkiAuthenticationexternalID.'"').' for pkiAuthenticationexternalID when calling AuthenticationexternalRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sAuthenticationexternalDescription) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sAuthenticationexternalDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sAuthenticationexternalDescription when calling AuthenticationexternalRequest., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sAuthenticationexternalDescription)?'null':'"'.$sAuthenticationexternalDescription.'"')." for sAuthenticationexternalDescription when calling AuthenticationexternalRequest., must conform to the pattern /^.{0,50}$/.");
        }
