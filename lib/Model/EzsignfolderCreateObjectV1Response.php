 ...
 */
class EzsignfolderCreateObjectV1Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignfolder-createObject-v1-Response';
