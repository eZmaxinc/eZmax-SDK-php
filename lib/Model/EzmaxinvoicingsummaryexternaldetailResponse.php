...
class EzmaxinvoicingsummaryexternaldetailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryexternaldetailCountreal']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryexternaldetailCountreal'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryexternaldetailCountreal'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryexternaldetailCountreal'].'"')." for 'dEzmaxinvoicingsummaryexternaldetailCountreal', must be conform to the pattern /^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryexternaldetailSubtotal']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryexternaldetailSubtotal'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryexternaldetailSubtotal'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryexternaldetailSubtotal'].'"')." for 'dEzmaxinvoicingsummaryexternaldetailSubtotal', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryexternaldetailRebate']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryexternaldetailRebate'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryexternaldetailRebate'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryexternaldetailRebate'].'"')." for 'dEzmaxinvoicingsummaryexternaldetailRebate', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryexternaldetailTotal']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryexternaldetailTotal'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryexternaldetailTotal'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryexternaldetailTotal'].'"')." for 'dEzmaxinvoicingsummaryexternaldetailTotal', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzmaxinvoicingsummaryexternaldetailID) && ($pkiEzmaxinvoicingsummaryexternaldetailID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzmaxinvoicingsummaryexternaldetailID)?'null':'"'.$pkiEzmaxinvoicingsummaryexternaldetailID.'"').' for pkiEzmaxinvoicingsummaryexternaldetailID when calling EzmaxinvoicingsummaryexternaldetailResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzmaxinvoicingsummaryexternalID) && ($fkiEzmaxinvoicingsummaryexternalID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxinvoicingsummaryexternalID)?'null':'"'.$fkiEzmaxinvoicingsummaryexternalID.'"').' for fkiEzmaxinvoicingsummaryexternalID when calling EzmaxinvoicingsummaryexternaldetailResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzmaxproductID < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxproductID)?'null':'"'.$fkiEzmaxproductID.'"').' for fkiEzmaxproductID when calling EzmaxinvoicingsummaryexternaldetailResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryexternaldetailSubtotal) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryexternaldetailSubtotal)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryexternaldetailSubtotal)?'null':'"'.$dEzmaxinvoicingsummaryexternaldetailSubtotal.'"')." for dEzmaxinvoicingsummaryexternaldetailSubtotal when calling EzmaxinvoicingsummaryexternaldetailResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryexternaldetailRebate) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryexternaldetailRebate)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryexternaldetailRebate)?'null':'"'.$dEzmaxinvoicingsummaryexternaldetailRebate.'"')." for dEzmaxinvoicingsummaryexternaldetailRebate when calling EzmaxinvoicingsummaryexternaldetailResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryexternaldetailTotal) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryexternaldetailTotal)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryexternaldetailTotal)?'null':'"'.$dEzmaxinvoicingsummaryexternaldetailTotal.'"')." for dEzmaxinvoicingsummaryexternaldetailTotal when calling EzmaxinvoicingsummaryexternaldetailResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
