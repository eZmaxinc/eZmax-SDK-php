...
/**
 * EzsignsignergroupResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignsignergroupResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignsignergroup-Response';
    ...
    */
	...
	//if (($pkiEzsignsignergroupID > 65535)) {
        if (($pkiEzsignsignergroupID > 65535)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignergroupID when calling EzsignsignergroupResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignergroupID)?'null':'"'.$pkiEzsignsignergroupID.'"').' for pkiEzsignsignergroupID when calling EzsignsignergroupResponse., must be smaller than or equal to 65535.');
        }
	//if (($pkiEzsignsignergroupID < 0)) {
        if (($pkiEzsignsignergroupID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignergroupID when calling EzsignsignergroupResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignergroupID)?'null':'"'.$pkiEzsignsignergroupID.'"').' for pkiEzsignsignergroupID when calling EzsignsignergroupResponse., must be bigger than or equal to 0.');
        }
