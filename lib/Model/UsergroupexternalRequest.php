...
/**
 * UsergroupexternalRequest Class Doc Comment
 *
 * @category Class
 * @description A Usergroupexternal Object
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UsergroupexternalRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'usergroupexternal-Request';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiUsergroupexternalID) && ($pkiUsergroupexternalID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $pkiUsergroupexternalID when calling UsergroupexternalRequest., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupexternalID)?'null':'"'.$pkiUsergroupexternalID.'"').' for pkiUsergroupexternalID when calling UsergroupexternalRequest., must be smaller than or equal to 255.');
        }
        //if (($pkiUsergroupexternalID < 0)) {
        if (!is_null($pkiUsergroupexternalID) && ($pkiUsergroupexternalID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiUsergroupexternalID when calling UsergroupexternalRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupexternalID)?'null':'"'.$pkiUsergroupexternalID.'"').' for pkiUsergroupexternalID when calling UsergroupexternalRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUsergroupexternalName) && (!preg_match("/(*UTF8)^.{0,64}$/", ObjectSerializer::toString($sUsergroupexternalName)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUsergroupexternalName when calling UsergroupexternalRequest., must conform to the pattern /^.{0,64}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupexternalName)?'null':'"'.$sUsergroupexternalName.'"')." for sUsergroupexternalName when calling UsergroupexternalRequest., must conform to the pattern /^.{0,64}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUsergroupexternalID) && (!preg_match("/(*UTF8)^.{0,64}$/", ObjectSerializer::toString($sUsergroupexternalID)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUsergroupexternalID when calling UsergroupexternalRequest., must conform to the pattern /^.{0,64}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupexternalID)?'null':'"'.$sUsergroupexternalID.'"')." for sUsergroupexternalID when calling UsergroupexternalRequest., must conform to the pattern /^.{0,64}$/.");
        }
