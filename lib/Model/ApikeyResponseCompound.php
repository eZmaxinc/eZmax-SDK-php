...
class ApikeyResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzmaxpartnerproductstageID) && ($fkiEzmaxpartnerproductstageID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzmaxpartnerproductstageID when calling ApikeyResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxpartnerproductstageID)?'null':'"'.$fkiEzmaxpartnerproductstageID.'"').' for fkiEzmaxpartnerproductstageID when calling ApikeyResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($fkiEzmaxpartnerproductstageID < 0)) {
        if (!is_null($fkiEzmaxpartnerproductstageID) && ($fkiEzmaxpartnerproductstageID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzmaxpartnerproductstageID when calling ApikeyResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxpartnerproductstageID)?'null':'"'.$fkiEzmaxpartnerproductstageID.'"').' for fkiEzmaxpartnerproductstageID when calling ApikeyResponseCompound., must be bigger than or equal to 0.');
        }
