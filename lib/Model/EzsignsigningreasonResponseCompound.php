...
/**
 * EzsignsigningreasonResponseCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignsigningreasonResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignsigningreason-ResponseCompound';
    ...
    */
	...
	//if (($pkiEzsignsigningreasonID > 255)) {
        if (($pkiEzsignsigningreasonID > 255)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsigningreasonID when calling EzsignsigningreasonResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsigningreasonID)?'null':'"'.$pkiEzsignsigningreasonID.'"').' for pkiEzsignsigningreasonID when calling EzsignsigningreasonResponseCompound., must be smaller than or equal to 255.');
        }
	//if (($pkiEzsignsigningreasonID < 0)) {
        if (($pkiEzsignsigningreasonID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsigningreasonID when calling EzsignsigningreasonResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsigningreasonID)?'null':'"'.$pkiEzsignsigningreasonID.'"').' for pkiEzsignsigningreasonID when calling EzsignsigningreasonResponseCompound., must be bigger than or equal to 0.');
        }
