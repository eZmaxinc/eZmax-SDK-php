...
/**
 * EzsignsignaturecustomdateRequestCompoundV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignsignaturecustomdateRequestCompoundV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignsignaturecustomdate-RequestCompoundV2';
    ...
    */
	...
	//if (($pkiEzsignsignaturecustomdateID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignaturecustomdateID when calling EzsignsignaturecustomdateRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignaturecustomdateID)?'null':'"'.$pkiEzsignsignaturecustomdateID.'"').' for pkiEzsignsignaturecustomdateID when calling EzsignsignaturecustomdateRequestCompoundV2., must be bigger than or equal to 0.');
        }
