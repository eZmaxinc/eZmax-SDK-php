...
//        if ((count($aPkiEzsigndocumentID) < 1)) {
        if ((count($aPkiEzsigndocumentID) < 1)) {
            throw new \InvalidArgumentException('invalid length for $aPkiEzsigndocumentID when calling EzsigndocumentCreateObjectV1ResponseMPayload., number of items must be greater than or equal to 1.');
        }
