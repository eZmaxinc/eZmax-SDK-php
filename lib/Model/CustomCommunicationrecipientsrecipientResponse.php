    ...
    */
	...
	//if (($fkiAgentID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiAgentID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAgentID)?'null':'"'.$fkiAgentID.'"').' for fkiAgentID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiBrokerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiBrokerID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBrokerID)?'null':'"'.$fkiBrokerID.'"').' for fkiBrokerID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiContactID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiContactID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiContactID)?'null':'"'.$fkiContactID.'"').' for fkiContactID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiCustomerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiCustomerID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCustomerID)?'null':'"'.$fkiCustomerID.'"').' for fkiCustomerID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEmployeeID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEmployeeID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEmployeeID)?'null':'"'.$fkiEmployeeID.'"').' for fkiEmployeeID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignsignerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignsignerID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsignerID)?'null':'"'.$fkiEzsignsignerID.'"').' for fkiEzsignsignerID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiFranchiseofficeID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiFranchiseofficeID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFranchiseofficeID)?'null':'"'.$fkiFranchiseofficeID.'"').' for fkiFranchiseofficeID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiAgentincorporationID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiAgentincorporationID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAgentincorporationID)?'null':'"'.$fkiAgentincorporationID.'"').' for fkiAgentincorporationID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiAssistantID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiAssistantID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAssistantID)?'null':'"'.$fkiAssistantID.'"').' for fkiAssistantID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiExternalbrokerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiExternalbrokerID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiExternalbrokerID)?'null':'"'.$fkiExternalbrokerID.'"').' for fkiExternalbrokerID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzcomagentID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzcomagentID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzcomagentID)?'null':'"'.$fkiEzcomagentID.'"').' for fkiEzcomagentID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiNotaryID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiNotaryID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiNotaryID)?'null':'"'.$fkiNotaryID.'"').' for fkiNotaryID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiRewardmemberID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiRewardmemberID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiRewardmemberID)?'null':'"'.$fkiRewardmemberID.'"').' for fkiRewardmemberID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiSupplierID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiSupplierID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiSupplierID)?'null':'"'.$fkiSupplierID.'"').' for fkiSupplierID when calling CustomCommunicationrecipientsrecipientResponse., must be bigger than or equal to 0.');
        }
    ...
    {
	//return $this->container['eCommunicationrecipientsrecipientObjecttype'];
     ...
     * Sets objEmail
     *
     * @param \eZmaxAPI\Model\EmailResponse|null $objEmail An Email Object and children to create a complete structure
     *
     * @return self
     */
