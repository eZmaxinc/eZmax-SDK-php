...
/**
 * CustomEzsignsignatureEzsignsignaturesAutomaticResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomEzsignsignatureEzsignsignaturesAutomaticResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Custom-EzsignsignatureEzsignsignaturesAutomatic-Response';
    ...
    */
	...
	//if (($pkiEzsignsignatureID < 0)) {
        if (($pkiEzsignsignatureID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignatureID when calling CustomEzsignsignatureEzsignsignaturesAutomaticResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignatureID)?'null':'"'.$pkiEzsignsignatureID.'"').' for pkiEzsignsignatureID when calling CustomEzsignsignatureEzsignsignaturesAutomaticResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignpagePagenumber < 1)) {
        if (($iEzsignpagePagenumber < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignpagePagenumber when calling CustomEzsignsignatureEzsignsignaturesAutomaticResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignpagePagenumber)?'null':'"'.$iEzsignpagePagenumber.'"').' for iEzsignpagePagenumber when calling CustomEzsignsignatureEzsignsignaturesAutomaticResponse., must be bigger than or equal to 1.');
        }
