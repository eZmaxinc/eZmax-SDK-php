...
/**
 * EzsignimportfolderResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignimportfolderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignimportfolder-Response';
    ...
    */
	...
	//if (($pkiEzsignimportfolderID > 16777215)) {
        if (($pkiEzsignimportfolderID > 16777215)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignimportfolderID when calling EzsignimportfolderResponse., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignimportfolderID)?'null':'"'.$pkiEzsignimportfolderID.'"').' for pkiEzsignimportfolderID when calling EzsignimportfolderResponse., must be smaller than or equal to 16777215.');
        }
	//if (($pkiEzsignimportfolderID < 0)) {
        if (($pkiEzsignimportfolderID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignimportfolderID when calling EzsignimportfolderResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignimportfolderID)?'null':'"'.$pkiEzsignimportfolderID.'"').' for pkiEzsignimportfolderID when calling EzsignimportfolderResponse., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{0,150}$/", ObjectSerializer::toString($sEzsignimportfolderName)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsignimportfolderName when calling EzsignimportfolderResponse., must conform to the pattern /^.{0,150}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignimportfolderName)?'null':'"'.$sEzsignimportfolderName.'"')." for sEzsignimportfolderName when calling EzsignimportfolderResponse., must conform to the pattern /^.{0,150}$/.");
        }
