...
/**
 * ScimServiceProviderConfigFilter Class Doc Comment
 *
 * @category Class
 ...
 */
class ScimServiceProviderConfigFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Scim_ServiceProviderConfig_filter';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['maxResults'] === null) {
            $invalidProperties[] = "'maxResults' can't be null";
        }
     ...
     * Sets maxResults
     *
     * @param int $maxResults An integer value specifying the maximum number of resources returned in a response.
     *
     * @return self
     */
	...
	//$this->container['maxResults'] = $maxResults;
        $this->container['maxResults'] = (is_null($maxResults) ? null : (int) $maxResults);
