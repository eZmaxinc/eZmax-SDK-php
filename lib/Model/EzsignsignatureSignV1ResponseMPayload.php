...
/**
 * EzsignsignatureSignV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignsignatureSignV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsignsignature-sign-v1-Response-mPayload';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['dtEzsignsignatureDateInFolderTimezone'] === null) {
            $invalidProperties[] = "'dtEzsignsignatureDateInFolderTimezone' can't be null";
        }
        //if (!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", $this->container['dtEzsignsignatureDateInFolderTimezone'])) {
     ...
     *
     * @param string $dtEzsignsignatureDateInFolderTimezone The date the Ezsignsignature was signed in folder's timezone
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtEzsignsignatureDateInFolderTimezone) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtEzsignsignatureDateInFolderTimezone)))) {
            //throw new \InvalidArgumentException("invalid value for \$dtEzsignsignatureDateInFolderTimezone when calling EzsignsignatureSignV1ResponseMPayload., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtEzsignsignatureDateInFolderTimezone)?'null':'"'.$dtEzsignsignatureDateInFolderTimezone.'"')." for dtEzsignsignatureDateInFolderTimezone when calling EzsignsignatureSignV1ResponseMPayload., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
