...
/**
 * CustomEzsignformfieldRequestAllOf Class Doc Comment
 *
 * @category Class
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 ...
 */
class CustomEzsignformfieldRequestAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Custom_Ezsignformfield_Request_allOf';
...
//        if (($pkiEzsignformfieldID < 0)) {
        if (!is_null($pkiEzsignformfieldID) && ($pkiEzsignformfieldID < 0)) {
            throw new \InvalidArgumentException('invalid value for $pkiEzsignformfieldID when calling CustomEzsignformfieldRequestAllOf., must be bigger than or equal to 0.');
        }
