    ...
    */
	...
	//if (($pkiEzmaxinvoicinguserID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzmaxinvoicinguserID when calling EzmaxinvoicinguserResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzmaxinvoicinguserID)?'null':'"'.$pkiEzmaxinvoicinguserID.'"').' for pkiEzmaxinvoicinguserID when calling EzmaxinvoicinguserResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzmaxinvoicingID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzmaxinvoicingID when calling EzmaxinvoicinguserResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxinvoicingID)?'null':'"'.$fkiEzmaxinvoicingID.'"').' for fkiEzmaxinvoicingID when calling EzmaxinvoicinguserResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiBillingentityinternalID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiBillingentityinternalID when calling EzmaxinvoicinguserResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBillingentityinternalID)?'null':'"'.$fkiBillingentityinternalID.'"').' for fkiBillingentityinternalID when calling EzmaxinvoicinguserResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling EzmaxinvoicinguserResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling EzmaxinvoicinguserResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzmaxinvoicinguserEzsigndocument < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzmaxinvoicinguserEzsigndocument when calling EzmaxinvoicinguserResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzmaxinvoicinguserEzsigndocument)?'null':'"'.$iEzmaxinvoicinguserEzsigndocument.'"').' for iEzmaxinvoicinguserEzsigndocument when calling EzmaxinvoicinguserResponse., must be bigger than or equal to 0.');
        }
