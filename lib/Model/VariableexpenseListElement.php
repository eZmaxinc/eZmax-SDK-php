...
/**
 * VariableexpenseListElement Class Doc Comment
 *
 * @category Class
 ...
 */
class VariableexpenseListElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'variableexpense-ListElement';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sVariableexpenseCode']) && !preg_match("/(*UTF8)^.{0,5}$/", $this->container['sVariableexpenseCode'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sVariableexpenseCode'])?'null':'"'.$this->container['sVariableexpenseCode'].'"')." for 'sVariableexpenseCode', must be conform to the pattern /^.{0,5}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiVariableexpenseID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $pkiVariableexpenseID when calling VariableexpenseListElement., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiVariableexpenseID)?'null':'"'.$pkiVariableexpenseID.'"').' for pkiVariableexpenseID when calling VariableexpenseListElement., must be smaller than or equal to 255.');
        }
        //if (($pkiVariableexpenseID < 1)) {
        if (($pkiVariableexpenseID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $pkiVariableexpenseID when calling VariableexpenseListElement., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiVariableexpenseID)?'null':'"'.$pkiVariableexpenseID.'"').' for pkiVariableexpenseID when calling VariableexpenseListElement., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sVariableexpenseCode) && (!preg_match("/(*UTF8)^.{0,5}$/", ObjectSerializer::toString($sVariableexpenseCode)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sVariableexpenseCode)?'null':'"'.$sVariableexpenseCode.'"')." for sVariableexpenseCode when calling VariableexpenseListElement., must conform to the pattern /^.{0,5}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sVariableexpenseDescriptionX) && (!preg_match("/(*UTF8)^.{0,40}$/", ObjectSerializer::toString($sVariableexpenseDescriptionX)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sVariableexpenseDescriptionX)?'null':'"'.$sVariableexpenseDescriptionX.'"')." for sVariableexpenseDescriptionX when calling VariableexpenseListElement., must conform to the pattern /^.{0,40}$/.");
        }
