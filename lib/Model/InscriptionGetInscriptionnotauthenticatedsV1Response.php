...
class InscriptionGetInscriptionnotauthenticatedsV1Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets mPayload
     *
     * @param object $mPayload Response for GET /1/object/inscription/{pkiInscriptionID}/getInscriptionnotauthenticateds
     *
     * @return self
     */
	...
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        ...
        $this->container['mPayload'] = (is_null($mPayload) ? null : $mPayload);
