...
/**
 * UserRequestCompoundV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class UserRequestCompoundV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'user-RequestCompoundV2';
    ...
    protected static $openAPITypes = [
        ...
        'objPhoneHome' => '\eZmaxAPI\Model\PhoneRequestCompoundV2',
        'objPhoneSMS' => '\eZmaxAPI\Model\PhoneRequestCompoundV2',
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiUserID) && ($pkiUserID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiUserID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUserID)?'null':'"'.$pkiUserID.'"').' for pkiUserID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiAgentID) && ($fkiAgentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiAgentID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAgentID)?'null':'"'.$fkiAgentID.'"').' for fkiAgentID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiBrokerID) && ($fkiBrokerID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBrokerID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBrokerID)?'null':'"'.$fkiBrokerID.'"').' for fkiBrokerID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiAssistantID) && ($fkiAssistantID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiAssistantID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAssistantID)?'null':'"'.$fkiAssistantID.'"').' for fkiAssistantID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEmployeeID) && ($fkiEmployeeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEmployeeID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEmployeeID)?'null':'"'.$fkiEmployeeID.'"').' for fkiEmployeeID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiCompanyIDDefault > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCompanyIDDefault when calling UserRequestCompoundV2., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCompanyIDDefault)?'null':'"'.$fkiCompanyIDDefault.'"').' for fkiCompanyIDDefault when calling UserRequestCompoundV2., must be smaller than or equal to 255.');
        }
        //if (($fkiCompanyIDDefault < 1)) {
        if (($fkiCompanyIDDefault < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCompanyIDDefault when calling UserRequestCompoundV2., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCompanyIDDefault)?'null':'"'.$fkiCompanyIDDefault.'"').' for fkiCompanyIDDefault when calling UserRequestCompoundV2., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiDepartmentIDDefault < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDepartmentIDDefault when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDepartmentIDDefault)?'null':'"'.$fkiDepartmentIDDefault.'"').' for fkiDepartmentIDDefault when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiTimezoneID < 0)) {
        if (($fkiTimezoneID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiTimezoneID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiTimezoneID)?'null':'"'.$fkiTimezoneID.'"').' for fkiTimezoneID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiLanguageID > 2)) {
        if (($fkiLanguageID > 2)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling UserRequestCompoundV2., must be smaller than or equal to 2.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling UserRequestCompoundV2., must be smaller than or equal to 2.');
        }
        //if (($fkiLanguageID < 1)) {
        if (($fkiLanguageID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling UserRequestCompoundV2., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling UserRequestCompoundV2., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiBillingentityinternalID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBillingentityinternalID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBillingentityinternalID)?'null':'"'.$fkiBillingentityinternalID.'"').' for fkiBillingentityinternalID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
        }
     ...
     * Sets objPhoneHome
     *
     * @param \eZmaxAPI\Model\PhoneRequestCompoundV2|null $objPhoneHome objPhoneHome
     *
     * @return self
     */
     ...
     * Sets objPhoneSMS
     *
     * @param \eZmaxAPI\Model\PhoneRequestCompoundV2|null $objPhoneSMS objPhoneSMS
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiSecretquestionID) && ($fkiSecretquestionID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiSecretquestionID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiSecretquestionID)?'null':'"'.$fkiSecretquestionID.'"').' for fkiSecretquestionID when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//return $this->container['sUserSecretresponse'];
        return is_null($this->container['sUserSecretresponse']) ? null : trim($this->container['sUserSecretresponse']);
    }
	...
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        ...
        $this->container['sUserSecretresponse'] = (is_null($sUserSecretresponse) ? null : trim((string) $sUserSecretresponse));
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiModuleIDForm) && ($fkiModuleIDForm < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiModuleIDForm when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiModuleIDForm)?'null':'"'.$fkiModuleIDForm.'"').' for fkiModuleIDForm when calling UserRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUserLoginname) && (!preg_match("/(*UTF8)^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/", ObjectSerializer::toString($sUserLoginname)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUserLoginname when calling UserRequestCompoundV2., must conform to the pattern /^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUserLoginname)?'null':'"'.$sUserLoginname.'"')." for sUserLoginname when calling UserRequestCompoundV2., must conform to the pattern /^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUserJobtitle) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sUserJobtitle)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUserJobtitle when calling UserRequestCompoundV2., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUserJobtitle)?'null':'"'.$sUserJobtitle.'"')." for sUserJobtitle when calling UserRequestCompoundV2., must conform to the pattern /^.{0,50}$/.");
        }
