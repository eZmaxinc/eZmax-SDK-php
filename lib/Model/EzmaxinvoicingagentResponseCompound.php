...
/**
 * EzmaxinvoicingagentResponseCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class EzmaxinvoicingagentResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezmaxinvoicingagent-ResponseCompound';
    ...
    */
	...
	//if (($pkiEzmaxinvoicingagentID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzmaxinvoicingagentID when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzmaxinvoicingagentID)?'null':'"'.$pkiEzmaxinvoicingagentID.'"').' for pkiEzmaxinvoicingagentID when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzmaxinvoicingID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzmaxinvoicingID when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxinvoicingID)?'null':'"'.$fkiEzmaxinvoicingID.'"').' for fkiEzmaxinvoicingID when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiBillingentityinternalID < 0)) {
        if (($fkiBillingentityinternalID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiBillingentityinternalID when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBillingentityinternalID)?'null':'"'.$fkiBillingentityinternalID.'"').' for fkiBillingentityinternalID when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiAgentID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiAgentID when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAgentID)?'null':'"'.$fkiAgentID.'"').' for fkiAgentID when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiBrokerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiBrokerID when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBrokerID)?'null':'"'.$fkiBrokerID.'"').' for fkiBrokerID when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzmaxinvoicingagentSession < 0)) {
        if (($iEzmaxinvoicingagentSession < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzmaxinvoicingagentSession when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzmaxinvoicingagentSession)?'null':'"'.$iEzmaxinvoicingagentSession.'"').' for iEzmaxinvoicingagentSession when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzmaxinvoicingagentCloned < 0)) {
        if (($iEzmaxinvoicingagentCloned < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzmaxinvoicingagentCloned when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzmaxinvoicingagentCloned)?'null':'"'.$iEzmaxinvoicingagentCloned.'"').' for iEzmaxinvoicingagentCloned when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzmaxinvoicingagentInvoice < 0)) {
        if (($iEzmaxinvoicingagentInvoice < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzmaxinvoicingagentInvoice when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzmaxinvoicingagentInvoice)?'null':'"'.$iEzmaxinvoicingagentInvoice.'"').' for iEzmaxinvoicingagentInvoice when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzmaxinvoicingagentInscription < 0)) {
        if (($iEzmaxinvoicingagentInscription < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzmaxinvoicingagentInscription when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzmaxinvoicingagentInscription)?'null':'"'.$iEzmaxinvoicingagentInscription.'"').' for iEzmaxinvoicingagentInscription when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzmaxinvoicingagentInscriptionactive < 0)) {
        if (($iEzmaxinvoicingagentInscriptionactive < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzmaxinvoicingagentInscriptionactive when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzmaxinvoicingagentInscriptionactive)?'null':'"'.$iEzmaxinvoicingagentInscriptionactive.'"').' for iEzmaxinvoicingagentInscriptionactive when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzmaxinvoicingagentSale < 0)) {
        if (($iEzmaxinvoicingagentSale < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzmaxinvoicingagentSale when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzmaxinvoicingagentSale)?'null':'"'.$iEzmaxinvoicingagentSale.'"').' for iEzmaxinvoicingagentSale when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzmaxinvoicingagentOtherincome < 0)) {
        if (($iEzmaxinvoicingagentOtherincome < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzmaxinvoicingagentOtherincome when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzmaxinvoicingagentOtherincome)?'null':'"'.$iEzmaxinvoicingagentOtherincome.'"').' for iEzmaxinvoicingagentOtherincome when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzmaxinvoicingagentCommissioncalculation < 0)) {
        if (($iEzmaxinvoicingagentCommissioncalculation < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzmaxinvoicingagentCommissioncalculation when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzmaxinvoicingagentCommissioncalculation)?'null':'"'.$iEzmaxinvoicingagentCommissioncalculation.'"').' for iEzmaxinvoicingagentCommissioncalculation when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzmaxinvoicingagentEzsigndocument < 0)) {
        if (($iEzmaxinvoicingagentEzsigndocument < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzmaxinvoicingagentEzsigndocument when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzmaxinvoicingagentEzsigndocument)?'null':'"'.$iEzmaxinvoicingagentEzsigndocument.'"').' for iEzmaxinvoicingagentEzsigndocument when calling EzmaxinvoicingagentResponseCompound., must be bigger than or equal to 0.');
        }
