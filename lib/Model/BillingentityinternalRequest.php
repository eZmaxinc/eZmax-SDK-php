...
/**
 * BillingentityinternalRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class BillingentityinternalRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'billingentityinternal-Request';
    ...
    */
	...
	//if (($pkiBillingentityinternalID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiBillingentityinternalID when calling BillingentityinternalRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiBillingentityinternalID)?'null':'"'.$pkiBillingentityinternalID.'"').' for pkiBillingentityinternalID when calling BillingentityinternalRequest., must be bigger than or equal to 0.');
        }
