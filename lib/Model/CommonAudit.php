...
class CommonAudit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'objAuditdetailCreated' => false,
		'objAuditdetailModified' => false
    ];
    ...
    {
        $this->setIfExists('objAuditdetailCreated', $data ?? [], null);
        $this->setIfExists('objAuditdetailModified', $data ?? [], null);
    }
