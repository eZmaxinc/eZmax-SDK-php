...
class EzsigndocumentGetObjectV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bEzsigndocumentHassignedsignatures'] === null) {
            $invalidProperties[] = "'bEzsigndocumentHassignedsignatures' can't be null";
        }
        if ($this->container['objAudit'] === null) {
            $invalidProperties[] = "'objAudit' can't be null";
        }
        if ($this->container['sEzsigndocumentExternalid'] === null) {
            $invalidProperties[] = "'sEzsigndocumentExternalid' can't be null";
        }
//        if (!preg_match("/^.{0,64}$/", $this->container['sEzsigndocumentExternalid'])) {
...
//        if (($iEzsigndocumentSignaturetotal < 0)) {
     ...
     *
     * @param bool $bEzsigndocumentHassignedsignatures If the Ezsigndocument contains signed signatures (From internal or external sources)
     *
     * @return self
     */
...
//        if ((!preg_match("/^.{0,64}$/", $sEzsigndocumentExternalid))) {
        if (!is_null($sEzsigndocumentExternalid) && (!preg_match("/^.{0,64}$/", $sEzsigndocumentExternalid))) {
            throw new \InvalidArgumentException("invalid value for \$sEzsigndocumentExternalid when calling EzsigndocumentGetObjectV1ResponseMPayload., must conform to the pattern /^.{0,64}$/.");
        }
