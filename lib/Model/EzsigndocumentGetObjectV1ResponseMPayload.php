    ...
    */
	...
	//if (($pkiEzsigndocumentID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigndocumentID when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndocumentID)?'null':'"'.$pkiEzsigndocumentID.'"').' for pkiEzsigndocumentID when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignfolderID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfolderID when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfolderID)?'null':'"'.$fkiEzsignfolderID.'"').' for fkiEzsignfolderID when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignfoldersignerassociationIDDeclinedtosign < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldersignerassociationIDDeclinedtosign when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationIDDeclinedtosign)?'null':'"'.$fkiEzsignfoldersignerassociationIDDeclinedtosign.'"').' for fkiEzsignfoldersignerassociationIDDeclinedtosign when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiLanguageID > 2)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsigndocumentGetObjectV1ResponseMPayload., must be smaller than or equal to 2.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsigndocumentGetObjectV1ResponseMPayload., must be smaller than or equal to 2.');
        }
	//if (($fkiLanguageID < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 1.');
        }
	...
	//if (($iEzsigndocumentOrder < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigndocumentOrder when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentOrder)?'null':'"'.$iEzsigndocumentOrder.'"').' for iEzsigndocumentOrder when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 1.');
        }
	...
	//if (($iEzsigndocumentPagetotal < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigndocumentPagetotal when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentPagetotal)?'null':'"'.$iEzsigndocumentPagetotal.'"').' for iEzsigndocumentPagetotal when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 1.');
        }
	...
	//if (($iEzsigndocumentSignaturesigned < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigndocumentSignaturesigned when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentSignaturesigned)?'null':'"'.$iEzsigndocumentSignaturesigned.'"').' for iEzsigndocumentSignaturesigned when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigndocumentSignaturetotal < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigndocumentSignaturetotal when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentSignaturetotal)?'null':'"'.$iEzsigndocumentSignaturetotal.'"').' for iEzsigndocumentSignaturetotal when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigndocumentFormfieldtotal < 0)) {
        if (($iEzsigndocumentFormfieldtotal < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsigndocumentFormfieldtotal when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentFormfieldtotal)?'null':'"'.$iEzsigndocumentFormfieldtotal.'"').' for iEzsigndocumentFormfieldtotal when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{32}$/", ObjectSerializer::toString($sEzsigndocumentMD5initial)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsigndocumentMD5initial when calling EzsigndocumentGetObjectV1ResponseMPayload., must conform to the pattern /^.{32}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigndocumentMD5initial)?'null':'"'.$sEzsigndocumentMD5initial.'"')." for sEzsigndocumentMD5initial when calling EzsigndocumentGetObjectV1ResponseMPayload., must conform to the pattern /^.{32}$/.");
        }
	...
	//if ((!preg_match("/^.{32}$/", ObjectSerializer::toString($sEzsigndocumentMD5signed)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsigndocumentMD5signed when calling EzsigndocumentGetObjectV1ResponseMPayload., must conform to the pattern /^.{32}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigndocumentMD5signed)?'null':'"'.$sEzsigndocumentMD5signed.'"')." for sEzsigndocumentMD5signed when calling EzsigndocumentGetObjectV1ResponseMPayload., must conform to the pattern /^.{32}$/.");
        }
	...
	//if ((!preg_match("/^.{0,128}$/", ObjectSerializer::toString($sEzsigndocumentExternalid)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsigndocumentExternalid when calling EzsigndocumentGetObjectV1ResponseMPayload., must conform to the pattern /^.{0,128}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigndocumentExternalid)?'null':'"'.$sEzsigndocumentExternalid.'"')." for sEzsigndocumentExternalid when calling EzsigndocumentGetObjectV1ResponseMPayload., must conform to the pattern /^.{0,128}$/.");
        }
	...
	//if (($iEzsigndocumentEzsignsignatureattachmenttotal < 0)) {
        if (($iEzsigndocumentEzsignsignatureattachmenttotal < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsigndocumentEzsignsignatureattachmenttotal when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentEzsignsignatureattachmenttotal)?'null':'"'.$iEzsigndocumentEzsignsignatureattachmenttotal.'"').' for iEzsigndocumentEzsignsignatureattachmenttotal when calling EzsigndocumentGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
