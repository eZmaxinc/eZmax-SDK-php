...
class CustomCommunicationListElementResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sCommunicationSubject']) && !preg_match("/(*UTF8)^.{0,200}$/", $this->container['sCommunicationSubject'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sCommunicationSubject'])?'null':'"'.$this->container['sCommunicationSubject'].'"')." for 'sCommunicationSubject', must be conform to the pattern /^.{0,200}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiCommunicationID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCommunicationID)?'null':'"'.$pkiCommunicationID.'"').' for pkiCommunicationID when calling CustomCommunicationListElementResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sCommunicationSubject) && (!preg_match("/(*UTF8)^.{0,200}$/", ObjectSerializer::toString($sCommunicationSubject)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sCommunicationSubject)?'null':'"'.$sCommunicationSubject.'"')." for sCommunicationSubject when calling CustomCommunicationListElementResponse., must conform to the pattern /^.{0,200}$/.");
        }
