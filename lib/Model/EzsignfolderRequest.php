    ...
    */
	...
	//if (($pkiEzsignfolderID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignfolderID when calling EzsignfolderRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignfolderID)?'null':'"'.$pkiEzsignfolderID.'"').' for pkiEzsignfolderID when calling EzsignfolderRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignfoldertypeID > 65535)) {
        if (($fkiEzsignfoldertypeID > 65535)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsignfolderRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsignfolderRequest., must be smaller than or equal to 65535.');
        }
	//if (($fkiEzsignfoldertypeID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsignfolderRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsignfolderRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiTimezoneID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiTimezoneID when calling EzsignfolderRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiTimezoneID)?'null':'"'.$fkiTimezoneID.'"').' for fkiTimezoneID when calling EzsignfolderRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntsarequirementID > 3)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntsarequirementID when calling EzsignfolderRequest., must be smaller than or equal to 3.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntsarequirementID)?'null':'"'.$fkiEzsigntsarequirementID.'"').' for fkiEzsigntsarequirementID when calling EzsignfolderRequest., must be smaller than or equal to 3.');
        }
	//if (($fkiEzsigntsarequirementID < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntsarequirementID when calling EzsignfolderRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntsarequirementID)?'null':'"'.$fkiEzsigntsarequirementID.'"').' for fkiEzsigntsarequirementID when calling EzsignfolderRequest., must be bigger than or equal to 1.');
        }
	...
	//if ((!preg_match("/^.{0,75}$/", ObjectSerializer::toString($sEzsignfolderDescription)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsignfolderDescription when calling EzsignfolderRequest., must conform to the pattern /^.{0,75}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignfolderDescription)?'null':'"'.$sEzsignfolderDescription.'"')." for sEzsignfolderDescription when calling EzsignfolderRequest., must conform to the pattern /^.{0,75}$/.");
        }
	...
	//if ((!preg_match("/^.{0,128}$/", ObjectSerializer::toString($sEzsignfolderExternalid)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsignfolderExternalid when calling EzsignfolderRequest., must conform to the pattern /^.{0,128}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignfolderExternalid)?'null':'"'.$sEzsignfolderExternalid.'"')." for sEzsignfolderExternalid when calling EzsignfolderRequest., must conform to the pattern /^.{0,128}$/.");
        }
