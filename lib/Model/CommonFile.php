...
class CommonFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//$this->container['sFileName'] = $sFileName;
        $this->container['sFileName'] = (is_null($sFileName) ? null : (string) $sFileName);
	...
	//$this->container['sFileUrl'] = $sFileUrl;
        $this->container['sFileUrl'] = (is_null($sFileUrl) ? null : (string) $sFileUrl);
	...
	//$this->container['eFileSource'] = $eFileSource;
        $this->container['eFileSource'] = (is_null($eFileSource) ? null : (string) $eFileSource);
