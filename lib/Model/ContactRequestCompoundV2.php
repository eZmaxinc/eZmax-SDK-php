...
class ContactRequestCompoundV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiContacttitleID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiContacttitleID when calling ContactRequestCompoundV2., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiLanguageID > 2)) {
        if (($fkiLanguageID > 2)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling ContactRequestCompoundV2., must be smaller than or equal to 2.');
        ...
        //if (($fkiLanguageID < 1)) {
        if (($fkiLanguageID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling ContactRequestCompoundV2., must be bigger than or equal to 1.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sContactFirstname) && (!preg_match("/(*UTF8)^.{1,20}$/", ObjectSerializer::toString($sContactFirstname)))) {
            //throw new \InvalidArgumentException("invalid value for \$sContactFirstname when calling ContactRequestCompoundV2., must conform to the pattern /^.{1,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sContactFirstname)?'null':'"'.$sContactFirstname.'"')." for sContactFirstname when calling ContactRequestCompoundV2., must conform to the pattern /^.{1,20}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sContactLastname) && (!preg_match("/(*UTF8)^.{1,25}$/", ObjectSerializer::toString($sContactLastname)))) {
            //throw new \InvalidArgumentException("invalid value for \$sContactLastname when calling ContactRequestCompoundV2., must conform to the pattern /^.{1,25}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sContactLastname)?'null':'"'.$sContactLastname.'"')." for sContactLastname when calling ContactRequestCompoundV2., must conform to the pattern /^.{1,25}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sContactOccupation) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sContactOccupation)))) {
            //throw new \InvalidArgumentException("invalid value for \$sContactOccupation when calling ContactRequestCompoundV2., must conform to the pattern /^.{0,50}$/.");
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($tContactNote) && (!preg_match("/(*UTF8)^.{0,32000}$/", ObjectSerializer::toString($tContactNote)))) {
            //throw new \InvalidArgumentException("invalid value for \$tContactNote when calling ContactRequestCompoundV2., must conform to the pattern /^.{0,32000}$/.");
