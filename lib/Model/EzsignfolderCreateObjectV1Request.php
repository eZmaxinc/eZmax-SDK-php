 ...
 */
class EzsignfolderCreateObjectV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'objEzsignfolderCompound' => '\eZmaxAPI\Model\EzsignfolderRequest'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('objEzsignfolderCompound', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param \eZmaxAPI\Model\EzsignfolderRequest|null $objEzsignfolderCompound An Ezsignfolder Object and children to create a complete structure
     *
     * @return self
     */
    ...
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($objEzsignfolderCompound)) {
            //throw new \InvalidArgumentException('non-nullable objEzsignfolderCompound cannot be null');
        //}
