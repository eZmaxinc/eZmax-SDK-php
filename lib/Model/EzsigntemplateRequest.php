...
/**
 * EzsigntemplateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigntemplate-Request';
...
//        if (($pkiEzsigntemplateID < 0)) {
        if (!is_null($pkiEzsigntemplateID) && ($pkiEzsigntemplateID < 0)) {
            throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplateID when calling EzsigntemplateRequest., must be bigger than or equal to 0.');
        }
...
//        if (($fkiEzsignfoldertypeID > 65535)) {
        if (($fkiEzsignfoldertypeID > 65535)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsigntemplateRequest., must be smaller than or equal to 65535.');
        }
//        if (($fkiEzsignfoldertypeID < 0)) {
        if (($fkiEzsignfoldertypeID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsigntemplateRequest., must be bigger than or equal to 0.');
        }
...
//        if (($fkiLanguageID > 2)) {
        if (($fkiLanguageID > 2)) {
            throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsigntemplateRequest., must be smaller than or equal to 2.');
        }
//        if (($fkiLanguageID < 1)) {
        if (($fkiLanguageID < 1)) {
            throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsigntemplateRequest., must be bigger than or equal to 1.');
        }
...
//        if ((!preg_match("/^.{1,50}$/", ObjectSerializer::toString($sEzsigntemplateFilenamepattern)))) {
        if (!is_null($sEzsigntemplateFilenamepattern) && (!preg_match("/(*UTF8)^.{1,50}$/", ObjectSerializer::toString($sEzsigntemplateFilenamepattern)))) {
            throw new \InvalidArgumentException("invalid value for \$sEzsigntemplateFilenamepattern when calling EzsigntemplateRequest., must conform to the pattern /^.{1,50}$/.");
        }
