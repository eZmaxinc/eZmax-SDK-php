...
class EmailRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//if (($pkiEmailID > 16777215)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEmailID when calling EmailRequestCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEmailID)?'null':'"'.$pkiEmailID.'"').' for pkiEmailID when calling EmailRequestCompound., must be smaller than or equal to 16777215.');
        }
	//if (($pkiEmailID < 1)) {
        if (!is_null($pkiEmailID) && ($pkiEmailID < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEmailID when calling EmailRequestCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEmailID)?'null':'"'.$pkiEmailID.'"').' for pkiEmailID when calling EmailRequestCompound., must be bigger than or equal to 1.');
        }
	...
	//if (($fkiEmailtypeID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEmailtypeID when calling EmailRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEmailtypeID)?'null':'"'.$fkiEmailtypeID.'"').' for fkiEmailtypeID when calling EmailRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddress)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEmailAddress when calling EmailRequestCompound., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEmailAddress)?'null':'"'.$sEmailAddress.'"')." for sEmailAddress when calling EmailRequestCompound., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
        }
