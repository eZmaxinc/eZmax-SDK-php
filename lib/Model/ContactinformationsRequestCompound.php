 ...
 * @link     https://openapi-generator.tech
 */
class ContactinformationsRequestCompound extends ContactinformationsRequest 
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['aObjAddress'] = isset($data['aObjAddress']) ? $data['aObjAddress'] : null;
        $this->container['aObjPhone'] = isset($data['aObjPhone']) ? $data['aObjPhone'] : null;
        $this->container['aObjEmail'] = isset($data['aObjEmail']) ? $data['aObjEmail'] : null;
        $this->container['aObjWebsite'] = isset($data['aObjWebsite']) ? $data['aObjWebsite'] : null;
