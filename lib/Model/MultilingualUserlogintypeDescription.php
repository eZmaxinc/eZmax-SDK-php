...
class MultilingualUserlogintypeDescription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sUserlogintypeDescription1']) && !preg_match("/(*UTF8)^.{0,50}$/", $this->container['sUserlogintypeDescription1'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sUserlogintypeDescription1'])?'null':'"'.$this->container['sUserlogintypeDescription1'].'"')." for 'sUserlogintypeDescription1', must be conform to the pattern /^.{0,50}$/.";
        }
        ...
        if (!is_null($this->container['sUserlogintypeDescription2']) && !preg_match("/(*UTF8)^.{0,50}$/", $this->container['sUserlogintypeDescription2'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sUserlogintypeDescription2'])?'null':'"'.$this->container['sUserlogintypeDescription2'].'"')." for 'sUserlogintypeDescription2', must be conform to the pattern /^.{0,50}$/.";
        }
