...
/**
 * EzsigntemplateglobalsignerResponseCompound Class Doc Comment
 *
 * @category Class
...
class EzsigntemplateglobalsignerResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplateglobalsigner-ResponseCompound';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sEzsigntemplateglobalsignerDescription']) && !preg_match("/(*UTF8)^.{1,50}$/", $this->container['sEzsigntemplateglobalsignerDescription'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsigntemplateglobalsignerDescription'])?'null':'"'.$this->container['sEzsigntemplateglobalsignerDescription'].'"')." for 'sEzsigntemplateglobalsignerDescription', must be conform to the pattern /^.{1,50}$/.";
        }
