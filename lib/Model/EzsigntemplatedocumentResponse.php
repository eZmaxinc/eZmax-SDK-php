    ...
    */
	...
	//if (($pkiEzsigntemplatedocumentID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatedocumentID when calling EzsigntemplatedocumentResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatedocumentID)?'null':'"'.$pkiEzsigntemplatedocumentID.'"').' for pkiEzsigntemplatedocumentID when calling EzsigntemplatedocumentResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplateID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplateID when calling EzsigntemplatedocumentResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateID)?'null':'"'.$fkiEzsigntemplateID.'"').' for fkiEzsigntemplateID when calling EzsigntemplatedocumentResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatedocumentPagetotal < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentPagetotal when calling EzsigntemplatedocumentResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentPagetotal)?'null':'"'.$iEzsigntemplatedocumentPagetotal.'"').' for iEzsigntemplatedocumentPagetotal when calling EzsigntemplatedocumentResponse., must be bigger than or equal to 1.');
        }
