...
class DepartmentGetMembersV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['aFkiAgentID'] = $data['aFkiAgentID'] ?? null;
        $this->container['aFkiBrokerID'] = $data['aFkiBrokerID'] ?? null;
        $this->container['aFkiCustomerID'] = $data['aFkiCustomerID'] ?? null;
        $this->container['aFkiEmployeeID'] = $data['aFkiEmployeeID'] ?? null;
    }
