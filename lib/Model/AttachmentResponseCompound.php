...
class AttachmentResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//if ((!preg_match("/^.{0,32}$/", ObjectSerializer::toString($sAttachmentMD5)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sAttachmentMD5 when calling AttachmentResponseCompound., must conform to the pattern /^.{0,32}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sAttachmentMD5)?'null':'"'.$sAttachmentMD5.'"')." for sAttachmentMD5 when calling AttachmentResponseCompound., must conform to the pattern /^.{0,32}$/.");
        }
