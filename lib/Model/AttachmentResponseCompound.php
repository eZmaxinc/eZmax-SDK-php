...
/**
 * AttachmentResponseCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class AttachmentResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'attachment-ResponseCompound';
    ...
    public function listInvalidProperties()
    {
        ...
        //if (!preg_match("/^[a-f0-9]{32}$/", $this->container['sAttachmentMD5'])) {
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiAttachmentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiAttachmentID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiAttachmentID)?'null':'"'.$pkiAttachmentID.'"').' for pkiAttachmentID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiComputerID) && ($fkiComputerID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiComputerID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiComputerID)?'null':'"'.$fkiComputerID.'"').' for fkiComputerID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiComputerID < 1)) {
        if (!is_null($fkiComputerID) && ($fkiComputerID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiComputerID when calling AttachmentResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiComputerID)?'null':'"'.$fkiComputerID.'"').' for fkiComputerID when calling AttachmentResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiAdjustmentID) && ($fkiAdjustmentID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiAdjustmentID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAdjustmentID)?'null':'"'.$fkiAdjustmentID.'"').' for fkiAdjustmentID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiAdjustmentID < 0)) {
        if (!is_null($fkiAdjustmentID) && ($fkiAdjustmentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiAdjustmentID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAdjustmentID)?'null':'"'.$fkiAdjustmentID.'"').' for fkiAdjustmentID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiAgentID) && ($fkiAgentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiAgentID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAgentID)?'null':'"'.$fkiAgentID.'"').' for fkiAgentID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiBankaccountID) && ($fkiBankaccountID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBankaccountID when calling AttachmentResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBankaccountID)?'null':'"'.$fkiBankaccountID.'"').' for fkiBankaccountID when calling AttachmentResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($fkiBankaccountID < 0)) {
        if (!is_null($fkiBankaccountID) && ($fkiBankaccountID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBankaccountID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBankaccountID)?'null':'"'.$fkiBankaccountID.'"').' for fkiBankaccountID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiBrokerID) && ($fkiBrokerID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBrokerID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBrokerID)?'null':'"'.$fkiBrokerID.'"').' for fkiBrokerID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiCommissionadvanceID) && ($fkiCommissionadvanceID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCommissionadvanceID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCommissionadvanceID)?'null':'"'.$fkiCommissionadvanceID.'"').' for fkiCommissionadvanceID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiCommissionadvanceID < 0)) {
        if (!is_null($fkiCommissionadvanceID) && ($fkiCommissionadvanceID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCommissionadvanceID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCommissionadvanceID)?'null':'"'.$fkiCommissionadvanceID.'"').' for fkiCommissionadvanceID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiCommunicationID) && ($fkiCommunicationID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCommunicationID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCommunicationID)?'null':'"'.$fkiCommunicationID.'"').' for fkiCommunicationID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiCustomerID) && ($fkiCustomerID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCustomerID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCustomerID)?'null':'"'.$fkiCustomerID.'"').' for fkiCustomerID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiCustomertemplateID) && ($fkiCustomertemplateID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCustomertemplateID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCustomertemplateID)?'null':'"'.$fkiCustomertemplateID.'"').' for fkiCustomertemplateID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiCustomertemplateID < 0)) {
        if (!is_null($fkiCustomertemplateID) && ($fkiCustomertemplateID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiCustomertemplateID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCustomertemplateID)?'null':'"'.$fkiCustomertemplateID.'"').' for fkiCustomertemplateID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiDepositID) && ($fkiDepositID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDepositID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDepositID)?'null':'"'.$fkiDepositID.'"').' for fkiDepositID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
        }
        //if (($fkiDepositID < 0)) {
        if (!is_null($fkiDepositID) && ($fkiDepositID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDepositID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDepositID)?'null':'"'.$fkiDepositID.'"').' for fkiDepositID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiDeposittransitchequeID) && ($fkiDeposittransitchequeID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDeposittransitchequeID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDeposittransitchequeID)?'null':'"'.$fkiDeposittransitchequeID.'"').' for fkiDeposittransitchequeID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiDeposittransitchequeID < 0)) {
        if (!is_null($fkiDeposittransitchequeID) && ($fkiDeposittransitchequeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDeposittransitchequeID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDeposittransitchequeID)?'null':'"'.$fkiDeposittransitchequeID.'"').' for fkiDeposittransitchequeID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiElectronicfundstransferID) && ($fkiElectronicfundstransferID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiElectronicfundstransferID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiElectronicfundstransferID)?'null':'"'.$fkiElectronicfundstransferID.'"').' for fkiElectronicfundstransferID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiElectronicfundstransferID < 1)) {
        if (!is_null($fkiElectronicfundstransferID) && ($fkiElectronicfundstransferID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiElectronicfundstransferID when calling AttachmentResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiElectronicfundstransferID)?'null':'"'.$fkiElectronicfundstransferID.'"').' for fkiElectronicfundstransferID when calling AttachmentResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEmployeeID) && ($fkiEmployeeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEmployeeID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEmployeeID)?'null':'"'.$fkiEmployeeID.'"').' for fkiEmployeeID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiExternalbrokerID) && ($fkiExternalbrokerID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiExternalbrokerID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiExternalbrokerID)?'null':'"'.$fkiExternalbrokerID.'"').' for fkiExternalbrokerID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzcomadvanceserverID) && ($fkiEzcomadvanceserverID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzcomadvanceserverID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzcomadvanceserverID)?'null':'"'.$fkiEzcomadvanceserverID.'"').' for fkiEzcomadvanceserverID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
        }
        //if (($fkiEzcomadvanceserverID < 0)) {
        if (!is_null($fkiEzcomadvanceserverID) && ($fkiEzcomadvanceserverID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzcomadvanceserverID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzcomadvanceserverID)?'null':'"'.$fkiEzcomadvanceserverID.'"').' for fkiEzcomadvanceserverID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzcomcompanyID) && ($fkiEzcomcompanyID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzcomcompanyID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzcomcompanyID)?'null':'"'.$fkiEzcomcompanyID.'"').' for fkiEzcomcompanyID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiEzcomcompanyID < 0)) {
        if (!is_null($fkiEzcomcompanyID) && ($fkiEzcomcompanyID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzcomcompanyID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzcomcompanyID)?'null':'"'.$fkiEzcomcompanyID.'"').' for fkiEzcomcompanyID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigndocumentID) && ($fkiEzsigndocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigndocumentID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigndocumentID)?'null':'"'.$fkiEzsigndocumentID.'"').' for fkiEzsigndocumentID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiGhacqcontractID) && ($fkiGhacqcontractID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiGhacqcontractID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiGhacqcontractID)?'null':'"'.$fkiGhacqcontractID.'"').' for fkiGhacqcontractID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
        }
        //if (($fkiGhacqcontractID < 0)) {
        if (!is_null($fkiGhacqcontractID) && ($fkiGhacqcontractID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiGhacqcontractID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiGhacqcontractID)?'null':'"'.$fkiGhacqcontractID.'"').' for fkiGhacqcontractID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiInscriptionID) && ($fkiInscriptionID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiInscriptionID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiInscriptionID)?'null':'"'.$fkiInscriptionID.'"').' for fkiInscriptionID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiInscriptiontempID) && ($fkiInscriptiontempID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiInscriptiontempID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiInscriptiontempID)?'null':'"'.$fkiInscriptiontempID.'"').' for fkiInscriptiontempID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
        }
        //if (($fkiInscriptiontempID < 1)) {
        if (!is_null($fkiInscriptiontempID) && ($fkiInscriptiontempID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiInscriptiontempID when calling AttachmentResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiInscriptiontempID)?'null':'"'.$fkiInscriptiontempID.'"').' for fkiInscriptiontempID when calling AttachmentResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiInscriptionnotauthenticatedID) && ($fkiInscriptionnotauthenticatedID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiInscriptionnotauthenticatedID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiInscriptionnotauthenticatedID)?'null':'"'.$fkiInscriptionnotauthenticatedID.'"').' for fkiInscriptionnotauthenticatedID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiInvoiceID) && ($fkiInvoiceID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiInvoiceID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiInvoiceID)?'null':'"'.$fkiInvoiceID.'"').' for fkiInvoiceID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiBuyercontractID) && ($fkiBuyercontractID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBuyercontractID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBuyercontractID)?'null':'"'.$fkiBuyercontractID.'"').' for fkiBuyercontractID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiBuyercontractID < 1)) {
        if (!is_null($fkiBuyercontractID) && ($fkiBuyercontractID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBuyercontractID when calling AttachmentResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBuyercontractID)?'null':'"'.$fkiBuyercontractID.'"').' for fkiBuyercontractID when calling AttachmentResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiFranchisebrokerID) && ($fkiFranchisebrokerID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFranchisebrokerID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFranchisebrokerID)?'null':'"'.$fkiFranchisebrokerID.'"').' for fkiFranchisebrokerID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiFranchiseagenceID) && ($fkiFranchiseagenceID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFranchiseagenceID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFranchiseagenceID)?'null':'"'.$fkiFranchiseagenceID.'"').' for fkiFranchiseagenceID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiFranchiseagenceID < 0)) {
        if (!is_null($fkiFranchiseagenceID) && ($fkiFranchiseagenceID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFranchiseagenceID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFranchiseagenceID)?'null':'"'.$fkiFranchiseagenceID.'"').' for fkiFranchiseagenceID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiFranchiseofficeID) && ($fkiFranchiseofficeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFranchiseofficeID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFranchiseofficeID)?'null':'"'.$fkiFranchiseofficeID.'"').' for fkiFranchiseofficeID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiFranchisefranchiseID) && ($fkiFranchisefranchiseID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFranchisefranchiseID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFranchisefranchiseID)?'null':'"'.$fkiFranchisefranchiseID.'"').' for fkiFranchisefranchiseID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiFranchisefranchiseID < 0)) {
        if (!is_null($fkiFranchisefranchiseID) && ($fkiFranchisefranchiseID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFranchisefranchiseID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFranchisefranchiseID)?'null':'"'.$fkiFranchisefranchiseID.'"').' for fkiFranchisefranchiseID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiFranchisecomplaintID) && ($fkiFranchisecomplaintID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFranchisecomplaintID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFranchisecomplaintID)?'null':'"'.$fkiFranchisecomplaintID.'"').' for fkiFranchisecomplaintID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiFranchisecomplaintID < 0)) {
        if (!is_null($fkiFranchisecomplaintID) && ($fkiFranchisecomplaintID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFranchisecomplaintID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFranchisecomplaintID)?'null':'"'.$fkiFranchisecomplaintID.'"').' for fkiFranchisecomplaintID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiLeadID) && ($fkiLeadID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLeadID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLeadID)?'null':'"'.$fkiLeadID.'"').' for fkiLeadID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiLeadID < 0)) {
        if (!is_null($fkiLeadID) && ($fkiLeadID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLeadID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLeadID)?'null':'"'.$fkiLeadID.'"').' for fkiLeadID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiMarketingprogramID) && ($fkiMarketingprogramID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiMarketingprogramID when calling AttachmentResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiMarketingprogramID)?'null':'"'.$fkiMarketingprogramID.'"').' for fkiMarketingprogramID when calling AttachmentResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($fkiMarketingprogramID < 0)) {
        if (!is_null($fkiMarketingprogramID) && ($fkiMarketingprogramID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiMarketingprogramID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiMarketingprogramID)?'null':'"'.$fkiMarketingprogramID.'"').' for fkiMarketingprogramID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiMarketingfollowID) && ($fkiMarketingfollowID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiMarketingfollowID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiMarketingfollowID)?'null':'"'.$fkiMarketingfollowID.'"').' for fkiMarketingfollowID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiMarketingfollowID < 0)) {
        if (!is_null($fkiMarketingfollowID) && ($fkiMarketingfollowID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiMarketingfollowID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiMarketingfollowID)?'null':'"'.$fkiMarketingfollowID.'"').' for fkiMarketingfollowID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiNotaryID) && ($fkiNotaryID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiNotaryID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiNotaryID)?'null':'"'.$fkiNotaryID.'"').' for fkiNotaryID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiOfficetaxreportID) && ($fkiOfficetaxreportID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiOfficetaxreportID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiOfficetaxreportID)?'null':'"'.$fkiOfficetaxreportID.'"').' for fkiOfficetaxreportID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiOfficetaxreportID < 0)) {
        if (!is_null($fkiOfficetaxreportID) && ($fkiOfficetaxreportID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiOfficetaxreportID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiOfficetaxreportID)?'null':'"'.$fkiOfficetaxreportID.'"').' for fkiOfficetaxreportID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiOtherincomeID) && ($fkiOtherincomeID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiOtherincomeID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiOtherincomeID)?'null':'"'.$fkiOtherincomeID.'"').' for fkiOtherincomeID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiOtherincomeID < 1)) {
        if (!is_null($fkiOtherincomeID) && ($fkiOtherincomeID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiOtherincomeID when calling AttachmentResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiOtherincomeID)?'null':'"'.$fkiOtherincomeID.'"').' for fkiOtherincomeID when calling AttachmentResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiPaymentpreparationID) && ($fkiPaymentpreparationID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiPaymentpreparationID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPaymentpreparationID)?'null':'"'.$fkiPaymentpreparationID.'"').' for fkiPaymentpreparationID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
        }
        //if (($fkiPaymentpreparationID < 0)) {
        if (!is_null($fkiPaymentpreparationID) && ($fkiPaymentpreparationID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiPaymentpreparationID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPaymentpreparationID)?'null':'"'.$fkiPaymentpreparationID.'"').' for fkiPaymentpreparationID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiSalaryID) && ($fkiSalaryID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiSalaryID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiSalaryID)?'null':'"'.$fkiSalaryID.'"').' for fkiSalaryID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
        }
        //if (($fkiSalaryID < 0)) {
        if (!is_null($fkiSalaryID) && ($fkiSalaryID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiSalaryID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiSalaryID)?'null':'"'.$fkiSalaryID.'"').' for fkiSalaryID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiSupplierID) && ($fkiSupplierID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiSupplierID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiSupplierID)?'null':'"'.$fkiSupplierID.'"').' for fkiSupplierID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiTranqcontractID) && ($fkiTranqcontractID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiTranqcontractID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiTranqcontractID)?'null':'"'.$fkiTranqcontractID.'"').' for fkiTranqcontractID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
        }
        //if (($fkiTranqcontractID < 0)) {
        if (!is_null($fkiTranqcontractID) && ($fkiTranqcontractID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiTranqcontractID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiTranqcontractID)?'null':'"'.$fkiTranqcontractID.'"').' for fkiTranqcontractID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiTemplateID) && ($fkiTemplateID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiTemplateID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiTemplateID)?'null':'"'.$fkiTemplateID.'"').' for fkiTemplateID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiTemplateID < 0)) {
        if (!is_null($fkiTemplateID) && ($fkiTemplateID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiTemplateID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiTemplateID)?'null':'"'.$fkiTemplateID.'"').' for fkiTemplateID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiDocumenttypechecklistID) && ($fkiDocumenttypechecklistID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDocumenttypechecklistID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDocumenttypechecklistID)?'null':'"'.$fkiDocumenttypechecklistID.'"').' for fkiDocumenttypechecklistID when calling AttachmentResponseCompound., must be smaller than or equal to 16777215.');
        }
        //if (($fkiDocumenttypechecklistID < 0)) {
        if (!is_null($fkiDocumenttypechecklistID) && ($fkiDocumenttypechecklistID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDocumenttypechecklistID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDocumenttypechecklistID)?'null':'"'.$fkiDocumenttypechecklistID.'"').' for fkiDocumenttypechecklistID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sDocumenttypeNameX) && (!preg_match("/(*UTF8)^.{0,55}$/", ObjectSerializer::toString($sDocumenttypeNameX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sDocumenttypeNameX when calling AttachmentResponseCompound., must conform to the pattern /^.{0,55}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sDocumenttypeNameX)?'null':'"'.$sDocumenttypeNameX.'"')." for sDocumenttypeNameX when calling AttachmentResponseCompound., must conform to the pattern /^.{0,55}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiFolderID) && ($fkiFolderID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFolderID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFolderID)?'null':'"'.$fkiFolderID.'"').' for fkiFolderID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiFolderID < 0)) {
        if (!is_null($fkiFolderID) && ($fkiFolderID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFolderID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFolderID)?'null':'"'.$fkiFolderID.'"').' for fkiFolderID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiRejectedoffertopurchaseID) && ($fkiRejectedoffertopurchaseID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiRejectedoffertopurchaseID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiRejectedoffertopurchaseID)?'null':'"'.$fkiRejectedoffertopurchaseID.'"').' for fkiRejectedoffertopurchaseID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiRejectedoffertopurchaseID < 1)) {
        if (!is_null($fkiRejectedoffertopurchaseID) && ($fkiRejectedoffertopurchaseID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiRejectedoffertopurchaseID when calling AttachmentResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiRejectedoffertopurchaseID)?'null':'"'.$fkiRejectedoffertopurchaseID.'"').' for fkiRejectedoffertopurchaseID when calling AttachmentResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiDisclosureID) && ($fkiDisclosureID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDisclosureID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDisclosureID)?'null':'"'.$fkiDisclosureID.'"').' for fkiDisclosureID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiDisclosureID < 0)) {
        if (!is_null($fkiDisclosureID) && ($fkiDisclosureID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDisclosureID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDisclosureID)?'null':'"'.$fkiDisclosureID.'"').' for fkiDisclosureID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiReconciliationID) && ($fkiReconciliationID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiReconciliationID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiReconciliationID)?'null':'"'.$fkiReconciliationID.'"').' for fkiReconciliationID when calling AttachmentResponseCompound., must be smaller than or equal to 65535.');
        }
        //if (($fkiReconciliationID < 0)) {
        if (!is_null($fkiReconciliationID) && ($fkiReconciliationID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiReconciliationID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiReconciliationID)?'null':'"'.$fkiReconciliationID.'"').' for fkiReconciliationID when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigndocumentIDReference) && ($fkiEzsigndocumentIDReference < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigndocumentIDReference when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigndocumentIDReference)?'null':'"'.$fkiEzsigndocumentIDReference.'"').' for fkiEzsigndocumentIDReference when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sAttachmentName) && (!preg_match("/(*UTF8)^(?!\\.{1,2}$)(?!.*[ .]$)(?!(?:CON|PRN|AUX|NUL|COM(?:[1-9]|[¹²³])|LPT(?:[1-9]|[¹²³]))(?:\\.|$))[^\\x00-\\x1F<>:\"\/\\\\\\\\|?*]{1,75}$/", ObjectSerializer::toString($sAttachmentName)))) {
            //throw new \InvalidArgumentException("invalid value for \$sAttachmentName when calling AttachmentResponseCompound., must conform to the pattern /^(?!\\.{1,2}$)(?!.*[ .]$)(?!(?:CON|PRN|AUX|NUL|COM(?:[1-9]|[¹²³])|LPT(?:[1-9]|[¹²³]))(?:\\.|$))[^\\x00-\\x1F<>:\"\/\\\\\\\\|?*]{1,75}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sAttachmentName)?'null':'"'.$sAttachmentName.'"')." for sAttachmentName when calling AttachmentResponseCompound., must conform to the pattern /^(?!\\.{1,2}$)(?!.*[ .]$)(?!(?:CON|PRN|AUX|NUL|COM(?:[1-9]|[¹²³])|LPT(?:[1-9]|[¹²³]))(?:\\.|$))[^\\x00-\\x1F<>:\"\/\\\\\\\\|?*]{1,75}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sAttachmentCategory) && (!preg_match("/(*UTF8)^(?!\\.{1,2}$)(?!.*[ .]$)(?!(?:CON|PRN|AUX|NUL|COM(?:[1-9]|[¹²³])|LPT(?:[1-9]|[¹²³]))(?:\\.|$))[^\\x00-\\x1F<>:\"\/\\\\\\\\|?*]{0,75}$/", ObjectSerializer::toString($sAttachmentCategory)))) {
            //throw new \InvalidArgumentException("invalid value for \$sAttachmentCategory when calling AttachmentResponseCompound., must conform to the pattern /^(?!\\.{1,2}$)(?!.*[ .]$)(?!(?:CON|PRN|AUX|NUL|COM(?:[1-9]|[¹²³])|LPT(?:[1-9]|[¹²³]))(?:\\.|$))[^\\x00-\\x1F<>:\"\/\\\\\\\\|?*]{0,75}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sAttachmentCategory)?'null':'"'.$sAttachmentCategory.'"')." for sAttachmentCategory when calling AttachmentResponseCompound., must conform to the pattern /^(?!\\.{1,2}$)(?!.*[ .]$)(?!(?:CON|PRN|AUX|NUL|COM(?:[1-9]|[¹²³])|LPT(?:[1-9]|[¹²³]))(?:\\.|$))[^\\x00-\\x1F<>:\"\/\\\\\\\\|?*]{0,75}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUserIDSpecific) && ($fkiUserIDSpecific < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserIDSpecific when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserIDSpecific)?'null':'"'.$fkiUserIDSpecific.'"').' for fkiUserIDSpecific when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iAttachmentSize > 4294967295)) {
            //throw new \InvalidArgumentException('invalid value for $iAttachmentSize when calling AttachmentResponseCompound., must be smaller than or equal to 4294967295.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iAttachmentSize)?'null':'"'.$iAttachmentSize.'"').' for iAttachmentSize when calling AttachmentResponseCompound., must be smaller than or equal to 4294967295.');
        }
        //if (($iAttachmentSize < 0)) {
        if (($iAttachmentSize < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iAttachmentSize when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iAttachmentSize)?'null':'"'.$iAttachmentSize.'"').' for iAttachmentSize when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iAttachmentEDMmoduleflag) && ($iAttachmentEDMmoduleflag > 255)) {
            //throw new \InvalidArgumentException('invalid value for $iAttachmentEDMmoduleflag when calling AttachmentResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iAttachmentEDMmoduleflag)?'null':'"'.$iAttachmentEDMmoduleflag.'"').' for iAttachmentEDMmoduleflag when calling AttachmentResponseCompound., must be smaller than or equal to 255.');
        }
        //if (($iAttachmentEDMmoduleflag < 0)) {
        if (!is_null($iAttachmentEDMmoduleflag) && ($iAttachmentEDMmoduleflag < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iAttachmentEDMmoduleflag when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iAttachmentEDMmoduleflag)?'null':'"'.$iAttachmentEDMmoduleflag.'"').' for iAttachmentEDMmoduleflag when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sAttachmentMD5) && (!preg_match("/(*UTF8)^[a-f0-9]{32}$/", ObjectSerializer::toString($sAttachmentMD5)))) {
            //throw new \InvalidArgumentException("invalid value for \$sAttachmentMD5 when calling AttachmentResponseCompound., must conform to the pattern /^[a-f0-9]{32}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sAttachmentMD5)?'null':'"'.$sAttachmentMD5.'"')." for sAttachmentMD5 when calling AttachmentResponseCompound., must conform to the pattern /^[a-f0-9]{32}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($tAttachmentRejectioncomment) && (!preg_match("/(*UTF8)^.{0,65535}$/", ObjectSerializer::toString($tAttachmentRejectioncomment)))) {
            //throw new \InvalidArgumentException("invalid value for \$tAttachmentRejectioncomment when calling AttachmentResponseCompound., must conform to the pattern /^.{0,65535}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($tAttachmentRejectioncomment)?'null':'"'.$tAttachmentRejectioncomment.'"')." for tAttachmentRejectioncomment when calling AttachmentResponseCompound., must conform to the pattern /^.{0,65535}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUserIDOwner) && ($fkiUserIDOwner < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserIDOwner when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserIDOwner)?'null':'"'.$fkiUserIDOwner.'"').' for fkiUserIDOwner when calling AttachmentResponseCompound., must be bigger than or equal to 0.');
        }
