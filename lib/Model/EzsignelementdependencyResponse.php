...
class EzsignelementdependencyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//if (($pkiEzsignelementdependencyID > 16777215)) {
        if (($pkiEzsignelementdependencyID > 16777215)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignelementdependencyID when calling EzsignelementdependencyResponse., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignelementdependencyID)?'null':'"'.$pkiEzsignelementdependencyID.'"').' for pkiEzsignelementdependencyID when calling EzsignelementdependencyResponse., must be smaller than or equal to 16777215.');
        }
	//if (($pkiEzsignelementdependencyID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignelementdependencyID when calling EzsignelementdependencyResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignelementdependencyID)?'null':'"'.$pkiEzsignelementdependencyID.'"').' for pkiEzsignelementdependencyID when calling EzsignelementdependencyResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignformfieldID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignformfieldID when calling EzsignelementdependencyResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignformfieldID)?'null':'"'.$fkiEzsignformfieldID.'"').' for fkiEzsignformfieldID when calling EzsignelementdependencyResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignsignatureID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignsignatureID when calling EzsignelementdependencyResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsignatureID)?'null':'"'.$fkiEzsignsignatureID.'"').' for fkiEzsignsignatureID when calling EzsignelementdependencyResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignformfieldIDValidation < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignformfieldIDValidation when calling EzsignelementdependencyResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignformfieldIDValidation)?'null':'"'.$fkiEzsignformfieldIDValidation.'"').' for fkiEzsignformfieldIDValidation when calling EzsignelementdependencyResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignformfieldgroupIDValidation < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignformfieldgroupIDValidation when calling EzsignelementdependencyResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignformfieldgroupIDValidation)?'null':'"'.$fkiEzsignformfieldgroupIDValidation.'"').' for fkiEzsignformfieldgroupIDValidation when calling EzsignelementdependencyResponse., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{0,50}$/", ObjectSerializer::toString($sEzsignelementdependencyValue)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsignelementdependencyValue when calling EzsignelementdependencyResponse., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignelementdependencyValue)?'null':'"'.$sEzsignelementdependencyValue.'"')." for sEzsignelementdependencyValue when calling EzsignelementdependencyResponse., must conform to the pattern /^.{0,50}$/.");
        }
