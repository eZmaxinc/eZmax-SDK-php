...
class EzmaxinvoicingsummaryglobalResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryglobalCountreal']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryglobalCountreal'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryglobalCountreal'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryglobalCountreal'].'"')." for 'dEzmaxinvoicingsummaryglobalCountreal', must be conform to the pattern /^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryglobalCountbilled']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryglobalCountbilled'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryglobalCountbilled'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryglobalCountbilled'].'"')." for 'dEzmaxinvoicingsummaryglobalCountbilled', must be conform to the pattern /^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryglobalSubtotal']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryglobalSubtotal'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryglobalSubtotal'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryglobalSubtotal'].'"')." for 'dEzmaxinvoicingsummaryglobalSubtotal', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryglobalRebateamount']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryglobalRebateamount'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryglobalRebateamount'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryglobalRebateamount'].'"')." for 'dEzmaxinvoicingsummaryglobalRebateamount', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryglobalRebatepercent']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryglobalRebatepercent'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryglobalRebatepercent'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryglobalRebatepercent'].'"')." for 'dEzmaxinvoicingsummaryglobalRebatepercent', must be conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryglobalRebatetotal']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryglobalRebatetotal'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryglobalRebatetotal'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryglobalRebatetotal'].'"')." for 'dEzmaxinvoicingsummaryglobalRebatetotal', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryglobalTotal']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryglobalTotal'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryglobalTotal'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryglobalTotal'].'"')." for 'dEzmaxinvoicingsummaryglobalTotal', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryglobalRepresentative']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryglobalRepresentative'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryglobalRepresentative'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryglobalRepresentative'].'"')." for 'dEzmaxinvoicingsummaryglobalRepresentative', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryglobalPartner']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryglobalPartner'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryglobalPartner'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryglobalPartner'].'"')." for 'dEzmaxinvoicingsummaryglobalPartner', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingsummaryglobalNet']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingsummaryglobalNet'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingsummaryglobalNet'])?'null':'"'.$this->container['dEzmaxinvoicingsummaryglobalNet'].'"')." for 'dEzmaxinvoicingsummaryglobalNet', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzmaxinvoicingsummaryglobalID) && ($pkiEzmaxinvoicingsummaryglobalID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzmaxinvoicingsummaryglobalID)?'null':'"'.$pkiEzmaxinvoicingsummaryglobalID.'"').' for pkiEzmaxinvoicingsummaryglobalID when calling EzmaxinvoicingsummaryglobalResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzmaxinvoicingID) && ($fkiEzmaxinvoicingID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxinvoicingID)?'null':'"'.$fkiEzmaxinvoicingID.'"').' for fkiEzmaxinvoicingID when calling EzmaxinvoicingsummaryglobalResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzmaxproductID < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxproductID)?'null':'"'.$fkiEzmaxproductID.'"').' for fkiEzmaxproductID when calling EzmaxinvoicingsummaryglobalResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzmaxinvoicingsummaryglobalDays < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzmaxinvoicingsummaryglobalDays)?'null':'"'.$iEzmaxinvoicingsummaryglobalDays.'"').' for iEzmaxinvoicingsummaryglobalDays when calling EzmaxinvoicingsummaryglobalResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryglobalCountreal) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryglobalCountreal)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryglobalCountreal)?'null':'"'.$dEzmaxinvoicingsummaryglobalCountreal.'"')." for dEzmaxinvoicingsummaryglobalCountreal when calling EzmaxinvoicingsummaryglobalResponse., must conform to the pattern /^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryglobalCountbilled) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryglobalCountbilled)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryglobalCountbilled)?'null':'"'.$dEzmaxinvoicingsummaryglobalCountbilled.'"')." for dEzmaxinvoicingsummaryglobalCountbilled when calling EzmaxinvoicingsummaryglobalResponse., must conform to the pattern /^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryglobalSubtotal) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryglobalSubtotal)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryglobalSubtotal)?'null':'"'.$dEzmaxinvoicingsummaryglobalSubtotal.'"')." for dEzmaxinvoicingsummaryglobalSubtotal when calling EzmaxinvoicingsummaryglobalResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryglobalRebateamount) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryglobalRebateamount)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryglobalRebateamount)?'null':'"'.$dEzmaxinvoicingsummaryglobalRebateamount.'"')." for dEzmaxinvoicingsummaryglobalRebateamount when calling EzmaxinvoicingsummaryglobalResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryglobalRebatepercent) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryglobalRebatepercent)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryglobalRebatepercent)?'null':'"'.$dEzmaxinvoicingsummaryglobalRebatepercent.'"')." for dEzmaxinvoicingsummaryglobalRebatepercent when calling EzmaxinvoicingsummaryglobalResponse., must conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryglobalRebatetotal) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryglobalRebatetotal)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryglobalRebatetotal)?'null':'"'.$dEzmaxinvoicingsummaryglobalRebatetotal.'"')." for dEzmaxinvoicingsummaryglobalRebatetotal when calling EzmaxinvoicingsummaryglobalResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryglobalTotal) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryglobalTotal)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryglobalTotal)?'null':'"'.$dEzmaxinvoicingsummaryglobalTotal.'"')." for dEzmaxinvoicingsummaryglobalTotal when calling EzmaxinvoicingsummaryglobalResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryglobalRepresentative) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryglobalRepresentative)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryglobalRepresentative)?'null':'"'.$dEzmaxinvoicingsummaryglobalRepresentative.'"')." for dEzmaxinvoicingsummaryglobalRepresentative when calling EzmaxinvoicingsummaryglobalResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryglobalPartner) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryglobalPartner)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryglobalPartner)?'null':'"'.$dEzmaxinvoicingsummaryglobalPartner.'"')." for dEzmaxinvoicingsummaryglobalPartner when calling EzmaxinvoicingsummaryglobalResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryglobalNet) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryglobalNet)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryglobalNet)?'null':'"'.$dEzmaxinvoicingsummaryglobalNet.'"')." for dEzmaxinvoicingsummaryglobalNet when calling EzmaxinvoicingsummaryglobalResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
