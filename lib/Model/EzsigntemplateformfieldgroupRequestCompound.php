...
/**
 * EzsigntemplateformfieldgroupRequestCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplateformfieldgroupRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplateformfieldgroup-RequestCompound';
    ...
    protected static $openAPITypes = [
        ...
        'aObjEzsigntemplateformfieldgroupsigner' => '\eZmaxAPI\Model\EzsigntemplateformfieldgroupsignerRequestCompound[]',
        'aObjDropdownElement' => '\eZmaxAPI\Model\CustomDropdownElementRequestCompound[]',
        'aObjEzsigntemplateformfield' => '\eZmaxAPI\Model\EzsigntemplateformfieldRequestCompound[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sEzsigntemplateformfieldgroupRegexp']) && !preg_match("/(*UTF8)^\\^.*\\$$|^$/", $this->container['sEzsigntemplateformfieldgroupRegexp'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsigntemplateformfieldgroupRegexp'])?'null':'"'.$this->container['sEzsigntemplateformfieldgroupRegexp'].'"')." for 'sEzsigntemplateformfieldgroupRegexp', must be conform to the pattern /^\\^.*\\$$|^$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzsigntemplateformfieldgroupID) && ($pkiEzsigntemplateformfieldgroupID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplateformfieldgroupID when calling EzsigntemplateformfieldgroupRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateformfieldgroupID)?'null':'"'.$pkiEzsigntemplateformfieldgroupID.'"').' for pkiEzsigntemplateformfieldgroupID when calling EzsigntemplateformfieldgroupRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigntemplatedocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatedocumentID when calling EzsigntemplateformfieldgroupRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatedocumentID)?'null':'"'.$fkiEzsigntemplatedocumentID.'"').' for fkiEzsigntemplatedocumentID when calling EzsigntemplateformfieldgroupRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if ((mb_strlen($sEzsigntemplateformfieldgroupLabel) > 50)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsigntemplateformfieldgroupLabel when calling EzsigntemplateformfieldgroupRequestCompound., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsigntemplateformfieldgroupLabel)?'null':'"'.$sEzsigntemplateformfieldgroupLabel.'"').', invalid length for sEzsigntemplateformfieldgroupLabel when calling EzsigntemplateformfieldgroupRequestCompound., must be smaller than or equal to 50.');
        }
        //if ((mb_strlen($sEzsigntemplateformfieldgroupLabel) < 1)) {
        if ((mb_strlen($sEzsigntemplateformfieldgroupLabel) < 1)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsigntemplateformfieldgroupLabel when calling EzsigntemplateformfieldgroupRequestCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsigntemplateformfieldgroupLabel)?'null':'"'.$sEzsigntemplateformfieldgroupLabel.'"').', invalid length for sEzsigntemplateformfieldgroupLabel when calling EzsigntemplateformfieldgroupRequestCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplateformfieldgroupStep < 1)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldgroupStep when calling EzsigntemplateformfieldgroupRequestCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldgroupStep)?'null':'"'.$iEzsigntemplateformfieldgroupStep.'"').' for iEzsigntemplateformfieldgroupStep when calling EzsigntemplateformfieldgroupRequestCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplateformfieldgroupFilledmin < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldgroupFilledmin when calling EzsigntemplateformfieldgroupRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldgroupFilledmin)?'null':'"'.$iEzsigntemplateformfieldgroupFilledmin.'"').' for iEzsigntemplateformfieldgroupFilledmin when calling EzsigntemplateformfieldgroupRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplateformfieldgroupFilledmax < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldgroupFilledmax when calling EzsigntemplateformfieldgroupRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldgroupFilledmax)?'null':'"'.$iEzsigntemplateformfieldgroupFilledmax.'"').' for iEzsigntemplateformfieldgroupFilledmax when calling EzsigntemplateformfieldgroupRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplateformfieldgroupMaxlength) && ($iEzsigntemplateformfieldgroupMaxlength > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldgroupMaxlength when calling EzsigntemplateformfieldgroupRequestCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldgroupMaxlength)?'null':'"'.$iEzsigntemplateformfieldgroupMaxlength.'"').' for iEzsigntemplateformfieldgroupMaxlength when calling EzsigntemplateformfieldgroupRequestCompound., must be smaller than or equal to 65535.');
        }
        ...
        if (!is_null($iEzsigntemplateformfieldgroupMaxlength) && ($iEzsigntemplateformfieldgroupMaxlength < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplateformfieldgroupMaxlength when calling EzsigntemplateformfieldgroupRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplateformfieldgroupMaxlength)?'null':'"'.$iEzsigntemplateformfieldgroupMaxlength.'"').' for iEzsigntemplateformfieldgroupMaxlength when calling EzsigntemplateformfieldgroupRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplateformfieldgroupRegexp) && (!preg_match("/(*UTF8)^\\^.*\\$$|^$/", ObjectSerializer::toString($sEzsigntemplateformfieldgroupRegexp)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplateformfieldgroupRegexp when calling EzsigntemplateformfieldgroupRequestCompound., must conform to the pattern /^\\^.*\\$$|^$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplateformfieldgroupRegexp)?'null':'"'.$sEzsigntemplateformfieldgroupRegexp.'"')." for sEzsigntemplateformfieldgroupRegexp when calling EzsigntemplateformfieldgroupRequestCompound., must conform to the pattern /^\\^.*\\$$|^$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplateformfieldgroupTextvalidationcustommessage) && (mb_strlen($sEzsigntemplateformfieldgroupTextvalidationcustommessage) < 0)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsigntemplateformfieldgroupTextvalidationcustommessage when calling EzsigntemplateformfieldgroupRequestCompound., must be bigger than or equal to 0.');
     ...
     *
     * @return \eZmaxAPI\Model\EzsigntemplateformfieldgroupsignerRequestCompound[]
     */
     ...
     *
     * @param \eZmaxAPI\Model\EzsigntemplateformfieldgroupsignerRequestCompound[] $aObjEzsigntemplateformfieldgroupsigner aObjEzsigntemplateformfieldgroupsigner
     *
     * @return self
     */
     ...
     *
     * @return \eZmaxAPI\Model\EzsigntemplateformfieldRequestCompound[]
     */
     ...
     *
     * @param \eZmaxAPI\Model\EzsigntemplateformfieldRequestCompound[] $aObjEzsigntemplateformfield aObjEzsigntemplateformfield
     *
     * @return self
     */
