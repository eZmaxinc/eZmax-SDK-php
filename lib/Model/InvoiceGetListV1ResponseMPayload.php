...
/**
 * InvoiceGetListV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /1/object/invoice/getList
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InvoiceGetListV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'invoice-getList-v1-Response-mPayload';
    ...
    protected static $openAPITypes = [
        'iRowReturned' => 'int',
        'iRowFiltered' => 'int',
        'aObjInvoice' => '\eZmaxAPI\Model\InvoiceListElement[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aObjInvoice', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aObjInvoice'] === null) {
            $invalidProperties[] = "'aObjInvoice' can't be null";
        }
     ...
     * Gets aObjInvoice
     *
     * @return \eZmaxAPI\Model\InvoiceListElement[]
     */
    public function getAObjInvoice()
    {
	//return $this->container['aObjInvoice'];
        return $this->container['aObjInvoice'];
    }
     ...
     * Sets aObjInvoice
     *
     * @param \eZmaxAPI\Model\InvoiceListElement[] $aObjInvoice aObjInvoice
     *
     * @return self
     */
    public function setAObjInvoice($aObjInvoice)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjInvoice)) {
            //throw new \InvalidArgumentException('non-nullable aObjInvoice cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjInvoice'] = $aObjInvoice;
        $this->container['aObjInvoice'] = $aObjInvoice;
