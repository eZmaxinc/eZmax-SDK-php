...
/**
 * CustomEzsignformfieldRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomEzsignformfieldRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Custom-Ezsignformfield-Request';
    ...
    */
	...
	//if (($pkiEzsignformfieldID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignformfieldID when calling CustomEzsignformfieldRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignformfieldID)?'null':'"'.$pkiEzsignformfieldID.'"').' for pkiEzsignformfieldID when calling CustomEzsignformfieldRequest., must be bigger than or equal to 0.');
        }
