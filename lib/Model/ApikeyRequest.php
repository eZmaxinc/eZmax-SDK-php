    ...
    */
	...
	//if (($pkiApikeyID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiApikeyID when calling ApikeyRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiApikeyID)?'null':'"'.$pkiApikeyID.'"').' for pkiApikeyID when calling ApikeyRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling ApikeyRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling ApikeyRequest., must be bigger than or equal to 0.');
        }
