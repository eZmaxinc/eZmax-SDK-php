    ...
    */
	...
	//if (($pkiFranchisereferalincomeID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiFranchisereferalincomeID when calling FranchisereferalincomeRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiFranchisereferalincomeID)?'null':'"'.$pkiFranchisereferalincomeID.'"').' for pkiFranchisereferalincomeID when calling FranchisereferalincomeRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiFranchisebrokerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiFranchisebrokerID when calling FranchisereferalincomeRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFranchisebrokerID)?'null':'"'.$fkiFranchisebrokerID.'"').' for fkiFranchisebrokerID when calling FranchisereferalincomeRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiFranchisereferalincomeprogramID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiFranchisereferalincomeprogramID when calling FranchisereferalincomeRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFranchisereferalincomeprogramID)?'null':'"'.$fkiFranchisereferalincomeprogramID.'"').' for fkiFranchisereferalincomeprogramID when calling FranchisereferalincomeRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiPeriodID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiPeriodID when calling FranchisereferalincomeRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPeriodID)?'null':'"'.$fkiPeriodID.'"').' for fkiPeriodID when calling FranchisereferalincomeRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiFranchiseofficeID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiFranchiseofficeID when calling FranchisereferalincomeRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFranchiseofficeID)?'null':'"'.$fkiFranchiseofficeID.'"').' for fkiFranchiseofficeID when calling FranchisereferalincomeRequest., must be bigger than or equal to 0.');
        }
