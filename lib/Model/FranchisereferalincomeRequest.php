    ...
    */
    ...
    public function setDFranchisereferalincomeLoan($dFranchisereferalincomeLoan)
    {
        ...
        if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $dFranchisereferalincomeLoan))) {
            throw new \InvalidArgumentException("invalid value for \$dFranchisereferalincomeLoan when calling FranchisereferalincomeRequest., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
    ...
    public function setDFranchisereferalincomeFranchiseamount($dFranchisereferalincomeFranchiseamount)
    {
        ...
        if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $dFranchisereferalincomeFranchiseamount))) {
            throw new \InvalidArgumentException("invalid value for \$dFranchisereferalincomeFranchiseamount when calling FranchisereferalincomeRequest., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
    ...
    public function setDFranchisereferalincomeFranchisoramount($dFranchisereferalincomeFranchisoramount)
    {
        ...
        if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $dFranchisereferalincomeFranchisoramount))) {
            throw new \InvalidArgumentException("invalid value for \$dFranchisereferalincomeFranchisoramount when calling FranchisereferalincomeRequest., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
    ...
    public function setDFranchisereferalincomeAgentamount($dFranchisereferalincomeAgentamount)
    {
        ...
        if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $dFranchisereferalincomeAgentamount))) {
            throw new \InvalidArgumentException("invalid value for \$dFranchisereferalincomeAgentamount when calling FranchisereferalincomeRequest., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
