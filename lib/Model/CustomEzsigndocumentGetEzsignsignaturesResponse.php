...
/**
 * CustomEzsigndocumentGetEzsignsignaturesResponse Class Doc Comment
 *
 * @category Class
 * @description An Ezsigndocument Object in the context of a getEzsignsignatures path
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomEzsigndocumentGetEzsignsignaturesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Custom-EzsigndocumentGetEzsignsignatures-Response';
    ...
    */
	...
	//if (($pkiEzsigndocumentID < 0)) {
        if (($pkiEzsigndocumentID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigndocumentID when calling CustomEzsigndocumentGetEzsignsignaturesResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndocumentID)?'null':'"'.$pkiEzsigndocumentID.'"').' for pkiEzsigndocumentID when calling CustomEzsigndocumentGetEzsignsignaturesResponse., must be bigger than or equal to 0.');
        }
