...
/**
 * AuthenticationexternalResponseCompound Class Doc Comment
 *
 * @category Class
...
class AuthenticationexternalResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'authenticationexternal-ResponseCompound';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sAuthenticationexternalAuthorizationurl) && (!preg_match("/(*UTF8)^https:\/\/[^\\s\/$.?#].[^\\s]*$/", ObjectSerializer::toString($sAuthenticationexternalAuthorizationurl)))) {
            //throw new \InvalidArgumentException("invalid value for \$sAuthenticationexternalAuthorizationurl when calling AuthenticationexternalResponseCompound., must conform to the pattern /^https:\/\/[^\\s\/$.?#].[^\\s]*$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sAuthenticationexternalAuthorizationurl)?'null':'"'.$sAuthenticationexternalAuthorizationurl.'"')." for sAuthenticationexternalAuthorizationurl when calling AuthenticationexternalResponseCompound., must conform to the pattern /^https:\/\/[^\\s\/$.?#].[^\\s]*$/.");
        }
