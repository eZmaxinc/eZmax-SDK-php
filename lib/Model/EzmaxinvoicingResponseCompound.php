...
/**
 * EzmaxinvoicingResponseCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class EzmaxinvoicingResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezmaxinvoicing-ResponseCompound';
    ...
    public function listInvalidProperties()
    {
        ...
        if (((is_null($this->container['yyyymmEzmaxinvoicing'])?0:mb_strlen($this->container['yyyymmEzmaxinvoicing'])) > 7)) {
        ...
        if (!is_null($this->container['dEzmaxinvoicingRebatepaymenttype']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingRebatepaymenttype'])) {
            //$invalidProperties[] = "invalid value for 'dEzmaxinvoicingRebatepaymenttype', must be conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingRebatepaymenttype'])?'null':'"'.$this->container['dEzmaxinvoicingRebatepaymenttype'].'"')." for 'dEzmaxinvoicingRebatepaymenttype', must be conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.";
        }
        ...
        if (!is_null($this->container['dEzmaxinvoicingRebatecontractlength']) && !preg_match("/(*UTF8)^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/", $this->container['dEzmaxinvoicingRebatecontractlength'])) {
            //$invalidProperties[] = "invalid value for 'dEzmaxinvoicingRebatecontractlength', must be conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzmaxinvoicingRebatecontractlength'])?'null':'"'.$this->container['dEzmaxinvoicingRebatecontractlength'].'"')." for 'dEzmaxinvoicingRebatecontractlength', must be conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzmaxinvoicingID) && ($pkiEzmaxinvoicingID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzmaxinvoicingID when calling EzmaxinvoicingResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzmaxinvoicingID)?'null':'"'.$pkiEzmaxinvoicingID.'"').' for pkiEzmaxinvoicingID when calling EzmaxinvoicingResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzmaxinvoicingcontractID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzmaxinvoicingcontractID when calling EzmaxinvoicingResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxinvoicingcontractID)?'null':'"'.$fkiEzmaxinvoicingcontractID.'"').' for fkiEzmaxinvoicingcontractID when calling EzmaxinvoicingResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzmaxpricingID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzmaxpricingID when calling EzmaxinvoicingResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxpricingID)?'null':'"'.$fkiEzmaxpricingID.'"').' for fkiEzmaxpricingID when calling EzmaxinvoicingResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiSystemconfigurationtypeID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiSystemconfigurationtypeID when calling EzmaxinvoicingResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiSystemconfigurationtypeID)?'null':'"'.$fkiSystemconfigurationtypeID.'"').' for fkiSystemconfigurationtypeID when calling EzmaxinvoicingResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if ((mb_strlen($yyyymmEzmaxinvoicing) > 7)) {
            //throw new \InvalidArgumentException('invalid length for $yyyymmEzmaxinvoicing when calling EzmaxinvoicingResponseCompound., must be smaller than or equal to 7.');
            throw new \InvalidArgumentException('value '.(is_null($yyyymmEzmaxinvoicing)?'null':'"'.$yyyymmEzmaxinvoicing.'"').', invalid length for yyyymmEzmaxinvoicing when calling EzmaxinvoicingResponseCompound., must be smaller than or equal to 7.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzmaxinvoicingDays < 1)) {
            //throw new \InvalidArgumentException('invalid value for $iEzmaxinvoicingDays when calling EzmaxinvoicingResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzmaxinvoicingDays)?'null':'"'.$iEzmaxinvoicingDays.'"').' for iEzmaxinvoicingDays when calling EzmaxinvoicingResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingRebatepaymenttype) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingRebatepaymenttype)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingRebatepaymenttype)?'null':'"'.$dEzmaxinvoicingRebatepaymenttype.'"')." for dEzmaxinvoicingRebatepaymenttype when calling EzmaxinvoicingResponseCompound., must conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzmaxinvoicingContractlength < 1)) {
            //throw new \InvalidArgumentException('invalid value for $iEzmaxinvoicingContractlength when calling EzmaxinvoicingResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzmaxinvoicingContractlength)?'null':'"'.$iEzmaxinvoicingContractlength.'"').' for iEzmaxinvoicingContractlength when calling EzmaxinvoicingResponseCompound., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingRebatecontractlength) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingRebatecontractlength)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingRebatecontractlength)?'null':'"'.$dEzmaxinvoicingRebatecontractlength.'"')." for dEzmaxinvoicingRebatecontractlength when calling EzmaxinvoicingResponseCompound., must conform to the pattern /^-{0,1}[\\d]{1,3}?\\.[\\d]{2}$/.");
        }
