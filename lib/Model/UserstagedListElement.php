...
//        if (!preg_match("/^.{0,20}$/", $this->container['sUserstagedFirstname'])) {
        if (!is_null($this->container['sUserstagedFirstname']) && !preg_match("/^.{0,20}$/", $this->container['sUserstagedFirstname'])) {
...
//        if (!preg_match("/^.{0,25}$/", $this->container['sUserstagedLastname'])) {
        if (!is_null($this->container['sUserstagedLastname']) && !preg_match("/^.{0,25}$/", $this->container['sUserstagedLastname'])) {
...
//        if (!preg_match("/^.{1,60}$/", $this->container['sUserstagedExternalid'])) {
        if (!is_null($this->container['sUserstagedExternalid']) && !preg_match("/^.{1,60}$/", $this->container['sUserstagedExternalid'])) {
