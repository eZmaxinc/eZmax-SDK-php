...
/**
 * UserstagedListElement Class Doc Comment
 *
 * @category Class
 ...
 */
class UserstagedListElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'userstaged-ListElement';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sUserstagedFirstname']) && !preg_match("/(*UTF8)^.{0,20}$/", $this->container['sUserstagedFirstname'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sUserstagedFirstname'])?'null':'"'.$this->container['sUserstagedFirstname'].'"')." for 'sUserstagedFirstname', must be conform to the pattern /^.{0,20}$/.";
        }
        ...
        if (!is_null($this->container['sUserstagedLastname']) && !preg_match("/(*UTF8)^.{0,25}$/", $this->container['sUserstagedLastname'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sUserstagedLastname'])?'null':'"'.$this->container['sUserstagedLastname'].'"')." for 'sUserstagedLastname', must be conform to the pattern /^.{0,25}$/.";
        }
        ...
        if (!is_null($this->container['sUserstagedExternalid']) && !preg_match("/(*UTF8)^.{1,60}$/", $this->container['sUserstagedExternalid'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sUserstagedExternalid'])?'null':'"'.$this->container['sUserstagedExternalid'].'"')." for 'sUserstagedExternalid', must be conform to the pattern /^.{1,60}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiUserstagedID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $pkiUserstagedID when calling UserstagedListElement., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUserstagedID)?'null':'"'.$pkiUserstagedID.'"').' for pkiUserstagedID when calling UserstagedListElement., must be smaller than or equal to 65535.');
        }
        //if (($pkiUserstagedID < 1)) {
        if (($pkiUserstagedID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $pkiUserstagedID when calling UserstagedListElement., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUserstagedID)?'null':'"'.$pkiUserstagedID.'"').' for pkiUserstagedID when calling UserstagedListElement., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEmailAddress) && (!preg_match("/(*UTF8)^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddress)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEmailAddress when calling UserstagedListElement., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEmailAddress)?'null':'"'.$sEmailAddress.'"')." for sEmailAddress when calling UserstagedListElement., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUserstagedFirstname) && (!preg_match("/(*UTF8)^.{0,20}$/", ObjectSerializer::toString($sUserstagedFirstname)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUserstagedFirstname when calling UserstagedListElement., must conform to the pattern /^.{0,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUserstagedFirstname)?'null':'"'.$sUserstagedFirstname.'"')." for sUserstagedFirstname when calling UserstagedListElement., must conform to the pattern /^.{0,20}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUserstagedLastname) && (!preg_match("/(*UTF8)^.{0,25}$/", ObjectSerializer::toString($sUserstagedLastname)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUserstagedLastname when calling UserstagedListElement., must conform to the pattern /^.{0,25}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUserstagedLastname)?'null':'"'.$sUserstagedLastname.'"')." for sUserstagedLastname when calling UserstagedListElement., must conform to the pattern /^.{0,25}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUserstagedExternalid) && (!preg_match("/(*UTF8)^.{1,60}$/", ObjectSerializer::toString($sUserstagedExternalid)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUserstagedExternalid when calling UserstagedListElement., must conform to the pattern /^.{1,60}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUserstagedExternalid)?'null':'"'.$sUserstagedExternalid.'"')." for sUserstagedExternalid when calling UserstagedListElement., must conform to the pattern /^.{1,60}$/.");
        }
