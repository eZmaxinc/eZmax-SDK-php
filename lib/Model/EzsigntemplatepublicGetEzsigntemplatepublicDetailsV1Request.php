...
/**
 * EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1Request Class Doc Comment
 *
 * @category Class
 * @description Request for POST /1/object/ezsigntemplatepublic/getEzsigntemplatepublicDetails
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplatepublic-getEzsigntemplatepublicDetails-v1-Request';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if ((mb_strlen($pksEzmaxcustomerCode) > 6)) {
            //throw new \InvalidArgumentException('invalid length for $pksEzmaxcustomerCode when calling EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1Request., must be smaller than or equal to 6.');
            throw new \InvalidArgumentException('value '.(is_null($pksEzmaxcustomerCode)?'null':'"'.$pksEzmaxcustomerCode.'"').', invalid length for pksEzmaxcustomerCode when calling EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1Request., must be smaller than or equal to 6.');
        }
        //if ((mb_strlen($pksEzmaxcustomerCode) < 2)) {
        if ((mb_strlen($pksEzmaxcustomerCode) < 2)) {
            //throw new \InvalidArgumentException('invalid length for $pksEzmaxcustomerCode when calling EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1Request., must be bigger than or equal to 2.');
            throw new \InvalidArgumentException('value '.(is_null($pksEzmaxcustomerCode)?'null':'"'.$pksEzmaxcustomerCode.'"').', invalid length for pksEzmaxcustomerCode when calling EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1Request., must be bigger than or equal to 2.');
        }
        ...
        if (!is_null($pksEzmaxcustomerCode) && (!preg_match("/(*UTF8)^[a-z\\d]{2,6}$/", ObjectSerializer::toString($pksEzmaxcustomerCode)))) {
            //throw new \InvalidArgumentException("invalid value for \$pksEzmaxcustomerCode when calling EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1Request., must conform to the pattern /^[a-z\\d]{2,6}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($pksEzmaxcustomerCode)?'null':'"'.$pksEzmaxcustomerCode.'"')." for pksEzmaxcustomerCode when calling EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1Request., must conform to the pattern /^[a-z\\d]{2,6}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatepublicReferenceid) && (!preg_match("/(*UTF8)^.{0,36}$/", ObjectSerializer::toString($sEzsigntemplatepublicReferenceid)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatepublicReferenceid when calling EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1Request., must conform to the pattern /^.{0,36}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatepublicReferenceid)?'null':'"'.$sEzsigntemplatepublicReferenceid.'"')." for sEzsigntemplatepublicReferenceid when calling EzsigntemplatepublicGetEzsigntemplatepublicDetailsV1Request., must conform to the pattern /^.{0,36}$/.");
        }
