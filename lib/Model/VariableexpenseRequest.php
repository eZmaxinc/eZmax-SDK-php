    ...
    */
	...
	//if (($pkiVariableexpenseID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiVariableexpenseID when calling VariableexpenseRequest., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiVariableexpenseID)?'null':'"'.$pkiVariableexpenseID.'"').' for pkiVariableexpenseID when calling VariableexpenseRequest., must be smaller than or equal to 255.');
        }
	//if (($pkiVariableexpenseID < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiVariableexpenseID when calling VariableexpenseRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiVariableexpenseID)?'null':'"'.$pkiVariableexpenseID.'"').' for pkiVariableexpenseID when calling VariableexpenseRequest., must be bigger than or equal to 1.');
        }
	...
	//if ((!preg_match("/^.{0,5}$/", ObjectSerializer::toString($sVariableexpenseCode)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sVariableexpenseCode when calling VariableexpenseRequest., must conform to the pattern /^.{0,5}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sVariableexpenseCode)?'null':'"'.$sVariableexpenseCode.'"')." for sVariableexpenseCode when calling VariableexpenseRequest., must conform to the pattern /^.{0,5}$/.");
        }
