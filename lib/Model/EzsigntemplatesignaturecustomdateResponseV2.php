...
/**
 * EzsigntemplatesignaturecustomdateResponseV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplatesignaturecustomdateResponseV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigntemplatesignaturecustomdate-ResponseV2';
    ...
    */
	...
	//if (($pkiEzsigntemplatesignaturecustomdateID < 0)) {
        if (($pkiEzsigntemplatesignaturecustomdateID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatesignaturecustomdateID when calling EzsigntemplatesignaturecustomdateResponseV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatesignaturecustomdateID)?'null':'"'.$pkiEzsigntemplatesignaturecustomdateID.'"').' for pkiEzsigntemplatesignaturecustomdateID when calling EzsigntemplatesignaturecustomdateResponseV2., must be bigger than or equal to 0.');
        }
