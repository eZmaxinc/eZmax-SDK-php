...
/**
 * EzsigntemplateformfieldgroupsignerRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplateformfieldgroupsignerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigntemplateformfieldgroupsigner-Request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['pkiEzsigntemplateformfieldgroupsignerID']) && ($this->container['pkiEzsigntemplateformfieldgroupsignerID'] < 0)) {
     ...
     *
     * @param int|null $pkiEzsigntemplateformfieldgroupsignerID The unique ID of the Ezsigntemplateformfieldgroupsigner
     *
     * @return self
     */
	...
	//if (($pkiEzsigntemplateformfieldgroupsignerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplateformfieldgroupsignerID when calling EzsigntemplateformfieldgroupsignerRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateformfieldgroupsignerID)?'null':'"'.$pkiEzsigntemplateformfieldgroupsignerID.'"').' for pkiEzsigntemplateformfieldgroupsignerID when calling EzsigntemplateformfieldgroupsignerRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatesignerID < 0)) {
        if (($fkiEzsigntemplatesignerID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatesignerID when calling EzsigntemplateformfieldgroupsignerRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatesignerID)?'null':'"'.$fkiEzsigntemplatesignerID.'"').' for fkiEzsigntemplatesignerID when calling EzsigntemplateformfieldgroupsignerRequest., must be bigger than or equal to 0.');
        }
