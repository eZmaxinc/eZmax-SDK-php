...
/**
 * EzsigntemplateformfieldgroupCreateObjectV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplateformfieldgroupCreateObjectV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigntemplateformfieldgroup-createObject-v1-Response-mPayload';
    ...
    protected static $openAPIFormats = [
        'aPkiEzsigntemplateformfieldgroupID' => null
    ];
    ...
    protected static array $openAPINullables = [
        'aPkiEzsigntemplateformfieldgroupID' => false
    ];
    ...
    protected static $attributeMap = [
        'aPkiEzsigntemplateformfieldgroupID' => 'a_pkiEzsigntemplateformfieldgroupID'
    ];
    ...
    protected static $setters = [
        'aPkiEzsigntemplateformfieldgroupID' => 'setAPkiEzsigntemplateformfieldgroupID'
    ];
    ...
    protected static $getters = [
        'aPkiEzsigntemplateformfieldgroupID' => 'getAPkiEzsigntemplateformfieldgroupID'
    ];
    ...
    {
        $this->setIfExists('aPkiEzsigntemplateformfieldgroupID', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets aPkiEzsigntemplateformfieldgroupID
     *
     * @return int[]
     */
    public function getAPkiEzsigntemplateformfieldgroupID()
    {
	//return $this->container['aPkiEzsigntemplateformfieldgroupID'];
        return $this->container['aPkiEzsigntemplateformfieldgroupID'];
    }

    /**
     * Sets aPkiEzsigntemplateformfieldgroupID
     *
     * @param int[] $aPkiEzsigntemplateformfieldgroupID An array of unique IDs representing the object that were requested to be created.  They are returned in the same order as the array containing the objects to be created that was sent in the request.
     *
     * @return self
     */
