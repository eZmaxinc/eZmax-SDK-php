...
class EzmaxinvoicingsummaryinternaldetailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzmaxinvoicingsummaryinternaldetailID) && ($pkiEzmaxinvoicingsummaryinternaldetailID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzmaxinvoicingsummaryinternaldetailID)?'null':'"'.$pkiEzmaxinvoicingsummaryinternaldetailID.'"').' for pkiEzmaxinvoicingsummaryinternaldetailID when calling EzmaxinvoicingsummaryinternaldetailResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzmaxinvoicingsummaryinternalID) && ($fkiEzmaxinvoicingsummaryinternalID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxinvoicingsummaryinternalID)?'null':'"'.$fkiEzmaxinvoicingsummaryinternalID.'"').' for fkiEzmaxinvoicingsummaryinternalID when calling EzmaxinvoicingsummaryinternaldetailResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzmaxproductID < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxproductID)?'null':'"'.$fkiEzmaxproductID.'"').' for fkiEzmaxproductID when calling EzmaxinvoicingsummaryinternaldetailResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiBillingentityexternalID < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBillingentityexternalID)?'null':'"'.$fkiBillingentityexternalID.'"').' for fkiBillingentityexternalID when calling EzmaxinvoicingsummaryinternaldetailResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryinternaldetailCountreal) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryinternaldetailCountreal)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryinternaldetailCountreal)?'null':'"'.$dEzmaxinvoicingsummaryinternaldetailCountreal.'"')." for dEzmaxinvoicingsummaryinternaldetailCountreal when calling EzmaxinvoicingsummaryinternaldetailResponse., must conform to the pattern /^-{0,1}[\\d]{1,6}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryinternaldetailSubtotal) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryinternaldetailSubtotal)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryinternaldetailSubtotal)?'null':'"'.$dEzmaxinvoicingsummaryinternaldetailSubtotal.'"')." for dEzmaxinvoicingsummaryinternaldetailSubtotal when calling EzmaxinvoicingsummaryinternaldetailResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryinternaldetailRebate) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryinternaldetailRebate)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryinternaldetailRebate)?'null':'"'.$dEzmaxinvoicingsummaryinternaldetailRebate.'"')." for dEzmaxinvoicingsummaryinternaldetailRebate when calling EzmaxinvoicingsummaryinternaldetailResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzmaxinvoicingsummaryinternaldetailTotal) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzmaxinvoicingsummaryinternaldetailTotal)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzmaxinvoicingsummaryinternaldetailTotal)?'null':'"'.$dEzmaxinvoicingsummaryinternaldetailTotal.'"')." for dEzmaxinvoicingsummaryinternaldetailTotal when calling EzmaxinvoicingsummaryinternaldetailResponse., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
