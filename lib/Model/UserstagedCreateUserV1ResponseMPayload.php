...
/**
 * UserstagedCreateUserV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 ...
 */
class UserstagedCreateUserV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userstaged-createUser-v1-Response-mPayload';
    ...
    */
	...
	//if (($pkiUserID < 0)) {
        if (($pkiUserID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiUserID when calling UserstagedCreateUserV1ResponseMPayload., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUserID)?'null':'"'.$pkiUserID.'"').' for pkiUserID when calling UserstagedCreateUserV1ResponseMPayload., must be bigger than or equal to 0.');
        }
