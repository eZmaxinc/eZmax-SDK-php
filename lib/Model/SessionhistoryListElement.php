...
class SessionhistoryListElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['dtSessionhistoryFirsthit']) && !preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", $this->container['dtSessionhistoryFirsthit'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtSessionhistoryFirsthit'])?'null':'"'.$this->container['dtSessionhistoryFirsthit'].'"')." for 'dtSessionhistoryFirsthit', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
        }
        ...
        if (!is_null($this->container['dtSessionhistoryLasthit']) && !preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", $this->container['dtSessionhistoryLasthit'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtSessionhistoryLasthit'])?'null':'"'.$this->container['dtSessionhistoryLasthit'].'"')." for 'dtSessionhistoryLasthit', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
        }
        ...
        if (!is_null($this->container['sComputerDescription']) && !preg_match("/(*UTF8)^.{0,50}$/", $this->container['sComputerDescription'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sComputerDescription'])?'null':'"'.$this->container['sComputerDescription'].'"')." for 'sComputerDescription', must be conform to the pattern /^.{0,50}$/.";
        }
        ...
        if (!is_null($this->container['sSessionhistoryDuration']) && !preg_match("/(*UTF8)^(0[0-9]{1}|\\d{2,}):([0-5][0-9]):([0-5][0-9])$/", $this->container['sSessionhistoryDuration'])) {
            //$invalidProperties[] = "invalid value for 'sSessionhistoryDuration', must be conform to the pattern /^(0[0-9]{1}|\\d{2,}):([0-5][0-9]):([0-5][0-9])$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sSessionhistoryDuration'])?'null':'"'.$this->container['sSessionhistoryDuration'].'"')." for 'sSessionhistoryDuration', must be conform to the pattern /^(0[0-9]{1}|\\d{2,}):([0-5][0-9]):([0-5][0-9])$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiSessionhistoryID > 2147483647)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSessionhistoryID)?'null':'"'.$pkiSessionhistoryID.'"').' for pkiSessionhistoryID when calling SessionhistoryListElement., must be smaller than or equal to 2147483647.');
        }
        ...
        if (($pkiSessionhistoryID < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSessionhistoryID)?'null':'"'.$pkiSessionhistoryID.'"').' for pkiSessionhistoryID when calling SessionhistoryListElement., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiComputerID) && ($fkiComputerID > 65535)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiComputerID)?'null':'"'.$fkiComputerID.'"').' for fkiComputerID when calling SessionhistoryListElement., must be smaller than or equal to 65535.');
        }
        //if (($fkiComputerID < 1)) {
        if (!is_null($fkiComputerID) && ($fkiComputerID < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiComputerID)?'null':'"'.$fkiComputerID.'"').' for fkiComputerID when calling SessionhistoryListElement., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUserID) && ($fkiUserID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling SessionhistoryListElement., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtSessionhistoryFirsthit) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtSessionhistoryFirsthit)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dtSessionhistoryFirsthit)?'null':'"'.$dtSessionhistoryFirsthit.'"')." for dtSessionhistoryFirsthit when calling SessionhistoryListElement., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtSessionhistoryLasthit) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtSessionhistoryLasthit)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($dtSessionhistoryLasthit)?'null':'"'.$dtSessionhistoryLasthit.'"')." for dtSessionhistoryLasthit when calling SessionhistoryListElement., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sComputerDescription) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sComputerDescription)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sComputerDescription)?'null':'"'.$sComputerDescription.'"')." for sComputerDescription when calling SessionhistoryListElement., must conform to the pattern /^.{0,50}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sSessionhistoryDuration) && (!preg_match("/(*UTF8)^(0[0-9]{1}|\\d{2,}):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($sSessionhistoryDuration)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sSessionhistoryDuration)?'null':'"'.$sSessionhistoryDuration.'"')." for sSessionhistoryDuration when calling SessionhistoryListElement., must conform to the pattern /^(0[0-9]{1}|\\d{2,}):([0-5][0-9]):([0-5][0-9])$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sUserLoginname) && (!preg_match("/(*UTF8)^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/", ObjectSerializer::toString($sUserLoginname)))) {
            //throw new \InvalidArgumentException("invalid value for \$sUserLoginname when calling SessionhistoryListElement., must conform to the pattern /^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUserLoginname)?'null':'"'.$sUserLoginname.'"')." for sUserLoginname when calling SessionhistoryListElement., must conform to the pattern /^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/.");
        }
