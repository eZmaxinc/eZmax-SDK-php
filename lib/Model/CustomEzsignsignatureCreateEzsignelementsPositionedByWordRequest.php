...
/**
 * CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Custom-EzsignsignatureCreateEzsignelementsPositionedByWord-Request';
    ...
    protected static $openAPITypes = [
        ...
        'aObjEzsignelementdependency' => '\eZmaxAPI\Model\EzsignelementdependencyRequestCompound[]',
        'aObjEzsignsignaturepaymentdetail' => '\eZmaxAPI\Model\EzsignsignaturepaymentdetailRequestCompound[]',
        'objCreateezsignelementspositionedbyword' => '\eZmaxAPI\Model\CustomCreateEzsignelementsPositionedByWordRequest'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'objCreateezsignelementspositionedbyword' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'objCreateezsignelementspositionedbyword' => false
    ];
    ...
    protected static $setters = [
        ...
        'objCreateezsignelementspositionedbyword' => 'setObjCreateezsignelementspositionedbyword'
    ];
    ...
    protected static $getters = [
        ...
        'objCreateezsignelementspositionedbyword' => 'getObjCreateezsignelementspositionedbyword'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('objCreateezsignelementspositionedbyword', $data ?? [], null);
    }
    ...
    */
	...
	//if (!is_null($this->container['dEzsignsignatureCreditcardamount']) && !preg_match("/^[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzsignsignatureCreditcardamount'])) {
        ...
        if ($this->container['objCreateezsignelementspositionedbyword'] === null) {
            $invalidProperties[] = "'objCreateezsignelementspositionedbyword' can't be null";
        }
	...
	//if (($pkiEzsignsignatureID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignatureID when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignatureID)?'null':'"'.$pkiEzsignsignatureID.'"').' for pkiEzsignsignatureID when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignfoldersignerassociationID < 0)) {
        if (($fkiEzsignfoldersignerassociationID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldersignerassociationID when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationID)?'null':'"'.$fkiEzsignfoldersignerassociationID.'"').' for fkiEzsignfoldersignerassociationID when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiPaymentgatewayID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiPaymentgatewayID when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPaymentgatewayID)?'null':'"'.$fkiPaymentgatewayID.'"').' for fkiPaymentgatewayID when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be smaller than or equal to 255.');
        }
	//if (($fkiPaymentgatewayID < 0)) {
        if (!is_null($fkiPaymentgatewayID) && ($fkiPaymentgatewayID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiPaymentgatewayID when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPaymentgatewayID)?'null':'"'.$fkiPaymentgatewayID.'"').' for fkiPaymentgatewayID when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignpagePagenumber < 1)) {
        if (($iEzsignpagePagenumber < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignpagePagenumber when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignpagePagenumber)?'null':'"'.$iEzsignpagePagenumber.'"').' for iEzsignpagePagenumber when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 1.');
        }
	...
	//if (($iEzsignsignatureX < 0)) {
        if (($iEzsignsignatureX < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureX when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureX)?'null':'"'.$iEzsignsignatureX.'"').' for iEzsignsignatureX when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignsignatureY < 0)) {
        if (($iEzsignsignatureY < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureY when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureY)?'null':'"'.$iEzsignsignatureY.'"').' for iEzsignsignatureY when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignsignatureWidth < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureWidth when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureWidth)?'null':'"'.$iEzsignsignatureWidth.'"').' for iEzsignsignatureWidth when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignsignatureHeight < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureHeight when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureHeight)?'null':'"'.$iEzsignsignatureHeight.'"').' for iEzsignsignatureHeight when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigndocumentID < 0)) {
        if (($fkiEzsigndocumentID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigndocumentID when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigndocumentID)?'null':'"'.$fkiEzsigndocumentID.'"').' for fkiEzsigndocumentID when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignfoldersignerassociationIDValidation < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldersignerassociationIDValidation when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationIDValidation)?'null':'"'.$fkiEzsignfoldersignerassociationIDValidation.'"').' for fkiEzsignfoldersignerassociationIDValidation when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignsignatureMaxlength > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureMaxlength when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureMaxlength)?'null':'"'.$iEzsignsignatureMaxlength.'"').' for iEzsignsignatureMaxlength when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be smaller than or equal to 65535.');
        }
	//if (($iEzsignsignatureMaxlength < 0)) {
        if (!is_null($iEzsignsignatureMaxlength) && ($iEzsignsignatureMaxlength < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignsignatureMaxlength when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignatureMaxlength)?'null':'"'.$iEzsignsignatureMaxlength.'"').' for iEzsignsignatureMaxlength when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if ((mb_strlen($sEzsignsignatureTextvalidationcustommessage) > 50)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzsignsignatureTextvalidationcustommessage when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignsignatureTextvalidationcustommessage)?'null':'"'.$sEzsignsignatureTextvalidationcustommessage.'"').', invalid length for sEzsignsignatureTextvalidationcustommessage when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be smaller than or equal to 50.');
        }
	//if ((mb_strlen($sEzsignsignatureTextvalidationcustommessage) < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzsignsignatureTextvalidationcustommessage when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignsignatureTextvalidationcustommessage)?'null':'"'.$sEzsignsignatureTextvalidationcustommessage.'"').', invalid length for sEzsignsignatureTextvalidationcustommessage when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^\\^.*\\$$|^$/", ObjectSerializer::toString($sEzsignsignatureRegexp)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsignsignatureRegexp when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must conform to the pattern /^\\^.*\\$$|^$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignsignatureRegexp)?'null':'"'.$sEzsignsignatureRegexp.'"')." for sEzsignsignatureRegexp when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must conform to the pattern /^\\^.*\\$$|^$/.");
        }
	...
	//if ((!preg_match("/^.{1,50}$/", ObjectSerializer::toString($sEzsignsignatureCreditcardamountdescription)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsignsignatureCreditcardamountdescription when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must conform to the pattern /^.{1,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignsignatureCreditcardamountdescription)?'null':'"'.$sEzsignsignatureCreditcardamountdescription.'"')." for sEzsignsignatureCreditcardamountdescription when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must conform to the pattern /^.{1,50}$/.");
        }
	...
	//if ((!preg_match("/^[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzsignsignatureCreditcardamount)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dEzsignsignatureCreditcardamount when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must conform to the pattern /^[\\d]{1,9}?\\.[\\d]{2}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzsignsignatureCreditcardamount)?'null':'"'.$dEzsignsignatureCreditcardamount.'"')." for dEzsignsignatureCreditcardamount when calling CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest., must conform to the pattern /^[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
     ...
     *
     * @return \eZmaxAPI\Model\EzsignelementdependencyRequestCompound[]|null
     */
     ...
     *
     * @param \eZmaxAPI\Model\EzsignelementdependencyRequestCompound[]|null $aObjEzsignelementdependency aObjEzsignelementdependency
     *
     * @return self
     */
     ...
     *
     * @return \eZmaxAPI\Model\EzsignsignaturepaymentdetailRequestCompound[]|null
     */
     ...
     *
     * @param \eZmaxAPI\Model\EzsignsignaturepaymentdetailRequestCompound[]|null $aObjEzsignsignaturepaymentdetail aObjEzsignsignaturepaymentdetail
     *
     * @return self
     */
    ...
    /**
     * Gets objCreateezsignelementspositionedbyword
     *
     * @return \eZmaxAPI\Model\CustomCreateEzsignelementsPositionedByWordRequest
     */
    public function getObjCreateezsignelementspositionedbyword()
    {
	//return $this->container['objCreateezsignelementspositionedbyword'];
        return $this->container['objCreateezsignelementspositionedbyword'];
    }

    /**
     * Sets objCreateezsignelementspositionedbyword
     *
     * @param \eZmaxAPI\Model\CustomCreateEzsignelementsPositionedByWordRequest $objCreateezsignelementspositionedbyword objCreateezsignelementspositionedbyword
     *
     * @return self
     */
    public function setObjCreateezsignelementspositionedbyword($objCreateezsignelementspositionedbyword)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($objCreateezsignelementspositionedbyword)) {
            //throw new \InvalidArgumentException('non-nullable objCreateezsignelementspositionedbyword cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
	//$this->container['objCreateezsignelementspositionedbyword'] = $objCreateezsignelementspositionedbyword;
        $this->container['objCreateezsignelementspositionedbyword'] = $objCreateezsignelementspositionedbyword;
