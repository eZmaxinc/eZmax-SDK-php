...
/**
 * EzsigndocumentResponseCompoundV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigndocumentResponseCompoundV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigndocument-ResponseCompoundV3';
    ...
    protected static $openAPITypes = [
        ...
        'iEzsigndocumentSteptotal' => 'int',
        'iEzsigndocumentStepcurrent' => 'int',
        'aObjEzsignfoldersignerassociationstatus' => '\eZmaxAPI\Model\CustomEzsignfoldersignerassociationstatusResponseV3[]',
    ...
    protected static $openAPIFormats = [
        ...
        'iEzsigndocumentSteptotal' => null,
        'iEzsigndocumentStepcurrent' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'bEzsigndocumentSendtoged' => false,
        'objAudit' => false,
        ...
        'iEzsigndocumentSteptotal' => false,
        'iEzsigndocumentStepcurrent' => false,
    ...
    protected static $attributeMap = [
        ...
        'bEzsigndocumentSendtoged' => 'bEzsigndocumentSendtoged',
        'objAudit' => 'objAudit',
    ...
    protected static $setters = [
        ...
        'bEzsigndocumentSendtoged' => 'setBEzsigndocumentSendtoged',
        ...
        'iEzsigndocumentSteptotal' => 'setIEzsigndocumentSteptotal',
        'iEzsigndocumentStepcurrent' => 'setIEzsigndocumentStepcurrent',
    ...
    protected static $getters = [
        ...
        'bEzsigndocumentSendtoged' => 'getBEzsigndocumentSendtoged',
        ...
        'iEzsigndocumentSteptotal' => 'getIEzsigndocumentSteptotal',
        'iEzsigndocumentStepcurrent' => 'getIEzsigndocumentStepcurrent',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bEzsigndocumentSendtoged', $data ?? [], null);
        ...
        $this->setIfExists('iEzsigndocumentSteptotal', $data ?? [], null);
        $this->setIfExists('iEzsigndocumentStepcurrent', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        //if (!is_null($this->container['sEzsigndocumentMD5initial']) && !preg_match("/^.{32}$/", $this->container['sEzsigndocumentMD5initial'])) {
        if (!is_null($this->container['sEzsigndocumentMD5initial']) && !preg_match("/(*UTF8)^.{32}$/", $this->container['sEzsigndocumentMD5initial'])) {
            //$invalidProperties[] = "invalid value for 'sEzsigndocumentMD5initial', must be conform to the pattern /^.{32}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsigndocumentMD5initial'])?'null':'"'.$this->container['sEzsigndocumentMD5initial'].'"')." for 'sEzsigndocumentMD5initial', must be conform to the pattern /^.{32}$/.";
        }

        //if (!is_null($this->container['sEzsigndocumentMD5signed']) && !preg_match("/^.{32}$/", $this->container['sEzsigndocumentMD5signed'])) {
        if (!is_null($this->container['sEzsigndocumentMD5signed']) && !preg_match("/(*UTF8)^.{32}$/", $this->container['sEzsigndocumentMD5signed'])) {
            //$invalidProperties[] = "invalid value for 'sEzsigndocumentMD5signed', must be conform to the pattern /^.{32}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsigndocumentMD5signed'])?'null':'"'.$this->container['sEzsigndocumentMD5signed'].'"')." for 'sEzsigndocumentMD5signed', must be conform to the pattern /^.{32}$/.";
        }
        ...
        if (!is_null($this->container['sEzsigndocumentExternalid']) && !preg_match("/(*UTF8)^.{0,128}$/", $this->container['sEzsigndocumentExternalid'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsigndocumentExternalid'])?'null':'"'.$this->container['sEzsigndocumentExternalid'].'"')." for 'sEzsigndocumentExternalid', must be conform to the pattern /^.{0,128}$/.";
        }
        ...
        if ($this->container['iEzsigndocumentSteptotal'] === null) {
            $invalidProperties[] = "'iEzsigndocumentSteptotal' can't be null";
        }
        if ($this->container['iEzsigndocumentStepcurrent'] === null) {
            $invalidProperties[] = "'iEzsigndocumentStepcurrent' can't be null";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigndocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigndocumentID when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndocumentID)?'null':'"'.$pkiEzsigndocumentID.'"').' for pkiEzsigndocumentID when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsignfolderID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfolderID when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfolderID)?'null':'"'.$fkiEzsignfolderID.'"').' for fkiEzsignfolderID when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignfoldersignerassociationIDDeclinedtosign) && ($fkiEzsignfoldersignerassociationIDDeclinedtosign < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldersignerassociationIDDeclinedtosign when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationIDDeclinedtosign)?'null':'"'.$fkiEzsignfoldersignerassociationIDDeclinedtosign.'"').' for fkiEzsignfoldersignerassociationIDDeclinedtosign when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiLanguageID) && ($fkiLanguageID > 2)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsigndocumentResponseCompoundV3., must be smaller than or equal to 2.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsigndocumentResponseCompoundV3., must be smaller than or equal to 2.');
        }
        //if (($fkiLanguageID < 1)) {
        if (!is_null($fkiLanguageID) && ($fkiLanguageID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigndocumentOrder < 1)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigndocumentOrder when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentOrder)?'null':'"'.$iEzsigndocumentOrder.'"').' for iEzsigndocumentOrder when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigndocumentPagetotal < 1)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigndocumentPagetotal when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentPagetotal)?'null':'"'.$iEzsigndocumentPagetotal.'"').' for iEzsigndocumentPagetotal when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigndocumentSignaturesigned < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigndocumentSignaturesigned when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentSignaturesigned)?'null':'"'.$iEzsigndocumentSignaturesigned.'"').' for iEzsigndocumentSignaturesigned when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigndocumentSignaturetotal < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigndocumentSignaturetotal when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentSignaturetotal)?'null':'"'.$iEzsigndocumentSignaturetotal.'"').' for iEzsigndocumentSignaturetotal when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigndocumentFormfieldtotal < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigndocumentFormfieldtotal when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentFormfieldtotal)?'null':'"'.$iEzsigndocumentFormfieldtotal.'"').' for iEzsigndocumentFormfieldtotal when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if ((!preg_match("/^.{32}$/", ObjectSerializer::toString($sEzsigndocumentMD5initial)))) {
        if (!is_null($sEzsigndocumentMD5initial) && (!preg_match("/(*UTF8)^.{32}$/", ObjectSerializer::toString($sEzsigndocumentMD5initial)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigndocumentMD5initial when calling EzsigndocumentResponseCompoundV3., must conform to the pattern /^.{32}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigndocumentMD5initial)?'null':'"'.$sEzsigndocumentMD5initial.'"')." for sEzsigndocumentMD5initial when calling EzsigndocumentResponseCompoundV3., must conform to the pattern /^.{32}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if ((!preg_match("/^.{32}$/", ObjectSerializer::toString($sEzsigndocumentMD5signed)))) {
        if (!is_null($sEzsigndocumentMD5signed) && (!preg_match("/(*UTF8)^.{32}$/", ObjectSerializer::toString($sEzsigndocumentMD5signed)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigndocumentMD5signed when calling EzsigndocumentResponseCompoundV3., must conform to the pattern /^.{32}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigndocumentMD5signed)?'null':'"'.$sEzsigndocumentMD5signed.'"')." for sEzsigndocumentMD5signed when calling EzsigndocumentResponseCompoundV3., must conform to the pattern /^.{32}$/.");
        }
    ...
    /**
     * Gets bEzsigndocumentSendtoged
     *
     * @return bool|null
     */
    public function getBEzsigndocumentSendtoged()
    {
	//return $this->container['bEzsigndocumentSendtoged'];
        return $this->container['bEzsigndocumentSendtoged'];
    }

    /**
     * Sets bEzsigndocumentSendtoged
     *
     * @param bool|null $bEzsigndocumentSendtoged Whether the Ezsigndocument was copied to EDM
     *
     * @return self
     */
    public function setBEzsigndocumentSendtoged($bEzsigndocumentSendtoged)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($bEzsigndocumentSendtoged)) {
            //throw new \InvalidArgumentException('non-nullable bEzsigndocumentSendtoged cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['bEzsigndocumentSendtoged'] = $bEzsigndocumentSendtoged;
        $this->container['bEzsigndocumentSendtoged'] = (is_null($bEzsigndocumentSendtoged) ? null : (bool) $bEzsigndocumentSendtoged);
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigndocumentExternalid) && (!preg_match("/(*UTF8)^.{0,128}$/", ObjectSerializer::toString($sEzsigndocumentExternalid)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigndocumentExternalid when calling EzsigndocumentResponseCompoundV3., must conform to the pattern /^.{0,128}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigndocumentExternalid)?'null':'"'.$sEzsigndocumentExternalid.'"')." for sEzsigndocumentExternalid when calling EzsigndocumentResponseCompoundV3., must conform to the pattern /^.{0,128}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigndocumentEzsignsignatureattachmenttotal < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigndocumentEzsignsignatureattachmenttotal when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigndocumentEzsignsignatureattachmenttotal)?'null':'"'.$iEzsigndocumentEzsignsignatureattachmenttotal.'"').' for iEzsigndocumentEzsignsignatureattachmenttotal when calling EzsigndocumentResponseCompoundV3., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets iEzsigndocumentSteptotal
     *
     * @return int
     */
    public function getIEzsigndocumentSteptotal()
    {
	//return $this->container['iEzsigndocumentSteptotal'];
        return $this->container['iEzsigndocumentSteptotal'];
    }

    /**
     * Sets iEzsigndocumentSteptotal
     *
     * @param int $iEzsigndocumentSteptotal The total number of steps
     *
     * @return self
     */
    public function setIEzsigndocumentSteptotal($iEzsigndocumentSteptotal)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($iEzsigndocumentSteptotal)) {
            //throw new \InvalidArgumentException('non-nullable iEzsigndocumentSteptotal cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['iEzsigndocumentSteptotal'] = $iEzsigndocumentSteptotal;
        $this->container['iEzsigndocumentSteptotal'] = (is_null($iEzsigndocumentSteptotal) ? null : (int) $iEzsigndocumentSteptotal);

        return $this;
    }

    /**
     * Gets iEzsigndocumentStepcurrent
     *
     * @return int
     */
    public function getIEzsigndocumentStepcurrent()
    {
	//return $this->container['iEzsigndocumentStepcurrent'];
        return $this->container['iEzsigndocumentStepcurrent'];
    }

    /**
     * Sets iEzsigndocumentStepcurrent
     *
     * @param int $iEzsigndocumentStepcurrent The current step
     *
     * @return self
     */
    public function setIEzsigndocumentStepcurrent($iEzsigndocumentStepcurrent)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($iEzsigndocumentStepcurrent)) {
            //throw new \InvalidArgumentException('non-nullable iEzsigndocumentStepcurrent cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['iEzsigndocumentStepcurrent'] = $iEzsigndocumentStepcurrent;
        $this->container['iEzsigndocumentStepcurrent'] = (is_null($iEzsigndocumentStepcurrent) ? null : (int) $iEzsigndocumentStepcurrent);
     ...
     *
     * @return \eZmaxAPI\Model\CustomEzsignfoldersignerassociationstatusResponseV3[]
     */
     ...
     *
     * @param \eZmaxAPI\Model\CustomEzsignfoldersignerassociationstatusResponseV3[] $aObjEzsignfoldersignerassociationstatus aObjEzsignfoldersignerassociationstatus
     *
     * @return self
     */
