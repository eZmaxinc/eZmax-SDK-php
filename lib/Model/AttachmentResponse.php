...
class AttachmentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiInscriptionchecklistID) && ($fkiInscriptionchecklistID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiInscriptionchecklistID when calling AttachmentResponse., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiInscriptionchecklistID)?'null':'"'.$fkiInscriptionchecklistID.'"').' for fkiInscriptionchecklistID when calling AttachmentResponse., must be smaller than or equal to 16777215.');
        }
        //if (($fkiInscriptionchecklistID < 0)) {
        if (!is_null($fkiInscriptionchecklistID) && ($fkiInscriptionchecklistID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiInscriptionchecklistID when calling AttachmentResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiInscriptionchecklistID)?'null':'"'.$fkiInscriptionchecklistID.'"').' for fkiInscriptionchecklistID when calling AttachmentResponse., must be bigger than or equal to 0.');
        }
