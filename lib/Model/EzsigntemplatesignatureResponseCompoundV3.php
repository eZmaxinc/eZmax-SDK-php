...
/**
 * EzsigntemplatesignatureResponseCompoundV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplatesignatureResponseCompoundV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigntemplatesignature-ResponseCompoundV3';
    ...
    */
	...
	//if (($pkiEzsigntemplatesignatureID < 0)) {
        if (($pkiEzsigntemplatesignatureID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatesignatureID when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatesignatureID)?'null':'"'.$pkiEzsigntemplatesignatureID.'"').' for pkiEzsigntemplatesignatureID when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatedocumentID < 0)) {
        if (($fkiEzsigntemplatedocumentID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatedocumentID when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatedocumentID)?'null':'"'.$fkiEzsigntemplatedocumentID.'"').' for fkiEzsigntemplatedocumentID when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatesignerID < 0)) {
        if (($fkiEzsigntemplatesignerID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatesignerID when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatesignerID)?'null':'"'.$fkiEzsigntemplatesignerID.'"').' for fkiEzsigntemplatesignerID when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatesignerIDValidation < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatesignerIDValidation when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatesignerIDValidation)?'null':'"'.$fkiEzsigntemplatesignerIDValidation.'"').' for fkiEzsigntemplatesignerIDValidation when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiPaymentgatewayID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiPaymentgatewayID when calling EzsigntemplatesignatureResponseCompoundV3., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPaymentgatewayID)?'null':'"'.$fkiPaymentgatewayID.'"').' for fkiPaymentgatewayID when calling EzsigntemplatesignatureResponseCompoundV3., must be smaller than or equal to 255.');
        }
	//if (($fkiPaymentgatewayID < 0)) {
        if (!is_null($fkiPaymentgatewayID) && ($fkiPaymentgatewayID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiPaymentgatewayID when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPaymentgatewayID)?'null':'"'.$fkiPaymentgatewayID.'"').' for fkiPaymentgatewayID when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatedocumentpagePagenumber < 1)) {
        if (($iEzsigntemplatedocumentpagePagenumber < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagePagenumber when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagePagenumber)?'null':'"'.$iEzsigntemplatedocumentpagePagenumber.'"').' for iEzsigntemplatedocumentpagePagenumber when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 1.');
        }
	...
	//if (($iEzsigntemplatesignatureX < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignatureX when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignatureX)?'null':'"'.$iEzsigntemplatesignatureX.'"').' for iEzsigntemplatesignatureX when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatesignatureY < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignatureY when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignatureY)?'null':'"'.$iEzsigntemplatesignatureY.'"').' for iEzsigntemplatesignatureY when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatesignatureWidth < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignatureWidth when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignatureWidth)?'null':'"'.$iEzsigntemplatesignatureWidth.'"').' for iEzsigntemplatesignatureWidth when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatesignatureHeight < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignatureHeight when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignatureHeight)?'null':'"'.$iEzsigntemplatesignatureHeight.'"').' for iEzsigntemplatesignatureHeight when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatesignatureStep < 1)) {
        if (($iEzsigntemplatesignatureStep < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignatureStep when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignatureStep)?'null':'"'.$iEzsigntemplatesignatureStep.'"').' for iEzsigntemplatesignatureStep when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 1.');
        }
	...
	//if (($iEzsigntemplatesignatureMaxlength > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignatureMaxlength when calling EzsigntemplatesignatureResponseCompoundV3., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignatureMaxlength)?'null':'"'.$iEzsigntemplatesignatureMaxlength.'"').' for iEzsigntemplatesignatureMaxlength when calling EzsigntemplatesignatureResponseCompoundV3., must be smaller than or equal to 65535.');
        }
	//if (($iEzsigntemplatesignatureMaxlength < 0)) {
        if (!is_null($iEzsigntemplatesignatureMaxlength) && ($iEzsigntemplatesignatureMaxlength < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignatureMaxlength when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignatureMaxlength)?'null':'"'.$iEzsigntemplatesignatureMaxlength.'"').' for iEzsigntemplatesignatureMaxlength when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^\\^.*\\$$|^$/", ObjectSerializer::toString($sEzsigntemplatesignatureRegexp)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatesignatureRegexp when calling EzsigntemplatesignatureResponseCompoundV3., must conform to the pattern /^\\^.*\\$$|^$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatesignatureRegexp)?'null':'"'.$sEzsigntemplatesignatureRegexp.'"')." for sEzsigntemplatesignatureRegexp when calling EzsigntemplatesignatureResponseCompoundV3., must conform to the pattern /^\\^.*\\$$|^$/.");
        }
	...
	//if ((mb_strlen($sEzsigntemplatesignatureTextvalidationcustommessage) > 50)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzsigntemplatesignatureTextvalidationcustommessage when calling EzsigntemplatesignatureResponseCompoundV3., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsigntemplatesignatureTextvalidationcustommessage)?'null':'"'.$sEzsigntemplatesignatureTextvalidationcustommessage.'"').', invalid length for sEzsigntemplatesignatureTextvalidationcustommessage when calling EzsigntemplatesignatureResponseCompoundV3., must be smaller than or equal to 50.');
        }
	//if ((mb_strlen($sEzsigntemplatesignatureTextvalidationcustommessage) < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzsigntemplatesignatureTextvalidationcustommessage when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsigntemplatesignatureTextvalidationcustommessage)?'null':'"'.$sEzsigntemplatesignatureTextvalidationcustommessage.'"').', invalid length for sEzsigntemplatesignatureTextvalidationcustommessage when calling EzsigntemplatesignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{0,30}$/", ObjectSerializer::toString($sEzsigntemplatesignaturePositioningpattern)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatesignaturePositioningpattern when calling EzsigntemplatesignatureResponseCompoundV3., must conform to the pattern /^.{0,30}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatesignaturePositioningpattern)?'null':'"'.$sEzsigntemplatesignaturePositioningpattern.'"')." for sEzsigntemplatesignaturePositioningpattern when calling EzsigntemplatesignatureResponseCompoundV3., must conform to the pattern /^.{0,30}$/.");
        }
	...
	//if ((!preg_match("/^.{1,50}$/", ObjectSerializer::toString($sEzsigntemplatesignatureCreditcardamountdescription)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatesignatureCreditcardamountdescription when calling EzsigntemplatesignatureResponseCompoundV3., must conform to the pattern /^.{1,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatesignatureCreditcardamountdescription)?'null':'"'.$sEzsigntemplatesignatureCreditcardamountdescription.'"')." for sEzsigntemplatesignatureCreditcardamountdescription when calling EzsigntemplatesignatureResponseCompoundV3., must conform to the pattern /^.{1,50}$/.");
        }
	...
	//if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzsigntemplatesignatureCreditcardamount)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dEzsigntemplatesignatureCreditcardamount when calling EzsigntemplatesignatureResponseCompoundV3., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzsigntemplatesignatureCreditcardamount)?'null':'"'.$dEzsigntemplatesignatureCreditcardamount.'"')." for dEzsigntemplatesignatureCreditcardamount when calling EzsigntemplatesignatureResponseCompoundV3., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
