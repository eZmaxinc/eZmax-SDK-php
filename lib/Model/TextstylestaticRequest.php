...
/**
 * TextstylestaticRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class TextstylestaticRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'textstylestatic-Request';
    ...
    */
	...
	//if (($fkiFontID < 0)) {
        if (($fkiFontID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiFontID when calling TextstylestaticRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFontID)?'null':'"'.$fkiFontID.'"').' for fkiFontID when calling TextstylestaticRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iTextstylestaticFontcolor > 16777215)) {
        if (($iTextstylestaticFontcolor > 16777215)) {
	    //throw new \InvalidArgumentException('invalid value for $iTextstylestaticFontcolor when calling TextstylestaticRequest., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iTextstylestaticFontcolor)?'null':'"'.$iTextstylestaticFontcolor.'"').' for iTextstylestaticFontcolor when calling TextstylestaticRequest., must be smaller than or equal to 16777215.');
        }
	//if (($iTextstylestaticFontcolor < 0)) {
        if (($iTextstylestaticFontcolor < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iTextstylestaticFontcolor when calling TextstylestaticRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iTextstylestaticFontcolor)?'null':'"'.$iTextstylestaticFontcolor.'"').' for iTextstylestaticFontcolor when calling TextstylestaticRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iTextstylestaticSize > 255)) {
        if (($iTextstylestaticSize > 255)) {
	    //throw new \InvalidArgumentException('invalid value for $iTextstylestaticSize when calling TextstylestaticRequest., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iTextstylestaticSize)?'null':'"'.$iTextstylestaticSize.'"').' for iTextstylestaticSize when calling TextstylestaticRequest., must be smaller than or equal to 255.');
        }
	//if (($iTextstylestaticSize < 1)) {
        if (($iTextstylestaticSize < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $iTextstylestaticSize when calling TextstylestaticRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iTextstylestaticSize)?'null':'"'.$iTextstylestaticSize.'"').' for iTextstylestaticSize when calling TextstylestaticRequest., must be bigger than or equal to 1.');
        }
