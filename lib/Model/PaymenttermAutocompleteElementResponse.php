...
/**
 * PaymenttermAutocompleteElementResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymenttermAutocompleteElementResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'paymentterm-AutocompleteElement-Response';
    ...
    */
	...
	//if ((!preg_match("/^.{1,40}$/", ObjectSerializer::toString($sPaymenttermDescriptionX)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sPaymenttermDescriptionX when calling PaymenttermAutocompleteElementResponse., must conform to the pattern /^.{1,40}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sPaymenttermDescriptionX)?'null':'"'.$sPaymenttermDescriptionX.'"')." for sPaymenttermDescriptionX when calling PaymenttermAutocompleteElementResponse., must conform to the pattern /^.{1,40}$/.");
        }
