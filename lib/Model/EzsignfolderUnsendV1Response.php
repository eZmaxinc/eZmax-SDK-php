...
/**
 * EzsignfolderUnsendV1Response Class Doc Comment
 *
 * @category Class
 * @description Response for the /1/object/ezsignfolder/{pkiEzsignfolderID}/unsend API Request
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class EzsignfolderUnsendV1Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignfolder-unsend-v1-Response';
