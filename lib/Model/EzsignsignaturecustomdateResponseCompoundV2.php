...
/**
 * EzsignsignaturecustomdateResponseCompoundV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignsignaturecustomdateResponseCompoundV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignsignaturecustomdate-ResponseCompoundV2';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['iEzsignsignaturecustomdateOffsetx'] === null) {
            $invalidProperties[] = "'iEzsignsignaturecustomdateOffsetx' can't be null";
        }
        if ($this->container['iEzsignsignaturecustomdateOffsety'] === null) {
            $invalidProperties[] = "'iEzsignsignaturecustomdateOffsety' can't be null";
        }
	...
	//if (($pkiEzsignsignaturecustomdateID < 0)) {
        if (($pkiEzsignsignaturecustomdateID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignaturecustomdateID when calling EzsignsignaturecustomdateResponseCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignaturecustomdateID)?'null':'"'.$pkiEzsignsignaturecustomdateID.'"').' for pkiEzsignsignaturecustomdateID when calling EzsignsignaturecustomdateResponseCompoundV2., must be bigger than or equal to 0.');
        }
