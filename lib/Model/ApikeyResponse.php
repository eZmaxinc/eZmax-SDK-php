...
class ApikeyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiApikeyID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiApikeyID)?'null':'"'.$pkiApikeyID.'"').' for pkiApikeyID when calling ApikeyResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiUserID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling ApikeyResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzmaxpartnerproductstageID) && ($fkiEzmaxpartnerproductstageID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzmaxpartnerproductstageID when calling ApikeyResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxpartnerproductstageID)?'null':'"'.$fkiEzmaxpartnerproductstageID.'"').' for fkiEzmaxpartnerproductstageID when calling ApikeyResponse., must be smaller than or equal to 255.');
        }
        //if (($fkiEzmaxpartnerproductstageID < 0)) {
        if (!is_null($fkiEzmaxpartnerproductstageID) && ($fkiEzmaxpartnerproductstageID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzmaxpartnerproductstageID when calling ApikeyResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzmaxpartnerproductstageID)?'null':'"'.$fkiEzmaxpartnerproductstageID.'"').' for fkiEzmaxpartnerproductstageID when calling ApikeyResponse., must be bigger than or equal to 0.');
        }
