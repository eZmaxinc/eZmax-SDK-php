...
/**
 * EzdoctemplatedocumentResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class EzdoctemplatedocumentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezdoctemplatedocument-Response';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzdoctemplatedocumentID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzdoctemplatedocumentID when calling EzdoctemplatedocumentResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzdoctemplatedocumentID)?'null':'"'.$pkiEzdoctemplatedocumentID.'"').' for pkiEzdoctemplatedocumentID when calling EzdoctemplatedocumentResponse., must be smaller than or equal to 65535.');
        }
        //if (($pkiEzdoctemplatedocumentID < 0)) {
        if (($pkiEzdoctemplatedocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzdoctemplatedocumentID when calling EzdoctemplatedocumentResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzdoctemplatedocumentID)?'null':'"'.$pkiEzdoctemplatedocumentID.'"').' for pkiEzdoctemplatedocumentID when calling EzdoctemplatedocumentResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if (($fkiLanguageID > 2)) {
        if (($fkiLanguageID > 2)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzdoctemplatedocumentResponse., must be smaller than or equal to 2.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzdoctemplatedocumentResponse., must be smaller than or equal to 2.');
        }
        //if (($fkiLanguageID < 1)) {
        if (($fkiLanguageID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzdoctemplatedocumentResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzdoctemplatedocumentResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignfoldertypeID) && ($fkiEzsignfoldertypeID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzdoctemplatedocumentResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzdoctemplatedocumentResponse., must be smaller than or equal to 65535.');
        }
        //if (($fkiEzsignfoldertypeID < 0)) {
        if (!is_null($fkiEzsignfoldertypeID) && ($fkiEzsignfoldertypeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzdoctemplatedocumentResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzdoctemplatedocumentResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzdoctemplatetypeID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatetypeID when calling EzdoctemplatedocumentResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatetypeID)?'null':'"'.$fkiEzdoctemplatetypeID.'"').' for fkiEzdoctemplatetypeID when calling EzdoctemplatedocumentResponse., must be smaller than or equal to 255.');
        }
        //if (($fkiEzdoctemplatetypeID < 0)) {
        if (($fkiEzdoctemplatetypeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatetypeID when calling EzdoctemplatedocumentResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatetypeID)?'null':'"'.$fkiEzdoctemplatetypeID.'"').' for fkiEzdoctemplatetypeID when calling EzdoctemplatedocumentResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzdoctemplatefieldtypecategoryID) && ($fkiEzdoctemplatefieldtypecategoryID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatefieldtypecategoryID when calling EzdoctemplatedocumentResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatefieldtypecategoryID)?'null':'"'.$fkiEzdoctemplatefieldtypecategoryID.'"').' for fkiEzdoctemplatefieldtypecategoryID when calling EzdoctemplatedocumentResponse., must be smaller than or equal to 255.');
        }
        ...
        if (!is_null($fkiEzdoctemplatefieldtypecategoryID) && ($fkiEzdoctemplatefieldtypecategoryID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatefieldtypecategoryID when calling EzdoctemplatedocumentResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatefieldtypecategoryID)?'null':'"'.$fkiEzdoctemplatefieldtypecategoryID.'"').' for fkiEzdoctemplatefieldtypecategoryID when calling EzdoctemplatedocumentResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzdoctemplatedocumentNameX) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sEzdoctemplatedocumentNameX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzdoctemplatedocumentNameX when calling EzdoctemplatedocumentResponse., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzdoctemplatedocumentNameX)?'null':'"'.$sEzdoctemplatedocumentNameX.'"')." for sEzdoctemplatedocumentNameX when calling EzdoctemplatedocumentResponse., must conform to the pattern /^.{0,50}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzdoctemplatefieldtypecategoryDescriptionX) && (!preg_match("/(*UTF8)^.{0,55}$/", ObjectSerializer::toString($sEzdoctemplatefieldtypecategoryDescriptionX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzdoctemplatefieldtypecategoryDescriptionX when calling EzdoctemplatedocumentResponse., must conform to the pattern /^.{0,55}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzdoctemplatefieldtypecategoryDescriptionX)?'null':'"'.$sEzdoctemplatefieldtypecategoryDescriptionX.'"')." for sEzdoctemplatefieldtypecategoryDescriptionX when calling EzdoctemplatedocumentResponse., must conform to the pattern /^.{0,55}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzdoctemplatetypeDescriptionX) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sEzdoctemplatetypeDescriptionX)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzdoctemplatetypeDescriptionX when calling EzdoctemplatedocumentResponse., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzdoctemplatetypeDescriptionX)?'null':'"'.$sEzdoctemplatetypeDescriptionX.'"')." for sEzdoctemplatetypeDescriptionX when calling EzdoctemplatedocumentResponse., must conform to the pattern /^.{0,50}$/.");
        }
