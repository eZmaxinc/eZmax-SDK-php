...
class EzsignbulksendsignermappingRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzsignbulksendsignermappingID) && ($pkiEzsignbulksendsignermappingID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignbulksendsignermappingID)?'null':'"'.$pkiEzsignbulksendsignermappingID.'"').' for pkiEzsignbulksendsignermappingID when calling EzsignbulksendsignermappingRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsignbulksendID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignbulksendID)?'null':'"'.$fkiEzsignbulksendID.'"').' for fkiEzsignbulksendID when calling EzsignbulksendsignermappingRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiUserID) && ($fkiUserID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling EzsignbulksendsignermappingRequestCompound., must be bigger than or equal to 0.');
        }
