    ...
    */
	...
	//if (!preg_match("/^.{1,3}$/", $this->container['sProvinceShortname'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sProvinceShortname', must be conform to the pattern /^.{1,3}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sProvinceShortname'])?'null':'"'.$this->container['sProvinceShortname'].'"')." for 'sProvinceShortname', must be conform to the pattern /^.{1,3}$/.";
        }
