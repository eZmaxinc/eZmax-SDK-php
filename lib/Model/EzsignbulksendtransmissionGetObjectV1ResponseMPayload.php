 ...
 */
class EzsignbulksendtransmissionGetObjectV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignbulksendtransmission-getObject-v1-Response-mPayload';
    ...
    */
    ...
    public function setPkiEzsignbulksendtransmissionID($pkiEzsignbulksendtransmissionID)
    {
        ...
        if (($pkiEzsignbulksendtransmissionID < 0)) {
            throw new \InvalidArgumentException('invalid value for $pkiEzsignbulksendtransmissionID when calling EzsignbulksendtransmissionGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setFkiEzsignbulksendID($fkiEzsignbulksendID)
    {
        ...
        if (($fkiEzsignbulksendID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsignbulksendID when calling EzsignbulksendtransmissionGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
    ...
    public function setIEzsignbulksendtransmissionErrors($iEzsignbulksendtransmissionErrors)
    {
        ...
        if (($iEzsignbulksendtransmissionErrors < 0)) {
            throw new \InvalidArgumentException('invalid value for $iEzsignbulksendtransmissionErrors when calling EzsignbulksendtransmissionGetObjectV1ResponseMPayload., must be bigger than or equal to 0.');
        }
