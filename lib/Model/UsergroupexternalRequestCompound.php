...
/**
 * UsergroupexternalRequestCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class UsergroupexternalRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'usergroupexternal-RequestCompound';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['pkiUsergroupexternalID']) && ($this->container['pkiUsergroupexternalID'] > 255)) {
            $invalidProperties[] = "invalid value for 'pkiUsergroupexternalID', must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['pkiUsergroupexternalID']) && ($this->container['pkiUsergroupexternalID'] < 0)) {
	...
	//if (!preg_match("/^.{0,64}$/", $this->container['sUsergroupexternalID'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sUsergroupexternalID', must be conform to the pattern /^.{0,64}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sUsergroupexternalID'])?'null':'"'.$this->container['sUsergroupexternalID'].'"')." for 'sUsergroupexternalID', must be conform to the pattern /^.{0,64}$/.";
        }
     ...
     *
     * @param int|null $pkiUsergroupexternalID The unique ID of the Usergroupexternal
     *
     * @return self
     */
	...
	//if (($pkiUsergroupexternalID > 255)) {
        if (!is_null($pkiUsergroupexternalID) && ($pkiUsergroupexternalID > 255)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiUsergroupexternalID when calling UsergroupexternalRequestCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupexternalID)?'null':'"'.$pkiUsergroupexternalID.'"').' for pkiUsergroupexternalID when calling UsergroupexternalRequestCompound., must be smaller than or equal to 255.');
        }
	//if (($pkiUsergroupexternalID < 0)) {
        if (!is_null($pkiUsergroupexternalID) && ($pkiUsergroupexternalID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiUsergroupexternalID when calling UsergroupexternalRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUsergroupexternalID)?'null':'"'.$pkiUsergroupexternalID.'"').' for pkiUsergroupexternalID when calling UsergroupexternalRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{0,64}$/", ObjectSerializer::toString($sUsergroupexternalName)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sUsergroupexternalName when calling UsergroupexternalRequestCompound., must conform to the pattern /^.{0,64}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupexternalName)?'null':'"'.$sUsergroupexternalName.'"')." for sUsergroupexternalName when calling UsergroupexternalRequestCompound., must conform to the pattern /^.{0,64}$/.");
        }
	...
	//if ((!preg_match("/^.{0,64}$/", ObjectSerializer::toString($sUsergroupexternalID)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sUsergroupexternalID when calling UsergroupexternalRequestCompound., must conform to the pattern /^.{0,64}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sUsergroupexternalID)?'null':'"'.$sUsergroupexternalID.'"')." for sUsergroupexternalID when calling UsergroupexternalRequestCompound., must conform to the pattern /^.{0,64}$/.");
        }
