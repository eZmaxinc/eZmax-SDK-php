    ...
    */
	...
	//if (($pkiModulesectionID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiModulesectionID when calling ModulesectionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiModulesectionID)?'null':'"'.$pkiModulesectionID.'"').' for pkiModulesectionID when calling ModulesectionResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiModuleID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiModuleID when calling ModulesectionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiModuleID)?'null':'"'.$fkiModuleID.'"').' for fkiModuleID when calling ModulesectionResponse., must be bigger than or equal to 0.');
        }
