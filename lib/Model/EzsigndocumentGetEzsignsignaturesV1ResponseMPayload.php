 ...
 *
 * @category Class
 * @description Payload for GET /1/object/ezsigndocument/{pkiEzsigndocumentID}/getEzsignsignatures
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsigndocumentGetEzsignsignaturesV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigndocument-getEzsignsignatures-v1-Response-mPayload';
