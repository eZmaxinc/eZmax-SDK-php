...
/**
 * DiscussionResponseCompound Class Doc Comment
 *
 * @category Class
...
class DiscussionResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'discussion-ResponseCompound';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sDiscussionDescription']) && !preg_match("/(*UTF8)^.{0,75}$/", $this->container['sDiscussionDescription'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sDiscussionDescription'])?'null':'"'.$this->container['sDiscussionDescription'].'"')." for 'sDiscussionDescription', must be conform to the pattern /^.{0,75}$/.";
        }
        ...
        if ($this->container['aObjDiscussionmessage'] === null) {
            $invalidProperties[] = "'aObjDiscussionmessage' can't be null";
        }
     ...
     *
     * @return \eZmaxAPI\Model\DiscussionmembershipResponseCompound[]
     */
    public function getAObjDiscussionmembership()
    {
	//return $this->container['aObjDiscussionmembership'];
        return $this->container['aObjDiscussionmembership'];
    }

    /**
     * Sets aObjDiscussionmembership
     *
     * @param \eZmaxAPI\Model\DiscussionmembershipResponseCompound[] $aObjDiscussionmembership aObjDiscussionmembership
     *
     * @return self
     */
    public function setAObjDiscussionmembership($aObjDiscussionmembership)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjDiscussionmembership)) {
            //throw new \InvalidArgumentException('non-nullable aObjDiscussionmembership cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjDiscussionmembership'] = $aObjDiscussionmembership;
        $this->container['aObjDiscussionmembership'] = $aObjDiscussionmembership;
    ...
    /**
     * Gets aObjDiscussionmessage
     *
     * @return \eZmaxAPI\Model\DiscussionmessageResponseCompound[]
     */
    public function getAObjDiscussionmessage()
    {
	//return $this->container['aObjDiscussionmessage'];
        return $this->container['aObjDiscussionmessage'];
    }

    /**
     * Sets aObjDiscussionmessage
     *
     * @param \eZmaxAPI\Model\DiscussionmessageResponseCompound[] $aObjDiscussionmessage aObjDiscussionmessage
     *
     * @return self
     */
    public function setAObjDiscussionmessage($aObjDiscussionmessage)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjDiscussionmessage)) {
            //throw new \InvalidArgumentException('non-nullable aObjDiscussionmessage cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjDiscussionmessage'] = $aObjDiscussionmessage;
        $this->container['aObjDiscussionmessage'] = $aObjDiscussionmessage;
