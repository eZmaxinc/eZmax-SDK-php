    ...
    */
	...
	//if ((mb_strlen($yyyymmEzmaxinvoicing) > 7)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $yyyymmEzmaxinvoicing when calling EzmaxinvoicingAutocompleteElementResponse., must be smaller than or equal to 7.');
            throw new \InvalidArgumentException('value '.(is_null($yyyymmEzmaxinvoicing)?'null':'"'.$yyyymmEzmaxinvoicing.'"').', invalid length for yyyymmEzmaxinvoicing when calling EzmaxinvoicingAutocompleteElementResponse., must be smaller than or equal to 7.');
        }
	...
	//if (($pkiEzmaxinvoicingID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzmaxinvoicingID when calling EzmaxinvoicingAutocompleteElementResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzmaxinvoicingID)?'null':'"'.$pkiEzmaxinvoicingID.'"').' for pkiEzmaxinvoicingID when calling EzmaxinvoicingAutocompleteElementResponse., must be bigger than or equal to 0.');
        }
