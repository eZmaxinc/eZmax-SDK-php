...
/**
 * EzsigntemplatepackagemembershipResponseCompoundV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplatepackagemembershipResponseCompoundV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplatepackagemembership-ResponseCompoundV3';
    ...
    protected static $openAPITypes = [
        ...
        'objEzsigntemplate' => '\eZmaxAPI\Model\EzsigntemplateResponseCompoundV4',
    ...
    protected static array $openAPINullables = [
        'pkiEzsigntemplatepackagemembershipID' => false,
        'fkiEzsigntemplatepackageID' => false,
        'fkiEzsigntemplateID' => false,
        'iEzsigntemplatepackagemembershipOrder' => false,
        'objEzsigntemplate' => false,
        'aObjEzsigntemplatepackagesignermembership' => false
    ];
    ...
    {
        $this->setIfExists('pkiEzsigntemplatepackagemembershipID', $data ?? [], null);
        $this->setIfExists('fkiEzsigntemplatepackageID', $data ?? [], null);
        $this->setIfExists('fkiEzsigntemplateID', $data ?? [], null);
        $this->setIfExists('iEzsigntemplatepackagemembershipOrder', $data ?? [], null);
        $this->setIfExists('objEzsigntemplate', $data ?? [], null);
        $this->setIfExists('aObjEzsigntemplatepackagesignermembership', $data ?? [], null);
    }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigntemplatepackagemembershipID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatepackagemembershipID when calling EzsigntemplatepackagemembershipResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepackagemembershipID)?'null':'"'.$pkiEzsigntemplatepackagemembershipID.'"').' for pkiEzsigntemplatepackagemembershipID when calling EzsigntemplatepackagemembershipResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigntemplatepackageID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepackageID when calling EzsigntemplatepackagemembershipResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatepackageID)?'null':'"'.$fkiEzsigntemplatepackageID.'"').' for fkiEzsigntemplatepackageID when calling EzsigntemplatepackagemembershipResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigntemplateID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplateID when calling EzsigntemplatepackagemembershipResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateID)?'null':'"'.$fkiEzsigntemplateID.'"').' for fkiEzsigntemplateID when calling EzsigntemplatepackagemembershipResponseCompoundV3., must be bigger than or equal to 0.');
        }
    ...
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($iEzsigntemplatepackagemembershipOrder)) {
            //throw new \InvalidArgumentException('non-nullable iEzsigntemplatepackagemembershipOrder cannot be null');
        //}
        //if (($iEzsigntemplatepackagemembershipOrder < 1)) {
        if (($iEzsigntemplatepackagemembershipOrder < 1)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatepackagemembershipOrder when calling EzsigntemplatepackagemembershipResponseCompoundV3., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatepackagemembershipOrder)?'null':'"'.$iEzsigntemplatepackagemembershipOrder.'"').' for iEzsigntemplatepackagemembershipOrder when calling EzsigntemplatepackagemembershipResponseCompoundV3., must be bigger than or equal to 1.');
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['iEzsigntemplatepackagemembershipOrder'] = $iEzsigntemplatepackagemembershipOrder;
        $this->container['iEzsigntemplatepackagemembershipOrder'] = (is_null($iEzsigntemplatepackagemembershipOrder) ? null : (int) $iEzsigntemplatepackagemembershipOrder);
     ...
     *
     * @return \eZmaxAPI\Model\EzsigntemplateResponseCompoundV4
     */
     ...
     *
     * @param \eZmaxAPI\Model\EzsigntemplateResponseCompoundV4 $objEzsigntemplate objEzsigntemplate
     *
     * @return self
     */
