...
/**
 * CreditcardmerchantAutocompleteElementResponse Class Doc Comment
 *
 * @category Class
 * @description A Creditcardmerchant AutocompleteElement Response
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreditcardmerchantAutocompleteElementResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'creditcardmerchant-AutocompleteElement-Response';
    ...
    */
	...
	//if (($pkiCreditcardmerchantID > 255)) {
        if (($pkiCreditcardmerchantID > 255)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiCreditcardmerchantID when calling CreditcardmerchantAutocompleteElementResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCreditcardmerchantID)?'null':'"'.$pkiCreditcardmerchantID.'"').' for pkiCreditcardmerchantID when calling CreditcardmerchantAutocompleteElementResponse., must be smaller than or equal to 255.');
        }
	//if (($pkiCreditcardmerchantID < 0)) {
        if (($pkiCreditcardmerchantID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiCreditcardmerchantID when calling CreditcardmerchantAutocompleteElementResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCreditcardmerchantID)?'null':'"'.$pkiCreditcardmerchantID.'"').' for pkiCreditcardmerchantID when calling CreditcardmerchantAutocompleteElementResponse., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{0,25}$/", ObjectSerializer::toString($sCreditcardmerchantDescription)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sCreditcardmerchantDescription when calling CreditcardmerchantAutocompleteElementResponse., must conform to the pattern /^.{0,25}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCreditcardmerchantDescription)?'null':'"'.$sCreditcardmerchantDescription.'"')." for sCreditcardmerchantDescription when calling CreditcardmerchantAutocompleteElementResponse., must conform to the pattern /^.{0,25}$/.");
        }
