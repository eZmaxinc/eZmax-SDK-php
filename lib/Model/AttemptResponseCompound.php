...
/**
 * AttemptResponseCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class AttemptResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'attempt-ResponseCompound';
    ...
    protected static array $openAPINullables = [
        'dtAttemptStart' => false,
		'sAttemptResult' => false,
		'iAttemptDuration' => false
    ];
    ...
    {
        $this->setIfExists('dtAttemptStart', $data ?? [], null);
        $this->setIfExists('sAttemptResult', $data ?? [], null);
        $this->setIfExists('iAttemptDuration', $data ?? [], null);
    }
