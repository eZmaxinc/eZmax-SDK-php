...
class TextstylestaticResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiTextstylestaticID) && ($pkiTextstylestaticID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiTextstylestaticID)?'null':'"'.$pkiTextstylestaticID.'"').' for pkiTextstylestaticID when calling TextstylestaticResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiFontID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFontID)?'null':'"'.$fkiFontID.'"').' for fkiFontID when calling TextstylestaticResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sFontName) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sFontName)))) {
            //throw new \InvalidArgumentException("invalid value for \$sFontName when calling TextstylestaticResponse., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sFontName)?'null':'"'.$sFontName.'"')." for sFontName when calling TextstylestaticResponse., must conform to the pattern /^.{0,50}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iTextstylestaticFontcolor > 16777215)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iTextstylestaticFontcolor)?'null':'"'.$iTextstylestaticFontcolor.'"').' for iTextstylestaticFontcolor when calling TextstylestaticResponse., must be smaller than or equal to 16777215.');
        }
        ...
        if (($iTextstylestaticFontcolor < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iTextstylestaticFontcolor)?'null':'"'.$iTextstylestaticFontcolor.'"').' for iTextstylestaticFontcolor when calling TextstylestaticResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iTextstylestaticSize > 255)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iTextstylestaticSize)?'null':'"'.$iTextstylestaticSize.'"').' for iTextstylestaticSize when calling TextstylestaticResponse., must be smaller than or equal to 255.');
        }
        ...
        if (($iTextstylestaticSize < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($iTextstylestaticSize)?'null':'"'.$iTextstylestaticSize.'"').' for iTextstylestaticSize when calling TextstylestaticResponse., must be bigger than or equal to 1.');
        }
