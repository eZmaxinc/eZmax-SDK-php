...
/**
 * EzsigntemplatepublicListElement Class Doc Comment
 *
 * @category Class
 * @description A Ezsigntemplatepublic List Element
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsigntemplatepublicListElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplatepublic-ListElement';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigntemplatepublicID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatepublicID when calling EzsigntemplatepublicListElement., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepublicID)?'null':'"'.$pkiEzsigntemplatepublicID.'"').' for pkiEzsigntemplatepublicID when calling EzsigntemplatepublicListElement., must be smaller than or equal to 65535.');
        }
        //if (($pkiEzsigntemplatepublicID < 0)) {
        if (($pkiEzsigntemplatepublicID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatepublicID when calling EzsigntemplatepublicListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepublicID)?'null':'"'.$pkiEzsigntemplatepublicID.'"').' for pkiEzsigntemplatepublicID when calling EzsigntemplatepublicListElement., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsignfoldertypeID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsigntemplatepublicListElement., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsigntemplatepublicListElement., must be smaller than or equal to 65535.');
        }
        //if (($fkiEzsignfoldertypeID < 0)) {
        if (($fkiEzsignfoldertypeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsigntemplatepublicListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsigntemplatepublicListElement., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiUserlogintypeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiUserlogintypeID when calling EzsigntemplatepublicListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserlogintypeID)?'null':'"'.$fkiUserlogintypeID.'"').' for fkiUserlogintypeID when calling EzsigntemplatepublicListElement., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplateID) && ($fkiEzsigntemplateID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplateID when calling EzsigntemplatepublicListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateID)?'null':'"'.$fkiEzsigntemplateID.'"').' for fkiEzsigntemplateID when calling EzsigntemplatepublicListElement., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplatepackageID) && ($fkiEzsigntemplatepackageID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepackageID when calling EzsigntemplatepublicListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatepackageID)?'null':'"'.$fkiEzsigntemplatepackageID.'"').' for fkiEzsigntemplatepackageID when calling EzsigntemplatepublicListElement., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatepublicDescription) && (!preg_match("/(*UTF8)^.{0,80}$/", ObjectSerializer::toString($sEzsigntemplatepublicDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatepublicDescription when calling EzsigntemplatepublicListElement., must conform to the pattern /^.{0,80}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatepublicDescription)?'null':'"'.$sEzsigntemplatepublicDescription.'"')." for sEzsigntemplatepublicDescription when calling EzsigntemplatepublicListElement., must conform to the pattern /^.{0,80}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($tEzsigntemplatepublicNote) && (!preg_match("/(*UTF8)^.{0,65535}$/", ObjectSerializer::toString($tEzsigntemplatepublicNote)))) {
            //throw new \InvalidArgumentException("invalid value for \$tEzsigntemplatepublicNote when calling EzsigntemplatepublicListElement., must conform to the pattern /^.{0,65535}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($tEzsigntemplatepublicNote)?'null':'"'.$tEzsigntemplatepublicNote.'"')." for tEzsigntemplatepublicNote when calling EzsigntemplatepublicListElement., must conform to the pattern /^.{0,65535}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplatepublicLimit > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatepublicLimit when calling EzsigntemplatepublicListElement., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatepublicLimit)?'null':'"'.$iEzsigntemplatepublicLimit.'"').' for iEzsigntemplatepublicLimit when calling EzsigntemplatepublicListElement., must be smaller than or equal to 65535.');
        }
        //if (($iEzsigntemplatepublicLimit < 0)) {
        if (($iEzsigntemplatepublicLimit < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatepublicLimit when calling EzsigntemplatepublicListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatepublicLimit)?'null':'"'.$iEzsigntemplatepublicLimit.'"').' for iEzsigntemplatepublicLimit when calling EzsigntemplatepublicListElement., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplatepublicLimitexceeded > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatepublicLimitexceeded when calling EzsigntemplatepublicListElement., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatepublicLimitexceeded)?'null':'"'.$iEzsigntemplatepublicLimitexceeded.'"').' for iEzsigntemplatepublicLimitexceeded when calling EzsigntemplatepublicListElement., must be smaller than or equal to 65535.');
        }
        //if (($iEzsigntemplatepublicLimitexceeded < 0)) {
        if (($iEzsigntemplatepublicLimitexceeded < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatepublicLimitexceeded when calling EzsigntemplatepublicListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatepublicLimitexceeded)?'null':'"'.$iEzsigntemplatepublicLimitexceeded.'"').' for iEzsigntemplatepublicLimitexceeded when calling EzsigntemplatepublicListElement., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtEzsigntemplatepublicLimitexceededsince) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtEzsigntemplatepublicLimitexceededsince)))) {
            //throw new \InvalidArgumentException("invalid value for \$dtEzsigntemplatepublicLimitexceededsince when calling EzsigntemplatepublicListElement., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtEzsigntemplatepublicLimitexceededsince)?'null':'"'.$dtEzsigntemplatepublicLimitexceededsince.'"')." for dtEzsigntemplatepublicLimitexceededsince when calling EzsigntemplatepublicListElement., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
     ...
     * Sets iEzsignfolder
     *
     * @param int $iEzsignfolder The total number of Ezsignfolders using the Ezsigntemplatepublic
     *
     * @return self
     */
     ...
     *
     * @param int $iEzsigndocument The total number of Ezsigndocuments using the Ezsigntemplatepublic
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatepublicEzsigntemplatedescription) && (!preg_match("/(*UTF8)^.{1,80}$/", ObjectSerializer::toString($sEzsigntemplatepublicEzsigntemplatedescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatepublicEzsigntemplatedescription when calling EzsigntemplatepublicListElement., must conform to the pattern /^.{1,80}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatepublicEzsigntemplatedescription)?'null':'"'.$sEzsigntemplatepublicEzsigntemplatedescription.'"')." for sEzsigntemplatepublicEzsigntemplatedescription when calling EzsigntemplatepublicListElement., must conform to the pattern /^.{1,80}$/.");
        }
