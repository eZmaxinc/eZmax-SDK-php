...
/**
 * ScimAuthenticationScheme Class Doc Comment
 *
 * @category Class
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 ...
 */
class ScimAuthenticationScheme implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Scim-AuthenticationScheme';
    ...
    public const TYPE_OAUTHBEARERTOKEN = 'oauthbearertoken';
    public const TYPE_HTTPBASIC = 'httpbasic';
    public const TYPE_HTTPDIGEST = 'httpdigest';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The authentication scheme.
     *
     * @return self
     */
