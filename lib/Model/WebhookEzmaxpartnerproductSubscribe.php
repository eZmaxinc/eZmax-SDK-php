...
/**
 * WebhookEzmaxpartnerproductSubscribe Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookEzmaxpartnerproductSubscribe implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Webhook-Ezmaxpartnerproduct-Subscribe';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['objEzmaxpartnerproduct'] === null) {
            $invalidProperties[] = "'objEzmaxpartnerproduct' can't be null";
        }
        //if (!is_null($this->container['sExternalID']) && !preg_match("/^.{0,128}$/", $this->container['sExternalID'])) {
        if (!is_null($this->container['sExternalID']) && !preg_match("/(*UTF8)^.{0,128}$/", $this->container['sExternalID'])) {
            //$invalidProperties[] = "invalid value for 'sExternalID', must be conform to the pattern /^.{0,128}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sExternalID'])?'null':'"'.$this->container['sExternalID'].'"')." for 'sExternalID', must be conform to the pattern /^.{0,128}$/.";
        }

        if ($this->container['sApikeyApikey'] === null) {
            $invalidProperties[] = "'sApikeyApikey' can't be null";
        }
    ...
    /**
     * Gets objEzmaxpartnerproduct
     *
     * @return \eZmaxAPI\Model\CustomEzmaxpartnerproductSubscribe
     */
    public function getObjEzmaxpartnerproduct()
    {
	//return $this->container['objEzmaxpartnerproduct'];
        return $this->container['objEzmaxpartnerproduct'];
    }

    /**
     * Sets objEzmaxpartnerproduct
     *
     * @param \eZmaxAPI\Model\CustomEzmaxpartnerproductSubscribe $objEzmaxpartnerproduct objEzmaxpartnerproduct
     *
     * @return self
     */
    public function setObjEzmaxpartnerproduct($objEzmaxpartnerproduct)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($objEzmaxpartnerproduct)) {
            //throw new \InvalidArgumentException('non-nullable objEzmaxpartnerproduct cannot be null');
        //}
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        //if ((!preg_match("/^.{0,128}$/", ObjectSerializer::toString($sExternalID)))) {
        if (!is_null($sExternalID) && (!preg_match("/(*UTF8)^.{0,128}$/", ObjectSerializer::toString($sExternalID)))) {
            //throw new \InvalidArgumentException("invalid value for \$sExternalID when calling WebhookEzmaxpartnerproductSubscribe., must conform to the pattern /^.{0,128}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sExternalID)?'null':'"'.$sExternalID.'"')." for sExternalID when calling WebhookEzmaxpartnerproductSubscribe., must conform to the pattern /^.{0,128}$/.");
        }
     ...
     * Sets sApikeyApikey
     *
     * @param string $sApikeyApikey sApikeyApikey
     *
     * @return self
     */
     ...
     * Sets sApikeySecret
     *
     * @param string $sApikeySecret sApikeySecret
     *
     * @return self
     */
