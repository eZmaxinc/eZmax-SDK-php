...
/**
 * WebsocketResponseErrorV1MPayload Class Doc Comment
 *
 * @category Class
 ...
 */
class WebsocketResponseErrorV1MPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Websocket-Response-Error-V1-mPayload';
    ...
    */
	...
	//if ((!preg_match("/^.{0,500}$/", ObjectSerializer::toString($sErrorMessage)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sErrorMessage when calling WebsocketResponseErrorV1MPayload., must conform to the pattern /^.{0,500}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sErrorMessage)?'null':'"'.$sErrorMessage.'"')." for sErrorMessage when calling WebsocketResponseErrorV1MPayload., must conform to the pattern /^.{0,500}$/.");
        }
