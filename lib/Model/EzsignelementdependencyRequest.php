...
class EzsignelementdependencyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzsignelementdependencyID) && ($pkiEzsignelementdependencyID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsignelementdependencyID when calling EzsignelementdependencyRequest., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignelementdependencyID)?'null':'"'.$pkiEzsignelementdependencyID.'"').' for pkiEzsignelementdependencyID when calling EzsignelementdependencyRequest., must be smaller than or equal to 16777215.');
        }
        ...
        if (!is_null($pkiEzsignelementdependencyID) && ($pkiEzsignelementdependencyID < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignelementdependencyID)?'null':'"'.$pkiEzsignelementdependencyID.'"').' for pkiEzsignelementdependencyID when calling EzsignelementdependencyRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignformfieldIDValidation) && ($fkiEzsignformfieldIDValidation < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignformfieldIDValidation)?'null':'"'.$fkiEzsignformfieldIDValidation.'"').' for fkiEzsignformfieldIDValidation when calling EzsignelementdependencyRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignformfieldgroupIDValidation) && ($fkiEzsignformfieldgroupIDValidation < 0)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignformfieldgroupIDValidation)?'null':'"'.$fkiEzsignformfieldgroupIDValidation.'"').' for fkiEzsignformfieldgroupIDValidation when calling EzsignelementdependencyRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignelementdependencyEzsignformfieldgrouplabel) && (mb_strlen($sEzsignelementdependencyEzsignformfieldgrouplabel) > 50)) {
            ...
            throw new \InvalidArgumentException('value '.(is_null($sEzsignelementdependencyEzsignformfieldgrouplabel)?'null':'"'.$sEzsignelementdependencyEzsignformfieldgrouplabel.'"').', invalid length for sEzsignelementdependencyEzsignformfieldgrouplabel when calling EzsignelementdependencyRequest., must be smaller than or equal to 50.');
        }
        ...
        if (!is_null($sEzsignelementdependencyEzsignformfieldgrouplabel) && (mb_strlen($sEzsignelementdependencyEzsignformfieldgrouplabel) < 1)) {
            ...
            throw new \InvalidArgumentException('value '.(is_null($sEzsignelementdependencyEzsignformfieldgrouplabel)?'null':'"'.$sEzsignelementdependencyEzsignformfieldgrouplabel.'"').', invalid length for sEzsignelementdependencyEzsignformfieldgrouplabel when calling EzsignelementdependencyRequest., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsignelementdependencyValue) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sEzsignelementdependencyValue)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignelementdependencyValue)?'null':'"'.$sEzsignelementdependencyValue.'"')." for sEzsignelementdependencyValue when calling EzsignelementdependencyRequest., must conform to the pattern /^.{0,50}$/.");
        }
