...
class EzsigntemplatepublicResetUrlV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//if ((!preg_match("/^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/", ObjectSerializer::toString($sEzsigntemplatepublicUrl)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatepublicUrl when calling EzsigntemplatepublicResetUrlV1ResponseMPayload., must conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatepublicUrl)?'null':'"'.$sEzsigntemplatepublicUrl.'"')." for sEzsigntemplatepublicUrl when calling EzsigntemplatepublicResetUrlV1ResponseMPayload., must conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.");
        }
