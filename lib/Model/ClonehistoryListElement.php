...
class ClonehistoryListElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['dtClonehistoryFirsthit']) && !preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", $this->container['dtClonehistoryFirsthit'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtClonehistoryFirsthit'])?'null':'"'.$this->container['dtClonehistoryFirsthit'].'"')." for 'dtClonehistoryFirsthit', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
        }
        ...
        if (!is_null($this->container['dtClonehistoryLasthit']) && !preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", $this->container['dtClonehistoryLasthit'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtClonehistoryLasthit'])?'null':'"'.$this->container['dtClonehistoryLasthit'].'"')." for 'dtClonehistoryLasthit', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
        }
        ...
        if (!is_null($this->container['sUserLoginnameCloning']) && !preg_match("/(*UTF8)^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/", $this->container['sUserLoginnameCloning'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sUserLoginnameCloning'])?'null':'"'.$this->container['sUserLoginnameCloning'].'"')." for 'sUserLoginnameCloning', must be conform to the pattern /^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/.";
        }
        ...
        if (!is_null($this->container['sUserLoginnameCloned']) && !preg_match("/(*UTF8)^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/", $this->container['sUserLoginnameCloned'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sUserLoginnameCloned'])?'null':'"'.$this->container['sUserLoginnameCloned'].'"')." for 'sUserLoginnameCloned', must be conform to the pattern /^(?:([\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20})|([a-zA-Z0-9]){1,32})$/.";
        }
