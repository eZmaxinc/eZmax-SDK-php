...
/**
 * CustomEzmaxcustomerResponse Class Doc Comment
 *
 * @category Class
 * @description A Ezmaxcustomer Object
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomEzmaxcustomerResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Custom-Ezmaxcustomer-Response';
    ...
    protected static $openAPITypes = [
        ...
        'objEzmaxcustomerCompany' => '\eZmaxAPI\Model\MultilingualEzmaxcustomerCompany'
    ];
    ...
    protected static $attributeMap = [
        ...
        'objEzmaxcustomerCompany' => 'objEzmaxcustomerCompany'
    ];
    ...
    protected static $setters = [
        ...
        'objEzmaxcustomerCompany' => 'setObjEzmaxcustomerCompany'
    ];
    ...
    protected static $getters = [
        ...
        'objEzmaxcustomerCompany' => 'getObjEzmaxcustomerCompany'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('objEzmaxcustomerCompany', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['fksEzmaxcustomerCode']) && !preg_match("/(*UTF8)^[a-z\\d]{2,6}$/", $this->container['fksEzmaxcustomerCode'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['fksEzmaxcustomerCode'])?'null':'"'.$this->container['fksEzmaxcustomerCode'].'"')." for 'fksEzmaxcustomerCode', must be conform to the pattern /^[a-z\\d]{2,6}$/.";
        }
        ...
        if ($this->container['objEzmaxcustomerCompany'] === null) {
            $invalidProperties[] = "'objEzmaxcustomerCompany' can't be null";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if ((mb_strlen($fksEzmaxcustomerCode) > 6)) {
            //throw new \InvalidArgumentException('invalid length for $fksEzmaxcustomerCode when calling CustomEzmaxcustomerResponse., must be smaller than or equal to 6.');
            throw new \InvalidArgumentException('value '.(is_null($fksEzmaxcustomerCode)?'null':'"'.$fksEzmaxcustomerCode.'"').', invalid length for fksEzmaxcustomerCode when calling CustomEzmaxcustomerResponse., must be smaller than or equal to 6.');
        }
        //if ((mb_strlen($fksEzmaxcustomerCode) < 2)) {
        if ((mb_strlen($fksEzmaxcustomerCode) < 2)) {
            //throw new \InvalidArgumentException('invalid length for $fksEzmaxcustomerCode when calling CustomEzmaxcustomerResponse., must be bigger than or equal to 2.');
            throw new \InvalidArgumentException('value '.(is_null($fksEzmaxcustomerCode)?'null':'"'.$fksEzmaxcustomerCode.'"').', invalid length for fksEzmaxcustomerCode when calling CustomEzmaxcustomerResponse., must be bigger than or equal to 2.');
        }
        ...
        if (!is_null($fksEzmaxcustomerCode) && (!preg_match("/(*UTF8)^[a-z\\d]{2,6}$/", ObjectSerializer::toString($fksEzmaxcustomerCode)))) {
            //throw new \InvalidArgumentException("invalid value for \$fksEzmaxcustomerCode when calling CustomEzmaxcustomerResponse., must conform to the pattern /^[a-z\\d]{2,6}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($fksEzmaxcustomerCode)?'null':'"'.$fksEzmaxcustomerCode.'"')." for fksEzmaxcustomerCode when calling CustomEzmaxcustomerResponse., must conform to the pattern /^[a-z\\d]{2,6}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiSystemconfigurationtypeID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiSystemconfigurationtypeID when calling CustomEzmaxcustomerResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiSystemconfigurationtypeID)?'null':'"'.$fkiSystemconfigurationtypeID.'"').' for fkiSystemconfigurationtypeID when calling CustomEzmaxcustomerResponse., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets objEzmaxcustomerCompany
     *
     * @return \eZmaxAPI\Model\MultilingualEzmaxcustomerCompany
     */
    public function getObjEzmaxcustomerCompany()
    {
	//return $this->container['objEzmaxcustomerCompany'];
        return $this->container['objEzmaxcustomerCompany'];
    }

    /**
     * Sets objEzmaxcustomerCompany
     *
     * @param \eZmaxAPI\Model\MultilingualEzmaxcustomerCompany $objEzmaxcustomerCompany objEzmaxcustomerCompany
     *
     * @return self
     */
    public function setObjEzmaxcustomerCompany($objEzmaxcustomerCompany)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($objEzmaxcustomerCompany)) {
            //throw new \InvalidArgumentException('non-nullable objEzmaxcustomerCompany cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['objEzmaxcustomerCompany'] = $objEzmaxcustomerCompany;
        $this->container['objEzmaxcustomerCompany'] = $objEzmaxcustomerCompany;
