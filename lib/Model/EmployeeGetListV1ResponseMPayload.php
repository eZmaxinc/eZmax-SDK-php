...
/**
 * EmployeeGetListV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /1/object/employee/getList
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EmployeeGetListV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'employee-getList-v1-Response-mPayload';
    ...
    protected static $openAPITypes = [
        'iRowReturned' => 'int',
        'iRowFiltered' => 'int',
        'aObjEmployee' => '\eZmaxAPI\Model\EmployeeListElement[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aObjEmployee', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aObjEmployee'] === null) {
            $invalidProperties[] = "'aObjEmployee' can't be null";
        }
     ...
     * Gets aObjEmployee
     *
     * @return \eZmaxAPI\Model\EmployeeListElement[]
     */
    public function getAObjEmployee()
    {
	//return $this->container['aObjEmployee'];
        return $this->container['aObjEmployee'];
    }
     ...
     * Sets aObjEmployee
     *
     * @param \eZmaxAPI\Model\EmployeeListElement[] $aObjEmployee aObjEmployee
     *
     * @return self
     */
    public function setAObjEmployee($aObjEmployee)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjEmployee)) {
            //throw new \InvalidArgumentException('non-nullable aObjEmployee cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjEmployee'] = $aObjEmployee;
        $this->container['aObjEmployee'] = $aObjEmployee;
