...
class BrandingResponseCompoundV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        //if (!is_null($this->container['sDomainName']) && !preg_match("/^(?=.{4,75}$)([a-zA-Z0-9-]+\\.)+[a-zA-Z]{2,63}$/", $this->container['sDomainName'])) {
        ...
        if (!is_null($this->container['sBrandingLogourl']) && !preg_match("/(*UTF8)^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/", $this->container['sBrandingLogourl'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sBrandingLogourl'])?'null':'"'.$this->container['sBrandingLogourl'].'"')." for 'sBrandingLogourl', must be conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.";
        }
        ...
        if (!is_null($this->container['sBrandingLogoemailurl']) && !preg_match("/(*UTF8)^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/", $this->container['sBrandingLogoemailurl'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sBrandingLogoemailurl'])?'null':'"'.$this->container['sBrandingLogoemailurl'].'"')." for 'sBrandingLogoemailurl', must be conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.";
        }
        ...
        if (!is_null($this->container['sBrandingLogointerfaceurl']) && !preg_match("/(*UTF8)^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/", $this->container['sBrandingLogointerfaceurl'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sBrandingLogointerfaceurl'])?'null':'"'.$this->container['sBrandingLogointerfaceurl'].'"')." for 'sBrandingLogointerfaceurl', must be conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiDomainID) && ($fkiDomainID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDomainID when calling BrandingResponseCompoundV3., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDomainID)?'null':'"'.$fkiDomainID.'"').' for fkiDomainID when calling BrandingResponseCompoundV3., must be smaller than or equal to 255.');
        }
        //if (($fkiDomainID < 0)) {
        if (!is_null($fkiDomainID) && ($fkiDomainID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiDomainID when calling BrandingResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDomainID)?'null':'"'.$fkiDomainID.'"').' for fkiDomainID when calling BrandingResponseCompoundV3., must be bigger than or equal to 0.');
        }
     ...
     * Sets sDomainName
     *
     * @param string|null $sDomainName The name of the Domain
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sDomainName) && (!preg_match("/(*UTF8)^(?=.{4,75}$)([a-zA-Z0-9-]+\\.)+[a-zA-Z]{2,63}$/", ObjectSerializer::toString($sDomainName)))) {
            //throw new \InvalidArgumentException("invalid value for \$sDomainName when calling BrandingResponseCompoundV3., must conform to the pattern /^(?=.{4,75}$)([a-zA-Z0-9-]+\\.)+[a-zA-Z]{2,63}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sDomainName)?'null':'"'.$sDomainName.'"')." for sDomainName when calling BrandingResponseCompoundV3., must conform to the pattern /^(?=.{4,75}$)([a-zA-Z0-9-]+\\.)+[a-zA-Z]{2,63}$/.");
        }
