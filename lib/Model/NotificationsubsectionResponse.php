    ...
    */
	...
	//if (($pkiNotificationsubsectionID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiNotificationsubsectionID when calling NotificationsubsectionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiNotificationsubsectionID)?'null':'"'.$pkiNotificationsubsectionID.'"').' for pkiNotificationsubsectionID when calling NotificationsubsectionResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiNotificationsectionID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiNotificationsectionID when calling NotificationsubsectionResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiNotificationsectionID)?'null':'"'.$fkiNotificationsectionID.'"').' for fkiNotificationsectionID when calling NotificationsubsectionResponse., must be bigger than or equal to 0.');
        }
