...
/**
 * BillingentityinternalListElement Class Doc Comment
 *
 * @category Class
 ...
 */
class BillingentityinternalListElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'billingentityinternal-ListElement';
    ...
    */
	...
	//if (($pkiBillingentityinternalID < 0)) {
        if (($pkiBillingentityinternalID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiBillingentityinternalID when calling BillingentityinternalListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiBillingentityinternalID)?'null':'"'.$pkiBillingentityinternalID.'"').' for pkiBillingentityinternalID when calling BillingentityinternalListElement., must be bigger than or equal to 0.');
        }
