...
class EzsigntemplatedocumentpagerecognitionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsigntemplatedocumentpagerecognitionID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatedocumentpagerecognitionID when calling EzsigntemplatedocumentpagerecognitionResponse., must be smaller than or equal to 65535.');
        ...
        if (($pkiEzsigntemplatedocumentpagerecognitionID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatedocumentpagerecognitionID when calling EzsigntemplatedocumentpagerecognitionResponse., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigntemplatedocumentpageID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatedocumentpageID when calling EzsigntemplatedocumentpagerecognitionResponse., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionSimilarpercentage) && ($iEzsigntemplatedocumentpagerecognitionSimilarpercentage > 100)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionSimilarpercentage when calling EzsigntemplatedocumentpagerecognitionResponse., must be smaller than or equal to 100.');
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionSimilarpercentage) && ($iEzsigntemplatedocumentpagerecognitionSimilarpercentage < 60)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionSimilarpercentage when calling EzsigntemplatedocumentpagerecognitionResponse., must be bigger than or equal to 60.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionX) && ($iEzsigntemplatedocumentpagerecognitionX > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionX when calling EzsigntemplatedocumentpagerecognitionResponse., must be smaller than or equal to 65535.');
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionX) && ($iEzsigntemplatedocumentpagerecognitionX < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionX when calling EzsigntemplatedocumentpagerecognitionResponse., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionY) && ($iEzsigntemplatedocumentpagerecognitionY > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionY when calling EzsigntemplatedocumentpagerecognitionResponse., must be smaller than or equal to 65535.');
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionY) && ($iEzsigntemplatedocumentpagerecognitionY < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionY when calling EzsigntemplatedocumentpagerecognitionResponse., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionWidth) && ($iEzsigntemplatedocumentpagerecognitionWidth > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionWidth when calling EzsigntemplatedocumentpagerecognitionResponse., must be smaller than or equal to 65535.');
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionWidth) && ($iEzsigntemplatedocumentpagerecognitionWidth < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionWidth when calling EzsigntemplatedocumentpagerecognitionResponse., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionHeight) && ($iEzsigntemplatedocumentpagerecognitionHeight > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionHeight when calling EzsigntemplatedocumentpagerecognitionResponse., must be smaller than or equal to 65535.');
        ...
        if (!is_null($iEzsigntemplatedocumentpagerecognitionHeight) && ($iEzsigntemplatedocumentpagerecognitionHeight < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionHeight when calling EzsigntemplatedocumentpagerecognitionResponse., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($tEzsigntemplatedocumentpagerecognitionText) && (!preg_match("/(*UTF8)^[.\\D\\d]{0,65535}$/", ObjectSerializer::toString($tEzsigntemplatedocumentpagerecognitionText)))) {
            //throw new \InvalidArgumentException("invalid value for \$tEzsigntemplatedocumentpagerecognitionText when calling EzsigntemplatedocumentpagerecognitionResponse., must conform to the pattern /^[.\\D\\d]{0,65535}$/.");
