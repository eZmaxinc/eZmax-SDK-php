 ...
 * @link     https://openapi-generator.tech
 */
class EzsignfoldersignerassociationRequest implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['fkiUserID'] = isset($data['fkiUserID']) ? $data['fkiUserID'] : null;
    ...
    public function setFkiUserID($fkiUserID)
    {
        ...
        if (!is_null($fkiUserID) && ($fkiUserID < 1)) {
            throw new \InvalidArgumentException('invalid value for $fkiUserID when calling EzsignfoldersignerassociationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setFkiEzsignfolderID($fkiEzsignfolderID)
    {
        ...
        if (($fkiEzsignfolderID < 1)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsignfolderID when calling EzsignfoldersignerassociationRequest., must be bigger than or equal to 1.');
        }
