    ...
    */
	...
	//if (($pkiEzsignfoldersignerassociationID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignfoldersignerassociationID when calling EzsignfoldersignerassociationRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignfoldersignerassociationID)?'null':'"'.$pkiEzsignfoldersignerassociationID.'"').' for pkiEzsignfoldersignerassociationID when calling EzsignfoldersignerassociationRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling EzsignfoldersignerassociationRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling EzsignfoldersignerassociationRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignsignergroupID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignsignergroupID when calling EzsignfoldersignerassociationRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsignergroupID)?'null':'"'.$fkiEzsignsignergroupID.'"').' for fkiEzsignsignergroupID when calling EzsignfoldersignerassociationRequest., must be smaller than or equal to 65535.');
        }
	//if (($fkiEzsignsignergroupID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignsignergroupID when calling EzsignfoldersignerassociationRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsignergroupID)?'null':'"'.$fkiEzsignsignergroupID.'"').' for fkiEzsignsignergroupID when calling EzsignfoldersignerassociationRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignfolderID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfolderID when calling EzsignfoldersignerassociationRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfolderID)?'null':'"'.$fkiEzsignfolderID.'"').' for fkiEzsignfolderID when calling EzsignfoldersignerassociationRequest., must be bigger than or equal to 0.');
        }
