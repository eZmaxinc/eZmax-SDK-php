...
//        if (($fkiUsergroupID > 255)) {
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID > 255)) {
            throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling EzsignfoldersignerassociationRequest., must be smaller than or equal to 255.');
        }
//        if (($fkiUsergroupID < 0)) {
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling EzsignfoldersignerassociationRequest., must be bigger than or equal to 0.');
        }
