...
class EzsigndocumentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        ...
        'fkiEzsignimportdocumentID' => null,
        'fkiLanguageID' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'fkiEzsignimportdocumentID' => false,
        'fkiLanguageID' => false,
    ...
    protected static $attributeMap = [
        ...
        'fkiEzsignimportdocumentID' => 'fkiEzsignimportdocumentID',
    ...
    protected static $setters = [
        ...
        'fkiEzsignimportdocumentID' => 'setFkiEzsignimportdocumentID',
    ...
    protected static $getters = [
        ...
        'fkiEzsignimportdocumentID' => 'getFkiEzsignimportdocumentID',
    ...
    public const E_EZSIGNDOCUMENT_SOURCE_EZSIGNIMPORTDOCUMENT = 'Ezsignimportdocument';
    ...
    public const E_EZSIGNDOCUMENT_FORM_DISCARD = 'Discard';
    public const E_EZSIGNDOCUMENT_FORM_FLATTEN = 'Flatten';
    ...
    public function getEEzsigndocumentSourceAllowableValues()
    {
        return [
            ...
            self::E_EZSIGNDOCUMENT_SOURCE_EZSIGNIMPORTDOCUMENT,
    ...
    public function getEEzsigndocumentFormAllowableValues()
    {
        return [
            ...
            self::E_EZSIGNDOCUMENT_FORM_DISCARD,
            self::E_EZSIGNDOCUMENT_FORM_FLATTEN,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('fkiEzsignimportdocumentID', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['fkiEzsignimportdocumentID']) && ($this->container['fkiEzsignimportdocumentID'] > 16777215)) {
            $invalidProperties[] = "invalid value for 'fkiEzsignimportdocumentID', must be smaller than or equal to 16777215.";
        }

        if (!is_null($this->container['fkiEzsignimportdocumentID']) && ($this->container['fkiEzsignimportdocumentID'] < 0)) {
            $invalidProperties[] = "invalid value for 'fkiEzsignimportdocumentID', must be bigger than or equal to 0.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzsigndocumentID) && ($pkiEzsigndocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigndocumentID when calling EzsigndocumentRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndocumentID)?'null':'"'.$pkiEzsigndocumentID.'"').' for pkiEzsigndocumentID when calling EzsigndocumentRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsignfolderID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfolderID when calling EzsigndocumentRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfolderID)?'null':'"'.$fkiEzsignfolderID.'"').' for fkiEzsignfolderID when calling EzsigndocumentRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplateID) && ($fkiEzsigntemplateID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplateID when calling EzsigndocumentRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateID)?'null':'"'.$fkiEzsigntemplateID.'"').' for fkiEzsigntemplateID when calling EzsigndocumentRequest., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsignfoldersignerassociationID) && ($fkiEzsignfoldersignerassociationID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldersignerassociationID when calling EzsigndocumentRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationID)?'null':'"'.$fkiEzsignfoldersignerassociationID.'"').' for fkiEzsignfoldersignerassociationID when calling EzsigndocumentRequest., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets fkiEzsignimportdocumentID
     *
     * @return int|null
     */
    public function getFkiEzsignimportdocumentID()
    {
	//return $this->container['fkiEzsignimportdocumentID'];
        return $this->container['fkiEzsignimportdocumentID'];
    }

    /**
     * Sets fkiEzsignimportdocumentID
     *
     * @param int|null $fkiEzsignimportdocumentID The unique ID of the Ezsignimportdocument
     *
     * @return self
     */
    public function setFkiEzsignimportdocumentID($fkiEzsignimportdocumentID)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($fkiEzsignimportdocumentID)) {
            //throw new \InvalidArgumentException('non-nullable fkiEzsignimportdocumentID cannot be null');
        //}
        //if (($fkiEzsignimportdocumentID > 16777215)) {
        if (!is_null($fkiEzsignimportdocumentID) && ($fkiEzsignimportdocumentID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignimportdocumentID when calling EzsigndocumentRequest., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignimportdocumentID)?'null':'"'.$fkiEzsignimportdocumentID.'"').' for fkiEzsignimportdocumentID when calling EzsigndocumentRequest., must be smaller than or equal to 16777215.');
        }
        //if (($fkiEzsignimportdocumentID < 0)) {
        if (!is_null($fkiEzsignimportdocumentID) && ($fkiEzsignimportdocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignimportdocumentID when calling EzsigndocumentRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignimportdocumentID)?'null':'"'.$fkiEzsignimportdocumentID.'"').' for fkiEzsignimportdocumentID when calling EzsigndocumentRequest., must be bigger than or equal to 0.');
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['fkiEzsignimportdocumentID'] = $fkiEzsignimportdocumentID;
        $this->container['fkiEzsignimportdocumentID'] = (is_null($fkiEzsignimportdocumentID) ? null : (int) $fkiEzsignimportdocumentID);
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiLanguageID > 2)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsigndocumentRequest., must be smaller than or equal to 2.');
        }
        //if (($fkiLanguageID < 1)) {
        if (($fkiLanguageID < 1)) {
            ...
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsigndocumentRequest., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigndocumentExternalid) && (!preg_match("/(*UTF8)^.{0,128}$/", ObjectSerializer::toString($sEzsigndocumentExternalid)))) {
            ...
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigndocumentExternalid)?'null':'"'.$sEzsigndocumentExternalid.'"')." for sEzsigndocumentExternalid when calling EzsigndocumentRequest., must conform to the pattern /^.{0,128}$/.");
        }
