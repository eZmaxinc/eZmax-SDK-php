...
class SignatureResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sSignatureUrl']) && !preg_match("/(*UTF8)^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/", $this->container['sSignatureUrl'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sSignatureUrl'])?'null':'"'.$this->container['sSignatureUrl'].'"')." for 'sSignatureUrl', must be conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.";
        }
        ...
        if (!is_null($this->container['sSignatureUrlinitials']) && !preg_match("/(*UTF8)^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/", $this->container['sSignatureUrlinitials'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sSignatureUrlinitials'])?'null':'"'.$this->container['sSignatureUrlinitials'].'"')." for 'sSignatureUrlinitials', must be conform to the pattern /^(https|http):\/\/[^\\s\/$.?#].[^\\s]*$/.";
        }
