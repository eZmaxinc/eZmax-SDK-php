...
/**
 * CommonResponseErrorWrongFranchiseoffice Class Doc Comment
 *
 * @category Class
 * @description Error Message when a Franchisebroker is not in this Franchiseoffice.
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CommonResponseErrorWrongFranchiseoffice implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Common-Response-Error-WrongFranchiseoffice';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sErrorMessage']) && !preg_match("/(*UTF8)^.{0,500}$/", $this->container['sErrorMessage'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sErrorMessage'])?'null':'"'.$this->container['sErrorMessage'].'"')." for 'sErrorMessage', must be conform to the pattern /^.{0,500}$/.";
        }

        if ($this->container['eErrorCode'] === null) {
            $invalidProperties[] = "'eErrorCode' can't be null";
        }
        if ($this->container['fkiFranchiseagenceID'] === null) {
            $invalidProperties[] = "'fkiFranchiseagenceID' can't be null";
        }
        if (($this->container['fkiFranchiseagenceID'] > 65535)) {
            $invalidProperties[] = "invalid value for 'fkiFranchiseagenceID', must be smaller than or equal to 65535.";
        }

        if (($this->container['fkiFranchiseagenceID'] < 0)) {
            $invalidProperties[] = "invalid value for 'fkiFranchiseagenceID', must be bigger than or equal to 0.";
        }

        if ($this->container['sFranchiseagenceName'] === null) {
            $invalidProperties[] = "'sFranchiseagenceName' can't be null";
        }
        ...
        if ($this->container['iFranchiseofficeCode'] === null) {
            $invalidProperties[] = "'iFranchiseofficeCode' can't be null";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sErrorMessage) && (!preg_match("/(*UTF8)^.{0,500}$/", ObjectSerializer::toString($sErrorMessage)))) {
            //throw new \InvalidArgumentException("invalid value for \$sErrorMessage when calling CommonResponseErrorWrongFranchiseoffice., must conform to the pattern /^.{0,500}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sErrorMessage)?'null':'"'.$sErrorMessage.'"')." for sErrorMessage when calling CommonResponseErrorWrongFranchiseoffice., must conform to the pattern /^.{0,500}$/.");
        }
     ...
     *
     * @param int $fkiFranchiseagenceID The unique ID of the Franchiseagence
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiFranchiseagenceID > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFranchiseagenceID when calling CommonResponseErrorWrongFranchiseoffice., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFranchiseagenceID)?'null':'"'.$fkiFranchiseagenceID.'"').' for fkiFranchiseagenceID when calling CommonResponseErrorWrongFranchiseoffice., must be smaller than or equal to 65535.');
        }
        //if (($fkiFranchiseagenceID < 0)) {
        if (($fkiFranchiseagenceID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFranchiseagenceID when calling CommonResponseErrorWrongFranchiseoffice., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFranchiseagenceID)?'null':'"'.$fkiFranchiseagenceID.'"').' for fkiFranchiseagenceID when calling CommonResponseErrorWrongFranchiseoffice., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string $sFranchiseagenceName The name of the Franchiseagence
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiFranchiseofficeID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiFranchiseofficeID when calling CommonResponseErrorWrongFranchiseoffice., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFranchiseofficeID)?'null':'"'.$fkiFranchiseofficeID.'"').' for fkiFranchiseofficeID when calling CommonResponseErrorWrongFranchiseoffice., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param string $iFranchiseofficeCode The code of the Franchiseoffice
     *
     * @return self
     */
