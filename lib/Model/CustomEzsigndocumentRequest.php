...
/**
 * CustomEzsigndocumentRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomEzsigndocumentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Custom-Ezsigndocument-Request';
    ...
    protected static $openAPITypes = [
        ...
        'aObjEzsigndocumentdependency' => '\eZmaxAPI\Model\EzsigndocumentdependencyRequestCompound[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aObjEzsigndocumentdependency'] === null) {
            $invalidProperties[] = "'aObjEzsigndocumentdependency' can't be null";
        }
	...
	//if (($pkiEzsigndocumentID < 0)) {
        if (($pkiEzsigndocumentID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigndocumentID when calling CustomEzsigndocumentRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndocumentID)?'null':'"'.$pkiEzsigndocumentID.'"').' for pkiEzsigndocumentID when calling CustomEzsigndocumentRequest., must be bigger than or equal to 0.');
        }
     ...
     *
     * @return \eZmaxAPI\Model\EzsigndocumentdependencyRequestCompound[]
     */
     ...
     *
     * @param \eZmaxAPI\Model\EzsigndocumentdependencyRequestCompound[] $aObjEzsigndocumentdependency aObjEzsigndocumentdependency
     *
     * @return self
     */
