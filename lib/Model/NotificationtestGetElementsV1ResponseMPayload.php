    ...
    */
	...
	//if (($pkiNotificationtestID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiNotificationtestID when calling NotificationtestGetElementsV1ResponseMPayload., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiNotificationtestID)?'null':'"'.$pkiNotificationtestID.'"').' for pkiNotificationtestID when calling NotificationtestGetElementsV1ResponseMPayload., must be bigger than or equal to 0.');
        }
