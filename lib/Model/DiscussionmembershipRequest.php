...
/**
 * DiscussionmembershipRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class DiscussionmembershipRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'discussionmembership-Request';
    ...
    */
	...
	//if (($pkiDiscussionmembershipID > 16777215)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiDiscussionmembershipID when calling DiscussionmembershipRequest., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiDiscussionmembershipID)?'null':'"'.$pkiDiscussionmembershipID.'"').' for pkiDiscussionmembershipID when calling DiscussionmembershipRequest., must be smaller than or equal to 16777215.');
        }
	//if (($pkiDiscussionmembershipID < 0)) {
        if (!is_null($pkiDiscussionmembershipID) && ($pkiDiscussionmembershipID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiDiscussionmembershipID when calling DiscussionmembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiDiscussionmembershipID)?'null':'"'.$pkiDiscussionmembershipID.'"').' for pkiDiscussionmembershipID when calling DiscussionmembershipRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiDiscussionID > 16777215)) {
        if (($fkiDiscussionID > 16777215)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiDiscussionID when calling DiscussionmembershipRequest., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDiscussionID)?'null':'"'.$fkiDiscussionID.'"').' for fkiDiscussionID when calling DiscussionmembershipRequest., must be smaller than or equal to 16777215.');
        }
	//if (($fkiDiscussionID < 0)) {
        if (($fkiDiscussionID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiDiscussionID when calling DiscussionmembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDiscussionID)?'null':'"'.$fkiDiscussionID.'"').' for fkiDiscussionID when calling DiscussionmembershipRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling DiscussionmembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling DiscussionmembershipRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUsergroupID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling DiscussionmembershipRequest., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling DiscussionmembershipRequest., must be smaller than or equal to 255.');
        }
	//if (($fkiUsergroupID < 0)) {
        if (!is_null($fkiUsergroupID) && ($fkiUsergroupID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiUsergroupID when calling DiscussionmembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUsergroupID)?'null':'"'.$fkiUsergroupID.'"').' for fkiUsergroupID when calling DiscussionmembershipRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiModulesectionID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiModulesectionID when calling DiscussionmembershipRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiModulesectionID)?'null':'"'.$fkiModulesectionID.'"').' for fkiModulesectionID when calling DiscussionmembershipRequest., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtDiscussionmembershipJoined)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dtDiscussionmembershipJoined when calling DiscussionmembershipRequest., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtDiscussionmembershipJoined)?'null':'"'.$dtDiscussionmembershipJoined.'"')." for dtDiscussionmembershipJoined when calling DiscussionmembershipRequest., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
