...
/**
 * CreditcarddetailResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class CreditcarddetailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'creditcarddetail-Response';
    ...
    */
	...
	//if (!preg_match("/^[\\d]{1,8}$/", $this->container['sCreditcarddetailCivic'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sCreditcarddetailCivic', must be conform to the pattern /^[\\d]{1,8}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sCreditcarddetailCivic'])?'null':'"'.$this->container['sCreditcarddetailCivic'].'"')." for 'sCreditcarddetailCivic', must be conform to the pattern /^[\\d]{1,8}$/.";
        }
	...
	//if (!preg_match("/^.{1,19}$/", $this->container['sCreditcarddetailStreet'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sCreditcarddetailStreet', must be conform to the pattern /^.{1,19}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sCreditcarddetailStreet'])?'null':'"'.$this->container['sCreditcarddetailStreet'].'"')." for 'sCreditcarddetailStreet', must be conform to the pattern /^.{1,19}$/.";
        }
	...
	//if (!preg_match("/^.{0,9}$/", $this->container['sCreditcarddetailZip'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sCreditcarddetailZip', must be conform to the pattern /^.{0,9}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sCreditcarddetailZip'])?'null':'"'.$this->container['sCreditcarddetailZip'].'"')." for 'sCreditcarddetailZip', must be conform to the pattern /^.{0,9}$/.";
        }
	...
	//if (($pkiCreditcarddetailID > 65535)) {
        if (($pkiCreditcarddetailID > 65535)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiCreditcarddetailID when calling CreditcarddetailResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCreditcarddetailID)?'null':'"'.$pkiCreditcarddetailID.'"').' for pkiCreditcarddetailID when calling CreditcarddetailResponse., must be smaller than or equal to 65535.');
        }
	//if (($pkiCreditcarddetailID < 0)) {
        if (($pkiCreditcarddetailID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiCreditcarddetailID when calling CreditcarddetailResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCreditcarddetailID)?'null':'"'.$pkiCreditcarddetailID.'"').' for pkiCreditcarddetailID when calling CreditcarddetailResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiCreditcardtypeID > 255)) {
        if (($fkiCreditcardtypeID > 255)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiCreditcardtypeID when calling CreditcarddetailResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCreditcardtypeID)?'null':'"'.$fkiCreditcardtypeID.'"').' for fkiCreditcardtypeID when calling CreditcarddetailResponse., must be smaller than or equal to 255.');
        }
	//if (($fkiCreditcardtypeID < 0)) {
        if (($fkiCreditcardtypeID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiCreditcardtypeID when calling CreditcarddetailResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCreditcardtypeID)?'null':'"'.$fkiCreditcardtypeID.'"').' for fkiCreditcardtypeID when calling CreditcarddetailResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iCreditcarddetailLastdigits > 9999)) {
        if (($iCreditcarddetailLastdigits > 9999)) {
	    //throw new \InvalidArgumentException('invalid value for $iCreditcarddetailLastdigits when calling CreditcarddetailResponse., must be smaller than or equal to 9999.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCreditcarddetailLastdigits)?'null':'"'.$iCreditcarddetailLastdigits.'"').' for iCreditcarddetailLastdigits when calling CreditcarddetailResponse., must be smaller than or equal to 9999.');
        }
	//if (($iCreditcarddetailLastdigits < 0)) {
        if (($iCreditcarddetailLastdigits < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iCreditcarddetailLastdigits when calling CreditcarddetailResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCreditcarddetailLastdigits)?'null':'"'.$iCreditcarddetailLastdigits.'"').' for iCreditcarddetailLastdigits when calling CreditcarddetailResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iCreditcarddetailExpirationmonth > 12)) {
        if (($iCreditcarddetailExpirationmonth > 12)) {
	    //throw new \InvalidArgumentException('invalid value for $iCreditcarddetailExpirationmonth when calling CreditcarddetailResponse., must be smaller than or equal to 12.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCreditcarddetailExpirationmonth)?'null':'"'.$iCreditcarddetailExpirationmonth.'"').' for iCreditcarddetailExpirationmonth when calling CreditcarddetailResponse., must be smaller than or equal to 12.');
        }
	//if (($iCreditcarddetailExpirationmonth < 0)) {
        if (($iCreditcarddetailExpirationmonth < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iCreditcarddetailExpirationmonth when calling CreditcarddetailResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCreditcarddetailExpirationmonth)?'null':'"'.$iCreditcarddetailExpirationmonth.'"').' for iCreditcarddetailExpirationmonth when calling CreditcarddetailResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iCreditcarddetailExpirationyear > 2200)) {
        if (($iCreditcarddetailExpirationyear > 2200)) {
	    //throw new \InvalidArgumentException('invalid value for $iCreditcarddetailExpirationyear when calling CreditcarddetailResponse., must be smaller than or equal to 2200.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCreditcarddetailExpirationyear)?'null':'"'.$iCreditcarddetailExpirationyear.'"').' for iCreditcarddetailExpirationyear when calling CreditcarddetailResponse., must be smaller than or equal to 2200.');
        }
	//if (($iCreditcarddetailExpirationyear < 0)) {
        if (($iCreditcarddetailExpirationyear < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iCreditcarddetailExpirationyear when calling CreditcarddetailResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iCreditcarddetailExpirationyear)?'null':'"'.$iCreditcarddetailExpirationyear.'"').' for iCreditcarddetailExpirationyear when calling CreditcarddetailResponse., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^[\\d]{1,8}$/", ObjectSerializer::toString($sCreditcarddetailCivic)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sCreditcarddetailCivic when calling CreditcarddetailResponse., must conform to the pattern /^[\\d]{1,8}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCreditcarddetailCivic)?'null':'"'.$sCreditcarddetailCivic.'"')." for sCreditcarddetailCivic when calling CreditcarddetailResponse., must conform to the pattern /^[\\d]{1,8}$/.");
        }
	...
	//if ((!preg_match("/^.{1,19}$/", ObjectSerializer::toString($sCreditcarddetailStreet)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sCreditcarddetailStreet when calling CreditcarddetailResponse., must conform to the pattern /^.{1,19}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCreditcarddetailStreet)?'null':'"'.$sCreditcarddetailStreet.'"')." for sCreditcarddetailStreet when calling CreditcarddetailResponse., must conform to the pattern /^.{1,19}$/.");
        }
	...
	//if ((!preg_match("/^.{0,9}$/", ObjectSerializer::toString($sCreditcarddetailZip)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sCreditcarddetailZip when calling CreditcarddetailResponse., must conform to the pattern /^.{0,9}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCreditcarddetailZip)?'null':'"'.$sCreditcarddetailZip.'"')." for sCreditcarddetailZip when calling CreditcarddetailResponse., must conform to the pattern /^.{0,9}$/.");
        }
