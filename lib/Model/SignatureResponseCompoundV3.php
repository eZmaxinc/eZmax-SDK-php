...
/**
 * SignatureResponseCompoundV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class SignatureResponseCompoundV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'signature-ResponseCompoundV3';
    ...
    */
	...
	//if (($pkiSignatureID > 16777215)) {
        if (($pkiSignatureID > 16777215)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiSignatureID when calling SignatureResponseCompoundV3., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSignatureID)?'null':'"'.$pkiSignatureID.'"').' for pkiSignatureID when calling SignatureResponseCompoundV3., must be smaller than or equal to 16777215.');
        }
	//if (($pkiSignatureID < 0)) {
        if (($pkiSignatureID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiSignatureID when calling SignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSignatureID)?'null':'"'.$pkiSignatureID.'"').' for pkiSignatureID when calling SignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiFontID < 0)) {
        if (($fkiFontID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiFontID when calling SignatureResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFontID)?'null':'"'.$fkiFontID.'"').' for fkiFontID when calling SignatureResponseCompoundV3., must be bigger than or equal to 0.');
        }
