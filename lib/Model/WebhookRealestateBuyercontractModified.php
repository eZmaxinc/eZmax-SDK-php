...
/**
 * WebhookRealestateBuyercontractModified Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookRealestateBuyercontractModified implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Webhook-Realestate-BuyercontractModified';
    ...
    protected static $openAPITypes = [
        ...
        'objBuyercontract' => '\eZmaxAPI\Model\BuyercontractResponse'
    ];
    ...
    protected static $attributeMap = [
        ...
        'objBuyercontract' => 'objBuyercontract'
    ];
    ...
    protected static $setters = [
        ...
        'objBuyercontract' => 'setObjBuyercontract'
    ];
    ...
    protected static $getters = [
        ...
        'objBuyercontract' => 'getObjBuyercontract'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('objBuyercontract', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['objBuyercontract'] === null) {
            $invalidProperties[] = "'objBuyercontract' can't be null";
        }
    ...
    /**
     * Gets objBuyercontract
     *
     * @return \eZmaxAPI\Model\BuyercontractResponse
     */
    public function getObjBuyercontract()
    {
	//return $this->container['objBuyercontract'];
        return $this->container['objBuyercontract'];
    }

    /**
     * Sets objBuyercontract
     *
     * @param \eZmaxAPI\Model\BuyercontractResponse $objBuyercontract objBuyercontract
     *
     * @return self
     */
    public function setObjBuyercontract($objBuyercontract)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($objBuyercontract)) {
            //throw new \InvalidArgumentException('non-nullable objBuyercontract cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['objBuyercontract'] = $objBuyercontract;
        $this->container['objBuyercontract'] = $objBuyercontract;
