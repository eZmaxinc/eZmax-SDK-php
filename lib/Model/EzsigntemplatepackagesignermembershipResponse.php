    ...
    */
	...
	//if (($pkiEzsigntemplatepackagesignermembershipID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatepackagesignermembershipID when calling EzsigntemplatepackagesignermembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatepackagesignermembershipID)?'null':'"'.$pkiEzsigntemplatepackagesignermembershipID.'"').' for pkiEzsigntemplatepackagesignermembershipID when calling EzsigntemplatepackagesignermembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatepackagemembershipID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepackagemembershipID when calling EzsigntemplatepackagesignermembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatepackagemembershipID)?'null':'"'.$fkiEzsigntemplatepackagemembershipID.'"').' for fkiEzsigntemplatepackagemembershipID when calling EzsigntemplatepackagesignermembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatepackagesignerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepackagesignerID when calling EzsigntemplatepackagesignermembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatepackagesignerID)?'null':'"'.$fkiEzsigntemplatepackagesignerID.'"').' for fkiEzsigntemplatepackagesignerID when calling EzsigntemplatepackagesignermembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatesignerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatesignerID when calling EzsigntemplatepackagesignermembershipResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatesignerID)?'null':'"'.$fkiEzsigntemplatesignerID.'"').' for fkiEzsigntemplatesignerID when calling EzsigntemplatepackagesignermembershipResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatepackagesignermembershipCopy < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatepackagesignermembershipCopy when calling EzsigntemplatepackagesignermembershipResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatepackagesignermembershipCopy)?'null':'"'.$iEzsigntemplatepackagesignermembershipCopy.'"').' for iEzsigntemplatepackagesignermembershipCopy when calling EzsigntemplatepackagesignermembershipResponse., must be bigger than or equal to 1.');
        }
