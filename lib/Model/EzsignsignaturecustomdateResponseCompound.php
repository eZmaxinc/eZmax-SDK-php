    ...
    */
	...
	//if (($pkiEzsignsignaturecustomdateID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignaturecustomdateID when calling EzsignsignaturecustomdateResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignaturecustomdateID)?'null':'"'.$pkiEzsignsignaturecustomdateID.'"').' for pkiEzsignsignaturecustomdateID when calling EzsignsignaturecustomdateResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignsignaturecustomdateX < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignsignaturecustomdateX when calling EzsignsignaturecustomdateResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignaturecustomdateX)?'null':'"'.$iEzsignsignaturecustomdateX.'"').' for iEzsignsignaturecustomdateX when calling EzsignsignaturecustomdateResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignsignaturecustomdateY < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignsignaturecustomdateY when calling EzsignsignaturecustomdateResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignsignaturecustomdateY)?'null':'"'.$iEzsignsignaturecustomdateY.'"').' for iEzsignsignaturecustomdateY when calling EzsignsignaturecustomdateResponseCompound., must be bigger than or equal to 0.');
        }
