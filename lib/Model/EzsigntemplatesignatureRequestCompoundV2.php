...
/**
 * EzsigntemplatesignatureRequestCompoundV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplatesignatureRequestCompoundV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigntemplatesignature-RequestCompoundV2';
    ...
    protected static $openAPITypes = [
        ...
        'aObjEzsigntemplatesignaturecustomdate' => '\eZmaxAPI\Model\EzsigntemplatesignaturecustomdateRequestCompoundV2[]',
        'aObjEzsigntemplateelementdependency' => '\eZmaxAPI\Model\EzsigntemplateelementdependencyRequestCompound[]',
        'aObjEzsigntemplatesignaturepaymentdetail' => '\eZmaxAPI\Model\EzsigntemplatesignaturepaymentdetailRequestCompound[]'
    ];
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiEzsigntemplatesignatureID) && ($pkiEzsigntemplatesignatureID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatesignatureID when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatesignatureID)?'null':'"'.$pkiEzsigntemplatesignatureID.'"').' for pkiEzsigntemplatesignatureID when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigntemplatedocumentID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatedocumentID when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatedocumentID)?'null':'"'.$fkiEzsigntemplatedocumentID.'"').' for fkiEzsigntemplatedocumentID when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsigntemplatesignerID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatesignerID when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatesignerID)?'null':'"'.$fkiEzsigntemplatesignerID.'"').' for fkiEzsigntemplatesignerID when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplatesignerIDValidation) && ($fkiEzsigntemplatesignerIDValidation < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatesignerIDValidation when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatesignerIDValidation)?'null':'"'.$fkiEzsigntemplatesignerIDValidation.'"').' for fkiEzsigntemplatesignerIDValidation when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiPaymentgatewayID) && ($fkiPaymentgatewayID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $fkiPaymentgatewayID when calling EzsigntemplatesignatureRequestCompoundV2., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPaymentgatewayID)?'null':'"'.$fkiPaymentgatewayID.'"').' for fkiPaymentgatewayID when calling EzsigntemplatesignatureRequestCompoundV2., must be smaller than or equal to 255.');
        }
        //if (($fkiPaymentgatewayID < 0)) {
        if (!is_null($fkiPaymentgatewayID) && ($fkiPaymentgatewayID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiPaymentgatewayID when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPaymentgatewayID)?'null':'"'.$fkiPaymentgatewayID.'"').' for fkiPaymentgatewayID when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplatedocumentpagePagenumber < 1)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagePagenumber when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagePagenumber)?'null':'"'.$iEzsigntemplatedocumentpagePagenumber.'"').' for iEzsigntemplatedocumentpagePagenumber when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplatesignatureX) && ($iEzsigntemplatesignatureX < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignatureX when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignatureX)?'null':'"'.$iEzsigntemplatesignatureX.'"').' for iEzsigntemplatesignatureX when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplatesignatureY) && ($iEzsigntemplatesignatureY < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignatureY when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignatureY)?'null':'"'.$iEzsigntemplatesignatureY.'"').' for iEzsigntemplatesignatureY when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplatesignatureWidth) && ($iEzsigntemplatesignatureWidth < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignatureWidth when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignatureWidth)?'null':'"'.$iEzsigntemplatesignatureWidth.'"').' for iEzsigntemplatesignatureWidth when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplatesignatureHeight) && ($iEzsigntemplatesignatureHeight < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignatureHeight when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignatureHeight)?'null':'"'.$iEzsigntemplatesignatureHeight.'"').' for iEzsigntemplatesignatureHeight when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsigntemplatesignatureStep < 1)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignatureStep when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignatureStep)?'null':'"'.$iEzsigntemplatesignatureStep.'"').' for iEzsigntemplatesignatureStep when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($iEzsigntemplatesignatureMaxlength) && ($iEzsigntemplatesignatureMaxlength > 65535)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignatureMaxlength when calling EzsigntemplatesignatureRequestCompoundV2., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignatureMaxlength)?'null':'"'.$iEzsigntemplatesignatureMaxlength.'"').' for iEzsigntemplatesignatureMaxlength when calling EzsigntemplatesignatureRequestCompoundV2., must be smaller than or equal to 65535.');
        }
        //if (($iEzsigntemplatesignatureMaxlength < 0)) {
        if (!is_null($iEzsigntemplatesignatureMaxlength) && ($iEzsigntemplatesignatureMaxlength < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignatureMaxlength when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignatureMaxlength)?'null':'"'.$iEzsigntemplatesignatureMaxlength.'"').' for iEzsigntemplatesignatureMaxlength when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatesignatureRegexp) && (!preg_match("/(*UTF8)^\\^.*\\$$|^$/", ObjectSerializer::toString($sEzsigntemplatesignatureRegexp)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatesignatureRegexp when calling EzsigntemplatesignatureRequestCompoundV2., must conform to the pattern /^\\^.*\\$$|^$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatesignatureRegexp)?'null':'"'.$sEzsigntemplatesignatureRegexp.'"')." for sEzsigntemplatesignatureRegexp when calling EzsigntemplatesignatureRequestCompoundV2., must conform to the pattern /^\\^.*\\$$|^$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatesignatureTextvalidationcustommessage) && (mb_strlen($sEzsigntemplatesignatureTextvalidationcustommessage) < 0)) {
            //throw new \InvalidArgumentException('invalid length for $sEzsigntemplatesignatureTextvalidationcustommessage when calling EzsigntemplatesignatureRequestCompoundV2., must be bigger than or equal to 0.');
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatesignaturePositioningpattern) && (!preg_match("/(*UTF8)^.{0,30}$/", ObjectSerializer::toString($sEzsigntemplatesignaturePositioningpattern)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatesignaturePositioningpattern when calling EzsigntemplatesignatureRequestCompoundV2., must conform to the pattern /^.{0,30}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatesignaturePositioningpattern)?'null':'"'.$sEzsigntemplatesignaturePositioningpattern.'"')." for sEzsigntemplatesignaturePositioningpattern when calling EzsigntemplatesignatureRequestCompoundV2., must conform to the pattern /^.{0,30}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatesignatureCreditcardamountdescription) && (!preg_match("/(*UTF8)^.{1,50}$/", ObjectSerializer::toString($sEzsigntemplatesignatureCreditcardamountdescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatesignatureCreditcardamountdescription when calling EzsigntemplatesignatureRequestCompoundV2., must conform to the pattern /^.{1,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplatesignatureCreditcardamountdescription)?'null':'"'.$sEzsigntemplatesignatureCreditcardamountdescription.'"')." for sEzsigntemplatesignatureCreditcardamountdescription when calling EzsigntemplatesignatureRequestCompoundV2., must conform to the pattern /^.{1,50}$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dEzsigntemplatesignatureCreditcardamount) && (!preg_match("/(*UTF8)^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzsigntemplatesignatureCreditcardamount)))) {
            //throw new \InvalidArgumentException("invalid value for \$dEzsigntemplatesignatureCreditcardamount when calling EzsigntemplatesignatureRequestCompoundV2., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzsigntemplatesignatureCreditcardamount)?'null':'"'.$dEzsigntemplatesignatureCreditcardamount.'"')." for dEzsigntemplatesignatureCreditcardamount when calling EzsigntemplatesignatureRequestCompoundV2., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
     ...
     *
     * @return \eZmaxAPI\Model\EzsigntemplatesignaturecustomdateRequestCompoundV2[]|null
     */
     ...
     *
     * @param \eZmaxAPI\Model\EzsigntemplatesignaturecustomdateRequestCompoundV2[]|null $aObjEzsigntemplatesignaturecustomdate An array of custom date blocks that will be filled at the time of signature.  Can only be used if bEzsigntemplatesignatureCustomdate is true.  Use an empty array if you don't want to have a date at all.
     *
     * @return self
     */
     ...
     *
     * @return \eZmaxAPI\Model\EzsigntemplatesignaturepaymentdetailRequestCompound[]|null
     */
     ...
     *
     * @param \eZmaxAPI\Model\EzsigntemplatesignaturepaymentdetailRequestCompound[]|null $aObjEzsigntemplatesignaturepaymentdetail aObjEzsigntemplatesignaturepaymentdetail
     *
     * @return self
     */
