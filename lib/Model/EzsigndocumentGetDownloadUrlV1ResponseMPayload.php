 ...
 */
class EzsigndocumentGetDownloadUrlV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['sDownloadUrl'] = $data['sDownloadUrl'] ?? null;
    }
