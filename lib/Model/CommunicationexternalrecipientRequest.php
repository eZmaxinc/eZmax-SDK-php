    ...
    */
	...
	//if (!is_null($this->container['sCommunicationexternalrecipientName']) && !preg_match("/^.{0,50}$/", $this->container['sCommunicationexternalrecipientName'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sCommunicationexternalrecipientName', must be conform to the pattern /^.{0,50}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sCommunicationexternalrecipientName'])?'null':'"'.$this->container['sCommunicationexternalrecipientName'].'"')." for 'sCommunicationexternalrecipientName', must be conform to the pattern /^.{0,50}$/.";
        }
	...
	//if ((!preg_match("/^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddress)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEmailAddress when calling CommunicationexternalrecipientRequest., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEmailAddress)?'null':'"'.$sEmailAddress.'"')." for sEmailAddress when calling CommunicationexternalrecipientRequest., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
        }
	...
	//if ((!preg_match("/^\\+[1-9]\\d{1,14}$/", ObjectSerializer::toString($sPhoneE164)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sPhoneE164 when calling CommunicationexternalrecipientRequest., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sPhoneE164)?'null':'"'.$sPhoneE164.'"')." for sPhoneE164 when calling CommunicationexternalrecipientRequest., must conform to the pattern /^\\+[1-9]\\d{1,14}$/.");
        }
	...
	//if ((!preg_match("/^.{0,50}$/", ObjectSerializer::toString($sCommunicationexternalrecipientName)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sCommunicationexternalrecipientName when calling CommunicationexternalrecipientRequest., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCommunicationexternalrecipientName)?'null':'"'.$sCommunicationexternalrecipientName.'"')." for sCommunicationexternalrecipientName when calling CommunicationexternalrecipientRequest., must conform to the pattern /^.{0,50}$/.");
        }
