...
/**
 * EzsignannotationRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignannotationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignannotation-Request';
    ...
    */
	...
	//if (($fkiEzsigndocumentID < 0)) {
        if (($fkiEzsigndocumentID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigndocumentID when calling EzsignannotationRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigndocumentID)?'null':'"'.$fkiEzsigndocumentID.'"').' for fkiEzsigndocumentID when calling EzsignannotationRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignannotationX < 0)) {
        if (($iEzsignannotationX < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignannotationX when calling EzsignannotationRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignannotationX)?'null':'"'.$iEzsignannotationX.'"').' for iEzsignannotationX when calling EzsignannotationRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignannotationY < 0)) {
        if (($iEzsignannotationY < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignannotationY when calling EzsignannotationRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignannotationY)?'null':'"'.$iEzsignannotationY.'"').' for iEzsignannotationY when calling EzsignannotationRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignannotationWidth < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignannotationWidth when calling EzsignannotationRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignannotationWidth)?'null':'"'.$iEzsignannotationWidth.'"').' for iEzsignannotationWidth when calling EzsignannotationRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignannotationHeight < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsignannotationHeight when calling EzsignannotationRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignannotationHeight)?'null':'"'.$iEzsignannotationHeight.'"').' for iEzsignannotationHeight when calling EzsignannotationRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsignpagePagenumber < 1)) {
        if (($iEzsignpagePagenumber < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $iEzsignpagePagenumber when calling EzsignannotationRequest., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignpagePagenumber)?'null':'"'.$iEzsignpagePagenumber.'"').' for iEzsignpagePagenumber when calling EzsignannotationRequest., must be bigger than or equal to 1.');
        }
