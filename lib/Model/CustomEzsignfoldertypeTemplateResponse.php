...
/**
 * CustomEzsignfoldertypeTemplateResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomEzsignfoldertypeTemplateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Custom-Ezsignfoldertype-Template-Response';
    ...
    */
	...
	//if (($pkiEzsignfoldertypeID > 65535)) {
        if (($pkiEzsignfoldertypeID > 65535)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignfoldertypeID when calling CustomEzsignfoldertypeTemplateResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignfoldertypeID)?'null':'"'.$pkiEzsignfoldertypeID.'"').' for pkiEzsignfoldertypeID when calling CustomEzsignfoldertypeTemplateResponse., must be smaller than or equal to 65535.');
        }
	//if (($pkiEzsignfoldertypeID < 0)) {
        if (($pkiEzsignfoldertypeID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignfoldertypeID when calling CustomEzsignfoldertypeTemplateResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignfoldertypeID)?'null':'"'.$pkiEzsignfoldertypeID.'"').' for pkiEzsignfoldertypeID when calling CustomEzsignfoldertypeTemplateResponse., must be bigger than or equal to 0.');
        }
