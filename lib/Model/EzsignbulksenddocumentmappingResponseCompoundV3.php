...
/**
 * EzsignbulksenddocumentmappingResponseCompoundV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignbulksenddocumentmappingResponseCompoundV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsignbulksenddocumentmapping-ResponseCompoundV3';
    ...
    protected static $openAPITypes = [
        ...
        'objEzsigntemplatepackage' => '\eZmaxAPI\Model\EzsigntemplatepackageResponseCompoundV3'
    ];
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiEzsignbulksenddocumentmappingID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiEzsignbulksenddocumentmappingID when calling EzsignbulksenddocumentmappingResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignbulksenddocumentmappingID)?'null':'"'.$pkiEzsignbulksenddocumentmappingID.'"').' for pkiEzsignbulksenddocumentmappingID when calling EzsignbulksenddocumentmappingResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($fkiEzsignbulksendID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsignbulksendID when calling EzsignbulksenddocumentmappingResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignbulksendID)?'null':'"'.$fkiEzsignbulksendID.'"').' for fkiEzsignbulksendID when calling EzsignbulksenddocumentmappingResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplatepackageID) && ($fkiEzsigntemplatepackageID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatepackageID when calling EzsignbulksenddocumentmappingResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatepackageID)?'null':'"'.$fkiEzsigntemplatepackageID.'"').' for fkiEzsigntemplatepackageID when calling EzsignbulksenddocumentmappingResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEzsigntemplateID) && ($fkiEzsigntemplateID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplateID when calling EzsignbulksenddocumentmappingResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplateID)?'null':'"'.$fkiEzsigntemplateID.'"').' for fkiEzsigntemplateID when calling EzsignbulksenddocumentmappingResponseCompoundV3., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iEzsignbulksenddocumentmappingOrder < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iEzsignbulksenddocumentmappingOrder when calling EzsignbulksenddocumentmappingResponseCompoundV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsignbulksenddocumentmappingOrder)?'null':'"'.$iEzsignbulksenddocumentmappingOrder.'"').' for iEzsignbulksenddocumentmappingOrder when calling EzsignbulksenddocumentmappingResponseCompoundV3., must be bigger than or equal to 0.');
        }
     ...
     *
     * @return \eZmaxAPI\Model\EzsigntemplateResponseCompoundV4|null
     */
     ...
     *
     * @param \eZmaxAPI\Model\EzsigntemplateResponseCompoundV4|null $objEzsigntemplate objEzsigntemplate
     *
     * @return self
     */
     ...
     *
     * @return \eZmaxAPI\Model\EzsigntemplatepackageResponseCompoundV3|null
     */
     ...
     *
     * @param \eZmaxAPI\Model\EzsigntemplatepackageResponseCompoundV3|null $objEzsigntemplatepackage objEzsigntemplatepackage
     *
     * @return self
     */
