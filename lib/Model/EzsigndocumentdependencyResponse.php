...
/**
 * EzsigndocumentdependencyResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigndocumentdependencyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigndocumentdependency-Response';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pkiEzsigndocumentdependencyID'] === null) {
            $invalidProperties[] = "'pkiEzsigndocumentdependencyID' can't be null";
        }
        if (($this->container['pkiEzsigndocumentdependencyID'] > 16777215)) {
            $invalidProperties[] = "invalid value for 'pkiEzsigndocumentdependencyID', must be smaller than or equal to 16777215.";
        }

        if (($this->container['pkiEzsigndocumentdependencyID'] < 0)) {
     ...
     *
     * @param int $pkiEzsigndocumentdependencyID The unique ID of the Ezsigndocumentdependency
     *
     * @return self
     */
	...
	//if (($pkiEzsigndocumentdependencyID > 16777215)) {
        if (($pkiEzsigndocumentdependencyID > 16777215)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigndocumentdependencyID when calling EzsigndocumentdependencyResponse., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndocumentdependencyID)?'null':'"'.$pkiEzsigndocumentdependencyID.'"').' for pkiEzsigndocumentdependencyID when calling EzsigndocumentdependencyResponse., must be smaller than or equal to 16777215.');
        }
	//if (($pkiEzsigndocumentdependencyID < 0)) {
        if (($pkiEzsigndocumentdependencyID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigndocumentdependencyID when calling EzsigndocumentdependencyResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigndocumentdependencyID)?'null':'"'.$pkiEzsigndocumentdependencyID.'"').' for pkiEzsigndocumentdependencyID when calling EzsigndocumentdependencyResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigndocumentIDdependency < 0)) {
        if (($fkiEzsigndocumentIDdependency < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigndocumentIDdependency when calling EzsigndocumentdependencyResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigndocumentIDdependency)?'null':'"'.$fkiEzsigndocumentIDdependency.'"').' for fkiEzsigndocumentIDdependency when calling EzsigndocumentdependencyResponse., must be bigger than or equal to 0.');
        }
