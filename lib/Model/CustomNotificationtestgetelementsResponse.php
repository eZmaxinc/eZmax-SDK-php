...
/**
 * CustomNotificationtestgetelementsResponse Class Doc Comment
 *
 * @category Class
 * @description Element Object in the context of Notificationtest
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomNotificationtestgetelementsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Custom-Notificationtestgetelements-Response';
    ...
    */
	...
	//if (($pkiNotificationtestID < 0)) {
        if (($pkiNotificationtestID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiNotificationtestID when calling CustomNotificationtestgetelementsResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiNotificationtestID)?'null':'"'.$pkiNotificationtestID.'"').' for pkiNotificationtestID when calling CustomNotificationtestgetelementsResponse., must be bigger than or equal to 0.');
        }
