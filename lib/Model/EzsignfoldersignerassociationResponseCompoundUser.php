    ...
    */
	...
	//if (($pkiUserID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiUserID when calling EzsignfoldersignerassociationResponseCompoundUser., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiUserID)?'null':'"'.$pkiUserID.'"').' for pkiUserID when calling EzsignfoldersignerassociationResponseCompoundUser., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiLanguageID > 2)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsignfoldersignerassociationResponseCompoundUser., must be smaller than or equal to 2.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsignfoldersignerassociationResponseCompoundUser., must be smaller than or equal to 2.');
        }
	//if (($fkiLanguageID < 1)) {
        if (($fkiLanguageID < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsignfoldersignerassociationResponseCompoundUser., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsignfoldersignerassociationResponseCompoundUser., must be bigger than or equal to 1.');
        }
	...
	//if ((!preg_match("/^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/", ObjectSerializer::toString($sEmailAddress)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEmailAddress when calling EzsignfoldersignerassociationResponseCompoundUser., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEmailAddress)?'null':'"'.$sEmailAddress.'"')." for sEmailAddress when calling EzsignfoldersignerassociationResponseCompoundUser., must conform to the pattern /^[\\w.%+\\-!#$%&'*+\/=?^`{|}~]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,20}$/.");
        }
