...
/**
 * AuthenticationexternalAutocompleteElementResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class AuthenticationexternalAutocompleteElementResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'authenticationexternal-AutocompleteElement-Response';
    ...
    protected static $openAPITypes = [
        ...
        'bAuthenticationexternalIsactive' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'bAuthenticationexternalIsactive' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'bAuthenticationexternalIsactive' => false
    ];
    ...
    protected static $setters = [
        ...
        'bAuthenticationexternalIsactive' => 'setBAuthenticationexternalIsactive'
    ];
    ...
    protected static $getters = [
        ...
        'bAuthenticationexternalIsactive' => 'getBAuthenticationexternalIsactive'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bAuthenticationexternalIsactive', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bAuthenticationexternalIsactive'] === null) {
            $invalidProperties[] = "'bAuthenticationexternalIsactive' can't be null";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiAuthenticationexternalID > 255)) {
            //throw new \InvalidArgumentException('invalid value for $pkiAuthenticationexternalID when calling AuthenticationexternalAutocompleteElementResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiAuthenticationexternalID)?'null':'"'.$pkiAuthenticationexternalID.'"').' for pkiAuthenticationexternalID when calling AuthenticationexternalAutocompleteElementResponse., must be smaller than or equal to 255.');
        }
        //if (($pkiAuthenticationexternalID < 0)) {
        if (($pkiAuthenticationexternalID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiAuthenticationexternalID when calling AuthenticationexternalAutocompleteElementResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiAuthenticationexternalID)?'null':'"'.$pkiAuthenticationexternalID.'"').' for pkiAuthenticationexternalID when calling AuthenticationexternalAutocompleteElementResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sAuthenticationexternalDescription) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sAuthenticationexternalDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sAuthenticationexternalDescription when calling AuthenticationexternalAutocompleteElementResponse., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sAuthenticationexternalDescription)?'null':'"'.$sAuthenticationexternalDescription.'"')." for sAuthenticationexternalDescription when calling AuthenticationexternalAutocompleteElementResponse., must conform to the pattern /^.{0,50}$/.");
        }
    ...
    /**
     * Gets bAuthenticationexternalIsactive
     *
     * @return bool
     */
    public function getBAuthenticationexternalIsactive()
    {
	//return $this->container['bAuthenticationexternalIsactive'];
        return $this->container['bAuthenticationexternalIsactive'];
    }

    /**
     * Sets bAuthenticationexternalIsactive
     *
     * @param bool $bAuthenticationexternalIsactive Whether the Authenticationexternal is active or not
     *
     * @return self
     */
    public function setBAuthenticationexternalIsactive($bAuthenticationexternalIsactive)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($bAuthenticationexternalIsactive)) {
            //throw new \InvalidArgumentException('non-nullable bAuthenticationexternalIsactive cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['bAuthenticationexternalIsactive'] = $bAuthenticationexternalIsactive;
        $this->container['bAuthenticationexternalIsactive'] = (is_null($bAuthenticationexternalIsactive) ? null : (bool) $bAuthenticationexternalIsactive);
