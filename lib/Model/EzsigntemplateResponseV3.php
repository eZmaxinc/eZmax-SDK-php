...
/**
 * EzsigntemplateResponseV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplateResponseV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigntemplate-ResponseV3';
    ...
    */
	...
	//if (($pkiEzsigntemplateID < 0)) {
        if (($pkiEzsigntemplateID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplateID when calling EzsigntemplateResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplateID)?'null':'"'.$pkiEzsigntemplateID.'"').' for pkiEzsigntemplateID when calling EzsigntemplateResponseV3., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatedocumentID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatedocumentID when calling EzsigntemplateResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatedocumentID)?'null':'"'.$fkiEzsigntemplatedocumentID.'"').' for fkiEzsigntemplatedocumentID when calling EzsigntemplateResponseV3., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignfoldertypeID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsigntemplateResponseV3., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsigntemplateResponseV3., must be smaller than or equal to 65535.');
        }
	//if (($fkiEzsignfoldertypeID < 0)) {
        if (!is_null($fkiEzsignfoldertypeID) && ($fkiEzsignfoldertypeID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldertypeID when calling EzsigntemplateResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldertypeID)?'null':'"'.$fkiEzsignfoldertypeID.'"').' for fkiEzsignfoldertypeID when calling EzsigntemplateResponseV3., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiLanguageID > 2)) {
        if (($fkiLanguageID > 2)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsigntemplateResponseV3., must be smaller than or equal to 2.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsigntemplateResponseV3., must be smaller than or equal to 2.');
        }
	//if (($fkiLanguageID < 1)) {
        if (($fkiLanguageID < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiLanguageID when calling EzsigntemplateResponseV3., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiLanguageID)?'null':'"'.$fkiLanguageID.'"').' for fkiLanguageID when calling EzsigntemplateResponseV3., must be bigger than or equal to 1.');
        }
	...
	//if (($fkiEzdoctemplatedocumentID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatedocumentID when calling EzsigntemplateResponseV3., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatedocumentID)?'null':'"'.$fkiEzdoctemplatedocumentID.'"').' for fkiEzdoctemplatedocumentID when calling EzsigntemplateResponseV3., must be smaller than or equal to 65535.');
        }
	//if (($fkiEzdoctemplatedocumentID < 0)) {
        if (!is_null($fkiEzdoctemplatedocumentID) && ($fkiEzdoctemplatedocumentID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzdoctemplatedocumentID when calling EzsigntemplateResponseV3., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzdoctemplatedocumentID)?'null':'"'.$fkiEzdoctemplatedocumentID.'"').' for fkiEzdoctemplatedocumentID when calling EzsigntemplateResponseV3., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{0,50}$/", ObjectSerializer::toString($sEzdoctemplatedocumentNameX)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzdoctemplatedocumentNameX when calling EzsigntemplateResponseV3., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzdoctemplatedocumentNameX)?'null':'"'.$sEzdoctemplatedocumentNameX.'"')." for sEzdoctemplatedocumentNameX when calling EzsigntemplateResponseV3., must conform to the pattern /^.{0,50}$/.");
        }
	...
	//if ((!preg_match("/^.{0,80}$/", ObjectSerializer::toString($sEzsigntemplateDescription)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplateDescription when calling EzsigntemplateResponseV3., must conform to the pattern /^.{0,80}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplateDescription)?'null':'"'.$sEzsigntemplateDescription.'"')." for sEzsigntemplateDescription when calling EzsigntemplateResponseV3., must conform to the pattern /^.{0,80}$/.");
        }
	...
	//if ((!preg_match("/^.{0,75}$/", ObjectSerializer::toString($sEzsigntemplateExternaldescription)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplateExternaldescription when calling EzsigntemplateResponseV3., must conform to the pattern /^.{0,75}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplateExternaldescription)?'null':'"'.$sEzsigntemplateExternaldescription.'"')." for sEzsigntemplateExternaldescription when calling EzsigntemplateResponseV3., must conform to the pattern /^.{0,75}$/.");
        }
	...
	//if ((!preg_match("/^.{1,50}$/", ObjectSerializer::toString($sEzsigntemplateFilenameregexp)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplateFilenameregexp when calling EzsigntemplateResponseV3., must conform to the pattern /^.{1,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsigntemplateFilenameregexp)?'null':'"'.$sEzsigntemplateFilenameregexp.'"')." for sEzsigntemplateFilenameregexp when calling EzsigntemplateResponseV3., must conform to the pattern /^.{1,50}$/.");
        }
