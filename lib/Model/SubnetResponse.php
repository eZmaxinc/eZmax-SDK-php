...
/**
 * SubnetResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class SubnetResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'subnet-Response';
    ...
    */
	...
	//if (($pkiSubnetID > 65535)) {
        if (($pkiSubnetID > 65535)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiSubnetID when calling SubnetResponse., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSubnetID)?'null':'"'.$pkiSubnetID.'"').' for pkiSubnetID when calling SubnetResponse., must be smaller than or equal to 65535.');
        }
	//if (($pkiSubnetID < 0)) {
        if (($pkiSubnetID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiSubnetID when calling SubnetResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSubnetID)?'null':'"'.$pkiSubnetID.'"').' for pkiSubnetID when calling SubnetResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling SubnetResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling SubnetResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiApikeyID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiApikeyID when calling SubnetResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiApikeyID)?'null':'"'.$fkiApikeyID.'"').' for fkiApikeyID when calling SubnetResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iSubnetNetwork > 4294967295)) {
        if (($iSubnetNetwork > 4294967295)) {
	    //throw new \InvalidArgumentException('invalid value for $iSubnetNetwork when calling SubnetResponse., must be smaller than or equal to 4294967295.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iSubnetNetwork)?'null':'"'.$iSubnetNetwork.'"').' for iSubnetNetwork when calling SubnetResponse., must be smaller than or equal to 4294967295.');
        }
	//if (($iSubnetNetwork < 0)) {
        if (($iSubnetNetwork < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iSubnetNetwork when calling SubnetResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iSubnetNetwork)?'null':'"'.$iSubnetNetwork.'"').' for iSubnetNetwork when calling SubnetResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($iSubnetMask > 4294967295)) {
        if (($iSubnetMask > 4294967295)) {
	    //throw new \InvalidArgumentException('invalid value for $iSubnetMask when calling SubnetResponse., must be smaller than or equal to 4294967295.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iSubnetMask)?'null':'"'.$iSubnetMask.'"').' for iSubnetMask when calling SubnetResponse., must be smaller than or equal to 4294967295.');
        }
	//if (($iSubnetMask < 0)) {
        if (($iSubnetMask < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iSubnetMask when calling SubnetResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iSubnetMask)?'null':'"'.$iSubnetMask.'"').' for iSubnetMask when calling SubnetResponse., must be bigger than or equal to 0.');
        }
