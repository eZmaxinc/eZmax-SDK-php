...
/**
 * ModuleResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ModuleResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'module-Response';
    ...
    */
	...
	//if (($pkiModuleID < 0)) {
        if (($pkiModuleID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiModuleID when calling ModuleResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiModuleID)?'null':'"'.$pkiModuleID.'"').' for pkiModuleID when calling ModuleResponse., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiModulegroupID > 255)) {
        if (($fkiModulegroupID > 255)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiModulegroupID when calling ModuleResponse., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiModulegroupID)?'null':'"'.$fkiModulegroupID.'"').' for fkiModulegroupID when calling ModuleResponse., must be smaller than or equal to 255.');
        }
	//if (($fkiModulegroupID < 1)) {
        if (($fkiModulegroupID < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiModulegroupID when calling ModuleResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiModulegroupID)?'null':'"'.$fkiModulegroupID.'"').' for fkiModulegroupID when calling ModuleResponse., must be bigger than or equal to 1.');
        }
