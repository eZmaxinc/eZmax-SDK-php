...
/**
 * EzsignfoldersignerassociationCreateObjectV3ResponseMPayload Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignfoldersignerassociationCreateObjectV3ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsignfoldersignerassociation-createObject-v3-Response-mPayload';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if ((count($aPkiEzsignfoldersignerassociationID) < 1)) {
            //throw new \InvalidArgumentException('invalid length for $aPkiEzsignfoldersignerassociationID when calling EzsignfoldersignerassociationCreateObjectV3ResponseMPayload., number of items must be greater than or equal to 1.');
            throw new \InvalidArgumentException('invalid length for aPkiEzsignfoldersignerassociationID when calling EzsignfoldersignerassociationCreateObjectV3ResponseMPayload., number of items must be greater than or equal to 1.');
        }
