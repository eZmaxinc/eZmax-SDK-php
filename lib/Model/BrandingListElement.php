...
/**
 * BrandingListElement Class Doc Comment
 *
 * @category Class
 ...
 */
class BrandingListElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'branding-ListElement';
    ...
    */
	...
	//if (($pkiBrandingID < 0)) {
        if (($pkiBrandingID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiBrandingID when calling BrandingListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiBrandingID)?'null':'"'.$pkiBrandingID.'"').' for pkiBrandingID when calling BrandingListElement., must be bigger than or equal to 0.');
        }
	...
	//if (($iBrandingColortext > 16777215)) {
        if (($iBrandingColortext > 16777215)) {
	    //throw new \InvalidArgumentException('invalid value for $iBrandingColortext when calling BrandingListElement., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iBrandingColortext)?'null':'"'.$iBrandingColortext.'"').' for iBrandingColortext when calling BrandingListElement., must be smaller than or equal to 16777215.');
        }
	//if (($iBrandingColortext < 0)) {
        if (($iBrandingColortext < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iBrandingColortext when calling BrandingListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iBrandingColortext)?'null':'"'.$iBrandingColortext.'"').' for iBrandingColortext when calling BrandingListElement., must be bigger than or equal to 0.');
        }
	...
	//if (($iBrandingColortextlinkbox > 16777215)) {
        if (($iBrandingColortextlinkbox > 16777215)) {
	    //throw new \InvalidArgumentException('invalid value for $iBrandingColortextlinkbox when calling BrandingListElement., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iBrandingColortextlinkbox)?'null':'"'.$iBrandingColortextlinkbox.'"').' for iBrandingColortextlinkbox when calling BrandingListElement., must be smaller than or equal to 16777215.');
        }
	//if (($iBrandingColortextlinkbox < 0)) {
        if (($iBrandingColortextlinkbox < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iBrandingColortextlinkbox when calling BrandingListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iBrandingColortextlinkbox)?'null':'"'.$iBrandingColortextlinkbox.'"').' for iBrandingColortextlinkbox when calling BrandingListElement., must be bigger than or equal to 0.');
        }
	...
	//if (($iBrandingColortextbutton > 16777215)) {
        if (($iBrandingColortextbutton > 16777215)) {
	    //throw new \InvalidArgumentException('invalid value for $iBrandingColortextbutton when calling BrandingListElement., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iBrandingColortextbutton)?'null':'"'.$iBrandingColortextbutton.'"').' for iBrandingColortextbutton when calling BrandingListElement., must be smaller than or equal to 16777215.');
        }
	//if (($iBrandingColortextbutton < 0)) {
        if (($iBrandingColortextbutton < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iBrandingColortextbutton when calling BrandingListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iBrandingColortextbutton)?'null':'"'.$iBrandingColortextbutton.'"').' for iBrandingColortextbutton when calling BrandingListElement., must be bigger than or equal to 0.');
        }
	...
	//if (($iBrandingColorbackground > 16777215)) {
        if (($iBrandingColorbackground > 16777215)) {
	    //throw new \InvalidArgumentException('invalid value for $iBrandingColorbackground when calling BrandingListElement., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iBrandingColorbackground)?'null':'"'.$iBrandingColorbackground.'"').' for iBrandingColorbackground when calling BrandingListElement., must be smaller than or equal to 16777215.');
        }
	//if (($iBrandingColorbackground < 0)) {
        if (($iBrandingColorbackground < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iBrandingColorbackground when calling BrandingListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iBrandingColorbackground)?'null':'"'.$iBrandingColorbackground.'"').' for iBrandingColorbackground when calling BrandingListElement., must be bigger than or equal to 0.');
        }
	...
	//if (($iBrandingColorbackgroundbutton > 16777215)) {
        if (($iBrandingColorbackgroundbutton > 16777215)) {
	    //throw new \InvalidArgumentException('invalid value for $iBrandingColorbackgroundbutton when calling BrandingListElement., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iBrandingColorbackgroundbutton)?'null':'"'.$iBrandingColorbackgroundbutton.'"').' for iBrandingColorbackgroundbutton when calling BrandingListElement., must be smaller than or equal to 16777215.');
        }
	//if (($iBrandingColorbackgroundbutton < 0)) {
        if (($iBrandingColorbackgroundbutton < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iBrandingColorbackgroundbutton when calling BrandingListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iBrandingColorbackgroundbutton)?'null':'"'.$iBrandingColorbackgroundbutton.'"').' for iBrandingColorbackgroundbutton when calling BrandingListElement., must be bigger than or equal to 0.');
        }
	...
	//if (($iBrandingColorbackgroundsmallbox > 16777215)) {
        if (($iBrandingColorbackgroundsmallbox > 16777215)) {
	    //throw new \InvalidArgumentException('invalid value for $iBrandingColorbackgroundsmallbox when calling BrandingListElement., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iBrandingColorbackgroundsmallbox)?'null':'"'.$iBrandingColorbackgroundsmallbox.'"').' for iBrandingColorbackgroundsmallbox when calling BrandingListElement., must be smaller than or equal to 16777215.');
        }
	//if (($iBrandingColorbackgroundsmallbox < 0)) {
        if (($iBrandingColorbackgroundsmallbox < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $iBrandingColorbackgroundsmallbox when calling BrandingListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iBrandingColorbackgroundsmallbox)?'null':'"'.$iBrandingColorbackgroundsmallbox.'"').' for iBrandingColorbackgroundsmallbox when calling BrandingListElement., must be bigger than or equal to 0.');
        }
