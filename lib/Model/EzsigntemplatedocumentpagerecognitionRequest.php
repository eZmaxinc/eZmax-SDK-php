...
/**
 * EzsigntemplatedocumentpagerecognitionRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsigntemplatedocumentpagerecognitionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsigntemplatedocumentpagerecognition-Request';
    ...
    */
	...
	//if (!preg_match("/^[.\\D\\d]{0,65535}$/", $this->container['tEzsigntemplatedocumentpagerecognitionText'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'tEzsigntemplatedocumentpagerecognitionText', must be conform to the pattern /^[.\\D\\d]{0,65535}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['tEzsigntemplatedocumentpagerecognitionText'])?'null':'"'.$this->container['tEzsigntemplatedocumentpagerecognitionText'].'"')." for 'tEzsigntemplatedocumentpagerecognitionText', must be conform to the pattern /^[.\\D\\d]{0,65535}$/.";
        }
	...
	//if (($pkiEzsigntemplatedocumentpagerecognitionID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatedocumentpagerecognitionID when calling EzsigntemplatedocumentpagerecognitionRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatedocumentpagerecognitionID)?'null':'"'.$pkiEzsigntemplatedocumentpagerecognitionID.'"').' for pkiEzsigntemplatedocumentpagerecognitionID when calling EzsigntemplatedocumentpagerecognitionRequest., must be smaller than or equal to 65535.');
        }
	//if (($pkiEzsigntemplatedocumentpagerecognitionID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatedocumentpagerecognitionID when calling EzsigntemplatedocumentpagerecognitionRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatedocumentpagerecognitionID)?'null':'"'.$pkiEzsigntemplatedocumentpagerecognitionID.'"').' for pkiEzsigntemplatedocumentpagerecognitionID when calling EzsigntemplatedocumentpagerecognitionRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsigntemplatedocumentpageID < 0)) {
        if (($fkiEzsigntemplatedocumentpageID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsigntemplatedocumentpageID when calling EzsigntemplatedocumentpagerecognitionRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatedocumentpageID)?'null':'"'.$fkiEzsigntemplatedocumentpageID.'"').' for fkiEzsigntemplatedocumentpageID when calling EzsigntemplatedocumentpagerecognitionRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatedocumentpagerecognitionSimilarpercentage > 100)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionSimilarpercentage when calling EzsigntemplatedocumentpagerecognitionRequest., must be smaller than or equal to 100.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionSimilarpercentage)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionSimilarpercentage.'"').' for iEzsigntemplatedocumentpagerecognitionSimilarpercentage when calling EzsigntemplatedocumentpagerecognitionRequest., must be smaller than or equal to 100.');
        }
	//if (($iEzsigntemplatedocumentpagerecognitionSimilarpercentage < 60)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionSimilarpercentage when calling EzsigntemplatedocumentpagerecognitionRequest., must be bigger than or equal to 60.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionSimilarpercentage)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionSimilarpercentage.'"').' for iEzsigntemplatedocumentpagerecognitionSimilarpercentage when calling EzsigntemplatedocumentpagerecognitionRequest., must be bigger than or equal to 60.');
        }
	...
	//if (($iEzsigntemplatedocumentpagerecognitionX > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionX when calling EzsigntemplatedocumentpagerecognitionRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionX)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionX.'"').' for iEzsigntemplatedocumentpagerecognitionX when calling EzsigntemplatedocumentpagerecognitionRequest., must be smaller than or equal to 65535.');
        }
	//if (($iEzsigntemplatedocumentpagerecognitionX < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionX when calling EzsigntemplatedocumentpagerecognitionRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionX)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionX.'"').' for iEzsigntemplatedocumentpagerecognitionX when calling EzsigntemplatedocumentpagerecognitionRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatedocumentpagerecognitionY > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionY when calling EzsigntemplatedocumentpagerecognitionRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionY)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionY.'"').' for iEzsigntemplatedocumentpagerecognitionY when calling EzsigntemplatedocumentpagerecognitionRequest., must be smaller than or equal to 65535.');
        }
	//if (($iEzsigntemplatedocumentpagerecognitionY < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionY when calling EzsigntemplatedocumentpagerecognitionRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionY)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionY.'"').' for iEzsigntemplatedocumentpagerecognitionY when calling EzsigntemplatedocumentpagerecognitionRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatedocumentpagerecognitionWidth > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionWidth when calling EzsigntemplatedocumentpagerecognitionRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionWidth)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionWidth.'"').' for iEzsigntemplatedocumentpagerecognitionWidth when calling EzsigntemplatedocumentpagerecognitionRequest., must be smaller than or equal to 65535.');
        }
	//if (($iEzsigntemplatedocumentpagerecognitionWidth < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionWidth when calling EzsigntemplatedocumentpagerecognitionRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionWidth)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionWidth.'"').' for iEzsigntemplatedocumentpagerecognitionWidth when calling EzsigntemplatedocumentpagerecognitionRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatedocumentpagerecognitionHeight > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionHeight when calling EzsigntemplatedocumentpagerecognitionRequest., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionHeight)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionHeight.'"').' for iEzsigntemplatedocumentpagerecognitionHeight when calling EzsigntemplatedocumentpagerecognitionRequest., must be smaller than or equal to 65535.');
        }
	//if (($iEzsigntemplatedocumentpagerecognitionHeight < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatedocumentpagerecognitionHeight when calling EzsigntemplatedocumentpagerecognitionRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatedocumentpagerecognitionHeight)?'null':'"'.$iEzsigntemplatedocumentpagerecognitionHeight.'"').' for iEzsigntemplatedocumentpagerecognitionHeight when calling EzsigntemplatedocumentpagerecognitionRequest., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^[.\\D\\d]{0,65535}$/", ObjectSerializer::toString($tEzsigntemplatedocumentpagerecognitionText)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$tEzsigntemplatedocumentpagerecognitionText when calling EzsigntemplatedocumentpagerecognitionRequest., must conform to the pattern /^[.\\D\\d]{0,65535}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($tEzsigntemplatedocumentpagerecognitionText)?'null':'"'.$tEzsigntemplatedocumentpagerecognitionText.'"')." for tEzsigntemplatedocumentpagerecognitionText when calling EzsigntemplatedocumentpagerecognitionRequest., must conform to the pattern /^[.\\D\\d]{0,65535}$/.");
        }
