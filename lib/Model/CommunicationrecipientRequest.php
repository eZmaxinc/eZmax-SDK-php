...
/**
 * CommunicationrecipientRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CommunicationrecipientRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'communicationrecipient-Request';
    ...
    */
	...
	//if (($pkiCommunicationrecipientID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiCommunicationrecipientID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiCommunicationrecipientID)?'null':'"'.$pkiCommunicationrecipientID.'"').' for pkiCommunicationrecipientID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiAgentID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiAgentID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAgentID)?'null':'"'.$fkiAgentID.'"').' for fkiAgentID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiBrokerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiBrokerID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBrokerID)?'null':'"'.$fkiBrokerID.'"').' for fkiBrokerID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiContactID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiContactID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiContactID)?'null':'"'.$fkiContactID.'"').' for fkiContactID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiCustomerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiCustomerID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCustomerID)?'null':'"'.$fkiCustomerID.'"').' for fkiCustomerID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEmployeeID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEmployeeID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEmployeeID)?'null':'"'.$fkiEmployeeID.'"').' for fkiEmployeeID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiAssistantID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiAssistantID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAssistantID)?'null':'"'.$fkiAssistantID.'"').' for fkiAssistantID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiExternalbrokerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiExternalbrokerID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiExternalbrokerID)?'null':'"'.$fkiExternalbrokerID.'"').' for fkiExternalbrokerID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiEzsignsignerID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiEzsignsignerID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignsignerID)?'null':'"'.$fkiEzsignsignerID.'"').' for fkiEzsignsignerID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiNotaryID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiNotaryID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiNotaryID)?'null':'"'.$fkiNotaryID.'"').' for fkiNotaryID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiSupplierID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiSupplierID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiSupplierID)?'null':'"'.$fkiSupplierID.'"').' for fkiSupplierID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiUserID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiMailboxsharedID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiMailboxsharedID when calling CommunicationrecipientRequest., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiMailboxsharedID)?'null':'"'.$fkiMailboxsharedID.'"').' for fkiMailboxsharedID when calling CommunicationrecipientRequest., must be smaller than or equal to 255.');
        }
	//if (($fkiMailboxsharedID < 0)) {
        if (!is_null($fkiMailboxsharedID) && ($fkiMailboxsharedID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiMailboxsharedID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiMailboxsharedID)?'null':'"'.$fkiMailboxsharedID.'"').' for fkiMailboxsharedID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiPhonelinesharedID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiPhonelinesharedID when calling CommunicationrecipientRequest., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPhonelinesharedID)?'null':'"'.$fkiPhonelinesharedID.'"').' for fkiPhonelinesharedID when calling CommunicationrecipientRequest., must be smaller than or equal to 255.');
        }
	//if (($fkiPhonelinesharedID < 0)) {
        if (!is_null($fkiPhonelinesharedID) && ($fkiPhonelinesharedID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiPhonelinesharedID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPhonelinesharedID)?'null':'"'.$fkiPhonelinesharedID.'"').' for fkiPhonelinesharedID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
        }
