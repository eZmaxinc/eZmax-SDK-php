...
//        if (($fkiAgentincorporationID < 0)) {
        if (!is_null($fkiAgentincorporationID) && ($fkiAgentincorporationID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiAgentincorporationID when calling CommunicationrecipientRequest., must be bigger than or equal to 0.');
        }
