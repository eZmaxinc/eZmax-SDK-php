...
/**
 * ContactinformationsResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactinformationsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'contactinformations-Response';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sContactinformationsUrl']) && !preg_match("/(*UTF8)^.{0,255}$/", $this->container['sContactinformationsUrl'])) {
            ...
            $invalidProperties[] = "invalid value ".(is_null($this->container['sContactinformationsUrl'])?'null':'"'.$this->container['sContactinformationsUrl'].'"')." for 'sContactinformationsUrl', must be conform to the pattern /^.{0,255}$/.";
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($pkiContactinformationsID > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $pkiContactinformationsID when calling ContactinformationsResponse., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiContactinformationsID)?'null':'"'.$pkiContactinformationsID.'"').' for pkiContactinformationsID when calling ContactinformationsResponse., must be smaller than or equal to 16777215.');
        }
        //if (($pkiContactinformationsID < 0)) {
        if (($pkiContactinformationsID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $pkiContactinformationsID when calling ContactinformationsResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiContactinformationsID)?'null':'"'.$pkiContactinformationsID.'"').' for pkiContactinformationsID when calling ContactinformationsResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiAddressIDDefault) && ($fkiAddressIDDefault < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiAddressIDDefault when calling ContactinformationsResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiAddressIDDefault)?'null':'"'.$fkiAddressIDDefault.'"').' for fkiAddressIDDefault when calling ContactinformationsResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiPhoneIDDefault) && ($fkiPhoneIDDefault < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiPhoneIDDefault when calling ContactinformationsResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiPhoneIDDefault)?'null':'"'.$fkiPhoneIDDefault.'"').' for fkiPhoneIDDefault when calling ContactinformationsResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiEmailIDDefault) && ($fkiEmailIDDefault > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEmailIDDefault when calling ContactinformationsResponse., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEmailIDDefault)?'null':'"'.$fkiEmailIDDefault.'"').' for fkiEmailIDDefault when calling ContactinformationsResponse., must be smaller than or equal to 16777215.');
        }
        //if (($fkiEmailIDDefault < 1)) {
        if (!is_null($fkiEmailIDDefault) && ($fkiEmailIDDefault < 1)) {
            //throw new \InvalidArgumentException('invalid value for $fkiEmailIDDefault when calling ContactinformationsResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEmailIDDefault)?'null':'"'.$fkiEmailIDDefault.'"').' for fkiEmailIDDefault when calling ContactinformationsResponse., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiWebsiteIDDefault) && ($fkiWebsiteIDDefault > 16777215)) {
            //throw new \InvalidArgumentException('invalid value for $fkiWebsiteIDDefault when calling ContactinformationsResponse., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiWebsiteIDDefault)?'null':'"'.$fkiWebsiteIDDefault.'"').' for fkiWebsiteIDDefault when calling ContactinformationsResponse., must be smaller than or equal to 16777215.');
        }
        //if (($fkiWebsiteIDDefault < 0)) {
        if (!is_null($fkiWebsiteIDDefault) && ($fkiWebsiteIDDefault < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiWebsiteIDDefault when calling ContactinformationsResponse., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiWebsiteIDDefault)?'null':'"'.$fkiWebsiteIDDefault.'"').' for fkiWebsiteIDDefault when calling ContactinformationsResponse., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sContactinformationsUrl) && (!preg_match("/(*UTF8)^.{0,255}$/", ObjectSerializer::toString($sContactinformationsUrl)))) {
            //throw new \InvalidArgumentException("invalid value for \$sContactinformationsUrl when calling ContactinformationsResponse., must conform to the pattern /^.{0,255}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sContactinformationsUrl)?'null':'"'.$sContactinformationsUrl.'"')." for sContactinformationsUrl when calling ContactinformationsResponse., must conform to the pattern /^.{0,255}$/.");
        }
