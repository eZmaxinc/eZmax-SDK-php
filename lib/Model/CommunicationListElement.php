...
/**
 * CommunicationListElement Class Doc Comment
 *
 * @category Class
 ...
 */
class CommunicationListElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'communication-ListElement';
    ...
    */
    ...
    public function setPkiCommunicationID($pkiCommunicationID)
    {
        ...
        if (($pkiCommunicationID < 0)) {
            throw new \InvalidArgumentException('invalid value for $pkiCommunicationID when calling CommunicationListElement., must be bigger than or equal to 0.');
        }
