...
/**
 * CustomEzsignfoldersignerassociationmessageRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomEzsignfoldersignerassociationmessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Custom-Ezsignfoldersignerassociationmessage-Request';
    ...
    */
    ...
    public function setFkiEzsignfoldersignerassociationID($fkiEzsignfoldersignerassociationID)
    {
        ...
        if (($fkiEzsignfoldersignerassociationID < 0)) {
            throw new \InvalidArgumentException('invalid value for $fkiEzsignfoldersignerassociationID when calling CustomEzsignfoldersignerassociationmessageRequest., must be bigger than or equal to 0.');
        }
