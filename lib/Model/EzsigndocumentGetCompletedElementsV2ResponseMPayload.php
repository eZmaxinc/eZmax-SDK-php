...
/**
 * EzsigndocumentGetCompletedElementsV2ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /2/object/ezsigndocument/{pkiEzsigndocumentID}/getCompletedElements
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsigndocumentGetCompletedElementsV2ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ezsigndocument-getCompletedElements-v2-Response-mPayload';
