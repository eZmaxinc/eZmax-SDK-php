...
/**
 * SystemconfigurationRequestCompoundV2 Class Doc Comment
 *
 * @category Class
 ...
 */
class SystemconfigurationRequestCompoundV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'systemconfiguration-RequestCompoundV2';
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($pkiSystemconfigurationID) && ($pkiSystemconfigurationID > 1)) {
            //throw new \InvalidArgumentException('invalid value for $pkiSystemconfigurationID when calling SystemconfigurationRequestCompoundV2., must be smaller than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSystemconfigurationID)?'null':'"'.$pkiSystemconfigurationID.'"').' for pkiSystemconfigurationID when calling SystemconfigurationRequestCompoundV2., must be smaller than or equal to 1.');
        }
        //if (($pkiSystemconfigurationID < 1)) {
        if (!is_null($pkiSystemconfigurationID) && ($pkiSystemconfigurationID < 1)) {
            //throw new \InvalidArgumentException('invalid value for $pkiSystemconfigurationID when calling SystemconfigurationRequestCompoundV2., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiSystemconfigurationID)?'null':'"'.$pkiSystemconfigurationID.'"').' for pkiSystemconfigurationID when calling SystemconfigurationRequestCompoundV2., must be bigger than or equal to 1.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($fkiBrandingID) && ($fkiBrandingID < 0)) {
            //throw new \InvalidArgumentException('invalid value for $fkiBrandingID when calling SystemconfigurationRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiBrandingID)?'null':'"'.$fkiBrandingID.'"').' for fkiBrandingID when calling SystemconfigurationRequestCompoundV2., must be bigger than or equal to 0.');
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($dtSystemconfigurationReadonlyexpirationend) && (!preg_match("/(*UTF8)^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/", ObjectSerializer::toString($dtSystemconfigurationReadonlyexpirationend)))) {
            //throw new \InvalidArgumentException("invalid value for \$dtSystemconfigurationReadonlyexpirationend when calling SystemconfigurationRequestCompoundV2., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtSystemconfigurationReadonlyexpirationend)?'null':'"'.$dtSystemconfigurationReadonlyexpirationend.'"')." for dtSystemconfigurationReadonlyexpirationend when calling SystemconfigurationRequestCompoundV2., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.");
        }
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (($iSystemconfigurationEzsignreminderhoursend > 23)) {
            //throw new \InvalidArgumentException('invalid value for $iSystemconfigurationEzsignreminderhoursend when calling SystemconfigurationRequestCompoundV2., must be smaller than or equal to 23.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iSystemconfigurationEzsignreminderhoursend)?'null':'"'.$iSystemconfigurationEzsignreminderhoursend.'"').' for iSystemconfigurationEzsignreminderhoursend when calling SystemconfigurationRequestCompoundV2., must be smaller than or equal to 23.');
        }
        //if (($iSystemconfigurationEzsignreminderhoursend < 0)) {
        if (($iSystemconfigurationEzsignreminderhoursend < 0)) {
            //throw new \InvalidArgumentException('invalid value for $iSystemconfigurationEzsignreminderhoursend when calling SystemconfigurationRequestCompoundV2., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iSystemconfigurationEzsignreminderhoursend)?'null':'"'.$iSystemconfigurationEzsignreminderhoursend.'"').' for iSystemconfigurationEzsignreminderhoursend when calling SystemconfigurationRequestCompoundV2., must be bigger than or equal to 0.');
        }
