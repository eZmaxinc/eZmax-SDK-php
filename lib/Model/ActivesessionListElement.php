    ...
    */
	...
	//if (!preg_match("/^.{0,32}$/", $this->container['sActivesessionLoginname'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sActivesessionLoginname', must be conform to the pattern /^.{0,32}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sActivesessionLoginname'])?'null':'"'.$this->container['sActivesessionLoginname'].'"')." for 'sActivesessionLoginname', must be conform to the pattern /^.{0,32}$/.";
        }
	...
	//if (!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", $this->container['dtActivesessionFirsthit'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'dtActivesessionFirsthit', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtActivesessionFirsthit'])?'null':'"'.$this->container['dtActivesessionFirsthit'].'"')." for 'dtActivesessionFirsthit', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
        }
	...
	//if (!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", $this->container['dtActivesessionLasthit'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'dtActivesessionLasthit', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['dtActivesessionLasthit'])?'null':'"'.$this->container['dtActivesessionLasthit'].'"')." for 'dtActivesessionLasthit', must be conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.";
        }
	...
	//if (($fkiUserID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiUserID when calling ActivesessionListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiUserID)?'null':'"'.$fkiUserID.'"').' for fkiUserID when calling ActivesessionListElement., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiComputerID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiComputerID when calling ActivesessionListElement., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiComputerID)?'null':'"'.$fkiComputerID.'"').' for fkiComputerID when calling ActivesessionListElement., must be smaller than or equal to 65535.');
        }
	//if (($fkiComputerID < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiComputerID when calling ActivesessionListElement., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiComputerID)?'null':'"'.$fkiComputerID.'"').' for fkiComputerID when calling ActivesessionListElement., must be bigger than or equal to 1.');
        }
	...
	//if (($fkiCompanyID > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiCompanyID when calling ActivesessionListElement., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCompanyID)?'null':'"'.$fkiCompanyID.'"').' for fkiCompanyID when calling ActivesessionListElement., must be smaller than or equal to 255.');
        }
	//if (($fkiCompanyID < 1)) {
        if (($fkiCompanyID < 1)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiCompanyID when calling ActivesessionListElement., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiCompanyID)?'null':'"'.$fkiCompanyID.'"').' for fkiCompanyID when calling ActivesessionListElement., must be bigger than or equal to 1.');
        }
	...
	//if (($fkiDepartmentID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiDepartmentID when calling ActivesessionListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiDepartmentID)?'null':'"'.$fkiDepartmentID.'"').' for fkiDepartmentID when calling ActivesessionListElement., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{0,32}$/", ObjectSerializer::toString($sActivesessionLoginname)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sActivesessionLoginname when calling ActivesessionListElement., must conform to the pattern /^.{0,32}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sActivesessionLoginname)?'null':'"'.$sActivesessionLoginname.'"')." for sActivesessionLoginname when calling ActivesessionListElement., must conform to the pattern /^.{0,32}$/.");
        }
	...
	//if ((!preg_match("/^.{0,50}$/", ObjectSerializer::toString($sComputerDescription)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sComputerDescription when calling ActivesessionListElement., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sComputerDescription)?'null':'"'.$sComputerDescription.'"')." for sComputerDescription when calling ActivesessionListElement., must conform to the pattern /^.{0,50}$/.");
        }
	...
	//if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtActivesessionFirsthit)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dtActivesessionFirsthit when calling ActivesessionListElement., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtActivesessionFirsthit)?'null':'"'.$dtActivesessionFirsthit.'"')." for dtActivesessionFirsthit when calling ActivesessionListElement., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
	...
	//if ((!preg_match("/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/", ObjectSerializer::toString($dtActivesessionLasthit)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dtActivesessionLasthit when calling ActivesessionListElement., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dtActivesessionLasthit)?'null':'"'.$dtActivesessionLasthit.'"')." for dtActivesessionLasthit when calling ActivesessionListElement., must conform to the pattern /^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/.");
        }
