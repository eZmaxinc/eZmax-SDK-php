    ...
    */
	...
	//if ((mb_strlen($sEzsignformfieldgroupLabel) > 50)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupLabel when calling CustomFormDataEzsignformfieldgroupResponse., must be smaller than or equal to 50.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupLabel)?'null':'"'.$sEzsignformfieldgroupLabel.'"').', invalid length for sEzsignformfieldgroupLabel when calling CustomFormDataEzsignformfieldgroupResponse., must be smaller than or equal to 50.');
        }
	//if ((mb_strlen($sEzsignformfieldgroupLabel) < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid length for $sEzsignformfieldgroupLabel when calling CustomFormDataEzsignformfieldgroupResponse., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('value '.(is_null($sEzsignformfieldgroupLabel)?'null':'"'.$sEzsignformfieldgroupLabel.'"').', invalid length for sEzsignformfieldgroupLabel when calling CustomFormDataEzsignformfieldgroupResponse., must be bigger than or equal to 1.');
        }
