...
//        if (($fkiEzsigntemplatepackagesignerID < 0)) {
        if (!is_null($fkiEzsigntemplatepackagesignerID) && ($fkiEzsigntemplatepackagesignerID < 0)) {
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsigntemplatepackagesignerID)?'null':'"'.$fkiEzsigntemplatepackagesignerID.'"').' for fkiEzsigntemplatepackagesignerID when calling CustomImportEzsigntemplatepackageRelationRequest., must be bigger than or equal to 0.');
        }
...
//        if (($fkiEzsignfoldersignerassociationID < 0)) {
        if (($fkiEzsignfoldersignerassociationID < 0)) {
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiEzsignfoldersignerassociationID)?'null':'"'.$fkiEzsignfoldersignerassociationID.'"').' for fkiEzsignfoldersignerassociationID when calling CustomImportEzsigntemplatepackageRelationRequest., must be bigger than or equal to 0.');
        }
