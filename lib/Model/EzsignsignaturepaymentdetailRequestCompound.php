...
/**
 * EzsignsignaturepaymentdetailRequestCompound Class Doc Comment
 *
 * @category Class
 * @description An Ezsignsignaturepaymentdetail Object and children to create a complete structure
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsignsignaturepaymentdetailRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignsignaturepaymentdetail-RequestCompound';
    ...
    */
	...
	//if (!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dEzsignsignaturepaymentdetailAmount'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'dEzsignsignaturepaymentdetailAmount', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['dEzsignsignaturepaymentdetailAmount'])?'null':'"'.$this->container['dEzsignsignaturepaymentdetailAmount'].'"')." for 'dEzsignsignaturepaymentdetailAmount', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
	...
	//if (($pkiEzsignsignaturepaymentdetailID > 65535)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignaturepaymentdetailID when calling EzsignsignaturepaymentdetailRequestCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignaturepaymentdetailID)?'null':'"'.$pkiEzsignsignaturepaymentdetailID.'"').' for pkiEzsignsignaturepaymentdetailID when calling EzsignsignaturepaymentdetailRequestCompound., must be smaller than or equal to 65535.');
        }
	//if (($pkiEzsignsignaturepaymentdetailID < 0)) {
        if (!is_null($pkiEzsignsignaturepaymentdetailID) && ($pkiEzsignsignaturepaymentdetailID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignaturepaymentdetailID when calling EzsignsignaturepaymentdetailRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignaturepaymentdetailID)?'null':'"'.$pkiEzsignsignaturepaymentdetailID.'"').' for pkiEzsignsignaturepaymentdetailID when calling EzsignsignaturepaymentdetailRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiGlaccountcontainerID < 0)) {
        if (($fkiGlaccountcontainerID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $fkiGlaccountcontainerID when calling EzsignsignaturepaymentdetailRequestCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiGlaccountcontainerID)?'null':'"'.$fkiGlaccountcontainerID.'"').' for fkiGlaccountcontainerID when calling EzsignsignaturepaymentdetailRequestCompound., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", ObjectSerializer::toString($dEzsignsignaturepaymentdetailAmount)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$dEzsignsignaturepaymentdetailAmount when calling EzsignsignaturepaymentdetailRequestCompound., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($dEzsignsignaturepaymentdetailAmount)?'null':'"'.$dEzsignsignaturepaymentdetailAmount.'"')." for dEzsignsignaturepaymentdetailAmount when calling EzsignsignaturepaymentdetailRequestCompound., must conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.");
        }
