...
class TextstylestaticResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sFontName', $data ?? [], null);
    ...
    */
	...
	//if (!preg_match("/^.{0,50}$/", $this->container['sFontName'])) {
        if (!is_null($this->container['sFontName']) && !preg_match("/(*UTF8)^.{0,50}$/", $this->container['sFontName'])) {
        //    $invalidProperties[] = "invalid value for 'sFontName', must be conform to the pattern /^.{0,50}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sFontName'])?'null':'"'.$this->container['sFontName'].'"')." for 'sFontName', must be conform to the pattern /^.{0,50}$/.";
        }
	...
	//if (($pkiTextstylestaticID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiTextstylestaticID when calling TextstylestaticResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiTextstylestaticID)?'null':'"'.$pkiTextstylestaticID.'"').' for pkiTextstylestaticID when calling TextstylestaticResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($fkiFontID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $fkiFontID when calling TextstylestaticResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($fkiFontID)?'null':'"'.$fkiFontID.'"').' for fkiFontID when calling TextstylestaticResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{0,50}$/", ObjectSerializer::toString($sFontName)))) {
        if (!is_null($sFontName) && (!preg_match("/(*UTF8)^.{0,50}$/", ObjectSerializer::toString($sFontName)))) {
	    //throw new \InvalidArgumentException("invalid value for \$sFontName when calling TextstylestaticResponseCompound., must conform to the pattern /^.{0,50}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sFontName)?'null':'"'.$sFontName.'"')." for sFontName when calling TextstylestaticResponseCompound., must conform to the pattern /^.{0,50}$/.");
        }
	...
	//if (($iTextstylestaticFontcolor > 16777215)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iTextstylestaticFontcolor when calling TextstylestaticResponseCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iTextstylestaticFontcolor)?'null':'"'.$iTextstylestaticFontcolor.'"').' for iTextstylestaticFontcolor when calling TextstylestaticResponseCompound., must be smaller than or equal to 16777215.');
        }
	//if (($iTextstylestaticFontcolor < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iTextstylestaticFontcolor when calling TextstylestaticResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iTextstylestaticFontcolor)?'null':'"'.$iTextstylestaticFontcolor.'"').' for iTextstylestaticFontcolor when calling TextstylestaticResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if (($iTextstylestaticSize > 255)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iTextstylestaticSize when calling TextstylestaticResponseCompound., must be smaller than or equal to 255.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iTextstylestaticSize)?'null':'"'.$iTextstylestaticSize.'"').' for iTextstylestaticSize when calling TextstylestaticResponseCompound., must be smaller than or equal to 255.');
        }
	//if (($iTextstylestaticSize < 1)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iTextstylestaticSize when calling TextstylestaticResponseCompound., must be bigger than or equal to 1.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iTextstylestaticSize)?'null':'"'.$iTextstylestaticSize.'"').' for iTextstylestaticSize when calling TextstylestaticResponseCompound., must be bigger than or equal to 1.');
        }
