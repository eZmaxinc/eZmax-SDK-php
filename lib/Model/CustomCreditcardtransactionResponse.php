    ...
    */
	...
	//if (!preg_match("/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/", $this->container['dCreditcardtransactionAmount'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'dCreditcardtransactionAmount', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['dCreditcardtransactionAmount'])?'null':'"'.$this->container['dCreditcardtransactionAmount'].'"')." for 'dCreditcardtransactionAmount', must be conform to the pattern /^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/.";
        }
	...
	//if (!preg_match("/^(([X]{4}[ ]){3}(\\d){4})|([X]{4}[ ][X]{6}[ ][X][\\d]{4})$/", $this->container['sCreditcardtransactionPartiallydecryptednumber'])) {
        if (!is_null($this->container['sCreditcardtransactionPartiallydecryptednumber']) && !preg_match("/(*UTF8)^(([X]{4}[ ]){3}(\\d){4})|([X]{4}[ ][X]{6}[ ][X][\\d]{4})$/", $this->container['sCreditcardtransactionPartiallydecryptednumber'])) {
        //    $invalidProperties[] = "invalid value for 'sCreditcardtransactionPartiallydecryptednumber', must be conform to the pattern /^(([X]{4}[ ]){3}(\\d){4})|([X]{4}[ ][X]{6}[ ][X][\\d]{4})$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sCreditcardtransactionPartiallydecryptednumber'])?'null':'"'.$this->container['sCreditcardtransactionPartiallydecryptednumber'].'"')." for 'sCreditcardtransactionPartiallydecryptednumber', must be conform to the pattern /^(([X]{4}[ ]){3}(\\d){4})|([X]{4}[ ][X]{6}[ ][X][\\d]{4})$/.";
        }
	...
	//if (!preg_match("/^[\\d]{18}$/", $this->container['sCreditcardtransactionReferencenumber'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sCreditcardtransactionReferencenumber', must be conform to the pattern /^[\\d]{18}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sCreditcardtransactionReferencenumber'])?'null':'"'.$this->container['sCreditcardtransactionReferencenumber'].'"')." for 'sCreditcardtransactionReferencenumber', must be conform to the pattern /^[\\d]{18}$/.";
        }
	...
	//if ((!preg_match("/^(([X]{4}[ ]){3}(\\d){4})|([X]{4}[ ][X]{6}[ ][X][\\d]{4})$/", ObjectSerializer::toString($sCreditcardtransactionPartiallydecryptednumber)))) {
        if (!is_null($sCreditcardtransactionPartiallydecryptednumber) && (!preg_match("/(*UTF8)^(([X]{4}[ ]){3}(\\d){4})|([X]{4}[ ][X]{6}[ ][X][\\d]{4})$/", ObjectSerializer::toString($sCreditcardtransactionPartiallydecryptednumber)))) {
	    //throw new \InvalidArgumentException("invalid value for \$sCreditcardtransactionPartiallydecryptednumber when calling CustomCreditcardtransactionResponse., must conform to the pattern /^(([X]{4}[ ]){3}(\\d){4})|([X]{4}[ ][X]{6}[ ][X][\\d]{4})$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sCreditcardtransactionPartiallydecryptednumber)?'null':'"'.$sCreditcardtransactionPartiallydecryptednumber.'"')." for sCreditcardtransactionPartiallydecryptednumber when calling CustomCreditcardtransactionResponse., must conform to the pattern /^(([X]{4}[ ]){3}(\\d){4})|([X]{4}[ ][X]{6}[ ][X][\\d]{4})$/.");
        }
