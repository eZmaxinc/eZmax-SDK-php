...
class CustomCreditcardtransactionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        'sCreditcardtypeCodename' => 'sCreditcardtypeCodename',
    ...
    protected static $setters = [
        'sCreditcardtypeCodename' => 'setSCreditcardtypeCodename',
    ...
    protected static $getters = [
        'sCreditcardtypeCodename' => 'getSCreditcardtypeCodename',
    ...
    {
        $this->setIfExists('sCreditcardtypeCodename', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sCreditcardtypeCodename'] === null) {
            $invalidProperties[] = "'sCreditcardtypeCodename' can't be null";
        }
//        if (!preg_match("/^[a-zA-Z ]{0,15}$/", $this->container['sCreditcardtypeCodename'])) {
        if (!is_null($this->container['sCreditcardtypeCodename']) && !preg_match("/^[a-zA-Z ]{0,15}$/", $this->container['sCreditcardtypeCodename'])) {
            $invalidProperties[] = "invalid value for 'sCreditcardtypeCodename', must be conform to the pattern /^[a-zA-Z ]{0,15}$/.";
        }
...
//        if (!preg_match("/^[\\d]{18}$/", $this->container['sCreditcardtransactionReferencenumber'])) {
    ...
    /**
     * Gets sCreditcardtypeCodename
     *
     * @return string
     */
    public function getSCreditcardtypeCodename()
    {
        return $this->container['sCreditcardtypeCodename'];
    }

    /**
     * Sets sCreditcardtypeCodename
     *
     * @param string $sCreditcardtypeCodename The codename of the Creditcardtype
     *
     * @return self
     */
    public function setSCreditcardtypeCodename($sCreditcardtypeCodename)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($sCreditcardtypeCodename)) {
            //throw new \InvalidArgumentException('non-nullable sCreditcardtypeCodename cannot be null');
        //}

//        if ((!preg_match("/^[a-zA-Z ]{0,15}$/", $sCreditcardtypeCodename))) {
        if (!is_null($sCreditcardtypeCodename) && (!preg_match("/^[a-zA-Z ]{0,15}$/", $sCreditcardtypeCodename))) {
            throw new \InvalidArgumentException("invalid value for \$sCreditcardtypeCodename when calling CustomCreditcardtransactionResponse., must conform to the pattern /^[a-zA-Z ]{0,15}$/.");
        }

        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
	//$this->container['sCreditcardtypeCodename'] = $sCreditcardtypeCodename;
        $this->container['sCreditcardtypeCodename'] = (is_null($sCreditcardtypeCodename) ? null : (string) $sCreditcardtypeCodename);
