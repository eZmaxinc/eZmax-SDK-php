...
class CreditcardclientListElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'bCreditcardclientLegacy' => 'setBCreditcardclientLegacy',
    ...
    protected static $getters = [
        ...
        'bCreditcardclientLegacy' => 'getBCreditcardclientLegacy',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('bCreditcardclientLegacy', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['bCreditcardclientLegacy'] === null) {
            $invalidProperties[] = "'bCreditcardclientLegacy' can't be null";
        }
    ...
    /**
     * Gets bCreditcardclientLegacy
     *
     * @return bool
     */
    public function getBCreditcardclientLegacy()
    {
	//return $this->container['bCreditcardclientLegacy'];
        return $this->container['bCreditcardclientLegacy'];
    }

    /**
     * Sets bCreditcardclientLegacy
     *
     * @param bool $bCreditcardclientLegacy Whether the Creditcardclient is legacy or not
     *
     * @return self
     */
    public function setBCreditcardclientLegacy($bCreditcardclientLegacy)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($bCreditcardclientLegacy)) {
            //throw new \InvalidArgumentException('non-nullable bCreditcardclientLegacy cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['bCreditcardclientLegacy'] = $bCreditcardclientLegacy;
        $this->container['bCreditcardclientLegacy'] = (is_null($bCreditcardclientLegacy) ? null : (bool) $bCreditcardclientLegacy);
