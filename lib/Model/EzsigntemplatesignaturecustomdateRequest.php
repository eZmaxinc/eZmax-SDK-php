    ...
    */
	...
	//if (($pkiEzsigntemplatesignaturecustomdateID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsigntemplatesignaturecustomdateID when calling EzsigntemplatesignaturecustomdateRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsigntemplatesignaturecustomdateID)?'null':'"'.$pkiEzsigntemplatesignaturecustomdateID.'"').' for pkiEzsigntemplatesignaturecustomdateID when calling EzsigntemplatesignaturecustomdateRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatesignaturecustomdateX < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignaturecustomdateX when calling EzsigntemplatesignaturecustomdateRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignaturecustomdateX)?'null':'"'.$iEzsigntemplatesignaturecustomdateX.'"').' for iEzsigntemplatesignaturecustomdateX when calling EzsigntemplatesignaturecustomdateRequest., must be bigger than or equal to 0.');
        }
	...
	//if (($iEzsigntemplatesignaturecustomdateY < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $iEzsigntemplatesignaturecustomdateY when calling EzsigntemplatesignaturecustomdateRequest., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($iEzsigntemplatesignaturecustomdateY)?'null':'"'.$iEzsigntemplatesignaturecustomdateY.'"').' for iEzsigntemplatesignaturecustomdateY when calling EzsigntemplatesignaturecustomdateRequest., must be bigger than or equal to 0.');
        }
