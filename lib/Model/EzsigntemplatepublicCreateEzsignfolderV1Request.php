...
class EzsigntemplatepublicCreateEzsignfolderV1Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if ((mb_strlen($pksEzmaxcustomerCode) > 6)) {
            //throw new \InvalidArgumentException('invalid length for $pksEzmaxcustomerCode when calling EzsigntemplatepublicCreateEzsignfolderV1Request., must be smaller than or equal to 6.');
        ...
        if ((mb_strlen($pksEzmaxcustomerCode) < 2)) {
            //throw new \InvalidArgumentException('invalid length for $pksEzmaxcustomerCode when calling EzsigntemplatepublicCreateEzsignfolderV1Request., must be bigger than or equal to 2.');
        ...
        if (!is_null($pksEzmaxcustomerCode) && (!preg_match("/(*UTF8)^[a-z\\d]{2,6}$/", ObjectSerializer::toString($pksEzmaxcustomerCode)))) {
            //throw new \InvalidArgumentException("invalid value for \$pksEzmaxcustomerCode when calling EzsigntemplatepublicCreateEzsignfolderV1Request., must conform to the pattern /^[a-z\\d]{2,6}$/.");
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sEzsigntemplatepublicReferenceid) && (!preg_match("/(*UTF8)^.{0,36}$/", ObjectSerializer::toString($sEzsigntemplatepublicReferenceid)))) {
            //throw new \InvalidArgumentException("invalid value for \$sEzsigntemplatepublicReferenceid when calling EzsigntemplatepublicCreateEzsignfolderV1Request., must conform to the pattern /^.{0,36}$/.");
