...
/**
 * EzsignimportfolderResponseCompound Class Doc Comment
 *
 * @category Class
 * @description A Ezsignimportfolder Object
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EzsignimportfolderResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignimportfolder-ResponseCompound';
    ...
    protected static $openAPITypes = [
        ...
        'aObjEzsignimportdocument' => '\eZmaxAPI\Model\CustomEzsignimportdocumentResponse[]'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'aObjEzsignimportdocument' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'aObjEzsignimportdocument' => 'a_objEzsignimportdocument'
    ];
    ...
    protected static $setters = [
        ...
        'aObjEzsignimportdocument' => 'setAObjEzsignimportdocument'
    ];
    ...
    protected static $getters = [
        ...
        'aObjEzsignimportdocument' => 'getAObjEzsignimportdocument'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aObjEzsignimportdocument', $data ?? [], null);
    }
    ...
    */
	...
	//if (!preg_match("/^.{0,150}$/", $this->container['sEzsignimportfolderName'])) {
        ...
        //    $invalidProperties[] = "invalid value for 'sEzsignimportfolderName', must be conform to the pattern /^.{0,150}$/.";
            $invalidProperties[] = "invalid value ".(is_null($this->container['sEzsignimportfolderName'])?'null':'"'.$this->container['sEzsignimportfolderName'].'"')." for 'sEzsignimportfolderName', must be conform to the pattern /^.{0,150}$/.";
        }
	...
	//if (($pkiEzsignimportfolderID > 16777215)) {
        if (($pkiEzsignimportfolderID > 16777215)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignimportfolderID when calling EzsignimportfolderResponseCompound., must be smaller than or equal to 16777215.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignimportfolderID)?'null':'"'.$pkiEzsignimportfolderID.'"').' for pkiEzsignimportfolderID when calling EzsignimportfolderResponseCompound., must be smaller than or equal to 16777215.');
        }
	//if (($pkiEzsignimportfolderID < 0)) {
        if (($pkiEzsignimportfolderID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignimportfolderID when calling EzsignimportfolderResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignimportfolderID)?'null':'"'.$pkiEzsignimportfolderID.'"').' for pkiEzsignimportfolderID when calling EzsignimportfolderResponseCompound., must be bigger than or equal to 0.');
        }
	...
	//if ((!preg_match("/^.{0,150}$/", ObjectSerializer::toString($sEzsignimportfolderName)))) {
	    ...
	    //throw new \InvalidArgumentException("invalid value for \$sEzsignimportfolderName when calling EzsignimportfolderResponseCompound., must conform to the pattern /^.{0,150}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sEzsignimportfolderName)?'null':'"'.$sEzsignimportfolderName.'"')." for sEzsignimportfolderName when calling EzsignimportfolderResponseCompound., must conform to the pattern /^.{0,150}$/.");
        }
    ...
    /**
     * Gets aObjEzsignimportdocument
     *
     * @return \eZmaxAPI\Model\CustomEzsignimportdocumentResponse[]|null
     */
    public function getAObjEzsignimportdocument()
    {
	//return $this->container['aObjEzsignimportdocument'];
        return $this->container['aObjEzsignimportdocument'];
    }

    /**
     * Sets aObjEzsignimportdocument
     *
     * @param \eZmaxAPI\Model\CustomEzsignimportdocumentResponse[]|null $aObjEzsignimportdocument aObjEzsignimportdocument
     *
     * @return self
     */
    public function setAObjEzsignimportdocument($aObjEzsignimportdocument)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjEzsignimportdocument)) {
            //throw new \InvalidArgumentException('non-nullable aObjEzsignimportdocument cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
	//$this->container['aObjEzsignimportdocument'] = $aObjEzsignimportdocument;
        $this->container['aObjEzsignimportdocument'] = $aObjEzsignimportdocument;
