...
/**
 * DiscussionRequestPatch Class Doc Comment
 *
 * @category Class
 ...
 */
class DiscussionRequestPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'discussion-RequestPatch';
    ...
    public function listInvalidProperties()
    {
        ...
        //if (!is_null($this->container['sDiscussionDescription']) && !preg_match("/^.{0,75}$/", $this->container['sDiscussionDescription'])) {
     ...
     *
     * @param string|null $sDiscussionDescription The description of the Discussion
     *
     * @return self
     */
	...
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        ...
        if (!is_null($sDiscussionDescription) && (!preg_match("/(*UTF8)^.{0,75}$/", ObjectSerializer::toString($sDiscussionDescription)))) {
            //throw new \InvalidArgumentException("invalid value for \$sDiscussionDescription when calling DiscussionRequestPatch., must conform to the pattern /^.{0,75}$/.");
            throw new \InvalidArgumentException("invalid value ".(is_null($sDiscussionDescription)?'null':'"'.$sDiscussionDescription.'"')." for sDiscussionDescription when calling DiscussionRequestPatch., must conform to the pattern /^.{0,75}$/.");
        }
