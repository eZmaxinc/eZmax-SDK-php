...
/**
 * DepositGetListV1ResponseMPayload Class Doc Comment
 *
 * @category Class
 * @description Payload for GET /1/object/deposit/getList
 * @package  eZmaxAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DepositGetListV1ResponseMPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'deposit-getList-v1-Response-mPayload';
    ...
    protected static $openAPITypes = [
        'iRowReturned' => 'int',
        'iRowFiltered' => 'int',
        'aObjDeposit' => '\eZmaxAPI\Model\DepositListElement[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('aObjDeposit', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aObjDeposit'] === null) {
            $invalidProperties[] = "'aObjDeposit' can't be null";
        }
     ...
     * Gets aObjDeposit
     *
     * @return \eZmaxAPI\Model\DepositListElement[]
     */
    public function getAObjDeposit()
    {
	//return $this->container['aObjDeposit'];
        return $this->container['aObjDeposit'];
    }
     ...
     * Sets aObjDeposit
     *
     * @param \eZmaxAPI\Model\DepositListElement[] $aObjDeposit aObjDeposit
     *
     * @return self
     */
    public function setAObjDeposit($aObjDeposit)
    {
	//Openapi doesn't allow to set a variable to null when it's defined as Non-nullable even if it is the normal way of unsetting a variable
        //if (is_null($aObjDeposit)) {
            //throw new \InvalidArgumentException('non-nullable aObjDeposit cannot be null');
        //}
        
	//Openapi doesn't cast variable so if you set a value to "1" instead of 1 in a int, it's not casted automatically
        //$this->container['aObjDeposit'] = $aObjDeposit;
        $this->container['aObjDeposit'] = $aObjDeposit;
