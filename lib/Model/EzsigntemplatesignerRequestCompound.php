...
class EzsigntemplatesignerRequestCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['pkiEzsigntemplatesignerID'] = $data['pkiEzsigntemplatesignerID'] ?? null;
        $this->container['fkiEzsigntemplateID'] = $data['fkiEzsigntemplateID'] ?? null;
        $this->container['sEzsigntemplatesignerDescription'] = $data['sEzsigntemplatesignerDescription'] ?? null;
    }
