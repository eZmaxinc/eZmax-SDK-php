...
class EzsignfoldertypeListElement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
	...
	//if (($pkiEzsignfoldertypeID > 65535)) {
        if (($pkiEzsignfoldertypeID > 65535)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignfoldertypeID when calling EzsignfoldertypeListElement., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignfoldertypeID)?'null':'"'.$pkiEzsignfoldertypeID.'"').' for pkiEzsignfoldertypeID when calling EzsignfoldertypeListElement., must be smaller than or equal to 65535.');
        }
	//if (($pkiEzsignfoldertypeID < 0)) {
	    ...
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignfoldertypeID when calling EzsignfoldertypeListElement., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignfoldertypeID)?'null':'"'.$pkiEzsignfoldertypeID.'"').' for pkiEzsignfoldertypeID when calling EzsignfoldertypeListElement., must be bigger than or equal to 0.');
        }
