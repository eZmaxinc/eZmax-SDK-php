...
/**
 * EzsignsignergroupResponseCompound Class Doc Comment
 *
 * @category Class
 ...
 */
class EzsignsignergroupResponseCompound implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ezsignsignergroup-ResponseCompound';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pkiEzsignsignergroupID'] === null) {
            $invalidProperties[] = "'pkiEzsignsignergroupID' can't be null";
        }
        if (($this->container['pkiEzsignsignergroupID'] > 65535)) {
            $invalidProperties[] = "invalid value for 'pkiEzsignsignergroupID', must be smaller than or equal to 65535.";
        }

        if (($this->container['pkiEzsignsignergroupID'] < 0)) {
     ...
     *
     * @param int $pkiEzsignsignergroupID The unique ID of the Ezsignsignergroup
     *
     * @return self
     */
	...
	//if (($pkiEzsignsignergroupID > 65535)) {
        if (($pkiEzsignsignergroupID > 65535)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignergroupID when calling EzsignsignergroupResponseCompound., must be smaller than or equal to 65535.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignergroupID)?'null':'"'.$pkiEzsignsignergroupID.'"').' for pkiEzsignsignergroupID when calling EzsignsignergroupResponseCompound., must be smaller than or equal to 65535.');
        }
	//if (($pkiEzsignsignergroupID < 0)) {
        if (($pkiEzsignsignergroupID < 0)) {
	    //throw new \InvalidArgumentException('invalid value for $pkiEzsignsignergroupID when calling EzsignsignergroupResponseCompound., must be bigger than or equal to 0.');
            throw new \InvalidArgumentException('invalid value '.(is_null($pkiEzsignsignergroupID)?'null':'"'.$pkiEzsignsignergroupID.'"').' for pkiEzsignsignergroupID when calling EzsignsignergroupResponseCompound., must be bigger than or equal to 0.');
        }
