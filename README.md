...
*ObjectAttachmentApi* | [**attachmentValidateV1**](docs/Api/ObjectAttachmentApi.md#attachmentvalidatev1) | **PATCH** /1/object/attachment/{pkiAttachmentID}/validate | Validate an existing attachment
