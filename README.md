...
------------ | ------------- | ------------- | -------------
*ObjectActivesessionApi* | [**objectActivesessionGetCurrent1**](docs/Api/ObjectActivesessionApi.md#objectactivesessiongetcurrent1) | **GET** /1/object/activesession/getCurrent | Get Current Activesession
