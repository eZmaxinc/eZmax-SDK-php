...
```php
ezsigntemplatepackagemembershipGetObjectV3($pkiEzsigntemplatepackagemembershipID): \eZmaxAPI\Model\EzsigntemplatepackagemembershipGetObjectV3Response
```
...
try {
    $result = $apiInstance->ezsigntemplatepackagemembershipGetObjectV3($pkiEzsigntemplatepackagemembershipID);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsigntemplatepackagemembershipApi->ezsigntemplatepackagemembershipGetObjectV3: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\eZmaxAPI\Model\EzsigntemplatepackagemembershipGetObjectV3Response**](../Model/EzsigntemplatepackagemembershipGetObjectV3Response.md)
