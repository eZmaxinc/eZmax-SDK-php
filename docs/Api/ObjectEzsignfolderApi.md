...
```php
ezsignfolderCreateObjectV3($ezsignfolderCreateObjectV3Request): \eZmaxAPI\Model\EzsignfolderCreateObjectV3Response
```
...
$ezsignfolderCreateObjectV3Request = new \eZmaxAPI\Model\EzsignfolderCreateObjectV3Request(); // \eZmaxAPI\Model\EzsignfolderCreateObjectV3Request

try {
    $result = $apiInstance->ezsignfolderCreateObjectV3($ezsignfolderCreateObjectV3Request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsignfolderApi->ezsignfolderCreateObjectV3: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ezsignfolderCreateObjectV3Request** | [**\eZmaxAPI\Model\EzsignfolderCreateObjectV3Request**](../Model/EzsignfolderCreateObjectV3Request.md)|  | |

### Return type

[**\eZmaxAPI\Model\EzsignfolderCreateObjectV3Response**](../Model/EzsignfolderCreateObjectV3Response.md)
...
$pkiEzsignfolderID = 56; // int
$ezsignfolderEditObjectV3Request = new \eZmaxAPI\Model\EzsignfolderEditObjectV3Request(); // \eZmaxAPI\Model\EzsignfolderEditObjectV3Request

try {
    $result = $apiInstance->ezsignfolderEditObjectV3($pkiEzsignfolderID, $ezsignfolderEditObjectV3Request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsignfolderApi->ezsignfolderEditObjectV3: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **pkiEzsignfolderID** | **int**|  | |
| **ezsignfolderEditObjectV3Request** | [**\eZmaxAPI\Model\EzsignfolderEditObjectV3Request**](../Model/EzsignfolderEditObjectV3Request.md)|  | |
...
```php
ezsignfolderGetActionableElementsV2($pkiEzsignfolderID): \eZmaxAPI\Model\EzsignfolderGetActionableElementsV2Response
```
...
try {
    $result = $apiInstance->ezsignfolderGetActionableElementsV2($pkiEzsignfolderID);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsignfolderApi->ezsignfolderGetActionableElementsV2: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\eZmaxAPI\Model\EzsignfolderGetAttachmentCountV1Response**](../Model/EzsignfolderGetAttachmentCountV1Response.md)
...
[**\eZmaxAPI\Model\EzsignfolderGetAttachmentsV1Response**](../Model/EzsignfolderGetAttachmentsV1Response.md)
...
```php
ezsignfolderGetEzsigndocumentsV2($pkiEzsignfolderID): \eZmaxAPI\Model\EzsignfolderGetEzsigndocumentsV2Response
```
...
try {
    $result = $apiInstance->ezsignfolderGetEzsigndocumentsV2($pkiEzsignfolderID);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsignfolderApi->ezsignfolderGetEzsigndocumentsV2: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\eZmaxAPI\Model\EzsignfolderGetEzsigndocumentsV2Response**](../Model/EzsignfolderGetEzsigndocumentsV2Response.md)
...
```php
ezsignfolderGetEzsignfoldersignerassociationsV2($pkiEzsignfolderID): \eZmaxAPI\Model\EzsignfolderGetEzsignfoldersignerassociationsV2Response
```
...
try {
    $result = $apiInstance->ezsignfolderGetEzsignfoldersignerassociationsV2($pkiEzsignfolderID);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsignfolderApi->ezsignfolderGetEzsignfoldersignerassociationsV2: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\eZmaxAPI\Model\EzsignfolderGetEzsignfoldersignerassociationsV2Response**](../Model/EzsignfolderGetEzsignfoldersignerassociationsV2Response.md)
...
```php
ezsignfolderGetObjectV3($pkiEzsignfolderID): \eZmaxAPI\Model\EzsignfolderGetObjectV3Response
```
...
try {
    $result = $apiInstance->ezsignfolderGetObjectV3($pkiEzsignfolderID);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsignfolderApi->ezsignfolderGetObjectV3: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\eZmaxAPI\Model\EzsignfolderGetObjectV3Response**](../Model/EzsignfolderGetObjectV3Response.md)
...
```php
ezsignfolderImportEzsigntemplatepackageV2($pkiEzsignfolderID, $ezsignfolderImportEzsigntemplatepackageV2Request): \eZmaxAPI\Model\EzsignfolderImportEzsigntemplatepackageV2Response
```
...
$pkiEzsignfolderID = 56; // int
$ezsignfolderImportEzsigntemplatepackageV2Request = new \eZmaxAPI\Model\EzsignfolderImportEzsigntemplatepackageV2Request(); // \eZmaxAPI\Model\EzsignfolderImportEzsigntemplatepackageV2Request

try {
    $result = $apiInstance->ezsignfolderImportEzsigntemplatepackageV2($pkiEzsignfolderID, $ezsignfolderImportEzsigntemplatepackageV2Request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsignfolderApi->ezsignfolderImportEzsigntemplatepackageV2: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **pkiEzsignfolderID** | **int**|  | |
| **ezsignfolderImportEzsigntemplatepackageV2Request** | [**\eZmaxAPI\Model\EzsignfolderImportEzsigntemplatepackageV2Request**](../Model/EzsignfolderImportEzsigntemplatepackageV2Request.md)|  | |
...
$pkiEzsignfolderID = 56; // int
$ezsignfolderReorderV2Request = new \eZmaxAPI\Model\EzsignfolderReorderV2Request(); // \eZmaxAPI\Model\EzsignfolderReorderV2Request

try {
    $result = $apiInstance->ezsignfolderReorderV2($pkiEzsignfolderID, $ezsignfolderReorderV2Request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsignfolderApi->ezsignfolderReorderV2: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **pkiEzsignfolderID** | **int**|  | |
| **ezsignfolderReorderV2Request** | [**\eZmaxAPI\Model\EzsignfolderReorderV2Request**](../Model/EzsignfolderReorderV2Request.md)|  | |
