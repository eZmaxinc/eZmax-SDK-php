...
```php
ezsigntemplatepackagesignerCreateObjectV2($ezsigntemplatepackagesignerCreateObjectV2Request): \eZmaxAPI\Model\EzsigntemplatepackagesignerCreateObjectV2Response
```
...
$ezsigntemplatepackagesignerCreateObjectV2Request = new \eZmaxAPI\Model\EzsigntemplatepackagesignerCreateObjectV2Request(); // \eZmaxAPI\Model\EzsigntemplatepackagesignerCreateObjectV2Request

try {
    $result = $apiInstance->ezsigntemplatepackagesignerCreateObjectV2($ezsigntemplatepackagesignerCreateObjectV2Request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsigntemplatepackagesignerApi->ezsigntemplatepackagesignerCreateObjectV2: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ezsigntemplatepackagesignerCreateObjectV2Request** | [**\eZmaxAPI\Model\EzsigntemplatepackagesignerCreateObjectV2Request**](../Model/EzsigntemplatepackagesignerCreateObjectV2Request.md)|  | |

### Return type

[**\eZmaxAPI\Model\EzsigntemplatepackagesignerCreateObjectV2Response**](../Model/EzsigntemplatepackagesignerCreateObjectV2Response.md)
...
```php
ezsigntemplatepackagesignerEditObjectV2($pkiEzsigntemplatepackagesignerID, $ezsigntemplatepackagesignerEditObjectV2Request): \eZmaxAPI\Model\EzsigntemplatepackagesignerEditObjectV2Response
```
...
$pkiEzsigntemplatepackagesignerID = 56; // int
$ezsigntemplatepackagesignerEditObjectV2Request = new \eZmaxAPI\Model\EzsigntemplatepackagesignerEditObjectV2Request(); // \eZmaxAPI\Model\EzsigntemplatepackagesignerEditObjectV2Request

try {
    $result = $apiInstance->ezsigntemplatepackagesignerEditObjectV2($pkiEzsigntemplatepackagesignerID, $ezsigntemplatepackagesignerEditObjectV2Request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsigntemplatepackagesignerApi->ezsigntemplatepackagesignerEditObjectV2: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **pkiEzsigntemplatepackagesignerID** | **int**|  | |
| **ezsigntemplatepackagesignerEditObjectV2Request** | [**\eZmaxAPI\Model\EzsigntemplatepackagesignerEditObjectV2Request**](../Model/EzsigntemplatepackagesignerEditObjectV2Request.md)|  | |

### Return type

[**\eZmaxAPI\Model\EzsigntemplatepackagesignerEditObjectV2Response**](../Model/EzsigntemplatepackagesignerEditObjectV2Response.md)
...
```php
ezsigntemplatepackagesignerGetObjectV3($pkiEzsigntemplatepackagesignerID): \eZmaxAPI\Model\EzsigntemplatepackagesignerGetObjectV3Response
```
...
try {
    $result = $apiInstance->ezsigntemplatepackagesignerGetObjectV3($pkiEzsigntemplatepackagesignerID);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsigntemplatepackagesignerApi->ezsigntemplatepackagesignerGetObjectV3: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\eZmaxAPI\Model\EzsigntemplatepackagesignerGetObjectV3Response**](../Model/EzsigntemplatepackagesignerGetObjectV3Response.md)
