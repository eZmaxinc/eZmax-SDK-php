...
```php
invoiceGetListV1($eOrderBy, $iRowMax, $iRowOffset, $acceptLanguage, $sFilter): \eZmaxAPI\Model\InvoiceGetListV1Response
```
...
try {
    $result = $apiInstance->invoiceGetListV1($eOrderBy, $iRowMax, $iRowOffset, $acceptLanguage, $sFilter);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectInvoiceApi->invoiceGetListV1: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\eZmaxAPI\Model\InvoiceGetListV1Response**](../Model/InvoiceGetListV1Response.md)
...
```php
invoiceImportIntoEDMV1($pkiInvoiceID, $invoiceImportIntoEDMV1Request): \eZmaxAPI\Model\InvoiceImportIntoEDMV1Response
```
...
$pkiInvoiceID = 56; // int
$invoiceImportIntoEDMV1Request = new \eZmaxAPI\Model\InvoiceImportIntoEDMV1Request(); // \eZmaxAPI\Model\InvoiceImportIntoEDMV1Request

try {
    $result = $apiInstance->invoiceImportIntoEDMV1($pkiInvoiceID, $invoiceImportIntoEDMV1Request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectInvoiceApi->invoiceImportIntoEDMV1: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **pkiInvoiceID** | **int**|  | |
| **invoiceImportIntoEDMV1Request** | [**\eZmaxAPI\Model\InvoiceImportIntoEDMV1Request**](../Model/InvoiceImportIntoEDMV1Request.md)|  | |

### Return type

[**\eZmaxAPI\Model\InvoiceImportIntoEDMV1Response**](../Model/InvoiceImportIntoEDMV1Response.md)
