...
```php
inscriptionnotauthenticatedGetObjectV2($pkiInscriptionnotauthenticatedID): \eZmaxAPI\Model\InscriptionnotauthenticatedGetObjectV2Response
```
...
$pkiInscriptionnotauthenticatedID = 56; // int | The unique ID of the Inscriptionnotauthenticated

try {
    $result = $apiInstance->inscriptionnotauthenticatedGetObjectV2($pkiInscriptionnotauthenticatedID);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectInscriptionnotauthenticatedApi->inscriptionnotauthenticatedGetObjectV2: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\eZmaxAPI\Model\InscriptionnotauthenticatedGetObjectV2Response**](../Model/InscriptionnotauthenticatedGetObjectV2Response.md)
