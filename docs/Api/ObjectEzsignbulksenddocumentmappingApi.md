...
```php
ezsignbulksenddocumentmappingGetObjectV3($pkiEzsignbulksenddocumentmappingID): \eZmaxAPI\Model\EzsignbulksenddocumentmappingGetObjectV3Response
```
...
try {
    $result = $apiInstance->ezsignbulksenddocumentmappingGetObjectV3($pkiEzsignbulksenddocumentmappingID);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsignbulksenddocumentmappingApi->ezsignbulksenddocumentmappingGetObjectV3: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\eZmaxAPI\Model\EzsignbulksenddocumentmappingGetObjectV3Response**](../Model/EzsignbulksenddocumentmappingGetObjectV3Response.md)
