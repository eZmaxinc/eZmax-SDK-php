...
try {
    ...
    echo 'Exception when calling ObjectEzsigndocumentApi->ezsigndocumentGetChildrenV1: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
ezsigndocumentGetFormDataV1($pkiEzsigndocumentID): \SplFileObject
```
