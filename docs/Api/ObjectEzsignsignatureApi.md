...
```php
ezsignsignatureCreateObjectV4($ezsignsignatureCreateObjectV4Request): \eZmaxAPI\Model\EzsignsignatureCreateObjectV4Response
```
...
$ezsignsignatureCreateObjectV4Request = new \eZmaxAPI\Model\EzsignsignatureCreateObjectV4Request(); // \eZmaxAPI\Model\EzsignsignatureCreateObjectV4Request

try {
    $result = $apiInstance->ezsignsignatureCreateObjectV4($ezsignsignatureCreateObjectV4Request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsignsignatureApi->ezsignsignatureCreateObjectV4: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ezsignsignatureCreateObjectV4Request** | [**\eZmaxAPI\Model\EzsignsignatureCreateObjectV4Request**](../Model/EzsignsignatureCreateObjectV4Request.md)|  | |

### Return type

[**\eZmaxAPI\Model\EzsignsignatureCreateObjectV4Response**](../Model/EzsignsignatureCreateObjectV4Response.md)
...
```php
ezsignsignatureEditObjectV3($pkiEzsignsignatureID, $ezsignsignatureEditObjectV3Request): \eZmaxAPI\Model\EzsignsignatureEditObjectV3Response
```
...
$pkiEzsignsignatureID = 56; // int
$ezsignsignatureEditObjectV3Request = new \eZmaxAPI\Model\EzsignsignatureEditObjectV3Request(); // \eZmaxAPI\Model\EzsignsignatureEditObjectV3Request

try {
    $result = $apiInstance->ezsignsignatureEditObjectV3($pkiEzsignsignatureID, $ezsignsignatureEditObjectV3Request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsignsignatureApi->ezsignsignatureEditObjectV3: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **pkiEzsignsignatureID** | **int**|  | |
| **ezsignsignatureEditObjectV3Request** | [**\eZmaxAPI\Model\EzsignsignatureEditObjectV3Request**](../Model/EzsignsignatureEditObjectV3Request.md)|  | |

### Return type

[**\eZmaxAPI\Model\EzsignsignatureEditObjectV3Response**](../Model/EzsignsignatureEditObjectV3Response.md)
...
```php
ezsignsignatureGetObjectV4($pkiEzsignsignatureID): \eZmaxAPI\Model\EzsignsignatureGetObjectV4Response
```
...
try {
    $result = $apiInstance->ezsignsignatureGetObjectV4($pkiEzsignsignatureID);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsignsignatureApi->ezsignsignatureGetObjectV4: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\eZmaxAPI\Model\EzsignsignatureGetObjectV4Response**](../Model/EzsignsignatureGetObjectV4Response.md)
