...
```php
contacttitleGetAutocompleteV2($sSelector, $sQuery, $acceptLanguage): \eZmaxAPI\Model\ContacttitleGetAutocompleteV2Response
```
...
$apiInstance = new eZmaxAPI\Api\ObjectContacttitleApi(
...
try {
    $result = $apiInstance->contacttitleGetAutocompleteV2($sSelector, $sQuery, $acceptLanguage);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectContacttitleApi->contacttitleGetAutocompleteV2: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\eZmaxAPI\Model\ContacttitleGetAutocompleteV2Response**](../Model/ContacttitleGetAutocompleteV2Response.md)
