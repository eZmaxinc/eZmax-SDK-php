...
```php
ezsigntemplateGetObjectV4($pkiEzsigntemplateID): \eZmaxAPI\Model\EzsigntemplateGetObjectV4Response
```
...
try {
    $result = $apiInstance->ezsigntemplateGetObjectV4($pkiEzsigntemplateID);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ObjectEzsigntemplateApi->ezsigntemplateGetObjectV4: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\eZmaxAPI\Model\EzsigntemplateGetObjectV4Response**](../Model/EzsigntemplateGetObjectV4Response.md)
